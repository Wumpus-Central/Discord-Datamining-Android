...
public class AlertDialogLayout extends C1733v0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: A */
    private boolean m40514A(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == C6384f.f37784P) {
                    view = childAt;
                } else if (id2 == C6384f.f13181k) {
                    view2 = childAt;
                } else if ((id2 != C6384f.f13183m && id2 != C6384f.f13185o) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m40513j(childCount, i2);
        return true;
    }

    /* renamed from: j */
    private void m40513j(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C1733v0.C1734a aVar = (C1733v0.C1734a) childAt.getLayoutParams();
    ...
    /* renamed from: y */
    private void m40512y(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: z */
    private static int m40511z(View view) {
        int C = C2733w0.m37061C(view);
        if (C > 0) {
            return C;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m40511z(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.v0$a r15 = (androidx.appcompat.widget.C1733v0.C1734a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.view.C2733w0.m37063B(r17)
            int r2 = androidx.core.view.C2706t.m37125b(r2, r3)
            r2 = r2 & 7
            r3 = 1
