...
public class SwitchCompat extends CompoundButton {
    ...
    private static final Property<SwitchCompat, Float> THUMB_POS = new C1624a(Float.class, "thumbPos");
    private static final int[] CHECKED_STATE_SET = {16842912};

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public static class EmojiCompatInitCallback extends C2863d.AbstractC2867e {

        /* renamed from: a */
        private final Reference<SwitchCompat> f1235a;

        EmojiCompatInitCallback(SwitchCompat switchCompat) {
            this.f1235a = new WeakReference(switchCompat);
        }

        @Override // androidx.emoji2.text.C2863d.AbstractC2867e
        /* renamed from: a */
        public void mo36438a(Throwable th2) {
            SwitchCompat switchCompat = this.f1235a.get();
    ...
    /* loaded from: classes.dex */
    class C1624a extends Property<SwitchCompat, Float> {
        C1624a(Class cls, String str) {
            super(cls, str);
        }
    ...
    private void applyThumbTint() {
        ...
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            ...
            if (this.mHasThumbTint) {
                C2400a.m37828o(mutate, this.mThumbTintList);
            }
            if (this.mHasThumbTintMode) {
                C2400a.m37827p(this.mThumbDrawable, this.mThumbTintMode);
            }
    ...
    private void applyTrackTint() {
        ...
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            ...
            if (this.mHasTrackTint) {
                C2400a.m37828o(mutate, this.mTrackTintList);
            }
            if (this.mHasTrackTintMode) {
                C2400a.m37827p(this.mTrackDrawable, this.mTrackTintMode);
            }
    ...
    private CharSequence doTransformForOnOffText(CharSequence charSequence) {
        TransformationMethod f = getEmojiTextViewHelper().m40488f(this.mSwitchTransformationMethod);
        if (f != null) {
    ...
    private int getThumbScrollRange() {
        ...
        if (drawable2 != null) {
            rect = C1709q0.m40055d(drawable2);
        } else {
            rect = C1709q0.f1459c;
        }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C6386h.f13218b);
            }
            C2733w0.m37048I0(this, charSequence);
        }
    }
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C6386h.f13219c);
            }
            C2733w0.m37048I0(this, charSequence);
        }
    }
    ...
    private void setupEmojiCompatLoadCallback() {
        if (this.mEmojiCompatInitCallback == null && this.mAppCompatEmojiTextHelper.m40492b() && C2863d.m36458h()) {
            C2863d b = C2863d.m36464b();
            int d = b.m36462d();
            if (d == 3 || d == 0) {
                EmojiCompatInitCallback emojiCompatInitCallback = new EmojiCompatInitCallback(this);
                this.mEmojiCompatInitCallback = emojiCompatInitCallback;
                b.m36447s(emojiCompatInitCallback);
            }
        }
    }
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        if (z) {
            this.mVelocityTracker.computeCurrentVelocity(RNCWebViewManager.COMMAND_CLEAR_FORM_DATA);
            float xVelocity = this.mVelocityTracker.getXVelocity();
            if (Math.abs(xVelocity) <= this.mMinFlingVelocity) {
                z2 = getTargetCheckedState();
            } else if (!C1735v1.m39981b(this) ? xVelocity <= 0.0f : xVelocity >= 0.0f) {
                z2 = false;
            }
        } else {
            z2 = isChecked;
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                C2400a.m37831l(background, i15, i4, i16, i6);
            }
        }
        super.draw(canvas);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            if (!this.mSplitTrack || drawable2 == null) {
                ...
                Rect d = C1709q0.m40055d(drawable2);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect d = C1709q0.m40055d(this.mThumbDrawable);
    ...
    public void onMeasure(int i, int i2) {
        ...
        Drawable drawable3 = this.mThumbDrawable;
        if (drawable3 != null) {
            Rect d = C1709q0.m40055d(drawable3);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        L_0x0038:
            ...
            r2 = r0
        L_0x003b:
            boolean r0 = androidx.appcompat.widget.C1735v1.m39981b(r6)
    ...
    public void setChecked(boolean z) {
        ...
        if (getWindowToken() == null || !C2733w0.m37029U(this)) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList c = t.m40124c(C6388j.f37894W2);
        if (c != null) {
            this.mTextColors = c;
        } else {
            this.mTextColors = getTextColors();
        }
        int f = t.m40121f(C6388j.f37882T2, 0);
        if (f != 0) {
            float f2 = f;
        ...
        setSwitchTypefaceByIndex(t.m40116k(C6388j.f37886U2, -1), t.m40116k(C6388j.f37890V2, -1));
        if (t.m40126a(C6388j.f13244b3, false)) {
            this.mSwitchTransformationMethod = new C7715a(getContext());
        } else {
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(C6525a.m25364b(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(C6525a.m25364b(getContext(), i));
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C6379a.f37746L);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C6388j.f37803D2;
        C1698n1 v = C1698n1.m40105v(context, attributeSet, iArr, i, 0);
        C2733w0.m36994o0(this, context, iArr, attributeSet, v.m40109r(), i, 0);
        Drawable g = v.m40120g(C6388j.f37818G2);
        this.mThumbDrawable = g;
        if (g != null) {
            g.setCallback(this);
        }
        Drawable g2 = v.m40120g(C6388j.f37863P2);
        this.mTrackDrawable = g2;
        if (g2 != null) {
            g2.setCallback(this);
        }
        setTextOnInternal(v.m40111p(C6388j.f37808E2));
        setTextOffInternal(v.m40111p(C6388j.f37813F2));
        this.mShowText = v.m40126a(C6388j.f37823H2, true);
        this.mThumbTextPadding = v.m40121f(C6388j.f37848M2, 0);
        this.mSwitchMinWidth = v.m40121f(C6388j.f37833J2, 0);
        this.mSwitchPadding = v.m40121f(C6388j.f37838K2, 0);
        this.mSplitTrack = v.m40126a(C6388j.f37828I2, false);
        ColorStateList c = v.m40124c(C6388j.f37853N2);
        if (c != null) {
            this.mThumbTintList = c;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode e = C1709q0.m40054e(v.m40116k(C6388j.f37858O2, -1), null);
        ...
        ColorStateList c2 = v.m40124c(C6388j.f37868Q2);
        if (c2 != null) {
            this.mTrackTintList = c2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode e2 = C1709q0.m40054e(v.m40116k(C6388j.f37873R2, -1), null);
        ...
        int n = v.m40113n(C6388j.f37843L2, 0);
        if (n != 0) {
