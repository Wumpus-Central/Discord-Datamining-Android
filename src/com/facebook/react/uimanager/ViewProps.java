...
public class ViewProps {
    ...
    /* renamed from: ON */
    public static final String f37199ON = "on";
    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c) {
            case 0:
                if (readableMap.getType(BORDER_RIGHT_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_RIGHT_COLOR) == 0) {
                    return true;
                }
                return false;
            case 1:
                ...
                return false;
            case 2:
                if (readableMap.getType(BORDER_TOP_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_TOP_COLOR) == 0) {
                    return true;
                }
                return false;
            case 3:
                ...
                return false;
            case 4:
                if (readableMap.getType(BORDER_BOTTOM_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_BOTTOM_COLOR) == 0) {
                    return true;
                }
                return false;
            case 5:
            ...
            case 6:
                ...
                return false;
            case 7:
                if (readableMap.getType(BORDER_LEFT_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_LEFT_COLOR) == 0) {
                    return true;
                }
                return false;
            case '\b':
