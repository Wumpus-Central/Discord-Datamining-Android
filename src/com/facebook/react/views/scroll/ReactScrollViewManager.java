...
public class ReactScrollViewManager extends ViewGroupManager<ReactScrollView> implements ReactScrollViewCommandHelper.ScrollCommandHandler<ReactScrollView> {
    ...
    public static Map<String, Object> createExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(ScrollEventType.getJSEventName(ScrollEventType.SCROLL), MapBuilder.m30831of("registrationName", "onScroll")).put(ScrollEventType.getJSEventName(ScrollEventType.BEGIN_DRAG), MapBuilder.m30831of("registrationName", "onScrollBeginDrag")).put(ScrollEventType.getJSEventName(ScrollEventType.END_DRAG), MapBuilder.m30831of("registrationName", "onScrollEndDrag")).put(ScrollEventType.getJSEventName(ScrollEventType.MOMENTUM_BEGIN), MapBuilder.m30831of("registrationName", "onMomentumScrollBegin")).put(ScrollEventType.getJSEventName(ScrollEventType.MOMENTUM_END), MapBuilder.m30831of("registrationName", "onMomentumScrollEnd")).build();
    }
    ...
    public void setContentOffset(ReactScrollView reactScrollView, ReadableMap readableMap) {
        ...
        if (readableMap != null) {
            ...
            reactScrollView.scrollTo((int) PixelUtil.toPixelFromDIP(d), (int) PixelUtil.toPixelFromDIP(d2));
            return;
        }
    ...
    public void setNestedScrollEnabled(ReactScrollView reactScrollView, boolean z) {
        C2733w0.m37060C0(reactScrollView, z);
    }
