...
public final class ExternalPipManager {
    ...
    public final void enterPipMode(Activity activity, boolean z, Function1<? super C10845s<Unit>, Unit> onResult) {
        boolean z2;
        ...
        if (!z2 || Build.VERSION.SDK_INT < 26) {
            ...
            onResult.invoke(C10845s.m10941a(C10845s.m10940b(C10848t.m10931a(new Exception("Disabled or unsupported.")))));
            return;
        }
        if (activity != null) {
            try {
                ...
                onResult.invoke(C10845s.m10941a(C10845s.m10940b(C10848t.m10931a(e))));
                return;
            }
        }
        C10845s.C10846a aVar3 = C10845s.f28533l;
        onResult.invoke(C10845s.m10941a(C10845s.m10940b(Unit.f25780a)));
    }
