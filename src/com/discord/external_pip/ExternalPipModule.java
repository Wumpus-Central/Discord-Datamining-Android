...
public final class ExternalPipModule extends ReactContextBaseJavaModule {
    ...
    private final ReactEvents reactEvents = new ReactEvents(C11098x.m10921a("onPipModeChanged", C9951f0.m14684b(OnPipModeChangedEvent.class)));
    ...
    public final void enterPipMode(Promise onResultPromise) {
        C9971q.m14633g(onResultPromise, "onResultPromise");
    ...
    public final void enterPipMode(boolean z, Function1<? super C11090s<Unit>, Unit> onResult) {
