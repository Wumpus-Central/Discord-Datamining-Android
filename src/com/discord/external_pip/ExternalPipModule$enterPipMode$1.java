...
final class ExternalPipModule$enterPipMode$1 extends AbstractC9973s implements Function1<C11090s<? extends Unit>, Unit> {
    ...
    public final void invoke(C11090s<? extends Unit> sVar) {
        if (C11090s.m10934h(sVar)) {
            this.$onResultPromise.resolve(Boolean.TRUE);
        } else {
            this.$onResultPromise.reject(C11090s.m10937e(sVar));
        }
    }
}
