...
public final class ReactionViewBinding {
    ...
    public static ReactionViewBinding bind(View view) {
        int i = C3630R.C3632id.reaction_count_1;
        TextView textView = (TextView) C13836a.m2313a(view, i);
        if (textView != null) {
            i = C3630R.C3632id.reaction_count_2;
            TextView textView2 = (TextView) C13836a.m2313a(view, i);
            if (textView2 != null) {
                i = C3630R.C3632id.reaction_count_switcher;
                TextSwitcher textSwitcher = (TextSwitcher) C13836a.m2313a(view, i);
                if (textSwitcher != null) {
                    i = C3630R.C3632id.reaction_emoji;
    ...
    public static ReactionViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        if (viewGroup != null) {
            layoutInflater.inflate(C3630R.layout.reaction_view, viewGroup);
