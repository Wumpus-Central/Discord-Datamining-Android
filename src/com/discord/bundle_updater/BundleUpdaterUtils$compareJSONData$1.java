...
public final class BundleUpdaterUtils$compareJSONData$1 extends AbstractC9973s implements Function1<String, Pair<? extends String, ? extends AssetStatus>> {
    ...
    public final Pair<String, AssetStatus> invoke(String key) {
        ...
        C9971q.m14634f(key, "key");
        if (C9971q.m14638b(string, BundleUpdaterUtilsKt.getStringOrNull(jSONObject, key))) {
            return null;
        }
        if (C9971q.m14638b(string, BundleUpdaterUtilsKt.getStringOrNull(this.$oldData, key))) {
            assetStatus = AssetStatus.CopyFromPrevious;
        } else {
            assetStatus = AssetStatus.Download;
        }
        return C11098x.m10921a(key, assetStatus);
    }
}
