...
public final class BundleUpdater$client$2 extends AbstractC9679s implements Function0<OkHttpClient> {
    ...
    public final OkHttpClient invoke() {
        ...
        return builder.m9911f(new CookieJar() { // from class: com.discord.bundle_updater.BundleUpdater$client$2.1
            ...
            public List<C12086k> loadForRequest(HttpUrl url) {
            ...
            @Override // okhttp3.CookieJar
            public void saveFromResponse(HttpUrl url, List<C12086k> cookies) {
                CookieManager cookieManager;
                String e0;
                C9677q.m14633g(url, "url");
                C9677q.m14633g(cookies, "cookies");
                cookieManager = BundleUpdater.this.getCookieManager();
                String httpUrl = url.toString();
                e0 = C9618r.m14760e0(cookies, "; ", null, null, 0, null, null, 62, null);
