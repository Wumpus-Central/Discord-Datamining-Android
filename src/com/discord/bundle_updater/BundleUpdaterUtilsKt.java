...
public final class BundleUpdaterUtilsKt {
    public static final JSONArray getArrayOrNull(JSONObject jSONObject, String key) {
        C9677q.m14633g(jSONObject, "<this>");
    ...
    public static final JSONObject getJSONFromAsset(AssetManager assetManager, String asset) {
        ...
        C9677q.m14633g(assetManager, "<this>");
        C9677q.m14633g(asset, "asset");
        InputStream open = assetManager.open(asset);
        C9677q.m14634f(open, "open(asset)");
        InputStreamReader inputStreamReader = new InputStreamReader(open, C12563d.f32852b);
        ...
        try {
            th = null;
            return new JSONObject(C14023q.m1668e(bufferedReader));
        } finally {
            try {
                throw th;
            } finally {
