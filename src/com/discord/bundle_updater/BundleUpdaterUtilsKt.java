...
import p426xf.C14103q;

@Metadata(m15074d1 = {"\u0000\"\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0014\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0004\u001a\u0014\u0010\u0005\u001a\u00020\u0002*\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0004H\u0000\u001a\u0014\u0010\b\u001a\u0004\u0018\u00010\u0002*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0004\u001a3\u0010\t\u001a\u0004\u0018\u0001H\n\"\u0004\b\u0000\u0010\n*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00042\u0012\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u0002H\n0\f¢\u0006\u0002\u0010\r\u001a\u0014\u0010\u000e\u001a\u0004\u0018\u00010\u0004*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0004¨\u0006\u000f"}, m15073d2 = {"getArrayOrNull", "Lorg/json/JSONArray;", "Lorg/json/JSONObject;", "key", "", "getJSONFromAsset", "Landroid/content/res/AssetManager;", "asset", "getObjectOrNull", "getOrNull", "T", "callback", "Lkotlin/Function1;", "(Lorg/json/JSONObject;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;", "getStringOrNull", "bundle_updater_release"}, m15072k = 2, m15071mv = {1, 8, 0}, m15069xi = 48)
/* loaded from: classes.dex */
public final class BundleUpdaterUtilsKt {
    public static final JSONArray getArrayOrNull(JSONObject jSONObject, String key) {
        C9971q.m14633g(jSONObject, "<this>");
    ...
    public static final JSONObject getJSONFromAsset(AssetManager assetManager, String asset) {
        ...
        C9971q.m14633g(assetManager, "<this>");
        C9971q.m14633g(asset, "asset");
        InputStream open = assetManager.open(asset);
        C9971q.m14634f(open, "open(asset)");
        InputStreamReader inputStreamReader = new InputStreamReader(open, C12694d.f28536b);
        ...
        try {
            th = null;
            return new JSONObject(C14103q.m1668e(bufferedReader));
        } finally {
            try {
                throw th;
            } finally {
