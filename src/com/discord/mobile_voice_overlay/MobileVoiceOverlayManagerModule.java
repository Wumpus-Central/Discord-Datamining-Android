...
public final class MobileVoiceOverlayManagerModule extends NativeMobileVoiceOverlaySpec {
    ...
    @Metadata(m15074d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m15073d2 = {"Lcom/discord/mobile_voice_overlay/MobileVoiceOverlayManagerModule$Companion;", "", "()V", "NAME", "", "OVERLAY_REQUEST_CODE", "", "create", "Lcom/facebook/react/bridge/NativeModule;", "reactContext", "Lcom/facebook/react/bridge/ReactApplicationContext;", "mobile_voice_overlay_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes5.dex */
    ...
    public MobileVoiceOverlayManagerModule(ReactApplicationContext reactContext) {
        ...
        Lazy a;
        C9677q.m14633g(reactContext, "reactContext");
        a = C10839n.m10945a(new MobileVoiceOverlayManagerModule$mobileVoiceOverlay$2(this));
        this.mobileVoiceOverlay$delegate = a;
    }
    ...
    public void setData(ReadableMap readableMap) {
        if (readableMap != null) {
            ...
            json.mo611a();
            final MobileVoiceOverlayData mobileVoiceOverlayData = (MobileVoiceOverlayData) json.mo578b(MobileVoiceOverlayData.Companion.serializer(), jsonString);
    ...
    public void showOverlay(ReadableMap readableMap) {
        if (readableMap != null) {
            ...
            String jsonString = NativeMapExtensionsKt.toJsonString(readableMap);
            json.mo611a();
            final MobileVoiceOverlayAssets mobileVoiceOverlayAssets = (MobileVoiceOverlayAssets) json.mo578b(MobileVoiceOverlayAssets.Companion.serializer(), jsonString);
