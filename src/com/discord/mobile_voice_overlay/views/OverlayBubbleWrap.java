...
public abstract class OverlayBubbleWrap extends OverlayView {
            ...
            protected void afterChange(KProperty<?> property, Boolean bool2, Boolean bool3) {
                ...
                if (bool2.booleanValue() != booleanValue) {
                    ...
                    if (booleanValue) {
                        ...
                        this.getSpringAnimationX().mo36516c();
                        this.getSpringAnimationY().mo36516c();
                    }
    ...
    private final void animateTo(SpringAnimation springAnimation, float f, float f2) {
        ...
        springAnimation.m36548j(f);
        springAnimation.m36513o(f2);
    }
    ...
    public void anchorOff(boolean z) {
        ...
        this.springAnimationX.mo36516c();
        this.springAnimationY.mo36516c();
        if (z) {
