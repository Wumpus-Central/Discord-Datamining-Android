...
public final class ResultAdapter extends RecyclerView.Adapter<ResultViewHolder> {
    ...
    public ResultAdapter(Function1<? super ChannelId, Unit> onChannelSelected) {
        List<MobileVoiceOverlaySelectorResult> i;
