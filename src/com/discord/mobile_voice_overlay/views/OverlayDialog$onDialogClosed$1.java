...
final class OverlayDialog$onDialogClosed$1 extends AbstractC9973s implements Function1<OverlayDialog, Unit> {
    public static final OverlayDialog$onDialogClosed$1 INSTANCE = new OverlayDialog$onDialogClosed$1();

    OverlayDialog$onDialogClosed$1() {
        super(1);
    }
