...
final class MobileVoiceOverlay$onTrashVoiceBubble$1 extends AbstractC9679s implements Function1<OverlayVoiceBubble, Unit> {
    ...
    public final void invoke2(OverlayVoiceBubble voiceBubble) {
        ...
        Animator invoke$lambda$2 = AnimatorInflater.loadAnimator(voiceBubble.getContext(), C3521R.animator.fade_out);
        final MobileVoiceOverlay mobileVoiceOverlay = this.this$0;
        invoke$lambda$2.setTarget(voiceBubble);
        C9677q.m14634f(invoke$lambda$2, "invoke$lambda$2");
