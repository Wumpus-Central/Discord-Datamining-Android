...
public final class MobileVoiceOverlay$menuDialogProvider$1 extends AbstractC9679s implements Function1<OverlayViewProvider<OverlayMenuBubbleDialog>, OverlayMenuBubbleDialog> {
    ...
    public final OverlayMenuBubbleDialog invoke(OverlayViewProvider<OverlayMenuBubbleDialog> it) {
        ...
        overlayMenuBubbleDialog.getInsetMargins().top = overlayMenuBubbleDialog.getResources().getDimensionPixelOffset(C3521R.dimen.vertical_safe_margin);
