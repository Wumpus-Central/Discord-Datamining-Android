...
public final class ViewOverlayMenuBinding {
    ...
    public static ViewOverlayMenuBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        if (viewGroup != null) {
            layoutInflater.inflate(C4573R.layout.view_overlay_menu, viewGroup);
