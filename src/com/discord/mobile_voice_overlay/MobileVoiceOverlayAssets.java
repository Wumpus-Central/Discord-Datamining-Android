...
public final class MobileVoiceOverlayAssets {
    ...
    public /* synthetic */ MobileVoiceOverlayAssets(int i, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, SerializationConstructorMarker serializationConstructorMarker) {
        if (2047 != (i & 2047)) {
            C2560n1.m33818b(i, 2047, MobileVoiceOverlayAssets$$serializer.INSTANCE.getDescriptor());
        }
        this.useSpeaker = str;
        this.mute = str2;
    ...
    public final MobileVoiceOverlayAssets copy(String useSpeaker, String mute, String disconnectFromVoice, String getInvite, String switchChannels, String openDiscord, String inviteLinkCopied, String channelSelect, String closeWindow, String searchChannels, String noResults) {
        C9677q.m14633g(useSpeaker, "useSpeaker");
        C9677q.m14633g(mute, "mute");
        C9677q.m14633g(disconnectFromVoice, "disconnectFromVoice");
        C9677q.m14633g(getInvite, "getInvite");
        C9677q.m14633g(switchChannels, "switchChannels");
        C9677q.m14633g(openDiscord, "openDiscord");
        C9677q.m14633g(inviteLinkCopied, "inviteLinkCopied");
        C9677q.m14633g(channelSelect, "channelSelect");
        C9677q.m14633g(closeWindow, "closeWindow");
        C9677q.m14633g(searchChannels, "searchChannels");
        C9677q.m14633g(noResults, "noResults");
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.useSpeaker, mobileVoiceOverlayAssets.useSpeaker) && C9677q.m14638b(this.mute, mobileVoiceOverlayAssets.mute) && C9677q.m14638b(this.disconnectFromVoice, mobileVoiceOverlayAssets.disconnectFromVoice) && C9677q.m14638b(this.getInvite, mobileVoiceOverlayAssets.getInvite) && C9677q.m14638b(this.switchChannels, mobileVoiceOverlayAssets.switchChannels) && C9677q.m14638b(this.openDiscord, mobileVoiceOverlayAssets.openDiscord) && C9677q.m14638b(this.inviteLinkCopied, mobileVoiceOverlayAssets.inviteLinkCopied) && C9677q.m14638b(this.channelSelect, mobileVoiceOverlayAssets.channelSelect) && C9677q.m14638b(this.closeWindow, mobileVoiceOverlayAssets.closeWindow) && C9677q.m14638b(this.searchChannels, mobileVoiceOverlayAssets.searchChannels) && C9677q.m14638b(this.noResults, mobileVoiceOverlayAssets.noResults);
    }
