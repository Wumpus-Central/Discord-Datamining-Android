...
public final class MobileVoiceOverlayData {
    ...
    private MobileVoiceOverlayData(int i, List<MobileVoiceOverlayDataUser> list, int i2, GuildId guildId, ChannelId channelId, String str, String str2, boolean z, boolean z2, ConnectionQuality connectionQuality, boolean z3, List<MobileVoiceOverlaySelectorResult> list2, SerializationConstructorMarker serializationConstructorMarker) {
        if (2047 != (i & 2047)) {
            C2560n1.m33818b(i, 2047, MobileVoiceOverlayData$$serializer.INSTANCE.getDescriptor());
        }
        this.users = list;
        this.extraUsers = i2;
    ...
    public static final void write$Self(MobileVoiceOverlayData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 0, new C2521f(MobileVoiceOverlayDataUser$$serializer.INSTANCE), self.users);
        ...
        output.mo13870t(serialDesc, 10, new C2521f(MobileVoiceOverlaySelectorResult$$serializer.INSTANCE), self.channelSelectorResults);
    }
    ...
    public final MobileVoiceOverlayData m42011copyHeAh3Ug(List<MobileVoiceOverlayDataUser> users, int i, GuildId guildId, long j, String channelName, String guildName, boolean z, boolean z2, ConnectionQuality connectionQuality, boolean z3, List<MobileVoiceOverlaySelectorResult> channelSelectorResults) {
        ...
        C9677q.m14633g(connectionQuality, "connectionQuality");
        C9677q.m14633g(channelSelectorResults, "channelSelectorResults");
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.users, mobileVoiceOverlayData.users) && this.extraUsers == mobileVoiceOverlayData.extraUsers && C9677q.m14638b(this.guildId, mobileVoiceOverlayData.guildId) && ChannelId.m42093equalsimpl0(this.channelId, mobileVoiceOverlayData.channelId) && C9677q.m14638b(this.channelName, mobileVoiceOverlayData.channelName) && C9677q.m14638b(this.guildName, mobileVoiceOverlayData.guildName) && this.deafened == mobileVoiceOverlayData.deafened && this.muted == mobileVoiceOverlayData.muted && this.connectionQuality == mobileVoiceOverlayData.connectionQuality && this.canGenerateInvite == mobileVoiceOverlayData.canGenerateInvite && C9677q.m14638b(this.channelSelectorResults, mobileVoiceOverlayData.channelSelectorResults);
    }
