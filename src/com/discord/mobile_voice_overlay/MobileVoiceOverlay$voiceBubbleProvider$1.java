...
public final class MobileVoiceOverlay$voiceBubbleProvider$1 extends AbstractC9679s implements Function1<OverlayViewProvider<OverlayVoiceBubble>, OverlayVoiceBubble> {
    ...
    public static final void invoke$lambda$2(OverlayVoiceBubble voiceBubble, MobileVoiceOverlay this$0, View view) {
        ...
        this$0.menuDialogProvider.withView(new MobileVoiceOverlay$voiceBubbleProvider$1$1$1(voiceBubble, new Rect(i, i2, i3, i4)));
    ...
    public final OverlayVoiceBubble invoke(OverlayViewProvider<OverlayVoiceBubble> it) {
        ...
        overlayVoiceBubble.getInsetMargins().set(i, dimensionPixelOffset, i, dimensionPixelOffset);
