...
public final class ImmersiveMode {
    ...
    private final void fitSystemWindowsAndAdjustResize(Activity activity) {
        ...
        C9971q.m14636d(view);
        C2733w0.m37058D0(viewGroup, new AbstractC2694r0() { // from class: m3.a
    ...
    public static final WindowInsetsCompat fitSystemWindowsAndAdjustResize$lambda$2(ViewGroup viewGroup, View rootViewChild, View view, WindowInsetsCompat insets) {
        C9971q.m14633g(rootViewChild, "$rootViewChild");
        C9971q.m14633g(view, "<anonymous parameter 0>");
        C9971q.m14633g(insets, "insets");
        viewGroup.setFitsSystemWindows(true);
        int max = Math.max(insets.m37521f(WindowInsetsCompat.C2542m.m37460b()).f3329d, 0);
        Iterator<T> it = rootViewInsetUpdateCallbacks.iterator();
        while (it.hasNext()) {
            ((Function1) it.next()).invoke(insets);
        }
        WindowInsetsCompat a = new WindowInsetsCompat.C2531b(insets).m37498b(WindowInsetsCompat.C2542m.m37455g(), Insets.m37935b(0, 0, 0, max)).m37499a();
        C2733w0.m37018c0(rootViewChild, a);
        return a;
    }

    public final void addRootViewInsetUpdateCallback(Function1<? super WindowInsetsCompat, Unit> onRootViewInsetsUpdated) {
        C9971q.m14633g(onRootViewInsetsUpdated, "onRootViewInsetsUpdated");
    ...
    public final void enableImmersiveMode(Activity activity) {
        ...
        C9971q.m14634f(window, "activity.window");
