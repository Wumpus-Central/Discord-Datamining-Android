...
public final class SafeAreaProviderManager$addEventEmitters$2 extends AbstractC9973s implements Function1<WindowInsetsCompat, Unit> {
    ...
    public final void invoke2(WindowInsetsCompat insets) {
        ...
        Insets f = insets.m37521f(WindowInsetsCompat.C2542m.m37460b());
        C9971q.m14634f(f, "insets.getInsets(WindowInsetsCompat.Type.ime())");
