...
public final class BSDiff {
    ...
    static {
        byte[] bytes = "MBSDIF43".getBytes(C12694d.f28536b);
    ...
    private final Sequence<Integer> chunkRange(long j) {
        ...
        Sequence K;
        Sequence<Integer> y;
        p = C6884j.m23948p(0, j);
        n = C6884j.m23950n(p, BUFFER_SIZE_BYTES);
        K = C9914r.m14782K(n);
        y = C12200o.m7420y(K, new BSDiff$chunkRange$1(j));
        return y;
    }
    ...
    public final void bspatchStreaming(File oldPath, File patchPath, File newPath) {
        ...
        C9971q.m14633g(oldPath, "oldPath");
        C9971q.m14633g(patchPath, "patchPath");
        C9971q.m14633g(newPath, "newPath");
        ...
        try {
            try {
                ...
                th = null;
                C14082c.m1713a(inputStream, th);
                C14082c.m1713a(bufferedInputStream3, th);
                C14082c.m1713a(bufferedInputStream2, th);
                C14082c.m1713a(bufferedInputStream, th);
            } finally {
                try {
                    throw th;
                } finally {
