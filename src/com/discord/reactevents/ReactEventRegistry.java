...
public final class ReactEventRegistry {
    ...
    public final Map<String, Object> exportEventConstants() {
        ...
        for (Object obj : values) {
            l = C11289v.m10247l(C11098x.m10921a("registrationName", (String) obj));
            hashMap.put(obj, l);
        }
        return hashMap;
    }
    ...
    public final String getEventName(ReactEvent event) {
        ...
        String str = this.events.get(C9951f0.m14684b(event.getClass()));
        if (str != null) {
            return str;
        }
        KClass b = C9951f0.m14684b(event.getClass());
    ...
    public final void registerEvent(String eventName, KClass<? extends ReactEvent> eventClass) {
        C9971q.m14633g(eventName, "eventName");
        C9971q.m14633g(eventClass, "eventClass");
