...
import com.discord.foreground_service.C4465R;
...
public final class ServiceNotification {
    ...
    private final Notification buildNotification(Context context, ServiceNotificationConfiguration serviceNotificationConfiguration) {
        ...
        NotificationCompat.Builder Y = D.m38574C(pendingIntent).m38551Z(C4465R.C4466drawable.ic_notification_24dp).m38560Q(true).m38552Y(true);
        ...
        C9971q.m14634f(g, "Builder(context, FOREGRO…   }\n            .build()");
        return g;
    }
    ...
    public final void clearNotifications(Context context) {
        ...
        while (it.hasNext()) {
            INSTANCE.getNotificationManagerCompat(context).m38431b(FOREGROUND_NOTIFICATION_TAG, ((AbstractC11283p) it).nextInt());
        }
    }
    ...
    public final void startForegroundCompat(Service service, Context context, List<ServiceNotificationConfiguration> serviceNotificationConfigurations) {
        ...
        C9971q.m14633g(serviceNotificationConfigurations, "serviceNotificationConfigurations");
        w0 = C9914r.m14742w0(serviceNotificationConfigurations, new Comparator() { // from class: com.discord.foreground_service.service.ServiceNotification$startForegroundCompat$$inlined$sortedBy$1
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                int d;
                d = C12120c.m7778d(((ServiceNotificationConfiguration) t).getPriority(), ((ServiceNotificationConfiguration) t2).getPriority());
                return d;
            }
        });
        U = C9914r.m14770U(w0);
        O = C9914r.m14776O(w0, 1);
