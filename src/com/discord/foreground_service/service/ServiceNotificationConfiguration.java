...
public final class ServiceNotificationConfiguration {
    ...
    public static final class Action {
        ...
        public boolean equals(Object obj) {
            ...
            return C9677q.m14638b(this.tag, action.tag) && C9677q.m14638b(this.taskName, action.taskName) && C9677q.m14638b(this.title, action.title) && C9677q.m14638b(this.data, action.data);
        }
    ...
    public ServiceNotificationConfiguration(String title, String str, Priority priority, Action action, List<Action> auxiliaryActions) {
        ...
        C9677q.m14633g(priority, "priority");
        C9677q.m14633g(auxiliaryActions, "auxiliaryActions");
        this.title = title;
        this.content = str;
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.title, serviceNotificationConfiguration.title) && C9677q.m14638b(this.content, serviceNotificationConfiguration.content) && this.priority == serviceNotificationConfiguration.priority && C9677q.m14638b(this.contentAction, serviceNotificationConfiguration.contentAction) && C9677q.m14638b(this.auxiliaryActions, serviceNotificationConfiguration.auxiliaryActions);
    }
