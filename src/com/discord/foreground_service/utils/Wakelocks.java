...
public final class Wakelocks {
    ...
    public final void acquire(Context context) {
        ...
        WifiManager wifiManager = (WifiManager) C2337a.m38128j(context, WifiManager.class);
        if (wifiManager != null) {
        ...
        PowerManager powerManager = (PowerManager) C2337a.m38128j(context, PowerManager.class);
        boolean z = false;
