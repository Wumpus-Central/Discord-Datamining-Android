...
public final class KeyboardExtensionsKt {
    ...
    public static final WindowInsetsControllerCompat getInsetsController(Window window, View view) {
        WindowInsetsControllerCompat a = C2696r2.m37145a(window, view);
        C9971q.m14634f(a, "getInsetsController(this, view)");
        return a;
    }
    ...
    public static final void hideKeyboard(View view, Window window) {
        ...
        C10129j.m14195d(MainImmediateScopeKt.MainImmediateScope(), null, null, new KeyboardExtensionsKt$hideKeyboard$1(window, view, null), 3, null);
    }

    public static final void showKeyboard(View view, Window window) {
        C9971q.m14633g(view, "<this>");
        C9971q.m14633g(window, "window");
        C10129j.m14195d(MainImmediateScopeKt.MainImmediateScope(), null, null, new KeyboardExtensionsKt$showKeyboard$1(window, view, null), 3, null);
    }
}
