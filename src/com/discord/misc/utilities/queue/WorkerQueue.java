...
public final class WorkerQueue<T> {
    ...
    public final boolean updateWorker(T t, boolean z, Function1<? super T, Unit> onWorkerActive) {
        ...
        Object V;
        Object h0;
        C9677q.m14633g(onWorkerActive, "onWorkerActive");
        if (z) {
            T t2 = this.currWorker;
            if (t2 == null || C9677q.m14638b(t2, t)) {
                this.currWorker = t;
            } else {
                this.nextWorkers.add(t);
            }
        } else if (C9677q.m14638b(this.currWorker, t)) {
            if (this.popFromEnd) {
                h0 = C9618r.m14757h0(this.nextWorkers);
                obj = (T) h0;
            } else {
                V = C9618r.m14769V(this.nextWorkers);
                obj = (T) V;
            }
        ...
        return C9677q.m14638b(this.currWorker, t);
    }
