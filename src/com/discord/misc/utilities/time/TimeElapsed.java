...
public final class TimeElapsed {
    ...
    public TimeElapsed(long j) {
        ...
        Lazy a2;
        this.startTime = j;
        a = C11084n.m10945a(new TimeElapsed$durationMillis$2(this));
        this.durationMillis$delegate = a;
        a2 = C11084n.m10945a(new TimeElapsed$duration$2(this));
    ...
    public final String getDuration() {
        ...
        C9971q.m14634f(value, "<get-duration>(...)");
        return (String) value;
    }
    ...
    public int hashCode() {
        return C4081a.m32873a(this.startTime);
    }
