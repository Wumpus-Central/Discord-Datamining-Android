...
public final class AnimatedImageStateManager$updateWorker$1 extends AbstractC9679s implements Function1<AnimatedImageStateManager<?>, Unit> {
    ...
    public final void invoke2(AnimatedImageStateManager<?> stateManager) {
        C9677q.m14633g(stateManager, "stateManager");
        stateManager.reload();
    }
}
