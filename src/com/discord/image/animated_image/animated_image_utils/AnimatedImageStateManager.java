...
public final class AnimatedImageStateManager<T> {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0018\u0010\u0003\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00050\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/image/animated_image/animated_image_utils/AnimatedImageStateManager$Companion;", "", "()V", "workerQueue", "Lcom/discord/misc/utilities/queue/WorkerQueue;", "Lcom/discord/image/animated_image/animated_image_utils/AnimatedImageStateManager;", "animated_image_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes5.dex */
    ...
    public AnimatedImageStateManager(Function0<Unit> handlePlay, Function0<Unit> handlePause, Function1<? super T, Unit> handleSetPlaceholder, Function1<? super T, Boolean> handleConfigIsValid, Function1<? super T, Unit> handleFetchAnimatedImage) {
        C9971q.m14633g(handlePlay, "handlePlay");
        C9971q.m14633g(handlePause, "handlePause");
        C9971q.m14633g(handleSetPlaceholder, "handleSetPlaceholder");
        C9971q.m14633g(handleConfigIsValid, "handleConfigIsValid");
        C9971q.m14633g(handleFetchAnimatedImage, "handleFetchAnimatedImage");
    ...
    public final void onTryFetch(T t) {
        if (!ThreadUtilsKt.isOnMainThread()) {
            Thread currentThread = Thread.currentThread();
            throw new IllegalStateException(("Expected to be on android main thread. Current: " + currentThread).toString());
        } else if (!C9971q.m14638b(this.animatedImageConfig, t) || !this.animatedImageLoaded) {
