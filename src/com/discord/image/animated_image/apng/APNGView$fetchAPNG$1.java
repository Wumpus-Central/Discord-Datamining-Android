...
@AbstractC9636e(m14702c = "com.discord.image.animated_image.apng.APNGView$fetchAPNG$1", m14701f = "APNGView.kt", m14700l = {82}, m14699m = "invokeSuspend")
/* loaded from: classes5.dex */
public final class APNGView$fetchAPNG$1 extends AbstractC9643k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((APNGView$fetchAPNG$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f25780a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C34131 r1 = new C34131(this.this$0, this.$config);
            this.label = 1;
    ...
    /* loaded from: classes5.dex */
    public static final class C34131<T> implements FlowCollector {
        final /* synthetic */ APNGView.Config $config;
        final /* synthetic */ APNGView this$0;

        /* JADX INFO: Access modifiers changed from: package-private */
        @Metadata(m15074d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, m15073d2 = {"Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, m15072k = 3, m15071mv = {1, 8, 0})
        @AbstractC9636e(m14702c = "com.discord.image.animated_image.apng.APNGView$fetchAPNG$1$1$1", m14701f = "APNGView.kt", m14700l = {}, m14699m = "invokeSuspend")
        /* renamed from: com.discord.image.animated_image.apng.APNGView$fetchAPNG$1$1$1 */
        /* loaded from: classes5.dex */
        public static final class C34141 extends AbstractC9643k implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
            final /* synthetic */ APNGView.Config $config;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C34141(APNGView aPNGView, ApngDrawable apngDrawable, APNGView.Config config, Continuation<? super C34141> continuation) {
                super(2, continuation);
                this.this$0 = aPNGView;
            ...
            @Override // kotlin.coroutines.jvm.internal.AbstractC9632a
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C34141(this.this$0, this.$drawable, this.$config, continuation);
            }

            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
                return ((C34141) create(coroutineScope, continuation)).invokeSuspend(Unit.f25780a);
            }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Metadata(m15074d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, m15073d2 = {"Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, m15072k = 3, m15071mv = {1, 8, 0})
        @AbstractC9636e(m14702c = "com.discord.image.animated_image.apng.APNGView$fetchAPNG$1$1$2", m14701f = "APNGView.kt", m14700l = {}, m14699m = "invokeSuspend")
        /* renamed from: com.discord.image.animated_image.apng.APNGView$fetchAPNG$1$1$2 */
        /* loaded from: classes5.dex */
        public static final class C34152 extends AbstractC9643k implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
            int label;
            final /* synthetic */ APNGView this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C34152(APNGView aPNGView, Continuation<? super C34152> continuation) {
                super(2, continuation);
                this.this$0 = aPNGView;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.AbstractC9632a
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C34152(this.this$0, continuation);
            }

            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
                return ((C34152) create(coroutineScope, continuation)).invokeSuspend(Unit.f25780a);
            }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Metadata(m15074d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, m15073d2 = {"Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, m15072k = 3, m15071mv = {1, 8, 0})
        @AbstractC9636e(m14702c = "com.discord.image.animated_image.apng.APNGView$fetchAPNG$1$1$3", m14701f = "APNGView.kt", m14700l = {}, m14699m = "invokeSuspend")
        /* renamed from: com.discord.image.animated_image.apng.APNGView$fetchAPNG$1$1$3 */
        /* loaded from: classes5.dex */
        public static final class C34163 extends AbstractC9643k implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
            int label;
            final /* synthetic */ APNGView this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C34163(APNGView aPNGView, Continuation<? super C34163> continuation) {
                super(2, continuation);
                this.this$0 = aPNGView;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.AbstractC9632a
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C34163(this.this$0, continuation);
            }

            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
                return ((C34163) create(coroutineScope, continuation)).invokeSuspend(Unit.f25780a);
            }
        ...
        C34131(APNGView aPNGView, APNGView.Config config) {
            this.this$0 = aPNGView;
            this.$config = config;
        }
        ...
        */
        public final java.lang.Object emit(com.discord.file_downloader.DownloadState r14, kotlin.coroutines.Continuation<? super kotlin.Unit> r15) {
            ...
            L_0x0018:
                ...
                java.lang.Object r1 = tf.C12956b.m4650d()
                int r2 = r0.label
                r3 = 3
                r4 = 2
                r5 = 1
            ...
            L_0x003d:
                ...
                com.discord.image.animated_image.apng.APNGView$fetchAPNG$1$1 r14 = (com.discord.image.animated_image.apng.APNGView$fetchAPNG$1.C34131) r14
                nf.C10848t.m10930b(r15)     // Catch: Exception -> 0x0075
                goto L_0x00a6
            L_0x0045:
                nf.C10848t.m10930b(r15)
                boolean r15 = r14 instanceof com.discord.file_downloader.DownloadState.Completed
                if (r15 == 0) goto L_0x008b
                com.linecorp.apng.ApngDrawable$b r7 = com.linecorp.apng.ApngDrawable.f14738C     // Catch: Exception -> 0x0074
                ...
                r11 = 6
                r12 = 0
                com.linecorp.apng.ApngDrawable r14 = com.linecorp.apng.ApngDrawable.C5347b.m26480c(r7, r8, r9, r10, r11, r12)     // Catch: Exception -> 0x0074
                kotlinx.coroutines.f2 r15 = kotlinx.coroutines.C9946y0.m13945c()     // Catch: Exception -> 0x0074
                ...
                java.lang.Object r14 = kotlinx.coroutines.C9840j.m14192g(r15, r2, r0)     // Catch: Exception -> 0x0074
                if (r14 != r1) goto L_0x00a6
                return r1
            L_0x0074:
                r14 = r13
            L_0x0075:
                kotlinx.coroutines.f2 r15 = kotlinx.coroutines.C9946y0.m13945c()
                ...
                r0.L$0 = r6
                r0.label = r4
                java.lang.Object r14 = kotlinx.coroutines.C9840j.m14192g(r15, r2, r0)
                if (r14 != r1) goto L_0x00a6
                return r1
            L_0x008b:
                boolean r14 = r14 instanceof com.discord.file_downloader.DownloadState.Failure
                if (r14 == 0) goto L_0x00a6
                kotlinx.coroutines.f2 r14 = kotlinx.coroutines.C9946y0.m13945c()
                ...
                r15.<init>(r2, r6)
                r0.label = r3
                java.lang.Object r14 = kotlinx.coroutines.C9840j.m14192g(r14, r15, r0)
                if (r14 != r1) goto L_0x00a3
                return r1
            L_0x00a3:
                kotlin.Unit r14 = kotlin.Unit.f25780a
                return r14
            L_0x00a6:
                kotlin.Unit r14 = kotlin.Unit.f25780a
                return r14
            */
            throw new UnsupportedOperationException("Method not decompiled: com.discord.image.animated_image.apng.APNGView$fetchAPNG$1.C34131.emit(com.discord.file_downloader.DownloadState, kotlin.coroutines.Continuation):java.lang.Object");
        }
