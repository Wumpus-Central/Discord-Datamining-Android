...
public final class GradientPostprocessor extends BasePostprocessor {
    ...
    public static final class Companion {
        ...
        private static final class Point {
            ...
            public boolean equals(Object obj) {
                ...
                return Float.compare(this.f7446x, point.f7446x) == 0 && Float.compare(this.f7447y, point.f7447y) == 0;
            }
            ...
            public int hashCode() {
                return (Float.floatToIntBits(this.f7446x) * 31) + Float.floatToIntBits(this.f7447y);
            }

            public String toString() {
                float f = this.f7446x;
                float f2 = this.f7447y;
    ...
    public GradientPostprocessor(PostProcessor.Gradient gradient) {
        C9971q.m14633g(gradient, "gradient");
    ...
    public void process(Bitmap bitmap) {
        ...
        if (i == 1) {
            pair = C11098x.m10921a(new Companion.Point(0.0f, bitmap.getHeight() / 2.0f), new Companion.Point(bitmap.getWidth(), bitmap.getHeight() / 2.0f));
        } else if (i == 2) {
            pair = C11098x.m10921a(new Companion.Point(bitmap.getWidth(), bitmap.getHeight() / 2.0f), new Companion.Point(0.0f, bitmap.getHeight() / 2.0f));
        } else if (i == 3) {
            pair = C11098x.m10921a(new Companion.Point(bitmap.getWidth() / 2.0f, 0.0f), new Companion.Point(bitmap.getWidth() / 2.0f, bitmap.getHeight()));
        } else if (i == 4) {
            pair = C11098x.m10921a(new Companion.Point(bitmap.getWidth() / 2.0f, bitmap.getHeight()), new Companion.Point(bitmap.getWidth() / 2.0f, 0.0f));
        } else {
            throw new C11088q();
        }
