...
public final class Replay {
    ...
    public /* synthetic */ Replay(int i, String str, long j, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, Replay$$serializer.INSTANCE.getDescriptor());
        }
        this.filename = str;
        this.lastModified = j;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.filename, replay.filename) && this.lastModified == replay.lastModified;
    }
    ...
    public int hashCode() {
        return (this.filename.hashCode() * 31) + C2968a.m32873a(this.lastModified);
    }
