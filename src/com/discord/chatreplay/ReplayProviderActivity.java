...
public final class ReplayProviderActivity extends Activity {
    ...
    public static final class Companion {
        ...
        public final List<Replay> getReplaysListFromIntent(Intent intent) {
            ...
            C9971q.m14636d(stringExtra);
            Json.C10266a aVar = Json.f22543d;
            aVar.mo611a();
            return (List) aVar.mo578b(new C3643f(Replay$$serializer.INSTANCE), stringExtra);
        }
        ...
        public final void requestUriPermission(Activity activity, String replayFilename, int i) {
            C9971q.m14633g(activity, "activity");
            C9971q.m14633g(replayFilename, "replayFilename");
            Intent intent = new Intent();
    ...
    private final Uri grantAccessToFile(String str, File file) {
        ...
        C9971q.m14634f(fileContentUri, "fileContentUri");
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (C9971q.m14638b(getIntent().getAction(), "com.discord.GET_REPLAY_LIST")) {
            List<Replay> replaysList = getReplaysList();
            Intent intent = new Intent();
            Json.C10266a aVar = Json.f22543d;
            aVar.mo611a();
            intent.putExtra(INTENT_EXTRA_REPLAYS_LIST, aVar.mo577c(new C3643f(Replay$$serializer.INSTANCE), replaysList));
            setResult(-1, intent);
            finish();
        } else if (C9971q.m14638b(getIntent().getAction(), "com.discord.REQUEST_REPLAY_ACCESS")) {
            Uri data = getIntent().getData();
            C9971q.m14636d(data);
            String queryParameter = data.getQueryParameter(TouchesHelper.TARGET_KEY);
            C9971q.m14636d(queryParameter);
            Uri data2 = getIntent().getData();
            C9971q.m14636d(data2);
            String queryParameter2 = data2.getQueryParameter("toPackage");
            C9971q.m14636d(queryParameter2);
