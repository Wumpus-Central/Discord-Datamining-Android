...
final class DebugRowLogger$writeJson$1$1 extends AbstractC9973s implements Function1<String, Unit> {
    ...
    public final void invoke2(String line) {
        ...
        if (this.$existingLine.f22067k) {
            this.$writer.write(",\n");
        }
        this.$writer.write(line);
        this.$existingLine.f22067k = true;
    }
}
