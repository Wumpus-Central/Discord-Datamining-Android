...
public final class DebugRowLogger implements RowLogger {
    ...
    public DebugRowLogger(Path logsFolderPath, int i) {
        C9971q.m14633g(logsFolderPath, "logsFolderPath");
    ...
    private final void appendLine(String str) {
        boolean w;
        w = C12718u.m5729w(str);
        if (!w) {
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(DebugRowLoggerKt.outputStream(this.replayFile, true), C12694d.f28536b);
            try {
                outputStreamWriter.write(str + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
                outputStreamWriter.flush();
                Unit unit = Unit.f22042a;
                C14082c.m1713a(outputStreamWriter, null);
                writeJson();
            } catch (Throwable th2) {
                try {
                    throw th2;
                } catch (Throwable th3) {
                    C14082c.m1713a(outputStreamWriter, th2);
                    throw th3;
                }
            }
        }
    ...
    private final void writeJson() {
        ...
        try {
            ...
            C14103q.m1670c(new InputStreamReader(new FileInputStream(this.replayFile), charset), new DebugRowLogger$writeJson$1$1(ref$BooleanRef, outputStreamWriter));
            outputStreamWriter.write("\n]");
            outputStreamWriter.flush();
            Unit unit = Unit.f22042a;
            th = null;
