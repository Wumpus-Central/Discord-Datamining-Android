...
public final class CrashReportingModule extends ReactContextBaseJavaModule {
    private final ReactEvents reactEvents = new ReactEvents(C10853x.m10921a("DCDCrashlyticsCrashReports", C9656f0.m14684b(CrashReportEvent.class)));
    ...
    public final void addListener(String type) {
        ...
        if (C9677q.m14638b(CrashReporting.INSTANCE.isCrashedLastRun(), Boolean.TRUE)) {
