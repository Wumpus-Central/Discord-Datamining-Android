...
public final class CrashReportEvent implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.crashedLastRun, crashReportEvent.crashedLastRun) && C9971q.m14638b(this.reason, crashReportEvent.reason) && C9971q.m14638b(this.tombstone, crashReportEvent.tombstone);
    }
    ...
    public WritableMap serialize() {
        ...
        if (tombstone != null) {
            ...
            m = C6884j.m23951m(new IntRange(0, RNCWebViewManager.COMMAND_CLEAR_FORM_DATA), AbstractC4002c.f6576k);
            if (m == 0) {
                w = C12718u.m5729w(tombstone.getText());
                if (!w) {
                    a1 = C12724x.m5652a1(tombstone.getText(), 6291456);
                    writableNativeMap.putString("tombstone", a1);
                }
            }
        }
        return NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("reports", NativeArrayExtensionsKt.nativeArrayOf(writableNativeMap)));
    }
