    ...
    */
    public final void processLogs$crash_reporting_release(java.io.BufferedReader r10, java.util.LinkedList<java.lang.String> r11, kotlin.text.Regex r12) {
        ...
        L_0x0017:
            ...
            kotlin.text.MatchResult r3 = kotlin.text.Regex.m14587c(r12, r3, r0, r5, r4)     // Catch: Exception -> 0x0079
            if (r3 != 0) goto L_0x0023
            goto L_0x000c
        L_0x0023:
            java.util.List r3 = r3.mo5841b()     // Catch: Exception -> 0x0079
    ...
    public final Tombstone fetchLastTombstone(Collection<String> collection) {
        ...
        for (Object obj : y) {
            if (!e.contains((String) obj)) {
                ...
                return new Tombstone(sb3, str2, w3, str, hashString(w3), hashString(sb3));
            }
        }
