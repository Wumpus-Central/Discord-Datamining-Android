...
public final class SystemLogReport$reportLastCrash$1 extends AbstractC9679s implements Function1<SystemLogUtils.Tombstone, Unit> {
    ...
    public final void invoke2(SystemLogUtils.Tombstone tombstone) {
        ...
        if (tombstone != null) {
            ...
            z0 = C12588v.m5660z0(tombstone.getText(), new String[]{ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE}, false, 0, 6, null);
            for (String str : z0) {
