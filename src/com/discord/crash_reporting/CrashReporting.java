...
import io.sentry.AbstractC8324b2;
import io.sentry.C8360d;
import io.sentry.C8432k2;
import io.sentry.C8468o3;
import io.sentry.EnumC8459n3;
import io.sentry.Scope;
import io.sentry.android.core.C8219b1;
...
public final class CrashReporting {
    ...
    public static final void captureMessage$lambda$1(String tag, String message, ErrorLevel errorLevel, Scope SentryScope) {
        ...
        C9677q.m14633g(errorLevel, "$errorLevel");
        C9677q.m14633g(SentryScope, "SentryScope");
        d = C9609i.m14825d(tag);
        SentryScope.m18372v(d);
        int i = WhenMappings.$EnumSwitchMapping$0[errorLevel.ordinal()];
        if (i == 1) {
            n3Var = EnumC8459n3.INFO;
        } else if (i == 2) {
            n3Var = EnumC8459n3.WARNING;
        } else {
            throw new C10843q();
        }
        C8432k2.m17706h(message, n3Var);
    }
    ...
    public static final void init$lambda$0(Context context, SentryAndroidOptions options) {
        ...
        options.setRelease("discord_android@177.6.0-2+177206");
        ...
        options.setProguardUuid("c8b10141-a50b-43da-90b2-8bce0da1f869");
    ...
    public final void addBreadcrumb(String breadcrumbMessage, Map<String, String> breadcrumbData, String str) {
        C9677q.m14633g(breadcrumbMessage, "breadcrumbMessage");
        C9677q.m14633g(breadcrumbData, "breadcrumbData");
        C8360d dVar = new C8360d(breadcrumbMessage);
    ...
    public final void captureMessage(final String tag, final String message, final ErrorLevel errorLevel) {
        ...
        C8432k2.m17690x(new AbstractC8324b2() { // from class: com.discord.crash_reporting.b
            @Override // io.sentry.AbstractC8324b2
            /* renamed from: a */
    ...
    public final double getTracingSampleRate() {
        boolean M;
        M = C12588v.m5709M(ClientInfo.INSTANCE.getReleaseChannel(), BuildConfig.FLAVOR, false, 2, null);
        return M ? 0.05d : 0.0d;
    }
    ...
    public final void init(final Context context) {
        ...
        if (!z) {
            if (isProductionChannel()) {
                ...
                C9677q.m14634f(DEVICE, "DEVICE");
                M = C12588v.m5709M(DEVICE, "vivo", false, 2, null);
                if (M) {
                    return;
                }
            }
            C8219b1.m18330f(context, new C8432k2.AbstractC8433a() { // from class: com.discord.crash_reporting.a
                @Override // io.sentry.C8432k2.AbstractC8433a
                /* renamed from: a */
                public final void mo17168a(C8468o3 o3Var) {
                    CrashReporting.init$lambda$0(context, (SentryAndroidOptions) o3Var);
                }
            });
            isCrashedLastRun = C8432k2.m17697q();
        }
    }
    ...
    public final boolean isProductionChannel() {
        ...
        boolean M2;
        ClientInfo clientInfo = ClientInfo.INSTANCE;
        M = C12588v.m5709M(clientInfo.getReleaseChannel(), "beta", false, 2, null);
        if (M) {
            return false;
        }
        M2 = C12588v.m5709M(clientInfo.getReleaseChannel(), BuildConfig.FLAVOR, false, 2, null);
        return !M2;
    }
