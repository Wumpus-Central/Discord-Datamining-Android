...
public final class ClientInfo {
    ...
    public static final String proguardUUID = "0bd9f430-9d85-48d5-862f-cb6473a3a58a";
    public static final String sentryDsn = "https://70545531dfe34835bf4dd0996821e8b6@o64374.ingest.sentry.io/5992375";
    public static final String sentryRelease = "discord_android@177.5.0-2+177205";
    ...
    public final String getOtaManifestETag() {
        ...
        C9971q.m14615y("otaManifestETag");
        return null;
    }
    ...
    public final String getReleaseChannel() {
        ...
        String str2 = null;
        if (str == null) {
            C9971q.m14615y("flavor");
            str = null;
        }
        String str3 = buildType;
        if (str3 == null) {
            C9971q.m14615y("buildType");
        } else {
            str2 = str3;
        }
        if (str2.length() > 0) {
    ...
    public final void init(Context context, String versionName2, int i, String flavor2, String buildType2, String otaManifest, String otaVersion2) {
        ...
        C9971q.m14633g(versionName2, "versionName");
        C9971q.m14633g(flavor2, "flavor");
        C9971q.m14633g(buildType2, "buildType");
        C9971q.m14633g(otaManifest, "otaManifest");
        C9971q.m14633g(otaVersion2, "otaVersion");
        ...
        C9971q.m14634f(packageName2, "context.packageName");
    ...
    public final boolean isDebugBuild() {
        ...
        return C9971q.m14638b(str, BuildConfig.BUILD_TYPE);
    }
    ...
    public final boolean isDeveloperBuild() {
        ...
        return C9971q.m14638b(str, "developer");
    }
