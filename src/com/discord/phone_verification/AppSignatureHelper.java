...
public final class AppSignatureHelper extends ContextWrapper {
    ...
    public static final class Companion {
        ...
        public final String hash(String str, String str2) {
            ...
            try {
                ...
                C9677q.m14634f(instance, "getInstance(HASH_TYPE)");
                instance.update(C7188f.m21574a(str + " " + str2));
                byte[] digest = instance.digest();
                C9677q.m14634f(digest, "messageDigest.digest()");
                i = C9601e.m14986i(digest, 0, 9);
                String encodeToString = Base64.encodeToString(i, 3);
                C9677q.m14634f(encodeToString, "encodeToString(hashSigna…ADDING or Base64.NO_WRAP)");
                String substring = encodeToString.substring(0, 11);
                C9677q.m14634f(substring, "this as java.lang.String…ing(startIndex, endIndex)");
    ...
    static {
        ...
        C9677q.m14634f(simpleName, "AppSignatureHelper::class.java.simpleName");
        TAG = simpleName;
    }
    ...
    public AppSignatureHelper(Context context) {
        super(context);
        Lazy a;
        a = C10839n.m10945a(new AppSignatureHelper$appSignatures$2(this));
