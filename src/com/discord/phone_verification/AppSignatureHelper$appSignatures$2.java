...
final class AppSignatureHelper$appSignatures$2 extends AbstractC9679s implements Function0<List<String>> {
    ...
    public final List<String> invoke() {
        ...
        try {
            ...
            C9677q.m14634f(apkContentsSigners, "packageManager.getPackag…ngInfo.apkContentsSigners");
            ArrayList arrayList2 = new ArrayList();
            for (Signature signature : apkContentsSigners) {
                AppSignatureHelper.Companion companion = AppSignatureHelper.Companion;
                C9677q.m14634f(packageName, "packageName");
                String charsString = signature.toCharsString();
                C9677q.m14634f(charsString, "signature.toCharsString()");
