...
public final class StickerId implements SnowflakePrimitive {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001ø\u0001\u0000\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/primitives/StickerId$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/primitives/StickerId;", "primitives_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes3.dex */
    ...
    public static final class Creator implements Parcelable.Creator<StickerId> {
        ...
        public /* bridge */ /* synthetic */ StickerId createFromParcel(Parcel parcel) {
            return StickerId.m42140boximpl(m42152createFromParcelaEuejx8(parcel));
        }

        /* renamed from: createFromParcel-aEuejx8  reason: not valid java name */
        public final long m42152createFromParcelaEuejx8(Parcel parcel) {
            C9971q.m14633g(parcel, "parcel");
            return StickerId.m42141constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ StickerId m42140boximpl(long j) {
        return new StickerId(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m42141constructorimpl(long j) {
        return j;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static int m42142describeContentsimpl(long j) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m42143equalsimpl(long j, Object obj) {
        return (obj instanceof StickerId) && j == ((StickerId) obj).m42149unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m42144equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m42145hashCodeimpl(long j) {
        return C4081a.m32873a(j);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m42146isValidimpl(long j) {
        return j > 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m42147toStringimpl(long j) {
        return String.valueOf(j);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static void m42148writeToParcelimpl(long j, Parcel out, int i) {
    ...
    public int describeContents() {
        return m42142describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m42143equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m42145hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m42146isValidimpl(this.snowflake);
    }

    public String toString() {
        return m42147toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m42149unboximpl() {
        return this.snowflake;
    }
    ...
    public void writeToParcel(Parcel out, int i) {
        C9971q.m14633g(out, "out");
        m42148writeToParcelimpl(this.snowflake, out, i);
    }
}
