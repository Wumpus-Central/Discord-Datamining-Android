...
public final class ShareBroadcastReceiver extends BroadcastReceiver {
    ...
    private final ReactEvents reactEvents = new ReactEvents(C11098x.m10921a("share-broadcast-receiver-app-clicked", C9951f0.m14684b(ShareBroadcastReceiverAppClicked.class)));
    ...
    public static final class Companion {
        ...
        public final IntentSender getPendingIntentSender(Context context) {
            ...
            C9971q.m14634f(intentSender, "getBroadcast(\n          …           ).intentSender");
            return intentSender;
        }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (componentName != null) {
            ...
            C9971q.m14634f(packageName, "clickedComponent.packageName");
