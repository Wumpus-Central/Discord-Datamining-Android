...
@AbstractC9636e(m14702c = "com.discord.samsung.SamsungModule$finishSamsungAuthorization$1$1$1", m14701f = "SamsungModule.kt", m14700l = {}, m14699m = "invokeSuspend")
/* loaded from: classes6.dex */
final class SamsungModule$finishSamsungAuthorization$1$1$1 extends AbstractC9643k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SamsungModule$finishSamsungAuthorization$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f25780a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            k = C11053v.m10248k(C10853x.m10921a("state", this.$state), C10853x.m10921a("code", "{\"code\":\"" + str2 + "\"}"));
            ArrayList arrayList = new ArrayList(k.size());
            for (Map.Entry entry : k.entrySet()) {
                arrayList.add(((String) entry.getKey()) + "=" + ((String) entry.getValue()));
            }
            e0 = C9618r.m14760e0(arrayList, "&", null, null, 0, null, null, 62, null);
            this.this$0.handleSamsungCallback(this.$client.mo9954a(new Request.Builder().m9869h(RequestBody.Companion.m9862b(e0, MediaType.f29382g.m9980a("application/x-www-form-urlencoded"))).m9865l(queryParameter).m9875b()).execute());
