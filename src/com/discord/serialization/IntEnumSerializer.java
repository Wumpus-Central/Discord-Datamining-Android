...
public class IntEnumSerializer<T extends IntEnum> implements KSerializer<T> {
    ...
    public IntEnumSerializer(KClass<T> type, T t) {
        ...
        C9971q.m14636d(l);
        this.serialName = l;
        Object[] enumConstants = C14376a.m737b(type).getEnumConstants();
        C9971q.m14636d(enumConstants);
        ...
        this.descriptor = C1427g.m41131a(this.serialName, AbstractC1413e.C1418f.f468a);
        if (numArr.length == this.choices.length) {
            A = C9899f.m14972A(numArr);
    ...
    */
    public final T deserialize(kotlinx.serialization.encoding.Decoder r6) {
        /*
            ...
            int r0 = kotlin.collections.C9894b.m15040O(r0, r1)
            r1 = 1
            r2 = 0
            r3 = -1
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        O = C9899f.m14948O(this.choices, value);
        if (O != -1 || (t = this.f1default) == null) {
            if (O != -1) {
