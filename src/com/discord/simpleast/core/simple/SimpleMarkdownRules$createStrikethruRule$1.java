...
final class SimpleMarkdownRules$createStrikethruRule$1 extends AbstractC9679s implements Function0<List<? extends CharacterStyle>> {
    ...
    public final List<? extends CharacterStyle> invoke() {
        ...
        d = C9609i.m14825d(new StrikethroughSpan());
        return d;
    }
}
