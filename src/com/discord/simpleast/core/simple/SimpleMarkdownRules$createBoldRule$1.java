...
final class SimpleMarkdownRules$createBoldRule$1 extends AbstractC9679s implements Function0<List<? extends CharacterStyle>> {
    ...
    public final List<? extends CharacterStyle> invoke() {
        ...
        d = C9609i.m14825d(new StyleSpan(1));
        return d;
    }
}
