...
final class SimpleMarkdownRules$createBoldRule$1 extends AbstractC9973s implements Function0<List<? extends CharacterStyle>> {
    ...
    public final List<? extends CharacterStyle> invoke() {
        ...
        d = C9905i.m14825d(new StyleSpan(1));
        return d;
    }
}
