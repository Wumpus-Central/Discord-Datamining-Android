...
public final class CodeStyleProviders<R> {
    ...
    public /* synthetic */ CodeStyleProviders(StyleNode.SpanProvider spanProvider, StyleNode.SpanProvider spanProvider2, StyleNode.SpanProvider spanProvider3, StyleNode.SpanProvider spanProvider4, StyleNode.SpanProvider spanProvider5, StyleNode.SpanProvider spanProvider6, StyleNode.SpanProvider spanProvider7, StyleNode.SpanProvider spanProvider8, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider, (i & 2) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider2, (i & 4) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider3, (i & 8) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider4, (i & 16) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider5, (i & 32) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider6, (i & 64) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider7, (i & 128) != 0 ? CodeStyleProvidersKt.emptyProvider() : spanProvider8);
    }
}
