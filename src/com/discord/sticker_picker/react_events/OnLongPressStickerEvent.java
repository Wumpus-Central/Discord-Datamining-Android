...
public final class OnLongPressStickerEvent implements ReactEvent {
    ...
    public /* synthetic */ OnLongPressStickerEvent(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, OnLongPressStickerEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.stickerId = str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnLongPressStickerEvent) && C9677q.m14638b(this.stickerId, ((OnLongPressStickerEvent) obj).stickerId);
    }
