...
public final class FileManagerModule extends NativeFileManagerSpec {
    ...
    private final CoroutineScope ioScope = C10135k0.m14187a(C10230y0.m13946b());
    ...
    public FileManagerModule(ReactApplicationContext reactContext) {
        ...
        C9971q.m14633g(reactContext, "reactContext");
        j = C11289v.m10249j(C11098x.m10921a("cache", getReactApplicationContext().getCacheDir().getAbsolutePath()), C11098x.m10921a("documents", getReactApplicationContext().getFilesDir().getAbsolutePath()));
        this.storageDirs = j;
    }
    ...
    public void fileExists(String path, Promise promise) {
        ...
        C10139l.m14174d(this.ioScope, null, null, new FileManagerModule$fileExists$1(promise, path, null), 3, null);
    }
    ...
    public void getSize(String uri, Promise promise) {
        ...
        C9971q.m14633g(promise, "promise");
        C10139l.m14174d(this.ioScope, null, null, new FileManagerModule$getSize$1(this, uri, promise, null), 3, null);
    }
    ...
    protected Map<String, Object> getTypedExportedConstants() {
        ...
        C9971q.m14636d(str);
        l = C11289v.m10247l(C11098x.m10921a("DocumentsDirPath", str));
        return l;
    }

    public final InputStream openRawResource(String assetUri) {
        C9971q.m14633g(assetUri, "assetUri");
        ...
        C9971q.m14634f(openRawResource, "reactApplicationContext.…urces.openRawResource(id)");
    ...
    public void readAsset(String assetUri, String encoding, Promise promise) {
        C9971q.m14633g(assetUri, "assetUri");
        C9971q.m14633g(encoding, "encoding");
        C9971q.m14633g(promise, "promise");
        C10139l.m14174d(this.ioScope, null, null, new FileManagerModule$readAsset$1(assetUri, this, encoding, promise, null), 3, null);
    }
    ...
    public void readFile(String path, String encoding, Promise promise) {
        ...
        C9971q.m14633g(encoding, "encoding");
        C9971q.m14633g(promise, "promise");
        C10139l.m14174d(this.ioScope, null, null, new FileManagerModule$readFile$1(path, encoding, promise, null), 3, null);
    }
    ...
    public void saveFileToGallery(String uri, String fileName, String fileType, Promise promise) {
        ...
        C9971q.m14633g(fileType, "fileType");
        C9971q.m14633g(promise, "promise");
        ...
        if (decodeStream != null) {
            ...
            try {
                ...
                if (C9971q.m14638b(fileType, "PNG")) {
                    decodeStream.compress(Bitmap.CompressFormat.PNG, 100, fileOutputStream);
                } else if (C9971q.m14638b(fileType, "JPEG")) {
    ...
    public void writeFile(String storageDir, String path, String data, String encoding, Promise promise) {
        C9971q.m14633g(storageDir, "storageDir");
        C9971q.m14633g(path, "path");
        C9971q.m14633g(data, "data");
        C9971q.m14633g(encoding, "encoding");
        C9971q.m14633g(promise, "promise");
        C10139l.m14174d(this.ioScope, null, null, new FileManagerModule$writeFile$1(this, storageDir, promise, path, encoding, data, null), 3, null);
    }
}
