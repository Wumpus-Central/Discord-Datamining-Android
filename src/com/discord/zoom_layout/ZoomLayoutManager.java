...
public final class ZoomLayoutManager extends ViewGroupManager<ZoomLayoutFixed> {
    ...
    private final ReactEvents reactEvents = new ReactEvents(C11098x.m10921a("onZoomChanged", C9951f0.m14684b(OnZoomChangedEvent.class)));
    ...
    public ZoomLayoutFixed createViewInstance(ThemedReactContext reactContext) {
        ...
        zoomLayoutFixed.getEngine().m26291l(new ZoomEngine.AbstractC6097c() { // from class: com.discord.zoom_layout.ZoomLayoutManager$createViewInstance$1$1
    ...
    public HashMap<String, Integer> getCommandsMap() {
        ...
        j = C11289v.m10249j(C11098x.m10921a("zoomTo", 0), C11098x.m10921a("unzoom", 1));
        return j;
    }

    public void receiveCommand(ZoomLayoutFixed zoomLayout, int i, ReadableArray readableArray) {
        C9971q.m14633g(zoomLayout, "zoomLayout");
        if (i != 0) {
            if (i == 1) {
