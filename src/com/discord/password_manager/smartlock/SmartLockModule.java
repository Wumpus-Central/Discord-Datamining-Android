...
public final class SmartLockModule extends ReactContextBaseJavaModule {
    ...
    static {
        ...
        C9971q.m14634f(simpleName, "SmartLockModule::class.java.simpleName");
        logTag = simpleName;
    }
    ...
    */
    public SmartLockModule(com.facebook.react.bridge.ReactApplicationContext r3) {
        /*
            ...
            com.google.android.gms.auth.api.credentials.CredentialsClient r3 = com.google.android.gms.auth.api.credentials.C5356b.m29172a(r3, r0)
    ...
    private final void requestCredentials() {
        C5355a a = new C5355a.C0149a().m29173c(true).m29174b(DISCORD_ACCOUNT_IDENTITY).m29175a();
        C9971q.m14634f(a, "Builder()\n            .s…ITY)\n            .build()");
        this.credentialsClient.m29186D(a).mo28871b(new AbstractC6424d() { // from class: com.discord.password_manager.smartlock.a
    ...
    public static final void requestCredentials$lambda$0(SmartLockModule this$0, Task task) {
        ...
        if (task.mo28858o()) {
            Credential c = ((C10760a) task.mo28862k()).m12369c();
            String str2 = null;
            if (c != null) {
                str = c.getId();
            } else {
            ...
            Credential c2 = ((C10760a) task.mo28862k()).m12369c();
            if (c2 != null) {
                str2 = c2.m29202B();
            }
            if (str != null) {
    ...
    public final void resolvePromiseWithCredentials(String str, String str2) {
        ...
        if (promise != null) {
            k = C11289v.m10248k(C11098x.m10921a("login", str), C11098x.m10921a("password", str2));
    ...
    public final void removeCredentials(String login) {
        C9971q.m14633g(login, "login");
        this.credentialsClient.m29187C(new Credential.C5353a(login).m29195a());
    }
    ...
    public final boolean updateAccountCredentials(String login, String password, String str, String str2) {
        ...
        Credential.C5353a aVar = new Credential.C5353a(login);
        if (str != null) {
            aVar.m29194b(str);
        }
        if (str2 != null) {
        ...
        C9971q.m14634f(a, "Builder(login).apply {\n …ssword)\n        }.build()");
        this.credentialsClient.m29185E(a).mo28871b(new AbstractC6424d() { // from class: com.discord.password_manager.smartlock.b
            @Override // p064db.AbstractC6424d
            /* renamed from: a */
            public final void mo4743a(Task task) {
