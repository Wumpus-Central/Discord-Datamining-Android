...
public final class NearbyHelperModule$manager$2 extends AbstractC9679s implements Function1<String, Unit> {
    final /* synthetic */ NearbyHelperModule this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NearbyHelperModule$manager$2(NearbyHelperModule nearbyHelperModule) {
        super(1);
