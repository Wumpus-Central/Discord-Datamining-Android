...
public final class OnNearbyMessageLostEvent implements ReactEvent {
    ...
    public /* synthetic */ OnNearbyMessageLostEvent(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, OnNearbyMessageLostEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.body = str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnNearbyMessageLostEvent) && C9971q.m14638b(this.body, ((OnNearbyMessageLostEvent) obj).body);
    }
