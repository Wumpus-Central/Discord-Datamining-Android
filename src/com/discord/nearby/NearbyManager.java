...
import p443ya.AbstractC14254b;
import p443ya.AbstractC14256d;
import p443ya.AbstractC14261h;
import p443ya.C14262i;
import va.C13386a;
...
public final class NearbyManager extends AbstractC14254b {
    ...
    private final NearbyManager$statusCallback$1 statusCallback = new AbstractC14261h() { // from class: com.discord.nearby.NearbyManager$statusCallback$1
        @Override // p443ya.AbstractC14261h
    ...
    public NearbyManager(Function1<? super String, Unit> onFoundUser, Function1<? super String, Unit> onLostUser, Function1<? super String, Unit> onError) {
        C9677q.m14633g(onFoundUser, "onFoundUser");
        C9677q.m14633g(onLostUser, "onLostUser");
        C9677q.m14633g(onError, "onError");
        this.onFoundUser = onFoundUser;
        this.onLostUser = onLostUser;
        this.onError = onError;
        SubscribeOptions a = new SubscribeOptions.C4753a().m28930b(C14262i.f36924s).m28931a();
    ...
    public final void disableNearby(Context context) {
        ...
        AbstractC14256d a = C13386a.m3605a(context);
        a.mo825g(this.statusCallback);
        Message message = this.outboundMessage;
        if (message == null) {
            C9677q.m14615y("outboundMessage");
            message = null;
        }
        a.mo827d(message);
        a.mo826e(this);
    ...
    public final void setOutboundMessage(String message) {
        C9677q.m14633g(message, "message");
        byte[] bytes = message.getBytes(C12563d.f32852b);
