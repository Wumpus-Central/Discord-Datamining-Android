...
import com.budiyev.android.codescanner.AbstractC4176d;
import com.budiyev.android.codescanner.AbstractC4183h;
...
public final class QRScanner extends FrameLayout implements AbstractC4176d, AbstractC4183h {
    ...
    @Override // com.budiyev.android.codescanner.AbstractC4176d
    ...
    @Override // com.budiyev.android.codescanner.AbstractC4183h
    public void onError(Throwable thrown) {
        C9971q.m14633g(thrown, "thrown");
    ...
    public QRScanner(Context context, AttributeSet attributeSet, int i) {
        ...
        C9971q.m14634f(codeScannerView, "binding.qrScanner");
        codeScannerView.setVisibility(0);
        inflate.qrScanner.setFrameColor(ColorUtilsKt.getColorCompat(context, C4638R.color.brand));
        codeScanner.m32489a0(-1);
        codeScanner.m32479f0(CodeScanner.f35919K);
