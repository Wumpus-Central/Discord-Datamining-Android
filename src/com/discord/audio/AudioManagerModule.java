...
public final class AudioManagerModule extends ReactContextBaseJavaModule {
    ...
    public final void setAudioManager(DiscordAudioManager discordAudioManager) {
        C9971q.m14633g(discordAudioManager, "<set-?>");
