...
public final class SoundExtensionsKt {
    public static final void fetchSound(Context context, String url, SoundManager soundManager, int i, int i2, Function1<? super Integer, Unit> soundResIdPrepared) {
        ...
        C9971q.m14633g(soundManager, "soundManager");
        C9971q.m14633g(soundResIdPrepared, "soundResIdPrepared");
        tryPruneSoundsCache(context);
        C10129j.m14195d(C10135k0.m14186b(), C10230y0.m13946b(), null, new SoundExtensionsKt$fetchSound$1(context, url, getRemoteSoundFilename(url), getSoundsCacheDirectory(context), soundManager, i, i2, soundResIdPrepared, null), 2, null);
    }
    ...
    public static final void tryPruneSoundsCache(Context context) {
        ...
        if (listFiles != null && listFiles.length >= 20) {
            C9897e.m14977r(listFiles, new Comparator() { // from class: com.discord.sounds.utils.SoundExtensionsKt$tryPruneSoundsCache$$inlined$compareByDescending$1
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
                    int d;
                    d = C12120c.m7778d(Long.valueOf(((File) t2).lastModified()), Long.valueOf(((File) t).lastModified()));
                    return d;
                }
            });
            d0 = C9899f.m14933d0(listFiles);
            File file = (File) d0;
            if (file != null) {
                file.delete();
            }
