...
public final class SoundPlayer {
    ...
    @Metadata(m15074d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J3\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\n\b\u0001\u0010\t\u001a\u0004\u0018\u00010\b2\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0002¢\u0006\u0002\u0010\f¨\u0006\r"}, m15073d2 = {"Lcom/discord/sounds/SoundPlayer$Companion;", "", "()V", "createMediaPlayer", "Landroid/media/MediaPlayer;", "context", "Landroid/content/Context;", "usage", "", "soundResId", "filePath", "", "(Landroid/content/Context;ILjava/lang/Integer;Ljava/lang/String;)Landroid/media/MediaPlayer;", "sounds_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes7.dex */
        ...
        public final MediaPlayer createMediaPlayer(Context context, int i, Integer num, String str) {
            ...
            if (str != null) {
                try {
                    ...
                    Log.INSTANCE.m32175w(SoundManager.Companion.getLogTag(), "Failed to set sound.", e);
                }
            }
            return mediaPlayer;
        }
    ...
    public SoundPlayer(MediaPlayer mediaPlayer, Function1<? super Integer, Unit> soundResIdPrepared) {
        C9971q.m14633g(soundResIdPrepared, "soundResIdPrepared");
    ...
    public final void pause() {
        try {
            ...
            Log.INSTANCE.m32175w(SoundManager.Companion.getLogTag(), "Failed to pause.", e);
        }
    }
    ...
    public final void play() {
        try {
            ...
            Log.INSTANCE.m32175w(SoundManager.Companion.getLogTag(), "Failed to start.", e);
        }
    }
    ...
    public final void setCurrentTime(int i) {
        try {
            ...
            Log.INSTANCE.m32175w(SoundManager.Companion.getLogTag(), "Failed to seek to.", e);
        }
    }
    ...
    public final void setPan(float f) {
        ...
        try {
            ...
            Log.INSTANCE.m32175w(SoundManager.Companion.getLogTag(), "Failed to pan.", e);
        }
    }
    ...
    public final void setVolume(float f) {
        try {
            ...
            Log.INSTANCE.m32175w(SoundManager.Companion.getLogTag(), "Failed to set volume.", e);
        }
    }
    ...
    public final void stop() {
        try {
            ...
            Log.INSTANCE.m32175w(SoundManager.Companion.getLogTag(), "Failed to stop.", e);
        }
    }
