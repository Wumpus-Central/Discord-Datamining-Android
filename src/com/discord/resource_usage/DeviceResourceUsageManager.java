...
public final class DeviceResourceUsageManager {
    ...
    static {
        ...
        try {
            ...
            l = C11090s.m10940b(Long.valueOf(Os.sysconf(OsConstants._SC_CLK_TCK)));
        } catch (Throwable th2) {
            C11090s.C11091a aVar2 = C11090s.f24606l;
            l = C11090s.m10940b(C11093t.m10931a(th2));
        }
        if (C11090s.m10935g(l)) {
            l = 100L;
        }
        SC_CLK_TCK = ((Number) l).longValue();
        try {
            l2 = C11090s.m10940b(Long.valueOf(Os.sysconf(OsConstants._SC_PAGE_SIZE)));
        } catch (Throwable th3) {
            C11090s.C11091a aVar3 = C11090s.f24606l;
            l2 = C11090s.m10940b(C11093t.m10931a(th3));
        }
        if (C11090s.m10935g(l2)) {
            l2 = 4096L;
        }
        SC_PAGE_SIZE = ((Number) l2).longValue();
        try {
            num = C11090s.m10940b(Integer.valueOf(Runtime.getRuntime().availableProcessors()));
        } catch (Throwable th4) {
            C11090s.C11091a aVar4 = C11090s.f24606l;
            num = C11090s.m10940b(C11093t.m10931a(th4));
        }
        if (C11090s.m10935g(num)) {
            num = 1;
        }
    ...
    public final void start() {
        ...
        synchronized (this.threadSync) {
            thread = this.thread;
            Thread b = C12581a.m6476b(true, true, null, "DeviceResourceUsageMonitor", 2, new DeviceResourceUsageManager$start$oldThread$1$thread$1(this), 4, null);
