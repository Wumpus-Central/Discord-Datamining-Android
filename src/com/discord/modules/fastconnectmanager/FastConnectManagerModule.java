...
public final class FastConnectManagerModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, String> getConstants() {
        ...
        l = C11289v.m10247l(C11098x.m10921a("clientState", companion.get(reactApplicationContext).getItem("_clientStateKey")), C11098x.m10921a("userId", companion.get(reactApplicationContext2).getItem("_userIdKey")), C11098x.m10921a("token", CacheModule.getToken$default(companion.get(reactApplicationContext3), false, 1, null)));
        return l;
    }
