...
public final class TimerEvent$$serializer implements AbstractC3644f0<TimerEvent> {
    ...
    public TimerEvent deserialize(Decoder decoder) {
        ...
        return new TimerEvent(i2, i, null);
    }
    ...
    public void serialize(Encoder encoder, TimerEvent value) {
        ...
        TimerEvent.write$Self(value, b, descriptor2);
