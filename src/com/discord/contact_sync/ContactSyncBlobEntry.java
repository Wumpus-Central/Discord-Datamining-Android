...
public final class ContactSyncBlobEntry {
    ...
    public /* synthetic */ ContactSyncBlobEntry(int i, String str, String str2, boolean z, String str3, String str4, String str5, SerializationConstructorMarker serializationConstructorMarker) {
        if (63 != (i & 63)) {
            C3681n1.m33818b(i, 63, ContactSyncBlobEntry$$serializer.INSTANCE.getDescriptor());
        }
        this.phone = str;
    ...
    public final ContactSyncBlobEntry copy(String phone, String unencryptedName, boolean z, String deviceContactId, String givenName, String familyName) {
        C9971q.m14633g(phone, "phone");
        C9971q.m14633g(unencryptedName, "unencryptedName");
        C9971q.m14633g(deviceContactId, "deviceContactId");
        C9971q.m14633g(givenName, "givenName");
        C9971q.m14633g(familyName, "familyName");
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.phone, contactSyncBlobEntry.phone) && C9971q.m14638b(this.unencryptedName, contactSyncBlobEntry.unencryptedName) && this.hasImageData == contactSyncBlobEntry.hasImageData && C9971q.m14638b(this.deviceContactId, contactSyncBlobEntry.deviceContactId) && C9971q.m14638b(this.givenName, contactSyncBlobEntry.givenName) && C9971q.m14638b(this.familyName, contactSyncBlobEntry.familyName);
    }
