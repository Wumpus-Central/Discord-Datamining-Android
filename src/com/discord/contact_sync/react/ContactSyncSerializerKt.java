...
public final class ContactSyncSerializerKt {
    ...
    public static final void serializeSyncContactResult(ReactContext reactContext, Callback callback) {
        ...
        try {
            ...
            aVar.mo611a();
            objArr[1] = aVar.mo577c(new C3695r0(C3622a2.f5917a, ContactSyncBlobEntry$$serializer.INSTANCE), contactsMap);
            Collection<ContactSyncBlobEntry> values = contactsMap.values();
            t = C9907k.m14809t(values, 10);
            ...
            aVar.mo611a();
            objArr[2] = aVar.mo577c(new C3643f(ContactSyncPayloadEntry$$serializer.INSTANCE), arrayList);
