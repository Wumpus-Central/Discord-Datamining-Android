...
public final class ValueChangeEvent implements ReactEvent {
    ...
    public /* synthetic */ ValueChangeEvent(int i, String str, int i2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, ValueChangeEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.value = str;
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.value, valueChangeEvent.value) && this.selectedSegmentIndex == valueChangeEvent.selectedSegmentIndex;
    }
