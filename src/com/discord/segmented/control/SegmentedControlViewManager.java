...
public final class SegmentedControlViewManager extends SimpleViewManager<SegmentedControlView> {
    private final ReactEvents reactEvents = new ReactEvents(C11098x.m10921a("onValueChange", C9951f0.m14684b(ValueChangeEvent.class)));
    ...
    public final void accessibilityRoleDescriptions(SegmentedControlView view, ReadableArray accessibilityRoleDescriptions) {
        ...
        C9971q.m14633g(accessibilityRoleDescriptions, "accessibilityRoleDescriptions");
        ...
        while (it.hasNext()) {
            String string = accessibilityRoleDescriptions.getString(((AbstractC11283p) it).nextInt());
            if (string != null) {
    ...
    public final void customSelectedTintColor(SegmentedControlView view, String customSelectedTintColor) {
        C9971q.m14633g(view, "view");
        C9971q.m14633g(customSelectedTintColor, "customSelectedTintColor");
    ...
    public final void setBackgroundColor(SegmentedControlView view, String backgroundColor) {
        C9971q.m14633g(view, "view");
        C9971q.m14633g(backgroundColor, "backgroundColor");
    ...
    public final void values(SegmentedControlView view, ReadableArray values) {
        ...
        Iterator<Integer> it = sizeRange.iterator();
        while (it.hasNext()) {
            String string = values.getString(((AbstractC11283p) it).nextInt());
            if (string != null) {
                arrayList.add(string);
            }
        }
