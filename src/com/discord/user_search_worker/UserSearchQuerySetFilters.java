...
public final class UserSearchQuerySetFilters {
    ...
    public /* synthetic */ UserSearchQuerySetFilters(int i, String str, Boolean bool, Boolean bool2, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, UserSearchQuerySetFilters$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.guild = null;
        } else {
    ...
    public static final void write$Self(UserSearchQuerySetFilters self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 0, C3622a2.f5917a, self.guild);
        }
        ...
        if (z2) {
            output.mo13874p(serialDesc, 1, C3652h.f5959a, self.friends);
        }
        if (output.mo13893A(serialDesc, 2) || self.strict != null) {
            z3 = true;
        }
        if (z3) {
            output.mo13874p(serialDesc, 2, C3652h.f5959a, self.strict);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.guild, userSearchQuerySetFilters.guild) && C9971q.m14638b(this.friends, userSearchQuerySetFilters.friends) && C9971q.m14638b(this.strict, userSearchQuerySetFilters.strict);
    }
