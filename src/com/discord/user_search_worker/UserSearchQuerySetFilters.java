...
public final class UserSearchQuerySetFilters {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/user_search_worker/UserSearchQuerySetFilters$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/user_search_worker/UserSearchQuerySetFilters;", "user_search_worker_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes7.dex */
    ...
    public /* synthetic */ UserSearchQuerySetFilters(int i, String str, Boolean bool, Boolean bool2, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 0) != 0) {
            C2560n1.m33818b(i, 0, UserSearchQuerySetFilters$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.guild = null;
        } else {
    ...
    public static final void write$Self(UserSearchQuerySetFilters self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z3 = false;
        if (!output.mo13893A(serialDesc, 0) && self.guild == null) {
            z = false;
        } else {
            z = true;
        }
        if (z) {
            output.mo13874p(serialDesc, 0, C2500a2.f6719a, self.guild);
        }
        if (!output.mo13893A(serialDesc, 1) && self.friends == null) {
            z2 = false;
        } else {
            z2 = true;
        }
        if (z2) {
            output.mo13874p(serialDesc, 1, C2530h.f6761a, self.friends);
        }
        if (output.mo13893A(serialDesc, 2) || self.strict != null) {
            z3 = true;
        }
        if (z3) {
            output.mo13874p(serialDesc, 2, C2530h.f6761a, self.strict);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.guild, userSearchQuerySetFilters.guild) && C9677q.m14638b(this.friends, userSearchQuerySetFilters.friends) && C9677q.m14638b(this.strict, userSearchQuerySetFilters.strict);
    }
