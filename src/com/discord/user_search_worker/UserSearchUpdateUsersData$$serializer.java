...
public final class UserSearchUpdateUsersData$$serializer implements AbstractC2522f0<UserSearchUpdateUsersData> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{new C2521f(UserSearchTransformedUser.Serializer.INSTANCE)};
    }
    ...
    public UserSearchUpdateUsersData deserialize(Decoder decoder) {
        ...
        int i = 1;
        if (b.mo13850p()) {
            obj = b.mo13847y(descriptor2, 0, new C2521f(UserSearchTransformedUser.Serializer.INSTANCE), null);
        } else {
            int i2 = 0;
            obj = null;
            while (i != 0) {
                ...
                if (o == -1) {
                    ...
                    obj = b.mo13847y(descriptor2, 0, new C2521f(UserSearchTransformedUser.Serializer.INSTANCE), obj);
                    i2 |= 1;
                } else {
                    throw new C14382n(o);
                }
