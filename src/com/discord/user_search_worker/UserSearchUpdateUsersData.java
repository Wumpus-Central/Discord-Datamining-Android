...
public final class UserSearchUpdateUsersData extends UserSearchData {
    ...
    public /* synthetic */ UserSearchUpdateUsersData(int i, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, UserSearchUpdateUsersData$$serializer.INSTANCE.getDescriptor());
        }
        this.payload = list;
    }
    ...
    public static final void write$Self(UserSearchUpdateUsersData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 0, new C2521f(UserSearchTransformedUser.Serializer.INSTANCE), self.payload);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UserSearchUpdateUsersData) && C9677q.m14638b(this.payload, ((UserSearchUpdateUsersData) obj).payload);
    }
