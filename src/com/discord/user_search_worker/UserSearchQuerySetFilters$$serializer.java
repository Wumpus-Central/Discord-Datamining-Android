...
public final class UserSearchQuerySetFilters$$serializer implements AbstractC2522f0<UserSearchQuerySetFilters> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14606a.m13u(C2500a2.f6719a), C14606a.m13u(hVar), C14606a.m13u(hVar)};
    }
    ...
    public UserSearchQuerySetFilters deserialize(Decoder decoder) {
        ...
        Object obj4 = null;
        if (b.mo13850p()) {
            obj3 = b.mo13852n(descriptor2, 0, C2500a2.f6719a, null);
            C2530h hVar = C2530h.f6761a;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj5 = b.mo13852n(descriptor2, 1, C2530h.f6761a, obj5);
                    i2 |= 2;
                } else if (o == 2) {
                    obj6 = b.mo13852n(descriptor2, 2, C2530h.f6761a, obj6);
                    i2 |= 4;
                } else {
                    throw new C14382n(o);
                }
