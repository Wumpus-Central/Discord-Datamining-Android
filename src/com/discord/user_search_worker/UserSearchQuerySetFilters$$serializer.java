...
public final class UserSearchQuerySetFilters$$serializer implements AbstractC3644f0<UserSearchQuerySetFilters> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m13841l("guild", true);
        pluginGeneratedSerialDescriptor.m13841l("friends", true);
        pluginGeneratedSerialDescriptor.m13841l("strict", true);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14667a.m13u(C3622a2.f5917a), C14667a.m13u(hVar), C14667a.m13u(hVar)};
    }
    ...
    public UserSearchQuerySetFilters deserialize(Decoder decoder) {
        ...
        Object obj4 = null;
        if (b.mo13850p()) {
            obj3 = b.mo13852n(descriptor2, 0, C3622a2.f5917a, null);
            C3652h hVar = C3652h.f5959a;
            obj = b.mo13852n(descriptor2, 1, hVar, null);
            obj2 = b.mo13852n(descriptor2, 2, hVar, null);
            i = 7;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj5 = b.mo13852n(descriptor2, 1, C3652h.f5959a, obj5);
                    i2 |= 2;
                } else if (o == 2) {
                    obj6 = b.mo13852n(descriptor2, 2, C3652h.f5959a, obj6);
                    i2 |= 4;
                } else {
                    throw new C14447n(o);
                }
    ...
    public void serialize(Encoder encoder, UserSearchQuerySetFilters value) {
        ...
        UserSearchQuerySetFilters.write$Self(value, b, descriptor2);
