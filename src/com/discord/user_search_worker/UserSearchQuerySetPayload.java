...
public final class UserSearchQuerySetPayload {
    ...
    public /* synthetic */ UserSearchQuerySetPayload(int i, String str, UserSearchQuerySetFilters userSearchQuerySetFilters, List list, List list2, Map map, int i2, SerializationConstructorMarker serializationConstructorMarker) {
        if (49 != (i & 49)) {
            C3681n1.m33818b(i, 49, UserSearchQuerySetPayload$$serializer.INSTANCE.getDescriptor());
        }
        this.query = str;
        if ((i & 2) == 0) {
            this.filters = null;
    ...
    public static final void write$Self(UserSearchQuerySetPayload self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z2) {
            output.mo13874p(serialDesc, 2, new C3643f(C3622a2.f5917a), self.blacklist);
        }
        if (output.mo13893A(serialDesc, 3) || self.whitelist != null) {
            z3 = true;
        }
        if (z3) {
            output.mo13874p(serialDesc, 3, new C3643f(C3622a2.f5917a), self.whitelist);
        }
        output.mo13870t(serialDesc, 4, new C3695r0(C3622a2.f5917a, C3712x.f6038a), self.boosters);
    ...
    public final UserSearchQuerySetPayload copy(String query, UserSearchQuerySetFilters userSearchQuerySetFilters, List<String> list, List<String> list2, Map<String, Double> boosters, int i) {
        ...
        C9971q.m14633g(boosters, "boosters");
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.query, userSearchQuerySetPayload.query) && C9971q.m14638b(this.filters, userSearchQuerySetPayload.filters) && C9971q.m14638b(this.blacklist, userSearchQuerySetPayload.blacklist) && C9971q.m14638b(this.whitelist, userSearchQuerySetPayload.whitelist) && C9971q.m14638b(this.boosters, userSearchQuerySetPayload.boosters) && this.limit == userSearchQuerySetPayload.limit;
    }
