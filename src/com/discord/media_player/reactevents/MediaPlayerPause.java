...
public final class MediaPlayerPause implements ReactEvent {
    ...
    public static final void write$Self(MediaPlayerPause self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13890D(serialDesc, 0, self.f7486id);
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7486id, mediaPlayerPause.f7486id) == 0 && this.paused == mediaPlayerPause.paused;
    }
    ...
    public int hashCode() {
        int doubleToLongBits = Double.doubleToLongBits(this.f7486id) * 31;
    ...
    public /* synthetic */ MediaPlayerPause(int i, double d, boolean z, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, MediaPlayerPause$$serializer.INSTANCE.getDescriptor());
        }
        this.f7486id = d;
        this.paused = z;
    }
