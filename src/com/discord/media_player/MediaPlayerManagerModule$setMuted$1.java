...
final class MediaPlayerManagerModule$setMuted$1 extends AbstractC9679s implements Function1<SimpleExoPlayer, Unit> {
    ...
    public final void invoke2(SimpleExoPlayer player) {
        C9677q.m14633g(player, "player");
        player.m30502d1(this.$muted ? 0.0f : 1.0f);
    }
}
