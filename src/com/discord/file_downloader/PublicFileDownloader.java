...
public final class PublicFileDownloader {
    ...
    @Metadata(m15074d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u001a\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0016¨\u0006\t"}, m15073d2 = {"Lcom/discord/file_downloader/PublicFileDownloader$PublicFileDownloadBroadcastReceiver;", "Landroid/content/BroadcastReceiver;", "()V", "onReceive", "", "context", "Landroid/content/Context;", "intent", "Landroid/content/Intent;", "file_downloader_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public final boolean onFileDownloaded(ProducerScope<? super DownloadState> producerScope, DownloadManager downloadManager, long j, String str) {
        try {
            if (downloadManager.query(new DownloadManager.Query().setFilterById(j)).moveToFirst()) {
                producerScope.mo3858d(new DownloadState.Completed(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), str)));
            } else {
                producerScope.mo3858d(new DownloadState.Failure(new IllegalStateException(new FileNotFoundException())));
            }
            th = null;
            return AbstractC13259x.C13260a.m3854a(producerScope, th, 1, th);
        } finally {
            try {
                throw th;
            } finally {
    ...
    public final Flow<DownloadState> downloadFile(Context context, String url, String fileName, String str) {
        ...
        return C9748d.m14432a(new PublicFileDownloader$downloadFile$1(context, url, fileName, str, null));
    }
}
