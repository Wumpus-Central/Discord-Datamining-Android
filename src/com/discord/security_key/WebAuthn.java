...
import p155ia.AbstractC8342i;
import p155ia.C8334f;
import p155ia.C8337g;
import p155ia.C8340h;
import p155ia.C8344j;
import p155ia.C8357o;
import p155ia.C8359p;
import p155ia.C8362q;
import p155ia.C8364r;
import p155ia.C8366s;
import p155ia.C8369t;
import p155ia.C8374v;
...
public final class WebAuthn {
    ...
    public WebAuthn(Function1<? super String, Unit> resolve, Function1<? super String, Unit> reject) {
        C9971q.m14633g(resolve, "resolve");
        C9971q.m14633g(reject, "reject");
    ...
    private final byte[] decodeBase64(String str) {
        ...
        C9971q.m14634f(decode, "decode(this, BASE64_FLAG)");
        return decode;
    }

    private final List<C8362q> parseCredentialDescriptors(JSONArray jSONArray) {
        IntRange q;
        ArrayList arrayList = new ArrayList();
        q = C6884j.m23947q(0, jSONArray.length());
        Iterator<Integer> it = q.iterator();
        while (it.hasNext()) {
            JSONObject jSONObject = jSONArray.getJSONObject(((AbstractC11283p) it).nextInt());
            String uVar = EnumC8371u.PUBLIC_KEY.toString();
            String string = jSONObject.getString("id");
            C9971q.m14634f(string, "obj.getString(\"id\")");
            arrayList.add(new C8362q(uVar, decodeBase64(string), null));
        }
        return arrayList;
    }
    ...
    private final String toBase64(byte[] bArr) {
        ...
        C9971q.m14634f(encodeToString, "encodeToString(this, BASE64_FLAG)");
        return encodeToString;
    }

    public final void authenticate(String challenge, Activity activity) {
        C9971q.m14633g(challenge, "challenge");
        C8366s.C8367a aVar = new C8366s.C8367a();
        ...
        C9971q.m14634f(string, "obj.getString(\"challenge\")");
        aVar.m19902c(decodeBase64(string));
        JSONArray jSONArray = jSONObject.getJSONArray("allowCredentials");
        C9971q.m14634f(jSONArray, "obj.getJSONArray(\"allowCredentials\")");
        ...
        Task<PendingIntent> D = C7572a.m21977a(activity).m20977D(aVar.m19904a());
        final WebAuthn$authenticate$1 webAuthn$authenticate$1 = new WebAuthn$authenticate$1(activity);
        D.mo28867f(new AbstractC6426f() { // from class: com.discord.security_key.c
        ...
        D.mo28869d(new AbstractC6425e() { // from class: com.discord.security_key.d
    ...
    public final void onActivityResult(int i, int i2, Intent intent) {
        ...
        C8357o p = C8357o.m19931p(bArr);
        if (p.m19928u() instanceof C8340h) {
            Function1<String, Unit> function1 = this.reject;
            AbstractC8342i u = p.m19928u();
            C9971q.m14635e(u, "null cannot be cast to non-null type com.google.android.gms.fido.fido2.api.common.AuthenticatorErrorResponse");
            String t = ((C8340h) u).m19943t();
            C9971q.m14636d(t);
            function1.invoke(t);
        } else if (i == 4001) {
            byte[] t2 = p.m19929t();
            C9971q.m14634f(t2, "credential.rawId");
            String base64 = toBase64(t2);
            AbstractC8342i u2 = p.m19928u();
            C9971q.m14635e(u2, "null cannot be cast to non-null type com.google.android.gms.fido.fido2.api.common.AuthenticatorAttestationResponse");
            C8337g gVar = (C8337g) u2;
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("id", base64);
            jSONObject.put("rawId", base64);
            jSONObject.put("type", EnumC8371u.PUBLIC_KEY.toString());
            JSONObject jSONObject2 = new JSONObject();
            byte[] p2 = gVar.mo19942p();
            C9971q.m14634f(p2, "response.clientDataJSON");
            jSONObject2.put("clientDataJSON", toBase64(p2));
            byte[] r = gVar.m19948r();
            C9971q.m14634f(r, "response.attestationObject");
            jSONObject2.put("attestationObject", toBase64(r));
            jSONObject.put("response", jSONObject2);
            Function1<String, Unit> function12 = this.resolve;
            String jSONObject3 = jSONObject.toString();
            C9971q.m14634f(jSONObject3, "obj.toString()");
            function12.invoke(jSONObject3);
        } else if (i == REQUEST_CODE_AUTHENTICATE) {
            byte[] t3 = p.m19929t();
            C9971q.m14634f(t3, "credential.rawId");
            String base642 = toBase64(t3);
            AbstractC8342i u3 = p.m19928u();
            C9971q.m14635e(u3, "null cannot be cast to non-null type com.google.android.gms.fido.fido2.api.common.AuthenticatorAssertionResponse");
            C8334f fVar = (C8334f) u3;
            JSONObject jSONObject4 = new JSONObject();
            jSONObject4.put("id", base642);
            jSONObject4.put("rawId", base642);
            jSONObject4.put("type", EnumC8371u.PUBLIC_KEY.toString());
            JSONObject jSONObject5 = new JSONObject();
            byte[] p3 = fVar.mo19942p();
            C9971q.m14634f(p3, "response.clientDataJSON");
            jSONObject5.put("clientDataJSON", toBase64(p3));
            byte[] r2 = fVar.m19953r();
            C9971q.m14634f(r2, "response.authenticatorData");
            jSONObject5.put("authenticatorData", toBase64(r2));
            byte[] u4 = fVar.m19951u();
            C9971q.m14634f(u4, "response.signature");
            ...
            C9971q.m14634f(jSONObject6, "obj.toString()");
    ...
    public final void register(String challenge, Activity activity) {
        IntRange q;
        C9971q.m14633g(challenge, "challenge");
        C8359p.C8360a aVar = new C8359p.C8360a();
        JSONObject jSONObject = new JSONObject(new JSONTokener(challenge));
        String string = jSONObject.getJSONObject("user").getString("id");
        C9971q.m14634f(string, "obj.getJSONObject(\"user\").getString(\"id\")");
        aVar.m19913h(new C8374v(decodeBase64(string), jSONObject.getJSONObject("user").getString("name"), null, jSONObject.getJSONObject("user").getString("displayName")));
        String string2 = jSONObject.getString("challenge");
        C9971q.m14634f(string2, "obj.getString(\"challenge\")");
        ...
        Iterator<Integer> it = q.iterator();
        while (it.hasNext()) {
            JSONObject jSONObject2 = jSONArray.getJSONObject(((AbstractC11283p) it).nextInt());
            arrayList.add(new C8364r(jSONObject2.getString("type"), jSONObject2.getInt("alg")));
        }
        ...
        C9971q.m14634f(jSONArray2, "obj.getJSONArray(\"excludeCredentials\")");
        aVar.m19917d(parseCredentialDescriptors(jSONArray2));
        C8344j.C8345a aVar2 = new C8344j.C8345a();
        aVar2.m19938b(EnumC8320b.m19963a(jSONObject.getJSONObject("authenticatorSection").getString("authenticatorAttachment")));
        aVar.m19919b(aVar2.m19939a());
        aVar.m19915f(new C8369t(jSONObject.getJSONObject("rp").getString("id"), jSONObject.getJSONObject("rp").getString("name"), null));
        Task<PendingIntent> C = C7572a.m21977a(activity).m20978C(aVar.m19920a());
        final WebAuthn$register$2 webAuthn$register$2 = new WebAuthn$register$2(activity);
        C.mo28867f(new AbstractC6426f() { // from class: com.discord.security_key.a
            @Override // p064db.AbstractC6426f
            /* renamed from: a */
            public final void mo25576a(Object obj) {
        ...
        C.mo28869d(new AbstractC6425e() { // from class: com.discord.security_key.b
            @Override // p064db.AbstractC6425e
            public final void onFailure(Exception exc) {
