...
public final class ScreenshotContentObserver extends ContentObserver {
    ...
    public static final class Companion {
        ...
        public final boolean isScreenshotPath(String str) {
            ...
            C9677q.m14634f(locale, "getDefault()");
            String lowerCase = str.toLowerCase(locale);
            C9677q.m14634f(lowerCase, "this as java.lang.String).toLowerCase(locale)");
            M = C12588v.m5709M(lowerCase, "screenshots/", false, 2, null);
            return M;
        }
    }
    ...
    public static final class ScreenshotData {
        ...
        public ScreenshotData(long j, String fileName, String relativePath, Uri uri, long j2) {
            ...
            C9677q.m14633g(relativePath, "relativePath");
        ...
        public boolean equals(Object obj) {
            ...
            return this.f8325id == screenshotData.f8325id && C9677q.m14638b(this.fileName, screenshotData.fileName) && C9677q.m14638b(this.relativePath, screenshotData.relativePath) && C9677q.m14638b(this.uri, screenshotData.uri) && this.dateAdded == screenshotData.dateAdded;
        }
        ...
        public int hashCode() {
            return (((((((C2968a.m32873a(this.f8325id) * 31) + this.fileName.hashCode()) * 31) + this.relativePath.hashCode()) * 31) + this.uri.hashCode()) * 31) + C2968a.m32873a(this.dateAdded);
        }
    ...
    public ScreenshotContentObserver(ContentResolver contentResolver, Function0<Unit> onScreenshot) {
        super(null);
        C9677q.m14633g(contentResolver, "contentResolver");
        C9677q.m14633g(onScreenshot, "onScreenshot");
    ...
    private final String[] getProjection() {
        ...
        p = C9601e.m14979p(new String[]{"_display_name", "date_added", "_id"}, strArr);
        p2 = C9601e.m14979p(p, strArr2);
        return (String[]) p2;
    }
            ...
            try {
                ...
                if (cursor != null) {
                    ...
                    if (i >= 29) {
                        ...
                        C9677q.m14634f(string, "cursor.getString(cursor.…mages.ImageColumns.DATA))");
                        relativePath = C12588v.m5694T0(string, '/', th, 2, th);
                    }
                    long j = query.getLong(query.getColumnIndex("_id"));
                    String string2 = query.getString(query.getColumnIndex("_display_name"));
                    C9677q.m14634f(string2, "cursor.getString(cursor.…ages.Media.DISPLAY_NAME))");
                    C9677q.m14634f(relativePath, "relativePath");
    ...
    private final void process(Uri uri) {
        ...
        if (screenshotData != null) {
            ...
            if (str != null) {
                u = C12587u.m5731u(str, screenshotData.getPath(), false, 2, null);
                if (u) {
                    return;
                }
            }
    ...
    public void onChange(boolean z, Uri uri) {
        ...
        if (uri != null) {
            ...
            C9677q.m14634f(uri3, "EXTERNAL_CONTENT_URI.toString()");
            H = C12587u.m5736H(uri2, uri3, false, 2, null);
            if (H) {
                try {
                    process(uri);
                } catch (Exception e) {
