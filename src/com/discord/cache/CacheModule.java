...
public final class CacheModule extends ReactContextBaseJavaModule {
    ...
    public static final class Companion {
        ...
        public final void quickInitCache(Context applicationContext) {
            ...
            C12444a.m6476b(false, false, null, null, 0, new CacheModule$Companion$quickInitCache$1(applicationContext), 31, null);
        }
    }

    static {
        HashSet<String> e;
        e = C9625w.m14721e("_clientStateKey", "_userIdKey", "token");
        FAST_CACHE_KEYS = e;
        String simpleName = CacheModule.class.getSimpleName();
        C9677q.m14634f(simpleName, "CacheModule::class.java.simpleName");
        logTag = simpleName;
    }
    ...
    private final void migrateLegacySettings(ReactContext reactContext) {
        if (!this.migrationSharedPrefs.getBoolean("migrated_legacy", false)) {
            ...
            C9677q.m14634f(migrationSharedPrefs, "migrationSharedPrefs");
    ...
    public final void clear() {
        ...
        C9677q.m14634f(fastCacheSharedPrefs, "fastCacheSharedPrefs");
        SharedPreferences.Editor editor2 = fastCacheSharedPrefs.edit();
        C9677q.m14634f(editor2, "editor");
        editor2.clear();
        editor2.apply();
    }
    ...
    public final void refresh(ReadableArray exclude, Promise promise) {
        Throwable th2;
        Set H0;
        C9677q.m14633g(exclude, "exclude");
        C9677q.m14633g(promise, "promise");
        ...
        try {
            ...
            C9677q.m14634f(arrayList, "exclude.toArrayList()");
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    if (!H0.contains(str2)) {
                        C9677q.m14635e(value, "null cannot be cast to non-null type kotlin.String");
