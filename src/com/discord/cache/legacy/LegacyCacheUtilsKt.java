...
public final class LegacyCacheUtilsKt {
    ...
    private static final SharedPreferences getLegacySharedPrefs(Context context) {
        ...
        C9677q.m14634f(sharedPreferences, "getSharedPreferences(\"${…s\", Context.MODE_PRIVATE)");
    ...
    private static final SharedPreferences getLegacySharedPrefsDurable(Context context) {
        ...
        C9677q.m14634f(sharedPreferences, "getSharedPreferences(\"pr…e\", Context.MODE_PRIVATE)");
        return sharedPreferences;
    }

    public static final boolean wasLegacyUsingAMOLEDTheme(Context context) {
        C9677q.m14633g(context, "<this>");
        return C9677q.m14638b(getLegacySharedPrefsDurable(context).getString("CACHE_KEY_THEME", null), "pureEvil");
    }
}
