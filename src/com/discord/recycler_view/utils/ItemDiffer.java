...
public final class ItemDiffer extends C1968c.AbstractC1970b {
    ...
    public ItemDiffer(List<? extends ItemDiffableType> oldItems, List<? extends ItemDiffableType> newItems) {
        C9677q.m14633g(oldItems, "oldItems");
        C9677q.m14633g(newItems, "newItems");
        this.oldItems = oldItems;
        this.newItems = newItems;
    }

    @Override // androidx.recyclerview.widget.C1968c.AbstractC1970b
    public boolean areContentsTheSame(int i, int i2) {
        return C9677q.m14638b(this.oldItems.get(i), this.newItems.get(i2));
    }

    @Override // androidx.recyclerview.widget.C1968c.AbstractC1970b
    public boolean areItemsTheSame(int i, int i2) {
        return C9677q.m14638b(this.oldItems.get(i).getItemId(), this.newItems.get(i2).getItemId());
    }
