...
public final class DeviceThermalStateManagerModule extends ReactContextBaseJavaModule {
    private final ReactEvents reactEvents = new ReactEvents(C11098x.m10921a("DeviceThermalStateDidChange", C9951f0.m14684b(DeviceThermalStateChangedEvent.class)));
    ...
    public final void getThermalState(Promise promise) {
        ...
        C9971q.m14635e(systemService, "null cannot be cast to non-null type android.os.PowerManager");
