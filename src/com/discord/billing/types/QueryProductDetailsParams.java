...
public final class QueryProductDetailsParams {
    ...
    public final com.android.billingclient.api.QueryProductDetailsParams create(ProductType productType, List<String> productIds) {
        C9971q.m14633g(productType, "productType");
        C9971q.m14633g(productIds, "productIds");
        ArrayList arrayList = new ArrayList();
        for (String str : productIds) {
            QueryProductDetailsParams.C4110b a = QueryProductDetailsParams.C4110b.m32758a().m32754b(str).m32753c(productType.getRawProductType()).m32755a();
            C9971q.m14634f(a, "newBuilder()\n           …                 .build()");
            arrayList.add(a);
        }
        QueryProductDetailsParams.C4109a b = com.android.billingclient.api.QueryProductDetailsParams.m32764a().m32760b(arrayList);
        C9971q.m14634f(b, "newBuilder().setProductList(productList)");
        com.android.billingclient.api.QueryProductDetailsParams a2 = b.m32761a();
        C9971q.m14634f(a2, "params.build()");
        return a2;
    }
}
