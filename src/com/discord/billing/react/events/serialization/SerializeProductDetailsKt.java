    ...
    public static final ReadableNativeArray serializeProductDetails(List<ProductDetails> list) {
        ...
        for (ProductDetails productDetails : list) {
            ...
            if (C9677q.m14638b(productDetails.m32791d(), "inapp")) {
                ...
                if (b != null) {
                    C9677q.m14634f(b, "productDetails.oneTimePu…oductDetails.productId}\")");
                    j = b.m32784b();
                    obj = b.m32785a();
                    str = b.m32783c();
                } else {
                ...
                obj = null;
                if (C9677q.m14638b(productDetails.m32791d(), "subs")) {
                    ...
                    if (e != null) {
                        ...
                        while (true) {
                            ...
                            Object next = it.next();
                            if (((ProductDetails.C2996d) next).m32777a() == null) {
                                z = true;
                                continue;
                            } else {
                                z = false;
                        ...
                        ProductDetails.C2996d dVar = (ProductDetails.C2996d) obj;
                        if (dVar != null) {
                            ProductDetails.C2994b bVar = dVar.m32775c().m32778a().get(0);
                            if (bVar != null) {
                                long b2 = bVar.m32780b();
                                Object a = bVar.m32781a();
                                String c = bVar.m32779c();
                                for (ProductDetails.C2996d dVar2 : e) {
            ...
            arrayList.add(NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("identifier", productDetails.m32792c()), C10853x.m10921a("title", productDetails.m32789f()), C10853x.m10921a("description", productDetails.m32794a()), C10853x.m10921a("priceString", obj), C10853x.m10921a("currencyCode", str), C10853x.m10921a("price", Integer.valueOf((int) (j / 10000))), C10853x.m10921a("type", productDetails.m32791d()), C10853x.m10921a("offerIds", NativeArrayExtensionsKt.toNativeArray(arrayList2))));
        }
