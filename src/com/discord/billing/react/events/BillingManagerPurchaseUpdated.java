...
public final class BillingManagerPurchaseUpdated implements ReactEvent {
    ...
    public /* synthetic */ BillingManagerPurchaseUpdated(int i, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i & 7)) {
            C3681n1.m33818b(i, 7, BillingManagerPurchaseUpdated$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public WritableNativeMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("purchase", NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("purchaseToken", this.purchaseToken), C11098x.m10921a("packageName", this.packageName), C11098x.m10921a("productId", this.sku))));
    }
}
