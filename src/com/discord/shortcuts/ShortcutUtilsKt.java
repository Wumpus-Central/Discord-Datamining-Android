...
public final class ShortcutUtilsKt {
    public static final NotificationCompat.Builder addShortcut(NotificationCompat.Builder builder, Context context, ShortcutInfoCompat shortcutInfo) {
        ...
        C9971q.m14633g(shortcutInfo, "shortcutInfo");
        builder.m38554W(shortcutInfo.m38092f());
        builder.m38562O(new C2348g(shortcutInfo.m38092f()));
        C2353b.m38064f(context, shortcutInfo);
        return builder;
    }
    ...
    public static final ShortcutInfoCompat createShortcut(Context context, String id2, CharSequence label, CharSequence longLabel, Bitmap bitmap, List<? extends Person> persons, Intent intent, int i) {
        ...
        C9971q.m14633g(longLabel, "longLabel");
        C9971q.m14633g(persons, "persons");
        C9971q.m14633g(intent, "intent");
        ShortcutInfoCompat.C2351a i2 = new ShortcutInfoCompat.C2351a(context, id2).m38078h(new C2348g(id2)).m38073m(label).m38077i(longLabel);
        if (bitmap != null) {
        ...
        C9971q.m14634f(a, "Builder(this, id)\n      …Array())\n        .build()");
        return a;
    }
    ...
    private static final Set<String> getShareCategories() {
        ...
        if (Build.VERSION.SDK_INT < 25) {
            c = C9920v.m14723c(BuildConfig.SHARE_CATEGORY);
            return c;
        }
        i = C9921w.m14717i(BuildConfig.SHARE_CATEGORY, "android.shortcut.conversation");
        return i;
    }
}
