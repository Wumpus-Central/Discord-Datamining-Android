...
public final class LocalImageThumbnailView extends FrameLayout {
    ...
    public final void loadDefaultBitmap(SimpleDraweeView simpleDraweeView, Uri uri) {
        simpleDraweeView.setController(C10061c.m13583g().m31933D(ImageRequestBuilder.m30874s(uri).m30898E(ResizeOptions.m31498a(simpleDraweeView.getWidth(), simpleDraweeView.getHeight())).m30892a()).build());
    }
    ...
    public final void setLocalImageSource(Uri uri, int i, int i2) {
        ...
        C9851l.m14174d(CoroutineViewUtilsKt.getAttachedScope(this), C9946y0.m13946b(), null, new LocalImageThumbnailView$setLocalImageSource$1(i, i2, this, uri, null), 2, null);
    }
    ...
    public LocalImageThumbnailView(Context context, AttributeSet attributeSet, int i) {
        ...
        simpleDraweeView.getHierarchy().m31774t(ScalingUtils.ScaleType.f9827i);
