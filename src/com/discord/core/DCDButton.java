...
public final class DCDButton extends FrameLayout {
    ...
    public final void ellipsize(TextUtils.TruncateAt behavior) {
        C9677q.m14633g(behavior, "behavior");
    ...
    public final void setIcon(String str, int i) {
        ReactAssetUtilsKt.setReactIcon(this.button, str, i);
    }
    ...
    public DCDButton(Context context, AttributeSet attributeSet) {
        ...
        C9677q.m14634f(progressBar, "binding.progress");
