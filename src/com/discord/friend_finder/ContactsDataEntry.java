...
public final class ContactsDataEntry {
    ...
    public /* synthetic */ ContactsDataEntry(int i, String str, String str2, String str3, ContactName[] contactNameArr, boolean z, String[] strArr, SerializationConstructorMarker serializationConstructorMarker) {
        if (63 != (i & 63)) {
            C3681n1.m33818b(i, 63, ContactsDataEntry$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(ContactsDataEntry self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 3, new C3708v1(C9951f0.m14684b(ContactName.class), ContactName$$serializer.INSTANCE), self.contactNames);
        output.mo13865y(serialDesc, 4, self.hasImageData);
        output.mo13870t(serialDesc, 5, new C3708v1(C9951f0.m14684b(String.class), C3622a2.f5917a), self.deviceContactIds);
    }
    ...
    public final ContactsDataEntry copy(String contactMethod, String contactMethodLabel, String contactMethodType, ContactName[] contactNames, boolean z, String[] deviceContactIds) {
        C9971q.m14633g(contactMethod, "contactMethod");
        C9971q.m14633g(contactMethodLabel, "contactMethodLabel");
        C9971q.m14633g(contactMethodType, "contactMethodType");
        C9971q.m14633g(contactNames, "contactNames");
        C9971q.m14633g(deviceContactIds, "deviceContactIds");
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.contactMethod, contactsDataEntry.contactMethod) && C9971q.m14638b(this.contactMethodLabel, contactsDataEntry.contactMethodLabel) && C9971q.m14638b(this.contactMethodType, contactsDataEntry.contactMethodType) && C9971q.m14638b(this.contactNames, contactsDataEntry.contactNames) && this.hasImageData == contactsDataEntry.hasImageData && C9971q.m14638b(this.deviceContactIds, contactsDataEntry.deviceContactIds);
    }
