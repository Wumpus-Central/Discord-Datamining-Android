...
public final class FriendFinderProvider {
        ...
        while (query.moveToNext()) {
            ...
            if (!(columnString2 == null || columnString3 == null)) {
                ...
                try {
                    ...
                    C9677q.m14634f(str, "context.getResources().g…tTypeLabelResource(type))");
                    try {
                        t = C12587u.m5732t(str, "Custom", true);
                    } catch (Exception unused) {
                        str3 = str;
                    }
                } catch (Exception unused2) {
                ...
                if (t) {
                    ...
                    C9677q.m14634f(str3, "phoneCursor.getString(ph…onDataKinds.Phone.LABEL))");
                    str = str3;
                }
                ...
                if (contactsDataEntry != null) {
                    C9601e.m14980o(contactsDataEntry.getContactNames(), contactName2);
                    if (z) {
                        contactsDataEntry.setHasImageData(true);
                    }
                    C9601e.m14980o(contactsDataEntry.getDeviceContactIds(), columnString3);
    ...
    public final String getImageForContactId(Context context, String contactId) {
        ...
        Uri parse;
        C9677q.m14633g(context, "context");
        C9677q.m14633g(contactId, "contactId");
