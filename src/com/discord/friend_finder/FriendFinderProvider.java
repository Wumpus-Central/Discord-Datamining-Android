...
@Metadata(m15074d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001a\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00042\u0006\u0010\u0007\u001a\u00020\bJ\u001a\u0010\t\u001a\u0004\u0018\u00010\n2\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\u0005H\u0002J\u0018\u0010\f\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\u0005J \u0010\r\u001a\u0004\u0018\u00010\u0005*\u00020\u000e2\u0006\u0010\u0007\u001a\u00020\b2\b\b\u0002\u0010\u000f\u001a\u00020\u0010H\u0002J\u0016\u0010\u0011\u001a\u0004\u0018\u00010\u0005*\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0005H\u0002¨\u0006\u0014"}, m15073d2 = {"Lcom/discord/friend_finder/FriendFinderProvider;", "", "()V", "fetchContacts", "", "", "Lcom/discord/friend_finder/ContactsDataEntry;", "context", "Landroid/content/Context;", "getContactName", "Lcom/discord/friend_finder/ContactNameEntry;", "contactId", "getImageForContactId", "asBase64BitmapString", "Landroid/net/Uri;", "quality", "", "getColumnString", "Landroid/database/Cursor;", "columnName", "friend_finder_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
...
public final class FriendFinderProvider {
    ...
    private final String asBase64BitmapString(Uri uri, Context context, int i) {
        ...
        try {
            ...
            try {
                ...
                C14082c.m1713a(openAssetFileDescriptor, th2);
            }
        }
    }
        ...
        while (query.moveToNext()) {
            ...
            if (!(columnString2 == null || columnString3 == null)) {
                ...
                try {
                    ...
                    C9971q.m14634f(str, "context.getResources().g…tTypeLabelResource(type))");
                    try {
                        t = C12718u.m5732t(str, "Custom", true);
                    } catch (Exception unused) {
                        str3 = str;
                    }
                } catch (Exception unused2) {
                ...
                if (t) {
                    ...
                    C9971q.m14634f(str3, "phoneCursor.getString(ph…onDataKinds.Phone.LABEL))");
                    str = str3;
                }
                ...
                if (contactsDataEntry != null) {
                    C9897e.m14980o(contactsDataEntry.getContactNames(), contactName2);
                    if (z) {
                        contactsDataEntry.setHasImageData(true);
                    }
                    C9897e.m14980o(contactsDataEntry.getDeviceContactIds(), columnString3);
    ...
    public final String getImageForContactId(Context context, String contactId) {
        ...
        Uri parse;
        C9971q.m14633g(context, "context");
        C9971q.m14633g(contactId, "contactId");
