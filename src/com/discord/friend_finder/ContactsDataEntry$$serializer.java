...
public final class ContactsDataEntry$$serializer implements AbstractC3644f0<ContactsDataEntry> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{a2Var, a2Var, a2Var, new C3708v1(C9951f0.m14684b(ContactName.class), ContactName$$serializer.INSTANCE), C3652h.f5959a, new C3708v1(C9951f0.m14684b(String.class), a2Var)};
    }
    ...
    public ContactsDataEntry deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj = b.mo13847y(descriptor2, 3, new C3708v1(C9951f0.m14684b(ContactName.class), ContactName$$serializer.INSTANCE), null);
            z = b.mo13861C(descriptor2, 4);
            obj2 = b.mo13847y(descriptor2, 5, new C3708v1(C9951f0.m14684b(String.class), C3622a2.f5917a), null);
            i = 63;
        } else {
            boolean z2 = true;
            int i3 = 0;
            ...
            while (z2) {
                ...
                switch (o) {
                    ...
                    case 2:
                        ...
                        i3 |= 4;
                    case 3:
                        obj3 = b.mo13847y(descriptor2, 3, new C3708v1(C9951f0.m14684b(ContactName.class), ContactName$$serializer.INSTANCE), obj3);
                        i3 |= 8;
                        c = 3;
                        i2 = 2;
                    case 4:
                        ...
                        i2 = 2;
                    case 5:
                        obj4 = b.mo13847y(descriptor2, 5, new C3708v1(C9951f0.m14684b(String.class), C3622a2.f5917a), obj4);
                        i3 |= 32;
                        c = 3;
                        i2 = 2;
                    default:
