...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        int i = C4744R.color.white_500;
        this.activityCardBackground = ColorUtilsKt.getColorCompat(context, i);
        int i2 = C4744R.color.primary_100;
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, i2);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.android_navigation_scrim_background_light);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, C4744R.color.android_ripple_light);
        int i3 = C4744R.color.primary_430;
        ...
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, C4744R.color.background_mentioned_light);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, C4744R.color.background_mentioned_hover_light);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, C4744R.color.background_message_automod_light);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, C4744R.color.background_message_automod_hover_light);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, C4744R.color.background_message_highlight_light);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, C4744R.color.background_message_highlight_hover_light);
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, C4744R.color.background_message_hover_light);
        ...
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, C4744R.color.background_modifier_accent_light);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, C4744R.color.background_modifier_active_light);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, C4744R.color.background_modifier_hover_light);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, C4744R.color.background_modifier_selected_light);
        ...
        int i4 = C4744R.color.primary_130;
        this.backgroundSecondary = ColorUtilsKt.getColorCompat(context, i4);
        int i5 = C4744R.color.primary_160;
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i5);
        int i6 = C4744R.color.primary_200;
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i6);
        int i7 = C4744R.color.black_500;
        this.black = ColorUtilsKt.getColorCompat(context, i7);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.bug_reporter_modal_submitting_background_light);
        int i8 = C4744R.color.red_430;
        ...
        int i9 = C4744R.color.red_500;
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i9);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.button_outline_brand_background_light);
        int i10 = C4744R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i10);
        int i11 = C4744R.color.brand_500;
        ...
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.button_outline_danger_background_light);
        ...
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.button_outline_positive_background_light);
        ...
        int i14 = C4744R.color.green_400;
        ...
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.button_outline_primary_background_light);
        int i15 = C4744R.color.primary_600;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i15);
        int i16 = C4744R.color.primary_530;
        ...
        int i17 = C4744R.color.primary_500;
        ...
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, C4744R.color.primary_400);
        int i18 = C4744R.color.primary_460;
        ...
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, C4744R.color.deprecated_card_editable_bg_light);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, i);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, C4744R.color.deprecated_quickswitcher_input_placeholder_light);
        ...
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, C4744R.color.deprecated_text_input_border_light);
        this.deprecatedTextInputBorderDisabled = ColorUtilsKt.getColorCompat(context, i6);
        int i19 = C4744R.color.primary_300;
        ...
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.display_banner_overflow_background_light);
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, C4744R.color.blue_345);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.forum_post_extra_media_count_container_background_light);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.forum_post_tag_background_light);
        int i20 = C4744R.color.primary_860;
        ...
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, C4744R.color.home_card_resting_border_light);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.info_box_background_light);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.info_danger_background_light);
        ...
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.info_help_background_light);
        int i21 = C4744R.color.blue_430;
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i21);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i7);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.info_positive_background_light);
        ...
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.info_warning_background_light);
        int i22 = C4744R.color.yellow_400;
        ...
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, C4744R.color.primary_560);
        ...
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, C4744R.color.live_stage_tile_border_light);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i11);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.mention_background_light);
        ...
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_message_input_border_light);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_note_background_light);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_overlay_light);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_overlay_synced_with_user_theme_light);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_profile_body_background_hover_light);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_role_pill_background_light);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_role_pill_border_light);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, C4744R.color.profile_gradient_section_box_light);
        ...
        this.redesignButtonFloatingPressedBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.primary_730);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i13);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.green_500);
        ...
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, C4744R.color.redesign_button_secondary_border_light);
        int i23 = C4744R.color.primary_230;
        ...
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, C4744R.color.scrollbar_thin_thumb_light);
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, C4744R.color.scrollbar_thin_track_light);
        ...
        this.textWarning = ColorUtilsKt.getColorCompat(context, C4744R.color.yellow_430);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i16);
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, C4744R.color.user_profile_header_overflow_background_light);
