...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        int i = C3713R.color.white_500;
        this.activityCardBackground = ColorUtilsKt.getColorCompat(context, i);
        int i2 = C3713R.color.primary_100;
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, i2);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.android_navigation_scrim_background_light);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, C3713R.color.android_ripple_light);
        int i3 = C3713R.color.primary_430;
        this.backgroundAccent = ColorUtilsKt.getColorCompat(context, i3);
        this.backgroundFloating = ColorUtilsKt.getColorCompat(context, i);
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, C3713R.color.background_mentioned_light);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_mentioned_hover_light);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_automod_light);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_automod_hover_light);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_highlight_light);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_highlight_hover_light);
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_hover_light);
        this.backgroundMobilePrimary = ColorUtilsKt.getColorCompat(context, i2);
        this.backgroundMobileSecondary = ColorUtilsKt.getColorCompat(context, i);
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_accent_light);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_active_light);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_hover_light);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_selected_light);
        this.backgroundNestedFloating = ColorUtilsKt.getColorCompat(context, i);
        this.backgroundPrimary = ColorUtilsKt.getColorCompat(context, i);
        int i4 = C3713R.color.primary_130;
        this.backgroundSecondary = ColorUtilsKt.getColorCompat(context, i4);
        int i5 = C3713R.color.primary_160;
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i5);
        int i6 = C3713R.color.primary_200;
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i6);
        int i7 = C3713R.color.black_500;
        this.black = ColorUtilsKt.getColorCompat(context, i7);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.bug_reporter_modal_submitting_background_light);
        int i8 = C3713R.color.red_430;
        this.buttonDangerBackground = ColorUtilsKt.getColorCompat(context, i8);
        this.buttonDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, C3713R.color.red_530);
        this.buttonDangerBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i8);
        int i9 = C3713R.color.red_500;
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i9);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_brand_background_light);
        int i10 = C3713R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i10);
        int i11 = C3713R.color.brand_500;
        ...
        this.buttonOutlineBrandText = ColorUtilsKt.getColorCompat(context, i7);
        this.buttonOutlineBrandTextActive = ColorUtilsKt.getColorCompat(context, i);
        this.buttonOutlineBrandTextHover = ColorUtilsKt.getColorCompat(context, i);
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_danger_background_light);
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, C3713R.color.red_460);
        this.buttonOutlineDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i8);
        this.buttonOutlineDangerBorder = ColorUtilsKt.getColorCompat(context, i8);
        this.buttonOutlineDangerBorderActive = ColorUtilsKt.getColorCompat(context, i8);
        this.buttonOutlineDangerBorderHover = ColorUtilsKt.getColorCompat(context, i8);
        this.buttonOutlineDangerText = ColorUtilsKt.getColorCompat(context, i7);
        this.buttonOutlineDangerTextActive = ColorUtilsKt.getColorCompat(context, i);
        this.buttonOutlineDangerTextHover = ColorUtilsKt.getColorCompat(context, i);
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_positive_background_light);
        int i12 = C3713R.color.green_530;
        this.buttonOutlinePositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i12);
        int i13 = C3713R.color.green_430;
        this.buttonOutlinePositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i13);
        int i14 = C3713R.color.green_400;
        ...
        this.buttonOutlinePositiveText = ColorUtilsKt.getColorCompat(context, i7);
        this.buttonOutlinePositiveTextActive = ColorUtilsKt.getColorCompat(context, i);
        this.buttonOutlinePositiveTextHover = ColorUtilsKt.getColorCompat(context, i);
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_primary_background_light);
        int i15 = C3713R.color.primary_600;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i15);
        int i16 = C3713R.color.primary_530;
        ...
        this.buttonOutlinePrimaryText = ColorUtilsKt.getColorCompat(context, i7);
        this.buttonOutlinePrimaryTextActive = ColorUtilsKt.getColorCompat(context, i);
        this.buttonOutlinePrimaryTextHover = ColorUtilsKt.getColorCompat(context, i);
        ...
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i12);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i3);
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i16);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i3);
        int i17 = C3713R.color.primary_500;
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i17);
        this.channelIcon = ColorUtilsKt.getColorCompat(context, i3);
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_400);
        int i18 = C3713R.color.primary_460;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i18);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, i5);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i);
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i6);
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i);
        this.controlBrandForeground = ColorUtilsKt.getColorCompat(context, i11);
        this.controlBrandForegroundNew = ColorUtilsKt.getColorCompat(context, i11);
        this.deprecatedCardBg = ColorUtilsKt.getColorCompat(context, i2);
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, C3713R.color.deprecated_card_editable_bg_light);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, i);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, C3713R.color.deprecated_quickswitcher_input_placeholder_light);
        this.deprecatedStoreBg = ColorUtilsKt.getColorCompat(context, i2);
        this.deprecatedTextInputBg = ColorUtilsKt.getColorCompat(context, i6);
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.deprecated_text_input_border_light);
        this.deprecatedTextInputBorderDisabled = ColorUtilsKt.getColorCompat(context, i6);
        int i19 = C3713R.color.primary_300;
        this.deprecatedTextInputBorderHover = ColorUtilsKt.getColorCompat(context, i19);
        this.deprecatedTextInputPrefix = ColorUtilsKt.getColorCompat(context, i19);
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.display_banner_overflow_background_light);
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, C3713R.color.blue_345);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.forum_post_extra_media_count_container_background_light);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.forum_post_tag_background_light);
        int i20 = C3713R.color.primary_860;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i20);
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i17);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, i2);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.home_card_resting_border_light);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_box_background_light);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_danger_background_light);
        this.infoDangerForeground = ColorUtilsKt.getColorCompat(context, i8);
        this.infoDangerText = ColorUtilsKt.getColorCompat(context, i7);
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_help_background_light);
        int i21 = C3713R.color.blue_430;
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i21);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i7);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_positive_background_light);
        this.infoPositiveForeground = ColorUtilsKt.getColorCompat(context, i14);
        this.infoPositiveText = ColorUtilsKt.getColorCompat(context, i7);
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_warning_background_light);
        int i22 = C3713R.color.yellow_400;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i22);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i7);
        this.inputBackground = ColorUtilsKt.getColorCompat(context, i6);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_560);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i20);
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i15);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i19);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i17);
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.live_stage_tile_border_light);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i11);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.mention_background_light);
        this.mentionForeground = ColorUtilsKt.getColorCompat(context, i11);
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i);
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i4);
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_message_input_border_light);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_note_background_light);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_overlay_light);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_overlay_synced_with_user_theme_light);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_profile_body_background_hover_light);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_role_pill_background_light);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_role_pill_border_light);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_section_box_light);
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i8);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i9);
        this.redesignButtonFloatingBackground = ColorUtilsKt.getColorCompat(context, i);
        this.redesignButtonFloatingPressedBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_730);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i13);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.green_500);
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonPrimaryPressedBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.brand_600);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.redesign_button_secondary_border_light);
        int i23 = C3713R.color.primary_230;
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i23);
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i23);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i4);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i19);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i5);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, C3713R.color.scrollbar_thin_thumb_light);
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, C3713R.color.scrollbar_thin_track_light);
        this.spoilerHiddenBackground = ColorUtilsKt.getColorCompat(context, i6);
        this.spoilerRevealedBackground = ColorUtilsKt.getColorCompat(context, i5);
        this.statusDanger = ColorUtilsKt.getColorCompat(context, i8);
        this.statusDangerBackground = ColorUtilsKt.getColorCompat(context, i8);
        this.statusDangerText = ColorUtilsKt.getColorCompat(context, i);
        ...
        this.statusPositiveText = ColorUtilsKt.getColorCompat(context, i);
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i22);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i);
        this.textBrand = ColorUtilsKt.getColorCompat(context, i11);
        this.textDanger = ColorUtilsKt.getColorCompat(context, i9);
        this.textLink = ColorUtilsKt.getColorCompat(context, i21);
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, i21);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i18);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i15);
        this.textPositive = ColorUtilsKt.getColorCompat(context, i13);
        this.textWarning = ColorUtilsKt.getColorCompat(context, C3713R.color.yellow_430);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i16);
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.user_profile_header_overflow_background_light);
        this.white = ColorUtilsKt.getColorCompat(context, i);
    }
