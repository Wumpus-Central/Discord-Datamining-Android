...
import com.discord.theme.C3713R;
        ...
        if (themeManager.isInitialized()) {
            if (!themeManager.shouldShowSplashImage$theme_release()) {
                ...
                if (ThemeManagerKt.getTheme() instanceof DarkTheme) {
                    i2 = C3713R.color.primary_660;
                } else {
                    i2 = C3713R.color.primary_160;
                }
            ...
            if (ThemeManagerKt.getTheme() instanceof DarkTheme) {
                i = C3713R.C3714drawable.background_splash_dark;
            } else {
                i = C3713R.C3714drawable.background_splash_light;
            }
