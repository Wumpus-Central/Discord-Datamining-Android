...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        int i = C3713R.color.primary_700;
        this.activityCardBackground = ColorUtilsKt.getColorCompat(context, i);
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_830);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.android_navigation_scrim_background_dark);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, C3713R.color.android_ripple_dark);
        this.backgroundAccent = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_530);
        this.backgroundFloating = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_800);
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, C3713R.color.background_mentioned_dark);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_mentioned_hover_dark);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_automod_dark);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_automod_hover_dark);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_highlight_dark);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_highlight_hover_dark);
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_message_hover_dark);
        int i2 = C3713R.color.primary_600;
        this.backgroundMobilePrimary = ColorUtilsKt.getColorCompat(context, i2);
        int i3 = C3713R.color.primary_630;
        this.backgroundMobileSecondary = ColorUtilsKt.getColorCompat(context, i3);
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_accent_dark);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_active_dark);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_hover_dark);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, C3713R.color.background_modifier_selected_dark);
        ...
        int i4 = C3713R.color.primary_660;
        ...
        int i5 = C3713R.color.black_500;
        this.black = ColorUtilsKt.getColorCompat(context, i5);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.bug_reporter_modal_submitting_background_dark);
        int i6 = C3713R.color.red_430;
        ...
        int i7 = C3713R.color.red_500;
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i7);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_brand_background_dark);
        int i8 = C3713R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i8);
        int i9 = C3713R.color.brand_500;
        ...
        int i10 = C3713R.color.white_500;
        ...
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_danger_background_dark);
        ...
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_positive_background_dark);
        ...
        int i14 = C3713R.color.green_360;
        ...
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.button_outline_primary_background_dark);
        int i15 = C3713R.color.primary_430;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i15);
        int i16 = C3713R.color.primary_500;
        ...
        int i17 = C3713R.color.green_500;
        ...
        int i18 = C3713R.color.primary_400;
        ...
        int i19 = C3713R.color.primary_360;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i19);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_560);
        ...
        int i20 = C3713R.color.brand_360;
        ...
        this.deprecatedCardBg = ColorUtilsKt.getColorCompat(context, C3713R.color.deprecated_card_bg_dark);
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, C3713R.color.deprecated_card_editable_bg_dark);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, C3713R.color.deprecated_quickswitcher_input_placeholder_dark);
        ...
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.deprecated_text_input_border_dark);
        this.deprecatedTextInputBorderDisabled = ColorUtilsKt.getColorCompat(context, i);
        this.deprecatedTextInputBorderHover = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_900);
        this.deprecatedTextInputPrefix = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_200);
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.display_banner_overflow_background_dark);
        int i21 = C3713R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i21);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.forum_post_extra_media_count_container_background_dark);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.forum_post_tag_background_dark);
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_130);
        int i22 = C3713R.color.primary_330;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i22);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.primary_645);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.home_card_resting_border_dark);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_box_background_dark);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_danger_background_dark);
        ...
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_help_background_dark);
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i21);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i10);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_positive_background_dark);
        ...
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.info_warning_background_dark);
        int i23 = C3713R.color.yellow_300;
        ...
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, C3713R.color.input_placeholder_text_dark);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i10);
        int i24 = C3713R.color.primary_230;
        ...
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.live_stage_tile_border_dark);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i10);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.mention_background_dark);
        this.mentionForeground = ColorUtilsKt.getColorCompat(context, C3713R.color.brand_260);
        ...
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_message_input_border_dark);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_note_background_dark);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_overlay_dark);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_overlay_synced_with_user_theme_dark);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_profile_body_background_hover_dark);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_role_pill_background_dark);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_role_pill_border_dark);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, C3713R.color.profile_gradient_section_box_dark);
        ...
        int i25 = C3713R.color.primary_730;
        ...
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, C3713R.color.redesign_button_secondary_border_dark);
        ...
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, C3713R.color.scrollbar_thin_track_dark);
        ...
        this.textDanger = ColorUtilsKt.getColorCompat(context, C3713R.color.red_345);
        this.textLink = ColorUtilsKt.getColorCompat(context, i21);
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, C3713R.color.blue_330);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i19);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i24);
        this.textPositive = ColorUtilsKt.getColorCompat(context, C3713R.color.green_330);
        ...
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, C3713R.color.user_profile_header_overflow_background_dark);
