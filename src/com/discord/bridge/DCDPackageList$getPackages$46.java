...
/* synthetic */ class DCDPackageList$getPackages$46 extends C9674n implements Function1<ReactApplicationContext, ShareManagerModule> {
    ...
    public final ShareManagerModule invoke(ReactApplicationContext p0) {
        C9677q.m14633g(p0, "p0");
        return new ShareManagerModule(p0);
    }
}
