...
/* synthetic */ class DCDPackageList$getPackages$50 extends C9968n implements Function1<ReactApplicationContext, TTIManagerModule> {
    ...
    public final TTIManagerModule invoke(ReactApplicationContext p0) {
        C9971q.m14633g(p0, "p0");
        return new TTIManagerModule(p0);
    }
}
