...
/* synthetic */ class DCDPackageList$getPackages$12 extends C9674n implements Function1<ReactApplicationContext, CrashReportingModule> {
    ...
    public final CrashReportingModule invoke(ReactApplicationContext p0) {
        C9677q.m14633g(p0, "p0");
        return new CrashReportingModule(p0);
    }
}
