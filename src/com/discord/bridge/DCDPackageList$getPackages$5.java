...
/* synthetic */ class DCDPackageList$getPackages$5 extends C9968n implements Function1<ReactApplicationContext, AudioRoutePickerModule> {
    ...
    public final AudioRoutePickerModule invoke(ReactApplicationContext p0) {
        C9971q.m14633g(p0, "p0");
        return new AudioRoutePickerModule(p0);
    }
}
