...
/* synthetic */ class DCDPackageList$getPackages$52 extends C9968n implements Function1<ReactApplicationContext, ScreenWakeLockManagerModule> {
    ...
    public final ScreenWakeLockManagerModule invoke(ReactApplicationContext p0) {
        C9971q.m14633g(p0, "p0");
        return new ScreenWakeLockManagerModule(p0);
    }
}
