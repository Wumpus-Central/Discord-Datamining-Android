...
/* synthetic */ class DCDPackageList$getPackages$44 extends C9674n implements Function1<ReactApplicationContext, IntentsSendModule> {
    ...
    public final IntentsSendModule invoke(ReactApplicationContext p0) {
        C9677q.m14633g(p0, "p0");
        return new IntentsSendModule(p0);
    }
}
