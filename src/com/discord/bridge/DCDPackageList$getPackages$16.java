...
/* synthetic */ class DCDPackageList$getPackages$16 extends C9968n implements Function1<ReactApplicationContext, DynamicLinkManagerModule> {
    ...
    public final DynamicLinkManagerModule invoke(ReactApplicationContext p0) {
        C9971q.m14633g(p0, "p0");
        return new DynamicLinkManagerModule(p0);
    }
}
