...
final class DCDPackageList$getPackages$56 extends AbstractC9973s implements Function1<ReactApplicationContext, ReactContextBaseJavaModule> {
    ...
    public final ReactContextBaseJavaModule invoke(ReactApplicationContext it) {
        ...
        return new KeyCommandsViewManagerModule(it);
    }
}
