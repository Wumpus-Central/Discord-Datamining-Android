...
/* synthetic */ class DCDPackageList$getPackages$33 extends C9674n implements Function1<ReactApplicationContext, NearbyHelperModule> {
    ...
    public final NearbyHelperModule invoke(ReactApplicationContext p0) {
        C9677q.m14633g(p0, "p0");
        return new NearbyHelperModule(p0);
    }
}
