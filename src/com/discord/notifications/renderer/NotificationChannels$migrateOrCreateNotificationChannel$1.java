...
final class NotificationChannels$migrateOrCreateNotificationChannel$1 extends AbstractC9679s implements Function2<NotificationChannelCompat, NotificationChannelCompat.Builder, Unit> {
    ...
    public final void invoke2(NotificationChannelCompat notificationChannelCompat, NotificationChannelCompat.Builder builder) {
        C9677q.m14633g(builder, "<anonymous parameter 1>");
    }
}
