...
final class NotificationDataUtilsKt$getTitle$3 extends AbstractC9679s implements Function1<RenderContext, Unit> {
    final /* synthetic */ NotificationData $this_getTitle;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationDataUtilsKt$getTitle$3(NotificationData notificationData) {
        super(1);
