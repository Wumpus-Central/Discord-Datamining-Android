...
public final class RenderNotificationMessageContentKt {
    public static final String renderNotificationMessageContent(String content) {
        ...
        String i = regex2.m14581i(regex.m14581i(content, C4608xb68ee08c.INSTANCE), C4609xb68ee08d.INSTANCE);
        while (true) {
            String str = null;
            ...
            C9971q.m14634f(formatted, "formatted");
            t0 = C12719v.m5666t0(content, c.mo5840c().m14605a(), c.mo5840c().m14604b() + 1, formatted);
            content = t0.toString();
            t02 = C12719v.m5666t0(i, c.mo5840c().m14605a(), c.mo5840c().m14604b() + 1, formatted);
            i = t02.toString();
        }
    }
}
