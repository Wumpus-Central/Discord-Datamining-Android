...
final class NotificationDataUtilsKt$getTitle$2 extends AbstractC9973s implements Function1<RenderContext, Unit> {
    final /* synthetic */ NotificationData $this_getTitle;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationDataUtilsKt$getTitle$2(NotificationData notificationData) {
        super(1);
    ...
    public final void invoke2(RenderContext i18nFormat) {
        ...
        i18nFormat.getArgs().put("channelName", this.$this_getTitle.getParentName());
    }
}
