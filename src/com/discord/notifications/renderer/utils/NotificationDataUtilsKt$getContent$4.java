...
final class NotificationDataUtilsKt$getContent$4 extends AbstractC9973s implements Function1<RenderContext, Unit> {
    ...
    public final void invoke2(RenderContext i18nFormat) {
        ...
        i18nFormat.getArgs().put("name", this.$this_getContent.getUserUsername());
    }
}
