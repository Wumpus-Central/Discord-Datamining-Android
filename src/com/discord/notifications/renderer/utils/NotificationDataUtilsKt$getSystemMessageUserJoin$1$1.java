...
final class NotificationDataUtilsKt$getSystemMessageUserJoin$1$1 extends AbstractC9973s implements Function1<RenderContext, Unit> {
    final /* synthetic */ String $userName;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationDataUtilsKt$getSystemMessageUserJoin$1$1(String str) {
        super(1);
        this.$userName = str;
    }
