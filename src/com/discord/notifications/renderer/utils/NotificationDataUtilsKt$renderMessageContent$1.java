...
final class NotificationDataUtilsKt$renderMessageContent$1 extends AbstractC9973s implements Function1<RenderContext, Unit> {
    final /* synthetic */ Sticker $sticker;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationDataUtilsKt$renderMessageContent$1(Sticker sticker) {
        super(1);
    ...
    public final void invoke2(RenderContext i18nFormat) {
        ...
        i18nFormat.getArgs().put("stickerName", this.$sticker.getName());
    }
}
