...
final class NotificationDataUtilsKt$getContent$8 extends AbstractC9973s implements Function1<RenderContext, Unit> {
    final /* synthetic */ NotificationData $this_getContent;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationDataUtilsKt$getContent$8(NotificationData notificationData) {
        super(1);
