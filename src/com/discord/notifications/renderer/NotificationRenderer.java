...
import kotlinx.coroutines.C9845k;
import nf.C10853x;
...
public final class NotificationRenderer {
    ...
    public final void clear(Context context, String notificationTag) {
        ...
        C9677q.m14633g(notificationTag, "notificationTag");
    ...
    public final void display(Context context, NotificationData notification, String str, Map<String, String> notificationDataMap, NotificationBehaviors notificationBehaviors, boolean z, boolean z2) {
        ...
        C9845k.m14188b(null, new NotificationRenderer$display$1(notification, context, z2, notificationDataMap, notificationBehaviors, str, z, null), 1, null);
    }
    ...
    public final void markNotificationAsDirectReply(Context context, String tag, String channelId, boolean z) {
        ...
        if (activeNotification != null) {
            NotificationCompat.Builder c = NotificationManagerUtilsKt.getNotificationBuilderOrCreate(context, channelId, activeNotification).m38546c(C1253d.m37746a(C10853x.m10921a(IGNORE_ACK_KEY, Boolean.valueOf(z))));
            C9677q.m14634f(c, "context.getNotificationB…_KEY to shouldIgnoreAck))");
