...
public final class NotificationClient {
    ...
    private final void showNotification(Context context, NotificationData notificationData, Map<String, String> map, boolean z) {
        ...
        k = C11289v.m10248k(C11098x.m10921a("type", notificationData.getType()), C11098x.m10921a("channelId", String.valueOf(notificationData.m42062getChannelIdqMVnFVQ())), C11098x.m10921a("messageId", String.valueOf(notificationData.m42062getChannelIdqMVnFVQ())));
        ...
        if (this.cache.isAuthed(context)) {
            if (C9971q.m14638b(notificationData.getType(), NotificationData.TYPE_CHANNEL_ACK)) {
                ...
                try {
                    ...
                    if (C9971q.m14638b(notificationData.getType(), NotificationData.TYPE_MESSAGE_CREATE) && updateAndComputeIfShouldRunBackgroundSync(context)) {
    ...
    public final void handleIntent(Context context, Intent intent) {
        ...
        if (IntentUtilsKt.hasExtra(intent, C9951f0.m14684b(ContentAction.class))) {
    ...
    public final void onDirectReplySuccess(Context context, String data) {
        ...
        pairArr[0] = C11098x.m10921a("type", notificationData.getType());
        pairArr[1] = C11098x.m10921a("channel_id", String.valueOf(notificationData.m42062getChannelIdqMVnFVQ()));
        ...
        pairArr[2] = C11098x.m10921a("message_id", str);
    ...
    public final void onNotificationReceived(Context context, Map<String, String> data) {
        C9971q.m14633g(context, "context");
        C9971q.m14633g(data, "data");
        showNotification(context, (NotificationData) AbstractC6945a.f15096b.m23891d(NotificationData.Companion.serializer(), data), data, true);
    }
    ...
    public final void setLocalNotificationListener(Function1<? super Map<String, String>, Unit> notificationListener) {
        C9971q.m14633g(notificationListener, "notificationListener");
    ...
    public final void setToken(String token) {
        C9971q.m14633g(token, "token");
        if (!C9971q.m14638b(this.token, token)) {
            this.token = token;
    ...
    public final void setTokenListener(Function1<? super String, Unit> tokenListener) {
        C9971q.m14633g(tokenListener, "tokenListener");
