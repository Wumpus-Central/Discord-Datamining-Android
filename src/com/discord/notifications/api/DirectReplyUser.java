...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, DirectReplyUser$$serializer.INSTANCE.getDescriptor());
        }
        this.f9037id = userId.m42162unboximpl();
        if ((i & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z3 = false;
        output.mo13870t(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m42153boximpl(self.f9037id));
        ...
        if (z) {
            output.mo13874p(serialDesc, 1, C2500a2.f6719a, self.username);
        }
        ...
        if (z2) {
            output.mo13874p(serialDesc, 2, C2500a2.f6719a, self.discriminator);
        }
        if (output.mo13893A(serialDesc, 3) || self.avatar != null) {
            z3 = true;
        }
        if (z3) {
            output.mo13874p(serialDesc, 3, C2500a2.f6719a, self.avatar);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m42157equalsimpl0(this.f9037id, directReplyUser.f9037id) && C9677q.m14638b(this.username, directReplyUser.username) && C9677q.m14638b(this.discriminator, directReplyUser.discriminator) && C9677q.m14638b(this.avatar, directReplyUser.avatar);
    }
    ...
    public int hashCode() {
        int i = UserId.m42158hashCodeimpl(this.f9037id) * 31;
    ...
    public String toString() {
        String str = UserId.m42160toStringimpl(this.f9037id);
