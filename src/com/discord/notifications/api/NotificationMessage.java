...
public final class NotificationMessage {
    ...
    public /* synthetic */ NotificationMessage(int i, List list, SerializationConstructorMarker serializationConstructorMarker) {
        List<Sticker> i2;
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, NotificationMessage$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            i2 = C9906j.m14820i();
    ...
    public static final void write$Self(NotificationMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (!output.mo13893A(serialDesc, 0)) {
            ...
            i = C9906j.m14820i();
            if (C9971q.m14638b(list, i)) {
                z = false;
            }
        }
        if (z) {
            output.mo13870t(serialDesc, 0, new C3643f(Sticker$$serializer.INSTANCE), self.stickerItems);
        }
    }
    ...
    public final NotificationMessage copy(List<Sticker> stickerItems) {
        C9971q.m14633g(stickerItems, "stickerItems");
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof NotificationMessage) && C9971q.m14638b(this.stickerItems, ((NotificationMessage) obj).stickerItems);
    }

    public final Sticker getSticker() {
        Object W;
        W = C9914r.m14768W(this.stickerItems);
        return (Sticker) W;
    }
    ...
    public /* synthetic */ NotificationMessage(List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? C9906j.m14820i() : list);
    }
}
