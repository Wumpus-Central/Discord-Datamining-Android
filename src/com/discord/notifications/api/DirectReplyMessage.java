...
public final class DirectReplyMessage {
    ...
    private static final Json json = C10285k.m13694b(null, DirectReplyMessage$Companion$json$1.INSTANCE, 1, null);
    ...
    public static final class Companion {
        ...
        public final NotificationData toNotificationData(String data) {
            ...
            if (discriminator != null) {
                num = C12717t.m5747m(discriminator);
            } else {
                num = null;
            }
    ...
    private DirectReplyMessage(int i, String str, ChannelId channelId, DirectReplyUser directReplyUser, String str2, Integer num, Integer num2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i & 7)) {
            C3681n1.m33818b(i, 7, DirectReplyMessage$$serializer.INSTANCE.getDescriptor());
        }
        this.f7500id = str;
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z5 = false;
        output.mo13870t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m42115boximpl(self.f7500id));
        ...
        if (z) {
            output.mo13874p(serialDesc, 3, C3622a2.f5917a, self.content);
        }
        ...
        if (z2) {
            output.mo13874p(serialDesc, 4, C3676m0.f5992a, self.type);
        }
        ...
        if (z3) {
            output.mo13874p(serialDesc, 5, C3676m0.f5992a, self.channelType);
        }
        ...
        if (z4) {
            output.mo13874p(serialDesc, 6, C3622a2.f5917a, self.channelName);
        }
        if (output.mo13893A(serialDesc, 7) || self.guildName != null) {
            z5 = true;
        }
        if (z5) {
            output.mo13874p(serialDesc, 7, C3622a2.f5917a, self.guildName);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.f7500id, directReplyMessage.f7500id) && ChannelId.m42093equalsimpl0(this.channelId, directReplyMessage.channelId) && C9971q.m14638b(this.author, directReplyMessage.author) && C9971q.m14638b(this.content, directReplyMessage.content) && C9971q.m14638b(this.type, directReplyMessage.type) && C9971q.m14638b(this.channelType, directReplyMessage.channelType) && C9971q.m14638b(this.channelName, directReplyMessage.channelName) && C9971q.m14638b(this.guildName, directReplyMessage.guildName);
    }
    ...
    public int hashCode() {
        int i = ((((MessageId.m42120hashCodeimpl(this.f7500id) * 31) + ChannelId.m42094hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m42121toStringimpl(this.f7500id);
