...
public enum StickerType implements IntEnum {
    ...
    public static final class Serializer extends IntEnumSerializer<StickerType> {
        ...
        private Serializer() {
            super(C9951f0.m14684b(StickerType.class), null, 2, null);
        }
    }

    static {
        Lazy<KSerializer<Object>> b;
        b = C11084n.m10944b(EnumC11087p.PUBLICATION, StickerType$Companion$$cachedSerializer$delegate$1.INSTANCE);
