...
public final class GetPhotosData {
    ...
    public final WritableNativeMap toNativeMap() {
        ...
        while (it.hasNext()) {
            arrayList.add(NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("node", toNativeMap((ContentResolverMedia) it.next()))));
        }
        pairArr[0] = C10853x.m10921a("edges", NativeArrayExtensionsKt.toNativeArray(arrayList));
    ...
    private final WritableNativeMap toNativeMap(ContentResolverMedia contentResolverMedia) {
        return NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("type", String.valueOf(contentResolverMedia.getMediaType())), C10853x.m10921a("image", NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("uri", String.valueOf(contentResolverMedia.getUri())), C10853x.m10921a("mimeType", contentResolverMedia.getMimeType()), C10853x.m10921a("filename", contentResolverMedia.getName()), C10853x.m10921a("width", Integer.valueOf(contentResolverMedia.getWidth())), C10853x.m10921a("height", Integer.valueOf(contentResolverMedia.getHeight())), C10853x.m10921a("playableDuration", Integer.valueOf(contentResolverMedia.getDuration())))));
    }
}
