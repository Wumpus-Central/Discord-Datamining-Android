...
public final class CompressionProgressEvent implements ReactEvent {
    ...
    public /* synthetic */ CompressionProgressEvent(int i, String str, int i2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, CompressionProgressEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.uri = str;
        this.progress = i2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.uri, compressionProgressEvent.uri) && this.progress == compressionProgressEvent.progress;
    }
