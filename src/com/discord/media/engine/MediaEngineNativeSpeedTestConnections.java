...
public final class MediaEngineNativeSpeedTestConnections {
    ...
    @Metadata(m15074d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m15073d2 = {"Lcom/discord/media/engine/MediaEngineNativeSpeedTestConnections$Companion;", "", "()V", "TAG", "", "media_engine_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes5.dex */
    ...
    public final NativeSpeedTestConnection get(int i) {
    ...
    public final void removeAndDispose(int i) {
        Unit unit;
        NativeSpeedTestConnection remove = this.connections.remove(Integer.valueOf(i));
        if (remove != null) {
            System.nanoTime();
            remove.dispose();
            Debug debug = Debug.INSTANCE;
