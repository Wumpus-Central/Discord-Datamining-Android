...
public final class MediaEngine$setEmitVADLevel2$$inlined$post$default$1 extends AbstractC9679s implements Function0<Unit> {
    final /* synthetic */ boolean $enable$inlined;
    final /* synthetic */ MediaEngine this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MediaEngine$setEmitVADLevel2$$inlined$post$default$1(MediaEngine mediaEngine, boolean z) {
        super(0);
