...
public final class MediaEngineModule$addConnectionCallbacks$2 extends AbstractC9973s implements Function4<Integer, String, Integer, Integer, Unit> {
    final /* synthetic */ int $connectionId;
    final /* synthetic */ MediaEngineModule this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MediaEngineModule$addConnectionCallbacks$2(MediaEngineModule mediaEngineModule, int i) {
        super(4);
    ...
    public final void invoke(int i, String server, int i2, int i3) {
        ...
        reactEvents.emitModuleEvent(this.this$0.getReactContext(), new PingCallbackEvent(this.$connectionId, i, server, i2, i3));
    }
}
