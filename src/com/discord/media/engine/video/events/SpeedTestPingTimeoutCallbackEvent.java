...
public final class SpeedTestPingTimeoutCallbackEvent implements ReactEvent {
    ...
    public /* synthetic */ SpeedTestPingTimeoutCallbackEvent(int i, int i2, String str, int i3, int i4, int i5, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i & 31)) {
            C2560n1.m33818b(i, 31, SpeedTestPingTimeoutCallbackEvent$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == speedTestPingTimeoutCallbackEvent.connectionId && C9677q.m14638b(this.server, speedTestPingTimeoutCallbackEvent.server) && this.port == speedTestPingTimeoutCallbackEvent.port && this.seq == speedTestPingTimeoutCallbackEvent.seq && this.timeout == speedTestPingTimeoutCallbackEvent.timeout;
    }
