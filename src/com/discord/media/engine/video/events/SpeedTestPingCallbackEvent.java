...
public final class SpeedTestPingCallbackEvent implements ReactEvent {
    ...
    public /* synthetic */ SpeedTestPingCallbackEvent(int i, int i2, int i3, String str, int i4, int i5, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i & 31)) {
            C3681n1.m33818b(i, 31, SpeedTestPingCallbackEvent$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == speedTestPingCallbackEvent.connectionId && this.ping == speedTestPingCallbackEvent.ping && C9971q.m14638b(this.server, speedTestPingCallbackEvent.server) && this.port == speedTestPingCallbackEvent.port && this.seq == speedTestPingCallbackEvent.seq;
    }
