...
public final class OnReadyEvent$$serializer implements AbstractC2522f0<OnReadyEvent> {
    ...
    public void serialize(Encoder encoder, OnReadyEvent value) {
        ...
        OnReadyEvent.write$Self(value, b, descriptor2);
