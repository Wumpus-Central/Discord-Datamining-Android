...
public final class OnVoiceEvent implements ReactEvent {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/media/engine/video/events/OnVoiceEvent$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/media/engine/video/events/OnVoiceEvent;", "media_engine_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes5.dex */
    ...
    public static final void write$Self(OnVoiceEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13871s(serialDesc, 0, self.level);
        output.mo13866x(serialDesc, 1, self.speaking);
    }
    ...
    public /* synthetic */ OnVoiceEvent(int i, float f, int i2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, OnVoiceEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.level = f;
        this.speaking = i2;
    }
