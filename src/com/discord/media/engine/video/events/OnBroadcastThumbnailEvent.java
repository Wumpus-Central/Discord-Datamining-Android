...
public final class OnBroadcastThumbnailEvent implements ReactEvent {
    ...
    public /* synthetic */ OnBroadcastThumbnailEvent(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, OnBroadcastThumbnailEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.imgdata = str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnBroadcastThumbnailEvent) && C9971q.m14638b(this.imgdata, ((OnBroadcastThumbnailEvent) obj).imgdata);
    }
