...
public final class ActiveSinksChangeEvent implements ReactEvent {
    ...
    public /* synthetic */ ActiveSinksChangeEvent(int i, String str, boolean z, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, ActiveSinksChangeEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.streamId = str;
        this.active = z;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.streamId, activeSinksChangeEvent.streamId) && this.active == activeSinksChangeEvent.active;
    }
