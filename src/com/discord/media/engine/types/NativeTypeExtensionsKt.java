...
public final class NativeTypeExtensionsKt {
    ...
    public static final List<Map<String, Object>> toListOfMaps(AudioInputDeviceDescription[] audioInputDeviceDescriptionArr) {
        Map k;
        C9677q.m14633g(audioInputDeviceDescriptionArr, "<this>");
        ...
        for (AudioInputDeviceDescription audioInputDeviceDescription : audioInputDeviceDescriptionArr) {
            i++;
            k = C11053v.m10248k(C10853x.m10921a("name", audioInputDeviceDescription.getName()), C10853x.m10921a("guid", audioInputDeviceDescription.getGuid()), C10853x.m10921a("index", Integer.valueOf(i)));
            arrayList.add(k);
        }
        return arrayList;
    }
    ...
    public static final Map<String, Object> toMap(ConnectionInfo connectionInfo) {
        Map<String, Object> k;
        C9677q.m14633g(connectionInfo, "<this>");
        k = C11053v.m10248k(C10853x.m10921a("protocol", connectionInfo.getProtocol()), C10853x.m10921a("address", connectionInfo.getLocalAddress()), C10853x.m10921a("port", Integer.valueOf(connectionInfo.getLocalPort())));
        return k;
    }

    public static final List<Map<String, Object>> toListOfMaps(AudioOutputDeviceDescription[] audioOutputDeviceDescriptionArr) {
        Map k;
        C9677q.m14633g(audioOutputDeviceDescriptionArr, "<this>");
        ...
        for (AudioOutputDeviceDescription audioOutputDeviceDescription : audioOutputDeviceDescriptionArr) {
            i++;
            k = C11053v.m10248k(C10853x.m10921a("name", audioOutputDeviceDescription.getName()), C10853x.m10921a("guid", audioOutputDeviceDescription.getGuid()), C10853x.m10921a("index", Integer.valueOf(i)));
            arrayList.add(k);
        }
        return arrayList;
    }
    ...
    public static final List<Map<String, Object>> toListOfMaps(VideoInputDeviceDescription[] videoInputDeviceDescriptionArr) {
        ...
        int t;
        Map k;
        C9677q.m14633g(videoInputDeviceDescriptionArr, "<this>");
        ...
        W = C9618r.m14768W((List) pair.m15067a());
        W2 = C9618r.m14768W((List) pair.m15066b());
        l = C9610j.m14817l((VideoInputDeviceDescription) W, (VideoInputDeviceDescription) W2);
        R = C9618r.m14773R(l);
        t = C9611k.m14809t(R, 10);
        ...
        for (Object obj : R) {
            ...
            k = C11053v.m10248k(C10853x.m10921a("name", videoInputDeviceDescription2.getName()), C10853x.m10921a("guid", videoInputDeviceDescription2.getGuid()), C10853x.m10921a("facing", i3 != 1 ? i3 != 2 ? "unknown" : "back" : "front"), C10853x.m10921a("index", Integer.valueOf(i2)));
            arrayList3.add(k);
        }
        return arrayList3;
    }
