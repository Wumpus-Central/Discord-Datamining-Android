...
public final class MediaManagerModule extends ReactContextBaseJavaModule {
    ...
    private final ReactEvents reactEvents = new ReactEvents(C10853x.m10921a("compression-progress", C9656f0.m14684b(CompressionProgressEvent.class)));
    private final CoroutineScope scope = C9846k0.m14186b();
    ...
    public final void cancelResolveToMediaFilePath(String uri, ReadableMap readableMap, Promise promise) {
        ...
        C9677q.m14634f(parse, "parse(uri)");
    ...
    public final void downloadMediaAsset(String uri, int i, Promise promise) {
        C9677q.m14633g(uri, "uri");
        C9677q.m14633g(promise, "promise");
        C9851l.m14174d(this.scope, C9946y0.m13946b(), null, new MediaManagerModule$downloadMediaAsset$1(this, uri, promise, null), 2, null);
    }
    ...
    public Map<String, List<String>> getConstants() {
        ...
        l = C9610j.m14817l("mp4", "mov", "png", "jpg", "jpeg", "gif", "webp");
        e = C11052u.m10254e(C10853x.m10921a("supportedExtensions", l));
        return e;
    }
    ...
    public void invalidate() {
        super.invalidate();
        C9846k0.m14184d(this.scope, new CancellationException("Module destroyed"));
    }
    ...
    public final void resolveToMediaFilePath(String uri, ReadableMap readableMap, Promise promise) {
        ...
        C9851l.m14174d(this.scope, null, null, new MediaManagerModule$resolveToMediaFilePath$1(this, parse, i, companion.fromString(str), NativeMapExtensionsKt.getBoolean(readableMap, "isLowQuality", false), promise, NativeMapExtensionsKt.getBoolean(readableMap, "canCancelCompression", false), uri, null), 3, null);
    }
}
