...
@AbstractC9931e(m14702c = "com.discord.media.utils.MediaResolver$copyToFile$2", m14701f = "MediaResolver.kt", m14700l = {}, m14699m = "invokeSuspend")
/* loaded from: classes5.dex */
public final class MediaResolver$copyToFile$2 extends AbstractC9938k implements Function2<CoroutineScope, Continuation<? super Uri>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Uri> continuation) {
        return ((MediaResolver$copyToFile$2) create(coroutineScope, continuation)).invokeSuspend(Unit.f22042a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (inputStream != null) {
                try {
                    C9971q.m14634f(inputStream, "inputStream");
