...
public final class Transcoder {
    ...
    public final void cancel(String requestId) {
        C9677q.m14633g(requestId, "requestId");
    ...
    public final Object convertCompress(final String str, Context context, final DiscordVideoMediaSource discordVideoMediaSource, final Function1<? super Float, Unit> function1, Continuation<? super Uri> continuation) {
        ...
        mediaTransformer.m26471h(str, discordVideoMediaSource.getInputUri(), discordVideoMediaSource.getOutputUri(), discordVideoMediaSource.getVideoFormat(), discordVideoMediaSource.getAudioFormat(), new AbstractC7045a() { // from class: com.discord.media.utils.Transcoder$convertCompress$3$2
            @Override // ge.AbstractC7045a
            public void onCancelled(String id2, List<C7487a> list) {
            ...
            @Override // ge.AbstractC7045a
            public void onCompleted(String id2, List<C7487a> list) {
                C9677q.m14633g(id2, "id");
                mediaTransformer.m26474e();
                ...
                cancellableContinuation.resumeWith(C10845s.m10940b(discordVideoMediaSource.getOutputUri()));
            }

            @Override // ge.AbstractC7045a
            public void onError(String id2, Throwable th2, List<C7487a> list) {
                C9677q.m14633g(id2, "id");
                mediaTransformer.m26474e();
                Transcoder.cancelCallbacks.remove(str);
                CancellableContinuation<Uri> cancellableContinuation = pVar;
                ...
                cancellableContinuation.resumeWith(C10845s.m10940b(C10848t.m10931a(th2)));
            }
