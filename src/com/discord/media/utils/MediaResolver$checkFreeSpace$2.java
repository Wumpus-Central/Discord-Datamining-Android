...
@AbstractC9931e(m14702c = "com.discord.media.utils.MediaResolver$checkFreeSpace$2", m14701f = "MediaResolver.kt", m14700l = {}, m14699m = "invokeSuspend")
/* loaded from: classes5.dex */
public final class MediaResolver$checkFreeSpace$2 extends AbstractC9938k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MediaResolver$checkFreeSpace$2) create(coroutineScope, continuation)).invokeSuspend(Unit.f22042a);
    }
                ...
                if (listFiles2 != null) {
                    for (File file4 : listFiles2) {
                        if (file4.isFile()) {
                            ...
                            C9971q.m14634f(name, "cacheItem.name");
                            H = C12718u.m5736H(name, "temp_", false, 2, null);
                            if (H && file4.lastModified() < half_day_millis) {
                                file4.delete();
                            }
                        }
                        if (file4.isDirectory() && C9971q.m14638b(file4.getName(), "compressor") && (listFiles = file4.listFiles()) != null) {
                            C9971q.m14634f(listFiles, "listFiles()");
