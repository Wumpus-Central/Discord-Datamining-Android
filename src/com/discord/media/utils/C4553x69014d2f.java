...
final class C4553x69014d2f extends AbstractC9973s implements Function1<String, CharSequence> {
    public static final C4553x69014d2f INSTANCE = new C4553x69014d2f();
    ...
    public final CharSequence invoke(String mimeType) {
        C9971q.m14633g(mimeType, "mimeType");
        return "'" + mimeType + "'";
    }
}
