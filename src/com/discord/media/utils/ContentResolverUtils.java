...
public final class ContentResolverUtils {
    ...
    public final File createTempFile(ContentResolver contentResolver, Uri uri, String prefix, String str) {
        ...
        C9677q.m14634f(createTempFile, "createTempFile(prefix, \"….deleteOnExit()\n        }");
    ...
    public final boolean isHeif(ContentResolver contentResolver, Uri uri) {
        C9677q.m14633g(contentResolver, "<this>");
        C9677q.m14633g(uri, "uri");
        if (C9677q.m14638b(contentResolver.getType(uri), "image/heif") || C9677q.m14638b(contentResolver.getType(uri), "image/heic")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isImage(ContentResolver contentResolver, Uri uri) {
        ...
        H = C12587u.m5736H(type, "image", false, 2, null);
        if (H) {
            return true;
        }
        return false;
    ...
    public final boolean isJpeg(ContentResolver contentResolver, Uri uri) {
        C9677q.m14633g(contentResolver, "<this>");
        C9677q.m14633g(uri, "uri");
        if (C9677q.m14638b(contentResolver.getType(uri), "image/jpeg") || C9677q.m14638b(contentResolver.getType(uri), "image/jpg")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isPng(ContentResolver contentResolver, Uri uri) {
        C9677q.m14633g(contentResolver, "<this>");
        C9677q.m14633g(uri, "uri");
        return C9677q.m14638b(contentResolver.getType(uri), "image/png");
    }
    ...
    public final Cursor queryCompat(ContentResolver contentResolver, Uri queryUri, String[] queryProjection, int i, String querySort, String str, Integer num) {
        ...
        C9677q.m14633g(queryProjection, "queryProjection");
        C9677q.m14633g(querySort, "querySort");
