...
public final class ChatPackage implements ReactPackage {
    ...
    public List<ChatModule> createNativeModules(ReactApplicationContext reactContext) {
        ...
        o = C9906j.m14814o(new ChatModule(reactContext));
        return o;
    }
    ...
    public List<BaseViewManager<? extends ViewGroup, LayoutShadowNode>> createViewManagers(ReactApplicationContext reactContext) {
        ...
        C9971q.m14633g(reactContext, "reactContext");
        o = C9906j.m14814o(new ChatViewManager(), new ChatListViewManager(), new MessageViewManagers.MessageViewManager(), new MessageViewManagers.MessageBundleViewManager(), new MessageViewManagers.SystemMessageViewManager(), new MessageViewManagers.GuildMultilineSystemMessageViewManager());
        return o;
    }
}
