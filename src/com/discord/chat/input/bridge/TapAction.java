...
public final class TapAction {
    ...
    public /* synthetic */ TapAction(int i, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i & 7)) {
            C2560n1.m33818b(i, 7, TapAction$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
        this.channelId = str2;
    ...
    public final TapAction copy(String action, String channelId, String optionName) {
        ...
        C9677q.m14633g(optionName, "optionName");
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.action, tapAction.action) && C9677q.m14638b(this.channelId, tapAction.channelId) && C9677q.m14638b(this.optionName, tapAction.optionName);
    }
