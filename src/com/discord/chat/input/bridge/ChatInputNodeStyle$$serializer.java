...
public final class ChatInputNodeStyle$$serializer implements AbstractC2522f0<ChatInputNodeStyle> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14606a.m13u(m0Var), m0Var, C14606a.m13u(BackgroundStyle$$serializer.INSTANCE), C14606a.m13u(ChatInputNodeFontWeight.Companion.serializer())};
    }
    ...
    public ChatInputNodeStyle deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            obj3 = b.mo13852n(descriptor2, 0, C2555m0.f6794a, null);
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj4 = b.mo13852n(descriptor2, 0, C2555m0.f6794a, obj4);
                    i4 |= 1;
                } else if (o == 1) {
