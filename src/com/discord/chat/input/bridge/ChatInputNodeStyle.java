...
public final class ChatInputNodeStyle {
    ...
    public /* synthetic */ ChatInputNodeStyle(int i, Integer num, int i2, BackgroundStyle backgroundStyle, ChatInputNodeFontWeight chatInputNodeFontWeight, SerializationConstructorMarker serializationConstructorMarker) {
        if (6 != (i & 6)) {
            C2560n1.m33818b(i, 6, ChatInputNodeStyle$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.fontSize = null;
        } else {
    ...
    public static final void write$Self(ChatInputNodeStyle self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 0, C2555m0.f6794a, self.fontSize);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.fontSize, chatInputNodeStyle.fontSize) && this.color == chatInputNodeStyle.color && C9677q.m14638b(this.backgroundStyle, chatInputNodeStyle.backgroundStyle) && this.fontWeight == chatInputNodeStyle.fontWeight;
    }
