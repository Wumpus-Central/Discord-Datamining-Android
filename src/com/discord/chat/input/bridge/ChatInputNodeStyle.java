...
public final class ChatInputNodeStyle {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/input/bridge/ChatInputNodeStyle$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/input/bridge/ChatInputNodeStyle;", "chat_input_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ ChatInputNodeStyle(int i, Integer num, int i2, BackgroundStyle backgroundStyle, ChatInputNodeFontWeight chatInputNodeFontWeight, SerializationConstructorMarker serializationConstructorMarker) {
        if (6 != (i & 6)) {
            C3681n1.m33818b(i, 6, ChatInputNodeStyle$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.fontSize = null;
        } else {
    ...
    public static final void write$Self(ChatInputNodeStyle self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z2 = false;
        if (!output.mo13893A(serialDesc, 0) && self.fontSize == null) {
            z = false;
        } else {
            z = true;
        }
        if (z) {
            output.mo13874p(serialDesc, 0, C3676m0.f5992a, self.fontSize);
        }
        output.mo13866x(serialDesc, 1, self.color);
        output.mo13874p(serialDesc, 2, BackgroundStyle$$serializer.INSTANCE, self.backgroundStyle);
        if (output.mo13893A(serialDesc, 3) || self.fontWeight != null) {
            z2 = true;
        }
        if (z2) {
            output.mo13874p(serialDesc, 3, ChatInputNodeFontWeight.Companion.serializer(), self.fontWeight);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.fontSize, chatInputNodeStyle.fontSize) && this.color == chatInputNodeStyle.color && C9971q.m14638b(this.backgroundStyle, chatInputNodeStyle.backgroundStyle) && this.fontWeight == chatInputNodeStyle.fontWeight;
    }
    ...
    public int hashCode() {
        ...
        if (chatInputNodeFontWeight != null) {
            i = chatInputNodeFontWeight.hashCode();
        }
        return hashCode2 + i;
    }
