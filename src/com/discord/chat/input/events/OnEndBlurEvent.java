...
public final class OnEndBlurEvent implements ReactEvent {
    ...
    public /* synthetic */ OnEndBlurEvent(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, OnEndBlurEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.text = str;
    }

    public static /* synthetic */ OnEndBlurEvent copy$default(OnEndBlurEvent onEndBlurEvent, String str, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final void write$Self(OnEndBlurEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13864z(serialDesc, 0, self.text);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnEndBlurEvent) && C9971q.m14638b(this.text, ((OnEndBlurEvent) obj).text);
    }
