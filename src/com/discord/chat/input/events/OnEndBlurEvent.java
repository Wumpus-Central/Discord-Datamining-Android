...
public final class OnEndBlurEvent implements ReactEvent {
    ...
    public /* synthetic */ OnEndBlurEvent(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, OnEndBlurEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.text = str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnEndBlurEvent) && C9677q.m14638b(this.text, ((OnEndBlurEvent) obj).text);
    }
