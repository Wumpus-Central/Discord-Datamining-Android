...
public final class OnSelectionOrTextChangeEvent implements ReactEvent {
    ...
    public /* synthetic */ OnSelectionOrTextChangeEvent(int i, int i2, int i3, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C3681n1.m33818b(i, 15, OnSelectionOrTextChangeEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.start = i2;
        this.end = i3;
        this.text = str;
    ...
    public boolean equals(Object obj) {
        ...
        return this.start == onSelectionOrTextChangeEvent.start && this.end == onSelectionOrTextChangeEvent.end && C9971q.m14638b(this.text, onSelectionOrTextChangeEvent.text) && C9971q.m14638b(this.editId, onSelectionOrTextChangeEvent.editId);
    }
