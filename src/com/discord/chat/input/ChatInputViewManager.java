...
public final class ChatInputViewManager extends ViewGroupManager<ChatInputRootView> {
    private final ReactEvents reactEvents = new ReactEvents(C10853x.m10921a("onChangeContentSize", C9656f0.m14684b(OnContentSizeChangeEvent.class)), C10853x.m10921a("onEndBlur", C9656f0.m14684b(OnEndBlurEvent.class)), C10853x.m10921a("onBeginFocus", C9656f0.m14684b(FocusEvent.class)), C10853x.m10921a("onSelectionOrTextChange", C9656f0.m14684b(OnSelectionOrTextChangeEvent.class)), C10853x.m10921a("onPasteImage", C9656f0.m14684b(OnPasteImageEvent.class)), C10853x.m10921a("onRequestSend", C9656f0.m14684b(OnRequestSendEvent.class)));
    ...
    public static final class OnRequestSendEvent implements ReactEvent {
        ...
        public /* synthetic */ OnRequestSendEvent(int i, SerializationConstructorMarker serializationConstructorMarker) {
            if ((i & 0) != 0) {
                C2560n1.m33818b(i, 0, ChatInputViewManager$OnRequestSendEvent$$serializer.INSTANCE.getDescriptor());
            }
        }
    ...
    public final void placeholderColor(ChatInputRootView view, String placeholderColor) {
        C9677q.m14633g(view, "view");
        C9677q.m14633g(placeholderColor, "placeholderColor");
    ...
    public final void selectionColor(ChatInputRootView view, String selectionColor) {
        C9677q.m14633g(view, "view");
        C9677q.m14633g(selectionColor, "selectionColor");
    }
    ...
    public final void textColor(ChatInputRootView view, String textColor) {
        C9677q.m14633g(view, "view");
        C9677q.m14633g(textColor, "textColor");
