...
public final class TapInviteEvent implements ReactEvent {
    ...
    public /* synthetic */ TapInviteEvent(int i, String str, int i2, Boolean bool, Boolean bool2, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C2560n1.m33818b(i, 15, TapInviteEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.index = i2;
        this.primary = bool;
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.messageId, tapInviteEvent.messageId) && this.index == tapInviteEvent.index && C9677q.m14638b(this.primary, tapInviteEvent.primary) && C9677q.m14638b(this.secondary, tapInviteEvent.secondary);
    }
