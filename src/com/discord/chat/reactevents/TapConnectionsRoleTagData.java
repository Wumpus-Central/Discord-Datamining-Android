...
public final class TapConnectionsRoleTagData implements ReactEvent {
    ...
    public /* synthetic */ TapConnectionsRoleTagData(int i, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C3681n1.m33818b(i, 15, TapConnectionsRoleTagData$$serializer.INSTANCE.getDescriptor());
        }
        this.userId = str;
        this.guildId = str2;
        this.channelId = str3;
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.userId, tapConnectionsRoleTagData.userId) && C9971q.m14638b(this.guildId, tapConnectionsRoleTagData.guildId) && C9971q.m14638b(this.channelId, tapConnectionsRoleTagData.channelId) && C9971q.m14638b(this.roleId, tapConnectionsRoleTagData.roleId);
    }
