...
public final class LongPressChannelData implements ReactEvent {
    ...
    public /* synthetic */ LongPressChannelData(int i, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, LongPressChannelData$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.guildId = null;
        } else {
    ...
    public static final void write$Self(LongPressChannelData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z2) {
            output.mo13874p(serialDesc, 1, C3622a2.f5917a, self.channelId);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.guildId, longPressChannelData.guildId) && C9971q.m14638b(this.channelId, longPressChannelData.channelId) && C9971q.m14638b(this.messageId, longPressChannelData.messageId) && C9971q.m14638b(this.originalLink, longPressChannelData.originalLink);
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("data", NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("guildId", this.guildId), C11098x.m10921a("channelId", this.channelId), C11098x.m10921a("messageId", this.messageId), C11098x.m10921a("originalLink", this.originalLink))));
    }
