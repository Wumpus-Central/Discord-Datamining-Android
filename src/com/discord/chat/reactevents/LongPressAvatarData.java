...
public final class LongPressAvatarData implements ReactEvent {
    ...
    public /* synthetic */ LongPressAvatarData(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, LongPressAvatarData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.userId = str2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.messageId, longPressAvatarData.messageId) && C9971q.m14638b(this.userId, longPressAvatarData.userId);
    }
