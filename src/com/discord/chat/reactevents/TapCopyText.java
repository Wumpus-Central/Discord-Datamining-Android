...
public final class TapCopyText implements ReactEvent {
    ...
    public /* synthetic */ TapCopyText(int i, CharSequence charSequence, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, TapCopyText$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(TapCopyText self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 0, new C14365c(C9656f0.m14684b(CharSequence.class), new Annotation[0]), self.text);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapCopyText) && C9677q.m14638b(this.text, ((TapCopyText) obj).text);
    }
    ...
    public WritableNativeMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("text", this.text.toString()));
    }
}
