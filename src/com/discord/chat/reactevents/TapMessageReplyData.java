...
public final class TapMessageReplyData implements ReactEvent {
    ...
    public /* synthetic */ TapMessageReplyData(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, TapMessageReplyData$$serializer.INSTANCE.getDescriptor());
        }
        this.channelId = str;
        this.originId = str2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.channelId, tapMessageReplyData.channelId) && C9971q.m14638b(this.originId, tapMessageReplyData.originId);
    }
