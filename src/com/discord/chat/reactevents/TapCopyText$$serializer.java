...
public final class TapCopyText$$serializer implements AbstractC2522f0<TapCopyText> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{new C14365c(C9656f0.m14684b(CharSequence.class), new Annotation[0])};
    }
    ...
    public TapCopyText deserialize(Decoder decoder) {
        ...
        int i = 1;
        if (b.mo13850p()) {
            obj = b.mo13847y(descriptor2, 0, new C14365c(C9656f0.m14684b(CharSequence.class), new Annotation[0]), null);
        } else {
            int i2 = 0;
            obj = null;
            while (i != 0) {
                ...
                if (o == -1) {
                    ...
                    obj = b.mo13847y(descriptor2, 0, new C14365c(C9656f0.m14684b(CharSequence.class), new Annotation[0]), obj);
                    i2 |= 1;
                } else {
                    throw new C14382n(o);
                }
