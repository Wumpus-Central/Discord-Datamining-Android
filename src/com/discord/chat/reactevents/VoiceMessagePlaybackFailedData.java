...
public final class VoiceMessagePlaybackFailedData implements ReactEvent {
    ...
    private VoiceMessagePlaybackFailedData(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, VoiceMessagePlaybackFailedData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
    ...
    public static final void write$Self(VoiceMessagePlaybackFailedData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13874p(serialDesc, 1, C3622a2.f5917a, self.errorMessage);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, voiceMessagePlaybackFailedData.messageId) && C9971q.m14638b(this.errorMessage, voiceMessagePlaybackFailedData.errorMessage);
    }
