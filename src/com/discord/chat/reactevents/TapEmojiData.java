...
public final class TapEmojiData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapEmojiData) && C9677q.m14638b(this.emoji, ((TapEmojiData) obj).emoji);
    }
    ...
    public WritableMap serialize() {
        ...
        if (emojiContentNode instanceof UnicodeEmojiContentNode) {
            writableNativeMap = NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("surrogate", ((UnicodeEmojiContentNode) emojiContentNode).getSurrogate()), C10853x.m10921a("content", ((UnicodeEmojiContentNode) this.emoji).getContent()));
        } else if (emojiContentNode instanceof CustomEmojiContentNode) {
            writableNativeMap = NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("id", String.valueOf(((CustomEmojiContentNode) emojiContentNode).getId())), C10853x.m10921a("alt", ((CustomEmojiContentNode) this.emoji).getAlt()), C10853x.m10921a("src", ((CustomEmojiContentNode) this.emoji).getSrc()));
        } else {
            throw new C10843q();
        }
        pairArr[0] = C10853x.m10921a("node", writableNativeMap);
