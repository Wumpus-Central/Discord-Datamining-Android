...
public final class TapReactionData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, tapReactionData.messageId) && C9971q.m14638b(this.reaction, tapReactionData.reaction) && C9971q.m14638b(this.isBurst, tapReactionData.isBurst);
    }
    ...
    public WritableMap serialize() {
        ...
        ReactionView.Reaction reaction = this.reaction;
        if (reaction != null) {
            writableNativeMap = NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("emoji", NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("name", reaction.getEmoji().getName()), C11098x.m10921a("id", this.reaction.getEmoji().getId()))), C11098x.m10921a("me", Boolean.valueOf(this.reaction.isMe())), C11098x.m10921a("me_burst", Boolean.valueOf(this.reaction.isMeBurst())));
        } else {
            writableNativeMap = null;
        }
        Pair[] pairArr = new Pair[3];
        pairArr[0] = C11098x.m10921a("messageId", this.messageId);
        pairArr[1] = C11098x.m10921a("reaction", writableNativeMap);
        ...
        pairArr[2] = C11098x.m10921a("isBurst", bool);
