...
public final class TapReactionData implements ReactEvent {
    ...
    public static /* synthetic */ TapReactionData m41945copyu7_MRrM$default(TapReactionData tapReactionData, String str, ReactionView.Reaction reaction, Boolean bool, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return tapReactionData.m41947copyu7_MRrM(str, reaction, bool);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m41946component13Eiw7ao() {
    ...
    public final TapReactionData m41947copyu7_MRrM(String messageId, ReactionView.Reaction reaction, Boolean bool) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, tapReactionData.messageId) && C9677q.m14638b(this.reaction, tapReactionData.reaction) && C9677q.m14638b(this.isBurst, tapReactionData.isBurst);
    }

    /* renamed from: getMessageId-3Eiw7ao  reason: not valid java name */
    public final String m41948getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode = (i + (reaction == null ? 0 : reaction.hashCode())) * 31;
    ...
    public WritableMap serialize() {
        ...
        ReactionView.Reaction reaction = this.reaction;
        if (reaction != null) {
            writableNativeMap = NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("emoji", NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("name", reaction.getEmoji().getName()), C10853x.m10921a("id", this.reaction.getEmoji().getId()))), C10853x.m10921a("me", Boolean.valueOf(this.reaction.isMe())), C10853x.m10921a("me_burst", Boolean.valueOf(this.reaction.isMeBurst())));
        } else {
            writableNativeMap = null;
        }
        Pair[] pairArr = new Pair[3];
        pairArr[0] = C10853x.m10921a("messageId", this.messageId);
        pairArr[1] = C10853x.m10921a("reaction", writableNativeMap);
        ...
        pairArr[2] = C10853x.m10921a("isBurst", bool);
