...
public final class LongPressReactionData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, longPressReactionData.messageId) && ChannelId.m42093equalsimpl0(this.channelId, longPressReactionData.channelId) && C9677q.m14638b(this.reaction, longPressReactionData.reaction);
    }
    ...
    public WritableMap serialize() {
        ...
        Boolean bool = null;
        if (reaction != null) {
            writableNativeMap = NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("emoji", NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("name", reaction.getEmoji().getName()), C10853x.m10921a("id", this.reaction.getEmoji().getId()))), C10853x.m10921a("me", Boolean.valueOf(this.reaction.isMe())));
        } else {
            writableNativeMap = null;
        }
        Pair[] pairArr = new Pair[4];
        pairArr[0] = C10853x.m10921a("messageId", this.messageId);
        pairArr[1] = C10853x.m10921a("channelId", ChannelId.m42096toStringimpl(this.channelId));
        pairArr[2] = C10853x.m10921a("reaction", writableNativeMap);
        ReactionView.Reaction reaction2 = this.reaction;
        if (reaction2 != null) {
            bool = Boolean.valueOf(reaction2.isBurstReaction());
        }
        pairArr[3] = C10853x.m10921a("isBurst", bool);
