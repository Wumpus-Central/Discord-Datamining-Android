...
public final class TapCallData implements ReactEvent {
    ...
    private TapCallData(int i, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, TapCallData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("data", NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("messageId", MessageId.m42121toStringimpl(this.messageId)), C11098x.m10921a("channelId", ChannelId.m42096toStringimpl(this.channelId)))));
    }
