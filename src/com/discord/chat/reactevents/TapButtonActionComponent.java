...
public final class TapButtonActionComponent implements ReactEvent {
    ...
    private TapButtonActionComponent(int i, String str, double d, String str2, ApplicationId applicationId, int[] iArr, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i & 31)) {
            C3681n1.m33818b(i, 31, TapButtonActionComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.messageFlags = d;
        this.customId = str2;
    ...
    public static final void write$Self(TapButtonActionComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13874p(serialDesc, 2, C3622a2.f5917a, self.customId);
        output.mo13870t(serialDesc, 3, ApplicationId$$serializer.INSTANCE, ApplicationId.m42076boximpl(self.applicationId));
        output.mo13870t(serialDesc, 4, C10259f.f22536c, self.indices);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, tapButtonActionComponent.messageId) && Double.compare(this.messageFlags, tapButtonActionComponent.messageFlags) == 0 && C9971q.m14638b(this.customId, tapButtonActionComponent.customId) && ApplicationId.m42080equalsimpl0(this.applicationId, tapButtonActionComponent.applicationId) && C9971q.m14638b(this.indices, tapButtonActionComponent.indices);
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("messageId", MessageId.m42121toStringimpl(this.messageId)), C11098x.m10921a("messageFlags", Double.valueOf(this.messageFlags)), C11098x.m10921a("customId", this.customId), C11098x.m10921a("applicationId", ApplicationId.m42083toStringimpl(this.applicationId)), C11098x.m10921a("indices", NativeArrayExtensionsKt.toNativeArray(this.indices)));
    }
