...
public final class LongPressStickerData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, longPressStickerData.messageId) && C9677q.m14638b(this.sticker, longPressStickerData.sticker);
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("messageId", this.messageId), C10853x.m10921a("sticker", NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("id", String.valueOf(this.sticker.getId())), C10853x.m10921a("name", this.sticker.getName()))));
    }
