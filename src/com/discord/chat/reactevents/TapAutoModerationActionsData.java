...
public final class TapAutoModerationActionsData implements ReactEvent {
    ...
    public /* synthetic */ TapAutoModerationActionsData(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, TapAutoModerationActionsData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.channelId = str2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.messageId, tapAutoModerationActionsData.messageId) && C9677q.m14638b(this.channelId, tapAutoModerationActionsData.channelId);
    }
