...
public final class OnTapReplyItemData implements ReactEvent {
    ...
    private OnTapReplyItemData(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, OnTapReplyItemData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
    }

    public /* synthetic */ OnTapReplyItemData(int i, String str, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static /* synthetic */ OnTapReplyItemData m41909copy1xi1bu0$default(OnTapReplyItemData onTapReplyItemData, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = onTapReplyItemData.messageId;
        }
        return onTapReplyItemData.m41911copy1xi1bu0(str);
    }
    ...
    public final OnTapReplyItemData m41911copy1xi1bu0(String messageId) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnTapReplyItemData) && MessageId.m42119equalsimpl0(this.messageId, ((OnTapReplyItemData) obj).messageId);
    }
