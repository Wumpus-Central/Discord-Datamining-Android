...
public final class LongPressMessageEvent implements ReactEvent {
    ...
    public /* synthetic */ LongPressMessageEvent(int i, String str, String str2, int i2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C2560n1.m33818b(i, 15, LongPressMessageEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.channelId = str2;
        this.mediaIndex = i2;
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.messageId, longPressMessageEvent.messageId) && C9677q.m14638b(this.channelId, longPressMessageEvent.channelId) && this.mediaIndex == longPressMessageEvent.mediaIndex && C9677q.m14638b(this.mediaType, longPressMessageEvent.mediaType);
    }
