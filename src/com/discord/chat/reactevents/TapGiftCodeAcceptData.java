...
public final class TapGiftCodeAcceptData implements ReactEvent {
    ...
    public /* synthetic */ TapGiftCodeAcceptData(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, TapGiftCodeAcceptData$$serializer.INSTANCE.getDescriptor());
        }
        this.giftCode = str;
    }

    public static /* synthetic */ TapGiftCodeAcceptData copy$default(TapGiftCodeAcceptData tapGiftCodeAcceptData, String str, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapGiftCodeAcceptData) && C9971q.m14638b(this.giftCode, ((TapGiftCodeAcceptData) obj).giftCode);
    }
