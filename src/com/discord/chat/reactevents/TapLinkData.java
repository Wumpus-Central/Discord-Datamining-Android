...
public final class TapLinkData implements ReactEvent {
    ...
    public static /* synthetic */ TapLinkData m41937copyfCSJrew$default(TapLinkData tapLinkData, String str, String str2, String str3, String str4, LinkContext linkContext, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return tapLinkData.m41939copyfCSJrew(str, str2, str3, str4, linkContext);
    }
                    ...
                    if (str.equals("webhookNameOnClick")) {
                        ...
                        if (webhookNameOnClick != null) {
                            ...
                            if (messageReference != null) {
                                ...
                                NativeMapExtensionsKt.put(nativeMapOf2, "channel_id", ChannelId.m42096toStringimpl(messageReference.m41639getChannelIdo4g7jtM()));
                                GuildId guildId = messageReference.m41640getGuildIdqOKuAAo();
                                if (guildId != null) {
                ...
                case -933189749:
                    if (str.equals("pinsOnClick")) {
                        ...
                        if (pinsOnClick != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m42096toStringimpl(pinsOnClick.m41644getMessageChannelIdo4g7jtM()));
                            break;
                        }
                    }
                    break;
                case -932369101:
                    if (str.equals("usernameOnClick")) {
                        ...
                        if (usernameOnClick != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m42160toStringimpl(usernameOnClick.m41654getUserIdre6GcUE()));
                            ChannelId channelId = usernameOnClick.m41653getMessageChannelIdqMVnFVQ();
                            if (channelId != null) {
                                NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m42096toStringimpl(channelId.m42098unboximpl()));
                                break;
                            }
                        }
                    }
                ...
                case 371724472:
                    if (str.equals("actorHook")) {
                        ...
                        if (actorHook != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m42160toStringimpl(actorHook.m41604getUserIdre6GcUE()));
                            break;
                        }
                    }
                    break;
                case 1318937603:
                    if (str.equals("otherUsernameOnClick")) {
                        ...
                        if (otherUsernameOnClick != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m42160toStringimpl(otherUsernameOnClick.m41654getUserIdre6GcUE()));
                            ChannelId channelId2 = otherUsernameOnClick.m41653getMessageChannelIdqMVnFVQ();
                            if (channelId2 != null) {
                                NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m42096toStringimpl(channelId2.m42098unboximpl()));
                                break;
                            }
                        }
                    }
                ...
                case 2071245203:
                    if (str.equals("commandNameOnClick")) {
                        ...
                        if (commandNameOnClick != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "userId", String.valueOf(commandNameOnClick.m41618getUserIdwUX8bhU()));
                            ...
                            String str2 = commandNameOnClick.m41617getMessageIdN_6c4I0();
                            NativeMapExtensionsKt.put(nativeMapOf, "messageId", str2 == null ? "null" : MessageId.m42121toStringimpl(str2));
                            NativeMapExtensionsKt.put(nativeMapOf, "applicationUserId", String.valueOf(commandNameOnClick.m41615getApplicationUserIdwUX8bhU()));
                            NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", String.valueOf(commandNameOnClick.m41616getMessageChannelIdqMVnFVQ()));
                            break;
                        }
                    }
                    break;
    ...
    public final String m41938component1N_6c4I0() {
    ...
    */
    ...
    public final String m41940getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        int i = 0;
        int i2 = (str == null ? 0 : MessageId.m42120hashCodeimpl(str)) * 31;
    ...
    public String toString() {
        String str = this.messageId;
        String str2 = str == null ? "null" : MessageId.m42121toStringimpl(str);
