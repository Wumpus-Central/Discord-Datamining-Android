...
public final class LongPressLinkData$$serializer implements AbstractC2522f0<LongPressLinkData> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{C14606a.m13u(C2500a2.f6719a)};
    }
    ...
    public LongPressLinkData deserialize(Decoder decoder) {
        ...
        int i = 1;
        if (b.mo13850p()) {
            obj = b.mo13852n(descriptor2, 0, C2500a2.f6719a, null);
        } else {
            int i2 = 0;
            obj = null;
            while (i != 0) {
                ...
                if (o == -1) {
                    ...
                    obj = b.mo13852n(descriptor2, 0, C2500a2.f6719a, obj);
                    i2 |= 1;
                } else {
                    throw new C14382n(o);
                }
