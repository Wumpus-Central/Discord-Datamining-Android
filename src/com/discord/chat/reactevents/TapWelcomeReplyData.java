...
public final class TapWelcomeReplyData implements ReactEvent {
    ...
    public static /* synthetic */ TapWelcomeReplyData m41961copyAyv7vGE$default(TapWelcomeReplyData tapWelcomeReplyData, long j, String str, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return tapWelcomeReplyData.m41963copyAyv7vGE(j, str);
    }
    ...
    public final String m41962component23Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: copy-Ayv7vGE  reason: not valid java name */
    public final TapWelcomeReplyData m41963copyAyv7vGE(long j, String messageId) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.stickerId == tapWelcomeReplyData.stickerId && MessageId.m42119equalsimpl0(this.messageId, tapWelcomeReplyData.messageId);
    }

    /* renamed from: getMessageId-3Eiw7ao  reason: not valid java name */
    public final String m41964getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        return (C2968a.m32873a(this.stickerId) * 31) + MessageId.m42120hashCodeimpl(this.messageId);
    }

    @Override // com.discord.reactevents.ReactEvent
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C10853x.m10921a("messageId", MessageId.m42121toStringimpl(this.messageId)), C10853x.m10921a("stickerId", String.valueOf(this.stickerId)));
    }

    public String toString() {
        long j = this.stickerId;
        String str = MessageId.m42121toStringimpl(this.messageId);
        return "TapWelcomeReplyData(stickerId=" + j + ", messageId=" + str + ")";
    }
}
