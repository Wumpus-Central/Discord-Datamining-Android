...
public final class TapCommandData implements ReactEvent {
    ...
    public /* synthetic */ TapCommandData(int i, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C3681n1.m33818b(i, 15, TapCommandData$$serializer.INSTANCE.getDescriptor());
        }
        this.channelId = str;
        this.commandId = str2;
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.channelId, tapCommandData.channelId) && C9971q.m14638b(this.commandId, tapCommandData.commandId) && C9971q.m14638b(this.commandName, tapCommandData.commandName) && C9971q.m14638b(this.commandKey, tapCommandData.commandKey);
    }
