...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo41710onTapActivityLauncherEmbeduU1mFKc(long j, long j2) {
        this.emitReactEvent.invoke(new TapActivityLauncherEmbedData(ApplicationId.m42083toStringimpl(j), ChannelId.m42096toStringimpl(j2)));
    }
    ...
    public void mo41727onTapShareForumPostmgk6anA(long j, long j2) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m42096toStringimpl(j), GuildId.m42109toStringimpl(j2)));
    }
