...
public final class LongPressCommandData implements ReactEvent {
    ...
    public /* synthetic */ LongPressCommandData(int i, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C2560n1.m33818b(i, 15, LongPressCommandData$$serializer.INSTANCE.getDescriptor());
        }
        this.channelId = str;
        this.commandId = str2;
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.channelId, longPressCommandData.channelId) && C9677q.m14638b(this.commandId, longPressCommandData.commandId) && C9677q.m14638b(this.commandName, longPressCommandData.commandName) && C9677q.m14638b(this.commandKey, longPressCommandData.commandKey);
    }
