...
public final class VoiceMessagePlaybackStartedData implements ReactEvent {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/reactevents/VoiceMessagePlaybackStartedData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/reactevents/VoiceMessagePlaybackStartedData;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    private VoiceMessagePlaybackStartedData(int i, String str, float f, float f2, UserId userId, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C3681n1.m33818b(i, 15, VoiceMessagePlaybackStartedData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
    ...
    public static /* synthetic */ VoiceMessagePlaybackStartedData m41975copyOuNwOLg$default(VoiceMessagePlaybackStartedData voiceMessagePlaybackStartedData, String str, float f, float f2, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return voiceMessagePlaybackStartedData.m41978copyOuNwOLg(str, f, f2, j);
    }
    ...
    public final long m41977component4re6GcUE() {
        return this.senderUserId;
    }

    /* renamed from: copy-OuNwOLg  reason: not valid java name */
    public final VoiceMessagePlaybackStartedData m41978copyOuNwOLg(String messageId, float f, float f2, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, voiceMessagePlaybackStartedData.messageId) && Float.compare(this.totalDurationSecs, voiceMessagePlaybackStartedData.totalDurationSecs) == 0 && Float.compare(this.startDurationSecs, voiceMessagePlaybackStartedData.startDurationSecs) == 0 && UserId.m42157equalsimpl0(this.senderUserId, voiceMessagePlaybackStartedData.senderUserId);
    }

    /* renamed from: getMessageId-3Eiw7ao  reason: not valid java name */
    public final String m41979getMessageId3Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: getSenderUserId-re6GcUE  reason: not valid java name */
    public final long m41980getSenderUserIdre6GcUE() {
        return this.senderUserId;
    }
    ...
    public int hashCode() {
        return (((((MessageId.m42120hashCodeimpl(this.messageId) * 31) + Float.floatToIntBits(this.totalDurationSecs)) * 31) + Float.floatToIntBits(this.startDurationSecs)) * 31) + UserId.m42158hashCodeimpl(this.senderUserId);
    }
    ...
    public String toString() {
        ...
        return "VoiceMessagePlaybackStartedData(messageId=" + str + ", totalDurationSecs=" + f + ", startDurationSecs=" + f2 + ", senderUserId=" + str2 + ")";
    }
