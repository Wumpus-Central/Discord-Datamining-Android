...
public final class InitiateReplyData implements ReactEvent {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/reactevents/InitiateReplyData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/reactevents/InitiateReplyData;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    private InitiateReplyData(int i, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, InitiateReplyData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.channelId = channelId.m42098unboximpl();
    }

    public /* synthetic */ InitiateReplyData(int i, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, str, channelId, serializationConstructorMarker);
    }

    public /* synthetic */ InitiateReplyData(String str, long j, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, j);
    }

    /* renamed from: copy-pfaIj0E$default  reason: not valid java name */
    public static /* synthetic */ InitiateReplyData m41893copypfaIj0E$default(InitiateReplyData initiateReplyData, String str, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return initiateReplyData.m41896copypfaIj0E(str, j);
    }
    ...
    public final InitiateReplyData m41896copypfaIj0E(String messageId, long j) {
        C9677q.m14633g(messageId, "messageId");
        return new InitiateReplyData(messageId, j, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.messageId, initiateReplyData.messageId) && ChannelId.m42093equalsimpl0(this.channelId, initiateReplyData.channelId);
    }
    ...
    private InitiateReplyData(String str, long j) {
        this.messageId = str;
        this.channelId = j;
    }
}
