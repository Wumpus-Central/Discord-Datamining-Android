...
public final class TapPostPreviewEmbedData implements ReactEvent {
    ...
    private TapPostPreviewEmbedData(int i, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C3681n1.m33818b(i, 15, TapPostPreviewEmbedData$$serializer.INSTANCE.getDescriptor());
        }
        this.guildId = str;
    ...
    public final TapPostPreviewEmbedData m41943copywInV0_I(String guildId, String parentChannelId, String threadId, String messageId) {
        ...
        C9971q.m14633g(parentChannelId, "parentChannelId");
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.guildId, tapPostPreviewEmbedData.guildId) && C9971q.m14638b(this.parentChannelId, tapPostPreviewEmbedData.parentChannelId) && C9971q.m14638b(this.threadId, tapPostPreviewEmbedData.threadId) && MessageId.m42119equalsimpl0(this.messageId, tapPostPreviewEmbedData.messageId);
    }
