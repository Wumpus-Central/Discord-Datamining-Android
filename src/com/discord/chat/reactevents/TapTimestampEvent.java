...
public final class TapTimestampEvent implements ReactEvent {
    ...
    public /* synthetic */ TapTimestampEvent(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, TapTimestampEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.timestamp = str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapTimestampEvent) && C9971q.m14638b(this.timestamp, ((TapTimestampEvent) obj).timestamp);
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("node", NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("full", this.timestamp))));
    }
