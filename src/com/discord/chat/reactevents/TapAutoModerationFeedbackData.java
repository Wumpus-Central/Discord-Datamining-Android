...
public final class TapAutoModerationFeedbackData implements ReactEvent {
    ...
    public /* synthetic */ TapAutoModerationFeedbackData(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, TapAutoModerationFeedbackData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
        this.channelId = str2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.messageId, tapAutoModerationFeedbackData.messageId) && C9677q.m14638b(this.channelId, tapAutoModerationFeedbackData.channelId);
    }
