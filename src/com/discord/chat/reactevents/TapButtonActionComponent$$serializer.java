...
public final class TapButtonActionComponent$$serializer implements AbstractC3644f0<TapButtonActionComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MessageId$$serializer.INSTANCE, C3712x.f6038a, C14667a.m13u(C3622a2.f5917a), ApplicationId$$serializer.INSTANCE, C10259f.f22536c};
    }
    ...
    public TapButtonActionComponent deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj2 = b.mo13847y(descriptor2, 4, C10259f.f22536c, null);
            i = 31;
        } else {
            double d2 = 0.0d;
            boolean z = true;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj7 = b.mo13847y(descriptor2, 4, C10259f.f22536c, obj7);
                    i2 |= 16;
                } else {
                    throw new C14447n(o);
                }
