...
public final class TapChannelData implements ReactEvent {
    ...
    public /* synthetic */ TapChannelData(int i, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, TapChannelData$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.guildId = null;
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.guildId, tapChannelData.guildId) && C9971q.m14638b(this.channelId, tapChannelData.channelId) && C9971q.m14638b(this.messageId, tapChannelData.messageId);
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("data", NativeMapExtensionsKt.nativeMapOf(C11098x.m10921a("guildId", this.guildId), C11098x.m10921a("channelId", this.channelId), C11098x.m10921a("messageId", this.messageId))));
    }
