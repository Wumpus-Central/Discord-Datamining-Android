...
public final class ExecutedCommand {
    ...
    private ExecutedCommand(int i, UserId userId, int i2, String str, AnnotatedStructurableText annotatedStructurableText, SerializationConstructorMarker serializationConstructorMarker) {
        if (11 != (i & 11)) {
            C2560n1.m33818b(i, 11, ExecutedCommand$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(ExecutedCommand self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 2, C2500a2.f6719a, self.avatarURL);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m42157equalsimpl0(this.userId, executedCommand.userId) && this.usernameColor == executedCommand.usernameColor && C9677q.m14638b(this.avatarURL, executedCommand.avatarURL) && C9677q.m14638b(this.content, executedCommand.content);
    }
