...
public final class ErrorMessage extends MessageBase {
    ...
    private ErrorMessage(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, ErrorMessage$$serializer.INSTANCE.getDescriptor());
        }
        this.f8423id = str;
    ...
    public static final void write$Self(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m42115boximpl(self.f8423id));
    ...
    public final ErrorMessage m41567copyntcYbpo(String id2, String stackTrace) {
        ...
        C9677q.m14633g(stackTrace, "stackTrace");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.f8423id, errorMessage.f8423id) && C9677q.m14638b(this.stackTrace, errorMessage.stackTrace);
    }
    ...
    public int hashCode() {
        return (MessageId.m42120hashCodeimpl(this.f8423id) * 31) + this.stackTrace.hashCode();
    }

    public String toString() {
        String str = MessageId.m42121toStringimpl(this.f8423id);
