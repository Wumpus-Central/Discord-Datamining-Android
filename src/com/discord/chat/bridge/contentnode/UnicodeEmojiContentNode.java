...
public final class UnicodeEmojiContentNode extends EmojiContentNode {
    ...
    public /* synthetic */ UnicodeEmojiContentNode(int i, String str, String str2, boolean z, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, UnicodeEmojiContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.content = str;
        this.surrogate = str2;
        if ((i & 4) == 0) {
    ...
    public final UnicodeEmojiContentNode copy(String content, String surrogate, boolean z) {
        ...
        C9677q.m14633g(surrogate, "surrogate");
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.content, unicodeEmojiContentNode.content) && C9677q.m14638b(this.surrogate, unicodeEmojiContentNode.surrogate) && getJumboable() == unicodeEmojiContentNode.getJumboable();
    }
