...
public final class LinkContext$$serializer implements AbstractC3644f0<LinkContext> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14667a.m13u(userNameOnClick$$serializer), C14667a.m13u(userNameOnClick$$serializer), C14667a.m13u(CommandOnClick$$serializer.INSTANCE), C14667a.m13u(ActorHook$$serializer.INSTANCE), C14667a.m13u(ThreadOnClick$$serializer.INSTANCE), C14667a.m13u(PinsOnClick$$serializer.INSTANCE), C14667a.m13u(WebhookNameOnClick$$serializer.INSTANCE), C14667a.m13u(HandleDelete$$serializer.INSTANCE), C14667a.m13u(RoleSubscriptionOnClick$$serializer.INSTANCE), C14667a.m13u(HandleMessage$$serializer.INSTANCE)};
    }
