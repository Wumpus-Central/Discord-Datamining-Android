...
public final class CommandMentionContentNode$$serializer implements AbstractC2522f0<CommandMentionContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{ChannelId$$serializer.INSTANCE, a2Var, a2Var, a2Var, new C2521f(ContentNodeSerializer.INSTANCE)};
    }
    ...
    public CommandMentionContentNode deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj = b.mo13847y(descriptor2, 4, new C2521f(ContentNodeSerializer.INSTANCE), null);
            i = 31;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj = b.mo13847y(descriptor2, 4, new C2521f(ContentNodeSerializer.INSTANCE), obj);
                    i2 |= 16;
                } else {
                    throw new C14382n(o);
                }
