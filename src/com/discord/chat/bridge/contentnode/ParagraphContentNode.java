...
public final class ParagraphContentNode extends ContentNode {
    ...
    public /* synthetic */ ParagraphContentNode(int i, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, ParagraphContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.content = list;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ ParagraphContentNode copy$default(ParagraphContentNode paragraphContentNode, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ParagraphContentNode) && C9971q.m14638b(this.content, ((ParagraphContentNode) obj).content);
    }
