...
public final class ContentNodeSerializer implements KSerializer<ContentNode> {
    ...
    public SerialDescriptor getDescriptor() {
        return C0207g.m41131a("ContentNode", AbstractC0192e.C0201i.f537a);
    }
    ...
    public ContentNode deserialize(Decoder decoder) {
        ...
        try {
            if (decoder instanceof AbstractC9993e) {
                ...
                return (ContentNode) ((AbstractC9993e) decoder).mo13730d().m13766d(ContentNodeKt.access$getSealedClassSerializer$p(), g);
            }
