...
public final class HandleSurveyMessage {
    ...
    private HandleSurveyMessage(int i, String str, ChannelId channelId, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, HandleSurveyMessage$$serializer.INSTANCE.getDescriptor());
        }
        this.f8430id = str;
    ...
    public static /* synthetic */ HandleSurveyMessage m41626copyEqy5D80$default(HandleSurveyMessage handleSurveyMessage, String str, long j, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = handleSurveyMessage.f8430id;
        }
        if ((i & 2) != 0) {
    ...
    public static final void write$Self(HandleSurveyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z = false;
        output.mo13870t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m42115boximpl(self.f8430id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.f8430id, handleSurveyMessage.f8430id) && ChannelId.m42093equalsimpl0(this.channelId, handleSurveyMessage.channelId) && C9677q.m14638b(this.loggingName, handleSurveyMessage.loggingName);
    }
    ...
    public int hashCode() {
        int i = ((MessageId.m42120hashCodeimpl(this.f8430id) * 31) + ChannelId.m42094hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return i + (str == null ? 0 : str.hashCode());
    }

    public String toString() {
        String str = MessageId.m42121toStringimpl(this.f8430id);
