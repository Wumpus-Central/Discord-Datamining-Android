...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    private CommandMentionContentNode(int i, ChannelId channelId, String str, String str2, String str3, List<? extends ContentNode> list, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (31 != (i & 31)) {
            C3681n1.m33818b(i, 31, CommandMentionContentNode$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(CommandMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 4, new C3643f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ChannelId.m42093equalsimpl0(this.channelId, commandMentionContentNode.channelId) && C9971q.m14638b(this.commandId, commandMentionContentNode.commandId) && C9971q.m14638b(this.commandName, commandMentionContentNode.commandName) && C9971q.m14638b(this.commandKey, commandMentionContentNode.commandKey) && C9971q.m14638b(getContent(), commandMentionContentNode.getContent());
    }
