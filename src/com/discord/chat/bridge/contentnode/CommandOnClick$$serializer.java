...
public final class CommandOnClick$$serializer implements AbstractC3644f0<CommandOnClick> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14667a.m13u(C3622a2.f5917a), C14667a.m13u(userId$$serializer), C14667a.m13u(MessageId$$serializer.INSTANCE), C14667a.m13u(userId$$serializer), C14667a.m13u(MessageType.Serializer.INSTANCE), C14667a.m13u(ChannelId$$serializer.INSTANCE)};
    }
    ...
    public CommandOnClick deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            obj6 = b.mo13852n(descriptor2, 0, C3622a2.f5917a, null);
            UserId$$serializer userId$$serializer = UserId$$serializer.INSTANCE;
            ...
            while (z) {
                ...
                switch (o) {
                    case -1:
                        ...
                        break;
                    case 0:
                        obj6 = b.mo13852n(descriptor2, 0, C3622a2.f5917a, obj6);
                        i2 |= 1;
                        break;
                    case 1:
