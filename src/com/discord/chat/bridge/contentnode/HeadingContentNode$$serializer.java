...
public final class HeadingContentNode$$serializer implements AbstractC2522f0<HeadingContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{C2555m0.f6794a, new C2521f(ContentNodeSerializer.INSTANCE)};
    }
    ...
    public HeadingContentNode deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj = b.mo13847y(descriptor2, 1, new C2521f(ContentNodeSerializer.INSTANCE), null);
            i = 3;
        } else {
            boolean z = true;
            i2 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj2 = b.mo13847y(descriptor2, 1, new C2521f(ContentNodeSerializer.INSTANCE), obj2);
                    i3 |= 2;
                } else {
                    throw new C14382n(o);
                }
