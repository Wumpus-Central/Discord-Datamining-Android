...
public final class HandleMessage$$serializer implements AbstractC3644f0<HandleMessage> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{C3622a2.f5917a, HandleSurveyMessage$$serializer.INSTANCE};
    }
    ...
    public HandleMessage deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj = b.mo13847y(descriptor2, 1, HandleSurveyMessage$$serializer.INSTANCE, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj2 = b.mo13847y(descriptor2, 1, HandleSurveyMessage$$serializer.INSTANCE, obj2);
                    i2 |= 2;
                } else {
                    throw new C14447n(o);
                }
        ...
        return new HandleMessage(i, str, (HandleSurveyMessage) obj, null);
    }
    ...
    public void serialize(Encoder encoder, HandleMessage value) {
        ...
        HandleMessage.write$Self(value, b, descriptor2);
