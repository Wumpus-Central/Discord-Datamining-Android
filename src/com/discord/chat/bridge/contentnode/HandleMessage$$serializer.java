...
public final class HandleMessage$$serializer implements AbstractC2522f0<HandleMessage> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{C2500a2.f6719a, HandleSurveyMessage$$serializer.INSTANCE};
    }
