...
public final class WebhookNameOnClick {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/contentnode/WebhookNameOnClick$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/contentnode/WebhookNameOnClick;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ WebhookNameOnClick(int i, String str, MessageReference messageReference, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, WebhookNameOnClick$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
        if ((i & 2) == 0) {
    ...
    public static final void write$Self(WebhookNameOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.mo13893A(serialDesc, 1) || self.messageReference != null) {
            z = true;
        }
        if (z) {
            output.mo13874p(serialDesc, 1, MessageReference$$serializer.INSTANCE, self.messageReference);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.action, webhookNameOnClick.action) && C9971q.m14638b(this.messageReference, webhookNameOnClick.messageReference);
    }
