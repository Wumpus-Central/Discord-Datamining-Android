...
public final class WebhookNameOnClick {
    ...
    public /* synthetic */ WebhookNameOnClick(int i, String str, MessageReference messageReference, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, WebhookNameOnClick$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
        if ((i & 2) == 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.action, webhookNameOnClick.action) && C9677q.m14638b(this.messageReference, webhookNameOnClick.messageReference);
    }
