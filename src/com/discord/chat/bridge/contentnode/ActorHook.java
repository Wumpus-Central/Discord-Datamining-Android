...
public final class ActorHook {
    ...
    private ActorHook(int i, String str, UserId userId, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, ActorHook$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.action, actorHook.action) && UserId.m42157equalsimpl0(this.userId, actorHook.userId);
    }
