...
public final class HandleDelete$$serializer implements AbstractC2522f0<HandleDelete> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{C2500a2.f6719a, HandleDeleteMessage$$serializer.INSTANCE};
    }
