...
public final class TextContentNode extends ContentNode {
    ...
    public /* synthetic */ TextContentNode(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, TextContentNode$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.content = null;
        } else {
    ...
    public static final void write$Self(TextContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z = true;
        if (!output.mo13893A(serialDesc, 0) && self.content == null) {
            z = false;
        }
        if (z) {
            output.mo13874p(serialDesc, 0, C3622a2.f5917a, self.content);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TextContentNode) && C9971q.m14638b(this.content, ((TextContentNode) obj).content);
    }
