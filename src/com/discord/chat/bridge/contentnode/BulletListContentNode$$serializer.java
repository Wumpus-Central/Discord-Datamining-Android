...
public final class BulletListContentNode$$serializer implements AbstractC2522f0<BulletListContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{C14606a.m13u(C2555m0.f6794a), C2530h.f6761a, new C2521f(new C2521f(ContentNodeSerializer.INSTANCE))};
    }
    ...
    public BulletListContentNode deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            obj2 = b.mo13852n(descriptor2, 0, C2555m0.f6794a, null);
            z = b.mo13861C(descriptor2, 1);
            obj = b.mo13847y(descriptor2, 2, new C2521f(new C2521f(ContentNodeSerializer.INSTANCE)), null);
            i = 7;
        } else {
            boolean z2 = true;
            boolean z3 = false;
            ...
            while (z2) {
                ...
                if (o == -1) {
                    ...
                    obj4 = b.mo13847y(descriptor2, 2, new C2521f(new C2521f(ContentNodeSerializer.INSTANCE)), obj4);
                    i2 |= 4;
                } else {
                    throw new C14382n(o);
                }
