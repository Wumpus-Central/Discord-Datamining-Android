...
public enum StaticChannelMentionType {
    ...
    public static final class Companion {
        ...
        public final StaticChannelMentionType fromValue(String channelId) {
            ...
            while (true) {
                ...
                if (C9971q.m14638b(staticChannelMentionType.getChannelId(), channelId)) {
                    break;
                }
                i++;
            }
    ...
    public static final class Serializer implements KSerializer<StaticChannelMentionType> {
        ...
        public SerialDescriptor getDescriptor() {
            return C1427g.m41131a("StaticChannelMentionType", AbstractC1413e.C1421i.f471a);
        }
    ...
    static {
        ...
        b = C11084n.m10944b(EnumC11087p.PUBLICATION, StaticChannelMentionType$Companion$$cachedSerializer$delegate$1.INSTANCE);
