...
public final class BlockQuoteContentNode extends ContentNode {
    ...
    public /* synthetic */ BlockQuoteContentNode(int i, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, BlockQuoteContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.content = list;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BlockQuoteContentNode) && C9677q.m14638b(this.content, ((BlockQuoteContentNode) obj).content);
    }
