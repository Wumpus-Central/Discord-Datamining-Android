...
public final class ThreadOnClick {
    ...
    public /* synthetic */ ThreadOnClick(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, ThreadOnClick$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
        this.threadId = str2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.action, threadOnClick.action) && C9677q.m14638b(this.threadId, threadOnClick.threadId);
    }
