...
public final class ThreadOnClick {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/contentnode/ThreadOnClick$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/contentnode/ThreadOnClick;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ ThreadOnClick(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, ThreadOnClick$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
        this.threadId = str2;
    }

    public static /* synthetic */ ThreadOnClick copy$default(ThreadOnClick threadOnClick, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final void write$Self(ThreadOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13864z(serialDesc, 1, self.threadId);
    }
    ...
    public final ThreadOnClick copy(String action, String threadId) {
        ...
        C9971q.m14633g(threadId, "threadId");
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.action, threadOnClick.action) && C9971q.m14638b(this.threadId, threadOnClick.threadId);
    }
