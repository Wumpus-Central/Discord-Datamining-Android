...
public final class CustomEmojiContentNode extends EmojiContentNode {
    ...
    public /* synthetic */ CustomEmojiContentNode(int i, long j, String str, String str2, String str3, boolean z, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (15 != (i & 15)) {
            C3681n1.m33818b(i, 15, CustomEmojiContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.f7206id = j;
        this.alt = str;
        this.src = str2;
    ...
    public static /* synthetic */ CustomEmojiContentNode copy$default(CustomEmojiContentNode customEmojiContentNode, long j, String str, String str2, String str3, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            j = customEmojiContentNode.f7206id;
        }
        if ((i & 2) != 0) {
    ...
    public static final void write$Self(CustomEmojiContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z = false;
        output.mo13889E(serialDesc, 0, self.f7206id);
    ...
    public final CustomEmojiContentNode copy(long j, String alt, String src, String frozenSrc, boolean z) {
        ...
        C9971q.m14633g(frozenSrc, "frozenSrc");
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7206id == customEmojiContentNode.f7206id && C9971q.m14638b(this.alt, customEmojiContentNode.alt) && C9971q.m14638b(this.src, customEmojiContentNode.src) && C9971q.m14638b(this.frozenSrc, customEmojiContentNode.frozenSrc) && getJumboable() == customEmojiContentNode.getJumboable();
    }
    ...
    public int hashCode() {
        int a = ((((((C4081a.m32873a(this.f7206id) * 31) + this.alt.hashCode()) * 31) + this.src.hashCode()) * 31) + this.frozenSrc.hashCode()) * 31;
