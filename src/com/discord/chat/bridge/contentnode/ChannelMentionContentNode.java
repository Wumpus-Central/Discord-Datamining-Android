...
public final class ChannelMentionContentNode extends MentionContentNode {
    ...
    public /* synthetic */ ChannelMentionContentNode(int i, String str, String str2, String str3, String str4, List list, List list2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (33 != (i & 33)) {
            C3681n1.m33818b(i, 33, ChannelMentionContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.channelId = str;
        if ((i & 2) == 0) {
            this.guildId = null;
    ...
    public static final void write$Self(ChannelMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 1, C3622a2.f5917a, self.guildId);
        }
        ...
        if (z2) {
            output.mo13874p(serialDesc, 2, C3622a2.f5917a, self.messageId);
        }
        ...
        if (z3) {
            output.mo13874p(serialDesc, 3, C3622a2.f5917a, self.originalLink);
        }
        if (output.mo13893A(serialDesc, 4) || self.inContent != null) {
            z4 = true;
        }
        if (z4) {
            output.mo13874p(serialDesc, 4, new C3643f(ContentNodeSerializer.INSTANCE), self.inContent);
        }
        output.mo13874p(serialDesc, 5, new C3643f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.channelId, channelMentionContentNode.channelId) && C9971q.m14638b(this.guildId, channelMentionContentNode.guildId) && C9971q.m14638b(this.messageId, channelMentionContentNode.messageId) && C9971q.m14638b(this.originalLink, channelMentionContentNode.originalLink) && C9971q.m14638b(this.inContent, channelMentionContentNode.inContent) && C9971q.m14638b(getContent(), channelMentionContentNode.getContent());
    }
