...
public final class ChannelMentionContentNode$$serializer implements AbstractC3644f0<ChannelMentionContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{a2Var, C14667a.m13u(a2Var), C14667a.m13u(a2Var), C14667a.m13u(a2Var), C14667a.m13u(new C3643f(contentNodeSerializer)), C14667a.m13u(new C3643f(contentNodeSerializer))};
    }
    ...
    public ChannelMentionContentNode deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            ContentNodeSerializer contentNodeSerializer = ContentNodeSerializer.INSTANCE;
            obj3 = b.mo13852n(descriptor2, 4, new C3643f(contentNodeSerializer), null);
            obj5 = b.mo13852n(descriptor2, 5, new C3643f(contentNodeSerializer), null);
            i = 63;
        } else {
            boolean z2 = true;
            int i2 = 0;
            ...
            while (z2) {
                ...
                switch (o) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        obj9 = b.mo13852n(descriptor2, 4, new C3643f(ContentNodeSerializer.INSTANCE), obj9);
                        i2 |= 16;
                        z = true;
                        break;
                    case 5:
                        obj10 = b.mo13852n(descriptor2, 5, new C3643f(ContentNodeSerializer.INSTANCE), obj10);
                        i2 |= 32;
                        z = true;
                        break;
                    default:
