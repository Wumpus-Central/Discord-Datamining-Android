...
public final class HandleDeleteMessage {
    ...
    private HandleDeleteMessage(int i, String str, ChannelId channelId, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, SerializationConstructorMarker serializationConstructorMarker) {
        if (11 != (i & 11)) {
            C3681n1.m33818b(i, 11, HandleDeleteMessage$$serializer.INSTANCE.getDescriptor());
        }
        this.f7207id = str;
    ...
    public static final void write$Self(HandleDeleteMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z = false;
        output.mo13870t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m42115boximpl(self.f7207id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.f7207id, handleDeleteMessage.f7207id) && ChannelId.m42093equalsimpl0(this.channelId, handleDeleteMessage.channelId) && C9971q.m14638b(this.loggingName, handleDeleteMessage.loggingName) && C9971q.m14638b(this.author, handleDeleteMessage.author);
    }
    ...
    public int hashCode() {
        int i = ((MessageId.m42120hashCodeimpl(this.f7207id) * 31) + ChannelId.m42094hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return ((i + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
    }

    public String toString() {
        String str = MessageId.m42121toStringimpl(this.f7207id);
