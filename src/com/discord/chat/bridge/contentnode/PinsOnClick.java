...
public final class PinsOnClick {
    ...
    private PinsOnClick(int i, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, PinsOnClick$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.action, pinsOnClick.action) && ChannelId.m42093equalsimpl0(this.messageChannelId, pinsOnClick.messageChannelId);
    }
