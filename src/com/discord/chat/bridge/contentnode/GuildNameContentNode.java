...
public final class GuildNameContentNode extends ContentNode {
    ...
    public /* synthetic */ GuildNameContentNode(int i, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (2 != (i & 2)) {
            C2560n1.m33818b(i, 2, GuildNameContentNode$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.guildId = null;
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.guildId, guildNameContentNode.guildId) && C9677q.m14638b(this.content, guildNameContentNode.content) && C9677q.m14638b(this.icon, guildNameContentNode.icon);
    }
