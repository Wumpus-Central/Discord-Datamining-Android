...
public final class TimestampContentNode extends ContentNode {
    ...
    public /* synthetic */ TimestampContentNode(int i, long j, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (7 != (i & 7)) {
            C2560n1.m33818b(i, 7, TimestampContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.timestamp = j;
        this.full = str;
        this.formatted = str2;
    ...
    public final TimestampContentNode copy(long j, String full, String formatted) {
        C9677q.m14633g(full, "full");
        C9677q.m14633g(formatted, "formatted");
    ...
    public boolean equals(Object obj) {
        ...
        return this.timestamp == timestampContentNode.timestamp && C9677q.m14638b(this.full, timestampContentNode.full) && C9677q.m14638b(this.formatted, timestampContentNode.formatted);
    }
    ...
    public int hashCode() {
        return (((C2968a.m32873a(this.timestamp) * 31) + this.full.hashCode()) * 31) + this.formatted.hashCode();
    }
