...
public final class StaticChannelMentionContentNode$$serializer implements AbstractC3644f0<StaticChannelMentionContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StaticChannelMentionType.Serializer.INSTANCE, C14667a.m13u(GuildId$$serializer.INSTANCE), new C3643f(ContentNodeSerializer.INSTANCE)};
    }
    ...
    public StaticChannelMentionContentNode deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj2 = b.mo13847y(descriptor2, 2, new C3643f(ContentNodeSerializer.INSTANCE), null);
            i = 7;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj6 = b.mo13847y(descriptor2, 2, new C3643f(ContentNodeSerializer.INSTANCE), obj6);
                    i2 |= 4;
                } else {
                    throw new C14447n(o);
                }
