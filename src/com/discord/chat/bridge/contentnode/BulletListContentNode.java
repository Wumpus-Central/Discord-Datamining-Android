...
public final class BulletListContentNode extends ContentNode {
    ...
    public /* synthetic */ BulletListContentNode(int i, Integer num, boolean z, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (4 != (i & 4)) {
            C3681n1.m33818b(i, 4, BulletListContentNode$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.start = null;
        } else {
    ...
    public static final void write$Self(BulletListContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 0, C3676m0.f5992a, self.start);
        }
        ...
        output.mo13870t(serialDesc, 2, new C3643f(new C3643f(ContentNodeSerializer.INSTANCE)), self.items);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.start, bulletListContentNode.start) && this.ordered == bulletListContentNode.ordered && C9971q.m14638b(this.items, bulletListContentNode.items);
    }
