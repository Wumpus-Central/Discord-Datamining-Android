...
public final class LinkContext {
    ...
    public /* synthetic */ LinkContext(int i, UserNameOnClick userNameOnClick, UserNameOnClick userNameOnClick2, CommandOnClick commandOnClick, ActorHook actorHook, ThreadOnClick threadOnClick, PinsOnClick pinsOnClick, WebhookNameOnClick webhookNameOnClick, HandleDelete handleDelete, RoleSubscriptionOnClick roleSubscriptionOnClick, HandleMessage handleMessage, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, LinkContext$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.usernameOnClick, linkContext.usernameOnClick) && C9971q.m14638b(this.otherUsernameOnClick, linkContext.otherUsernameOnClick) && C9971q.m14638b(this.commandNameOnClick, linkContext.commandNameOnClick) && C9971q.m14638b(this.actorHook, linkContext.actorHook) && C9971q.m14638b(this.threadOnClick, linkContext.threadOnClick) && C9971q.m14638b(this.pinsOnClick, linkContext.pinsOnClick) && C9971q.m14638b(this.webhookNameOnClick, linkContext.webhookNameOnClick) && C9971q.m14638b(this.handleDelete, linkContext.handleDelete) && C9971q.m14638b(this.roleSubscriptionOnClick, linkContext.roleSubscriptionOnClick) && C9971q.m14638b(this.handleMessage, linkContext.handleMessage);
    }
