...
public final class CodeBlockContentNode extends ContentNode {
    ...
    public /* synthetic */ CodeBlockContentNode(int i, String str, String str2, boolean z, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (7 != (i & 7)) {
            C3681n1.m33818b(i, 7, CodeBlockContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.lang = str;
        this.content = str2;
        this.inQuote = z;
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.lang, codeBlockContentNode.lang) && C9971q.m14638b(this.content, codeBlockContentNode.content) && this.inQuote == codeBlockContentNode.inQuote;
    }
