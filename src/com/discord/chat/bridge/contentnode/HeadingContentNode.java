...
public final class HeadingContentNode extends ContentNode {
    ...
    public /* synthetic */ HeadingContentNode(int i, int i2, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (3 != (i & 3)) {
            C2560n1.m33818b(i, 3, HeadingContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.level = i2;
        this.content = list;
    }
    ...
    public static final void write$Self(HeadingContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 1, new C2521f(ContentNodeSerializer.INSTANCE), self.content);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.level == headingContentNode.level && C9677q.m14638b(this.content, headingContentNode.content);
    }
