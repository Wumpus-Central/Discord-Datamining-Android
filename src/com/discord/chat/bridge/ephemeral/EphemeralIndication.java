...
public final class EphemeralIndication {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/ephemeral/EphemeralIndication$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/ephemeral/EphemeralIndication;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ EphemeralIndication(int i, StructurableText structurableText, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i & 7)) {
            C2560n1.m33818b(i, 7, EphemeralIndication$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(EphemeralIndication self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 0, StructurableTextSerializer.INSTANCE, self.content);
        output.mo13864z(serialDesc, 1, self.helpArticleLink);
        output.mo13864z(serialDesc, 2, self.helpButtonAccessibilityLabel);
    }
    ...
    public final EphemeralIndication copy(StructurableText content, String helpArticleLink, String helpButtonAccessibilityLabel) {
        ...
        C9677q.m14633g(helpArticleLink, "helpArticleLink");
        C9677q.m14633g(helpButtonAccessibilityLabel, "helpButtonAccessibilityLabel");
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.content, ephemeralIndication.content) && C9677q.m14638b(this.helpArticleLink, ephemeralIndication.helpArticleLink) && C9677q.m14638b(this.helpButtonAccessibilityLabel, ephemeralIndication.helpButtonAccessibilityLabel);
    }
