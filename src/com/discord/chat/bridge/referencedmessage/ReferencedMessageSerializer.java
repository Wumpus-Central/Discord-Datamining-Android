...
public final class ReferencedMessageSerializer extends AbstractC9992d<ReferencedMessage> {
    ...
    private ReferencedMessageSerializer() {
        super(C9656f0.m14684b(ReferencedMessage.class));
    }
    ...
    protected DeserializationStrategy<ReferencedMessage> selectDeserializer(JsonElement element) {
        ...
        JsonElement jsonElement = (JsonElement) C9994f.m13719j(element).get("state");
        if (jsonElement == null || (k = C9994f.m13718k(jsonElement)) == null) {
            str = null;
        } else {
            str = k.mo13692a();
        }
        if (C9677q.m14638b(str, STATE_LOADED)) {
            return LoadedReferencedMessage.Companion.serializer();
        }
        if (C9677q.m14638b(str, "1")) {
