...
public final class SystemReferencedMessage extends ReferencedMessage {
    ...
    public /* synthetic */ SystemReferencedMessage(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, SystemReferencedMessage$$serializer.INSTANCE.getDescriptor());
        }
        this.content = str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SystemReferencedMessage) && C9971q.m14638b(this.content, ((SystemReferencedMessage) obj).content);
    }
