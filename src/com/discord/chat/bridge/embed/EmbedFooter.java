...
public final class EmbedFooter {
    ...
    public /* synthetic */ EmbedFooter(int i, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        Lazy a;
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, EmbedFooter$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.iconURL = null;
        } else {
    ...
    public static final void write$Self(EmbedFooter self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 0, C3622a2.f5917a, self.iconURL);
        }
        ...
        if (z2) {
            output.mo13874p(serialDesc, 1, C3622a2.f5917a, self.iconProxyURL);
        }
        if (output.mo13893A(serialDesc, 2) || self.content != null) {
            z3 = true;
        }
        if (z3) {
            output.mo13874p(serialDesc, 2, C3622a2.f5917a, self.content);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.iconURL, embedFooter.iconURL) && C9971q.m14638b(this.iconProxyURL, embedFooter.iconProxyURL) && C9971q.m14638b(this.content, embedFooter.content);
    }
    ...
    public EmbedFooter(String str, String str2, String str3) {
        ...
        this.iconProxyURL = str2;
        this.content = str3;
        a = C11084n.m10945a(new EmbedFooter$imageUrl$2(this));
        this.imageUrl$delegate = a;
    }
