...
public final class Embed implements SpoilerableData {
    ...
    public /* synthetic */ Embed(int i, EmbedType embedType, EmbedAuthor embedAuthor, EmbedProvider embedProvider, String str, StructurableText structurableText, List list, String str2, String str3, StructurableText structurableText2, EmbedMedia embedMedia, List list2, EmbedMedia embedMedia2, EmbedThumbnail embedThumbnail, String str4, String str5, String str6, Boolean bool, EmbedFooter embedFooter, String str7, String str8, EmbedFailureState embedFailureState, Integer num, Integer num2, Integer num3, int i2, String str9, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (16777217 != (i & 16777217)) {
            C2560n1.m33818b(i, 16777217, Embed$$serializer.INSTANCE.getDescriptor());
        }
        this.type = embedType;
        String str10 = null;
        if ((i & 2) == 0) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:195:0x0287, code lost:
        if (kotlin.jvm.internal.C9677q.m14638b(r1, r3) == false) goto L_0x0270;
     */
    /*
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        return this.type == embed.type && C9677q.m14638b(this.author, embed.author) && C9677q.m14638b(this.provider, embed.provider) && C9677q.m14638b(this.rawTitle, embed.rawTitle) && C9677q.m14638b(this.title, embed.title) && C9677q.m14638b(this.fields, embed.fields) && C9677q.m14638b(this.url, embed.url) && C9677q.m14638b(this.rawDescription, embed.rawDescription) && C9677q.m14638b(this.description, embed.description) && C9677q.m14638b(this.image, embed.image) && C9677q.m14638b(this.images, embed.images) && C9677q.m14638b(this.video, embed.video) && C9677q.m14638b(this.thumbnail, embed.thumbnail) && C9677q.m14638b(this.numAttachments, embed.numAttachments) && C9677q.m14638b(this.attachmentsSize, embed.attachmentsSize) && C9677q.m14638b(this.messageSendError, embed.messageSendError) && C9677q.m14638b(this.disableBackgroundColor, embed.disableBackgroundColor) && C9677q.m14638b(this.footer, embed.footer) && C9677q.m14638b(this.spoiler, embed.spoiler) && C9677q.m14638b(this.iconURL, embed.iconURL) && this.failureState == embed.failureState && C9677q.m14638b(this.providerColor, embed.providerColor) && C9677q.m14638b(this.borderLeftColor, embed.borderLeftColor) && C9677q.m14638b(this.headerTextColor, embed.headerTextColor) && this.bodyTextColor == embed.bodyTextColor;
    }
