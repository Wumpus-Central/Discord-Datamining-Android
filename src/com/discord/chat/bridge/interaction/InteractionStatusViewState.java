...
public enum InteractionStatusViewState implements IntEnum {
    ...
    public static final class Serializer extends IntEnumSerializer<InteractionStatusViewState> {
        ...
        private Serializer() {
            super(C9656f0.m14684b(InteractionStatusViewState.class), InteractionStatusViewState.UNKNOWN);
        }
    }

    static {
        Lazy<KSerializer<Object>> b;
        b = C10839n.m10944b(EnumC10842p.PUBLICATION, C3153xb1fb8692.INSTANCE);
