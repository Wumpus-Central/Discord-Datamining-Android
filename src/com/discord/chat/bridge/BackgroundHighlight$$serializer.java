...
@Metadata(m15074d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, m15073d2 = {"com/discord/chat/bridge/BackgroundHighlight.$serializer", "Lbj/f0;", "Lcom/discord/chat/bridge/BackgroundHighlight;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0})
/* loaded from: classes4.dex */
public final class BackgroundHighlight$$serializer implements AbstractC2522f0<BackgroundHighlight> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m13841l(ViewProps.BACKGROUND_COLOR, true);
        pluginGeneratedSerialDescriptor.m13841l("gutterColor", true);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14606a.m13u(m0Var), C14606a.m13u(m0Var)};
    }
    ...
    public BackgroundHighlight deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            C2555m0 m0Var = C2555m0.f6794a;
            obj = b.mo13852n(descriptor2, 0, m0Var, null);
            obj2 = b.mo13852n(descriptor2, 1, m0Var, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj3 = b.mo13852n(descriptor2, 0, C2555m0.f6794a, obj3);
                    i2 |= 1;
                } else if (o == 1) {
                    obj2 = b.mo13852n(descriptor2, 1, C2555m0.f6794a, obj2);
                    i2 |= 2;
                } else {
                    throw new C14382n(o);
                }
        ...
        return new BackgroundHighlight(i, (Integer) obj, (Integer) obj2, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, BackgroundHighlight value) {
        ...
        BackgroundHighlight.write$Self(value, b, descriptor2);
