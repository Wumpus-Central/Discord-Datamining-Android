...
public abstract class SelectComponent extends Component {
    ...
    static {
        ...
        b = C10839n.m10944b(EnumC10842p.PUBLICATION, SelectComponent$Companion$$cachedSerializer$delegate$1.INSTANCE);
        $cachedSerializer$delegate = b;
    }

    public /* synthetic */ SelectComponent(int i, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
    }
