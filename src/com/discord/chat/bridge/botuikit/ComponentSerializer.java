...
public final class ComponentSerializer extends AbstractC10272d<Component> {
    ...
    static {
        ...
        componentClassSerializer = new SealedClassSerializer<>("Component", C9951f0.m14684b(Component.class), new KClass[]{C9951f0.m14684b(UnknownComponent.class), C9951f0.m14684b(ActionRowComponent.class), C9951f0.m14684b(ButtonComponent.class), C9951f0.m14684b(StringSelectComponent.class), C9951f0.m14684b(UserSelectComponent.class), C9951f0.m14684b(RoleSelectComponent.class), C9951f0.m14684b(MentionableSelectComponent.class), C9951f0.m14684b(ChannelSelectComponent.class)}, new KSerializer[]{UnknownComponent.Companion.serializer(), ActionRowComponent.Companion.serializer(), ButtonComponent.Companion.serializer(), StringSelectComponent.Companion.serializer(), UserSelectComponent.Companion.serializer(), RoleSelectComponent.Companion.serializer(), MentionableSelectComponent.Companion.serializer(), ChannelSelectComponent.Companion.serializer()});
    }

    private ComponentSerializer() {
        super(C9951f0.m14684b(Component.class));
    }
    ...
    protected DeserializationStrategy<Component> selectDeserializer(JsonElement element) {
        ...
        if (jsonElement == null || (k = C10274f.m13718k(jsonElement)) == null) {
            ...
            num = Integer.valueOf(C10274f.m13720i(k));
        }
        M = C9914r.m14778M(list, num);
        if (M) {
