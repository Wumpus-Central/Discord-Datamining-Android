...
public final class StringSelectComponent extends SelectComponent {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/botuikit/StringSelectComponent$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/botuikit/StringSelectComponent;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    */
    ...
    public int hashCode() {
        ...
        int i3 = disabled ? 1 : 0;
        int i4 = disabled ? 1 : 0;
        int hashCode = (((((type + i2) * 31) + getState().hashCode()) * 31) + this.options.hashCode()) * 31;
        List<Integer> list = this.selectedOptions;
        if (list != null) {
            i = list.hashCode();
        }
