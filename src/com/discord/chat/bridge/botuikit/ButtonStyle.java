...
public enum ButtonStyle implements IntEnum {
    ...
    public static final class Serializer extends IntEnumSerializer<ButtonStyle> {
        ...
        private Serializer() {
            super(C9951f0.m14684b(ButtonStyle.class), ButtonStyle.UNKNOWN);
        }
    }

    static {
        Lazy<KSerializer<Object>> b;
        b = C11084n.m10944b(EnumC11087p.PUBLICATION, ButtonStyle$Companion$$cachedSerializer$delegate$1.INSTANCE);
