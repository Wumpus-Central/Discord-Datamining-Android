...
public final class UnknownComponent$$serializer implements AbstractC2522f0<UnknownComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{m0Var, new C2521f(m0Var)};
    }
        ...
        if (b.mo13850p()) {
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj2 = b.mo13847y(descriptor2, 1, new C2521f(C2555m0.f6794a), obj2);
                    i3 |= 2;
                } else {
                    throw new C14382n(o);
                }
