...
public final class SearchableSelectItem$$serializer implements AbstractC2522f0<SearchableSelectItem> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{a2Var, a2Var, C14606a.m13u(ComponentEmoji$$serializer.INSTANCE), m0Var, C14606a.m13u(a2Var), C14606a.m13u(m0Var)};
    }
    ...
    public SearchableSelectItem deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj2 = b.mo13852n(descriptor2, 4, C2500a2.f6719a, null);
            obj3 = b.mo13852n(descriptor2, 5, C2555m0.f6794a, null);
            i2 = 63;
        } else {
            boolean z = true;
            int i3 = 0;
            ...
            while (z) {
                ...
                switch (o) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        obj5 = b.mo13852n(descriptor2, 4, C2500a2.f6719a, obj5);
                        i4 |= 16;
                        break;
                    case 5:
                        obj6 = b.mo13852n(descriptor2, 5, C2555m0.f6794a, obj6);
                        i4 |= 32;
                        break;
                    default:
                        throw new C14382n(o);
