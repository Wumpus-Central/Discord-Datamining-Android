...
public final class UserSelectComponent extends SearchableSelectComponent {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/botuikit/UserSelectComponent$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/botuikit/UserSelectComponent;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ UserSelectComponent(int i, List list, int i2, List list2, String str, String str2, String str3, String str4, int i3, int i4, boolean z, ActionComponentState actionComponentState, SerializationConstructorMarker serializationConstructorMarker) {
        super(i, list, serializationConstructorMarker);
        if (1438 != (i & 1438)) {
            C2560n1.m33818b(i, 1438, UserSelectComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.type = i2;
        this.indices = list2;
    ...
    public final UserSelectComponent copy(int i, List<Integer> indices, String applicationId, String customId, String str, String str2, int i2, int i3, boolean z, ActionComponentState state) {
        ...
        return new UserSelectComponent(i, indices, applicationId, customId, str, str2, i2, i3, z, state);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == userSelectComponent.getType() && C9677q.m14638b(getIndices(), userSelectComponent.getIndices()) && C9677q.m14638b(getApplicationId(), userSelectComponent.getApplicationId()) && C9677q.m14638b(getCustomId(), userSelectComponent.getCustomId()) && C9677q.m14638b(getPlaceholder(), userSelectComponent.getPlaceholder()) && C9677q.m14638b(getAccessibilityLabel(), userSelectComponent.getAccessibilityLabel()) && getMinValues() == userSelectComponent.getMinValues() && getMaxValues() == userSelectComponent.getMaxValues() && getDisabled() == userSelectComponent.getDisabled() && getState() == userSelectComponent.getState();
    }
    ...
    public /* synthetic */ UserSelectComponent(int i, List list, String str, String str2, String str3, String str4, int i2, int i3, boolean z, ActionComponentState actionComponentState, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, list, str, str2, (i4 & 16) != 0 ? null : str3, (i4 & 32) != 0 ? null : str4, i2, i3, (i4 & Spliterator.NONNULL) != 0 ? false : z, actionComponentState);
    }

    public UserSelectComponent(int i, List<Integer> indices, String applicationId, String customId, String str, String str2, int i2, int i3, boolean z, ActionComponentState state) {
        C9677q.m14633g(indices, "indices");
        C9677q.m14633g(applicationId, "applicationId");
        C9677q.m14633g(customId, "customId");
        C9677q.m14633g(state, "state");
