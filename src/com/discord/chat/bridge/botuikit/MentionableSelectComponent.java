...
public final class MentionableSelectComponent extends SearchableSelectComponent {
    ...
    public /* synthetic */ MentionableSelectComponent(int i, List list, int i2, List list2, String str, String str2, String str3, String str4, int i3, int i4, boolean z, ActionComponentState actionComponentState, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (1438 != (i & 1438)) {
            C3681n1.m33818b(i, 1438, MentionableSelectComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.type = i2;
        this.indices = list2;
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == mentionableSelectComponent.getType() && C9971q.m14638b(getIndices(), mentionableSelectComponent.getIndices()) && C9971q.m14638b(getApplicationId(), mentionableSelectComponent.getApplicationId()) && C9971q.m14638b(getCustomId(), mentionableSelectComponent.getCustomId()) && C9971q.m14638b(getPlaceholder(), mentionableSelectComponent.getPlaceholder()) && C9971q.m14638b(getAccessibilityLabel(), mentionableSelectComponent.getAccessibilityLabel()) && getMinValues() == mentionableSelectComponent.getMinValues() && getMaxValues() == mentionableSelectComponent.getMaxValues() && getDisabled() == mentionableSelectComponent.getDisabled() && getState() == mentionableSelectComponent.getState();
    }
