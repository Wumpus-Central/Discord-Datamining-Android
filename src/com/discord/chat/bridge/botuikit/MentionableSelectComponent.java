...
public final class MentionableSelectComponent extends SearchableSelectComponent {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/botuikit/MentionableSelectComponent$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/botuikit/MentionableSelectComponent;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ MentionableSelectComponent(int i, List list, int i2, List list2, String str, String str2, String str3, String str4, int i3, int i4, boolean z, ActionComponentState actionComponentState, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (1438 != (i & 1438)) {
            C2560n1.m33818b(i, 1438, MentionableSelectComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.type = i2;
        this.indices = list2;
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == mentionableSelectComponent.getType() && C9677q.m14638b(getIndices(), mentionableSelectComponent.getIndices()) && C9677q.m14638b(getApplicationId(), mentionableSelectComponent.getApplicationId()) && C9677q.m14638b(getCustomId(), mentionableSelectComponent.getCustomId()) && C9677q.m14638b(getPlaceholder(), mentionableSelectComponent.getPlaceholder()) && C9677q.m14638b(getAccessibilityLabel(), mentionableSelectComponent.getAccessibilityLabel()) && getMinValues() == mentionableSelectComponent.getMinValues() && getMaxValues() == mentionableSelectComponent.getMaxValues() && getDisabled() == mentionableSelectComponent.getDisabled() && getState() == mentionableSelectComponent.getState();
    }
