...
public final class StringSelectItem extends SelectItem {
    ...
    public /* synthetic */ StringSelectItem(int i, String str, String str2, ComponentEmoji componentEmoji, String str3, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (3 != (i & 3)) {
            C3681n1.m33818b(i, 3, StringSelectItem$$serializer.INSTANCE.getDescriptor());
        }
        this.label = str;
        this.value = str2;
        if ((i & 4) == 0) {
    ...
    public static final void write$Self(StringSelectItem self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z2) {
            output.mo13874p(serialDesc, 3, C3622a2.f5917a, self.description);
        }
        if (output.mo13893A(serialDesc, 4) || !C9971q.m14638b(self.f0default, Boolean.FALSE)) {
            z3 = true;
        }
        if (z3) {
            output.mo13874p(serialDesc, 4, C3652h.f5959a, self.f0default);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(getLabel(), stringSelectItem.getLabel()) && C9971q.m14638b(getValue(), stringSelectItem.getValue()) && C9971q.m14638b(getEmoji(), stringSelectItem.getEmoji()) && C9971q.m14638b(this.description, stringSelectItem.description) && C9971q.m14638b(this.f0default, stringSelectItem.f0default);
    }
