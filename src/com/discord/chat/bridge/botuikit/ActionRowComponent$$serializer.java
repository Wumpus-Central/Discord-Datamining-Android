...
public final class ActionRowComponent$$serializer implements AbstractC3644f0<ActionRowComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{m0Var, new C3643f(m0Var), C14667a.m13u(C3622a2.f5917a), new C3643f(ComponentSerializer.INSTANCE)};
    }
    ...
    public ActionRowComponent deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj3 = b.mo13847y(descriptor2, 3, new C3643f(ComponentSerializer.INSTANCE), null);
            i2 = 15;
        } else {
            boolean z = true;
            int i3 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj4 = b.mo13847y(descriptor2, 1, new C3643f(C3676m0.f5992a), obj4);
                    i4 |= 2;
                } else if (o == 2) {
                    obj5 = b.mo13852n(descriptor2, 2, C3622a2.f5917a, obj5);
                    i4 |= 4;
                } else if (o == 3) {
                    obj6 = b.mo13847y(descriptor2, 3, new C3643f(ComponentSerializer.INSTANCE), obj6);
                    i4 |= 8;
                } else {
                    throw new C14447n(o);
                }
