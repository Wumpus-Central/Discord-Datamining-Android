...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    public /* synthetic */ ChannelSelectComponent(int i, List list, int i2, List list2, String str, String str2, String str3, String str4, int i3, int i4, boolean z, ActionComponentState actionComponentState, List list3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (1438 != (i & 1438)) {
            C3681n1.m33818b(i, 1438, ChannelSelectComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.type = i2;
        this.indices = list2;
    ...
    public static final void write$Self(ChannelSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 2, new C3643f(m0Var), self.getIndices());
        ...
        if (z4) {
            output.mo13874p(serialDesc, 11, new C3643f(m0Var), self.channelTypes);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == channelSelectComponent.getType() && C9971q.m14638b(getIndices(), channelSelectComponent.getIndices()) && C9971q.m14638b(getApplicationId(), channelSelectComponent.getApplicationId()) && C9971q.m14638b(getCustomId(), channelSelectComponent.getCustomId()) && C9971q.m14638b(getPlaceholder(), channelSelectComponent.getPlaceholder()) && C9971q.m14638b(getAccessibilityLabel(), channelSelectComponent.getAccessibilityLabel()) && getMinValues() == channelSelectComponent.getMinValues() && getMaxValues() == channelSelectComponent.getMaxValues() && getDisabled() == channelSelectComponent.getDisabled() && getState() == channelSelectComponent.getState() && C9971q.m14638b(this.channelTypes, channelSelectComponent.channelTypes);
    }
