...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/botuikit/ChannelSelectComponent$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/botuikit/ChannelSelectComponent;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ ChannelSelectComponent(int i, List list, int i2, List list2, String str, String str2, String str3, String str4, int i3, int i4, boolean z, ActionComponentState actionComponentState, List list3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (1438 != (i & 1438)) {
            C2560n1.m33818b(i, 1438, ChannelSelectComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.type = i2;
        this.indices = list2;
    ...
    public static final void write$Self(ChannelSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 2, new C2521f(m0Var), self.getIndices());
        ...
        if (!output.mo13893A(serialDesc, 11) && self.channelTypes == null) {
            z4 = false;
        }
        if (z4) {
            output.mo13874p(serialDesc, 11, new C2521f(m0Var), self.channelTypes);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == channelSelectComponent.getType() && C9677q.m14638b(getIndices(), channelSelectComponent.getIndices()) && C9677q.m14638b(getApplicationId(), channelSelectComponent.getApplicationId()) && C9677q.m14638b(getCustomId(), channelSelectComponent.getCustomId()) && C9677q.m14638b(getPlaceholder(), channelSelectComponent.getPlaceholder()) && C9677q.m14638b(getAccessibilityLabel(), channelSelectComponent.getAccessibilityLabel()) && getMinValues() == channelSelectComponent.getMinValues() && getMaxValues() == channelSelectComponent.getMaxValues() && getDisabled() == channelSelectComponent.getDisabled() && getState() == channelSelectComponent.getState() && C9677q.m14638b(this.channelTypes, channelSelectComponent.channelTypes);
    }
    ...
    public int hashCode() {
        ...
        int i3 = disabled ? 1 : 0;
        int i4 = disabled ? 1 : 0;
        int hashCode = (((type + i2) * 31) + getState().hashCode()) * 31;
    ...
    public /* synthetic */ ChannelSelectComponent(int i, List list, String str, String str2, String str3, String str4, int i2, int i3, boolean z, ActionComponentState actionComponentState, List list2, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, list, str, str2, (i4 & 16) != 0 ? null : str3, (i4 & 32) != 0 ? null : str4, i2, i3, (i4 & Spliterator.NONNULL) != 0 ? false : z, actionComponentState, (i4 & Spliterator.IMMUTABLE) != 0 ? null : list2);
    }
