...
public final class Message extends MessageBase {
    ...
    /* loaded from: classes4.dex */
    static final class C31501 extends AbstractC9679s implements Function0<Integer> {
        C31501() {
            super(0);
        }
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/Message$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/Message;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    private Message(int i, int i2, int i3, MessageType messageType, String str, String str2, ChannelId channelId, GuildId guildId, MessageState messageState, UserId userId, long j, String str3, Float f, String str4, String str5, Integer num, Integer num2, boolean z, boolean z2, Integer num3, String str6, String str7, List<Embed> list, List<Attachment> list2, Float f2, StructurableText structurableText, List<UploadProgress> list3, List<MessageReaction> list4, Boolean bool, Boolean bool2, List<? extends CodedLinkEmbed> list5, List<Sticker> list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z3, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List<? extends Component> list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List<String> list8, Boolean bool10, Boolean bool11, Long l, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z4, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List<? extends GiftEmbed> list9, GiftEmbed giftEmbed, Integer num5, String str15, List<PostPreviewEmbed> list10, SerializationConstructorMarker serializationConstructorMarker) {
        super(i, serializationConstructorMarker);
        Lazy a;
        if (((11 != (i & 11)) | (1 != (i2 & 1))) || ((i3 & 0) != 0)) {
            C2560n1.m33819a(new int[]{i, i2, i3}, new int[]{11, 1, 0}, Message$$serializer.INSTANCE.getDescriptor());
        }
        ...
        this.useSortedReactions = (33554432 & i) == 0 ? Boolean.TRUE : bool;
        this.useAddBurstReaction = (67108864 & i) == 0 ? Boolean.FALSE : bool2;
        if ((134217728 & i) == 0) {
        ...
        if ((i2 & Spliterator.SUBSIZED) == 0) {
            this.interactionStatus = null;
        } else {
            this.interactionStatus = interactionStatus;
        }
        this.useAttachmentGridLayout = (i2 & 32768) == 0 ? Boolean.FALSE : bool7;
        this.useAttachmentUploadPreview = (i2 & 65536) == 0 ? Boolean.FALSE : bool8;
        this.isCurrentUserMessageAuthor = (i2 & 131072) == 0 ? Boolean.FALSE : bool9;
        if ((i2 & 262144) == 0) {
            this.title = null;
        } else {
            this.title = str11;
        ...
        a = C10839n.m10945a(new C31501());
        this.constrainedWidth$delegate = a;
    }

    public /* synthetic */ Message(int i, int i2, int i3, MessageType messageType, String str, String str2, ChannelId channelId, GuildId guildId, MessageState messageState, UserId userId, long j, String str3, Float f, String str4, String str5, Integer num, Integer num2, boolean z, boolean z2, Integer num3, String str6, String str7, List list, List list2, Float f2, StructurableText structurableText, List list3, List list4, Boolean bool, Boolean bool2, List list5, List list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z3, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List list8, Boolean bool10, Boolean bool11, Long l, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z4, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List list9, GiftEmbed giftEmbed, Integer num5, String str15, List list10, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, i2, i3, messageType, str, str2, channelId, guildId, messageState, userId, j, str3, f, str4, str5, num, num2, z, z2, num3, str6, str7, list, list2, f2, structurableText, list3, list4, bool, bool2, list5, list6, roleIcon, connectionsRoleTag, threadEmbed, z3, bool3, bool4, referencedMessage, executedCommand, list7, str8, bool5, str9, bool6, num4, str10, ephemeralIndication, surveyIndication, interactionStatus, bool7, bool8, bool9, str11, str12, list8, bool10, bool11, l, sticker, str13, str14, bool12, activityInviteEmbed, z4, forumPostActions, autoModerationContext, list9, giftEmbed, num5, str15, list10, serializationConstructorMarker);
    }

    public /* synthetic */ Message(MessageType messageType, String str, String str2, long j, GuildId guildId, MessageState messageState, UserId userId, long j2, String str3, Float f, String str4, String str5, Integer num, Integer num2, boolean z, boolean z2, Integer num3, String str6, String str7, List list, List list2, Float f2, StructurableText structurableText, List list3, List list4, Boolean bool, Boolean bool2, List list5, List list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z3, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List list8, Boolean bool10, Boolean bool11, Long l, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z4, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List list9, GiftEmbed giftEmbed, Integer num5, String str15, List list10, DefaultConstructorMarker defaultConstructorMarker) {
        this(messageType, str, str2, j, guildId, messageState, userId, j2, str3, f, str4, str5, num, num2, z, z2, num3, str6, str7, list, list2, f2, structurableText, list3, list4, bool, bool2, list5, list6, roleIcon, connectionsRoleTag, threadEmbed, z3, bool3, bool4, referencedMessage, executedCommand, list7, str8, bool5, str9, bool6, num4, str10, ephemeralIndication, surveyIndication, interactionStatus, bool7, bool8, bool9, str11, str12, list8, bool10, bool11, l, sticker, str13, str14, bool12, activityInviteEmbed, z4, forumPostActions, autoModerationContext, list9, giftEmbed, num5, str15, list10);
    }
    ...
    public static final void write$Self(Message self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z = false;
        output.mo13870t(serialDesc, 0, MessageType.Serializer.INSTANCE, self.type);
        MessageId$$serializer messageId$$serializer = MessageId$$serializer.INSTANCE;
        output.mo13870t(serialDesc, 1, messageId$$serializer, MessageId.m42115boximpl(self.f8424id));
        if (output.mo13893A(serialDesc, 2) || self.nonce != null) {
            String str = self.nonce;
            output.mo13874p(serialDesc, 2, messageId$$serializer, str != null ? MessageId.m42115boximpl(str) : null);
        }
        output.mo13870t(serialDesc, 3, ChannelId$$serializer.INSTANCE, ChannelId.m42089boximpl(self.channelId));
        if (output.mo13893A(serialDesc, 4) || self.guildId != null) {
            output.mo13874p(serialDesc, 4, GuildId$$serializer.INSTANCE, self.guildId);
        }
        if (output.mo13893A(serialDesc, 5) || self.state != null) {
            output.mo13874p(serialDesc, 5, MessageState.Serializer.INSTANCE, self.state);
        }
        if (output.mo13893A(serialDesc, 6) || self.authorId != null) {
            output.mo13874p(serialDesc, 6, UserId$$serializer.INSTANCE, self.authorId);
        }
        if (output.mo13893A(serialDesc, 7) || self.flags != 0) {
            output.mo13889E(serialDesc, 7, self.flags);
        }
        if (output.mo13893A(serialDesc, 8) || self.edited != null) {
            output.mo13874p(serialDesc, 8, C2500a2.f6719a, self.edited);
        }
        if (output.mo13893A(serialDesc, 9) || self._constrainedWidth != null) {
            output.mo13874p(serialDesc, 9, C2518e0.f6744a, self._constrainedWidth);
        }
        if (output.mo13893A(serialDesc, 10) || self.timestamp != null) {
            output.mo13874p(serialDesc, 10, C2500a2.f6719a, self.timestamp);
        }
        if (output.mo13893A(serialDesc, 11) || self.username != null) {
            output.mo13874p(serialDesc, 11, C2500a2.f6719a, self.username);
        }
        if (output.mo13893A(serialDesc, 12) || self.usernameColor != null) {
            output.mo13874p(serialDesc, 12, C2555m0.f6794a, self.usernameColor);
        }
        if (output.mo13893A(serialDesc, 13) || self.roleColor != null) {
            output.mo13874p(serialDesc, 13, C2555m0.f6794a, self.roleColor);
        }
        if (output.mo13893A(serialDesc, 14) || self.shouldShowRoleDot) {
            output.mo13865y(serialDesc, 14, self.shouldShowRoleDot);
        }
        if (output.mo13893A(serialDesc, 15) || self.shouldShowRoleOnName) {
            output.mo13865y(serialDesc, 15, self.shouldShowRoleOnName);
        }
        if (output.mo13893A(serialDesc, 16) || self.colorString != null) {
            output.mo13874p(serialDesc, 16, C2555m0.f6794a, self.colorString);
        }
        if (output.mo13893A(serialDesc, 17) || self.avatarURL != null) {
            output.mo13874p(serialDesc, 17, C2500a2.f6719a, self.avatarURL);
        }
        if (output.mo13893A(serialDesc, 18) || self.avatarDecorationURL != null) {
            output.mo13874p(serialDesc, 18, C2500a2.f6719a, self.avatarDecorationURL);
        }
        if (output.mo13893A(serialDesc, 19) || self.embeds != null) {
            output.mo13874p(serialDesc, 19, new C2521f(Embed$$serializer.INSTANCE), self.embeds);
        }
        if (output.mo13893A(serialDesc, 20) || self.attachments != null) {
            output.mo13874p(serialDesc, 20, new C2521f(Attachment$$serializer.INSTANCE), self.attachments);
        }
        if (output.mo13893A(serialDesc, 21) || self.attachmentsOpacity != null) {
            output.mo13874p(serialDesc, 21, C2518e0.f6744a, self.attachmentsOpacity);
        }
        if (output.mo13893A(serialDesc, 22) || self.content != null) {
            output.mo13874p(serialDesc, 22, StructurableTextSerializer.INSTANCE, self.content);
        }
        if (output.mo13893A(serialDesc, 23) || self.progress != null) {
            output.mo13874p(serialDesc, 23, new C2521f(UploadProgress$$serializer.INSTANCE), self.progress);
        }
        if (output.mo13893A(serialDesc, 24) || self.reactions != null) {
            output.mo13874p(serialDesc, 24, new C2521f(MessageReaction$$serializer.INSTANCE), self.reactions);
        }
        if (output.mo13893A(serialDesc, 25) || !C9677q.m14638b(self.useSortedReactions, Boolean.TRUE)) {
            output.mo13874p(serialDesc, 25, C2530h.f6761a, self.useSortedReactions);
        }
        if (output.mo13893A(serialDesc, 26) || !C9677q.m14638b(self.useAddBurstReaction, Boolean.FALSE)) {
            output.mo13874p(serialDesc, 26, C2530h.f6761a, self.useAddBurstReaction);
        }
        if (output.mo13893A(serialDesc, 27) || self.codedLinks != null) {
            output.mo13874p(serialDesc, 27, new C2521f(C14606a.m13u(CodedLinkSerializer.INSTANCE)), self.codedLinks);
        }
        if (output.mo13893A(serialDesc, 28) || self.stickers != null) {
            output.mo13874p(serialDesc, 28, new C2521f(Sticker$$serializer.INSTANCE), self.stickers);
        }
        if (output.mo13893A(serialDesc, 29) || self.roleIcon != null) {
            output.mo13874p(serialDesc, 29, RoleIcon$$serializer.INSTANCE, self.roleIcon);
        }
        if (output.mo13893A(serialDesc, 30) || self.connectionsRoleTag != null) {
            output.mo13874p(serialDesc, 30, ConnectionsRoleTag$$serializer.INSTANCE, self.connectionsRoleTag);
        }
        if (output.mo13893A(serialDesc, 31) || self.threadEmbed != null) {
            output.mo13874p(serialDesc, 31, ThreadEmbed$$serializer.INSTANCE, self.threadEmbed);
        }
        output.mo13865y(serialDesc, 32, self.mentioned);
        if (output.mo13893A(serialDesc, 33) || self.gifAutoPlay != null) {
            output.mo13874p(serialDesc, 33, C2530h.f6761a, self.gifAutoPlay);
        }
        if (output.mo13893A(serialDesc, 34) || self.animateEmoji != null) {
            output.mo13874p(serialDesc, 34, C2530h.f6761a, self.animateEmoji);
        }
        if (output.mo13893A(serialDesc, 35) || self.referencedMessage != null) {
            output.mo13874p(serialDesc, 35, ReferencedMessageSerializer.INSTANCE, self.referencedMessage);
        }
        if (output.mo13893A(serialDesc, 36) || self.executedCommand != null) {
            output.mo13874p(serialDesc, 36, ExecutedCommand$$serializer.INSTANCE, self.executedCommand);
        }
        if (output.mo13893A(serialDesc, 37) || self.components != null) {
            output.mo13874p(serialDesc, 37, new C2521f(ComponentSerializer.INSTANCE), self.components);
        }
        if (output.mo13893A(serialDesc, 38) || self.threadStarterMessageHeader != null) {
            output.mo13874p(serialDesc, 38, C2500a2.f6719a, self.threadStarterMessageHeader);
        }
        if (output.mo13893A(serialDesc, 39) || self.communicationDisabled != null) {
            output.mo13874p(serialDesc, 39, C2530h.f6761a, self.communicationDisabled);
        }
        if (output.mo13893A(serialDesc, 40) || self.tagText != null) {
            output.mo13874p(serialDesc, 40, C2500a2.f6719a, self.tagText);
        }
        if (output.mo13893A(serialDesc, 41) || self.tagVerified != null) {
            output.mo13874p(serialDesc, 41, C2530h.f6761a, self.tagVerified);
        }
        if (output.mo13893A(serialDesc, 42) || self.tagBackgroundColor != null) {
            output.mo13874p(serialDesc, 42, C2555m0.f6794a, self.tagBackgroundColor);
        }
        if (output.mo13893A(serialDesc, 43) || self.opTagText != null) {
            output.mo13874p(serialDesc, 43, C2500a2.f6719a, self.opTagText);
        }
        if (output.mo13893A(serialDesc, 44) || self.ephemeralIndication != null) {
            output.mo13874p(serialDesc, 44, EphemeralIndication$$serializer.INSTANCE, self.ephemeralIndication);
        }
        if (output.mo13893A(serialDesc, 45) || self.surveyIndication != null) {
            output.mo13874p(serialDesc, 45, SurveyIndication$$serializer.INSTANCE, self.surveyIndication);
        }
        if (output.mo13893A(serialDesc, 46) || self.interactionStatus != null) {
            output.mo13874p(serialDesc, 46, InteractionStatus$$serializer.INSTANCE, self.interactionStatus);
        }
        if (output.mo13893A(serialDesc, 47) || !C9677q.m14638b(self.useAttachmentGridLayout, Boolean.FALSE)) {
            output.mo13874p(serialDesc, 47, C2530h.f6761a, self.useAttachmentGridLayout);
        }
        if (output.mo13893A(serialDesc, 48) || !C9677q.m14638b(self.useAttachmentUploadPreview, Boolean.FALSE)) {
            output.mo13874p(serialDesc, 48, C2530h.f6761a, self.useAttachmentUploadPreview);
        }
        if (output.mo13893A(serialDesc, 49) || !C9677q.m14638b(self.isCurrentUserMessageAuthor, Boolean.FALSE)) {
            output.mo13874p(serialDesc, 49, C2530h.f6761a, self.isCurrentUserMessageAuthor);
        }
        if (output.mo13893A(serialDesc, 50) || self.title != null) {
            output.mo13874p(serialDesc, 50, C2500a2.f6719a, self.title);
        }
        if (output.mo13893A(serialDesc, 51) || self.description != null) {
            output.mo13874p(serialDesc, 51, C2500a2.f6719a, self.description);
        }
        if (output.mo13893A(serialDesc, 52) || self.avatarURLs != null) {
            output.mo13874p(serialDesc, 52, new C2521f(C2500a2.f6719a), self.avatarURLs);
        }
        if (output.mo13893A(serialDesc, 53) || self.isCallActive != null) {
            output.mo13874p(serialDesc, 53, C2530h.f6761a, self.isCallActive);
        }
        if (output.mo13893A(serialDesc, 54) || self.missed != null) {
            output.mo13874p(serialDesc, 54, C2530h.f6761a, self.missed);
        }
        if (output.mo13893A(serialDesc, 55) || self.rawMilliseconds != null) {
            output.mo13874p(serialDesc, 55, C2589w0.f6835a, self.rawMilliseconds);
        }
        if (output.mo13893A(serialDesc, 56) || self.sticker != null) {
            output.mo13874p(serialDesc, 56, Sticker$$serializer.INSTANCE, self.sticker);
        }
        if (output.mo13893A(serialDesc, 57) || self.stickerLabel != null) {
            output.mo13874p(serialDesc, 57, C2500a2.f6719a, self.stickerLabel);
        }
        if (output.mo13893A(serialDesc, 58) || self.buttonLabel != null) {
            output.mo13874p(serialDesc, 58, C2500a2.f6719a, self.buttonLabel);
        }
        if (output.mo13893A(serialDesc, 59) || self.showInviteToSpeakButton != null) {
            output.mo13874p(serialDesc, 59, C2530h.f6761a, self.showInviteToSpeakButton);
        }
        if (output.mo13893A(serialDesc, 60) || self.activityInviteEmbed != null) {
            output.mo13874p(serialDesc, 60, ActivityInviteEmbed$$serializer.INSTANCE, self.activityInviteEmbed);
        }
        if (output.mo13893A(serialDesc, 61) || self.isFirstForumPostMessage) {
            output.mo13865y(serialDesc, 61, self.isFirstForumPostMessage);
        }
        if (output.mo13893A(serialDesc, 62) || self.postActions != null) {
            output.mo13874p(serialDesc, 62, ForumPostActions$$serializer.INSTANCE, self.postActions);
        }
        if (output.mo13893A(serialDesc, 63) || self.autoModerationContext != null) {
            output.mo13874p(serialDesc, 63, AutoModerationContext$$serializer.INSTANCE, self.autoModerationContext);
        }
        if (output.mo13893A(serialDesc, 64) || self.giftCodes != null) {
            output.mo13874p(serialDesc, 64, new C2521f(GiftEmbedSerializer.INSTANCE), self.giftCodes);
        }
        if (output.mo13893A(serialDesc, 65) || self.referralTrialOffer != null) {
            output.mo13874p(serialDesc, 65, GiftEmbedSerializer.INSTANCE, self.referralTrialOffer);
        }
        if (output.mo13893A(serialDesc, 66) || self.totalMonthsSubscribed != null) {
            output.mo13874p(serialDesc, 66, C2555m0.f6794a, self.totalMonthsSubscribed);
        }
        if (output.mo13893A(serialDesc, 67) || self.swipeToReplyIconUrl != null) {
            output.mo13874p(serialDesc, 67, C2500a2.f6719a, self.swipeToReplyIconUrl);
        }
        if (output.mo13893A(serialDesc, 68) || self.postPreviewEmbeds != null) {
            z = true;
        }
        if (z) {
            output.mo13874p(serialDesc, 68, new C2521f(PostPreviewEmbed$$serializer.INSTANCE), self.postPreviewEmbeds);
        }
    }
    ...
    public final String m41570component23Eiw7ao() {
        return this.f8424id;
    }
    ...
    public final String m41571component3N_6c4I0() {
        return this.nonce;
    }
    ...
    public final long m41572component4o4g7jtM() {
    ...
    public final GuildId m41573component5qOKuAAo() {
        return this.guildId;
    }
    ...
    public final UserId m41574component7wUX8bhU() {
    ...
    public final Message m41575copyHxUhIIA(MessageType type, String id2, String str, long j, GuildId guildId, MessageState messageState, UserId userId, long j2, String str2, Float f, String str3, String str4, Integer num, Integer num2, boolean z, boolean z2, Integer num3, String str5, String str6, List<Embed> list, List<Attachment> list2, Float f2, StructurableText structurableText, List<UploadProgress> list3, List<MessageReaction> list4, Boolean bool, Boolean bool2, List<? extends CodedLinkEmbed> list5, List<Sticker> list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z3, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List<? extends Component> list7, String str7, Boolean bool5, String str8, Boolean bool6, Integer num4, String str9, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str10, String str11, List<String> list8, Boolean bool10, Boolean bool11, Long l, Sticker sticker, String str12, String str13, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z4, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List<? extends GiftEmbed> list9, GiftEmbed giftEmbed, Integer num5, String str14, List<PostPreviewEmbed> list10) {
        C9677q.m14633g(type, "type");
        C9677q.m14633g(id2, "id");
        return new Message(type, id2, str, j, guildId, messageState, userId, j2, str2, f, str3, str4, num, num2, z, z2, num3, str5, str6, list, list2, f2, structurableText, list3, list4, bool, bool2, list5, list6, roleIcon, connectionsRoleTag, threadEmbed, z3, bool3, bool4, referencedMessage, executedCommand, list7, str7, bool5, str8, bool6, num4, str9, ephemeralIndication, surveyIndication, interactionStatus, bool7, bool8, bool9, str10, str11, list8, bool10, bool11, l, sticker, str12, str13, bool12, activityInviteEmbed, z4, forumPostActions, autoModerationContext, list9, giftEmbed, num5, str14, list10, null);
    }
    ...
    */
    ...
    public final UserId m41576getAuthorIdwUX8bhU() {
        return this.authorId;
    }
    ...
    public final long m41577getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final GuildId m41578getGuildIdqOKuAAo() {
        return this.guildId;
    }

    /* renamed from: getId-3Eiw7ao  reason: not valid java name */
    public final String m41579getId3Eiw7ao() {
        return this.f8424id;
    }
    ...
    public final String m41580getNonceN_6c4I0() {
        return this.nonce;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.type.hashCode() * 31) + MessageId.m42120hashCodeimpl(this.f8424id)) * 31;
        String str = this.nonce;
        int i = 0;
        int i2 = (((hashCode + (str == null ? 0 : MessageId.m42120hashCodeimpl(str))) * 31) + ChannelId.m42094hashCodeimpl(this.channelId)) * 31;
        GuildId guildId = this.guildId;
        int i3 = (i2 + (guildId == null ? 0 : GuildId.m42107hashCodeimpl(guildId.m42111unboximpl()))) * 31;
        MessageState messageState = this.state;
        int hashCode2 = (i3 + (messageState == null ? 0 : messageState.hashCode())) * 31;
        UserId userId = this.authorId;
        int i4 = (((hashCode2 + (userId == null ? 0 : UserId.m42158hashCodeimpl(userId.m42162unboximpl()))) * 31) + C2968a.m32873a(this.flags)) * 31;
        ...
        int i15 = z3 ? 1 : 0;
        int i16 = z3 ? 1 : 0;
        int i17 = (hashCode24 + i14) * 31;
        Boolean bool3 = this.gifAutoPlay;
        int hashCode25 = (i17 + (bool3 == null ? 0 : bool3.hashCode())) * 31;
        ...
        int i18 = (hashCode52 + i5) * 31;
        ForumPostActions forumPostActions = this.postActions;
        int hashCode53 = (i18 + (forumPostActions == null ? 0 : forumPostActions.hashCode())) * 31;
    ...
    public String toString() {
        ...
        String str = MessageId.m42121toStringimpl(this.f8424id);
        String str2 = this.nonce;
        String str3 = str2 == null ? "null" : MessageId.m42121toStringimpl(str2);
        String str4 = ChannelId.m42096toStringimpl(this.channelId);
        GuildId guildId = this.guildId;
        MessageState messageState = this.state;
        UserId userId = this.authorId;
        long j = this.flags;
        ...
        List<PostPreviewEmbed> list10 = this.postPreviewEmbeds;
        return "Message(type=" + messageType + ", id=" + str + ", nonce=" + str3 + ", channelId=" + str4 + ", guildId=" + guildId + ", state=" + messageState + ", authorId=" + userId + ", flags=" + j + ", edited=" + str5 + ", _constrainedWidth=" + f + ", timestamp=" + str6 + ", username=" + str7 + ", usernameColor=" + num + ", roleColor=" + num2 + ", shouldShowRoleDot=" + z + ", shouldShowRoleOnName=" + z2 + ", colorString=" + num3 + ", avatarURL=" + str8 + ", avatarDecorationURL=" + str9 + ", embeds=" + list + ", attachments=" + list2 + ", attachmentsOpacity=" + f2 + ", content=" + structurableText + ", progress=" + list3 + ", reactions=" + list4 + ", useSortedReactions=" + bool + ", useAddBurstReaction=" + bool2 + ", codedLinks=" + list5 + ", stickers=" + list6 + ", roleIcon=" + roleIcon + ", connectionsRoleTag=" + connectionsRoleTag + ", threadEmbed=" + threadEmbed + ", mentioned=" + z3 + ", gifAutoPlay=" + bool3 + ", animateEmoji=" + bool4 + ", referencedMessage=" + referencedMessage + ", executedCommand=" + executedCommand + ", components=" + list7 + ", threadStarterMessageHeader=" + str10 + ", communicationDisabled=" + bool5 + ", tagText=" + str11 + ", tagVerified=" + bool6 + ", tagBackgroundColor=" + num4 + ", opTagText=" + str12 + ", ephemeralIndication=" + ephemeralIndication + ", surveyIndication=" + surveyIndication + ", interactionStatus=" + interactionStatus + ", useAttachmentGridLayout=" + bool7 + ", useAttachmentUploadPreview=" + bool8 + ", isCurrentUserMessageAuthor=" + bool9 + ", title=" + str13 + ", description=" + str14 + ", avatarURLs=" + list8 + ", isCallActive=" + bool10 + ", missed=" + bool11 + ", rawMilliseconds=" + l + ", sticker=" + sticker + ", stickerLabel=" + str15 + ", buttonLabel=" + str16 + ", showInviteToSpeakButton=" + bool12 + ", activityInviteEmbed=" + activityInviteEmbed + ", isFirstForumPostMessage=" + z4 + ", postActions=" + forumPostActions + ", autoModerationContext=" + autoModerationContext + ", giftCodes=" + list9 + ", referralTrialOffer=" + giftEmbed + ", totalMonthsSubscribed=" + num5 + ", swipeToReplyIconUrl=" + str17 + ", postPreviewEmbeds=" + list10 + ")";
    }

    public /* synthetic */ Message(MessageType messageType, String str, String str2, long j, GuildId guildId, MessageState messageState, UserId userId, long j2, String str3, Float f, String str4, String str5, Integer num, Integer num2, boolean z, boolean z2, Integer num3, String str6, String str7, List list, List list2, Float f2, StructurableText structurableText, List list3, List list4, Boolean bool, Boolean bool2, List list5, List list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z3, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List list8, Boolean bool10, Boolean bool11, Long l, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z4, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List list9, GiftEmbed giftEmbed, Integer num5, String str15, List list10, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(messageType, str, (i & 4) != 0 ? null : str2, j, (i & 16) != 0 ? null : guildId, (i & 32) != 0 ? null : messageState, (i & 64) != 0 ? null : userId, (i & 128) != 0 ? 0L : j2, (i & Spliterator.NONNULL) != 0 ? null : str3, (i & 512) != 0 ? null : f, (i & Spliterator.IMMUTABLE) != 0 ? null : str4, (i & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : str5, (i & 4096) != 0 ? null : num, (i & 8192) != 0 ? null : num2, (i & Spliterator.SUBSIZED) != 0 ? false : z, (i & 32768) != 0 ? false : z2, (i & 65536) != 0 ? null : num3, (i & 131072) != 0 ? null : str6, (i & 262144) != 0 ? null : str7, (i & 524288) != 0 ? null : list, (i & 1048576) != 0 ? null : list2, (i & 2097152) != 0 ? null : f2, (i & 4194304) != 0 ? null : structurableText, (i & 8388608) != 0 ? null : list3, (i & 16777216) != 0 ? null : list4, (i & 33554432) != 0 ? Boolean.TRUE : bool, (i & 67108864) != 0 ? Boolean.FALSE : bool2, (i & 134217728) != 0 ? null : list5, (i & 268435456) != 0 ? null : list6, (i & 536870912) != 0 ? null : roleIcon, (i & 1073741824) != 0 ? null : connectionsRoleTag, (i & Integer.MIN_VALUE) != 0 ? null : threadEmbed, z3, (i2 & 2) != 0 ? null : bool3, (i2 & 4) != 0 ? null : bool4, (i2 & 8) != 0 ? null : referencedMessage, (i2 & 16) != 0 ? null : executedCommand, (i2 & 32) != 0 ? null : list7, (i2 & 64) != 0 ? null : str8, (i2 & 128) != 0 ? null : bool5, (i2 & Spliterator.NONNULL) != 0 ? null : str9, (i2 & 512) != 0 ? null : bool6, (i2 & Spliterator.IMMUTABLE) != 0 ? null : num4, (i2 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : str10, (i2 & 4096) != 0 ? null : ephemeralIndication, (i2 & 8192) != 0 ? null : surveyIndication, (i2 & Spliterator.SUBSIZED) != 0 ? null : interactionStatus, (32768 & i2) != 0 ? Boolean.FALSE : bool7, (i2 & 65536) != 0 ? Boolean.FALSE : bool8, (i2 & 131072) != 0 ? Boolean.FALSE : bool9, (i2 & 262144) != 0 ? null : str11, (i2 & 524288) != 0 ? null : str12, (i2 & 1048576) != 0 ? null : list8, (i2 & 2097152) != 0 ? null : bool10, (i2 & 4194304) != 0 ? null : bool11, (8388608 & i2) != 0 ? null : l, (16777216 & i2) != 0 ? null : sticker, (33554432 & i2) != 0 ? null : str13, (67108864 & i2) != 0 ? null : str14, (134217728 & i2) != 0 ? null : bool12, (268435456 & i2) != 0 ? null : activityInviteEmbed, (536870912 & i2) != 0 ? false : z4, (1073741824 & i2) != 0 ? null : forumPostActions, (i2 & Integer.MIN_VALUE) != 0 ? null : autoModerationContext, (i3 & 1) != 0 ? null : list9, (i3 & 2) != 0 ? null : giftEmbed, (i3 & 4) != 0 ? null : num5, (i3 & 8) != 0 ? null : str15, (i3 & 16) != 0 ? null : list10, null);
    }
    ...
    private Message(MessageType messageType, String str, String str2, long j, GuildId guildId, MessageState messageState, UserId userId, long j2, String str3, Float f, String str4, String str5, Integer num, Integer num2, boolean z, boolean z2, Integer num3, String str6, String str7, List<Embed> list, List<Attachment> list2, Float f2, StructurableText structurableText, List<UploadProgress> list3, List<MessageReaction> list4, Boolean bool, Boolean bool2, List<? extends CodedLinkEmbed> list5, List<Sticker> list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z3, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List<? extends Component> list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List<String> list8, Boolean bool10, Boolean bool11, Long l, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z4, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List<? extends GiftEmbed> list9, GiftEmbed giftEmbed, Integer num5, String str15, List<PostPreviewEmbed> list10) {
        ...
        this.swipeToReplyIconUrl = str15;
        this.postPreviewEmbeds = list10;
        a = C10839n.m10945a(new Message$constrainedWidth$2(this));
        this.constrainedWidth$delegate = a;
    }
}
