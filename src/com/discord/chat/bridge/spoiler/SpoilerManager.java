...
public final class SpoilerManager {
    ...
    public final boolean m41693isNotRevealedV2PEE7g(String id2) {
        C9677q.m14633g(id2, "id");
        return !m41694isRevealedV2PEE7g(id2);
    }

    /* renamed from: isRevealed-V2PEE7g  reason: not valid java name */
    public final boolean m41694isRevealedV2PEE7g(String id2) {
        C9677q.m14633g(id2, "id");
        return revealedSpoilers.contains(SpoilerIdentifier.m41685boximpl(id2));
    }

    /* renamed from: markRevealed-V2PEE7g  reason: not valid java name */
    public final void m41695markRevealedV2PEE7g(String id2) {
        C9677q.m14633g(id2, "id");
        revealedSpoilers.add(SpoilerIdentifier.m41685boximpl(id2));
    }
