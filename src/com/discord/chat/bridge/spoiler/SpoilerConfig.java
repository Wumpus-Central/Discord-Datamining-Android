...
public final class SpoilerConfig {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ SpoilerConfig copy$default(SpoilerConfig spoilerConfig, SpoilerAttributes spoilerAttributes, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final void onReveal() {
        this.onReveal.invoke(SpoilerIdentifier.m41685boximpl(this.attributes.m41682getIdentifierBq9X6Gg()));
    }
