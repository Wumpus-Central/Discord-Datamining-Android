...
public final class SpoilerAttributes {
    ...
    public static final class Companion {
        ...
        private final SpoilerAttributes m41683forItemA9xMOlw(SpoilerableData spoilerableData, String str, String str2) {
            String spoilerOrNull = spoilerableData.getSpoilerOrNull();
            if (spoilerOrNull == null) {
                return null;
            }
            String str3 = MessageId.m42121toStringimpl(str);
            return new SpoilerAttributes(SpoilerIdentifier.m41686constructorimpl("spoiler:messageId" + str3 + ":" + str2), spoilerOrNull, null);
        }
    ...
    public static /* synthetic */ SpoilerAttributes m41679copyBDqOPVI$default(SpoilerAttributes spoilerAttributes, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return spoilerAttributes.m41681copyBDqOPVI(str, str2);
    }

    /* renamed from: component1-Bq9X6Gg  reason: not valid java name */
    public final String m41680component1Bq9X6Gg() {
    ...
    public final String m41682getIdentifierBq9X6Gg() {
        return this.identifier;
    }
    ...
    public int hashCode() {
        return (SpoilerIdentifier.m41689hashCodeimpl(this.identifier) * 31) + this.label.hashCode();
    }

    public String toString() {
        String str = SpoilerIdentifier.m41690toStringimpl(this.identifier);
