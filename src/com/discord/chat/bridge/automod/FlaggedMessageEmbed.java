...
public final class FlaggedMessageEmbed {
    ...
    private FlaggedMessageEmbed(int i, String str, ChannelId channelId, GuildId guildId, UserId userId, StructurableText structurableText, String str2, String str3, int i2, Integer num, boolean z, String str4, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        if (643 != (i & 643)) {
            C3681n1.m33818b(i, 643, FlaggedMessageEmbed$$serializer.INSTANCE.getDescriptor());
        }
        this.f7203id = str;
    ...
    public static final void write$Self(FlaggedMessageEmbed self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z8 = false;
        output.mo13870t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m42115boximpl(self.f7203id));
        ...
        if (z4) {
            output.mo13874p(serialDesc, 5, C3622a2.f5917a, self.channelName);
        }
        ...
        if (z5) {
            output.mo13874p(serialDesc, 6, C3622a2.f5917a, self.username);
        }
        ...
        if (z6) {
            output.mo13874p(serialDesc, 8, C3676m0.f5992a, self.roleColor);
        }
        ...
        if (z7) {
            output.mo13874p(serialDesc, 10, C3622a2.f5917a, self.avatarURL);
        }
        if (output.mo13893A(serialDesc, 11) || !C9971q.m14638b(self.communicationDisabled, Boolean.FALSE)) {
            z8 = true;
        }
        if (z8) {
            output.mo13874p(serialDesc, 11, C3652h.f5959a, self.communicationDisabled);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(this.f7203id, flaggedMessageEmbed.f7203id) && ChannelId.m42093equalsimpl0(this.channelId, flaggedMessageEmbed.channelId) && C9971q.m14638b(this.guildId, flaggedMessageEmbed.guildId) && C9971q.m14638b(this.userId, flaggedMessageEmbed.userId) && C9971q.m14638b(this.content, flaggedMessageEmbed.content) && C9971q.m14638b(this.channelName, flaggedMessageEmbed.channelName) && C9971q.m14638b(this.username, flaggedMessageEmbed.username) && this.usernameColor == flaggedMessageEmbed.usernameColor && C9971q.m14638b(this.roleColor, flaggedMessageEmbed.roleColor) && this.shouldShowRoleDot == flaggedMessageEmbed.shouldShowRoleDot && C9971q.m14638b(this.avatarURL, flaggedMessageEmbed.avatarURL) && C9971q.m14638b(this.communicationDisabled, flaggedMessageEmbed.communicationDisabled);
    }
    ...
    public int hashCode() {
        int i = ((MessageId.m42120hashCodeimpl(this.f7203id) * 31) + ChannelId.m42094hashCodeimpl(this.channelId)) * 31;
    ...
    public String toString() {
        String str = MessageId.m42121toStringimpl(this.f7203id);
