...
public final class EmbeddedActivityInviteEmbedImpl extends CodedLinkEmbed implements EmbeddedActivityInviteEmbed {
    ...
    public /* synthetic */ EmbeddedActivityInviteEmbedImpl(int i, int i2, int i3, int i4, int i5, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, Integer num4, Boolean bool, Boolean bool2, Integer num5, Integer num6, Boolean bool3, Integer num7, String str4, String str5, String str6, Integer num8, Integer num9, Integer num10, String str7, String str8, Integer num11, String str9, List list, CodedLinkExtendedType codedLinkExtendedType, AnnotatedStructurableText annotatedStructurableText, String str10, boolean z, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if ((-939524081 != (i & (-939524081))) || ((i2 & 0) != 0)) {
            C3681n1.m33819a(new int[]{i, i2}, new int[]{-939524081, 0}, EmbeddedActivityInviteEmbedImpl$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(EmbeddedActivityInviteEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.mo13893A(serialDesc, 12) || self.getEmbedCanBeTapped() != null) {
            output.mo13874p(serialDesc, 12, C3652h.f5959a, self.getEmbedCanBeTapped());
        }
        if (output.mo13893A(serialDesc, 13) || self.getResolvingGradientEnd() != null) {
            output.mo13874p(serialDesc, 13, C3676m0.f5992a, self.getResolvingGradientEnd());
        }
        if (output.mo13893A(serialDesc, 14) || self.getResolvingGradientStart() != null) {
            output.mo13874p(serialDesc, 14, C3676m0.f5992a, self.getResolvingGradientStart());
        }
        if (output.mo13893A(serialDesc, 15) || self.getSplashHasRadialGradient() != null) {
            output.mo13874p(serialDesc, 15, C3652h.f5959a, self.getSplashHasRadialGradient());
        }
        if (output.mo13893A(serialDesc, 16) || self.getSplashOpacity() != null) {
            output.mo13874p(serialDesc, 16, C3676m0.f5992a, self.getSplashOpacity());
        }
        ...
        if (output.mo13893A(serialDesc, 20) || self.getSubtitleColor() != null) {
            output.mo13874p(serialDesc, 20, C3676m0.f5992a, self.getSubtitleColor());
        }
        if (output.mo13893A(serialDesc, 21) || self.getThumbnailBackgroundColor() != null) {
            output.mo13874p(serialDesc, 21, C3676m0.f5992a, self.getThumbnailBackgroundColor());
        }
        if (output.mo13893A(serialDesc, 22) || self.getThumbnailCornerRadius() != null) {
            output.mo13874p(serialDesc, 22, C3676m0.f5992a, self.getThumbnailCornerRadius());
        }
        ...
        if (output.mo13893A(serialDesc, 25) || self.getTitleColor() != null) {
            output.mo13874p(serialDesc, 25, C3676m0.f5992a, self.getTitleColor());
        }
        if (output.mo13893A(serialDesc, 26) || self.getTitleText() != null) {
            output.mo13874p(serialDesc, 26, a2Var, self.getTitleText());
        }
        output.mo13870t(serialDesc, 27, new C3643f(a2Var), self.getParticipantAvatarUris());
    ...
    public final EmbeddedActivityInviteEmbedImpl copy(int i, int i2, int i3, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, Integer num4, Boolean bool, Boolean bool2, Integer num5, Integer num6, Boolean bool3, Integer num7, String str4, String str5, String str6, Integer num8, Integer num9, Integer num10, String str7, String str8, Integer num11, String str9, List<String> participantAvatarUris, CodedLinkExtendedType extendedType, AnnotatedStructurableText annotatedStructurableText, String noParticipantsText, boolean z) {
        C9971q.m14633g(participantAvatarUris, "participantAvatarUris");
        C9971q.m14633g(extendedType, "extendedType");
        C9971q.m14633g(noParticipantsText, "noParticipantsText");
    ...
    public boolean equals(Object obj) {
        ...
        return getBackgroundColor() == embeddedActivityInviteEmbedImpl.getBackgroundColor() && getBorderColor() == embeddedActivityInviteEmbedImpl.getBorderColor() && getHeaderColor() == embeddedActivityInviteEmbedImpl.getHeaderColor() && C9971q.m14638b(getHeaderText(), embeddedActivityInviteEmbedImpl.getHeaderText()) && getType() == embeddedActivityInviteEmbedImpl.getType() && C9971q.m14638b(getAcceptLabelBackgroundColor(), embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor()) && C9971q.m14638b(getAcceptLabelBorderColor(), embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor()) && C9971q.m14638b(getAcceptLabelColor(), embeddedActivityInviteEmbedImpl.getAcceptLabelColor()) && C9971q.m14638b(getAcceptLabelText(), embeddedActivityInviteEmbedImpl.getAcceptLabelText()) && C9971q.m14638b(getBodyText(), embeddedActivityInviteEmbedImpl.getBodyText()) && C9971q.m14638b(getBodyTextColor(), embeddedActivityInviteEmbedImpl.getBodyTextColor()) && C9971q.m14638b(getCanBeAccepted(), embeddedActivityInviteEmbedImpl.getCanBeAccepted()) && C9971q.m14638b(getEmbedCanBeTapped(), embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped()) && C9971q.m14638b(getResolvingGradientEnd(), embeddedActivityInviteEmbedImpl.getResolvingGradientEnd()) && C9971q.m14638b(getResolvingGradientStart(), embeddedActivityInviteEmbedImpl.getResolvingGradientStart()) && C9971q.m14638b(getSplashHasRadialGradient(), embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient()) && C9971q.m14638b(getSplashOpacity(), embeddedActivityInviteEmbedImpl.getSplashOpacity()) && C9971q.m14638b(getSplashUrl(), embeddedActivityInviteEmbedImpl.getSplashUrl()) && C9971q.m14638b(getInviteSplash(), embeddedActivityInviteEmbedImpl.getInviteSplash()) && C9971q.m14638b(getSubtitle(), embeddedActivityInviteEmbedImpl.getSubtitle()) && C9971q.m14638b(getSubtitleColor(), embeddedActivityInviteEmbedImpl.getSubtitleColor()) && C9971q.m14638b(getThumbnailBackgroundColor(), embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor()) && C9971q.m14638b(getThumbnailCornerRadius(), embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius()) && C9971q.m14638b(getThumbnailText(), embeddedActivityInviteEmbedImpl.getThumbnailText()) && C9971q.m14638b(getThumbnailUrl(), embeddedActivityInviteEmbedImpl.getThumbnailUrl()) && C9971q.m14638b(getTitleColor(), embeddedActivityInviteEmbedImpl.getTitleColor()) && C9971q.m14638b(getTitleText(), embeddedActivityInviteEmbedImpl.getTitleText()) && C9971q.m14638b(getParticipantAvatarUris(), embeddedActivityInviteEmbedImpl.getParticipantAvatarUris()) && getExtendedType() == embeddedActivityInviteEmbedImpl.getExtendedType() && C9971q.m14638b(getStructurableSubtitleText(), embeddedActivityInviteEmbedImpl.getStructurableSubtitleText()) && C9971q.m14638b(getNoParticipantsText(), embeddedActivityInviteEmbedImpl.getNoParticipantsText()) && getCtaEnabled() == embeddedActivityInviteEmbedImpl.getCtaEnabled();
    }
