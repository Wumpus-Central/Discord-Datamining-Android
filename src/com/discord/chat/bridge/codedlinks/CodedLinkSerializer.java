...
public final class CodedLinkSerializer extends AbstractC9992d<CodedLinkEmbed> {
    public static final CodedLinkSerializer INSTANCE = new CodedLinkSerializer();

    private CodedLinkSerializer() {
        super(C9656f0.m14684b(CodedLinkEmbed.class));
    }
    ...
    protected DeserializationStrategy<CodedLinkEmbed> selectDeserializer(JsonElement element) {
        ...
        JsonElement jsonElement = (JsonElement) C9994f.m13719j(element).get("extendedType");
        if (jsonElement == null || (k = C9994f.m13718k(jsonElement)) == null) {
            str = null;
        } else {
            str = k.mo13692a();
        }
        if (C9677q.m14638b(str, String.valueOf(CodedLinkExtendedType.GUILD_SCHEDULED_EVENT.getSerialNumber()))) {
            return GuildEventInviteEmbedImpl.Companion.serializer();
        }
        if (C9677q.m14638b(str, String.valueOf(CodedLinkExtendedType.GUILD_INVITE_DISABLED.getSerialNumber()))) {
            return GuildInviteDisabledEmbedImpl.Companion.serializer();
        }
        if (C9677q.m14638b(str, String.valueOf(CodedLinkExtendedType.ACTIVITY_LAUNCHER.getSerialNumber()))) {
            return ActivityLauncherEmbedImpl.Companion.serializer();
        }
        if (C9677q.m14638b(str, String.valueOf(CodedLinkExtendedType.EMBEDDED_ACTIVITY_INVITE.getSerialNumber()))) {
