...
public final class ActivityLauncherEmbedImpl extends CodedLinkEmbed implements ActivityLauncherEmbed {
    ...
    private ActivityLauncherEmbedImpl(int i, int i2, int i3, int i4, int i5, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, Integer num4, Boolean bool, Boolean bool2, Integer num5, Integer num6, Boolean bool3, Integer num7, String str4, String str5, String str6, Integer num8, Integer num9, Integer num10, String str7, String str8, Integer num11, String str9, ApplicationId applicationId, ChannelId channelId, CodedLinkExtendedType codedLinkExtendedType, List<String> list, String str10, String str11, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if ((1476395023 != (i & 1476395023)) || (1 != (i2 & 1))) {
            C3681n1.m33819a(new int[]{i, i2}, new int[]{1476395023, 1}, ActivityLauncherEmbedImpl$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(ActivityLauncherEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 30, new C3643f(a2Var), self.getParticipantAvatarUris());
    ...
    public final ActivityLauncherEmbedImpl m41600copy3qwsJ70(int i, int i2, int i3, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, Integer num4, Boolean bool, Boolean bool2, Integer num5, Integer num6, Boolean bool3, Integer num7, String str4, String str5, String str6, Integer num8, Integer num9, Integer num10, String str7, String str8, Integer num11, String str9, long j, long j2, CodedLinkExtendedType extendedType, List<String> participantAvatarUris, String str10, String participantsText) {
        ...
        C9971q.m14633g(participantsText, "participantsText");
    ...
    public boolean equals(Object obj) {
        ...
        return getBackgroundColor() == activityLauncherEmbedImpl.getBackgroundColor() && getBorderColor() == activityLauncherEmbedImpl.getBorderColor() && getHeaderColor() == activityLauncherEmbedImpl.getHeaderColor() && C9971q.m14638b(getHeaderText(), activityLauncherEmbedImpl.getHeaderText()) && getType() == activityLauncherEmbedImpl.getType() && C9971q.m14638b(getAcceptLabelBackgroundColor(), activityLauncherEmbedImpl.getAcceptLabelBackgroundColor()) && C9971q.m14638b(getAcceptLabelBorderColor(), activityLauncherEmbedImpl.getAcceptLabelBorderColor()) && C9971q.m14638b(getAcceptLabelColor(), activityLauncherEmbedImpl.getAcceptLabelColor()) && C9971q.m14638b(getAcceptLabelText(), activityLauncherEmbedImpl.getAcceptLabelText()) && C9971q.m14638b(getBodyText(), activityLauncherEmbedImpl.getBodyText()) && C9971q.m14638b(getBodyTextColor(), activityLauncherEmbedImpl.getBodyTextColor()) && C9971q.m14638b(getCanBeAccepted(), activityLauncherEmbedImpl.getCanBeAccepted()) && C9971q.m14638b(getEmbedCanBeTapped(), activityLauncherEmbedImpl.getEmbedCanBeTapped()) && C9971q.m14638b(getResolvingGradientEnd(), activityLauncherEmbedImpl.getResolvingGradientEnd()) && C9971q.m14638b(getResolvingGradientStart(), activityLauncherEmbedImpl.getResolvingGradientStart()) && C9971q.m14638b(getSplashHasRadialGradient(), activityLauncherEmbedImpl.getSplashHasRadialGradient()) && C9971q.m14638b(getSplashOpacity(), activityLauncherEmbedImpl.getSplashOpacity()) && C9971q.m14638b(getSplashUrl(), activityLauncherEmbedImpl.getSplashUrl()) && C9971q.m14638b(getInviteSplash(), activityLauncherEmbedImpl.getInviteSplash()) && C9971q.m14638b(getSubtitle(), activityLauncherEmbedImpl.getSubtitle()) && C9971q.m14638b(getSubtitleColor(), activityLauncherEmbedImpl.getSubtitleColor()) && C9971q.m14638b(getThumbnailBackgroundColor(), activityLauncherEmbedImpl.getThumbnailBackgroundColor()) && C9971q.m14638b(getThumbnailCornerRadius(), activityLauncherEmbedImpl.getThumbnailCornerRadius()) && C9971q.m14638b(getThumbnailText(), activityLauncherEmbedImpl.getThumbnailText()) && C9971q.m14638b(getThumbnailUrl(), activityLauncherEmbedImpl.getThumbnailUrl()) && C9971q.m14638b(getTitleColor(), activityLauncherEmbedImpl.getTitleColor()) && C9971q.m14638b(getTitleText(), activityLauncherEmbedImpl.getTitleText()) && ApplicationId.m42080equalsimpl0(mo41595getApplicationIdVavddsQ(), activityLauncherEmbedImpl.mo41595getApplicationIdVavddsQ()) && ChannelId.m42093equalsimpl0(mo41596getChannelIdo4g7jtM(), activityLauncherEmbedImpl.mo41596getChannelIdo4g7jtM()) && getExtendedType() == activityLauncherEmbedImpl.getExtendedType() && C9971q.m14638b(getParticipantAvatarUris(), activityLauncherEmbedImpl.getParticipantAvatarUris()) && C9971q.m14638b(getDescription(), activityLauncherEmbedImpl.getDescription()) && C9971q.m14638b(getParticipantsText(), activityLauncherEmbedImpl.getParticipantsText());
    }
