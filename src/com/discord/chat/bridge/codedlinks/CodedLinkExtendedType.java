...
public enum CodedLinkExtendedType implements IntEnum {
    ...
    public static final class Serializer extends IntEnumSerializer<CodedLinkExtendedType> {
        ...
        private Serializer() {
            super(C9656f0.m14684b(CodedLinkExtendedType.class), null, 2, null);
        }
    }

    static {
        Lazy<KSerializer<Object>> b;
        b = C10839n.m10944b(EnumC10842p.PUBLICATION, CodedLinkExtendedType$Companion$$cachedSerializer$delegate$1.INSTANCE);
