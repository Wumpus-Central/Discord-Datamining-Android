...
public final class Attachment implements SpoilerableData {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/attachment/Attachment$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/attachment/Attachment;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    */
    ...
    private final Integer getProxyUrlQueryParam(String str) {
        ...
        try {
            ...
            if (value != null) {
                C9971q.m14634f(value, "getValue(paramName)");
                num = C12717t.m5747m(value);
            } else {
                num = null;
            }
            obj = C11090s.m10940b(num);
        } catch (Throwable th2) {
    ...
    */
    ...
    public final Attachment copy(String url, String str, String filename, String size, Integer num, Integer num2, boolean z, String str2, String str3, String str4, String str5, boolean z2, Integer num3, String str6, String str7, Float f, String str8, boolean z3) {
        C9971q.m14633g(url, "url");
        C9971q.m14633g(filename, "filename");
        C9971q.m14633g(size, "size");
        return new Attachment(url, str, filename, size, num, num2, z, str2, str3, str4, str5, z2, num3, str6, str7, f, str8, z3);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.url, attachment.url) && C9971q.m14638b(this.videoUrl, attachment.videoUrl) && C9971q.m14638b(this.filename, attachment.filename) && C9971q.m14638b(this.size, attachment.size) && C9971q.m14638b(this.sourceWidth, attachment.sourceWidth) && C9971q.m14638b(this.sourceHeight, attachment.sourceHeight) && this.isSpoiler == attachment.isSpoiler && C9971q.m14638b(this.spoiler, attachment.spoiler) && C9971q.m14638b(this.description, attachment.description) && C9971q.m14638b(this.hint, attachment.hint) && C9971q.m14638b(this.role, attachment.role) && this.showDescription == attachment.showDescription && C9971q.m14638b(this.progress, attachment.progress) && C9971q.m14638b(this.uploaderId, attachment.uploaderId) && C9971q.m14638b(this.uploaderItemId, attachment.uploaderItemId) && C9971q.m14638b(this.durationSecs, attachment.durationSecs) && C9971q.m14638b(this.waveform, attachment.waveform) && this.isAnimated == attachment.isAnimated;
    }
    ...
    public int hashCode() {
        ...
        int hashCode9 = (i10 + (num3 == null ? 0 : num3.hashCode())) * 31;
    ...
    public String toString() {
        ...
        boolean z3 = this.isAnimated;
        return "Attachment(url=" + str + ", videoUrl=" + str2 + ", filename=" + str3 + ", size=" + str4 + ", sourceWidth=" + num + ", sourceHeight=" + num2 + ", isSpoiler=" + z + ", spoiler=" + str5 + ", description=" + str6 + ", hint=" + str7 + ", role=" + str8 + ", showDescription=" + z2 + ", progress=" + num3 + ", uploaderId=" + str9 + ", uploaderItemId=" + str10 + ", durationSecs=" + f + ", waveform=" + str11 + ", isAnimated=" + z3 + ")";
    }
    ...
    */
    public Attachment(java.lang.String r7, java.lang.String r8, java.lang.String r9, java.lang.String r10, java.lang.Integer r11, java.lang.Integer r12, boolean r13, java.lang.String r14, java.lang.String r15, java.lang.String r16, java.lang.String r17, boolean r18, java.lang.Integer r19, java.lang.String r20, java.lang.String r21, java.lang.Float r22, java.lang.String r23, boolean r24) {
        /*
            ...
            kotlin.jvm.internal.C9971q.m14633g(r7, r5)
            java.lang.String r5 = "filename"
            kotlin.jvm.internal.C9971q.m14633g(r9, r5)
            java.lang.String r5 = "size"
            kotlin.jvm.internal.C9971q.m14633g(r10, r5)
            r6.<init>()
            r0.url = r1
            r1 = r8
            r0.videoUrl = r1
        ...
        L_0x005c:
            ...
            boolean r5 = p326ri.C12707l.m5767w(r3)
    ...
    public /* synthetic */ Attachment(String str, String str2, String str3, String str4, Integer num, Integer num2, boolean z, String str5, String str6, String str7, String str8, boolean z2, Integer num3, String str9, String str10, Float f, String str11, boolean z3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, (i & 2) != 0 ? null : str2, str3, str4, (i & 16) != 0 ? null : num, (i & 32) != 0 ? null : num2, z, (i & 128) != 0 ? null : str5, (i & Spliterator.NONNULL) != 0 ? null : str6, (i & 512) != 0 ? null : str7, (i & Spliterator.IMMUTABLE) != 0 ? null : str8, (i & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? false : z2, (i & 4096) != 0 ? null : num3, (i & 8192) != 0 ? null : str9, (i & Spliterator.SUBSIZED) != 0 ? null : str10, (32768 & i) != 0 ? null : f, (65536 & i) != 0 ? null : str11, (i & 131072) != 0 ? true : z3);
    }
}
