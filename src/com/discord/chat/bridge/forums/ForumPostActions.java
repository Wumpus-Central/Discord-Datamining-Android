...
public final class ForumPostActions {
    ...
    public /* synthetic */ ForumPostActions(int i, int i2, boolean z, String str, String str2, String str3, String str4, MessageReaction messageReaction, SerializationConstructorMarker serializationConstructorMarker) {
        if (63 != (i & 63)) {
            C3681n1.m33818b(i, 63, ForumPostActions$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public final ForumPostActions copy(int i, boolean z, String followIcon, String followLabel, String shareIcon, String shareLabel, MessageReaction messageReaction) {
        C9971q.m14633g(followIcon, "followIcon");
        C9971q.m14633g(followLabel, "followLabel");
        C9971q.m14633g(shareIcon, "shareIcon");
        C9971q.m14633g(shareLabel, "shareLabel");
    ...
    public boolean equals(Object obj) {
        ...
        return this.numDisplayedReactions == forumPostActions.numDisplayedReactions && this.isFollowing == forumPostActions.isFollowing && C9971q.m14638b(this.followIcon, forumPostActions.followIcon) && C9971q.m14638b(this.followLabel, forumPostActions.followLabel) && C9971q.m14638b(this.shareIcon, forumPostActions.shareIcon) && C9971q.m14638b(this.shareLabel, forumPostActions.shareLabel) && C9971q.m14638b(this.defaultReaction, forumPostActions.defaultReaction);
    }
