...
public final class MessageFrameJump extends MessageFrame {
    ...
    public /* synthetic */ MessageFrameJump(int i, MessageFrameType messageFrameType, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i & 1)) {
            C3681n1.m33818b(i, 1, MessageFrameJump$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(MessageFrameJump self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 1, C3622a2.f5917a, self.guildName);
        }
        if (output.mo13893A(serialDesc, 2) || self.channelName != null) {
            z2 = true;
        }
        if (z2) {
            output.mo13874p(serialDesc, 2, C3622a2.f5917a, self.channelName);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == messageFrameJump.getType() && C9971q.m14638b(this.guildName, messageFrameJump.guildName) && C9971q.m14638b(this.channelName, messageFrameJump.channelName);
    }
