...
public final class MessageFrameSerializer extends AbstractC10272d<MessageFrame> {
    ...
    static {
        ...
        messageFrameClassSerializer = new SealedClassSerializer<>("MessageFrame", C9951f0.m14684b(MessageFrame.class), new KClass[]{C9951f0.m14684b(UnknownMessageFrame.class), C9951f0.m14684b(MessageFrameJump.class), C9951f0.m14684b(MessageFrameMediaViewer.class)}, new KSerializer[]{UnknownMessageFrame.Companion.serializer(), MessageFrameJump.Companion.serializer(), MessageFrameMediaViewer.Companion.serializer()});
    }

    private MessageFrameSerializer() {
        super(C9951f0.m14684b(MessageFrame.class));
    }
