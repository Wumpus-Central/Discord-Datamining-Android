...
public final class RoleIcon {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/roleicons/RoleIcon$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/roleicons/RoleIcon;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public static /* synthetic */ RoleIcon copy$default(RoleIcon roleIcon, String str, String str2, String str3, int i, String str4, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = roleIcon.source;
        }
        if ((i2 & 2) != 0) {
        ...
        return roleIcon.copy(str, str2, str3, i, str4);
    }
    ...
    public static final void write$Self(RoleIcon self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13864z(serialDesc, 4, self.alt);
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + i) * 31) + this.name.hashCode()) * 31) + this.size) * 31) + this.alt.hashCode();
    }
    ...
    public String toString() {
        ...
        return "RoleIcon(source=" + str + ", unicodeEmoji=" + str2 + ", name=" + str3 + ", size=" + i + ", alt=" + str4 + ")";
    }
    ...
    public /* synthetic */ RoleIcon(String str, String str2, String str3, int i, String str4, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? null : str, (i2 & 2) != 0 ? null : str2, str3, i, str4);
    }
}
