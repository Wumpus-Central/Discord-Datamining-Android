...
public final class AnnotatedStructurableTextSerializer implements KSerializer<AnnotatedStructurableText> {
    ...
    private static final SerialDescriptor descriptor = C0207g.m41131a("AnnotatedStructurableText", AbstractC0192e.C0201i.f537a);
    ...
    public AnnotatedStructurableText deserialize(Decoder decoder) {
        ...
        return new AnnotatedStructurableText((List) decoder.mo13909G(new C2521f(ContentNodeSerializer.INSTANCE)));
    }
