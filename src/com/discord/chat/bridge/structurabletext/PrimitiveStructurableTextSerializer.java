...
public final class PrimitiveStructurableTextSerializer implements KSerializer<PrimitiveStructurableText> {
    ...
    private static final SerialDescriptor descriptor = C0207g.m41131a("PrimitiveStructurableText", AbstractC0192e.C0201i.f537a);
    ...
    public PrimitiveStructurableText deserialize(Decoder decoder) {
        ...
        return new PrimitiveStructurableText(decoder.mo13894z());
    }
