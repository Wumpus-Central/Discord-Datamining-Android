...
public final class Sticker {
    ...
    public /* synthetic */ Sticker(int i, long j, StickerFormatType stickerFormatType, String str, String str2, String str3, Integer num, Integer num2, int i2, SerializationConstructorMarker serializationConstructorMarker) {
        if (159 != (i & 159)) {
            C3681n1.m33818b(i, 159, Sticker$$serializer.INSTANCE.getDescriptor());
        }
        this.f7213id = j;
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z2 = false;
        output.mo13889E(serialDesc, 0, self.f7213id);
        ...
        if (z) {
            output.mo13874p(serialDesc, 5, C3676m0.f5992a, self.width);
        }
        if (output.mo13893A(serialDesc, 6) || self.height != null) {
            z2 = true;
        }
        if (z2) {
            output.mo13874p(serialDesc, 6, C3676m0.f5992a, self.height);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7213id == sticker.f7213id && this.formatType == sticker.formatType && C9971q.m14638b(this.name, sticker.name) && C9971q.m14638b(this.asset, sticker.asset) && C9971q.m14638b(this.url, sticker.url) && C9971q.m14638b(this.width, sticker.width) && C9971q.m14638b(this.height, sticker.height) && this.renderMode == sticker.renderMode;
    }
    ...
    public int hashCode() {
        int a = ((((((((C4081a.m32873a(this.f7213id) * 31) + this.formatType.hashCode()) * 31) + this.name.hashCode()) * 31) + this.asset.hashCode()) * 31) + this.url.hashCode()) * 31;
