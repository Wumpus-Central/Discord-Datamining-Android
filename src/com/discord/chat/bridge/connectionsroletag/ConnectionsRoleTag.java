...
public final class ConnectionsRoleTag {
    ...
    public /* synthetic */ ConnectionsRoleTag(int i, String str, String str2, int i2, int i3, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C2560n1.m33818b(i, 15, ConnectionsRoleTag$$serializer.INSTANCE.getDescriptor());
        }
        this.f8427id = str;
        this.name = str2;
    ...
    public static /* synthetic */ ConnectionsRoleTag copy$default(ConnectionsRoleTag connectionsRoleTag, String str, String str2, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            str = connectionsRoleTag.f8427id;
        }
        if ((i3 & 2) != 0) {
    ...
    public static final void write$Self(ConnectionsRoleTag self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13864z(serialDesc, 0, self.f8427id);
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.f8427id, connectionsRoleTag.f8427id) && C9677q.m14638b(this.name, connectionsRoleTag.name) && this.backgroundColor == connectionsRoleTag.backgroundColor && this.iconColor == connectionsRoleTag.iconColor;
    }
    ...
    public int hashCode() {
        return (((((this.f8427id.hashCode() * 31) + this.name.hashCode()) * 31) + this.backgroundColor) * 31) + this.iconColor;
    }
