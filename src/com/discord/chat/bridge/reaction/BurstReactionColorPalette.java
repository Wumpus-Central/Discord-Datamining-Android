...
public final class BurstReactionColorPalette implements BurstReactionView.BurstColorPalette {
    ...
    public /* synthetic */ BurstReactionColorPalette(int i, String str, String str2, String str3, float f, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i & 15)) {
            C3681n1.m33818b(i, 15, BurstReactionColorPalette$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(getBackgroundColor(), burstReactionColorPalette.getBackgroundColor()) && C9971q.m14638b(getAccentColor(), burstReactionColorPalette.getAccentColor()) && C9971q.m14638b(getHighlightColor(), burstReactionColorPalette.getHighlightColor()) && Float.compare(getOpacity(), burstReactionColorPalette.getOpacity()) == 0;
    }
