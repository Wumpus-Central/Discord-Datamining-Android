...
public final class MessageReactionEmoji implements ReactionView.Emoji {
    ...
    public /* synthetic */ MessageReactionEmoji(int i, String str, String str2, String str3, String str4, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        if (6 != (i & 6)) {
            C3681n1.m33818b(i, 6, MessageReactionEmoji$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
            this.name = null;
        } else {
    ...
    public static final void write$Self(MessageReactionEmoji self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 0, C3622a2.f5917a, self.getName());
        }
        ...
        if (z2) {
            output.mo13874p(serialDesc, 3, C3622a2.f5917a, self.getId());
        }
        if (output.mo13893A(serialDesc, 4) || self.getAnimated() != null) {
            z3 = true;
        }
        if (z3) {
            output.mo13874p(serialDesc, 4, C3652h.f5959a, self.getAnimated());
        }
    }
    ...
    public final MessageReactionEmoji copy(String str, String src, String displayName, String str2, Boolean bool) {
        C9971q.m14633g(src, "src");
        C9971q.m14633g(displayName, "displayName");
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(getName(), messageReactionEmoji.getName()) && C9971q.m14638b(getSrc(), messageReactionEmoji.getSrc()) && C9971q.m14638b(getDisplayName(), messageReactionEmoji.getDisplayName()) && C9971q.m14638b(getId(), messageReactionEmoji.getId()) && C9971q.m14638b(getAnimated(), messageReactionEmoji.getAnimated());
    }
