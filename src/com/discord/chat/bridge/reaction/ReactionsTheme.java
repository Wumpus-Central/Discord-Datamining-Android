...
public final class ReactionsTheme implements ReactionView.ReactionsTheme {
    ...
    public /* synthetic */ ReactionsTheme(int i, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 0) != 0) {
            C3681n1.m33818b(i, 0, ReactionsTheme$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
    ...
    public static final void write$Self(ReactionsTheme self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z) {
            output.mo13874p(serialDesc, 0, C3676m0.f5992a, self.getReactionBackgroundColor());
        }
        ...
        if (z2) {
            output.mo13874p(serialDesc, 1, C3676m0.f5992a, self.getReactionBorderColor());
        }
        ...
        if (z3) {
            output.mo13874p(serialDesc, 2, C3676m0.f5992a, self.getReactionTextColor());
        }
        ...
        if (z4) {
            output.mo13874p(serialDesc, 3, C3676m0.f5992a, self.getActiveReactionBackgroundColor());
        }
        ...
        if (z5) {
            output.mo13874p(serialDesc, 4, C3676m0.f5992a, self.getActiveReactionBorderColor());
        }
        if (output.mo13893A(serialDesc, 5) || self.getActiveReactionTextColor() != null) {
            z6 = true;
        }
        if (z6) {
            output.mo13874p(serialDesc, 5, C3676m0.f5992a, self.getActiveReactionTextColor());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(getReactionBackgroundColor(), reactionsTheme.getReactionBackgroundColor()) && C9971q.m14638b(getReactionBorderColor(), reactionsTheme.getReactionBorderColor()) && C9971q.m14638b(getReactionTextColor(), reactionsTheme.getReactionTextColor()) && C9971q.m14638b(getActiveReactionBackgroundColor(), reactionsTheme.getActiveReactionBackgroundColor()) && C9971q.m14638b(getActiveReactionBorderColor(), reactionsTheme.getActiveReactionBorderColor()) && C9971q.m14638b(getActiveReactionTextColor(), reactionsTheme.getActiveReactionTextColor());
    }
