...
public final class UploadProgressRow$$serializer implements AbstractC2522f0<UploadProgressRow> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{C2555m0.f6794a, ChangeType.Serializer.INSTANCE, Message$$serializer.INSTANCE, C2500a2.f6719a};
    }
