...
public final class BlockedGroupContent {
    ...
    public /* synthetic */ BlockedGroupContent(int i, @AbstractC14370f(with = MessageSerializer.class) MessageBase messageBase, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            C2560n1.m33818b(i, 1, BlockedGroupContent$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BlockedGroupContent) && C9677q.m14638b(this.message, ((BlockedGroupContent) obj).message);
    }
