...
public final class RowSerializer extends AbstractC9992d<Row> {
    private static final String CHANGE_TYPE_DELETE = "3";
    public static final RowSerializer INSTANCE = new RowSerializer();
    private static final SealedClassSerializer<Row> rowSealedClassSerializer = new SealedClassSerializer<>("Row", C9656f0.m14684b(Row.class), new KClass[]{C9656f0.m14684b(LoadingRow.class), C9656f0.m14684b(MessageRow.class), C9656f0.m14684b(SeparatorRow.class), C9656f0.m14684b(BlockedGroupRow.class), C9656f0.m14684b(UploadProgressRow.class), C9656f0.m14684b(EmbeddedActivityRow.class)}, new KSerializer[]{LoadingRow.Companion.serializer(), MessageRow.Companion.serializer(), SeparatorRow.Companion.serializer(), BlockedGroupRow.Companion.serializer(), UploadProgressRow.Companion.serializer(), EmbeddedActivityRow.Companion.serializer()});

    private RowSerializer() {
        super(C9656f0.m14684b(Row.class));
    }
    ...
    protected DeserializationStrategy<Row> selectDeserializer(JsonElement element) {
        ...
        if (C9677q.m14638b(str, CHANGE_TYPE_DELETE)) {
