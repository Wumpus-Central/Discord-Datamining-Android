...
public final class EmbeddedActivityRow extends Row {
    ...
    public /* synthetic */ EmbeddedActivityRow(int i, int i2, ChangeType changeType, String str, List list, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (127 != (i & 127)) {
            C3681n1.m33818b(i, 127, EmbeddedActivityRow$$serializer.INSTANCE.getDescriptor());
        }
        this.index = i2;
    ...
    public static final void write$Self(EmbeddedActivityRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13870t(serialDesc, 3, new C3643f(C3622a2.f5917a), self.avatarUrls);
    ...
    public boolean equals(Object obj) {
        ...
        return getIndex() == embeddedActivityRow.getIndex() && getChangeType() == embeddedActivityRow.getChangeType() && C9971q.m14638b(this.content, embeddedActivityRow.content) && C9971q.m14638b(this.avatarUrls, embeddedActivityRow.avatarUrls) && C9971q.m14638b(this.buttonText, embeddedActivityRow.buttonText) && C9971q.m14638b(this.embeddedActivityKey, embeddedActivityRow.embeddedActivityKey) && C9971q.m14638b(this.dismissButtonAccessibilityLabel, embeddedActivityRow.dismissButtonAccessibilityLabel);
    }
