...
public final class EmbeddedActivityRow extends Row {
    ...
    @Metadata(m15074d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/bridge/row/EmbeddedActivityRow$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/row/EmbeddedActivityRow;", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ EmbeddedActivityRow(int i, int i2, ChangeType changeType, String str, List list, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (127 != (i & 127)) {
            C2560n1.m33818b(i, 127, EmbeddedActivityRow$$serializer.INSTANCE.getDescriptor());
        }
        this.index = i2;
    ...
    public static /* synthetic */ EmbeddedActivityRow copy$default(EmbeddedActivityRow embeddedActivityRow, int i, ChangeType changeType, String str, List list, String str2, String str3, String str4, int i2, Object obj) {
        ...
        return embeddedActivityRow.copy(i, changeType, str, list, str2, str3, str4);
    }
    ...
    public static final void write$Self(EmbeddedActivityRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13864z(serialDesc, 2, self.content);
        output.mo13870t(serialDesc, 3, new C2521f(C2500a2.f6719a), self.avatarUrls);
        output.mo13864z(serialDesc, 4, self.buttonText);
        output.mo13864z(serialDesc, 5, self.embeddedActivityKey);
        output.mo13864z(serialDesc, 6, self.dismissButtonAccessibilityLabel);
    }
    ...
    public final EmbeddedActivityRow copy(int i, ChangeType changeType, String content, List<String> avatarUrls, String buttonText, String embeddedActivityKey, String dismissButtonAccessibilityLabel) {
        ...
        C9677q.m14633g(avatarUrls, "avatarUrls");
        C9677q.m14633g(buttonText, "buttonText");
        C9677q.m14633g(embeddedActivityKey, "embeddedActivityKey");
        C9677q.m14633g(dismissButtonAccessibilityLabel, "dismissButtonAccessibilityLabel");
    ...
    public boolean equals(Object obj) {
        ...
        return getIndex() == embeddedActivityRow.getIndex() && getChangeType() == embeddedActivityRow.getChangeType() && C9677q.m14638b(this.content, embeddedActivityRow.content) && C9677q.m14638b(this.avatarUrls, embeddedActivityRow.avatarUrls) && C9677q.m14638b(this.buttonText, embeddedActivityRow.buttonText) && C9677q.m14638b(this.embeddedActivityKey, embeddedActivityRow.embeddedActivityKey) && C9677q.m14638b(this.dismissButtonAccessibilityLabel, embeddedActivityRow.dismissButtonAccessibilityLabel);
    }
