...
public final class SeparatorRow extends Row {
    ...
    public /* synthetic */ SeparatorRow(int i, ChangeType changeType, int i2, String str, String str2, int i3, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (31 != (i & 31)) {
            C2560n1.m33818b(i, 31, SeparatorRow$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final void write$Self(SeparatorRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.mo13864z(serialDesc, 3, self.f8433id);
    ...
    public boolean equals(Object obj) {
        ...
        return getChangeType() == separatorRow.getChangeType() && getIndex() == separatorRow.getIndex() && C9677q.m14638b(this.text, separatorRow.text) && C9677q.m14638b(this.f8433id, separatorRow.f8433id) && this.color == separatorRow.color && C9677q.m14638b(this.scrollTo, separatorRow.scrollTo);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((getChangeType().hashCode() * 31) + getIndex()) * 31) + this.text.hashCode()) * 31) + this.f8433id.hashCode()) * 31) + this.color) * 31;
