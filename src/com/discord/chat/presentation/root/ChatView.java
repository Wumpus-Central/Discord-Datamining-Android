...
public final class ChatView extends ReactViewGroup {
    ...
    @Metadata(m15074d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u001a\u0010\u0006\u001a\u00020\u0007X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000b¨\u0006\f"}, m15073d2 = {"Lcom/discord/chat/presentation/root/ChatView$Companion;", "", "()V", "INDEX_CHAT_LIST", "", "INDEX_PORTAL_VIEW", "areChatAnimationsEnabled", "", "getAreChatAnimationsEnabled", "()Z", "setAreChatAnimationsEnabled", "(Z)V", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public static final void attachPortalViewToChatList$lambda$5(View portalView, ChatView this$0, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (portalView.getMeasuredHeight() > 0 && portalView.getMeasuredWidth() > 0) {
            ...
            if (!chatListView.isComputingLayout()) {
                ...
                Pair<Integer, Integer> a = z ? C10853x.m10921a(Integer.valueOf(portalView.getMeasuredWidth()), Integer.valueOf(portalView.getMeasuredHeight())) : null;
                if (portalView.getParent() instanceof ChatView) {
                    ViewParent parent = portalView.getParent();
                    C9677q.m14635e(parent, "null cannot be cast to non-null type android.view.ViewGroup");
                ...
                chatListView2.setPortalView(portalView, a);
            }
        }
    }
    ...
    public final void scrollTo(int i, Scroller.TargetAlignment targetScreenLocation, boolean z, boolean z2) {
        C9677q.m14633g(targetScreenLocation, "targetScreenLocation");
