...
public final class BlockedGroupChatListItem extends ChatListItem {
    ...
    public boolean equals(Object obj) {
        ...
        return C9971q.m14638b(this.text, blockedGroupChatListItem.text) && C9971q.m14638b(getId(), blockedGroupChatListItem.getId()) && this.textColor == blockedGroupChatListItem.textColor && this.backgroundColor == blockedGroupChatListItem.backgroundColor && this.borderColor == blockedGroupChatListItem.borderColor && this.isRevealed == blockedGroupChatListItem.isRevealed && C9971q.m14638b(this.content, blockedGroupChatListItem.content);
    }
