...
public final class AutomodSystemMessageItem extends ChatListItem {
    ...
    public /* synthetic */ AutomodSystemMessageItem(Message message, MessageContext messageContext, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        MessageContext messageContext2 = (i & 2) != 0 ? new MessageContext(false, false, null, null, null, null, null, false, false, false, false, false, 4095, null) : messageContext;
        if ((i & 4) != 0) {
            z2 = true;
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.message, automodSystemMessageItem.message) && C9677q.m14638b(this.messageContext, automodSystemMessageItem.messageContext) && this.allowChildGestures == automodSystemMessageItem.allowChildGestures;
    }
