...
public abstract class ChannelChatListAdapterUpdate {
    ...
    private ChannelChatListAdapterUpdate(int i, Function0<Unit> function0, Function0<Unit> function02) {
        this.updateId = i;
        this.preCommit = function0;
        this.postCommit = function02;
    }

    public /* synthetic */ ChannelChatListAdapterUpdate(int i, Function0 function0, Function0 function02, DefaultConstructorMarker defaultConstructorMarker) {
