...
public class BaseChatListAdapter extends C5215b<List<? extends ChatListItem>> implements ChatListAdapter {
    ...
    public BaseChatListAdapter(Function0<? extends ChatEventHandler> eventHandlerProvider, Function0<ComponentProvider> messageComponentProvider) {
        ...
        C9677q.m14634f(delegatesManager, "delegatesManager");
    ...
    public ChatListItem getChatListItem(int i) {
        Object X;
        X = C9618r.m14767X(this.chatListItems, i);
