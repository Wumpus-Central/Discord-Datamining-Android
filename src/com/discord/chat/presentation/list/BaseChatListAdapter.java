...
import com.hannesdorfmann.adapterdelegates4.C5877b;
...
public class BaseChatListAdapter extends C5877b<List<? extends ChatListItem>> implements ChatListAdapter {
    ...
    public BaseChatListAdapter(Function0<? extends ChatEventHandler> eventHandlerProvider, Function0<ComponentProvider> messageComponentProvider) {
        ...
        i = C9906j.m14820i();
        this.chatListItems = i;
        AdapterDelegatesManager<T> delegatesManager = this.delegatesManager;
        C9971q.m14634f(delegatesManager, "delegatesManager");
    ...
    public ChatListItem getChatListItem(int i) {
        Object X;
        X = C9914r.m14767X(this.chatListItems, i);
