...
public final class MessageBundleViewMoreDelegate extends MessageBundleBaseDelegate {
    private View.OnClickListener onTapViewMoreText = new View.OnClickListener() { // from class: com.discord.chat.presentation.list.delegate.messagebundling.b
    ...
    public final void setOnTapViewMoreText(View.OnClickListener onClickListener) {
        C9971q.m14633g(onClickListener, "<set-?>");
