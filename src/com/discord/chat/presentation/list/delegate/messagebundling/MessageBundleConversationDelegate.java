...
public final class MessageBundleConversationDelegate extends MessageBundleBaseDelegate {
    ...
    public MessageBundleConversationDelegate(Function3<? super View, ? super Integer, ? super Integer, Unit> onMeasured) {
        super(onMeasured);
        C9971q.m14633g(onMeasured, "onMeasured");
    }
    ...
    public static final void onBindViewHolder$lambda$0(MessageBundleConversationDelegate this$0, MessageBundleItem item, View view) {
        ...
        this$0.onTapReply.invoke(MessageId.m42115boximpl(((MessageBundleConversationItem) item).getMessageItem().getMessage().m41579getId3Eiw7ao()));
    }
    ...
    public void onBindViewHolder(View view, final MessageBundleItem item, List<? extends MessageBundleItem> items, int i) {
    ...
    public boolean isForViewType(List<? extends MessageBundleItem> items, int i) {
        C9971q.m14633g(items, "items");
        return items.get(i) instanceof MessageBundleConversationItem;
    }
}
