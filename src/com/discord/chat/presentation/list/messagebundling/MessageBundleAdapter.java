...
public final class MessageBundleAdapter extends C5877b<List<? extends MessageBundleItem>> implements ChatListAdapter {
    ...
    public MessageBundleAdapter() {
        ...
        k = C11289v.m10248k(C11098x.m10921a(0, new MessageBundleMessageDelegate(new MessageBundleAdapter$delegates$1(this))), C11098x.m10921a(1, new MessageBundleConversationDelegate(new MessageBundleAdapter$delegates$2(this))), C11098x.m10921a(2, new MessageBundleViewMoreDelegate(MessageBundleAdapter$delegates$3.INSTANCE)));
        this.delegates = k;
    ...
    public final void setItems(List<? extends MessageBundleItem> items, Function1<? super MessageId, Unit> onTruncateMessage, Float f, Function1<? super MessageId, Unit> onTapReply, View.OnClickListener onTapViewMoreText) {
        ...
        C9971q.m14633g(onTruncateMessage, "onTruncateMessage");
        C9971q.m14633g(onTapReply, "onTapReply");
        C9971q.m14633g(onTapViewMoreText, "onTapViewMoreText");
        this.items = items;
