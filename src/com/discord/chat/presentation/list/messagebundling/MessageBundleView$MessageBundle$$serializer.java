...
public final class MessageBundleView$MessageBundle$$serializer implements AbstractC2522f0<MessageBundleView.MessageBundle> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14606a.m13u(MessageFrameFeedHeaderView$MessageBundleHeader$$serializer.INSTANCE), new C2521f(messageRow$$serializer), C14606a.m13u(C2518e0.f6744a), new C2521f(messageRow$$serializer), C14606a.m13u(C2500a2.f6719a)};
    }
    ...
    public MessageBundleView.MessageBundle deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            MessageRow$$serializer messageRow$$serializer = MessageRow$$serializer.INSTANCE;
            obj = b.mo13847y(descriptor2, 1, new C2521f(messageRow$$serializer), null);
            obj2 = b.mo13852n(descriptor2, 2, C2518e0.f6744a, null);
            obj4 = b.mo13847y(descriptor2, 3, new C2521f(messageRow$$serializer), null);
            obj3 = b.mo13852n(descriptor2, 4, C2500a2.f6719a, null);
            i = 31;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj7 = b.mo13847y(descriptor2, 1, new C2521f(MessageRow$$serializer.INSTANCE), obj7);
                    i2 |= 2;
                } else if (o == 2) {
                    obj8 = b.mo13852n(descriptor2, 2, C2518e0.f6744a, obj8);
                    i2 |= 4;
                } else if (o == 3) {
                    obj9 = b.mo13847y(descriptor2, 3, new C2521f(MessageRow$$serializer.INSTANCE), obj9);
                    i2 |= 8;
                } else if (o == 4) {
                    obj10 = b.mo13852n(descriptor2, 4, C2500a2.f6719a, obj10);
                    i2 |= 16;
                } else {
                    throw new C14382n(o);
                }
