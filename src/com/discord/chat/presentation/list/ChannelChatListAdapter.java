...
public final class ChannelChatListAdapter extends BaseChatListAdapter {
    ...
    public ChannelChatListAdapter(Function0<Unit> doLayout, Function0<Unit> enableAnimations, Function0<Unit> disableAnimations, Function0<? extends ChatEventHandler> eventHandlerProvider, Function0<ComponentProvider> messageComponentProvider) {
        ...
        C9971q.m14633g(doLayout, "doLayout");
        C9971q.m14633g(enableAnimations, "enableAnimations");
        C9971q.m14633g(disableAnimations, "disableAnimations");
    ...
    */
    ...
    public final void processNextUpdate() {
        if (!ThreadUtilsKt.isOnMainThread()) {
            ...
            C9971q.m14634f(remove, "updateQueue.remove()");
    ...
    public final void processPortalViewUpdate(PortalViewUpdate portalViewUpdate) {
        ...
        i0 = C9914r.m14756i0(getChatListItems$chat_release());
        ...
        if (i == 1) {
            ...
            C9971q.m14636d(portalChatListItem);
            list = C9914r.m14749p0(chatListItems$chat_release, portalChatListItem);
        } else if (i == 2) {
            list = C9914r.m14775P(getChatListItems$chat_release(), 1);
        } else if (i == 3) {
            list = C9914r.m14788F0(getChatListItems$chat_release());
            k4 = C9906j.m14818k(getChatListItems$chat_release());
            PortalViewChatListItem portalChatListItem2 = portalViewUpdate.getPortalChatListItem();
            C9971q.m14636d(portalChatListItem2);
        ...
        if (i2 == 1) {
            k = C9906j.m14818k(getChatListItems$chat_release());
            notifyItemInserted(k);
        } else if (i2 == 2) {
            k2 = C9906j.m14818k(getChatListItems$chat_release());
            notifyItemRemoved(k2 + 1);
        } else if (i2 == 3) {
            k3 = C9906j.m14818k(getChatListItems$chat_release());
    ...
    public final void processUpdate(ChannelChatListAdapterUpdate channelChatListAdapterUpdate) {
        ...
        if (ThreadUtilsKt.isOnMainThread()) {
            ...
            d = C10139l.m14174d(C10135k0.m14186b(), null, null, new ChannelChatListAdapter$processUpdate$1$1(this, null), 3, null);
    ...
    public final void setItems(List<? extends ChatListItem> items, List<? extends ListOperation> list, Function0<Unit> preCommit, Function0<Unit> postCommit) {
        C9971q.m14633g(items, "items");
        C9971q.m14633g(preCommit, "preCommit");
        C9971q.m14633g(postCommit, "postCommit");
        int i = this.updateCount + 1;
        this.updateCount = i;
