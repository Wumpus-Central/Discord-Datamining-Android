...
@Metadata(m15074d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u001b\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\u0006J\u001c\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\f\u0010\r\u001a\b\u0012\u0004\u0012\u00020\n0\u000eJ\u0006\u0010\u000f\u001a\u00020\nR\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, m15073d2 = {"Lcom/discord/chat/presentation/loading/ChatLoadingView;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "binding", "Lcom/discord/chat/databinding/ChatLoadingViewBinding;", "showButton", "", "button", "Lcom/discord/chat/bridge/row/LoadMoreButton;", "onClick", "Lkotlin/Function0;", "showProgress", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
...
public final class ChatLoadingView extends ConstraintLayout {
    ...
    public final void showButton(LoadMoreButton button, final Function0<Unit> onClick) {
        ...
        C9677q.m14634f(progressBar, "binding.progressSpinner");
        progressBar.setVisibility(8);
        Button button2 = this.binding.button;
        C9677q.m14634f(button2, "binding.button");
        button2.setVisibility(0);
        this.binding.button.setText(button.getText());
        Button button3 = this.binding.button;
        C9677q.m14634f(button3, "binding.button");
        ...
        C9677q.m14634f(button5, "binding.button");
    ...
    public final void showProgress() {
        ...
        C9677q.m14634f(button, "binding.button");
    ...
    public ChatLoadingView(Context context, AttributeSet attributeSet) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(C3147R.dimen.message_horizontal_spacing);
