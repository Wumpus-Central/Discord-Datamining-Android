...
@Metadata(m15074d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u001b\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\u0006J\u0016\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\fR\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, m15073d2 = {"Lcom/discord/chat/presentation/deserializationerror/DeserializationErrorView;", "Landroid/widget/LinearLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "binding", "Lcom/discord/chat/databinding/DeserializationErrorViewBinding;", "configure", "", "json", "", "causeMessage", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
...
public final class DeserializationErrorView extends LinearLayout {
    ...
    public static final void configure$lambda$0(DeserializationErrorView this$0, String json, View view) {
        ...
        C9677q.m14633g(json, "$json");
        Object j = C1150a.m38128j(this$0.getContext(), ClipboardManager.class);
        C9677q.m14636d(j);
        ((ClipboardManager) j).setPrimaryClip(ClipData.newPlainText("Error JSON", json));
    ...
    public final void configure(final String json, String causeMessage) {
        ...
        C9677q.m14634f(button, "binding.copyButton");
    ...
    public DeserializationErrorView(Context context, AttributeSet attributeSet) {
        ...
        C9677q.m14634f(textView, "binding.json");
        ...
        C9677q.m14634f(textView2, "binding.exception");
        ...
        C9677q.m14634f(textView3, "binding.causeHeader");
        SetTextSizeSpKt.setTextSizeSp(textView3, 24.0f);
        TextView textView4 = inflate.causeHeader;
        C9677q.m14634f(textView4, "binding.causeHeader");
