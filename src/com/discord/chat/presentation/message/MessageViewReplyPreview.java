...
public final class MessageViewReplyPreview extends ConstraintLayout implements SpineParentMessage {
    ...
    public static final void configureExecutedCommand_LdU2QRA$lambda$7(ChatEventHandler eventHandler, String messageId, ExecutedCommand executedCommand, View view) {
        ...
        C9677q.m14633g(executedCommand, "$executedCommand");
    ...
    public final void m41761configureExecutedCommandLdU2QRA(final String messageId, final ExecutedCommand executedCommand, boolean z, boolean z2, boolean z3, final ChatEventHandler eventHandler) {
        ...
        C9677q.m14634f(simpleDraweeView2, "binding.replyAuthorAvatar");
        ...
        C9677q.m14634f(simpleDraweeView3, "binding.replyIcon");
        ...
        C9677q.m14634f(linearLayout2, "binding.replyLeadingViews");
        ...
        C9677q.m14634f(messageContentView3, "binding.replyText");
        ...
        C9677q.m14634f(messageContentView4, "binding.replyText");
    ...
    public final void configureReply(ReferencedMessage reply, boolean z, final Function0<Unit> onClick) {
        ...
        if (reply instanceof LoadedReferencedMessage) {
            ...
            if (message.getShouldShowRoleDot()) {
                ...
                C9677q.m14634f(roleDotView, "binding.replyRoleDot");
                ...
                C9677q.m14634f(roleDotView2, "binding.replyRoleDot");
            ...
            if (avatarUrl == null || message.getUsername() == null || message.m41576getAuthorIdwUX8bhU() == null) {
                ...
                C9677q.m14634f(simpleDraweeView2, "binding.replyIcon");
                simpleDraweeView2.setVisibility(0);
            } else {
                SimpleDraweeView simpleDraweeView3 = this.binding.replyAuthorAvatar;
                C9677q.m14634f(simpleDraweeView3, "binding.replyAuthorAvatar");
                simpleDraweeView3.setVisibility(0);
                SimpleDraweeView simpleDraweeView4 = this.binding.replyIcon;
                C9677q.m14634f(simpleDraweeView4, "binding.replyIcon");
            ...
            if (loadedReferencedMessage.getSystemContent() != null) {
                ...
                C9677q.m14634f(linearLayout3, "binding.replyLeadingViews");
            ...
            C9677q.m14634f(simpleDraweeView7, "binding.replyIcon");
            ...
            C9677q.m14634f(messageContentView5, "binding.replyText");
            ...
            C9677q.m14634f(linearLayout5, "binding.replyLeadingViews");
        ...
        if (this.binding.replyText.isLaidOut() && this.binding.replyText.getWidth() > 0) {
            ...
            C9677q.m14634f(linearLayout6, "binding.replyLeadingViews");
        ...
        C1559w0.m36990q0(this, new C1369a() { // from class: com.discord.chat.presentation.message.MessageViewReplyPreview$configureReply$4
            ...
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                info.m37388b(new AccessibilityNodeInfoCompat.C1377a(16, I18nUtilsKt.i18nFormat$default(context4, I18nMessage.MOBILE_SCROLL_TO_MESSAGE_ACTION_A11Y_LABEL, null, 2, null)));
            }
    ...
    public View getSpineOriginView() {
        ...
        C9677q.m14634f(simpleDraweeView, "binding.replyIcon");
    ...
    public MessageViewReplyPreview(Context context, AttributeSet attributeSet) {
        ...
        float dimension = getResources().getDimension(C3147R.dimen.message_start_guideline);
        float f = 2;
        float dimension2 = (dimension / f) - (getResources().getDimension(C3147R.dimen.spine_width) / f);
        float dimension3 = (dimension - getResources().getDimension(C3147R.dimen.message_reply_leading_views_margin_start)) - dimension2;
