...
public final class CallSystemMessageView extends ConstraintLayout {
    ...
    public final void setMessage(Message message) {
        ...
        if (C9677q.m14638b(message.isCallActive(), bool)) {
            i = this.greenIconColor;
        } else if (C9677q.m14638b(message.getMissed(), bool)) {
            i = this.redIconColor;
        } else {
        ...
        if (C9677q.m14638b(message.isCallActive(), bool)) {
            ...
            C9677q.m14636d(rawMilliseconds);
            C9851l.m14174d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new CallSystemMessageView$setMessage$1(this, rawMilliseconds.longValue(), message, null), 3, null);
        } else {
