...
public final class AutomodSystemMessageView extends ConstraintLayout implements VerticalSpacingItemDecoration.SpacingProviderView, SpineParentMessage {
    ...
    private final void configureAuthor(Message message, final AutoModerationContext autoModerationContext, final ChatEventHandler chatEventHandler) {
        ...
        C9677q.m14634f(configureAuthor$lambda$8, "configureAuthor$lambda$8");
    ...
    public static final void configureAuthor$lambda$8$lambda$7(ChatEventHandler eventHandler, AutoModerationContext automodContext, View view) {
        ...
        C9677q.m14633g(automodContext, "$automodContext");
        String str2 = ChannelId.m42096toStringimpl(automodContext.getMessage().m41587getChannelIdo4g7jtM());
        GuildId guildId = automodContext.getMessage().m41588getGuildIdqOKuAAo();
        if (guildId != null) {
            str = GuildId.m42109toStringimpl(guildId.m42111unboximpl());
        } else {
            str = null;
        }
    ...
    private final void configureCommunicationDisabled(boolean z) {
        ...
        C9677q.m14634f(configureCommunicationDisabled$lambda$9, "configureCommunicationDisabled$lambda$9");
        if (z) {
            i = 0;
        } else {
            i = 8;
    ...
    private final List<MessageAccessory> generateMessageAccessories(Message message, MessageContext messageContext) {
        ...
        String str = message2.m41589getId3Eiw7ao();
        long j = message2.m41587getChannelIdo4g7jtM();
        GuildId guildId = message2.m41588getGuildIdqOKuAAo();
        UserId userId = message2.m41590getUserIdwUX8bhU();
        ...
        Message message3 = new Message(messageType, str, (String) null, j, guildId, (MessageState) null, userId, 0L, (String) null, (Float) null, (String) null, username, Integer.valueOf(usernameColor), roleColor, shouldShowRoleDot, false, (Integer) null, avatarURL, (String) null, (List) null, (List) null, (Float) null, content, (List) null, (List) null, (Boolean) null, (Boolean) null, (List) null, (List) null, message.getRoleIcon(), (ConnectionsRoleTag) null, (ThreadEmbed) null, false, (Boolean) null, (Boolean) null, (ReferencedMessage) null, (ExecutedCommand) null, (List) null, (String) null, Boolean.valueOf(z), (String) null, (Boolean) null, (Integer) null, (String) null, (EphemeralIndication) null, (SurveyIndication) null, (InteractionStatus) null, (Boolean) null, (Boolean) null, (Boolean) null, (String) null, (String) null, (List) null, (Boolean) null, (Boolean) null, (Long) null, (Sticker) null, (String) null, (String) null, (Boolean) null, (ActivityInviteEmbed) null, false, (ForumPostActions) null, autoModerationContext, (List) null, (GiftEmbed) null, (Integer) null, (String) null, (List) null, -541227100, 2147483518, 31, (DefaultConstructorMarker) null);
        if (autoModerationContext.getNotification() != null) {
            this.accessories.add(new AutoModerationNotificationEmbedAccessory(message3.m41579getId3Eiw7ao(), message, autoModerationContext, null));
        } else {
            this.accessories.add(new FlaggedMessageEmbedAccessory(message3.m41579getId3Eiw7ao(), message3, messageContext, null));
            this.accessories.add(new FlaggedMessageActionBarAccessory(message3.m41579getId3Eiw7ao(), message, autoModerationContext, null));
        }
    ...
    public static /* synthetic */ void setMessage$default(AutomodSystemMessageView automodSystemMessageView, Message message, MessageContext messageContext, ChatEventHandler chatEventHandler, ComponentProvider componentProvider, boolean z, int i, Object obj) {
        ...
        automodSystemMessageView.setMessage(message, messageContext, chatEventHandler, componentProvider, z);
    }
    ...
    public final void setMessage(Message message, MessageContext messageContext, ChatEventHandler eventHandler, ComponentProvider componentProvider, boolean z) {
        ...
        if (autoModerationContext != null) {
            ...
            this.binding.accessoriesView.m41760setAccessoriesRC8ZMxU(message.m41579getId3Eiw7ao(), message.m41577getChannelIdo4g7jtM(), message.m41578getGuildIdqOKuAAo(), generateMessageAccessories(message, messageContext), eventHandler, componentProvider);
        }
    }
    ...
    public AutomodSystemMessageView(Context context, AttributeSet attributeSet) {
        ...
        _init_$lambda$4.setBackgroundColor(ColorUtilsKt.getThemeColor(context, C3147R.color.brand_500, C3147R.color.brand_600));
        _init_$lambda$4.setTextColor(ColorUtilsKt.getThemeColor(context, C3147R.color.white_100, C3147R.color.white_160));
        ...
        C9677q.m14634f(_init_$lambda$5, "_init_$lambda$5");
