...
public final class SystemMessageView extends ConstraintLayout implements SpineParentMessage {
    ...
    private final List<MessageAccessory> generateMessageAccessories(Message message, MessageContext messageContext) {
        ...
        if (content != null) {
            ...
            if (message.getTimestamp() != null) {
                ...
                i2 = getResources().getDimensionPixelSize(C3147R.dimen.message_accessories_vertical_spacing);
            }
            arrayList.add(new MessageContentAccessory(str, content, shouldAnimateEmoji, shouldShowRoleDot, shouldShowRoleOnName, i2, ThemeManagerKt.getTheme().getTextNormal(), ThemeManagerKt.getTheme().getTextNormal(), DiscordFont.PrimaryNormal, 16, true, i, null, null, null, 24576, null));
        }
        String timestamp = message.getTimestamp();
        if (timestamp != null) {
            this.accessories.add(new TimestampMessageAccessory(message.m41579getId3Eiw7ao(), timestamp, ThemeManagerKt.getTheme().getTextMuted(), DiscordFont.PrimaryMedium, null));
        }
        ...
        if (totalMonthsSubscribed == null || totalMonthsSubscribed.intValue() > 1) {
            ...
            C9677q.m14634f(context, "binding.root.context");
            message2 = message;
            arrayList2.add(new RoleSubscriptionPurchaseAccessory(str2, username, MessageKt.avatarUrl(message2, context), i, null));
        }
        Sticker sticker = message.getSticker();
        if (sticker != null) {
            this.accessories.add(new WelcomeStickerAccessory(message2, sticker));
        }
        if (message.getType() == MessageType.STAGE_RAISE_HAND && C9677q.m14638b(message.getShowInviteToSpeakButton(), Boolean.TRUE)) {
    ...
    private final Pair<ReactAsset, Integer> getIconAndColor(MessageType messageType) {
        switch (WhenMappings.$EnumSwitchMapping$0[messageType.ordinal()]) {
            ...
            case 5:
            case 6:
                return C10853x.m10921a(ReactAsset.ArrowForward, Integer.valueOf(this.greenIconColor));
            case 7:
            case 8:
                return C10853x.m10921a(ReactAsset.ArrowBack, Integer.valueOf(this.redIconColor));
            case 9:
            case 10:
                return C10853x.m10921a(ReactAsset.Pencil, Integer.valueOf(this.normalIconColor));
            case 11:
                return C10853x.m10921a(ReactAsset.Pin, Integer.valueOf(this.normalIconColor));
            case 12:
                return C10853x.m10921a(ReactAsset.Ticket, Integer.valueOf(this.normalIconColor));
            case 13:
            case 14:
            case 15:
            case 16:
                return C10853x.m10921a(ReactAsset.MemberListBadge, Integer.valueOf(this.pinkIconColor));
            case 17:
                return C10853x.m10921a(ReactAsset.AnnouncementThread, Integer.valueOf(this.normalIconColor));
            case 18:
                return C10853x.m10921a(ReactAsset.Close, Integer.valueOf(this.redIconColor));
            case 19:
                return C10853x.m10921a(ReactAsset.Check, Integer.valueOf(this.greenIconColor));
            case 20:
            case 21:
                return C10853x.m10921a(ReactAsset.Alert, Integer.valueOf(this.warnIconColor));
            case 22:
            case 23:
                return C10853x.m10921a(ReactAsset.Thread, Integer.valueOf(this.normalIconColor));
            case 24:
                return C10853x.m10921a(ReactAsset.StageChannel, Integer.valueOf(this.greenIconColor));
            case 25:
            case 26:
                return C10853x.m10921a(ReactAsset.StageChannel, Integer.valueOf(this.normalIconColor));
            case 27:
                return C10853x.m10921a(ReactAsset.MoveToSpeaker, Integer.valueOf(this.normalIconColor));
            case 28:
                return C10853x.m10921a(ReactAsset.RaisedHand, Integer.valueOf(this.normalIconColor));
            default:
    ...
    public static final boolean setMessage$lambda$0(Message message, ChatEventHandler eventHandler, View view) {
        ...
        if (onMessageLongPressed != null) {
            onMessageLongPressed.invoke(MessageId.m42115boximpl(message.m41579getId3Eiw7ao()), ChannelId.m42089boximpl(message.m41577getChannelIdo4g7jtM()), null, null);
        }
        return true;
    }
    ...
    public View getSpineOriginView() {
        ...
        C9677q.m14634f(simpleDraweeView, "binding.icon");
    ...
    public final void setMessage(final Message message, MessageContext context, final ChatEventHandler eventHandler) {
        ...
        int intValue = iconAndColor.m15066b().intValue();
        SimpleDraweeView simpleDraweeView = this.binding.icon;
        C9677q.m14634f(simpleDraweeView, "binding.icon");
        ReactAssetUtilsKt.setReactAsset(simpleDraweeView, iconAndColor.m15067a());
        SimpleDraweeView simpleDraweeView2 = this.binding.icon;
        C9677q.m14634f(simpleDraweeView2, "binding.icon");
        ...
        this.binding.accessoriesView.m41760setAccessoriesRC8ZMxU(message.m41579getId3Eiw7ao(), message.m41577getChannelIdo4g7jtM(), message.m41578getGuildIdqOKuAAo(), generateMessageAccessories, eventHandler, null);
        MessageAccessoriesView messageAccessoriesView = this.binding.accessoriesView;
        C9677q.m14634f(messageAccessoriesView, "binding.accessoriesView");
    ...
    public SystemMessageView(Context context, AttributeSet attributeSet) {
        ...
        this.greenIconColor = ColorUtilsKt.getColorCompat(this, C3147R.color.green_360);
        this.redIconColor = ColorUtilsKt.getColorCompat(this, C3147R.color.red_400);
        this.warnIconColor = ColorUtilsKt.getColorCompat(this, C3147R.color.yellow_300);
        this.pinkIconColor = ColorUtilsKt.getColorCompat(this, C3147R.color.guild_boosting_pink);
