...
public final class SystemMessageView extends ConstraintLayout implements SpineParentMessage {
    ...
    private final List<MessageAccessory> generateMessageAccessories(Message message, MessageContext messageContext) {
        ...
        if (content != null) {
            ...
            if (message.getTimestamp() != null) {
                ...
                i2 = getResources().getDimensionPixelSize(C4254R.dimen.message_accessories_vertical_spacing);
            }
        ...
        if (totalMonthsSubscribed == null || totalMonthsSubscribed.intValue() > 1) {
            ...
            C9971q.m14634f(context, "binding.root.context");
            message2 = message;
        ...
        if (message.getType() == MessageType.STAGE_RAISE_HAND && C9971q.m14638b(message.getShowInviteToSpeakButton(), Boolean.TRUE)) {
    ...
    private final Pair<ReactAsset, Integer> getIconAndColor(MessageType messageType) {
        switch (WhenMappings.$EnumSwitchMapping$0[messageType.ordinal()]) {
            ...
            case 5:
            case 6:
                return C11098x.m10921a(ReactAsset.ArrowForward, Integer.valueOf(this.greenIconColor));
            case 7:
            case 8:
                return C11098x.m10921a(ReactAsset.ArrowBack, Integer.valueOf(this.redIconColor));
            case 9:
            case 10:
                return C11098x.m10921a(ReactAsset.Pencil, Integer.valueOf(this.normalIconColor));
            case 11:
                return C11098x.m10921a(ReactAsset.Pin, Integer.valueOf(this.normalIconColor));
            case 12:
                return C11098x.m10921a(ReactAsset.Ticket, Integer.valueOf(this.normalIconColor));
            case 13:
            case 14:
            case 15:
            case 16:
                return C11098x.m10921a(ReactAsset.MemberListBadge, Integer.valueOf(this.pinkIconColor));
            case 17:
                return C11098x.m10921a(ReactAsset.AnnouncementThread, Integer.valueOf(this.normalIconColor));
            case 18:
                return C11098x.m10921a(ReactAsset.Close, Integer.valueOf(this.redIconColor));
            case 19:
                return C11098x.m10921a(ReactAsset.Check, Integer.valueOf(this.greenIconColor));
            case 20:
            case 21:
                return C11098x.m10921a(ReactAsset.Alert, Integer.valueOf(this.warnIconColor));
            case 22:
            case 23:
                return C11098x.m10921a(ReactAsset.Thread, Integer.valueOf(this.normalIconColor));
            case 24:
                return C11098x.m10921a(ReactAsset.StageChannel, Integer.valueOf(this.greenIconColor));
            case 25:
            case 26:
                return C11098x.m10921a(ReactAsset.StageChannel, Integer.valueOf(this.normalIconColor));
            case 27:
                return C11098x.m10921a(ReactAsset.MoveToSpeaker, Integer.valueOf(this.normalIconColor));
            case 28:
                return C11098x.m10921a(ReactAsset.RaisedHand, Integer.valueOf(this.normalIconColor));
            default:
    ...
    public final void setMessage(final Message message, MessageContext context, final ChatEventHandler eventHandler) {
        ...
        C9971q.m14634f(messageAccessoriesView, "binding.accessoriesView");
    ...
    public SystemMessageView(Context context, AttributeSet attributeSet) {
        ...
        this.warnIconColor = ColorUtilsKt.getColorCompat(this, C4254R.color.yellow_300);
        this.pinkIconColor = ColorUtilsKt.getColorCompat(this, C4254R.color.guild_boosting_pink);
