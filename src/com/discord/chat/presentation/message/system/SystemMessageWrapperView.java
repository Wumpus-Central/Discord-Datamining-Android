...
public final class SystemMessageWrapperView extends FrameLayout {
    ...
    public final void setMessage(Message message, MessageContext messageContext, ChatEventHandler eventHandler) {
        ...
        C9971q.m14634f(messageView, "binding.messageView");
        ...
        addView(view, -1, -2);
        this.drawHighlight = this.highlightDrawer.getShouldRenderHighlight().invoke(new MessageItem(message, null, messageContext, false, false, null, null, false, ItemTouchHelper.AbstractC3083c.DEFAULT_SWIPE_ANIMATION_DURATION, null)).booleanValue();
    }
