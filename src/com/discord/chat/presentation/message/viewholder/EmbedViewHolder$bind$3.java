...
public /* synthetic */ class EmbedViewHolder$bind$3 extends C9674n implements Function2<MessageId, LinkContentNode, Unit> {
    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId, LinkContentNode linkContentNode) {
        m41880invokentcYbpo(messageId.m42123unboximpl(), linkContentNode);
        return Unit.f25780a;
    }

    /* renamed from: invoke-ntcYbpo  reason: not valid java name */
    public final void m41880invokentcYbpo(String p0, LinkContentNode p1) {
