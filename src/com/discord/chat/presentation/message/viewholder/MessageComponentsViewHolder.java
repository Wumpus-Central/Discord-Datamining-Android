...
public final class MessageComponentsViewHolder extends MessagePartViewHolder implements ComponentActionListener {
    ...
    private String messageId = MessageId.m42116constructorimpl("0");
    ...
    public MessageComponentsViewHolder(MessageComponentsView messageComponentsView, ChatEventHandler eventHandler) {
        ...
        C9677q.m14633g(messageComponentsView, "messageComponentsView");
    ...
    public final void bind(MessageComponentsAccessory componentsComponentsAccessory, ComponentProvider componentProvider) {
        C9677q.m14633g(componentsComponentsAccessory, "componentsComponentsAccessory");
        this.messageId = componentsComponentsAccessory.mo41765getMessageId3Eiw7ao();
    ...
    public final String m41886getMessageId3Eiw7ao() {
    ...
    public void mo41868onTapButtonActionComponenty43Yjpg(String str, long j, List<Integer> indices) {
        int[] C0;
        C9677q.m14633g(indices, "indices");
        ChatEventHandler chatEventHandler = this.eventHandler;
        String str2 = this.messageId;
        long j2 = this.messageFlags;
        C0 = C9618r.m14791C0(indices);
        chatEventHandler.mo41714onTapButtonActionComponentNkFJqEg(str2, j2, str, j, C0);
    }

    @Override // com.discord.chat.presentation.message.view.botuikit.ComponentActionListener
    public void onTapSelectActionComponent(SelectComponent selectComponent) {
        C9677q.m14633g(selectComponent, "selectComponent");
        this.eventHandler.mo41726onTapSelectActionComponentu7_MRrM(this.messageId, this.messageFlags, selectComponent);
    }

    @Override // com.discord.chat.presentation.message.view.botuikit.ComponentActionListener
    public void openLink(String url) {
        C9677q.m14633g(url, "url");
        this.eventHandler.mo41704onLinkClickedu7_MRrM(this.messageId, url, "");
    }
    ...
    public final void m41887setMessageId1xi1bu0(String str) {
