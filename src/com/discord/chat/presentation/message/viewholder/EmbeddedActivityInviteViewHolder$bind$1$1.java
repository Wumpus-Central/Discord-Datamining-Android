...
public /* synthetic */ class EmbeddedActivityInviteViewHolder$bind$1$1 extends C9968n implements Function2<MessageId, LinkContentNode, Unit> {
    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId, LinkContentNode linkContentNode) {
        m41881invokentcYbpo(messageId.m42123unboximpl(), linkContentNode);
        return Unit.f22042a;
    }

    /* renamed from: invoke-ntcYbpo  reason: not valid java name */
    public final void m41881invokentcYbpo(String p0, LinkContentNode p1) {
