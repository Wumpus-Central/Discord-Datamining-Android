...
@Metadata(m15074d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004JE\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0018\u0010\t\u001a\u0014\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f\u0012\u0004\u0012\u00020\u00060\n2\u0018\u0010\r\u001a\u0014\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f\u0012\u0004\u0012\u00020\u00060\nø\u0001\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u000e"}, m15073d2 = {"Lcom/discord/chat/presentation/message/viewholder/AutoModerationNotificationEmbedViewHolder;", "Lcom/discord/chat/presentation/message/viewholder/MessagePartViewHolder;", "notificationEmbedView", "Lcom/discord/chat/presentation/message/view/AutoModerationNotificationEmbedView;", "(Lcom/discord/chat/presentation/message/view/AutoModerationNotificationEmbedView;)V", "bind", "", "notificationEmbedAccessory", "Lcom/discord/chat/presentation/message/messagepart/AutoModerationNotificationEmbedAccessory;", "onTapAutoModerationActions", "Lkotlin/Function2;", "Lcom/discord/primitives/MessageId;", "Lcom/discord/primitives/ChannelId;", "onTapAutoModerationFeedback", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
...
public final class AutoModerationNotificationEmbedViewHolder extends MessagePartViewHolder {
    ...
    public AutoModerationNotificationEmbedViewHolder(AutoModerationNotificationEmbedView notificationEmbedView) {
        ...
        C9677q.m14633g(notificationEmbedView, "notificationEmbedView");
    ...
    public static final void bind$lambda$0(Function2 onTapAutoModerationActions, String messageId, long j, View view) {
        C9677q.m14633g(onTapAutoModerationActions, "$onTapAutoModerationActions");
    ...
    public static final void bind$lambda$1(Function2 onTapAutoModerationFeedback, String messageId, long j, View view) {
        C9677q.m14633g(onTapAutoModerationFeedback, "$onTapAutoModerationFeedback");
        C9677q.m14633g(messageId, "$messageId");
    ...
    public final void bind(AutoModerationNotificationEmbedAccessory notificationEmbedAccessory, final Function2<? super MessageId, ? super ChannelId, Unit> onTapAutoModerationActions, final Function2<? super MessageId, ? super ChannelId, Unit> onTapAutoModerationFeedback) {
        C9677q.m14633g(notificationEmbedAccessory, "notificationEmbedAccessory");
        C9677q.m14633g(onTapAutoModerationActions, "onTapAutoModerationActions");
        C9677q.m14633g(onTapAutoModerationFeedback, "onTapAutoModerationFeedback");
        final long j = notificationEmbedAccessory.getMessage().m41577getChannelIdo4g7jtM();
        final String str = notificationEmbedAccessory.mo41765getMessageId3Eiw7ao();
        this.notificationEmbedView.configure(notificationEmbedAccessory.getModerationContext(), new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.c
            ...
            public final void onClick(View view) {
                AutoModerationNotificationEmbedViewHolder.bind$lambda$0(Function2.this, str, j, view);
            }
        }, new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.d
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AutoModerationNotificationEmbedViewHolder.bind$lambda$1(Function2.this, str, j, view);
            }
        });
    }
}
