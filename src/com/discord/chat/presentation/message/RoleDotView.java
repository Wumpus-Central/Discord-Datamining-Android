...
public final class RoleDotView extends FrameLayout {
    ...
    public final void configure(int i, int i2) {
        ...
        C9677q.m14634f(frameLayout, "binding.roleDotViewBackground");
        ...
        int colorCompat = ColorUtilsKt.getColorCompat(this, ThemeManagerKt.getTheme().getColorRes(C3147R.color.black, C3147R.color.white));
