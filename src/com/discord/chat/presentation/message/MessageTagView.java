...
public final class MessageTagView extends FrameLayout {
    ...
    public MessageTagView(Context context, AttributeSet attrs) {
        ...
        C9677q.m14634f(textView, "binding.tag");
        ...
        C9677q.m14634f(simpleDraweeView, "binding.verifiedBotIcon");
        ...
        C9677q.m14634f(simpleDraweeView2, "binding.verifiedBotIcon");
    ...
    public final void configureTagView(String str, Boolean bool, Integer num, String str2, final ChatEventHandler eventHandler) {
        ...
        if (str != null) {
            ...
            textView.setTextColor(ColorUtilsKt.getColorCompat(context, C3147R.color.white));
            ConstraintLayout constraintLayout = this.binding.layout;
            C9677q.m14634f(constraintLayout, "binding.layout");
            ...
            C9677q.m14634f(simpleDraweeView, "binding.verifiedBotIcon");
            if (C9677q.m14638b(bool, Boolean.TRUE)) {
                i = 0;
            }
            simpleDraweeView.setVisibility(i);
            if (num != null) {
                ConstraintLayout constraintLayout2 = this.binding.layout;
                C9677q.m14634f(constraintLayout2, "binding.layout");
            ...
            this.binding.layout.setBackground(C5956a.m25364b(getContext(), C3147R.C3148drawable.drawable_message_author_tag_bg));
        } else if (str2 != null) {
            this.binding.tag.setText(str2);
            TextView textView2 = this.binding.tag;
            Context context2 = getContext();
            C9677q.m14634f(context2, "context");
            textView2.setTextColor(ColorUtilsKt.getColorCompat(context2, C3147R.color.brand_560));
            ConstraintLayout constraintLayout3 = this.binding.layout;
            C9677q.m14634f(constraintLayout3, "binding.layout");
            Context context3 = getContext();
            C9677q.m14634f(context3, "context");
            ViewBackgroundUtilsKt.setBackgroundRectangle$default(constraintLayout3, ColorUtilsKt.getThemeColor(context3, C3147R.color.brand_200, C3147R.color.brand_260), SizeUtilsKt.getDpToPx(8), null, 0, 12, null);
            ConstraintLayout constraintLayout4 = this.binding.layout;
            C9677q.m14634f(constraintLayout4, "binding.layout");
