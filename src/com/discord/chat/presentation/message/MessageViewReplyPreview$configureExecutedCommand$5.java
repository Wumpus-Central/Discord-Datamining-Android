...
final class MessageViewReplyPreview$configureExecutedCommand$5 extends AbstractC9679s implements Function1<LinkContentNode, LinkStyle> {
    ...
    public final LinkStyle invoke(LinkContentNode it) {
        ...
        if (!C9677q.m14638b(it.getTarget(), "usernameOnClick")) {
