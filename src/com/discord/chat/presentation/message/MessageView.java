...
public final class MessageView extends ConstraintLayout implements VerticalSpacingItemDecoration.SpacingProviderView, SpineParentMessage, SwipeReplyInitiator {
    ...
    @Metadata(m15074d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m15073d2 = {"Lcom/discord/chat/presentation/message/MessageView$ChainPart;", "", "(Ljava/lang/String;I)V", "ONLY", "START", "MIDDLE", "END", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    public static final boolean configureAuthor$lambda$28$lambda$27(Message message, ChatEventHandler eventHandler, View view) {
        ...
        eventHandler.mo41705onLongPressAvatarx5gers8(message.m41579getId3Eiw7ao(), message.m41576getAuthorIdwUX8bhU().m42162unboximpl());
        return true;
    }
    ...
    */
        ...
        if (function4 != null) {
            return new View.OnLongClickListener() { // from class: com.discord.chat.presentation.message.q
                ...
                public final boolean onLongClick(View view) {
                    ...
                    generateMessageAccessories$getLongClickListener$lambda$7$lambda$6 = MessageView.m32291xca729c2f(Function4.this, message, i, mediaType, view);
    ...
    public Integer spacingPxOverride() {
        int i;
        int i2 = WhenMappings.$EnumSwitchMapping$1[((ChainPart) this.onChainPart.invoke()).ordinal()];
        if (i2 == 1 || i2 == 2) {
