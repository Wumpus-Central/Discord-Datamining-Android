...
final class SpineDrawer$lineDrawable$2 extends AbstractC9679s implements Function0<PaintDrawable> {
    ...
    public final PaintDrawable invoke() {
        ...
        paintDrawable.setIntrinsicWidth(this.this$0.getContext().getResources().getDimensionPixelSize(C3147R.dimen.spine_width));
