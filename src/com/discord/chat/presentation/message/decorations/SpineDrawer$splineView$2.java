...
final class SpineDrawer$splineView$2 extends AbstractC9973s implements Function0<ChannelSpineView> {
    ...
    public final ChannelSpineView invoke() {
        ...
        channelSpineView.setHorizontalPadding(channelSpineView.getContext().getResources().getDimensionPixelSize(C4254R.dimen.thread_spine_end_padding));
