...
public final class ConnectionsRoleTagView extends FrameLayout {
    ...
    public ConnectionsRoleTagView(Context context, AttributeSet attrs) {
        ...
        C9677q.m14634f(textView, "binding.roleName");
        SetTextSizeSpKt.setTextSizeSp(textView, 12.0f);
        TextView textView2 = inflate.roleName;
        C9677q.m14634f(textView2, "binding.roleName");
    ...
    public static final void configureConnectionsRoleTag_uESh2Cg$lambda$0(ChatEventHandler eventHandler, UserId userId, GuildId guildId, ChannelId channelId, ConnectionsRoleTag connectionsRoleTag, View view) {
        ...
        C9677q.m14633g(connectionsRoleTag, "$connectionsRoleTag");
        eventHandler.onTapConnectionsRoleTag(UserId.m42160toStringimpl(userId.m42162unboximpl()), GuildId.m42109toStringimpl(guildId.m42111unboximpl()), ChannelId.m42096toStringimpl(channelId.m42098unboximpl()), connectionsRoleTag.getId());
    }

    /* renamed from: configureConnectionsRoleTag-uESh2Cg  reason: not valid java name */
    public final void m41745configureConnectionsRoleTaguESh2Cg(final UserId userId, final GuildId guildId, final ChannelId channelId, final ConnectionsRoleTag connectionsRoleTag, final ChatEventHandler eventHandler) {
        C9677q.m14633g(connectionsRoleTag, "connectionsRoleTag");
        C9677q.m14633g(eventHandler, "eventHandler");
        ImageView imageView = this.binding.verifiedCheckIconBackground;
        C9677q.m14634f(imageView, "binding.verifiedCheckIconBackground");
        ...
        C9677q.m14634f(imageView2, "binding.verifiedCheckIcon");
        ...
        if (userId != null && guildId != null && channelId != null) {
            ...
            C9677q.m14634f(cardView, "binding.connectionsRoleTagContainer");
