...
public final class GiftView extends CardView {
    ...
    public static final class Companion {
        ...
        public interface State {
            ...
            public static final class Resolved implements State {
                ...
                public int hashCode() {
                    return C4081a.m32873a(getAccessoryId());
                }
    ...
    public static final void bind$lambda$14(Function1 onTapEmbed, GiftEmbed gift, View view) {
        C9971q.m14633g(onTapEmbed, "$onTapEmbed");
        C9971q.m14633g(gift, "$gift");
    ...
    public static final void bind$lambda$17$lambda$16(Function1 onTapAccept, GiftEmbed gift, View view) {
        C9971q.m14633g(onTapAccept, "$onTapAccept");
        C9971q.m14633g(gift, "$gift");
    ...
    private final void initTextStyling() {
        ...
        C9971q.m14634f(initTextStyling$lambda$1, "initTextStyling$lambda$1");
        ...
        C9971q.m14634f(initTextStyling$lambda$2, "initTextStyling$lambda$2");
        ...
        C9971q.m14634f(initTextStyling$lambda$3, "initTextStyling$lambda$3");
        ...
        C9971q.m14634f(initTextStyling$lambda$4, "initTextStyling$lambda$4");
    ...
    public final void bind(GiftMessageAccessory accessory, final Function1<? super String, Unit> onTapEmbed, final Function1<? super String, Unit> onTapAccept) {
        ...
        C9971q.m14634f(constraintLayout, "binding.content");
        int i = 0;
        ...
        if (gift instanceof GiftEmbed.Resolving) {
            ...
            C9971q.m14634f(group, "binding.gradients");
            ...
            simpleDraweeView.getHierarchy().m31788D(C4830a.m31729a(SizeUtilsKt.getDpToPx(gift.getThumbnailCornerRadius())));
            ...
            C9971q.m14634f(bind$lambda$12, "bind$lambda$12");
            CharSequence text = bind$lambda$12.getText();
            C9971q.m14634f(text, "text");
            w = C12718u.m5729w(text);
            ...
            C9971q.m14634f(bind$lambda$13, "bind$lambda$13");
            CharSequence text2 = bind$lambda$13.getText();
            C9971q.m14634f(text2, "text");
            w2 = C12718u.m5729w(text2);
            ...
            if (resolved instanceof GiftEmbed.Resolved.Invalid) {
                ...
                C9971q.m14634f(textView2, "binding.body");
                textView2.setVisibility(8);
                DCDButton dCDButton = this.binding.acceptButton;
                C9971q.m14634f(dCDButton, "binding.acceptButton");
                ...
                C9971q.m14634f(constraintLayout3, "binding.content");
                ...
                C9971q.m14634f(bind$lambda$15, "bind$lambda$15");
                CharSequence text3 = bind$lambda$15.getText();
                C9971q.m14634f(text3, "text");
                w3 = C12718u.m5729w(text3);
                if (!(!w3)) {
                    i = 8;
                }
