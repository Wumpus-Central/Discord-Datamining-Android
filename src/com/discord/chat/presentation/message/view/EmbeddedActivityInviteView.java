...
public final class EmbeddedActivityInviteView extends ConstraintLayout {
    ...
    public final void setAvatarUris(List<String> avatarUris) {
        ...
        t = C9907k.m14809t(avatarUris, 10);
        ...
        C9971q.m14634f(textView, "binding.noParticipantsText");
        if (!(!z)) {
            i2 = 8;
        }
    ...
    public final void setHeaderText(CharSequence charSequence) {
        ...
        C9971q.m14634f(textView, "binding.itemHeader");
        if (!z2) {
            i = 8;
        }
    ...
    public final void setLaunchButton(String str, Integer num, boolean z) {
        ...
        C9971q.m14634f(setLaunchButton$lambda$9, "setLaunchButton$lambda$9");
        int i = 0;
    ...
    public final void setOnLaunchButtonClickListener(View.OnClickListener onLaunchButtonClickListener) {
        C9971q.m14633g(onLaunchButtonClickListener, "onLaunchButtonClickListener");
    ...
    public final void setSplash(String str, int i) {
        ...
        C9971q.m14634f(simpleDraweeView, "binding.itemHero");
        int i2 = 0;
        if (str != null) {
            z = true;
        } else {
        ...
        C9971q.m14634f(simpleDraweeView2, "binding.itemHero");
    ...
    public final void setTitleText(CharSequence charSequence) {
        ...
        C9971q.m14634f(textView, "binding.itemTitle");
        if (!z2) {
            i = 8;
        }
        textView.setVisibility(i);
