...
public final class MediaView$setMediaData$1 extends AbstractC9973s implements Function1<PipelineDraweeControllerBuilder, Unit> {
    ...
    public final void invoke2(PipelineDraweeControllerBuilder setOptionalImageUrl) {
        ...
        C9971q.m14633g(setOptionalImageUrl, "$this$setOptionalImageUrl");
        mediaViewBinding = this.this$0.binding;
        SimpleDraweeView simpleDraweeView = mediaViewBinding.inlineMediaImagePreview;
        C9971q.m14634f(simpleDraweeView, "binding.inlineMediaImagePreview");
