...
public final class MessageContentView extends SimpleDraweeSpanTextView implements VerticalSpacingItemDecoration.SpacingProviderView {
    ...
    @Metadata(m15074d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m15073d2 = {"Lcom/discord/chat/presentation/message/view/MessageContentView$Companion;", "", "()V", "LINE_SPACING_ADD", "", "LINE_SPACING_MULT", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    ...
    private final void m41863truncatepPZZVto(String str, Truncation truncation, int i, DraweeSpanStringBuilder draweeSpanStringBuilder, Function1<? super MessageId, Unit> function1) {
        ...
        if (lineCount > numberOfLines || b) {
            ...
            if (seeMoreLabelColor != null) {
                i3 = seeMoreLabelColor.intValue();
            } else {
                i3 = ThemeManagerKt.getTheme().getTextLink();
            }
            draweeSpanStringBuilder.setSpan(new ClickableSpan(touchPriority, Integer.valueOf(i3), null, new MessageContentView$truncate$1(function1, str), 4, null), lineVisibleEnd, draweeSpanStringBuilder.length(), 33);
