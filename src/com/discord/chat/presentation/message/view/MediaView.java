...
public class MediaView extends FrameLayout {
    ...
    private final void registerForPortal() {
        ...
        if (mediaSource != null && (portal = mediaSource.getPortal()) != null) {
            ...
            if (mediaPlayer != null && this.mediaPlayerView != null) {
                ...
                MediaPlayerView mediaPlayerView = this.mediaPlayerView;
                C9971q.m14636d(mediaPlayerView);
    ...
    protected void onAttachedToWindow() {
        ...
        C10139l.m14174d(CoroutineViewUtilsKt.attachedScope(this, true), null, null, new MediaView$onAttachedToWindow$1(this, null), 3, null);
    }
    ...
    */
    ...
    public MediaView(Context context, AttributeSet attributeSet, int i) {
        ...
        C9971q.m14634f(simpleDraweeView, "binding.inlineMediaGifIndicator");
        ...
        gradientDrawable.setStroke(simpleDraweeView2.getResources().getDimensionPixelSize(C4254R.dimen.message_media_view_stroke), ColorUtilsKt.getColorCompat(context, C4254R.color.chat_media_view_stroke));
