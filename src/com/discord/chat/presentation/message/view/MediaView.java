...
public class MediaView extends FrameLayout {
    ...
    private final Pair<MediaPlayer, MediaPlayerView> prepareMediaPlayer(MediaSource mediaSource, boolean z) {
        ...
        MediaPlayer.preparePlayer$default(mediaPlayer, mediaSource, true, z, 0L, mediaPlayerView, null, 40, null);
    ...
    private final void registerForPortal() {
        ...
        if (mediaSource != null && (portal = mediaSource.getPortal()) != null) {
            ...
            if (mediaPlayer != null && this.mediaPlayerView != null) {
                C9677q.m14636d(mediaPlayer);
                MediaPlayerView mediaPlayerView = this.mediaPlayerView;
                C9677q.m14636d(mediaPlayerView);
            ...
            MediaPlayer a = pair.m15067a();
            PortalViewContextManager.INSTANCE.addPortal(doubleValue, pair.m15066b().getView(), new MediaView$registerForPortal$1(this), new MediaView$registerForPortal$2(this, doubleValue, a), new MediaView$registerForPortal$3(this, a, doubleValue, mediaSource), new MediaView$registerForPortal$4(mediaSource, this));
        }
    }
    ...
    public static /* synthetic */ void setMediaData$default(MediaView mediaView, MediaSource mediaSource, boolean z, boolean z2, boolean z3, MediaPlayer.Event event, boolean z4, Integer num, PortalViewContextManager.Event event2, boolean z5, boolean z6, boolean z7, int i, Object obj) {
        if (obj == null) {
            mediaView.setMediaData((i & 1) != 0 ? mediaView.mediaSource : mediaSource, (i & 2) != 0 ? mediaView.mediaViewDetached : z, (i & 4) != 0 ? mediaView.mediaViewScrolling : z2, (i & 8) != 0 ? mediaView.mediaViewFocused : z3, (i & 16) != 0 ? mediaView.mediaPlaybackState : event, (i & 32) != 0 ? mediaView.mediaVolumeOn : z4, (i & 64) != 0 ? mediaView.mediaOrientation : num, (i & 128) != 0 ? mediaView.mediaPortalEvent : event2, (i & Spliterator.NONNULL) != 0 ? mediaView.mediaCanPlayInline : z5, (i & 512) != 0 ? mediaView.mediaPlayThirdParty : z6, (i & Spliterator.IMMUTABLE) != 0 ? mediaView.mediaHidePlayButton : z7);
            return;
        }
    ...
    protected void onAttachedToWindow() {
        ...
        C9851l.m14174d(CoroutineViewUtilsKt.attachedScope(this, true), null, null, new MediaView$onAttachedToWindow$1(this, null), 3, null);
    }
    ...
    public void onWindowFocusChanged(boolean z) {
        ...
        setMediaData$default(this, null, false, false, z, null, false, null, null, false, false, false, 2039, null);
    }
    ...
    */
    ...
    public MediaView(Context context, AttributeSet attributeSet, int i) {
        ...
        C9677q.m14634f(simpleDraweeView, "binding.inlineMediaGifIndicator");
        ...
        simpleDraweeView2.getHierarchy().m31768z(new ColorDrawable(ThemeManagerKt.getTheme().getBackgroundSecondaryAlt()));
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(0);
        gradientDrawable.setStroke(simpleDraweeView2.getResources().getDimensionPixelSize(C3147R.dimen.message_media_view_stroke), ColorUtilsKt.getColorCompat(context, C3147R.color.chat_media_view_stroke));
        simpleDraweeView2.getHierarchy().m31769y(gradientDrawable);
    }
}
