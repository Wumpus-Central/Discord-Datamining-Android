...
public final class SpoilerView extends FrameLayout {
    ...
    public static final void _init_$lambda$2(final SpoilerView this$0, View it) {
        ...
        C9971q.m14635e(viewParent, "null cannot be cast to non-null type android.view.ViewGroup");
        C3226h hVar = new C3226h(2);
        hVar.setDuration(150L);
        hVar.addListener(new C3282z() { // from class: com.discord.chat.presentation.message.view.SpoilerView$1$transition$1$1
            @Override // androidx.transition.C3282z, androidx.transition.Transition.AbstractC3182g
            public void onTransitionEnd(Transition transition) {
                Function0 function0;
                C9971q.m14633g(transition, "transition");
                function0 = SpoilerView.this.onReveal;
                function0.invoke();
            }
        });
        C3184a0.m34980a((ViewGroup) viewParent, hVar);
    ...
    public SpoilerView(Context context, AttributeSet attributeSet) {
        ...
        textView.setBackgroundColor(ColorUtilsKt.getColorCompat(context, C4254R.color.primary_800));
