...
public final class ActivityLauncherView extends ConstraintLayout {
    ...
    public final void setAvatarUris(List<String> avatarUris) {
        ...
        C9971q.m14634f(linearLayout, "binding.participantsInfoContainer");
        if (!(!z)) {
            i2 = 8;
        }
    ...
    public final void setLaunchButton(String str, Integer num) {
        ...
        C9971q.m14634f(setLaunchButton$lambda$6, "setLaunchButton$lambda$6");
        int i = 0;
    ...
    public ActivityLauncherView(Context context, AttributeSet attributeSet, int i) {
        ...
        C9971q.m14634f(lambda$4$lambda$0, "lambda$4$lambda$0");
        ...
        C9971q.m14634f(lambda$4$lambda$1, "lambda$4$lambda$1");
        ...
        C9971q.m14634f(lambda$4$lambda$2, "lambda$4$lambda$2");
        ...
        C9971q.m14634f(lambda$4$lambda$3, "lambda$4$lambda$3");
        SetTextSizeSpKt.setTextSizeSp(lambda$4$lambda$3, 12.0f);
        DiscordFontUtilsKt.setDiscordFont(lambda$4$lambda$3, discordFont);
        ViewBackgroundUtilsKt.setBackgroundRectangle$default(this, ColorUtilsKt.getColorCompat(context, ThemeManagerKt.getTheme().getColorRes(C4254R.color.primary_130, C4254R.color.primary_630)), SizeUtilsKt.getDpToPx(8), null, 0, 12, null);
    }
}
