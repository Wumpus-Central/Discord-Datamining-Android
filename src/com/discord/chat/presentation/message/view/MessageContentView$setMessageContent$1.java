...
public final class MessageContentView$setMessageContent$1 extends AbstractC9679s implements Function1<LinkContentNode, LinkStyle> {
    ...
    public final LinkStyle invoke(LinkContentNode linkContentNode) {
        C9677q.m14633g(linkContentNode, "<anonymous parameter 0>");
