...
public final class MediaView$registerForPortal$3 extends AbstractC9679s implements Function1<View, Unit> {
    ...
    public final void invoke2(View it) {
        ...
        if (!C9677q.m14639a(portal, mediaSource != null ? mediaSource.getPortal() : null) || this.$mediaPlayer.hasEnded() || !this.this$0.isAttachedToWindow()) {
