...
public final class SelectComponentView extends ConstraintLayout implements ComponentView<SelectComponent> {
    ...
    private final void setImage(SimpleDraweeSpanTextView simpleDraweeSpanTextView, String str, Integer num, boolean z) {
        ...
        AbstractC3766a c = C10061c.m13583g().m31933D(z2.m30892a()).build();
        C9677q.m14634f(c, "newDraweeControllerBuild…d())\n            .build()");
        GenericDraweeHierarchyBuilder w = GenericDraweeHierarchyBuilder.m31735u(getContext().getResources()).m31733w(ScalingUtils.ScaleType.f9823e);
        C9677q.m14634f(w, "newInstance(context.reso…ils.ScaleType.FIT_CENTER)");
        if (num != null) {
    ...
    public KClass<SelectComponent> getComponentType() {
        return C9656f0.m14684b(SelectComponent.class);
    }
    ...
    public SelectComponentView(Context context, AttributeSet attributeSet, int i) {
        ...
        Lazy a;
        C9677q.m14633g(context, "context");
        a = C10839n.m10945a(SelectComponentView$postProcessor$2.INSTANCE);
    ...
    public void configure(final SelectComponent component, ComponentProvider componentProvider, final ComponentActionListener componentActionListener) {
        ...
        C9677q.m14634f(materialTextView, "binding.selectComponentSelectionText");
        ...
        C9677q.m14634f(simpleDraweeView, "binding.selectComponentChevron");
        ...
        if (!(!selectedItems.isEmpty())) {
            ...
            C9677q.m14634f(materialTextView2, "binding.selectComponentSelectionText");
            materialTextView2.setVisibility(0);
            FlexboxLayout flexboxLayout = bind.selectComponentSelectionsRoot;
            C9677q.m14634f(flexboxLayout, "binding.selectComponentSelectionsRoot");
            ...
            C9677q.m14634f(materialTextView3, "binding.selectComponentSelectionText");
            materialTextView3.setVisibility(0);
            FlexboxLayout flexboxLayout2 = bind.selectComponentSelectionsRoot;
            C9677q.m14634f(flexboxLayout2, "binding.selectComponentSelectionsRoot");
            flexboxLayout2.setVisibility(8);
            bind.selectComponentSelectionText.setTextColor(ThemeManagerKt.getTheme().getTextNormal());
            W = C9618r.m14768W(selectedItems);
            ...
            if (selectItem != null) {
                ...
                if (selectItem.getEmoji() != null) {
                    ...
                    C9677q.m14634f(simpleDraweeSpanTextView, "binding.selectComponentSelectionIcon");
                    ...
                    if (selectItem instanceof SearchableSelectItem) {
                        ...
                        if (searchableSelectItem.getIconSrc() != null) {
                            ...
                            C9677q.m14634f(simpleDraweeSpanTextView2, "binding.selectComponentSelectionIcon");
                            ...
                            C9677q.m14634f(simpleDraweeSpanTextView3, "binding.selectComponentSelectionIcon");
                    ...
                    C9677q.m14634f(simpleDraweeSpanTextView4, "binding.selectComponentSelectionIcon");
                    simpleDraweeSpanTextView4.setVisibility(8);
                }
            }
        } else {
            FlexboxLayout flexboxLayout3 = bind.selectComponentSelectionsRoot;
            C9677q.m14634f(flexboxLayout3, "binding.selectComponentSelectionsRoot");
            MaterialTextView materialTextView4 = bind.selectComponentSelectionText;
            C9677q.m14634f(materialTextView4, "binding.selectComponentSelectionText");
        ...
        C9677q.m14634f(progressBar, "binding.selectComponentLoading");
        progressBar.setVisibility(z3 ^ true ? 4 : 0);
        SimpleDraweeView simpleDraweeView2 = bind.selectComponentChevron;
        C9677q.m14634f(simpleDraweeView2, "binding.selectComponentChevron");
        if (!z3) {
            i = 0;
        }
        ...
        C9677q.m14634f(root3, "binding.root");
