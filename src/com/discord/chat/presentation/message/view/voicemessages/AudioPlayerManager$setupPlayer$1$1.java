...
public final class AudioPlayerManager$setupPlayer$1$1 extends AbstractC9679s implements Function1<MediaPlayer.Event, Unit> {
    ...
    public final void invoke2(MediaPlayer.Event event) {
        ...
        if (C9677q.m14638b(event, MediaPlayer.Event.PlaybackEnded.INSTANCE)) {
        ...
        if (!C9677q.m14638b(event2, event)) {
