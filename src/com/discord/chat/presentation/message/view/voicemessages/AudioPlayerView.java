...
public final class AudioPlayerView extends FrameLayout {
    ...
    public final void configureAudioWave(AudioPlayerViewState audioPlayerViewState) {
        ...
        if (audioPlayerViewState.isPlaying$chat_release(this.wasPlayingBeforeBeingPaused)) {
            i = getContext().getColor(C4254R.color.brand_430);
    ...
    */
    ...
    public final void configurePlayButton(final AudioPlayerViewState audioPlayerViewState) {
        ...
        LinearLayout linearLayout = this.binding.playerContainer;
        C9971q.m14634f(linearLayout, "binding.playerContainer");
    ...
    private final void configurePlayerState(AudioPlayerViewState audioPlayerViewState, boolean z) {
        boolean z2;
        boolean b = C9971q.m14638b(audioPlayerViewState.getMediaState$chat_release(), MediaPlayer.Event.PlaybackEnded.INSTANCE);
        boolean z3 = false;
        ...
        if (C9971q.m14638b(audioPlayerViewState.getMediaState$chat_release(), MediaPlayer.Event.StartedPlaying.INSTANCE) && !z4 && audioPlayerViewState.getAttached()) {
            z3 = true;
        }
        setKeepScreenOn(z3);
    }
    ...
    public final void maybeLogPlaybackEnded() {
        ...
        if (currentPosition != null) {
            ...
            if (listener != null) {
                ...
                listener.voiceMessagePlaybackEnded((float) C12905a.m5143E(C12907c.m5089t(longValue, EnumC12908d.MILLISECONDS), EnumC12908d.SECONDS));
            }
        }
    }
    ...
    public final void maybeLogPlaybackStarted() {
        ...
        if (currentPosition != null) {
            ...
            if (listener != null) {
                C12905a.C0415a aVar = C12905a.f28981l;
                listener.voiceMessagePlaybackStarted((float) C12905a.m5143E(C12907c.m5089t(longValue, EnumC12908d.MILLISECONDS), EnumC12908d.SECONDS));
            }
        }
    }
    ...
    private final void reset(boolean z) {
        ...
        d = C10139l.m14174d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$reset$1(this, null), 3, null);
        this.resetJob = d;
        C10139l.m14174d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$reset$2(this, null), 3, null);
    }

    private final synchronized void setState(AudioPlayerViewState audioPlayerViewState, boolean z) {
        if (!z) {
            if (C9971q.m14638b(this.state, audioPlayerViewState)) {
                return;
            }
        }
        boolean z2 = !C9971q.m14638b(audioPlayerViewState.getSourceUrl(), this.state.getSourceUrl());
    ...
    private final int toSeconds(long j) {
        C12905a.C0415a aVar = C12905a.f28981l;
        return (int) Math.ceil(C12905a.m5143E(C12907c.m5089t(j, EnumC12908d.MILLISECONDS), EnumC12908d.SECONDS));
    }
    ...
    public final void toggleDurationEmitter(boolean z) {
        ...
        if (z) {
            d = C10139l.m14174d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$toggleDurationEmitter$2(this, null), 3, null);
            this.durationJob = d;
        }
    }
    ...
    public final void setDurationMs(long j) {
        ...
        C9971q.m14634f(setDurationMs$lambda$3, "setDurationMs$lambda$3");
    ...
    public final void setSampleData(byte[] sampleData) {
        C9971q.m14633g(sampleData, "sampleData");
    ...
    public final void m41873setSourceUrlntcYbpo(String messageId, String str) {
        ...
        if (!C9971q.m14638b(str, this.state.getSourceUrl())) {
            if (str == null) {
                reset(false);
            } else {
    ...
    public final void setUploadProgress(Integer num, Function0<Unit> onCancelUpload, Float f) {
        ...
        if (z && !this.uploadFinished) {
            ...
            C9971q.m14634f(linearLayout, "binding.uploadOverlayBackground");
        ...
        C9971q.m14634f(attachmentUploadOverlayView2, "binding.uploadOverlay");
    ...
    public AudioPlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        a = C11084n.m10945a(new AudioPlayerView$bounceAnimator$2(context));
        this.bounceAnimator$delegate = a;
        a2 = C11084n.m10945a(new AudioPlayerView$animatorManager$2(context, this));
        ...
        if (ThemeManagerKt.getTheme() instanceof LightTheme) {
            i2 = C4254R.C4255drawable.drawable_audio_play_button_gradient_light;
        } else {
            i2 = C4254R.C4255drawable.drawable_audio_play_button_gradient_dark;
        }
        inflate.buttonContainer.setBackgroundResource(i2);
        inflate.wipe.setBackgroundResource(i2);
        C2733w0.m36990q0(this, new C2549a() { // from class: com.discord.chat.presentation.message.view.voicemessages.AudioPlayerView.3
