...
public final class AudioPlayerManager {
    ...
    @Metadata(m15074d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\f\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\b\u0018\u00002\u00020\u0001B\u0018\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005ø\u0001\u0000¢\u0006\u0002\u0010\u0006J\u0019\u0010\u000b\u001a\u00020\u0003HÆ\u0003ø\u0001\u0002ø\u0001\u0001ø\u0001\u0000¢\u0006\u0004\b\f\u0010\bJ\t\u0010\r\u001a\u00020\u0005HÆ\u0003J*\u0010\u000e\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001ø\u0001\u0001ø\u0001\u0000¢\u0006\u0004\b\u000f\u0010\u0010J\u0013\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0014\u001a\u00020\u0015HÖ\u0001J\t\u0010\u0016\u001a\u00020\u0005HÖ\u0001R\u001c\u0010\u0002\u001a\u00020\u0003ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\b\u0082\u0002\u000f\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u0017"}, m15073d2 = {"Lcom/discord/chat/presentation/message/view/voicemessages/AudioPlayerManager$AudioSource;", "", "messageId", "Lcom/discord/primitives/MessageId;", "url", "", "(Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/internal/DefaultConstructorMarker;)V", "getMessageId-3Eiw7ao", "()Ljava/lang/String;", "Ljava/lang/String;", "getUrl", "component1", "component1-3Eiw7ao", "component2", "copy", "copy-ntcYbpo", "(Ljava/lang/String;Ljava/lang/String;)Lcom/discord/chat/presentation/message/view/voicemessages/AudioPlayerManager$AudioSource;", "equals", "", "other", "hashCode", "", "toString", "chat_release"}, m15072k = 1, m15071mv = {1, 8, 0}, m15069xi = 48)
    /* loaded from: classes4.dex */
    public static final class AudioSource {
        ...
        public static /* synthetic */ AudioSource m41869copyntcYbpo$default(AudioSource audioSource, String str, String str2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return audioSource.m41871copyntcYbpo(str, str2);
        }

        /* renamed from: component1-3Eiw7ao  reason: not valid java name */
        public final String m41870component13Eiw7ao() {
        ...
        public int hashCode() {
            return (MessageId.m42120hashCodeimpl(this.messageId) * 31) + this.url.hashCode();
        }
    ...
    private final boolean requestAudioFocus() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            i = audioManager3.requestAudioFocus(audioFocusRequest);
        } else {
            AudioManager audioManager4 = audioManager;
            if (audioManager4 == null) {
                C9971q.m14615y("audioManager");
            ...
            i = audioManager2.requestAudioFocus(focusListener, 3, 4);
        }
        if (i == 1) {
            return true;
        }
    ...
    public final void setupPlayer(Context context, AudioSource source, long j, Function1<? super MediaPlayer.Event, Unit> onStateChanged) {
        ...
        if (!C9971q.m14638b(source, getCurrentPlayerSource())) {
            ...
            if (requestAudioFocus()) {
                ...
                MediaPlayer.preparePlayer$default(mediaPlayer2, mediaSource, true, false, j2, null, null, 52, null);
            }
        }
