...
@AbstractC9636e(m14702c = "com.discord.chat.presentation.message.view.FileAttachmentView$setContent$2$1", m14701f = "FileAttachmentView.kt", m14700l = {94}, m14699m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class FileAttachmentView$setContent$2$1 extends AbstractC9643k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FileAttachmentView$setContent$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f25780a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super DownloadState> flowCollector = new FlowCollector() { // from class: com.discord.chat.presentation.message.view.FileAttachmentView$setContent$2$1.1
                ...
                /* JADX INFO: Access modifiers changed from: package-private */
                @Metadata(m15074d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, m15073d2 = {"Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, m15072k = 3, m15071mv = {1, 8, 0})
                @AbstractC9636e(m14702c = "com.discord.chat.presentation.message.view.FileAttachmentView$setContent$2$1$1$1", m14701f = "FileAttachmentView.kt", m14700l = {}, m14699m = "invokeSuspend")
                /* renamed from: com.discord.chat.presentation.message.view.FileAttachmentView$setContent$2$1$1$1 */
                /* loaded from: classes4.dex */
                public static final class C32401 extends AbstractC9643k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    final /* synthetic */ DownloadState $downloadState;
                    int label;
                    final /* synthetic */ FileAttachmentView this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C32401(DownloadState downloadState, FileAttachmentView fileAttachmentView, Continuation<? super C32401> continuation) {
                        super(2, continuation);
                    ...
                    @Override // kotlin.coroutines.jvm.internal.AbstractC9632a
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C32401(this.$downloadState, this.this$0, continuation);
                    }

                    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                        return ((C32401) create(coroutineScope, continuation)).invokeSuspend(Unit.f25780a);
                    }
                ...
                public final Object emit(DownloadState downloadState, Continuation<? super Unit> continuation) {
                    Object d2;
                    Object g = C9840j.m14192g(C9946y0.m13945c(), new C32401(downloadState, FileAttachmentView.this, null), continuation);
                    d2 = C12962d.m4646d();
                    return g == d2 ? g : Unit.f25780a;
                }
            };
            this.label = 1;
