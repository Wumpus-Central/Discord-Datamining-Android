...
public final class FileAttachmentView extends ConstraintLayout {
    ...
    public static final void setContent$lambda$0(Function2 onClick, String url, String attachmentName, View view) {
        ...
        C9971q.m14633g(attachmentName, "$attachmentName");
    ...
    public static final void setContent$lambda$1(FileAttachmentView this$0, String url, String attachmentName, String attachmentDescription, View view) {
        ...
        C9971q.m14633g(url, "$url");
        C9971q.m14633g(attachmentName, "$attachmentName");
        C9971q.m14633g(attachmentDescription, "$attachmentDescription");
        C10139l.m14174d(CoroutineViewUtilsKt.getAttachedScope(this$0), C10230y0.m13946b(), null, new FileAttachmentView$setContent$2$1(this$0, url, attachmentName, attachmentDescription, null), 2, null);
    }
    ...
    public final void setContent(final String attachmentName, final String attachmentDescription, final String url, final Function2<? super String, ? super String, Unit> onClick, boolean z, SpoilerConfig spoilerConfig, Integer num, Function0<Unit> onCancelUpload, UploadContext uploadContext, Float f) {
        ...
        C9971q.m14633g(uploadContext, "uploadContext");
        boolean z2 = true;
        boolean z3 = num != null;
        ...
        C9971q.m14634f(textView, "binding.fileAttachmentName");
        ViewUtilsKt.setOptionalText(textView, attachmentName);
        TextView textView2 = this.binding.fileAttachmentDescription;
        C9971q.m14634f(textView2, "binding.fileAttachmentDescription");
        ...
        C9971q.m14634f(simpleDraweeView2, "binding.fileAttachmentDownload");
        ...
        if (z) {
            ...
            C9971q.m14634f(spoilerView, "binding.spoiler");
        ...
        C9971q.m14634f(uploadOverlay, "uploadOverlay");
    ...
    public FileAttachmentView(Context context, AttributeSet attributeSet) {
        ...
        C9971q.m14634f(simpleDraweeView3, "binding.fileAttachmentIcon");
        ...
        C9971q.m14634f(simpleDraweeView4, "binding.fileAttachmentIcon");
        ...
        C9971q.m14634f(textView3, "binding.fileAttachmentDescription");
        ...
        ViewBackgroundUtilsKt.setBackgroundRectangle(root2, ThemeManagerKt.getTheme().getBackgroundSecondary(), SizeUtilsKt.getDpToPx(8), Integer.valueOf(ColorUtilsKt.getColorCompat(this, C4254R.color.primary_dark_700_alpha_60)), SizeUtilsKt.getDpToPx(0.25f));
    }
}
