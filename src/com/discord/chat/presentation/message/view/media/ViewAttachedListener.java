...
public final class ViewAttachedListener implements View.OnAttachStateChangeListener {
    ...
    /* loaded from: classes4.dex */
    static final class C32641 extends AbstractC9679s implements Function1<Boolean, Unit> {
    ...
    public ViewAttachedListener(View view, Function1<? super Boolean, Unit> viewAttached, Function1<? super Boolean, Unit> viewScrolling) {
        ...
        C9677q.m14633g(viewAttached, "viewAttached");
        C9677q.m14633g(viewScrolling, "viewScrolling");
        this.view = view;
        this.viewAttached = viewAttached;
        this.viewScrolling = viewScrolling;
        this.isAttachedDelay = view.getResources().getInteger(C3147R.integer.material_motion_duration_short_1);
        ...
        a = C10839n.m10945a(new ViewAttachedListener$scrollStateListener$2(this));
    ...
    public /* synthetic */ ViewAttachedListener(View view, Function1 function1, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(view, function1, (i & 4) != 0 ? C32641.INSTANCE : function12);
    }
}
