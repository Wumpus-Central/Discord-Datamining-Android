...
public final class ViewScrollStateListener implements ViewTreeObserver.OnScrollChangedListener {
    ...
    private Runnable isScrollingStoppedRunnable = new Runnable() { // from class: com.discord.chat.presentation.message.view.media.b
    ...
    public ViewScrollStateListener(View view, Function1<? super Boolean, Unit> viewScrolling) {
        ...
        this.isScrollingDuration = view.getResources().getInteger(C3147R.integer.material_motion_duration_long_2);
        queueScrollStop();
    }
