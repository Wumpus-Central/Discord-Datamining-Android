...
public /* synthetic */ class MessageAccessoriesAdapter$onBindViewHolder$6 extends C9968n implements Function2<MessageId, LinkContentNode, Unit> {
    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId, LinkContentNode linkContentNode) {
        m41757invokentcYbpo(messageId.m42123unboximpl(), linkContentNode);
        return Unit.f22042a;
    }

    /* renamed from: invoke-ntcYbpo  reason: not valid java name */
    public final void m41757invokentcYbpo(String p0, LinkContentNode p1) {
