...
final class MessageViewReplyPreview$configureExecutedCommand$2 extends AbstractC9973s implements Function1<LinkContentNode, Unit> {
    ...
    public final void invoke2(LinkContentNode it) {
        ...
        this.$eventHandler.mo41703onLinkClickedntcYbpo(this.$messageId, it);
    }
}
