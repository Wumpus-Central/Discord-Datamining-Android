...
public /* synthetic */ class MessageAccessoriesAdapter$onBindViewHolder$41 extends C9968n implements Function2<MessageId, ChannelId, Unit> {
    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId, ChannelId channelId) {
        m41754invokepfaIj0E(messageId.m42123unboximpl(), channelId.m42098unboximpl());
        return Unit.f22042a;
    }

    /* renamed from: invoke-pfaIj0E  reason: not valid java name */
    public final void m41754invokepfaIj0E(String p0, long j) {
        C9971q.m14633g(p0, "p0");
        ((ChatEventHandler) this.receiver).mo41712onTapAutoModerationFeedbackpfaIj0E(p0, j);
    }
}
