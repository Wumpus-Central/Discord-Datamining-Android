...
public final class MessageViewAccessibilityDelegate extends C1369a {
    ...
    public MessageViewAccessibilityDelegate(Message message, MessageContentView contentView, View.OnClickListener onClickListener, View.OnLongClickListener onLongClickListener) {
        ...
        C9677q.m14633g(contentView, "contentView");
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
        ...
        C9677q.m14634f(spans, "augmentedText.getSpans(0… SpoilerSpan::class.java)");
        for (SpoilerSpan spoilerSpan : (SpoilerSpan[]) spans) {
            if (!spoilerSpan.isRevealed()) {
                ...
                C9677q.m14634f(context, "host.context");
        ...
        C9677q.m14634f(spans2, "augmentedText.getSpans(0…sibilitySpan::class.java)");
        ...
        C9677q.m14634f(context2, "host.context");
        ...
        info.m37398S(AccessibilityNodeInfoCompat.C1377a.f4196i);
        info.m37359p0(15);
    }
