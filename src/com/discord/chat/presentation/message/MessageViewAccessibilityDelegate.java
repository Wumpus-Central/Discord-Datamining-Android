...
public final class MessageViewAccessibilityDelegate extends C2549a {
    ...
    public MessageViewAccessibilityDelegate(Message message, MessageContentView contentView, View.OnClickListener onClickListener, View.OnLongClickListener onLongClickListener) {
        ...
        C9971q.m14633g(contentView, "contentView");
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
        ...
        C9971q.m14634f(spans, "augmentedText.getSpans(0… SpoilerSpan::class.java)");
        for (SpoilerSpan spoilerSpan : (SpoilerSpan[]) spans) {
            if (!spoilerSpan.isRevealed()) {
                ...
                C9971q.m14634f(context, "host.context");
        ...
        C9971q.m14634f(spans2, "augmentedText.getSpans(0…sibilitySpan::class.java)");
        ...
        C9971q.m14634f(context2, "host.context");
        ...
        if (!arrayList.isEmpty()) {
            ...
            spannableStringBuilder.replace(0, 0, (CharSequence) (e0 + ", "));
        }
        info.m37418D0(spannableStringBuilder);
        info.m37398S(AccessibilityNodeInfoCompat.C2556a.f3561i);
        info.m37359p0(15);
    }
    ...
    public boolean performAccessibilityAction(View host, int i, Bundle bundle) {
        ...
        } else if (i == 32 && (onLongClickListener = this.onLongClick) != null) {
