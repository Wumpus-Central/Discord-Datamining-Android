...
public final class MessageFrameFeedHeaderView$MessageBundleHeader$$serializer implements AbstractC2522f0<MessageFrameFeedHeaderView.MessageBundleHeader> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{C14606a.m13u(a2Var), C14606a.m13u(a2Var), C14606a.m13u(new C2521f(a2Var)), C14606a.m13u(a2Var)};
    }
    ...
    public MessageFrameFeedHeaderView.MessageBundleHeader deserialize(Decoder decoder) {
        ...
        if (b.mo13850p()) {
            ...
            obj = b.mo13852n(descriptor2, 2, new C2521f(a2Var), null);
            ...
            while (z) {
                ...
                if (o == -1) {
                    ...
                    obj = b.mo13852n(descriptor2, 2, new C2521f(C2500a2.f6719a), obj);
                    i2 |= 4;
                } else if (o == 3) {
