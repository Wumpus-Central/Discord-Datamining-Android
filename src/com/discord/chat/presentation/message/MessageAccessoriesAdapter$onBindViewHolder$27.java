...
public final class MessageAccessoriesAdapter$onBindViewHolder$27 extends AbstractC9973s implements Function1<Sticker, Unit> {
    ...
    public final void invoke2(Sticker it) {
        ...
        chatEventHandler.mo41708onStickerClickedAyv7vGE(((StickerMessageAccessory) this.$part).getSticker(), this.$part.mo41765getMessageId3Eiw7ao());
    }
}
