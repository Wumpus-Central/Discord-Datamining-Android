...
public final class VideoAttachmentMessageAccessory extends MessageAccessory implements PortalUiModel {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), videoAttachmentMessageAccessory.mo41765getMessageId3Eiw7ao()) && getIndex() == videoAttachmentMessageAccessory.getIndex() && C9971q.m14638b(this.attachment, videoAttachmentMessageAccessory.attachment) && this.constrainedWidth == videoAttachmentMessageAccessory.constrainedWidth && this.radiusPx == videoAttachmentMessageAccessory.radiusPx && C9971q.m14638b(this.spoilerAttributes, videoAttachmentMessageAccessory.spoilerAttributes) && C9971q.m14638b(this.onLongClick, videoAttachmentMessageAccessory.onLongClick) && this.useNewAltTextButton == videoAttachmentMessageAccessory.useNewAltTextButton && this.hideMediaPlayButton == videoAttachmentMessageAccessory.hideMediaPlayButton && C9971q.m14638b(this.attachmentsOpacity, videoAttachmentMessageAccessory.attachmentsOpacity);
    }
