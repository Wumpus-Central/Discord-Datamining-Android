...
public final class MessageContentAccessory extends MessageAccessory {
    ...
    public final MessageContentAccessory m41824copyUwkiYZs(String messageId, StructurableText messageContent, boolean z, boolean z2, boolean z3, int i, int i2, int i3, DiscordFont messageFont, int i4, boolean z4, int i5, String str, Truncation truncation, DiscordTheme theme) {
        ...
        C9971q.m14633g(messageContent, "messageContent");
        C9971q.m14633g(messageFont, "messageFont");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), messageContentAccessory.mo41765getMessageId3Eiw7ao()) && C9971q.m14638b(this.messageContent, messageContentAccessory.messageContent) && this.shouldAnimateEmoji == messageContentAccessory.shouldAnimateEmoji && this.shouldShowRoleDot == messageContentAccessory.shouldShowRoleDot && this.shouldShowRoleOnName == messageContentAccessory.shouldShowRoleOnName && this.bottomSpacingPx == messageContentAccessory.bottomSpacingPx && this.linkColor == messageContentAccessory.linkColor && this.messageTextColor == messageContentAccessory.messageTextColor && this.messageFont == messageContentAccessory.messageFont && this.textSizeSp == messageContentAccessory.textSizeSp && this.boldLinkText == messageContentAccessory.boldLinkText && this.constrainedWidth == messageContentAccessory.constrainedWidth && C9971q.m14638b(this.editedLabel, messageContentAccessory.editedLabel) && C9971q.m14638b(this.truncation, messageContentAccessory.truncation) && C9971q.m14638b(this.theme, messageContentAccessory.theme);
    }
