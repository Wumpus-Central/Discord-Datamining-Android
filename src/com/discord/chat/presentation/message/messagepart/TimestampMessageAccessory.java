...
public final class TimestampMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ TimestampMessageAccessory m41843copyAFFcxXc$default(TimestampMessageAccessory timestampMessageAccessory, String str, String str2, int i, DiscordFont discordFont, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = timestampMessageAccessory.mo41765getMessageId3Eiw7ao();
        }
        if ((i2 & 2) != 0) {
        ...
        return timestampMessageAccessory.m41845copyAFFcxXc(str, str2, i, discordFont);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m41844component13Eiw7ao() {
    ...
    public final TimestampMessageAccessory m41845copyAFFcxXc(String messageId, String timestamp, int i, DiscordFont discordFont) {
        C9971q.m14633g(messageId, "messageId");
        C9971q.m14633g(timestamp, "timestamp");
        C9971q.m14633g(discordFont, "discordFont");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), timestampMessageAccessory.mo41765getMessageId3Eiw7ao()) && C9971q.m14638b(this.timestamp, timestampMessageAccessory.timestamp) && this.textColor == timestampMessageAccessory.textColor && this.discordFont == timestampMessageAccessory.discordFont;
    }
    ...
    public int hashCode() {
        return (((((MessageId.m42120hashCodeimpl(mo41765getMessageId3Eiw7ao()) * 31) + this.timestamp.hashCode()) * 31) + this.textColor) * 31) + this.discordFont.hashCode();
    }
    ...
    public String toString() {
        ...
        return "TimestampMessageAccessory(messageId=" + str + ", timestamp=" + str2 + ", textColor=" + i + ", discordFont=" + discordFont + ")";
    }
}
