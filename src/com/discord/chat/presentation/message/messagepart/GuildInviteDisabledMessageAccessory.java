...
public final class GuildInviteDisabledMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ GuildInviteDisabledMessageAccessory m41804copyu7_MRrM$default(GuildInviteDisabledMessageAccessory guildInviteDisabledMessageAccessory, String str, int i, GuildInviteDisabledEmbedImpl guildInviteDisabledEmbedImpl, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = guildInviteDisabledMessageAccessory.mo41765getMessageId3Eiw7ao();
        }
        if ((i2 & 2) != 0) {
        ...
        return guildInviteDisabledMessageAccessory.m41806copyu7_MRrM(str, i, guildInviteDisabledEmbedImpl);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m41805component13Eiw7ao() {
    ...
    public final GuildInviteDisabledMessageAccessory m41806copyu7_MRrM(String messageId, int i, GuildInviteDisabledEmbedImpl invite) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), guildInviteDisabledMessageAccessory.mo41765getMessageId3Eiw7ao()) && this.codedLinkIndex == guildInviteDisabledMessageAccessory.codedLinkIndex && C9677q.m14638b(this.invite, guildInviteDisabledMessageAccessory.invite);
    }
    ...
    public String toString() {
        ...
        return "GuildInviteDisabledMessageAccessory(messageId=" + str + ", codedLinkIndex=" + i + ", invite=" + guildInviteDisabledEmbedImpl + ")";
    }
}
