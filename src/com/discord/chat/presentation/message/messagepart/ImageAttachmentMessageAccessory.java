...
public final class ImageAttachmentMessageAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), imageAttachmentMessageAccessory.mo41765getMessageId3Eiw7ao()) && this.attachmentIndex == imageAttachmentMessageAccessory.attachmentIndex && C9971q.m14638b(this.attachment, imageAttachmentMessageAccessory.attachment) && this.constrainedWidth == imageAttachmentMessageAccessory.constrainedWidth && this.radiusPx == imageAttachmentMessageAccessory.radiusPx && C9971q.m14638b(this.spoilerAttributes, imageAttachmentMessageAccessory.spoilerAttributes) && C9971q.m14638b(this.onLongClick, imageAttachmentMessageAccessory.onLongClick) && this.useNewAltTextButton == imageAttachmentMessageAccessory.useNewAltTextButton && C9971q.m14638b(this.attachmentsOpacity, imageAttachmentMessageAccessory.attachmentsOpacity);
    }
