...
public final class ThreadEmbedMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ ThreadEmbedMessageAccessory m41840copyntcYbpo$default(ThreadEmbedMessageAccessory threadEmbedMessageAccessory, String str, ThreadEmbed threadEmbed, int i, Object obj) {
        if ((i & 1) != 0) {
            str = threadEmbedMessageAccessory.mo41765getMessageId3Eiw7ao();
        }
        if ((i & 2) != 0) {
            threadEmbed = threadEmbedMessageAccessory.threadEmbed;
        }
        return threadEmbedMessageAccessory.m41842copyntcYbpo(str, threadEmbed);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m41841component13Eiw7ao() {
    ...
    public final ThreadEmbedMessageAccessory m41842copyntcYbpo(String messageId, ThreadEmbed threadEmbed) {
        C9971q.m14633g(messageId, "messageId");
        C9971q.m14633g(threadEmbed, "threadEmbed");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), threadEmbedMessageAccessory.mo41765getMessageId3Eiw7ao()) && C9971q.m14638b(this.threadEmbed, threadEmbedMessageAccessory.threadEmbed);
    }
    ...
    public int hashCode() {
        return (MessageId.m42120hashCodeimpl(mo41765getMessageId3Eiw7ao()) * 31) + this.threadEmbed.hashCode();
    }
