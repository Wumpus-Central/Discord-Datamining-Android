...
public final class ForumPostActionBar extends MessageAccessory {
    ...
    private ForumPostActionBar(String str, ForumPostActions forumPostActions, List<MessageReaction> list, boolean z, String str2, ReactionsTheme reactionsTheme, boolean z2) {
        ...
        this.useSortedReactions = z2;
    }

    public /* synthetic */ ForumPostActionBar(String str, ForumPostActions forumPostActions, List list, boolean z, String str2, ReactionsTheme reactionsTheme, boolean z2, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, forumPostActions, list, z, str2, reactionsTheme, z2);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: copy-dB0-bEw$default  reason: not valid java name */
    public static /* synthetic */ ForumPostActionBar m41795copydB0bEw$default(ForumPostActionBar forumPostActionBar, String str, ForumPostActions forumPostActions, List list, boolean z, String str2, ReactionsTheme reactionsTheme, boolean z2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = forumPostActionBar.mo41765getMessageId3Eiw7ao();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 64) != 0) {
            z2 = forumPostActionBar.useSortedReactions;
        }
        return forumPostActionBar.m41797copydB0bEw(str, forumPostActions, list, z, str2, reactionsTheme, z2);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m41796component13Eiw7ao() {
    ...
    public final ForumPostActionBar m41797copydB0bEw(String messageId, ForumPostActions postActions, List<MessageReaction> list, boolean z, String addNewReactionAccessibilityLabel, ReactionsTheme reactionsTheme, boolean z2) {
        C9677q.m14633g(messageId, "messageId");
        C9677q.m14633g(postActions, "postActions");
        C9677q.m14633g(addNewReactionAccessibilityLabel, "addNewReactionAccessibilityLabel");
        return new ForumPostActionBar(messageId, postActions, list, z, addNewReactionAccessibilityLabel, reactionsTheme, z2, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), forumPostActionBar.mo41765getMessageId3Eiw7ao()) && C9677q.m14638b(this.postActions, forumPostActionBar.postActions) && C9677q.m14638b(this.reactions, forumPostActionBar.reactions) && this.canAddNewReactions == forumPostActionBar.canAddNewReactions && C9677q.m14638b(this.addNewReactionAccessibilityLabel, forumPostActionBar.addNewReactionAccessibilityLabel) && C9677q.m14638b(this.reactionsTheme, forumPostActionBar.reactionsTheme) && this.useSortedReactions == forumPostActionBar.useSortedReactions;
    }
    ...
    public int hashCode() {
        int i = ((MessageId.m42120hashCodeimpl(mo41765getMessageId3Eiw7ao()) * 31) + this.postActions.hashCode()) * 31;
        ...
        int i5 = z ? 1 : 0;
        int i6 = z ? 1 : 0;
        int hashCode2 = (((hashCode + i4) * 31) + this.addNewReactionAccessibilityLabel.hashCode()) * 31;
        ReactionsTheme reactionsTheme = this.reactionsTheme;
        if (reactionsTheme != null) {
            i2 = reactionsTheme.hashCode();
        }
        int i7 = (hashCode2 + i2) * 31;
        boolean z2 = this.useSortedReactions;
        if (!z2) {
            i3 = z2 ? 1 : 0;
        }
        return i7 + i3;
    ...
    public String toString() {
        ...
        ReactionsTheme reactionsTheme = this.reactionsTheme;
        boolean z2 = this.useSortedReactions;
        return "ForumPostActionBar(messageId=" + str + ", postActions=" + forumPostActions + ", reactions=" + list + ", canAddNewReactions=" + z + ", addNewReactionAccessibilityLabel=" + str2 + ", reactionsTheme=" + reactionsTheme + ", useSortedReactions=" + z2 + ")";
    }
}
