...
public final class GiftMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ GiftMessageAccessory m41798copyu7_MRrM$default(GiftMessageAccessory giftMessageAccessory, String str, int i, GiftEmbed giftEmbed, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = giftMessageAccessory.mo41765getMessageId3Eiw7ao();
        }
        if ((i2 & 2) != 0) {
        ...
        return giftMessageAccessory.m41800copyu7_MRrM(str, i, giftEmbed);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m41799component13Eiw7ao() {
    ...
    public final GiftMessageAccessory m41800copyu7_MRrM(String messageId, int i, GiftEmbed gift) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m42119equalsimpl0(mo41765getMessageId3Eiw7ao(), giftMessageAccessory.mo41765getMessageId3Eiw7ao()) && this.index == giftMessageAccessory.index && C9971q.m14638b(this.gift, giftMessageAccessory.gift);
    }
    ...
    public int hashCode() {
        return (((MessageId.m42120hashCodeimpl(mo41765getMessageId3Eiw7ao()) * 31) + this.index) * 31) + this.gift.hashCode();
    }
    ...
    public String toString() {
        ...
        return "GiftMessageAccessory(messageId=" + str + ", index=" + i + ", gift=" + giftEmbed + ")";
    }
}
