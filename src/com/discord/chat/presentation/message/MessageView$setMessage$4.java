...
public final class MessageView$setMessage$4 extends AbstractC9679s implements Function1<MessageContentView, Unit> {
    ...
    public final void invoke2(MessageContentView it) {
        ...
        C1559w0.m36990q0(this.this$0, new MessageViewAccessibilityDelegate(this.$message, it, this.$onClick, this.$messageLongPress));
    }
}
