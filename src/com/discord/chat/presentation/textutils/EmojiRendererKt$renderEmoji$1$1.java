...
final class EmojiRendererKt$renderEmoji$1$1 extends AbstractC9679s implements Function1<GenericDraweeHierarchyBuilder, Unit> {
    ...
    public final void invoke2(GenericDraweeHierarchyBuilder renderEmojiInto) {
        C9677q.m14633g(renderEmojiInto, "$this$renderEmojiInto");
        int i = 0;
