...
public final class TextUtilsKt$toSpannable$12$click$6 extends AbstractC9679s implements Function1<View, Unit> {
    ...
    public final void invoke2(View it) {
        ...
        this.$rc.getOnTapChannel().invoke(((StaticChannelMentionContentNode) this.$contentNode).getChannelId().getChannelId(), String.valueOf(((StaticChannelMentionContentNode) this.$contentNode).m41648getGuildIdqOKuAAo()), null);
    }
}
