...
final class TextUtilsKt$toSpannable$12$1$1 extends AbstractC9679s implements Function1<RenderContext.Insets, RenderContext.Insets> {
    ...
    public final RenderContext.Insets invoke(RenderContext.Insets updateInsets) {
        C9677q.m14633g(updateInsets, "$this$updateInsets");
