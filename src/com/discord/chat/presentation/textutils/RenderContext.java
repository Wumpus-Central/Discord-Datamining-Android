...
public final class RenderContext {
    ...
    public RenderContext(Context context, String containerId, Function1<? super LinkContentNode, Unit> onTapLink, Function1<? super LinkContentNode, Unit> onLongTapLink, Function1<? super LinkContentNode, LinkStyle> linkStyle, Function3<? super String, ? super String, ? super String, Unit> onTapChannel, Function4<? super String, ? super String, ? super String, ? super String, Unit> onLongPressChannel, Function2<? super String, ? super String, Unit> onTapMention, Function1<? super CommandMentionContentNode, Unit> onTapCommand, Function1<? super CommandMentionContentNode, Unit> onLongPressCommand, Function0<Unit> onTapSpoiler, Function1<? super String, Unit> onTapTimestamp, Function1<? super EmojiContentNode, Unit> onTapEmoji, boolean z, boolean z2, boolean z3, boolean z4, SpoilerState spoilerState, int i, Integer num, Insets insets, DiscordTheme theme, float f, Integer num2) {
        ...
        C9677q.m14633g(onTapLink, "onTapLink");
        ...
        C9677q.m14633g(spoilerState, "spoilerState");
    ...
    public boolean equals(Object obj) {
        ...
        return C9677q.m14638b(this.context, renderContext.context) && C9677q.m14638b(this.containerId, renderContext.containerId) && C9677q.m14638b(this.onTapLink, renderContext.onTapLink) && C9677q.m14638b(this.onLongTapLink, renderContext.onLongTapLink) && C9677q.m14638b(this.linkStyle, renderContext.linkStyle) && C9677q.m14638b(this.onTapChannel, renderContext.onTapChannel) && C9677q.m14638b(this.onLongPressChannel, renderContext.onLongPressChannel) && C9677q.m14638b(this.onTapMention, renderContext.onTapMention) && C9677q.m14638b(this.onTapCommand, renderContext.onTapCommand) && C9677q.m14638b(this.onLongPressCommand, renderContext.onLongPressCommand) && C9677q.m14638b(this.onTapSpoiler, renderContext.onTapSpoiler) && C9677q.m14638b(this.onTapTimestamp, renderContext.onTapTimestamp) && C9677q.m14638b(this.onTapEmoji, renderContext.onTapEmoji) && this.animateEmoji == renderContext.animateEmoji && this.shouldShowRoleDot == renderContext.shouldShowRoleDot && this.shouldShowRoleOnName == renderContext.shouldShowRoleOnName && this.singleLine == renderContext.singleLine && this.spoilerState == renderContext.spoilerState && this.listNestedLevel == renderContext.listNestedLevel && C9677q.m14638b(this.listOrderedIndex, renderContext.listOrderedIndex) && C9677q.m14638b(this.insets, renderContext.insets) && C9677q.m14638b(this.theme, renderContext.theme) && Float.compare(this.baselineHeight, renderContext.baselineHeight) == 0 && C9677q.m14638b(this.emojiSizeOverride, renderContext.emojiSizeOverride);
    }
