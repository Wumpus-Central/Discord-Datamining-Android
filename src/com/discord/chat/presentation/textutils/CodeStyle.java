...
public final class CodeStyle {
    ...
    public final void renderCodeBlock(DraweeSpanStringBuilder builder, CodeBlockContentNode node, RenderContext rc) {
        ...
        if (rc.spoilerIsHidden()) {
            ...
            i = rc.getTheme().getBackgroundSecondary();
        }
        BlockBackgroundSpan blockBackgroundSpan = new BlockBackgroundSpan(i, rc.getTheme().getBackgroundSecondaryAlt(), SizeUtilsKt.getDpToPx(1), SizeUtilsKt.getDpToPx(4), rc.getInsets().getStart(), rc.getInsets().getTop(), rc.getInsets().getBottom());
