...
public final class MessageViewBinding {
    ...
    public static MessageViewBinding bind(View view) {
        ...
        if (messageAccessoriesView != null) {
            ...
            if (simpleDraweeView != null) {
                i = C3147R.C3149id.author_avatar_decoration;
                    ...
                    if (textView != null) {
                        ...
                        if (connectionsRoleTagView != null) {
                            ...
                            if (simpleDraweeView3 != null) {
                                i = C3147R.C3149id.highlight_header;
                                MessageHighlightHeader messageHighlightHeader = (MessageHighlightHeader) C13836a.m2313a(view, i);
                                if (messageHighlightHeader != null) {
                                    ...
                                    if (guideline != null) {
                                        ...
                                        MessageFrameHeaderView messageFrameHeaderView = (MessageFrameHeaderView) C13836a.m2313a(view, i);
                                                    ...
                                                    if (messageViewReplyPreview != null) {
                                                        ...
                                                        if (roleDotView != null) {
                                                            ...
                                                            if (roleIconView != null) {
                                                                i = C3147R.C3149id.suppress_notifications_icon;
    ...
    public static MessageViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        if (viewGroup != null) {
            layoutInflater.inflate(C3147R.layout.message_view, viewGroup);
