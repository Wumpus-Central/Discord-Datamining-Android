...
@AbstractC9636e(m14702c = "com.discord.chat.ChatModule$updateRows$1", m14701f = "ChatModule.kt", m14700l = {}, m14699m = "invokeSuspend")
/* loaded from: classes4.dex */
final class ChatModule$updateRows$1 extends AbstractC9643k implements Function2<ChatListManager, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(ChatListManager chatListManager, Continuation<? super Unit> continuation) {
        return ((ChatModule$updateRows$1) create(chatListManager, continuation)).invokeSuspend(Unit.f25780a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            try {
                ...
                json.mo611a();
                chatListManager.updateRows((List) json.mo578b(new C2521f(RowSerializer.INSTANCE), str));
            } catch (Exception e) {
                CrashReporting crashReporting = CrashReporting.INSTANCE;
                i = this.this$0.previousRowUpdateTag;
                ChatModule chatModule = this.this$0;
                i2 = chatModule.previousRowUpdateTag;
                k = C11053v.m10248k(C10853x.m10921a("tag", String.valueOf(this.$tag)), C10853x.m10921a("tagRowSize", String.valueOf(chatListManager.getRowCount())), C10853x.m10921a("previousTag", String.valueOf(i)), C10853x.m10921a("previousTagRowSize", String.valueOf(chatModule.getChatListManager(i2).getRowCount())));
