...
/* renamed from: com.discord.chat.messagemanager.MessageViewManagers$MessageBundleViewManager$createViewInstance$1 */
/* loaded from: classes4.dex */
public final class C4271x62a6ca56 extends AbstractC9973s implements Function3<View, Integer, Integer, Unit> {
    final /* synthetic */ ThemedReactContext $reactContext;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C4271x62a6ca56(ThemedReactContext themedReactContext) {
        super(3);
