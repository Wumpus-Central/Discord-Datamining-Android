...
public final class LoggingLineNumberTree extends C13143a.AbstractC13145c {
    private final List<String> ignoreClasses;

    public LoggingLineNumberTree() {
        List<String> l;
        l = C9906j.m14817l(C13143a.class.getName(), C13143a.C13144b.class.getName(), C13143a.AbstractC13145c.class.getName(), C13143a.C0422a.class.getName(), LoggingLineNumberTree.class.getName(), Log.class.getName());
    ...
    private final StackTraceElement getCalleStackTraceElement() {
        ...
        for (StackTraceElement stackTraceElement : stackTrace) {
            if (!this.ignoreClasses.contains(stackTraceElement.getClassName())) {
                C9971q.m14634f(stackTraceElement, "Throwable().stackTrace\n …sName !in ignoreClasses }");
