...
public final class Log {
    ...
    static {
        C13143a.f29446a.m4531a(new LoggingTree());
    }
    ...
    public final void m32181d(String tag, String message, Throwable th2) {
        ...
        C13143a.C13144b bVar = C13143a.f29446a;
        bVar.m4530b(tag);
    ...
    public final void m32180d(KClass<?> tag, String message, Throwable th2) {
        C9971q.m14633g(tag, "tag");
        C9971q.m14633g(message, "message");
        String simpleName = C14376a.m737b(tag).getSimpleName();
        C9971q.m14634f(simpleName, "tag.java.simpleName");
