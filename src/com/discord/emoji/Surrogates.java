...
public final class Surrogates {
    ...
    public static boolean m41987equalsimpl(String str, Object obj) {
        return (obj instanceof Surrogates) && C9677q.m14638b(str, ((Surrogates) obj).m41994unboximpl());
    }
    ...
    private static final String m41991toCodePointsimpl(String str) {
        ...
        C9677q.m14634f(sb3, "StringBuilder().apply(builderAction).toString()");
        return sb3;
    }
    ...
    public static final String m41993withoutDiversityimpl(String str) {
        ...
        C9677q.m14634f(chars, "toChars(value.codePointAt(0))");
        a0 = C9603f.m14936a0(chars, "", null, null, 0, null, null, 62, null);
        return a0;
    }
