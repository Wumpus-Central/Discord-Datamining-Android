...
public abstract class RenderableEmoji {
    ...
    public static final class CustomWithEmojiId extends RenderableEmoji {
        ...
        public int hashCode() {
            ...
            int i2 = z ? 1 : 0;
            int i3 = z ? 1 : 0;
            return ((a + i) * 31) + this.alt.hashCode();
        }
    ...
    public static final class Unicode extends RenderableEmoji {
        ...
        private Unicode(String str) {
            ...
            String str2 = null;
            this.surrogates = str;
            String str3 = Surrogates.m41993withoutDiversityimpl(str);
        ...
        public static /* synthetic */ Unicode m41981copyhLBmEAo$default(Unicode unicode, String str, int i, Object obj) {
            if ((i & 1) != 0) {
                str = unicode.surrogates;
            }
            return unicode.m41983copyhLBmEAo(str);
        }

        /* renamed from: component1-Mny0UXI  reason: not valid java name */
        public final String m41982component1Mny0UXI() {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Unicode) && Surrogates.m41988equalsimpl0(this.surrogates, ((Unicode) obj).surrogates);
        }
        ...
        public final String m41984getSurrogatesMny0UXI() {
            return this.surrogates;
        }

        @Override // com.discord.emoji.RenderableEmoji
        public String getUrl(boolean z, int i) {
            return Surrogates.m41990toAssetUrlimpl(this.surrogates);
        }

        public int hashCode() {
            return Surrogates.m41989hashCodeimpl(this.surrogates);
        }

        public String toString() {
            String str = Surrogates.m41992toStringimpl(this.surrogates);
