...
public abstract class TTILoggingApplication extends Application {
    ...
    public static final class Companion {
        static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {C9951f0.m14681e(new C9977w(Companion.class, "applicationOpenedTimestampExcludingActivityLaunchGap", "getApplicationOpenedTimestampExcludingActivityLaunchGap()J", 0)), C9951f0.m14681e(new C9977w(Companion.class, "applicationStartedTimestamp", "getApplicationStartedTimestamp()J", 0)), C9951f0.m14681e(new C9977w(Companion.class, "applicationInitializeTimestamp", "getApplicationInitializeTimestamp()J", 0))};
