...
import kotlinx.coroutines.C10216u2;
import kotlinx.coroutines.CoroutineScope;
import nf.C11093t;
import tf.C13080d;

@Metadata(m15074d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, m15073d2 = {"Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, m15072k = 3, m15071mv = {1, 8, 0})
@AbstractC9931e(m14702c = "com.discord.analytics.InstallReferrerModule$get$1", m14701f = "InstallReferrerModule.kt", m14700l = {35}, m14699m = "invokeSuspend")
/* loaded from: classes.dex */
final class InstallReferrerModule$get$1 extends AbstractC9938k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @Metadata(m15074d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, m15073d2 = {"Lkotlinx/coroutines/CoroutineScope;", "", "<anonymous>"}, m15072k = 3, m15071mv = {1, 8, 0})
    @AbstractC9931e(m14702c = "com.discord.analytics.InstallReferrerModule$get$1$1", m14701f = "InstallReferrerModule.kt", m14700l = {39}, m14699m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends AbstractC9938k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(Ref$ObjectRef<InstallReferrerClient> ref$ObjectRef, InstallReferrerModule installReferrerModule, Ref$ObjectRef<String> ref$ObjectRef2, SharedPreferences sharedPreferences, Promise promise, int i, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            AnonymousClass1 r8 = new AnonymousClass1(this.$client, this.this$0, this.$referrer, this.$prefs, this.$promise, this.$attempts, continuation);
            r8.L$0 = obj;
            return r8;
        }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((InstallReferrerModule$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f22042a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (C10216u2.m13985c(1000L, r12, this) == d) {
                return d;
            }
        } else if (i == 1) {
            C11093t.m10930b(obj);
