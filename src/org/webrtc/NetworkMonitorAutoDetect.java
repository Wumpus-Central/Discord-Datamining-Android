...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    private class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            Logging.m9642d(NetworkMonitorAutoDetect.TAG, "Network becomes available: " + network.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            Logging.m9642d(NetworkMonitorAutoDetect.TAG, "capabilities changed: " + networkCapabilities.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            Logging.m9642d(NetworkMonitorAutoDetect.TAG, "link properties changed");
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLosing(Network network, int i) {
            Logging.m9642d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is about to lose in " + i + "ms");
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLost(Network network) {
            Logging.m9642d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is disconnected");
    ...
    static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        WifiDirectManagerDelegate(NetworkChangeDetector.Observer observer, Context context) {
            ...
            if (Build.VERSION.SDK_INT > 28) {
                ...
                wifiP2pManager.requestGroupInfo(wifiP2pManager.initialize(context, context.getMainLooper(), null), new WifiP2pManager.GroupInfoListener() { // from class: org.webrtc.t
        ...
        public void lambda$new$0(@Nullable WifiP2pGroup wifiP2pGroup) {
            if (wifiP2pGroup != null && wifiP2pGroup.getInterface() != null) {
                try {
                    ...
                    Logging.m9640e(NetworkMonitorAutoDetect.TAG, "Unable to get WifiP2p network interface", e);
                }
            }
        }
    ...
    public NetworkMonitorAutoDetect(NetworkChangeDetector.Observer observer, Context context) {
        ...
        if (this.connectivityManagerDelegate.supportNetworkCallback()) {
            ...
            try {
                ...
                Logging.m9638w(TAG, "Unable to obtain permission to request a cellular network.");
    ...
    private void connectionTypeChanged(NetworkState networkState) {
        ...
        if (connectionType != this.connectionType || !wifiSSID.equals(this.wifiSSID)) {
            ...
            Logging.m9642d(TAG, "Network connectivity changed, type is: " + this.connectionType);
    ...
    public static class ConnectivityManagerDelegate {
        ...
        public NetworkChangeDetector.NetworkInformation networkToInfo(@Nullable Network network) {
            ...
            if (linkProperties == null) {
                Logging.m9638w(NetworkMonitorAutoDetect.TAG, "Detected unknown network: " + network.toString());
                return null;
            } else if (linkProperties.getInterfaceName() == null) {
                Logging.m9638w(NetworkMonitorAutoDetect.TAG, "Null interface name for network " + network.toString());
                return null;
            } else {
                ...
                if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN || connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN_CELLULAR) {
                    Logging.m9642d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " connection type is " + connectionType + " because it has type " + networkState.getNetworkType() + " and subtype " + networkState.getNetworkSubType());
                }
        ...
        public void releaseCallback(ConnectivityManager.NetworkCallback networkCallback) {
            if (supportNetworkCallback()) {
                Logging.m9642d(NetworkMonitorAutoDetect.TAG, "Unregister network callback");
        ...
        NetworkState getNetworkState(@Nullable Network network) {
            ...
            if (networkInfo == null) {
                Logging.m9638w(NetworkMonitorAutoDetect.TAG, "Couldn't retrieve information from network " + network.toString());
                return new NetworkState(false, -1, -1, -1, -1);
