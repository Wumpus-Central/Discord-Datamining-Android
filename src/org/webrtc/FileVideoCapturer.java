...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) {
            ...
            while (true) {
                ...
                if (read == -1) {
                    ...
                    Logging.m9642d(TAG, "Color space: " + str2);
                    if (!str2.equals("420") && !str2.equals("420mpeg2")) {
                        ...
                        this.frameWidth = i;
                        this.frameHeight = i2;
                        Logging.m9642d(TAG, "frame dim: (" + i + ", " + i2 + ")");
                        return;
                    }
                } else {
        ...
        public void close() {
            try {
                ...
                Logging.m9640e(TAG, "Problem closing file", e);
            }
        }
    ...
    public FileVideoCapturer(String str) {
        try {
            ...
            Logging.m9642d(TAG, "Could not open video file: " + str);
            throw e;
        }
    }
