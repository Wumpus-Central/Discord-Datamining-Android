...
public class WebRtcAudioRecord {
    ...
    private boolean enableBuiltInAEC(boolean z) {
        ...
        Logging.m9641e(TAG, "Built-in AEC is not supported on this platform");
        return false;
    }
    ...
    private boolean enableBuiltInNS(boolean z) {
        ...
        Logging.m9641e(TAG, "Built-in NS is not supported on this platform");
        return false;
    }
    ...
    public static synchronized void setAudioSource(int i) {
        synchronized (WebRtcAudioRecord.class) {
            Logging.m9638w(TAG, "Audio source is changed from: " + audioSource + " to " + i);
            audioSource = i;
        }
    }

    public static void setErrorCallback(WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback) {
        Logging.m9642d(TAG, "Set error callback");
    ...
    private boolean startRecording() {
        ...
        try {
            ...
            Logging.m9640e(TAG, "WebrtcAudioRecord.startRecording fail hard!", th2);
            throw th2;
        }
    }
