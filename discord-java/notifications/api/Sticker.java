...
public final class Sticker implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<Sticker> {
        ...
        public final Sticker createFromParcel(Parcel parcel) {
            Boolean bool;
            q.g(parcel, "parcel");
            long j10 = ((StickerId) parcel.readParcelable(Sticker.class.getClassLoader())).m592unboximpl();
    ...
    private Sticker(int i10, StickerId stickerId, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if ((i10 & 1) == 0) {
            j10 = StickerId.m584constructorimpl(0L);
        } else {
            j10 = stickerId.m592unboximpl();
        }
        this.f7502id = j10;
        this.name = str;
        if ((i10 & 4) == 0) {
    ...
    public static /* synthetic */ void m505getGuildIdqOKuAAo$annotations() {
    }

    /* renamed from: getId-e_wqtJY$annotations  reason: not valid java name */
    public static /* synthetic */ void m506getIde_wqtJY$annotations() {
    }
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z17 = false;
        if (!output.A(serialDesc, 0) && StickerId.m587equalsimpl0(self.f7502id, StickerId.m584constructorimpl(0L))) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.t(serialDesc, 0, StickerId$$serializer.INSTANCE, StickerId.m583boximpl(self.f7502id));
        }
        ...
        if (z11) {
            output.p(serialDesc, 2, w0.f6033a, self.packId);
        }
        ...
        if (z12) {
            output.p(serialDesc, 3, GuildId$$serializer.INSTANCE, self.guildId);
        }
        if (!output.A(serialDesc, 4) && q.b(self.description, "")) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (z13) {
            output.z(serialDesc, 4, self.description);
        }
        if (!output.A(serialDesc, 5) && self.formatType == StickerFormatType.Companion.fromInt(0)) {
            z14 = false;
        } else {
            z14 = true;
        }
        if (z14) {
            output.t(serialDesc, 5, StickerFormatType.Serializer.INSTANCE, self.formatType);
        }
        if (!output.A(serialDesc, 6) && q.b(self.tags, "")) {
            z15 = false;
        } else {
            z15 = true;
        }
        if (z15) {
            output.z(serialDesc, 6, self.tags);
        }
        if (!output.A(serialDesc, 7) && self.type == StickerType.Companion.fromInt(0)) {
            z16 = false;
        } else {
            z16 = true;
        }
        if (z16) {
            output.t(serialDesc, 7, StickerType.Serializer.INSTANCE, self.type);
        }
        if (output.A(serialDesc, 8) || self.available != null) {
            z17 = true;
        }
        if (z17) {
            output.p(serialDesc, 8, h.f5959a, self.available);
        }
    }

    /* renamed from: component1-e_wqtJY  reason: not valid java name */
    public final long m507component1e_wqtJY() {
        return this.f7502id;
    }
    ...
    public final GuildId m508component4qOKuAAo() {
        return this.guildId;
    }
    ...
    public final Sticker m509copyfJhvhH4(long j10, String name, Long l10, GuildId guildId, String description, StickerFormatType formatType, String tags, StickerType type, Boolean bool) {
        q.g(name, "name");
    ...
    public final GuildId m510getGuildIdqOKuAAo() {
        return this.guildId;
    }

    /* renamed from: getId-e_wqtJY  reason: not valid java name */
    public final long m511getIde_wqtJY() {
        return this.f7502id;
    }
    ...
    public int hashCode() {
        int i10 = ((StickerId.m588hashCodeimpl(this.f7502id) * 31) + this.name.hashCode()) * 31;
        Long l10 = this.packId;
        int i11 = 0;
        int hashCode = (i10 + (l10 == null ? 0 : l10.hashCode())) * 31;
        GuildId guildId = this.guildId;
        int i12 = (((((((((hashCode + (guildId == null ? 0 : GuildId.m550hashCodeimpl(guildId.m554unboximpl()))) * 31) + this.description.hashCode()) * 31) + this.formatType.hashCode()) * 31) + this.tags.hashCode()) * 31) + this.type.hashCode()) * 31;
    ...
    public String toString() {
        String str = StickerId.m590toStringimpl(this.f7502id);
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        out.writeParcelable(StickerId.m583boximpl(this.f7502id), i10);
    ...
    public /* synthetic */ Sticker(long j10, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? StickerId.m584constructorimpl(0L) : j10, str, (i10 & 4) != 0 ? null : l10, (i10 & 8) != 0 ? null : guildId, (i10 & 16) != 0 ? "" : str2, (i10 & 32) != 0 ? StickerFormatType.Companion.fromInt(0) : stickerFormatType, (i10 & 64) != 0 ? "" : str3, (i10 & 128) != 0 ? StickerType.Companion.fromInt(0) : stickerType, (i10 & Spliterator.NONNULL) != 0 ? null : bool, null);
    }
}
