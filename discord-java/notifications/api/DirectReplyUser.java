...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7501id = userId.m605unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.t(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m596boximpl(self.f7501id));
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m600equalsimpl0(this.f7501id, directReplyUser.f7501id) && q.b(this.username, directReplyUser.username) && q.b(this.discriminator, directReplyUser.discriminator) && q.b(this.avatar, directReplyUser.avatar);
    }
    ...
    public int hashCode() {
        int i10 = UserId.m601hashCodeimpl(this.f7501id) * 31;
    ...
    public String toString() {
        String str = UserId.m603toStringimpl(this.f7501id);
