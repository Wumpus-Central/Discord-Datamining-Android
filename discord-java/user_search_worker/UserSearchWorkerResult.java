...
public final class UserSearchWorkerResult {
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7545id, userSearchWorkerResult.f7545id) && q.b(this.username, userSearchWorkerResult.username) && q.b(this.comparator, userSearchWorkerResult.comparator) && Double.compare(this.score, userSearchWorkerResult.score) == 0;
    }
