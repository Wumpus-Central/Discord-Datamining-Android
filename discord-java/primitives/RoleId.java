...
public final class RoleId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<RoleId> {
        ...
        public /* bridge */ /* synthetic */ RoleId createFromParcel(Parcel parcel) {
            return RoleId.m570boximpl(m582createFromParcelK4NZIAs(parcel));
        }

        /* renamed from: createFromParcel-K4NZIAs  reason: not valid java name */
        public final long m582createFromParcelK4NZIAs(Parcel parcel) {
            q.g(parcel, "parcel");
            return RoleId.m571constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ RoleId m570boximpl(long j10) {
        return new RoleId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m571constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static int m572describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m573equalsimpl(long j10, Object obj) {
        return (obj instanceof RoleId) && j10 == ((RoleId) obj).m579unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m574equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }
    ...
    public static boolean m576isValidimpl(long j10) {
        return j10 > 0;
    }
    ...
    public static void m578writeToParcelimpl(long j10, Parcel out, int i10) {
        q.g(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m572describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m573equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m575hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m576isValidimpl(this.snowflake);
    }

    public String toString() {
        return m577toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m579unboximpl() {
        return this.snowflake;
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        m578writeToParcelimpl(this.snowflake, out, i10);
    }
}
