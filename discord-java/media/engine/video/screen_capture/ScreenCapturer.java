...
public final class ScreenCapturer extends ScreenCapturerAndroid {
    ...
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\n\u001a\u00020\u00042\u0006\u0010\u000b\u001a\u00020\u0004H\u0002J\u0010\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000fH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lcom/discord/media/engine/video/screen_capture/ScreenCapturer$Companion;", "", "()V", "AUDIO_FORMAT", "", "CHANNEL_CONFIG", "MIN_REPEAT_FRAMERATE", "SAMPLING_RATE_IN_HZ", "TAG", "", "closestMod16", "n", "getScreenSize", "Landroid/graphics/Rect;", "context", "Landroid/content/Context;", "media_engine_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes5.dex */
    ...
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0016\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, d2 = {"Lcom/discord/media/engine/video/screen_capture/ScreenCapturer$OnStopCallback;", "Landroid/media/projection/MediaProjection$Callback;", "()V", "onStop", "", "media_engine_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes5.dex */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, d2 = {"Lcom/discord/media/engine/video/screen_capture/ScreenCapturer$Watchdog;", "Ljava/lang/Runnable;", "(Lcom/discord/media/engine/video/screen_capture/ScreenCapturer;)V", "run", "", "media_engine_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes5.dex */
    ...
    public synchronized void changeCaptureFormat(int i10, int i11, int i12) {
        changeCaptureFormatInternal(this.lastMeasuredSize, Math.max(i10, i11));
        setFramerate(i12);
    }
    ...
    public final synchronized void changeCaptureFormatInternal(Rect measuredSize, int i10) {
        ...
        if (max > 0) {
            float f10 = i10 / max;
            this.calculatedSize.set((int) (measuredSize.width() * f10), (int) (measuredSize.height() * f10));
    ...
    public void createVirtualDisplay() {
        try {
            ...
            Log.INSTANCE.e(TAG, "error in createVirtualDisplay", th2);
        }
    }
    ...
    public synchronized void startCapture(int i10, int i11, int i12) {
        ...
        this.maxDimension = Math.max(i10, i11);
        setFramerate(i12);
