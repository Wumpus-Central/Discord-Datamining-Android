...
public final class ContentResolverMedia {
    ...
    public int hashCode() {
        int a10 = ((((a.a(this.f7482id) * 31) + this.uri.hashCode()) * 31) + this.mediaType.hashCode()) * 31;
