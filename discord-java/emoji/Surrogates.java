...
public final class Surrogates {
    ...
    public static final /* synthetic */ Surrogates m422boximpl(String str) {
        return new Surrogates(str);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static String m423constructorimpl(String value) {
        q.g(value, "value");
        return value;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m424equalsimpl(String str, Object obj) {
        return (obj instanceof Surrogates) && q.b(str, ((Surrogates) obj).m431unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m425equalsimpl0(String str, String str2) {
        return q.b(str, str2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m426hashCodeimpl(String str) {
        return str.hashCode();
    }

    /* renamed from: toAssetUrl-impl  reason: not valid java name */
    public static final String m427toAssetUrlimpl(String str) {
        String str2 = m428toCodePointsimpl(str);
        return "asset:///emoji-" + str2 + ".png";
    }

    /* renamed from: toCodePoints-impl  reason: not valid java name */
    private static final String m428toCodePointsimpl(String str) {
        boolean z10;
    ...
    public static String m429toStringimpl(String str) {
        return "Surrogates(value=" + str + ")";
    }

    /* renamed from: withoutDiversity-impl  reason: not valid java name */
    public static final String m430withoutDiversityimpl(String str) {
        String a02;
    ...
    public final /* synthetic */ String m431unboximpl() {
        return this.value;
    }
}
