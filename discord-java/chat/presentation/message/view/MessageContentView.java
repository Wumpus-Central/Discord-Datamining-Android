...
public final class MessageContentView extends SimpleDraweeSpanTextView implements VerticalSpacingItemDecoration.SpacingProviderView {
    ...
    private final void m300truncatepPZZVto(String str, Truncation truncation, int i10, DraweeSpanStringBuilder draweeSpanStringBuilder, Function1<? super MessageId, Unit> function1) {
        int i11;
        int i12;
