...
public final class MessageAccessoriesAdapter$onBindViewHolder$36 extends s implements Function2<String, String, Unit> {
    ...
    public final void invoke2(String url, String filename) {
        ...
        q.d(str);
        chatEventHandler.mo141onLinkClickedu7_MRrM(str, url, filename);
    }
}
