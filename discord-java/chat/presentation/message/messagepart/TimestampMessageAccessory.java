...
public final class TimestampMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ TimestampMessageAccessory m280copyAFFcxXc$default(TimestampMessageAccessory timestampMessageAccessory, String str, String str2, int i10, DiscordFont discordFont, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = timestampMessageAccessory.mo202getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return timestampMessageAccessory.m282copyAFFcxXc(str, str2, i10, discordFont);
    }
    ...
    public final TimestampMessageAccessory m282copyAFFcxXc(String messageId, String timestamp, int i10, DiscordFont discordFont) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m562equalsimpl0(mo202getMessageId3Eiw7ao(), timestampMessageAccessory.mo202getMessageId3Eiw7ao()) && q.b(this.timestamp, timestampMessageAccessory.timestamp) && this.textColor == timestampMessageAccessory.textColor && this.discordFont == timestampMessageAccessory.discordFont;
    }
    ...
    public int hashCode() {
        return (((((MessageId.m563hashCodeimpl(mo202getMessageId3Eiw7ao()) * 31) + this.timestamp.hashCode()) * 31) + this.textColor) * 31) + this.discordFont.hashCode();
    }
