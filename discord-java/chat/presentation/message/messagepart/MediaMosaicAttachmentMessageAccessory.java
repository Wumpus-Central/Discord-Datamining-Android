...
public final class MediaMosaicAttachmentMessageAccessory extends MessageAccessory {
    ...
    public /* synthetic */ MediaMosaicAttachmentMessageAccessory(String str, List list, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, list, i10);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: copy-u7_MRrM$default  reason: not valid java name */
    public static /* synthetic */ MediaMosaicAttachmentMessageAccessory m253copyu7_MRrM$default(MediaMosaicAttachmentMessageAccessory mediaMosaicAttachmentMessageAccessory, String str, List list, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = mediaMosaicAttachmentMessageAccessory.mo202getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return mediaMosaicAttachmentMessageAccessory.m255copyu7_MRrM(str, list, i10);
    }
    ...
    public final MediaMosaicAttachmentMessageAccessory m255copyu7_MRrM(String messageId, List<? extends MessageAccessory> attachments, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m562equalsimpl0(mo202getMessageId3Eiw7ao(), mediaMosaicAttachmentMessageAccessory.mo202getMessageId3Eiw7ao()) && q.b(this.attachments, mediaMosaicAttachmentMessageAccessory.attachments) && this.constrainedWidth == mediaMosaicAttachmentMessageAccessory.constrainedWidth;
    }
    ...
    public int hashCode() {
        return (((MessageId.m563hashCodeimpl(mo202getMessageId3Eiw7ao()) * 31) + this.attachments.hashCode()) * 31) + this.constrainedWidth;
    }
