...
public final class SurveyIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ SurveyIndicationMessageAccessory m274copyntcYbpo$default(SurveyIndicationMessageAccessory surveyIndicationMessageAccessory, String str, SurveyIndication surveyIndication, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = surveyIndicationMessageAccessory.mo202getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            surveyIndication = surveyIndicationMessageAccessory.surveyIndication;
        }
        return surveyIndicationMessageAccessory.m276copyntcYbpo(str, surveyIndication);
    }
    ...
    public final SurveyIndicationMessageAccessory m276copyntcYbpo(String messageId, SurveyIndication surveyIndication) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m562equalsimpl0(mo202getMessageId3Eiw7ao(), surveyIndicationMessageAccessory.mo202getMessageId3Eiw7ao()) && q.b(this.surveyIndication, surveyIndicationMessageAccessory.surveyIndication);
    }
    ...
    public int hashCode() {
        return (MessageId.m563hashCodeimpl(mo202getMessageId3Eiw7ao()) * 31) + this.surveyIndication.hashCode();
    }
