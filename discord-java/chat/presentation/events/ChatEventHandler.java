...
public interface ChatEventHandler {
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void m172onLinkClickedu7_MRrM$default(ChatEventHandler chatEventHandler, String str, String str2, String str3, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    str3 = null;
                }
        ...
        public static /* synthetic */ void m173onTapButtonActionComponentNkFJqEg$default(ChatEventHandler chatEventHandler, String str, long j10, String str2, long j11, int[] iArr, int i10, Object obj) {
            if (obj == null) {
        ...
        public static /* synthetic */ void m174onTapReactionu7_MRrM$default(ChatEventHandler chatEventHandler, String str, ReactionView.Reaction reaction, Boolean bool, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    bool = Boolean.FALSE;
                }
                chatEventHandler.mo160onTapReactionu7_MRrM(str, reaction, bool);
                return;
            }
        ...
        public static /* synthetic */ void m175onTapSelectActionComponentu7_MRrM$default(ChatEventHandler chatEventHandler, String str, long j10, SelectComponent selectComponent, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 2) != 0) {
                    j10 = 0;
                }
                chatEventHandler.mo163onTapSelectActionComponentu7_MRrM(str, j10, selectComponent);
                return;
            }
    ...
    public static final class Empty implements ChatEventHandler {
        ...
        public void mo153onTapFollowForumPostpfaIj0E(String messageId, long j10) {
            q.g(messageId, "messageId");
        }
        ...
        public void mo154onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
            q.g(messageId, "messageId");
            q.g(type, "type");
        ...
        public void mo155onTapInviteEmbedAFFcxXc(String messageId, int i10, Boolean bool, Boolean bool2) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: onTapInviteToSpeak-1xi1bu0 */
        public void mo156onTapInviteToSpeak1xi1bu0(String messageId) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: onTapJoinActivity-1xi1bu0 */
        public void mo157onTapJoinActivity1xi1bu0(String messageId) {
            q.g(messageId, "messageId");
        }
        ...
        public void mo158onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        public void mo159onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: onTapReaction-u7_MRrM */
        public void mo160onTapReactionu7_MRrM(String messageId, ReactionView.Reaction reaction, Boolean bool) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: onTapReactionOverflow-pfaIj0E */
        public void mo161onTapReactionOverflowpfaIj0E(String messageId, long j10) {
            q.g(messageId, "messageId");
        }
        ...
        public void mo162onTapSeeMore1xi1bu0(String messageId) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: onTapSelectActionComponent-u7_MRrM */
        public void mo163onTapSelectActionComponentu7_MRrM(String messageId, long j10, SelectComponent selectComponent) {
            q.g(messageId, "messageId");
        ...
        public void mo164onTapShareForumPostmgk6anA(long j10, long j11) {
        }
        ...
        public void mo165onTapThreadEmbed1xi1bu0(String messageId) {
            q.g(messageId, "messageId");
        }
        ...
        public void mo166onTapToggleBlockedMessages1xi1bu0(String messageId) {
            q.g(messageId, "messageId");
        }
        ...
        public void mo167onTapUsernamex5gers8(String messageId, long j10) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: onWelcomeReplyClicked-Ayv7vGE */
        public void mo168onWelcomeReplyClickedAyv7vGE(Sticker sticker, String messageId) {
            q.g(sticker, "sticker");
            q.g(messageId, "messageId");
        }
        ...
        public void mo169voiceMessagePlaybackEndedOuNwOLg(String messageId, float f10, float f11, long j10) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: voiceMessagePlaybackFailed-ntcYbpo */
        public void mo170voiceMessagePlaybackFailedntcYbpo(String messageId, String str) {
            q.g(messageId, "messageId");
        }

        @Override // com.discord.chat.presentation.events.ChatEventHandler
        /* renamed from: voiceMessagePlaybackStarted-OuNwOLg */
        public void mo171voiceMessagePlaybackStartedOuNwOLg(String messageId, float f10, float f11, long j10) {
            q.g(messageId, "messageId");
        }
    ...
    void mo153onTapFollowForumPostpfaIj0E(String str, long j10);
    ...
    void mo154onTapImagea6FnOk(String str, int i10, String str2, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num);

    /* renamed from: onTapInviteEmbed-AFFcxXc  reason: not valid java name */
    void mo155onTapInviteEmbedAFFcxXc(String str, int i10, Boolean bool, Boolean bool2);

    /* renamed from: onTapInviteToSpeak-1xi1bu0  reason: not valid java name */
    void mo156onTapInviteToSpeak1xi1bu0(String str);

    /* renamed from: onTapJoinActivity-1xi1bu0  reason: not valid java name */
    void mo157onTapJoinActivity1xi1bu0(String str);
    ...
    void mo158onTapMessageReply0eiqbug(long j10, String str);

    void onTapOpTag();

    /* renamed from: onTapPostPreviewEmbed-kUTrp-s  reason: not valid java name */
    void mo159onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String str);

    /* renamed from: onTapReaction-u7_MRrM  reason: not valid java name */
    void mo160onTapReactionu7_MRrM(String str, ReactionView.Reaction reaction, Boolean bool);

    /* renamed from: onTapReactionOverflow-pfaIj0E  reason: not valid java name */
    void mo161onTapReactionOverflowpfaIj0E(String str, long j10);

    void onTapRoleIcon(String str, String str2);

    /* renamed from: onTapSeeMore-1xi1bu0  reason: not valid java name */
    void mo162onTapSeeMore1xi1bu0(String str);

    /* renamed from: onTapSelectActionComponent-u7_MRrM  reason: not valid java name */
    void mo163onTapSelectActionComponentu7_MRrM(String str, long j10, SelectComponent selectComponent);

    /* renamed from: onTapShareForumPost-mgk6anA  reason: not valid java name */
    void mo164onTapShareForumPostmgk6anA(long j10, long j11);
