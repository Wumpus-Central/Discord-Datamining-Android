...
public final class HandleSurveyMessage {
    ...
    public static final void write$Self(HandleSurveyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m558boximpl(self.f7208id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m562equalsimpl0(this.f7208id, handleSurveyMessage.f7208id) && ChannelId.m536equalsimpl0(this.channelId, handleSurveyMessage.channelId) && q.b(this.loggingName, handleSurveyMessage.loggingName);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m563hashCodeimpl(this.f7208id) * 31) + ChannelId.m537hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return i10 + (str == null ? 0 : str.hashCode());
    }

    public String toString() {
        String str = MessageId.m564toStringimpl(this.f7208id);
