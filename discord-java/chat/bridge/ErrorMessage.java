...
public final class ErrorMessage extends MessageBase {
    ...
    public static final void write$Self(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m558boximpl(self.f7201id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m562equalsimpl0(this.f7201id, errorMessage.f7201id) && q.b(this.stackTrace, errorMessage.stackTrace);
    }
    ...
    public int hashCode() {
        return (MessageId.m563hashCodeimpl(this.f7201id) * 31) + this.stackTrace.hashCode();
    }

    public String toString() {
        String str = MessageId.m564toStringimpl(this.f7201id);
