...
public final class Sticker {
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.E(serialDesc, 0, self.f7213id);
        ...
        output.z(serialDesc, 4, self.url);
        if (!output.A(serialDesc, 5) && self.width == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.p(serialDesc, 5, m0.f5992a, self.width);
        }
        if (output.A(serialDesc, 6) || self.height != null) {
            z11 = true;
        }
        if (z11) {
            output.p(serialDesc, 6, m0.f5992a, self.height);
        }
        output.x(serialDesc, 7, self.renderMode);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7213id == sticker.f7213id && this.formatType == sticker.formatType && q.b(this.name, sticker.name) && q.b(this.asset, sticker.asset) && q.b(this.url, sticker.url) && q.b(this.width, sticker.width) && q.b(this.height, sticker.height) && this.renderMode == sticker.renderMode;
    }
    ...
    public int hashCode() {
        int a10 = ((((((((a.a(this.f7213id) * 31) + this.formatType.hashCode()) * 31) + this.name.hashCode()) * 31) + this.asset.hashCode()) * 31) + this.url.hashCode()) * 31;
