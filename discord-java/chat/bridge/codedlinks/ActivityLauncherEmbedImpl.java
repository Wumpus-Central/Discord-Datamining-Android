...
public final class ActivityLauncherEmbedImpl extends CodedLinkEmbed implements ActivityLauncherEmbed {
    ...
    public static final void write$Self(ActivityLauncherEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 27, ApplicationId$$serializer.INSTANCE, ApplicationId.m519boximpl(self.mo32getApplicationIdVavddsQ()));
        output.t(serialDesc, 28, ChannelId$$serializer.INSTANCE, ChannelId.m532boximpl(self.mo33getChannelIdo4g7jtM()));
    ...
    public String toString() {
        ...
        String str = ApplicationId.m526toStringimpl(mo32getApplicationIdVavddsQ());
        String str2 = ChannelId.m539toStringimpl(mo33getChannelIdo4g7jtM());
