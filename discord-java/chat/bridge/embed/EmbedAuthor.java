...
public final class EmbedAuthor {
    ...
    /* renamed from: com.discord.chat.bridge.embed.EmbedAuthor$1  reason: invalid class name */
    /* loaded from: classes4.dex */
    ...
    public static final void write$Self(EmbedAuthor self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.p(serialDesc, 1, a2.f5917a, self.url);
        }
        ...
        if (z11) {
            output.p(serialDesc, 2, a2.f5917a, self.iconURL);
        }
        if (output.A(serialDesc, 3) || self.iconProxyURL != null) {
            z12 = true;
        }
        if (z12) {
            output.p(serialDesc, 3, a2.f5917a, self.iconProxyURL);
        }
    }
