...
public final class MessageViewManagers$MessageBundleViewManager$createViewInstance$1 extends s implements Function3<View, Integer, Integer, Unit> {
    final /* synthetic */ ThemedReactContext $reactContext;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MessageViewManagers$MessageBundleViewManager$createViewInstance$1(ThemedReactContext themedReactContext) {
        super(3);
