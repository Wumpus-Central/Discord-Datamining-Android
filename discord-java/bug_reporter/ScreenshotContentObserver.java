...
public final class ScreenshotContentObserver extends ContentObserver {
    ...
    public static final class ScreenshotData {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f7184id == screenshotData.f7184id && q.b(this.fileName, screenshotData.fileName) && q.b(this.relativePath, screenshotData.relativePath) && q.b(this.uri, screenshotData.uri) && this.dateAdded == screenshotData.dateAdded;
        }
        ...
        public int hashCode() {
            return (((((((a.a(this.f7184id) * 31) + this.fileName.hashCode()) * 31) + this.relativePath.hashCode()) * 31) + this.uri.hashCode()) * 31) + a.a(this.dateAdded);
        }

        public String toString() {
            long j10 = this.f7184id;
