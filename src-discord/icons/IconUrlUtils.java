...
public final class IconUrlUtils {
    ...
    public static  String m483getApplicationIconweIltyw$default(IconUrlUtils iconUrlUtils, ApplicationId applicationId, String str, int i10, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            i10 = 160;
        }
        return iconUrlUtils.m488getApplicationIconweIltyw(applicationId, str, i10);
    }
    ...
    public static  String m484getForChannelJYSGpIY$default(IconUrlUtils iconUrlUtils, Context context, ChannelId channelId, String str, boolean z10, Integer num, int i10, Object obj) {
        if ((i10 & 16) != 0) {
            num = null;
        }
        return iconUrlUtils.m489getForChannelJYSGpIY(context, channelId, str, z10, num);
    }

    
    public static  String m485getForGuild14CJxO4$default(IconUrlUtils iconUrlUtils, GuildId guildId, String str, String str2, boolean z10, Integer num, int i10, Object obj) {
        String str3 = (i10 & 4) != 0 ? null : str2;
        if ((i10 & 8) != 0) {
            z10 = false;
        }
        return iconUrlUtils.m490getForGuild14CJxO4(guildId, str, str3, z10, (i10 & 16) != 0 ? null : num);
    }

    
    public static  String m486getForGuildMember2tNb6hE$default(IconUrlUtils iconUrlUtils, String str, GuildId guildId, UserId userId, Integer num, boolean z10, int i10, Object obj) {
        if ((i10 & 8) != 0) {
            num = null;
        }
        if ((i10 & 16) != 0) {
        ...
        return iconUrlUtils.m491getForGuildMember2tNb6hE(str, guildId, userId, num, z10);
    }
    ...
    public final String m488getApplicationIconweIltyw(ApplicationId applicationId, String str, int i10) {
    ...
    public final String m489getForChannelJYSGpIY(Context context, ChannelId channelId, String str, boolean z10, Integer num) {
        boolean z11;
        Object obj;
        q.h(context, "context");
        if (channelId == null) {
    ...
    public final String m490getForGuild14CJxO4(GuildId guildId, String str, String str2, boolean z10, Integer num) {
        boolean z11;
        Object obj;
        if (str == null || str.length() == 0) {
            z11 = true;
    ...
    public final java.lang.String m491getForGuildMember2tNb6hE(java.lang.String r9, com.discord.primitives.GuildId r10, com.discord.primitives.UserId r11, java.lang.Integer r12, boolean r13) {
        
        throw new UnsupportedOperationException("Method not decompiled: com.discord.icons.IconUrlUtils.m491getForGuildMember2tNb6hE(java.lang.String, com.discord.primitives.GuildId, com.discord.primitives.UserId, java.lang.Integer, boolean):java.lang.String");
    }

    
    public final String m492getForUser_fRzTXg(Context context, UserId userId, String str, Integer num, boolean z10, Integer num2) {
        Object obj;
        q.h(context, "context");
        if (userId != null) {
            if (UserId.m658equalsimpl(UserId.m656constructorimpl(-1L), userId)) {
                if (str == null) {
                    return "";
                }
                return str;
