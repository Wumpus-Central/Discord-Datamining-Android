...
public final class IconUrlUtils {
    ...
    public static /* synthetic */ String m456getApplicationIconweIltyw$default(IconUrlUtils iconUrlUtils, ApplicationId applicationId, String str, int i10, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            i10 = 160;
        }
        return iconUrlUtils.m461getApplicationIconweIltyw(applicationId, str, i10);
    }
    ...
    public static /* synthetic */ String m457getForChannelJYSGpIY$default(IconUrlUtils iconUrlUtils, Context context, ChannelId channelId, String str, boolean z10, Integer num, int i10, Object obj) {
        if ((i10 & 16) != 0) {
            num = null;
        }
        return iconUrlUtils.m462getForChannelJYSGpIY(context, channelId, str, z10, num);
    }

    /* renamed from: getForGuild-14CJxO4$default  reason: not valid java name */
    public static /* synthetic */ String m458getForGuild14CJxO4$default(IconUrlUtils iconUrlUtils, GuildId guildId, String str, String str2, boolean z10, Integer num, int i10, Object obj) {
        String str3 = (i10 & 4) != 0 ? null : str2;
        if ((i10 & 8) != 0) {
            z10 = false;
        }
        return iconUrlUtils.m463getForGuild14CJxO4(guildId, str, str3, z10, (i10 & 16) != 0 ? null : num);
    }

    /* renamed from: getForGuildMember-2tNb6hE$default  reason: not valid java name */
    public static /* synthetic */ String m459getForGuildMember2tNb6hE$default(IconUrlUtils iconUrlUtils, String str, GuildId guildId, UserId userId, Integer num, boolean z10, int i10, Object obj) {
        if ((i10 & 8) != 0) {
            num = null;
        }
        if ((i10 & 16) != 0) {
        ...
        return iconUrlUtils.m464getForGuildMember2tNb6hE(str, guildId, userId, num, z10);
    }
    ...
    public final String m461getApplicationIconweIltyw(ApplicationId applicationId, String str, int i10) {
    ...
    public final String m462getForChannelJYSGpIY(Context context, ChannelId channelId, String str, boolean z10, Integer num) {
        boolean z11;
        Object obj;
        q.g(context, "context");
        if (channelId == null) {
    ...
    public final String m463getForGuild14CJxO4(GuildId guildId, String str, String str2, boolean z10, Integer num) {
        boolean z11;
        Object obj;
        if (str == null || str.length() == 0) {
            z11 = true;
    ...
    */
    public final java.lang.String m464getForGuildMember2tNb6hE(java.lang.String r9, com.discord.primitives.GuildId r10, com.discord.primitives.UserId r11, java.lang.Integer r12, boolean r13) {
        /*
            r8 = this;
            r0 = 0
            r1 = 1
        ...
        L_0x000e:
            ...
            long r2 = r10.m586unboximpl()
            boolean r2 = com.discord.primitives.GuildId.m583isValidimpl(r2)
        ...
        L_0x001f:
            ...
            long r2 = r11.m637unboximpl()
            boolean r2 = com.discord.primitives.UserId.m634isValidimpl(r2)
        ...
        L_0x0072:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.discord.icons.IconUrlUtils.m464getForGuildMember2tNb6hE(java.lang.String, com.discord.primitives.GuildId, com.discord.primitives.UserId, java.lang.Integer, boolean):java.lang.String");
    }

    /* renamed from: getForUser-_fRzTXg  reason: not valid java name */
    public final String m465getForUser_fRzTXg(Context context, UserId userId, String str, Integer num, boolean z10, Integer num2) {
        Object obj;
        q.g(context, "context");
        if (userId != null) {
            if (UserId.m631equalsimpl(UserId.m629constructorimpl(-1L), userId)) {
                if (str == null) {
                    return "";
                }
                return str;
