...
public class IconView extends FrameLayout {
    ...
    public static abstract class IconSize {
        ...
        public static final class Custom extends IconSize {
            ...
            public static  Custom copy$default(Custom custom, int i10, int i11, int i12, Object obj) {
                if ((i12 & 1) != 0) {
        ...
        public  IconSize(int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
            this(i10, i11);
        }
    ...
    public static  void setAssets$default(IconView iconView, IconSize iconSize, List list, int i10, Object obj) {
        if (obj == null) {
            if ((i10 & 1) != 0) {
