...
public abstract class DownloadState {
    ...
    public static final class Completed extends DownloadState {
        ...
        public static  Completed copy$default(Completed completed, File file, int i10, Object obj) {
            if ((i10 & 1) != 0) {
                file = completed.file;
            }
    ...
    public static final class Failure extends DownloadState {
        ...
        public static  Failure copy$default(Failure failure, Exception exc, int i10, Object obj) {
            if ((i10 & 1) != 0) {
    ...
    public  DownloadState(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
}
