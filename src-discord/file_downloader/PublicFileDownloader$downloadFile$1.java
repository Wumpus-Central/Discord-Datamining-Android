...
public final class PublicFileDownloader$downloadFile$1 extends k implements Function2<ProducerScope<? super DownloadState>, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends s implements Function0<Unit> {
        ...
        public final void invoke2() {
            PublicFileDownloader.onDownloadListeners.remove(Long.valueOf(this.$downloadId.f22106k));
            PublicFileDownloader.INSTANCE.onFileDownloaded(this.$$this$callbackFlow, this.$manager, this.$downloadId.f22106k, this.$fileName);
        }
    }
    ...
    public final Object invoke(ProducerScope<? super DownloadState> producerScope, Continuation<? super Unit> continuation) {
        return ((PublicFileDownloader$downloadFile$1) create(producerScope, continuation)).invokeSuspend(Unit.f22080a);
    }
