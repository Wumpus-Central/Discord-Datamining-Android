...
public final class ReactMarkerListener implements ReactMarker.MarkerListener {
    ...
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {f0.e(new w(ReactMarkerListener.class, "bundleStartedTimestamp", "getBundleStartedTimestamp()J", 0)), f0.e(new w(ReactMarkerListener.class, "bundleLoadedTimestamp", "getBundleLoadedTimestamp()J", 0)), f0.e(new w(ReactMarkerListener.class, "bundleParsedTimestamp", "getBundleParsedTimestamp()J", 0))};
