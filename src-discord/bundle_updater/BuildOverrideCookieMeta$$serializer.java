...
@Metadata(d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, d2 = {"com/discord/bundle_updater/BuildOverrideCookieMeta.$serializer", "Lwi/f0;", "Lcom/discord/bundle_updater/BuildOverrideCookieMeta;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "bundle_updater_release"}, k = 1, mv = {1, 8, 0})
...
public final class BuildOverrideCookieMeta$$serializer implements f0<BuildOverrideCookieMeta> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f29758a;
        return new KSerializer[]{a.u(a2Var), a.u(a2Var), a.u(new f(a2Var)), a.u(new f(a2Var)), a.u(h.f29800a), a.u(new r0(a2Var, m0.f29833a))};
    }
    ...
    public BuildOverrideCookieMeta deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj5 = b10.n(descriptor2, 4, h.f29800a, null);
            obj6 = b10.n(descriptor2, 5, new r0(a2Var, m0.f29833a), null);
            i10 = 63;
        } else {
            boolean z11 = true;
            int i12 = 0;
            ...
            while (z11) {
                ...
                switch (o10) {
                    case -1:
                        ...
                        i11 = 5;
                    case 0:
                        obj7 = b10.n(descriptor2, 0, a2.f29758a, obj7);
                        i12 |= 1;
                        c10 = c10;
                        z10 = z10;
                        i11 = 5;
                    case 1:
                        obj8 = b10.n(descriptor2, 1, a2.f29758a, obj8);
                        i12 |= 2;
                        c10 = c10;
                        z10 = true;
                    case 2:
                        obj9 = b10.n(descriptor2, 2, new f(a2.f29758a), obj9);
                        i12 |= 4;
                        c10 = 2;
                        z10 = true;
                    case 3:
                        obj = b10.n(descriptor2, 3, new f(a2.f29758a), obj);
                        i12 |= 8;
                        c10 = 2;
                        z10 = true;
                    case 4:
                        obj10 = b10.n(descriptor2, 4, h.f29800a, obj10);
                        i12 |= 16;
                        c10 = 2;
                        z10 = true;
                    case 5:
                        obj11 = b10.n(descriptor2, i11, new r0(a2.f29758a, m0.f29833a), obj11);
                        i12 |= 32;
                        c10 = 2;
                        z10 = true;
                    default:
