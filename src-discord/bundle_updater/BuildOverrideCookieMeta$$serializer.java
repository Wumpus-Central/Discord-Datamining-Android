...
public final class BuildOverrideCookieMeta$$serializer implements f0<BuildOverrideCookieMeta> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f29755a;
        return new KSerializer[]{a.u(a2Var), a.u(a2Var), a.u(new f(a2Var)), a.u(new f(a2Var)), a.u(h.f29797a), a.u(new r0(a2Var, m0.f29830a))};
    }
    ...
    public BuildOverrideCookieMeta deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj5 = b10.n(descriptor2, 4, h.f29797a, null);
            obj6 = b10.n(descriptor2, 5, new r0(a2Var, m0.f29830a), null);
            i10 = 63;
        } else {
            boolean z11 = true;
            int i12 = 0;
            ...
            while (z11) {
                ...
                switch (o10) {
                    ...
                    case 0:
                        ...
                        i11 = 5;
                    case 1:
                        obj8 = b10.n(descriptor2, 1, a2.f29755a, obj8);
                        i12 |= 2;
                        c10 = c10;
                        z10 = true;
                    case 2:
                        obj9 = b10.n(descriptor2, 2, new f(a2.f29755a), obj9);
                        i12 |= 4;
                        c10 = 2;
                        z10 = true;
                    case 3:
                        obj = b10.n(descriptor2, 3, new f(a2.f29755a), obj);
                        i12 |= 8;
                        c10 = 2;
                        z10 = true;
                    case 4:
                        obj10 = b10.n(descriptor2, 4, h.f29797a, obj10);
                        i12 |= 16;
                        c10 = 2;
                        z10 = true;
                    case 5:
                        obj11 = b10.n(descriptor2, i11, new r0(a2.f29755a, m0.f29830a), obj11);
                        i12 |= 32;
                        c10 = 2;
                        z10 = true;
                    default:
