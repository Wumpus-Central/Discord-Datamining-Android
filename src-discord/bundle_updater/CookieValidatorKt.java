...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\u001a\u0018\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001\u001a\u0012\u0010\b\u001a\u00020\u0007*\u00020\u00012\u0006\u0010\u0006\u001a\u00020\u0001¨\u0006\t"}, d2 = {"Landroid/webkit/CookieManager;", "", "url", "", "Lij/k;", "getCookiesForUrl", "version", "", "validateBuildOverrideCookie", "bundle_updater_release"}, k = 2, mv = {1, 8, 0})
...
public final class CookieValidatorKt {
    public static final List<k> getCookiesForUrl(CookieManager cookieManager, String url) {
        ...
        for (String str : z02) {
            k c10 = k.f17619n.c(HttpUrl.f24055l.d(url), str);
            if (c10 != null) {
                arrayList.add(c10);
            }
        }
    ...
    public static final boolean validateBuildOverrideCookie(String str, String version) {
        ...
        ByteString.a aVar = ByteString.f24217o;
        ...
        if (!(a10 == null || (B = a10.B()) == null)) {
            try {
                ...
                p10 = xf.j.p(0, arrayOrNull.length());
