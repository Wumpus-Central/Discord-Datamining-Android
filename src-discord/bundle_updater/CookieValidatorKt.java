...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\u001a\u0018\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001\u001a\u0012\u0010\b\u001a\u00020\u0007*\u00020\u00012\u0006\u0010\u0006\u001a\u00020\u0001¨\u0006\t"}, d2 = {"Landroid/webkit/CookieManager;", "", "url", "", "Llj/k;", "getCookiesForUrl", "version", "", "validateBuildOverrideCookie", "bundle_updater_release"}, k = 2, mv = {1, 8, 0})
    ...
    public static final boolean validateBuildOverrideCookie(String str, String version) {
        ...
        if (!(a10 == null || (C = a10.C()) == null)) {
            try {
                ...
                q10 = ag.j.q(0, arrayOrNull.length());
                if (!(q10 instanceof Collection) || !((Collection) q10).isEmpty()) {
                    Iterator<Integer> it = q10.iterator();
                    while (it.hasNext()) {
                        if (q.c(arrayOrNull.get(((p) it).nextInt()), version)) {
                            return true;
                        }
                    }
                }
