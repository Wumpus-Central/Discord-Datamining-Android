...
public final class BuildOverrideCookieMeta {
    ...
    public static final void write$Self(BuildOverrideCookieMeta self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.B(serialDesc, 0, a2.f29762a, self.expiresAt);
        }
        ...
        if (z11) {
            output.B(serialDesc, 1, a2.f29762a, self.releaseChannel);
        }
        ...
        if (z12) {
            output.B(serialDesc, 2, new wi.f(a2.f29762a), self.validForUserIds);
        }
        ...
        if (z13) {
            output.B(serialDesc, 3, new wi.f(a2.f29762a), self.allowedVersions);
        }
        ...
        if (z14) {
            output.B(serialDesc, 4, h.f29804a, self.allowLoggedOut);
        }
        if (output.z(serialDesc, 5) || self.experiments != null) {
            z15 = true;
        }
        if (z15) {
            output.B(serialDesc, 5, new r0(a2.f29762a, m0.f29837a), self.experiments);
        }
    }
