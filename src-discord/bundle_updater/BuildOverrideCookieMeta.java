...
public final class BuildOverrideCookieMeta {
    ...
    public static final void write$Self(BuildOverrideCookieMeta self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.E(serialDesc, 0, a2.f6238a, self.expiresAt);
        }
        ...
        if (z11) {
            output.E(serialDesc, 1, a2.f6238a, self.releaseChannel);
        }
        ...
        if (z12) {
            output.E(serialDesc, 2, new cj.f(a2.f6238a), self.validForUserIds);
        }
        ...
        if (z13) {
            output.E(serialDesc, 3, new cj.f(a2.f6238a), self.allowedVersions);
        }
        ...
        if (z14) {
            output.E(serialDesc, 4, h.f6280a, self.allowLoggedOut);
        }
        if (output.z(serialDesc, 5) || self.experiments != null) {
            z15 = true;
        }
        if (z15) {
            output.E(serialDesc, 5, new r0(a2.f6238a, m0.f6313a), self.experiments);
        }
    }
