...
public final class BundleDownloadedEvent implements ReactEvent {
    ...
    public  BundleDownloadedEvent(int i10, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  BundleDownloadedEvent copy$default(BundleDownloadedEvent bundleDownloadedEvent, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(BundleDownloadedEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.x(serialDesc, 0, self.versionRequired);
    }
