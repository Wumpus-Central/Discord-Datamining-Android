...
public final class AudioInputDeviceDescription {
    ...
    public static  AudioInputDeviceDescription copy$default(AudioInputDeviceDescription audioInputDeviceDescription, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.name, audioInputDeviceDescription.name) && q.c(this.guid, audioInputDeviceDescription.guid);
    }
