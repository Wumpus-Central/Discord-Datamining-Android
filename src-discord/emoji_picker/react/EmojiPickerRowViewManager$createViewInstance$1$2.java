...
public final class EmojiPickerRowViewManager$createViewInstance$1$2 extends s implements Function1<String, Unit> {
    ...
    public EmojiPickerRowViewManager$createViewInstance$1$2(EmojiPickerRowViewManager emojiPickerRowViewManager, EventDispatcher eventDispatcher, ThemedReactContext themedReactContext, EmojiPickerRowView emojiPickerRowView) {
        super(1);
