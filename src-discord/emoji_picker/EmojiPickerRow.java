...
public final class EmojiPickerRow {
    ...
    public static final class Emoji {
        ...
        public boolean equals(Object obj) {
            ...
            return q.b(this.f7130id, emoji.f7130id) && q.b(this.name, emoji.name) && q.b(this.url, emoji.url) && this.disabled == emoji.disabled;
        }
    ...
    public static  EmojiPickerRow copy$default(EmojiPickerRow emojiPickerRow, int i10, int i11, int i12, List list, int i13, Object obj) {
        if ((i13 & 1) != 0) {
