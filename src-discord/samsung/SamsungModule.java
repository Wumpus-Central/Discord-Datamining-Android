...
public final class SamsungModule extends ReactContextBaseJavaModule {
    ...
    */
    ...
    public final Uri handleSamsungCallback(Response response) {
        ...
        String query;
        String str2 = null;
        String t10 = Response.t(response, "Location", null, 2, null);
        if (t10 != null) {
            uri = Uri.parse(t10);
        } else {
            uri = null;
    ...
    */
    ...
    public final void finishSamsungAuthorization(String authCode, String str, String str2, Promise promise) {
        ...
        l.d(m.a((LifecycleOwner) currentActivity), null, null, new SamsungModule$finishSamsungAuthorization$1(str, this, str2, authCode, null), 3, null);
    }
