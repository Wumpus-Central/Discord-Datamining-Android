...
public final class NativeMapExtensionsKt {
    private static final Json json = l.b(null, NativeMapExtensionsKt$json$1.INSTANCE, 1, null);
    ...
    public static  boolean getBoolean$default(ReadableMap readableMap, String str, boolean z10, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            z10 = false;
        }
    ...
    public static final JSONObject toJson(ReadableMap readableMap) {
        ...
        q.g(keySetIterator, "keySetIterator()");
    ...
    public static final String toJsonString(ReadableMap readableMap) {
        ...
        q.g(jSONObject, "toJson().toString()");
        return jSONObject;
    }
    ...
    public static final  <T> T toKotlinObject(ReadableMap readableMap) {
        ...
        return (T) json2.b(j.d(a10, null), jsonString);
    }
    ...
    public static final Map<String, String> toStringMap(ReadableMap readableMap) {
        ...
        q.f(hashMap, "null cannot be cast to non-null type kotlin.collections.Map<kotlin.String, kotlin.String>");
        return hashMap;
    }
}
