...
public final class FriendFinderProvider {
    ...
    static  String asBase64BitmapString$default(FriendFinderProvider friendFinderProvider, Uri uri, Context context, int i10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            i10 = 100;
        }
