...
public final class ContactsDataEntry$$serializer implements f0<ContactsDataEntry> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f26246a;
        return new KSerializer[]{a2Var, a2Var, a2Var, new v1(kotlin.jvm.internal.f0.b(ContactName.class), ContactName$$serializer.INSTANCE), h.f26288a, new v1(kotlin.jvm.internal.f0.b(String.class), a2Var)};
    }
    ...
    public ContactsDataEntry deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj2 = c10.m(descriptor2, 5, new v1(kotlin.jvm.internal.f0.b(String.class), a2.f26246a), null);
            i10 = 63;
        } else {
            boolean z11 = true;
            int i12 = 0;
            ...
            while (z11) {
                ...
                switch (x10) {
                    ...
                    case 4:
                        ...
                        i11 = 2;
                    case 5:
                        obj4 = c10.m(descriptor2, 5, new v1(kotlin.jvm.internal.f0.b(String.class), a2.f26246a), obj4);
                        i12 |= 32;
                        c11 = 3;
                        i11 = 2;
                    default:
