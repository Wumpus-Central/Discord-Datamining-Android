...
public final class ContactsDataEntry {
    ...
    public  ContactsDataEntry(int i10, String str, String str2, String str3, ContactName[] contactNameArr, boolean z10, String[] strArr, SerializationConstructorMarker serializationConstructorMarker) {
        if (63 != (i10 & 63)) {
    ...
    public static  ContactsDataEntry copy$default(ContactsDataEntry contactsDataEntry, String str, String str2, String str3, ContactName[] contactNameArr, boolean z10, String[] strArr, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static  void getContactMethod$annotations() {
    }

    public static  void getContactMethodLabel$annotations() {
    }

    public static  void getContactMethodType$annotations() {
    }

    public static  void getContactNames$annotations() {
    }

    public static  void getDeviceContactIds$annotations() {
    }
    ...
    public static final void write$Self(ContactsDataEntry self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.contactMethod);
        output.y(serialDesc, 1, self.contactMethodLabel);
        output.y(serialDesc, 2, self.contactMethodType);
        output.i(serialDesc, 3, new v1(f0.b(ContactName.class), ContactName$$serializer.INSTANCE), self.contactNames);
        output.x(serialDesc, 4, self.hasImageData);
        output.i(serialDesc, 5, new v1(f0.b(String.class), a2.f6238a), self.deviceContactIds);
    }
