...
public final class ContactsDataEntry {
    ...
    public static final void write$Self(ContactsDataEntry self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 0, self.contactMethod);
        output.z(serialDesc, 1, self.contactMethodLabel);
        output.z(serialDesc, 2, self.contactMethodType);
        output.t(serialDesc, 3, new v1(f0.b(ContactName.class), ContactName$$serializer.INSTANCE), self.contactNames);
        output.y(serialDesc, 4, self.hasImageData);
        output.t(serialDesc, 5, new v1(f0.b(String.class), a2.f5917a), self.deviceContactIds);
    }
