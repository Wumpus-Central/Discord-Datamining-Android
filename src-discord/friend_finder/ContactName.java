...
public final class ContactName {
    ...
    public /* synthetic */ ContactName(int i10, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
    ...
    public static /* synthetic */ ContactName copy$default(ContactName contactName, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(ContactName self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        a2 a2Var = a2.f32924a;
        output.u(serialDesc, 0, a2Var, self.displayName);
        output.u(serialDesc, 1, a2Var, self.givenName);
        output.u(serialDesc, 2, a2Var, self.familyName);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.displayName, contactName.displayName) && q.b(this.givenName, contactName.givenName) && q.b(this.familyName, contactName.familyName);
    }
