...
public final class ApplicationId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<ApplicationId> {
        ...
        public /* bridge */ /* synthetic */ ApplicationId createFromParcel(Parcel parcel) {
            return ApplicationId.m550boximpl(m562createFromParcelUV2lyTI(parcel));
        }

        /* renamed from: createFromParcel-UV2lyTI  reason: not valid java name */
        public final long m562createFromParcelUV2lyTI(Parcel parcel) {
            q.g(parcel, "parcel");
            return ApplicationId.m551constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ ApplicationId m550boximpl(long j10) {
        return new ApplicationId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m551constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static int m552describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m553equalsimpl(long j10, Object obj) {
        return (obj instanceof ApplicationId) && j10 == ((ApplicationId) obj).m559unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m554equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m555hashCodeimpl(long j10) {
        return b.a(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m556isValidimpl(long j10) {
        return j10 > 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m557toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static void m558writeToParcelimpl(long j10, Parcel out, int i10) {
        q.g(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m552describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m553equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m555hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m556isValidimpl(this.snowflake);
    }

    public String toString() {
        return m557toStringimpl(this.snowflake);
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        m558writeToParcelimpl(this.snowflake, out, i10);
    }
}
