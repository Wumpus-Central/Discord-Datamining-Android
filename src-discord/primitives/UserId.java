...
public final class UserId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<UserId> {
        ...
        public /* bridge */ /* synthetic */ UserId createFromParcel(Parcel parcel) {
            return UserId.m626boximpl(m638createFromParcelPmcOV3I(parcel));
        }

        /* renamed from: createFromParcel-PmcOV3I  reason: not valid java name */
        public final long m638createFromParcelPmcOV3I(Parcel parcel) {
            q.g(parcel, "parcel");
            return UserId.m627constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ UserId m626boximpl(long j10) {
        return new UserId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m627constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static int m628describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m629equalsimpl(long j10, Object obj) {
        return (obj instanceof UserId) && j10 == ((UserId) obj).m635unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m630equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m631hashCodeimpl(long j10) {
        return b.a(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m632isValidimpl(long j10) {
        return j10 > 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m633toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static void m634writeToParcelimpl(long j10, Parcel out, int i10) {
        q.g(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m628describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m629equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m631hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m632isValidimpl(this.snowflake);
    }

    public String toString() {
        return m633toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m635unboximpl() {
        return this.snowflake;
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        m634writeToParcelimpl(this.snowflake, out, i10);
    }
}
