...
public final class UserId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<UserId> {
        ...
        public   UserId createFromParcel(Parcel parcel) {
            return UserId.m631boximpl(m643createFromParcelPmcOV3I(parcel));
        }

        
        public final long m643createFromParcelPmcOV3I(Parcel parcel) {
            q.h(parcel, "parcel");
            return UserId.m632constructorimpl(parcel.readLong());
        }
    ...
    public static final  UserId m631boximpl(long j10) {
        return new UserId(j10);
    }

    
    public static long m632constructorimpl(long j10) {
        return j10;
    }

    
    public static int m633describeContentsimpl(long j10) {
        return 0;
    }

    
    public static boolean m634equalsimpl(long j10, Object obj) {
        return (obj instanceof UserId) && j10 == ((UserId) obj).m640unboximpl();
    }

    
    public static final boolean m635equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }
    ...
    public static boolean m637isValidimpl(long j10) {
        return j10 > 0;
    }

    
    public static String m638toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    
    public static void m639writeToParcelimpl(long j10, Parcel out, int i10) {
        q.h(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m633describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m634equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m636hashCodeimpl(this.snowflake);
    }

    @Override 
    public boolean isValid() {
        return m637isValidimpl(this.snowflake);
    }

    public String toString() {
        return m638toStringimpl(this.snowflake);
    }

    
    public final  long m640unboximpl() {
        return this.snowflake;
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.h(out, "out");
        m639writeToParcelimpl(this.snowflake, out, i10);
    }
}
