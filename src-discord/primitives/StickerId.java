...
public final class StickerId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<StickerId> {
        ...
        public   StickerId createFromParcel(Parcel parcel) {
            return StickerId.m632boximpl(m644createFromParcelaEuejx8(parcel));
        }

        
        public final long m644createFromParcelaEuejx8(Parcel parcel) {
            q.h(parcel, "parcel");
            return StickerId.m633constructorimpl(parcel.readLong());
        }
    ...
    public static final  StickerId m632boximpl(long j10) {
        return new StickerId(j10);
    }

    
    public static long m633constructorimpl(long j10) {
        return j10;
    }

    
    public static int m634describeContentsimpl(long j10) {
        return 0;
    }

    
    public static boolean m635equalsimpl(long j10, Object obj) {
        return (obj instanceof StickerId) && j10 == ((StickerId) obj).m641unboximpl();
    }
    ...
    public static int m637hashCodeimpl(long j10) {
        return b.a(j10);
    }

    
    public static boolean m638isValidimpl(long j10) {
        return j10 > 0;
    }

    
    public static String m639toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    
    public static void m640writeToParcelimpl(long j10, Parcel out, int i10) {
        q.h(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m634describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m635equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m637hashCodeimpl(this.snowflake);
    }

    @Override 
    public boolean isValid() {
        return m638isValidimpl(this.snowflake);
    }

    public String toString() {
        return m639toStringimpl(this.snowflake);
    }

    
    public final  long m641unboximpl() {
        return this.snowflake;
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.h(out, "out");
        m640writeToParcelimpl(this.snowflake, out, i10);
    }
}
