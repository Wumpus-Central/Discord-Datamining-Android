...
public final class StickerId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<StickerId> {
        ...
        public /* bridge */ /* synthetic */ StickerId createFromParcel(Parcel parcel) {
            return StickerId.m597boximpl(m609createFromParcelaEuejx8(parcel));
        }

        /* renamed from: createFromParcel-aEuejx8  reason: not valid java name */
        public final long m609createFromParcelaEuejx8(Parcel parcel) {
            q.g(parcel, "parcel");
            return StickerId.m598constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ StickerId m597boximpl(long j10) {
    ...
    public static boolean m600equalsimpl(long j10, Object obj) {
        return (obj instanceof StickerId) && j10 == ((StickerId) obj).m606unboximpl();
    }
