...
public final class RoleId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<RoleId> {
        ...
        public /* bridge */ /* synthetic */ RoleId createFromParcel(Parcel parcel) {
            return RoleId.m575boximpl(m587createFromParcelK4NZIAs(parcel));
        }

        /* renamed from: createFromParcel-K4NZIAs  reason: not valid java name */
        public final long m587createFromParcelK4NZIAs(Parcel parcel) {
            q.g(parcel, "parcel");
            return RoleId.m576constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ RoleId m575boximpl(long j10) {
    ...
    public static boolean m578equalsimpl(long j10, Object obj) {
        return (obj instanceof RoleId) && j10 == ((RoleId) obj).m584unboximpl();
    }
