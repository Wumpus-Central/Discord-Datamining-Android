...
public final class RoleId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<RoleId> {
        ...
        public /* bridge */ /* synthetic */ RoleId createFromParcel(Parcel parcel) {
            return RoleId.m600boximpl(m612createFromParcelK4NZIAs(parcel));
        }

        /* renamed from: createFromParcel-K4NZIAs  reason: not valid java name */
        public final long m612createFromParcelK4NZIAs(Parcel parcel) {
            q.g(parcel, "parcel");
            return RoleId.m601constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ RoleId m600boximpl(long j10) {
        return new RoleId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m601constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static int m602describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m603equalsimpl(long j10, Object obj) {
        return (obj instanceof RoleId) && j10 == ((RoleId) obj).m609unboximpl();
    }
    ...
    public static int m605hashCodeimpl(long j10) {
        return b.a(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m606isValidimpl(long j10) {
        return j10 > 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m607toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static void m608writeToParcelimpl(long j10, Parcel out, int i10) {
        q.g(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m602describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m603equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m605hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m606isValidimpl(this.snowflake);
    }

    public String toString() {
        return m607toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m609unboximpl() {
        return this.snowflake;
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        m608writeToParcelimpl(this.snowflake, out, i10);
    }
}
