...
public final class ChannelId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<ChannelId> {
        ...
        public /* bridge */ /* synthetic */ ChannelId createFromParcel(Parcel parcel) {
            return ChannelId.m562boximpl(m574createFromParcel18flms(parcel));
        }

        /* renamed from: createFromParcel-18-flms  reason: not valid java name */
        public final long m574createFromParcel18flms(Parcel parcel) {
            q.g(parcel, "parcel");
            return ChannelId.m563constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ ChannelId m562boximpl(long j10) {
    ...
    public static int m564describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m565equalsimpl(long j10, Object obj) {
        return (obj instanceof ChannelId) && j10 == ((ChannelId) obj).m571unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m566equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }
    ...
    public static boolean m568isValidimpl(long j10) {
        return j10 > 0;
    }
    ...
    public static void m570writeToParcelimpl(long j10, Parcel out, int i10) {
        q.g(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m564describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m565equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m567hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m568isValidimpl(this.snowflake);
    }

    public String toString() {
        return m569toStringimpl(this.snowflake);
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        m570writeToParcelimpl(this.snowflake, out, i10);
    }
}
