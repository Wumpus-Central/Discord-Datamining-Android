...
public final class GuildId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<GuildId> {
        ...
        public /* bridge */ /* synthetic */ GuildId createFromParcel(Parcel parcel) {
            return GuildId.m575boximpl(m587createFromParcelhCFrBxw(parcel));
        }

        /* renamed from: createFromParcel-hCFrBxw  reason: not valid java name */
        public final long m587createFromParcelhCFrBxw(Parcel parcel) {
            q.g(parcel, "parcel");
            return GuildId.m576constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ GuildId m575boximpl(long j10) {
        return new GuildId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m576constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static int m577describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m578equalsimpl(long j10, Object obj) {
        return (obj instanceof GuildId) && j10 == ((GuildId) obj).m584unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m579equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m580hashCodeimpl(long j10) {
        return b.a(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m581isValidimpl(long j10) {
        return j10 > 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m582toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static void m583writeToParcelimpl(long j10, Parcel out, int i10) {
        q.g(out, "out");
        out.writeLong(j10);
    }
    ...
    public int describeContents() {
        return m577describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m578equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m580hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m581isValidimpl(this.snowflake);
    }

    public String toString() {
        return m582toStringimpl(this.snowflake);
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        m583writeToParcelimpl(this.snowflake, out, i10);
    }
}
