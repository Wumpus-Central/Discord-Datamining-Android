...
public final class MessageId implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<MessageId> {
        ...
        public   MessageId createFromParcel(Parcel parcel) {
            return MessageId.m631boximpl(m642createFromParcelMpY7Jxs(parcel));
        }

        
        public final String m642createFromParcelMpY7Jxs(Parcel parcel) {
            q.h(parcel, "parcel");
            return MessageId.m632constructorimpl(parcel.readString());
        }
    ...
    public static final  MessageId m631boximpl(String str) {
    ...
    public static int m633describeContentsimpl(String str) {
        return 0;
    }

    
    public static boolean m634equalsimpl(String str, Object obj) {
        return (obj instanceof MessageId) && q.c(str, ((MessageId) obj).m639unboximpl());
    }

    
    public static final boolean m635equalsimpl0(String str, String str2) {
        return q.c(str, str2);
    }

    
    public static int m636hashCodeimpl(String str) {
        return str.hashCode();
    }

    
    public static String m637toStringimpl(String str) {
        return str;
    }

    
    public static void m638writeToParcelimpl(String str, Parcel out, int i10) {
        q.h(out, "out");
        out.writeString(str);
    }
    ...
    public int describeContents() {
        return m633describeContentsimpl(this.value);
    }
    ...
    public int hashCode() {
        return m636hashCodeimpl(this.value);
    }
    ...
    public final  String m639unboximpl() {
        return this.value;
    }
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.h(out, "out");
        m638writeToParcelimpl(this.value, out, i10);
    }
}
