...
public final class DiscordGestureHandlerEnabledRootView$Companion$initNestedScrollOnTouchListeners$2 extends s implements Function2<View, Function1<? super MotionEvent, ? extends Unit>, Unit> {
    public static final DiscordGestureHandlerEnabledRootView$Companion$initNestedScrollOnTouchListeners$2 INSTANCE = new DiscordGestureHandlerEnabledRootView$Companion$initNestedScrollOnTouchListeners$2();

    DiscordGestureHandlerEnabledRootView$Companion$initNestedScrollOnTouchListeners$2() {
        super(2);
    }
