...
public final class ActivityInviteEmbedView extends ConstraintLayout {
    ...
    private static abstract class ImageConfig {
        ...
        public static final class End extends ImageConfig {
            ...
            public static /* synthetic */ End copy$default(End end, String str, boolean z10, boolean z11, int i10, Object obj) {
                if ((i10 & 1) != 0) {
                    str = end.uri;
                }
                if ((i10 & 2) != 0) {
    ...
    public /* synthetic */ ActivityInviteEmbedView(Context context, AttributeSet attributeSet, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    */
    ...
    public ActivityInviteEmbedView(Context context, AttributeSet attributeSet, int i10) {
        ...
        b10 = n.b(p.NONE, ActivityInviteEmbedView$grayscalePostprocessor$2.INSTANCE);
        this.grayscalePostprocessor$delegate = b10;
