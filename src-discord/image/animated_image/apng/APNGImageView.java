...
public abstract class APNGImageView extends FrameLayout {
    ...
    public static  void inflateApngView$default(APNGImageView aPNGImageView, boolean z10, int i10, Object obj) {
        if (obj == null) {
            if ((i10 & 1) != 0) {
                z10 = true;
            }
    ...
    public static  void recycleChild$default(APNGImageView aPNGImageView, View view, boolean z10, int i10, Object obj) {
        if (obj == null) {
            if ((i10 & 2) != 0) {
                z10 = true;
            }
    ...
    public static  void resetViews$default(APNGImageView aPNGImageView, View view, boolean z10, int i10, Object obj) {
        if (obj == null) {
            if ((i10 & 1) != 0) {
                view = null;
            }
