...
public final class APNGView$fetchAPNG$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((APNGView$fetchAPNG$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f22076a);
    }
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        /* loaded from: classes8.dex */
        public static final class C01141 extends k implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
            final /* synthetic */ APNGView.Config $config;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01141(APNGView aPNGView, ApngDrawable apngDrawable, APNGView.Config config, Continuation<? super C01141> continuation) {
                super(2, continuation);
                this.this$0 = aPNGView;
            ...
            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01141(this.this$0, this.$drawable, this.$config, continuation);
            }

            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
                return ((C01141) create(coroutineScope, continuation)).invokeSuspend(Unit.f22076a);
            }
        ...
        */
        public final java.lang.Object emit(com.discord.file_downloader.DownloadState r14, kotlin.coroutines.Continuation<? super kotlin.Unit> r15) {
            ...
            L_0x003d:
                ...
                jg.t.b(r15)     // Catch: Exception -> 0x0075
                goto L_0x00a6
            L_0x0045:
                jg.t.b(r15)
            ...
            L_0x008b:
                ...
                return r1
            L_0x00a3:
                kotlin.Unit r14 = kotlin.Unit.f22076a
                return r14
            L_0x00a6:
                kotlin.Unit r14 = kotlin.Unit.f22076a
                return r14
