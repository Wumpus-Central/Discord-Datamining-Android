...
public final class FrescoFetchDecodedImageKt {
    ...
    public static final void fetchDecodedImage(Context context, Uri uri, PostProcessor postProcessor, final Function1<? super Bitmap, Unit> onDecodedImage) {
        ...
        c.a().d(s10.A(basePostprocessor).a(), context).d(new b() { // from class: com.discord.image.fresco.FrescoFetchDecodedImageKt$fetchDecodedImage$2
            @Override // com.facebook.datasource.b
            protected void onFailureImpl(DataSource<CloseableReference<v5.c>> dataSource) {
    ...
    public static final Object fetchDecodedImage(Context context, Uri uri, PostProcessor postProcessor, final boolean z10, Continuation<? super Bitmap> continuation) {
        ...
        if (uri == null) {
            ...
            DataSource<CloseableReference<v5.c>> d11 = c.a().d(s10.A(basePostprocessor).a(), context);
            d11.d(new b() { // from class: com.discord.image.fresco.FrescoFetchDecodedImageKt$fetchDecodedImage$6$subscriber$1
                @Override // com.facebook.datasource.b
                protected void onFailureImpl(DataSource<CloseableReference<v5.c>> dataSource) {
                    q.g(dataSource, "dataSource");
                    pVar.resumeWith(s.b(null));
            ...
            pVar.k(new FrescoFetchDecodedImageKt$fetchDecodedImage$6$1(d11));
        }
        Object y10 = pVar.y();
        d10 = d.d();
        if (y10 == d10) {
