...
public final class FrescoConfigKt {
    public static final ImagePipelineConfig frescoConfig(Context context) {
        ...
        ImagePipelineConfig.Builder P = M.P(new ReactOkHttpNetworkFetcher(B.b(new Interceptor() { // from class: com.discord.image.fresco.config.FrescoConfigKt$frescoConfig$$inlined$-addNetworkInterceptor$1
        ...
        x.b n10 = x.n();
        z a10 = l.a();
        ImagePipelineConfig K = P.Q(new y(n10.n(new z(a10.f29477b, a10.f29476a * 2, a10.f29478c)).m())).N(true).L().t(true).K();
