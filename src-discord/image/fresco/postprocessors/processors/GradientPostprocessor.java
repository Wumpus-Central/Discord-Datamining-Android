...
public final class GradientPostprocessor extends BasePostprocessor {
    ...
    public static final class Companion {
        ...
        private static final class Point {
            ...
            private final float f7131x;

            
            private final float f7132y;
            ...
            public boolean equals(Object obj) {
                ...
                return Float.compare(this.f7131x, point.f7131x) == 0 && Float.compare(this.f7132y, point.f7132y) == 0;
            }
            ...
            public int hashCode() {
                return (Float.floatToIntBits(this.f7131x) * 31) + Float.floatToIntBits(this.f7132y);
            }

            public String toString() {
                float f10 = this.f7131x;
                float f11 = this.f7132y;
