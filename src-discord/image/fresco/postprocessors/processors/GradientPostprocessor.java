...
public final class GradientPostprocessor extends BasePostprocessor {
    ...
    public static final class Companion {
        ...
        private static final class Point {
            ...
            private final float f7865x;

            /* renamed from: y  reason: collision with root package name */
            private final float f7866y;
            ...
            public boolean equals(Object obj) {
                ...
                return Float.compare(this.f7865x, point.f7865x) == 0 && Float.compare(this.f7866y, point.f7866y) == 0;
            }
            ...
            public int hashCode() {
                return (Float.floatToIntBits(this.f7865x) * 31) + Float.floatToIntBits(this.f7866y);
            }

            public String toString() {
                float f10 = this.f7865x;
                float f11 = this.f7866y;
