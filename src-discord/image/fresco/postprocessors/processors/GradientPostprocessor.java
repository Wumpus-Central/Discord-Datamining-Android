...
public final class GradientPostprocessor extends BasePostprocessor {
    ...
    public static final class Companion {
        ...
        private static final class Point {
            ...
            private final float f7503x;

            
            private final float f7504y;
            ...
            public boolean equals(Object obj) {
                ...
                return Float.compare(this.f7503x, point.f7503x) == 0 && Float.compare(this.f7504y, point.f7504y) == 0;
            }
            ...
            public int hashCode() {
                return (Float.floatToIntBits(this.f7503x) * 31) + Float.floatToIntBits(this.f7504y);
            }

            public String toString() {
                float f10 = this.f7503x;
                float f11 = this.f7504y;
