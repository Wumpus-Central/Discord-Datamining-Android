...
public final class GradientPostprocessor extends BasePostprocessor {
    ...
    public static final class Companion {
        ...
        private static final class Point {
            ...
            private final float f7867x;

            /* renamed from: y  reason: collision with root package name */
            private final float f7868y;
            ...
            public boolean equals(Object obj) {
                ...
                return Float.compare(this.f7867x, point.f7867x) == 0 && Float.compare(this.f7868y, point.f7868y) == 0;
            }
            ...
            public int hashCode() {
                return (Float.floatToIntBits(this.f7867x) * 31) + Float.floatToIntBits(this.f7868y);
            }

            public String toString() {
                float f10 = this.f7867x;
                float f11 = this.f7868y;
