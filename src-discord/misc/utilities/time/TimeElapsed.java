...
public final class TimeElapsed {
    ...
    public TimeElapsed(long j10) {
        ...
        Lazy a11;
        this.startTime = j10;
        a10 = n.a(new TimeElapsed$durationMillis$2(this));
        this.durationMillis$delegate = a10;
        a11 = n.a(new TimeElapsed$duration$2(this));
        this.duration$delegate = a11;
    }
    ...
    public static  TimeElapsed copy$default(TimeElapsed timeElapsed, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public  TimeElapsed(long j10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
