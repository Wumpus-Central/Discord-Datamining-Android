...
public final class ViewBackgroundUtilsKt {
    ...
    public static  void setBackgroundOval$default(View view, int i10, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = 0;
        }
    ...
    public static  void setBackgroundRectangle$default(View view, int i10, int i11, Integer num, int i12, int i13, Object obj) {
        if ((i13 & 4) != 0) {
            num = null;
        }
        if ((i13 & 8) != 0) {
