...
public final class PendingIntentUtils {
    ...
    public static  int immutablePendingIntentFlag$default(PendingIntentUtils pendingIntentUtils, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            i10 = 134217728;
        }
    ...
    public static  int mutablePendingIntentFlag$default(PendingIntentUtils pendingIntentUtils, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            i10 = 134217728;
        }
