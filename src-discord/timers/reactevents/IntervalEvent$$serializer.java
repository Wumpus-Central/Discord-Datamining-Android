...
public final class IntervalEvent$$serializer implements f0<IntervalEvent> {
    ...
    public IntervalEvent deserialize(Decoder decoder) {
        ...
        c10.b(descriptor2);
        return new IntervalEvent(i11, i10, null);
    }
    ...
    public void serialize(Encoder encoder, IntervalEvent value) {
        ...
        IntervalEvent.write$Self(value, c10, descriptor2);
        c10.b(descriptor2);
    }
