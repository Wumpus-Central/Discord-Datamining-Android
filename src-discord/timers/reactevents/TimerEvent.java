...
public final class TimerEvent implements ReactEvent {
    ...
    public static final void write$Self(TimerEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 0, self.f7304id);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TimerEvent) && this.f7304id == ((TimerEvent) obj).f7304id;
    }
    ...
    public String toString() {
        int i10 = this.f7304id;
        return "TimerEvent(id=" + i10 + ")";
    }

    public  TimerEvent(int i10, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
