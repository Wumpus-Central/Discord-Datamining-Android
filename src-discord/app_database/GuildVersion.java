...
public final class GuildVersion {
    ...
    public static final void write$Self(GuildVersion self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.f6870id);
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f6870id, guildVersion.f6870id) && this.version == guildVersion.version;
    }
    ...
    public int hashCode() {
        return (this.f6870id.hashCode() * 31) + b.a(this.version);
    }

    public String toString() {
        String str = this.f6870id;
