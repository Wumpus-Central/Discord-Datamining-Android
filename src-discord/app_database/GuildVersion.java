...
public final class GuildVersion {
    ...
    public static final void write$Self(GuildVersion self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 0, self.f7239id);
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7239id, guildVersion.f7239id) && this.version == guildVersion.version;
    }
    ...
    public int hashCode() {
        return (this.f7239id.hashCode() * 31) + b.a(this.version);
    }
