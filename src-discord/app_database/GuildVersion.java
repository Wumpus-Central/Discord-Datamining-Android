...
public final class GuildVersion {
    ...
    public static final void write$Self(GuildVersion self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.f7185id);
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7185id, guildVersion.f7185id) && this.version == guildVersion.version;
    }
    ...
    public int hashCode() {
        return (this.f7185id.hashCode() * 31) + b.a(this.version);
    }
