...
public final class GuildVersion {
    ...
    public static final void write$Self(GuildVersion self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.x(serialDesc, 0, self.f7194id);
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7194id, guildVersion.f7194id) && this.version == guildVersion.version;
    }
    ...
    public int hashCode() {
        return (this.f7194id.hashCode() * 31) + b.a(this.version);
    }

    public String toString() {
        String str = this.f7194id;
