...
public final class GuildVersion {
    ...
    public static final void write$Self(GuildVersion self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.s(serialDesc, 0, self.f7053id);
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7053id, guildVersion.f7053id) && this.version == guildVersion.version;
    }
    ...
    public int hashCode() {
        return (this.f7053id.hashCode() * 31) + b.a(this.version);
    }

    public String toString() {
        String str = this.f7053id;
