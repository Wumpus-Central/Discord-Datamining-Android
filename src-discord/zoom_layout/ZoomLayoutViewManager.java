...
public final class ZoomLayoutViewManager extends ViewGroupManager<ZoomLayoutFixed> implements DCDZoomLayoutAndroidManagerInterface<ZoomLayoutFixed> {
    ...
    public ZoomLayoutFixed createViewInstance(final ThemedReactContext reactContext) {
        ...
        ref$ObjectRef.f20744k = UIManagerHelper.getEventDispatcherForReactTag(reactContext, zoomLayoutFixed.getId());
        ...
        zoomLayoutFixed.getEngine().l(new ZoomEngine.c() { // from class: com.discord.zoom_layout.ZoomLayoutViewManager$createViewInstance$1$1
            ...
            public void onUpdate(ZoomEngine engine, Matrix matrix) {
                q.g(engine, "engine");
                q.g(matrix, "matrix");
                ZoomLayoutViewManager.this.getReactEvents$zoom_layout_release().emitEvent(ref$ObjectRef.f20744k, reactContext, zoomLayoutFixed, new OnZoomChangedEvent(zoomLayoutFixed.getZoom()));
            }
        });
