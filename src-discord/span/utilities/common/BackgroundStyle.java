...
public final class BackgroundStyle {
    ...
    public static  BackgroundStyle copy$default(BackgroundStyle backgroundStyle, int i10, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
    ...
    public static final void write$Self(BackgroundStyle self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 0, self.backgroundColor);
        output.w(serialDesc, 1, self.cornerRadius);
    }
    ...
    public  BackgroundStyle(int i10, int i11, int i12, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
