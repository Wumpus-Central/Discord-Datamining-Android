...
public final class ClickableSpan extends android.text.style.ClickableSpan implements NestedClickableSpan {
    ...
    public  ClickableSpan(NestedClickableSpan.TouchPriority touchPriority, Integer num, Function1 function1, Function1 function12, int i10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static  ClickableSpan copy$default(ClickableSpan clickableSpan, NestedClickableSpan.TouchPriority touchPriority, Integer num, Function1 function1, Function1 function12, int i10, Object obj) {
        if ((i10 & 1) != 0) {
