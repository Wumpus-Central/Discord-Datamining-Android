...
public final class TapMentionData implements ReactEvent {
    ...
    public /* synthetic */ TapMentionData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static /* synthetic */ TapMentionData copy$default(TapMentionData tapMentionData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapMentionData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 0, self.userId);
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.userId, tapMentionData.userId) && q.b(this.channelId, tapMentionData.channelId);
    }
