...
public final class LongPressAvatarData implements ReactEvent {
    ...
    public  LongPressAvatarData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  LongPressAvatarData copy$default(LongPressAvatarData longPressAvatarData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.messageId, longPressAvatarData.messageId) && q.c(this.userId, longPressAvatarData.userId);
    }
