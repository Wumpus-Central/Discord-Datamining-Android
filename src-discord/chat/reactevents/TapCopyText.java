...
public final class TapCopyText implements ReactEvent {
    ...
    public  TapCopyText(int i10, CharSequence charSequence, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  TapCopyText copy$default(TapCopyText tapCopyText, CharSequence charSequence, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapCopyText self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, new c(f0.b(CharSequence.class), new Annotation[0]), self.text);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapCopyText) && q.c(this.text, ((TapCopyText) obj).text);
    }
