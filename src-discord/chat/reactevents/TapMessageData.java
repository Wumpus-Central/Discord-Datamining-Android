...
public final class TapMessageData implements ReactEvent {
    ...
    public  TapMessageData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  TapMessageData copy$default(TapMessageData tapMessageData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.messageId, tapMessageData.messageId) && q.c(this.channelId, tapMessageData.channelId);
    }
