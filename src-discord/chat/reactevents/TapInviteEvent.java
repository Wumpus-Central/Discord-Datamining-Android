...
public final class TapInviteEvent implements ReactEvent {
    ...
    public static final void write$Self(TapInviteEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 1, self.index);
        h hVar = h.f26275a;
        output.z(serialDesc, 2, hVar, self.primary);
        output.z(serialDesc, 3, hVar, self.secondary);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.messageId, tapInviteEvent.messageId) && this.index == tapInviteEvent.index && q.b(this.primary, tapInviteEvent.primary) && q.b(this.secondary, tapInviteEvent.secondary);
    }
