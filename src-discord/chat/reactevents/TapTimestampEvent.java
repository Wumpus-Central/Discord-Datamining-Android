...
public final class TapTimestampEvent implements ReactEvent {
    ...
    public /* synthetic */ TapTimestampEvent(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
            n1.b(i10, 1, TapTimestampEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.timestamp = str;
    }

    public static /* synthetic */ TapTimestampEvent copy$default(TapTimestampEvent tapTimestampEvent, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapTimestampEvent) && q.b(this.timestamp, ((TapTimestampEvent) obj).timestamp);
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(x.a("node", NativeMapExtensionsKt.nativeMapOf(x.a("full", this.timestamp))));
    }
