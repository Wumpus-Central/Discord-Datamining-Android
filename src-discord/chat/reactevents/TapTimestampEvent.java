...
public final class TapTimestampEvent implements ReactEvent {
    ...
    public  TapTimestampEvent(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  TapTimestampEvent copy$default(TapTimestampEvent tapTimestampEvent, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapTimestampEvent) && q.c(this.timestamp, ((TapTimestampEvent) obj).timestamp);
    }
