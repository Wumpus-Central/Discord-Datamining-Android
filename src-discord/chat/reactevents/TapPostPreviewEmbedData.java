...
public final class TapPostPreviewEmbedData implements ReactEvent {
    ...
    public static  TapPostPreviewEmbedData m399copywInV0_I$default(TapPostPreviewEmbedData tapPostPreviewEmbedData, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapPostPreviewEmbedData.m401copywInV0_I(str, str2, str3, str4);
    }
    ...
    public static final void write$Self(TapPostPreviewEmbedData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 3, MessageId$$serializer.INSTANCE, MessageId.m593boximpl(self.messageId));
    }
    ...
    public final String m400component43Eiw7ao() {
        return this.messageId;
    }

    
    public final TapPostPreviewEmbedData m401copywInV0_I(String guildId, String parentChannelId, String threadId, String messageId) {
        q.h(guildId, "guildId");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.guildId, tapPostPreviewEmbedData.guildId) && q.c(this.parentChannelId, tapPostPreviewEmbedData.parentChannelId) && q.c(this.threadId, tapPostPreviewEmbedData.threadId) && MessageId.m597equalsimpl0(this.messageId, tapPostPreviewEmbedData.messageId);
    }
    ...
    public int hashCode() {
        return (((((this.guildId.hashCode() * 31) + this.parentChannelId.hashCode()) * 31) + this.threadId.hashCode()) * 31) + MessageId.m598hashCodeimpl(this.messageId);
    }
    ...
    public String toString() {
        ...
        String str4 = MessageId.m599toStringimpl(this.messageId);
