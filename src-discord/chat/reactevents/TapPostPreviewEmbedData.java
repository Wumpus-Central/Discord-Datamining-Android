...
public final class TapPostPreviewEmbedData implements ReactEvent {
    ...
    public static /* synthetic */ TapPostPreviewEmbedData m378copywInV0_I$default(TapPostPreviewEmbedData tapPostPreviewEmbedData, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapPostPreviewEmbedData.m380copywInV0_I(str, str2, str3, str4);
    }
    ...
    public static final void write$Self(TapPostPreviewEmbedData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 3, MessageId$$serializer.INSTANCE, MessageId.m558boximpl(self.messageId));
    }
    ...
    public final String m379component43Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: copy-wInV0_I  reason: not valid java name */
    public final TapPostPreviewEmbedData m380copywInV0_I(String guildId, String parentChannelId, String threadId, String messageId) {
        q.g(guildId, "guildId");
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.guildId, tapPostPreviewEmbedData.guildId) && q.b(this.parentChannelId, tapPostPreviewEmbedData.parentChannelId) && q.b(this.threadId, tapPostPreviewEmbedData.threadId) && MessageId.m562equalsimpl0(this.messageId, tapPostPreviewEmbedData.messageId);
    }
    ...
    public int hashCode() {
        return (((((this.guildId.hashCode() * 31) + this.parentChannelId.hashCode()) * 31) + this.threadId.hashCode()) * 31) + MessageId.m563hashCodeimpl(this.messageId);
    }
    ...
    public String toString() {
        ...
        String str4 = MessageId.m564toStringimpl(this.messageId);
