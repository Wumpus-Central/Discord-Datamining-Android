...
public final class TapCallData implements ReactEvent {
    ...
    public static  TapCallData m412copypfaIj0E$default(TapCallData tapCallData, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapCallData.m415copypfaIj0E(str, j10);
    }
    ...
    public final long m414component2o4g7jtM() {
        return this.channelId;
    }

    
    public final TapCallData m415copypfaIj0E(String messageId, long j10) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m640equalsimpl0(this.messageId, tapCallData.messageId) && ChannelId.m614equalsimpl0(this.channelId, tapCallData.channelId);
    }

    
    public final long m416getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public int hashCode() {
        return (MessageId.m641hashCodeimpl(this.messageId) * 31) + ChannelId.m615hashCodeimpl(this.channelId);
    }

    @Override 
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(x.a("data", NativeMapExtensionsKt.nativeMapOf(x.a("messageId", MessageId.m642toStringimpl(this.messageId)), x.a("channelId", ChannelId.m617toStringimpl(this.channelId)))));
    }
