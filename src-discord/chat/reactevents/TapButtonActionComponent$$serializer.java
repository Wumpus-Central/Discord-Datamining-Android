...
public final class TapButtonActionComponent$$serializer implements f0<TapButtonActionComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MessageId$$serializer.INSTANCE, x.f30689a, a.u(a2.f30568a), ApplicationId$$serializer.INSTANCE, f.f21956c};
    }
    ...
    public TapButtonActionComponent deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj2 = b10.y(descriptor2, 4, f.f21956c, null);
            i10 = 31;
        } else {
            double d11 = 0.0d;
            boolean z10 = true;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj7 = b10.y(descriptor2, 4, f.f21956c, obj7);
                    i11 |= 16;
                } else {
                    throw new n(o10);
                }
