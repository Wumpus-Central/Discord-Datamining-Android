...
public final class TapButtonActionComponent$$serializer implements f0<TapButtonActionComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MessageId$$serializer.INSTANCE, x.f32430a, a.u(a2.f32309a), ApplicationId$$serializer.INSTANCE, f.f22570c};
    }
    ...
    public TapButtonActionComponent deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj2 = b10.y(descriptor2, 4, f.f22570c, null);
            i10 = 31;
        } else {
            double d11 = 0.0d;
            boolean z10 = true;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj7 = b10.y(descriptor2, 4, f.f22570c, obj7);
                    i11 |= 16;
                } else {
                    throw new n(o10);
                }
