...
public final class TapButtonActionComponent$$serializer implements f0<TapButtonActionComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MessageId$$serializer.INSTANCE, x.f29671a, a.u(a2.f29550a), ApplicationId$$serializer.INSTANCE, f.f21532c};
    }
    ...
    public TapButtonActionComponent deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj2 = c10.m(descriptor2, 4, f.f21532c, null);
            i10 = 31;
        } else {
            double d11 = 0.0d;
            boolean z10 = true;
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj7 = c10.m(descriptor2, 4, f.f21532c, obj7);
                    i11 |= 16;
                } else {
                    throw new n(x10);
                }
        ...
        return new TapButtonActionComponent(i10, messageId != null ? messageId.m613unboximpl() : null, d10, (String) obj, (ApplicationId) obj3, (int[]) obj2, null, null);
    }
