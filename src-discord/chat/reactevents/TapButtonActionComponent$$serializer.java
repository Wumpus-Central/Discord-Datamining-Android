...
public final class TapButtonActionComponent$$serializer implements f0<TapButtonActionComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MessageId$$serializer.INSTANCE, x.f29885a, a.u(a2.f29764a), ApplicationId$$serializer.INSTANCE, f.f21735c};
    }
    ...
    public TapButtonActionComponent deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj = b10.n(descriptor2, 2, a2.f29764a, null);
            obj3 = b10.y(descriptor2, 3, ApplicationId$$serializer.INSTANCE, null);
            obj2 = b10.y(descriptor2, 4, f.f21735c, null);
            i10 = 31;
        } else {
            double d11 = 0.0d;
            boolean z10 = true;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj7 = b10.y(descriptor2, 4, f.f21735c, obj7);
                    i11 |= 16;
                } else {
                    throw new n(o10);
                }
        ...
        return new TapButtonActionComponent(i10, messageId != null ? messageId.m625unboximpl() : null, d10, (String) obj, (ApplicationId) obj3, (int[]) obj2, null, null);
    }
