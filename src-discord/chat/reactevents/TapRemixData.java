...
public final class TapRemixData implements ReactEvent {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Lcom/discord/chat/reactevents/TapRemixData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/reactevents/TapRemixData;", "chat_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final KSerializer<TapRemixData> serializer() {
            return TapRemixData$$serializer.INSTANCE;
        }
    }

    private TapRemixData(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
            n1.b(i10, 1, TapRemixData$$serializer.INSTANCE.getDescriptor());
        }
        this.messageId = str;
    }

    public  TapRemixData(int i10, String str, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, str, serializationConstructorMarker);
    }

    public  TapRemixData(String str, DefaultConstructorMarker defaultConstructorMarker) {
        this(str);
    }

    
    public static  TapRemixData m427copy1xi1bu0$default(TapRemixData tapRemixData, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = tapRemixData.messageId;
        }
        return tapRemixData.m429copy1xi1bu0(str);
    }
    ...
    public final TapRemixData m429copy1xi1bu0(String messageId) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapRemixData) && MessageId.m621equalsimpl0(this.messageId, ((TapRemixData) obj).messageId);
    }
    ...
    private TapRemixData(String str) {
        this.messageId = str;
    }
}
