...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo143onLongPressAvatarx5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m586toStringimpl(messageId), UserId.m625toStringimpl(j10)));
    }
    ...
    public void mo145onLongPressUsernamex5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m586toStringimpl(messageId), UserId.m625toStringimpl(j10)));
    }
    ...
    public void mo148onTapActivityLauncherEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityLauncherEmbedData(ApplicationId.m548toStringimpl(j10), ChannelId.m561toStringimpl(j11)));
    }
    ...
    public void mo149onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m586toStringimpl(messageId), ChannelId.m561toStringimpl(j10)));
    }
    ...
    public void mo150onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m586toStringimpl(messageId), ChannelId.m561toStringimpl(j10)));
    }
    ...
    public void mo151onTapAvatarx5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m586toStringimpl(messageId), UserId.m625toStringimpl(j10)));
    }
    ...
    public void mo155onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m586toStringimpl(messageId), ChannelId.m561toStringimpl(j10)));
    }
    ...
    public void mo156onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m586toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo160onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m561toStringimpl(j10), MessageId.m586toStringimpl(originId)));
    }
    ...
    public void mo161onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m574toStringimpl(j10), ChannelId.m561toStringimpl(j11), ChannelId.m561toStringimpl(j12), messageId, null));
    }
    ...
    public void mo163onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m586toStringimpl(messageId), ChannelId.m561toStringimpl(j10)));
    }
    ...
    public void mo166onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m561toStringimpl(j10), GuildId.m574toStringimpl(j11)));
    }
    ...
    public void mo167onTapTagEqy5D80(String messageId, long j10, String str) {
        q.g(messageId, "messageId");
    ...
    public void mo168onTapThreadEmbed1xi1bu0(String messageId) {
        q.g(messageId, "messageId");
    ...
    public void mo169onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m586toStringimpl(messageId)));
    }
    ...
    public void mo170onTapUsernamex5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m586toStringimpl(messageId), UserId.m625toStringimpl(j10)));
    }

    @Override // com.discord.chat.presentation.events.ChatEventHandler
    /* renamed from: onWelcomeReplyClicked-Ayv7vGE */
    public void mo171onWelcomeReplyClickedAyv7vGE(Sticker sticker, String messageId) {
        q.g(sticker, "sticker");
        q.g(messageId, "messageId");
    ...
    public void mo172voiceMessagePlaybackEndedHuwN0RY(String messageId, float f10, float f11, long j10, float f12) {
        q.g(messageId, "messageId");
    ...
    public void mo173voiceMessagePlaybackFailedntcYbpo(String messageId, String str) {
        q.g(messageId, "messageId");
    ...
    public void mo174voiceMessagePlaybackStartedOuNwOLg(String messageId, float f10, float f11, long j10) {
        q.g(messageId, "messageId");
