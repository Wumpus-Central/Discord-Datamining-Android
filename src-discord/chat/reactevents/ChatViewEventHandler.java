...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo160onLongPressAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m630toStringimpl(messageId), UserId.m669toStringimpl(j10)));
    }
    ...
    public void mo162onLongPressUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m630toStringimpl(messageId), UserId.m669toStringimpl(j10)));
    }
    ...
    public void mo165onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityBookmarkEmbedData(ApplicationId.m592toStringimpl(j10), ChannelId.m605toStringimpl(j11)));
    }
    ...
    public void mo166onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m630toStringimpl(messageId), ChannelId.m605toStringimpl(j10)));
    }
    ...
    public void mo167onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m630toStringimpl(messageId), ChannelId.m605toStringimpl(j10)));
    }
    ...
    public void mo168onTapAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m630toStringimpl(messageId), UserId.m669toStringimpl(j10)));
    }
    ...
    public void mo171onTapChannelPromptButtonEqy5D80(String messageId, long j10, String buttonType) {
        ...
        this.emitReactEvent.invoke(new TapChannelPromptButtonData(MessageId.m630toStringimpl(messageId), ChannelId.m605toStringimpl(j10), buttonType));
    }
    ...
    public void mo173onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m630toStringimpl(messageId), ChannelId.m605toStringimpl(j10)));
    }
    ...
    public void mo174onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m630toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo178onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m605toStringimpl(j10), MessageId.m630toStringimpl(originId)));
    }
    ...
    public void mo179onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m618toStringimpl(j10), ChannelId.m605toStringimpl(j11), ChannelId.m605toStringimpl(j12), messageId, null));
    }
    ...
    public void mo181onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m630toStringimpl(messageId), ChannelId.m605toStringimpl(j10)));
    }
    ...
    public void mo185onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m605toStringimpl(j10), GuildId.m618toStringimpl(j11)));
    }
    ...
    public void mo186onTapSummarysekaTiM(long j10, String messageId, String summaryId) {
        ...
        this.emitReactEvent.invoke(new TapSummaryData(ChannelId.m605toStringimpl(j10), MessageId.m630toStringimpl(messageId), summaryId));
    }
    ...
    public void mo187onTapSummaryJumpsekaTiM(long j10, String messageId, String summaryId) {
        q.h(messageId, "messageId");
        q.h(summaryId, "summaryId");
        this.emitReactEvent.invoke(new TapSummaryJumpData(ChannelId.m605toStringimpl(j10), MessageId.m630toStringimpl(messageId), summaryId));
    }
    ...
    public void mo190onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m630toStringimpl(messageId)));
    }
    ...
    public void mo191onTapUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m630toStringimpl(messageId), UserId.m669toStringimpl(j10)));
    }
