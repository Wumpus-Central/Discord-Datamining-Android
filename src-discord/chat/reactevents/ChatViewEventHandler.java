...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo151onLongPressAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m599toStringimpl(messageId), UserId.m638toStringimpl(j10)));
    }
    ...
    public void mo153onLongPressUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m599toStringimpl(messageId), UserId.m638toStringimpl(j10)));
    }
    ...
    public void mo156onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityBookmarkEmbedData(ApplicationId.m561toStringimpl(j10), ChannelId.m574toStringimpl(j11)));
    }
    ...
    public void mo157onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m599toStringimpl(messageId), ChannelId.m574toStringimpl(j10)));
    }
    ...
    public void mo158onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m599toStringimpl(messageId), ChannelId.m574toStringimpl(j10)));
    }
    ...
    public void mo159onTapAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m599toStringimpl(messageId), UserId.m638toStringimpl(j10)));
    }
    ...
    public void mo163onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m599toStringimpl(messageId), ChannelId.m574toStringimpl(j10)));
    }
    ...
    public void mo164onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m599toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo168onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m574toStringimpl(j10), MessageId.m599toStringimpl(originId)));
    }
    ...
    public void mo169onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m587toStringimpl(j10), ChannelId.m574toStringimpl(j11), ChannelId.m574toStringimpl(j12), messageId, null));
    }
    ...
    public void mo171onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m599toStringimpl(messageId), ChannelId.m574toStringimpl(j10)));
    }
    ...
    public void mo174onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m574toStringimpl(j10), GuildId.m587toStringimpl(j11)));
    }
    ...
    public void mo175onTapSummarysekaTiM(long j10, String messageId, String summaryId) {
        ...
        this.emitReactEvent.invoke(new TapSummaryData(ChannelId.m574toStringimpl(j10), MessageId.m599toStringimpl(messageId), summaryId));
    }

    @Override 
    
    public void mo176onTapSummaryJumpsekaTiM(long j10, String messageId, String summaryId) {
        q.h(messageId, "messageId");
        q.h(summaryId, "summaryId");
        this.emitReactEvent.invoke(new TapSummaryJumpData(ChannelId.m574toStringimpl(j10), MessageId.m599toStringimpl(messageId), summaryId));
    }
    ...
    public void mo177onTapTagEqy5D80(String messageId, long j10, String str) {
        q.h(messageId, "messageId");
    ...
    public void mo178onTapThreadEmbed1xi1bu0(String messageId) {
        q.h(messageId, "messageId");
    ...
    public void mo179onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m599toStringimpl(messageId)));
    }
    ...
    public void mo180onTapUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m599toStringimpl(messageId), UserId.m638toStringimpl(j10)));
    }

    @Override 
    
    public void mo181onWelcomeReplyClickedAyv7vGE(Sticker sticker, String messageId) {
        q.h(sticker, "sticker");
        q.h(messageId, "messageId");
    ...
    public void mo182voiceMessagePlaybackEndedHuwN0RY(String messageId, float f10, float f11, long j10, float f12) {
        q.h(messageId, "messageId");
    ...
    public void mo183voiceMessagePlaybackFailedntcYbpo(String messageId, String str) {
        q.h(messageId, "messageId");
    ...
    public void mo184voiceMessagePlaybackStartedOuNwOLg(String messageId, float f10, float f11, long j10) {
        q.h(messageId, "messageId");
