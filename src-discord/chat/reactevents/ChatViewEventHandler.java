...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo150onLongPressAvatarx5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m596toStringimpl(messageId), UserId.m635toStringimpl(j10)));
    }
    ...
    public void mo152onLongPressUsernamex5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m596toStringimpl(messageId), UserId.m635toStringimpl(j10)));
    }
    ...
    public void mo155onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityBookmarkEmbedData(ApplicationId.m558toStringimpl(j10), ChannelId.m571toStringimpl(j11)));
    }
    ...
    public void mo156onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m596toStringimpl(messageId), ChannelId.m571toStringimpl(j10)));
    }
    ...
    public void mo157onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m596toStringimpl(messageId), ChannelId.m571toStringimpl(j10)));
    }
    ...
    public void mo158onTapAvatarx5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m596toStringimpl(messageId), UserId.m635toStringimpl(j10)));
    }
    ...
    public void mo162onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m596toStringimpl(messageId), ChannelId.m571toStringimpl(j10)));
    }
    ...
    public void mo163onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m596toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo167onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m571toStringimpl(j10), MessageId.m596toStringimpl(originId)));
    }
    ...
    public void mo168onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m584toStringimpl(j10), ChannelId.m571toStringimpl(j11), ChannelId.m571toStringimpl(j12), messageId, null));
    }
    ...
    public void mo170onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m596toStringimpl(messageId), ChannelId.m571toStringimpl(j10)));
    }
    ...
    public void mo173onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m571toStringimpl(j10), GuildId.m584toStringimpl(j11)));
    }
    ...
    public void mo174onTapSummarysekaTiM(long j10, String messageId, String summaryId) {
        ...
        this.emitReactEvent.invoke(new TapSummaryData(ChannelId.m571toStringimpl(j10), MessageId.m596toStringimpl(messageId), summaryId));
    }
    ...
    public void mo177onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m596toStringimpl(messageId)));
    }
    ...
    public void mo178onTapUsernamex5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m596toStringimpl(messageId), UserId.m635toStringimpl(j10)));
    }
