...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo159onLongPressAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m623toStringimpl(messageId), UserId.m662toStringimpl(j10)));
    }
    ...
    public void mo161onLongPressUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m623toStringimpl(messageId), UserId.m662toStringimpl(j10)));
    }
    ...
    public void mo164onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityBookmarkEmbedData(ApplicationId.m585toStringimpl(j10), ChannelId.m598toStringimpl(j11)));
    }
    ...
    public void mo165onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m623toStringimpl(messageId), ChannelId.m598toStringimpl(j10)));
    }
    ...
    public void mo166onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m623toStringimpl(messageId), ChannelId.m598toStringimpl(j10)));
    }
    ...
    public void mo167onTapAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m623toStringimpl(messageId), UserId.m662toStringimpl(j10)));
    }
    ...
    public void mo170onTapChannelPromptButtonEqy5D80(String messageId, long j10, String buttonType) {
        ...
        this.emitReactEvent.invoke(new TapChannelPromptButtonData(MessageId.m623toStringimpl(messageId), ChannelId.m598toStringimpl(j10), buttonType));
    }
    ...
    public void mo172onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m623toStringimpl(messageId), ChannelId.m598toStringimpl(j10)));
    }
    ...
    public void mo173onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m623toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo177onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m598toStringimpl(j10), MessageId.m623toStringimpl(originId)));
    }
    ...
    public void mo178onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m611toStringimpl(j10), ChannelId.m598toStringimpl(j11), ChannelId.m598toStringimpl(j12), messageId, null));
    }
    ...
    public void mo180onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m623toStringimpl(messageId), ChannelId.m598toStringimpl(j10)));
    }
    ...
    public void mo184onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m598toStringimpl(j10), GuildId.m611toStringimpl(j11)));
    }
    ...
    public void mo185onTapSummarysekaTiM(long j10, String messageId, String summaryId) {
        ...
        this.emitReactEvent.invoke(new TapSummaryData(ChannelId.m598toStringimpl(j10), MessageId.m623toStringimpl(messageId), summaryId));
    }
    ...
    public void mo186onTapSummaryJumpsekaTiM(long j10, String messageId, String summaryId) {
        q.h(messageId, "messageId");
        q.h(summaryId, "summaryId");
        this.emitReactEvent.invoke(new TapSummaryJumpData(ChannelId.m598toStringimpl(j10), MessageId.m623toStringimpl(messageId), summaryId));
    }
    ...
    public void mo189onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m623toStringimpl(messageId)));
    }
    ...
    public void mo190onTapUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m623toStringimpl(messageId), UserId.m662toStringimpl(j10)));
    }
