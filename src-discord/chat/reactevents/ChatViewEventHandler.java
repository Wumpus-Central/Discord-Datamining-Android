...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo142onLongPressAvatarx5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m564toStringimpl(messageId), UserId.m603toStringimpl(j10)));
    }
    ...
    public void mo144onLongPressUsernamex5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m564toStringimpl(messageId), UserId.m603toStringimpl(j10)));
    }
    ...
    public void mo147onTapActivityLauncherEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityLauncherEmbedData(ApplicationId.m526toStringimpl(j10), ChannelId.m539toStringimpl(j11)));
    }
    ...
    public void mo148onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m564toStringimpl(messageId), ChannelId.m539toStringimpl(j10)));
    }
    ...
    public void mo149onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m564toStringimpl(messageId), ChannelId.m539toStringimpl(j10)));
    }
    ...
    public void mo150onTapAvatarx5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m564toStringimpl(messageId), UserId.m603toStringimpl(j10)));
    }
    ...
    public void mo153onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m564toStringimpl(messageId), ChannelId.m539toStringimpl(j10)));
    }
    ...
    public void mo154onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m564toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo158onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m539toStringimpl(j10), MessageId.m564toStringimpl(originId)));
    }
    ...
    public void mo159onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m552toStringimpl(j10), ChannelId.m539toStringimpl(j11), ChannelId.m539toStringimpl(j12), messageId, null));
    }
    ...
    public void mo161onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m564toStringimpl(messageId), ChannelId.m539toStringimpl(j10)));
    }
    ...
    public void mo164onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m539toStringimpl(j10), GuildId.m552toStringimpl(j11)));
    }
    ...
    public void mo166onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m564toStringimpl(messageId)));
    }
    ...
    public void mo167onTapUsernamex5gers8(String messageId, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m564toStringimpl(messageId), UserId.m603toStringimpl(j10)));
    }
    ...
    public void mo169voiceMessagePlaybackEndedOuNwOLg(String messageId, float f10, float f11, long j10) {
        q.g(messageId, "messageId");
        this.emitReactEvent.invoke(new VoiceMessagePlaybackEndedData(messageId, f10, f11, j10, null));
    }
