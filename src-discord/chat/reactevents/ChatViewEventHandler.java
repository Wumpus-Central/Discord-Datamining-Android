...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo162onLongPressAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m637toStringimpl(messageId), UserId.m676toStringimpl(j10)));
    }
    ...
    public void mo164onLongPressUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m637toStringimpl(messageId), UserId.m676toStringimpl(j10)));
    }
    ...
    public void mo167onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityBookmarkEmbedData(ApplicationId.m599toStringimpl(j10), ChannelId.m612toStringimpl(j11)));
    }
    ...
    public void mo168onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m637toStringimpl(messageId), ChannelId.m612toStringimpl(j10)));
    }
    ...
    public void mo169onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m637toStringimpl(messageId), ChannelId.m612toStringimpl(j10)));
    }
    ...
    public void mo170onTapAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m637toStringimpl(messageId), UserId.m676toStringimpl(j10)));
    }
    ...
    public void mo173onTapChannelPromptButtonEqy5D80(String messageId, long j10, String buttonType) {
        ...
        this.emitReactEvent.invoke(new TapChannelPromptButtonData(MessageId.m637toStringimpl(messageId), ChannelId.m612toStringimpl(j10), buttonType));
    }
    ...
    public void mo175onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m637toStringimpl(messageId), ChannelId.m612toStringimpl(j10)));
    }
    ...
    public void mo177onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m637toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo181onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m612toStringimpl(j10), MessageId.m637toStringimpl(originId)));
    }
    ...
    public void mo182onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m625toStringimpl(j10), ChannelId.m612toStringimpl(j11), ChannelId.m612toStringimpl(j12), messageId, null));
    }
    ...
    public void mo184onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m637toStringimpl(messageId), ChannelId.m612toStringimpl(j10)));
    }
    ...
    public void mo188onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m612toStringimpl(j10), GuildId.m625toStringimpl(j11)));
    }
    ...
    public void mo189onTapSummarysekaTiM(long j10, String messageId, String summaryId) {
        ...
        this.emitReactEvent.invoke(new TapSummaryData(ChannelId.m612toStringimpl(j10), MessageId.m637toStringimpl(messageId), summaryId));
    }
    ...
    public void mo190onTapSummaryJumpsekaTiM(long j10, String messageId, String summaryId) {
        q.h(messageId, "messageId");
        q.h(summaryId, "summaryId");
        this.emitReactEvent.invoke(new TapSummaryJumpData(ChannelId.m612toStringimpl(j10), MessageId.m637toStringimpl(messageId), summaryId));
    }
    ...
    public void mo193onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m637toStringimpl(messageId)));
    }
    ...
    public void mo194onTapUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m637toStringimpl(messageId), UserId.m676toStringimpl(j10)));
    }
