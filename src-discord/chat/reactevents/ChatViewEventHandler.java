...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo165onLongPressAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m649toStringimpl(messageId), UserId.m688toStringimpl(j10)));
    }
    ...
    public void mo167onLongPressUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m649toStringimpl(messageId), UserId.m688toStringimpl(j10)));
    }
    ...
    public void mo170onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11) {
        this.emitReactEvent.invoke(new TapActivityBookmarkEmbedData(ApplicationId.m611toStringimpl(j10), ChannelId.m624toStringimpl(j11)));
    }
    ...
    public void mo171onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m649toStringimpl(messageId), ChannelId.m624toStringimpl(j10)));
    }
    ...
    public void mo172onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m649toStringimpl(messageId), ChannelId.m624toStringimpl(j10)));
    }
    ...
    public void mo173onTapAvatarx5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m649toStringimpl(messageId), UserId.m688toStringimpl(j10)));
    }
    ...
    public void mo176onTapChannelPromptButtonEqy5D80(String messageId, long j10, String buttonType) {
        ...
        this.emitReactEvent.invoke(new TapChannelPromptButtonData(MessageId.m649toStringimpl(messageId), ChannelId.m624toStringimpl(j10), buttonType));
    }
    ...
    public void mo178onTapFollowForumPostpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m649toStringimpl(messageId), ChannelId.m624toStringimpl(j10)));
    }
    ...
    public void mo180onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
        ...
        this.emitReactEvent.invoke(new TapImageData(MessageId.m649toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num));
    }
    ...
    public void mo184onTapMessageReply0eiqbug(long j10, String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m624toStringimpl(j10), MessageId.m649toStringimpl(originId)));
    }
    ...
    public void mo185onTapObscuredMediaLearnMore8a0ehIg(String messageId, long j10, String str, String str2) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapObscuredMediaLearnMoreData(MessageId.m649toStringimpl(messageId), ChannelId.m624toStringimpl(j10), String.valueOf(str), String.valueOf(str2)));
    }
    ...
    public void mo186onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m637toStringimpl(j10), ChannelId.m624toStringimpl(j11), ChannelId.m624toStringimpl(j12), messageId, null));
    }
    ...
    public void mo188onTapReactionOverflowpfaIj0E(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m649toStringimpl(messageId), ChannelId.m624toStringimpl(j10)));
    }
    ...
    public void mo192onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m624toStringimpl(j10), GuildId.m637toStringimpl(j11)));
    }
    ...
    public void mo193onTapSummarysekaTiM(long j10, String messageId, String summaryId) {
        ...
        this.emitReactEvent.invoke(new TapSummaryData(ChannelId.m624toStringimpl(j10), MessageId.m649toStringimpl(messageId), summaryId));
    }
    ...
    public void mo194onTapSummaryJumpsekaTiM(long j10, String messageId, String summaryId) {
        q.h(messageId, "messageId");
        q.h(summaryId, "summaryId");
        this.emitReactEvent.invoke(new TapSummaryJumpData(ChannelId.m624toStringimpl(j10), MessageId.m649toStringimpl(messageId), summaryId));
    }
    ...
    public void mo197onTapToggleBlockedMessages1xi1bu0(String messageId) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m649toStringimpl(messageId)));
    }
    ...
    public void mo198onTapUsernamex5gers8(String messageId, long j10) {
        q.h(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m649toStringimpl(messageId), UserId.m688toStringimpl(j10)));
    }
