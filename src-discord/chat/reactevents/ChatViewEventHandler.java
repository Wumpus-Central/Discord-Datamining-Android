...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public void mo170voiceMessagePlaybackEndedOuNwOLg(String messageId, float f10, float f11, long j10) {
        q.g(messageId, "messageId");
