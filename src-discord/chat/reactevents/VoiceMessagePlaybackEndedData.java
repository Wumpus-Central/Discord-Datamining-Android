...
public final class VoiceMessagePlaybackEndedData implements ReactEvent {
    ...
    public static  VoiceMessagePlaybackEndedData m453copyHuwN0RY$default(VoiceMessagePlaybackEndedData voiceMessagePlaybackEndedData, String str, float f10, float f11, long j10, float f12, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return voiceMessagePlaybackEndedData.m456copyHuwN0RY(str, f10, f11, j10, f12);
    }
    ...
    public final VoiceMessagePlaybackEndedData m456copyHuwN0RY(String messageId, float f10, float f11, long j10, float f12) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m621equalsimpl0(this.messageId, voiceMessagePlaybackEndedData.messageId) && Float.compare(this.totalDurationSecs, voiceMessagePlaybackEndedData.totalDurationSecs) == 0 && Float.compare(this.endDurationSecs, voiceMessagePlaybackEndedData.endDurationSecs) == 0 && UserId.m659equalsimpl0(this.senderUserId, voiceMessagePlaybackEndedData.senderUserId) && Float.compare(this.durationListeningSecs, voiceMessagePlaybackEndedData.durationListeningSecs) == 0;
    }
    ...
    public int hashCode() {
        return (((((((MessageId.m622hashCodeimpl(this.messageId) * 31) + Float.floatToIntBits(this.totalDurationSecs)) * 31) + Float.floatToIntBits(this.endDurationSecs)) * 31) + UserId.m660hashCodeimpl(this.senderUserId)) * 31) + Float.floatToIntBits(this.durationListeningSecs);
    }
