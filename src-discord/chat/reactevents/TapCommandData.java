...
public final class TapCommandData implements ReactEvent {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Lcom/discord/chat/reactevents/TapCommandData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/reactevents/TapCommandData;", "chat_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public  TapCommandData(int i10, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i10 & 15)) {
            n1.b(i10, 15, TapCommandData$$serializer.INSTANCE.getDescriptor());
        }
        this.channelId = str;
        this.commandId = str2;
    ...
    public static  TapCommandData copy$default(TapCommandData tapCommandData, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public TapCommandData(CommandMentionContentNode node) {
        this(ChannelId.m612toStringimpl(node.m54getChannelIdo4g7jtM()), node.getCommandId(), node.getCommandName(), node.getCommandKey());
        q.h(node, "node");
    }
}
