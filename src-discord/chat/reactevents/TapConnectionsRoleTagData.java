...
public final class TapConnectionsRoleTagData implements ReactEvent {
    ...
    public  TapConnectionsRoleTagData(int i10, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i10 & 15)) {
    ...
    public static  TapConnectionsRoleTagData copy$default(TapConnectionsRoleTagData tapConnectionsRoleTagData, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapConnectionsRoleTagData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 3, self.roleId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.userId, tapConnectionsRoleTagData.userId) && q.c(this.guildId, tapConnectionsRoleTagData.guildId) && q.c(this.channelId, tapConnectionsRoleTagData.channelId) && q.c(this.roleId, tapConnectionsRoleTagData.roleId);
    }
