...
public final class TapSummaryData implements ReactEvent {
    ...
    public  TapSummaryData(int i10, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
    ...
    public static  TapSummaryData copy$default(TapSummaryData tapSummaryData, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapSummaryData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 1, self.messageId);
        output.y(serialDesc, 2, self.summaryId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.channelId, tapSummaryData.channelId) && q.c(this.messageId, tapSummaryData.messageId) && q.c(this.summaryId, tapSummaryData.summaryId);
    }
