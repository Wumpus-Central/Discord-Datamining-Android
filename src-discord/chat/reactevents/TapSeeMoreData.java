...
public final class TapSeeMoreData implements ReactEvent {
    ...
    public static  TapSeeMoreData m450copy1xi1bu0$default(TapSeeMoreData tapSeeMoreData, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = tapSeeMoreData.messageId;
        }
        return tapSeeMoreData.m452copy1xi1bu0(str);
    }
    ...
    public final TapSeeMoreData m452copy1xi1bu0(String messageId) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapSeeMoreData) && MessageId.m640equalsimpl0(this.messageId, ((TapSeeMoreData) obj).messageId);
    }

    
    public final String m453getMessageId3Eiw7ao() {
        return this.messageId;
    }
