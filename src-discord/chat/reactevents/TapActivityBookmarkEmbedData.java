...
public final class TapActivityBookmarkEmbedData implements ReactEvent {
    ...
    public /* synthetic */ TapActivityBookmarkEmbedData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static /* synthetic */ TapActivityBookmarkEmbedData copy$default(TapActivityBookmarkEmbedData tapActivityBookmarkEmbedData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapActivityBookmarkEmbedData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 0, self.applicationId);
