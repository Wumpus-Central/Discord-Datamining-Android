...
public final class LongPressCommandData implements ReactEvent {
    ...
    public /* synthetic */ LongPressCommandData(int i10, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i10 & 15)) {
    ...
    public static /* synthetic */ LongPressCommandData copy$default(LongPressCommandData longPressCommandData, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.channelId, longPressCommandData.channelId) && q.b(this.commandId, longPressCommandData.commandId) && q.b(this.commandName, longPressCommandData.commandName) && q.b(this.commandKey, longPressCommandData.commandKey);
    }
    ...
    public LongPressCommandData(CommandMentionContentNode node) {
        this(ChannelId.m544toStringimpl(node.m45getChannelIdo4g7jtM()), node.getCommandId(), node.getCommandName(), node.getCommandKey());
        q.g(node, "node");
    }
}
