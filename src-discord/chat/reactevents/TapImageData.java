...
public final class TapImageData implements ReactEvent {
    ...
    public static final class Layout {
        ...
        public boolean equals(Object obj) {
            ...
            return this.width == layout.width && this.height == layout.height && this.f7920x == layout.f7920x && this.f7921y == layout.f7921y && this.resizeMode == layout.resizeMode;
        }
        ...
        public int hashCode() {
            return (((((((this.width * 31) + this.height) * 31) + this.f7920x) * 31) + this.f7921y) * 31) + this.resizeMode.hashCode();
        }

        public final WritableMap serialize() {
            return NativeMapExtensionsKt.nativeMapOf(x.a("width", Integer.valueOf(this.width)), x.a("height", Integer.valueOf(this.height)), x.a("x", Integer.valueOf(this.f7920x)), x.a("y", Integer.valueOf(this.f7921y)), x.a(ViewProps.RESIZE_MODE, this.resizeMode.getValue()));
        }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7919id, tapImageData.f7919id) && this.index == tapImageData.index && q.b(this.type, tapImageData.type) && q.b(this.layout, tapImageData.layout) && q.b(this.portal, tapImageData.portal) && q.b(this.embedIndex, tapImageData.embedIndex);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((this.f7919id.hashCode() * 31) + this.index) * 31) + this.type.hashCode()) * 31) + this.layout.hashCode()) * 31;
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(x.a("id", this.f7919id), x.a("index", Integer.valueOf(this.index)), x.a("type", this.type), x.a("layout", this.layout.serialize()), x.a("portal", this.portal), x.a("embedIndex", this.embedIndex));
    }
