...
public final class TapImageData implements ReactEvent {
    ...
    public static final class Layout {
        ...
        private final int f7478x;

        
        private final int f7479y;
        ...
        public boolean equals(Object obj) {
            ...
            return this.width == layout.width && this.height == layout.height && this.f7478x == layout.f7478x && this.f7479y == layout.f7479y && this.resizeMode == layout.resizeMode;
        }
        ...
        public int hashCode() {
            return (((((((this.width * 31) + this.height) * 31) + this.f7478x) * 31) + this.f7479y) * 31) + this.resizeMode.hashCode();
        }

        public final WritableMap serialize() {
            return NativeMapExtensionsKt.nativeMapOf(x.a("width", Integer.valueOf(this.width)), x.a("height", Integer.valueOf(this.height)), x.a("x", Integer.valueOf(this.f7478x)), x.a("y", Integer.valueOf(this.f7479y)), x.a(ViewProps.RESIZE_MODE, this.resizeMode.getValue()));
        }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7477id, tapImageData.f7477id) && this.index == tapImageData.index && q.c(this.type, tapImageData.type) && q.c(this.layout, tapImageData.layout) && q.c(this.portal, tapImageData.portal) && q.c(this.embedIndex, tapImageData.embedIndex);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((this.f7477id.hashCode() * 31) + this.index) * 31) + this.type.hashCode()) * 31) + this.layout.hashCode()) * 31;
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(x.a("id", this.f7477id), x.a("index", Integer.valueOf(this.index)), x.a("type", this.type), x.a("layout", this.layout.serialize()), x.a("portal", this.portal), x.a("embedIndex", this.embedIndex));
    }
