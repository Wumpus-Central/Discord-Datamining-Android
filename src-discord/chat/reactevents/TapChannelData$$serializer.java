...
public final class TapChannelData$$serializer implements f0<TapChannelData> {
    ...
    public TapChannelData deserialize(Decoder decoder) {
        ...
        b10.c(descriptor2);
        return new TapChannelData(i10, (String) obj2, (String) obj, (String) obj3, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, TapChannelData value) {
        ...
        TapChannelData.write$Self(value, b10, descriptor2);
        b10.c(descriptor2);
    }
