...
public final class LongPressChannelData implements ReactEvent {
    ...
    public  LongPressChannelData(int i10, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i10 & 0) != 0) {
    ...
    public static  LongPressChannelData copy$default(LongPressChannelData longPressChannelData, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(LongPressChannelData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.B(serialDesc, 0, a2.f29764a, self.guildId);
        }
        ...
        if (z11) {
            output.B(serialDesc, 1, a2.f29764a, self.channelId);
        }
        ...
        if (z12) {
            output.B(serialDesc, 2, a2.f29764a, self.messageId);
        }
        if (output.z(serialDesc, 3) || self.originalLink != null) {
            z13 = true;
        }
        if (z13) {
            output.B(serialDesc, 3, a2.f29764a, self.originalLink);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.guildId, longPressChannelData.guildId) && q.c(this.channelId, longPressChannelData.channelId) && q.c(this.messageId, longPressChannelData.messageId) && q.c(this.originalLink, longPressChannelData.originalLink);
    }
    ...
    public  LongPressChannelData(String str, String str2, String str3, String str4, int i10, DefaultConstructorMarker defaultConstructorMarker) {
