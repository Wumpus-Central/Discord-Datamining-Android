...
public final class TapGiftCodeAcceptData implements ReactEvent {
    ...
    public static  TapGiftCodeAcceptData m417copyNU4t8f8$default(TapGiftCodeAcceptData tapGiftCodeAcceptData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapGiftCodeAcceptData.m419copyNU4t8f8(str, str2);
    }
    ...
    public static final void write$Self(TapGiftCodeAcceptData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (str != null) {
            messageId = MessageId.m631boximpl(str);
        } else {
            messageId = null;
        }
    ...
    public final String m418component2N_6c4I0() {
        return this.messageId;
    }

    
    public final TapGiftCodeAcceptData m419copyNU4t8f8(String giftCode, String str) {
    ...
    public final String m420getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        return hashCode + (str == null ? 0 : MessageId.m636hashCodeimpl(str));
    }
