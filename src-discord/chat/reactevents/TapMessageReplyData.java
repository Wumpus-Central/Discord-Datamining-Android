...
public final class TapMessageReplyData implements ReactEvent {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Lcom/discord/chat/reactevents/TapMessageReplyData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/reactevents/TapMessageReplyData;", "chat_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public  TapMessageReplyData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
            n1.b(i10, 3, TapMessageReplyData$$serializer.INSTANCE.getDescriptor());
        }
        this.channelId = str;
        this.originId = str2;
    }

    public static  TapMessageReplyData copy$default(TapMessageReplyData tapMessageReplyData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapMessageReplyData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 1, self.originId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.channelId, tapMessageReplyData.channelId) && q.c(this.originId, tapMessageReplyData.originId);
    }
