...
public final class TapAutoModerationActionsData implements ReactEvent {
    ...
    public  TapAutoModerationActionsData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  TapAutoModerationActionsData copy$default(TapAutoModerationActionsData tapAutoModerationActionsData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.messageId, tapAutoModerationActionsData.messageId) && q.c(this.channelId, tapAutoModerationActionsData.channelId);
    }
