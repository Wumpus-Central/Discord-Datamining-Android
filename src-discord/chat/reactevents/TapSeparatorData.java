...
public final class TapSeparatorData implements ReactEvent {
    ...
    public static  TapSeparatorData copy$default(TapSeparatorData tapSeparatorData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public  TapSeparatorData(String str, String str2, int i10, DefaultConstructorMarker defaultConstructorMarker) {
