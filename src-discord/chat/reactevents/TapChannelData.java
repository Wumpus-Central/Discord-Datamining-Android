...
public final class TapChannelData implements ReactEvent {
    ...
    public  TapChannelData(int i10, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i10 & 0) != 0) {
    ...
    public static  TapChannelData copy$default(TapChannelData tapChannelData, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public  TapChannelData(String str, String str2, String str3, int i10, DefaultConstructorMarker defaultConstructorMarker) {
