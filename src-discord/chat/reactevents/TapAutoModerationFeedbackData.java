...
public final class TapAutoModerationFeedbackData implements ReactEvent {
    ...
    public  TapAutoModerationFeedbackData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  TapAutoModerationFeedbackData copy$default(TapAutoModerationFeedbackData tapAutoModerationFeedbackData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.messageId, tapAutoModerationFeedbackData.messageId) && q.c(this.channelId, tapAutoModerationFeedbackData.channelId);
    }
