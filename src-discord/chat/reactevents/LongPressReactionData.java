...
public final class LongPressReactionData implements ReactEvent {
    ...
    public static  LongPressReactionData m352copyEqy5D80$default(LongPressReactionData longPressReactionData, String str, long j10, ReactionView.Reaction reaction, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return longPressReactionData.m355copyEqy5D80(str, j10, reaction);
    }
    ...
    public final long m354component2o4g7jtM() {
    ...
    public final LongPressReactionData m355copyEqy5D80(String messageId, long j10, ReactionView.Reaction reaction) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m596equalsimpl0(this.messageId, longPressReactionData.messageId) && ChannelId.m570equalsimpl0(this.channelId, longPressReactionData.channelId) && q.b(this.reaction, longPressReactionData.reaction);
    }

    
    public final long m356getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m597hashCodeimpl(this.messageId) * 31) + ChannelId.m571hashCodeimpl(this.channelId)) * 31;
    ...
    public WritableMap serialize() {
        ...
        pairArr[1] = x.a("channelId", ChannelId.m573toStringimpl(this.channelId));
