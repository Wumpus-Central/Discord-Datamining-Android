...
public final class LongPressReactionData implements ReactEvent {
    ...
    public static  LongPressReactionData m388copyEqy5D80$default(LongPressReactionData longPressReactionData, String str, long j10, ReactionView.Reaction reaction, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return longPressReactionData.m391copyEqy5D80(str, j10, reaction);
    }

    
    public final String m389component13Eiw7ao() {
        return this.messageId;
    }

    
    public final long m390component2o4g7jtM() {
    ...
    public final LongPressReactionData m391copyEqy5D80(String messageId, long j10, ReactionView.Reaction reaction) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m640equalsimpl0(this.messageId, longPressReactionData.messageId) && ChannelId.m614equalsimpl0(this.channelId, longPressReactionData.channelId) && q.c(this.reaction, longPressReactionData.reaction);
    }

    
    public final long m392getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public WritableMap serialize() {
        ...
        pairArr[1] = x.a("channelId", ChannelId.m617toStringimpl(this.channelId));
