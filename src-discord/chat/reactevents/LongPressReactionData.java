...
public final class LongPressReactionData implements ReactEvent {
    ...
    public static  LongPressReactionData m361copyEqy5D80$default(LongPressReactionData longPressReactionData, String str, long j10, ReactionView.Reaction reaction, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return longPressReactionData.m364copyEqy5D80(str, j10, reaction);
    }
    ...
    public final LongPressReactionData m364copyEqy5D80(String messageId, long j10, ReactionView.Reaction reaction) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m609equalsimpl0(this.messageId, longPressReactionData.messageId) && ChannelId.m583equalsimpl0(this.channelId, longPressReactionData.channelId) && q.c(this.reaction, longPressReactionData.reaction);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m610hashCodeimpl(this.messageId) * 31) + ChannelId.m584hashCodeimpl(this.channelId)) * 31;
    ...
    public WritableMap serialize() {
        ...
        pairArr[1] = x.a("channelId", ChannelId.m586toStringimpl(this.channelId));
