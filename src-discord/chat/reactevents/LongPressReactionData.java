...
public final class LongPressReactionData implements ReactEvent {
    ...
    public static  LongPressReactionData m351copyEqy5D80$default(LongPressReactionData longPressReactionData, String str, long j10, ReactionView.Reaction reaction, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return longPressReactionData.m354copyEqy5D80(str, j10, reaction);
    }
    ...
    public final LongPressReactionData m354copyEqy5D80(String messageId, long j10, ReactionView.Reaction reaction) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m595equalsimpl0(this.messageId, longPressReactionData.messageId) && ChannelId.m569equalsimpl0(this.channelId, longPressReactionData.channelId) && q.b(this.reaction, longPressReactionData.reaction);
    }

    
    public final long m355getChannelIdo4g7jtM() {
        return this.channelId;
    }

    
    public final String m356getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m596hashCodeimpl(this.messageId) * 31) + ChannelId.m570hashCodeimpl(this.channelId)) * 31;
    ...
    public WritableMap serialize() {
        ...
        pairArr[1] = x.a("channelId", ChannelId.m572toStringimpl(this.channelId));
