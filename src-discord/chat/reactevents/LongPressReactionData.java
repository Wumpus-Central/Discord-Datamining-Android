...
public final class LongPressReactionData implements ReactEvent {
    ...
    public static  LongPressReactionData m353copyEqy5D80$default(LongPressReactionData longPressReactionData, String str, long j10, ReactionView.Reaction reaction, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return longPressReactionData.m356copyEqy5D80(str, j10, reaction);
    }

    
    public final String m354component13Eiw7ao() {
    ...
    public final LongPressReactionData m356copyEqy5D80(String messageId, long j10, ReactionView.Reaction reaction) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m597equalsimpl0(this.messageId, longPressReactionData.messageId) && ChannelId.m571equalsimpl0(this.channelId, longPressReactionData.channelId) && q.c(this.reaction, longPressReactionData.reaction);
    }

    
    public final long m357getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m598hashCodeimpl(this.messageId) * 31) + ChannelId.m572hashCodeimpl(this.channelId)) * 31;
    ...
    public WritableMap serialize() {
        ...
        pairArr[1] = x.a("channelId", ChannelId.m574toStringimpl(this.channelId));
