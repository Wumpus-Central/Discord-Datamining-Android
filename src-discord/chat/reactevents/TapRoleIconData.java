...
public final class TapRoleIconData implements ReactEvent {
    ...
    public  TapRoleIconData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  TapRoleIconData copy$default(TapRoleIconData tapRoleIconData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.roleName, tapRoleIconData.roleName) && q.c(this.roleIconSource, tapRoleIconData.roleIconSource);
    }
