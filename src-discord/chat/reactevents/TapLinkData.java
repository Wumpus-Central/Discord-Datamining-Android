...
public final class TapLinkData implements ReactEvent {
    ...
    public static  TapLinkData m415copyfCSJrew$default(TapLinkData tapLinkData, String str, String str2, String str3, String str4, LinkContext linkContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapLinkData.m417copyfCSJrew(str, str2, str3, str4, linkContext);
    }
                ...
                case -1732468237:
                    if (str2.equals("handleDelete")) {
                        ...
                        if (handleDelete != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "message", NativeMapExtensionsKt.nativeMapOf(x.a("id", handleDelete.getMessage().m71getId3Eiw7ao()), x.a("channel_id", ChannelId.m598toStringimpl(handleDelete.getMessage().m70getChannelIdo4g7jtM())), x.a("loggingName", handleDelete.getMessage().getLoggingName()), x.a("author", NativeMapExtensionsKt.nativeMapOf(x.a("username", handleDelete.getMessage().getAuthor().getUsername())))));
                            break;
                        }
                    }
                    break;
                    ...
                    if (str2.equals("webhookNameOnClick")) {
                        ...
                        if (webhookNameOnClick != null) {
                            ...
                            if (messageReference != null) {
                                ...
                                NativeMapExtensionsKt.put(nativeMapOf2, "channel_id", ChannelId.m598toStringimpl(messageReference.m85getChannelIdo4g7jtM()));
                                GuildId guildId = messageReference.m86getGuildIdqOKuAAo();
                                if (guildId != null) {
                                    NativeMapExtensionsKt.put(nativeMapOf2, "guild_id", GuildId.m611toStringimpl(guildId.m613unboximpl()));
                                }
                ...
                case -933189749:
                    if (str2.equals("pinsOnClick")) {
                        ...
                        if (pinsOnClick != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m598toStringimpl(pinsOnClick.m90getMessageChannelIdo4g7jtM()));
                            break;
                        }
                    }
                    break;
                case -932369101:
                    if (str2.equals("usernameOnClick")) {
                        ...
                        if (usernameOnClick != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m662toStringimpl(usernameOnClick.m100getUserIdre6GcUE()));
                            ChannelId channelId = usernameOnClick.m99getMessageChannelIdqMVnFVQ();
                            if (channelId != null) {
                                NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m598toStringimpl(channelId.m600unboximpl()));
                                break;
                            }
                        }
                    }
                ...
                case 371724472:
                    if (str2.equals("actorHook")) {
                        ...
                        if (actorHook != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m662toStringimpl(actorHook.m50getUserIdre6GcUE()));
                            break;
                        }
                    }
                    break;
                case 1318937603:
                    if (str2.equals("otherUsernameOnClick")) {
                        ...
                        if (otherUsernameOnClick != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m662toStringimpl(otherUsernameOnClick.m100getUserIdre6GcUE()));
                            ChannelId channelId2 = otherUsernameOnClick.m99getMessageChannelIdqMVnFVQ();
                            if (channelId2 != null) {
                                NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m598toStringimpl(channelId2.m600unboximpl()));
                                break;
                            }
                        }
                    }
                ...
                case 1532521663:
                    if (str2.equals("handleMessage")) {
                        ...
                        if (handleMessage != null) {
                            ...
                            NativeMapExtensionsKt.put(nativeMapOf, "message", NativeMapExtensionsKt.nativeMapOf(x.a("id", handleMessage.getMessage().m78getId3Eiw7ao()), x.a("channel_id", ChannelId.m598toStringimpl(handleMessage.getMessage().m77getChannelIdo4g7jtM())), x.a("loggingName", handleMessage.getMessage().getLoggingName())));
                    ...
                    if (str2.equals("commandNameOnClick")) {
                        ...
                        if (commandNameOnClick != null) {
                            ...
                            if (str3 == null) {
                                ...
                                str = MessageId.m623toStringimpl(str3);
                            }
    ...
    public final String m416component1N_6c4I0() {
    ...
    public final TapLinkData m417copyfCSJrew(String str, String str2, String str3, String content, LinkContext linkContext) {
        q.h(content, "content");
    ...
    public final String m418getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        int i10 = 0;
        int i11 = (str == null ? 0 : MessageId.m622hashCodeimpl(str)) * 31;
    ...
    public WritableMap serialize() {
        ...
        if (linkContext == null || (writableNativeMap = toMap(linkContext)) == null) {
            ...
            if (str2 == null) {
                ...
                str = MessageId.m623toStringimpl(str2);
            }
    ...
    public String toString() {
        String str = this.messageId;
        String str2 = str == null ? "null" : MessageId.m623toStringimpl(str);
