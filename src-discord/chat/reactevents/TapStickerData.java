...
public final class TapStickerData implements ReactEvent {
    ...
    public static  TapStickerData m429copyAyv7vGE$default(TapStickerData tapStickerData, Sticker sticker, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapStickerData.m431copyAyv7vGE(sticker, str);
    }
    ...
    public final String m430component23Eiw7ao() {
        return this.messageId;
    }

    
    public final TapStickerData m431copyAyv7vGE(Sticker sticker, String messageId) {
        q.h(sticker, "sticker");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.sticker, tapStickerData.sticker) && MessageId.m611equalsimpl0(this.messageId, tapStickerData.messageId);
    }
    ...
    public int hashCode() {
        return (this.sticker.hashCode() * 31) + MessageId.m612hashCodeimpl(this.messageId);
    }
