...
public final class TapCancelUploadItemData implements ReactEvent {
    ...
    public  TapCancelUploadItemData(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  TapCancelUploadItemData copy$default(TapCancelUploadItemData tapCancelUploadItemData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.uploaderId, tapCancelUploadItemData.uploaderId) && q.c(this.itemId, tapCancelUploadItemData.itemId);
    }
