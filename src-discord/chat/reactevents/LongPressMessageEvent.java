...
public final class LongPressMessageEvent implements ReactEvent {
    ...
    public  LongPressMessageEvent(int i10, String str, String str2, int i11, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i10 & 15)) {
    ...
    public static  LongPressMessageEvent copy$default(LongPressMessageEvent longPressMessageEvent, String str, String str2, int i10, String str3, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(LongPressMessageEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 2, self.mediaIndex);
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.messageId, longPressMessageEvent.messageId) && q.c(this.channelId, longPressMessageEvent.channelId) && this.mediaIndex == longPressMessageEvent.mediaIndex && q.c(this.mediaType, longPressMessageEvent.mediaType);
    }
