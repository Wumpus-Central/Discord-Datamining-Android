...
public final class ChatScrollPositionEvent implements ReactEvent {
    ...
    public /* synthetic */ ChatScrollPositionEvent(int i10, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, int i11, int i12, SerializationConstructorMarker serializationConstructorMarker) {
        if (511 != (i10 & 511)) {
    ...
    public static final void write$Self(ChatScrollPositionEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.s(serialDesc, 0, self.isAtBottom);
        output.s(serialDesc, 1, self.isNearBottom);
        output.s(serialDesc, 2, self.isNearTop);
        output.s(serialDesc, 3, self.dragging);
        output.s(serialDesc, 4, self.decelerating);
        output.s(serialDesc, 5, self.shouldShowJumpToPresent);
        output.s(serialDesc, 6, self.isFirstMessageVisible);
        output.r(serialDesc, 7, self.firstVisibleMessageIndex);
        output.r(serialDesc, 8, self.lastVisibleMessageIndex);
    }
