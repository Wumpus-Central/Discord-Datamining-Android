...
public final class ChatScrollPositionEvent implements ReactEvent {
    ...
    public static final void write$Self(ChatScrollPositionEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.isAtBottom);
        output.y(serialDesc, 1, self.isNearBottom);
        output.y(serialDesc, 2, self.isNearTop);
        output.y(serialDesc, 3, self.dragging);
        output.y(serialDesc, 4, self.decelerating);
        output.y(serialDesc, 5, self.shouldShowJumpToPresent);
        output.y(serialDesc, 6, self.isFirstMessageVisible);
        output.x(serialDesc, 7, self.firstVisibleMessageIndex);
        output.x(serialDesc, 8, self.lastVisibleMessageIndex);
    }
