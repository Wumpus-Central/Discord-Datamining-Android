...
public final class TapButtonActionComponent implements ReactEvent {
    ...
    public static final void write$Self(TapButtonActionComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.e(serialDesc, 2, a2.f30568a, self.customId);
        output.h(serialDesc, 3, ApplicationId$$serializer.INSTANCE, ApplicationId.m578boximpl(self.applicationId));
        output.h(serialDesc, 4, kotlinx.serialization.internal.f.f21956c, self.indices);
    }
