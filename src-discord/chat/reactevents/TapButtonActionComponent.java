...
public final class TapButtonActionComponent implements ReactEvent {
    ...
    public static /* synthetic */ TapButtonActionComponent m368copyNkFJqEg$default(TapButtonActionComponent tapButtonActionComponent, String str, double d10, String str2, long j10, int[] iArr, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapButtonActionComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.e(serialDesc, 2, a2.f26972a, self.customId);
        output.C(serialDesc, 3, ApplicationId$$serializer.INSTANCE, ApplicationId.m551boximpl(self.applicationId));
        output.C(serialDesc, 4, kotlinx.serialization.internal.f.f21211c, self.indices);
    }
