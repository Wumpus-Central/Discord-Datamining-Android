...
public final class TapButtonActionComponent implements ReactEvent {
    ...
    public /* synthetic */ TapButtonActionComponent(int i10, String str, double d10, String str2, ApplicationId applicationId, int[] iArr, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, str, d10, str2, applicationId, iArr, serializationConstructorMarker);
    }

    public /* synthetic */ TapButtonActionComponent(String str, double d10, String str2, long j10, int[] iArr, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, d10, str2, j10, iArr);
    }

    public /* synthetic */ TapButtonActionComponent(String str, long j10, String str2, long j11, int[] iArr, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, j10, str2, j11, iArr);
    }

    /* renamed from: copy-NkFJqEg$default  reason: not valid java name */
    public static /* synthetic */ TapButtonActionComponent m366copyNkFJqEg$default(TapButtonActionComponent tapButtonActionComponent, String str, double d10, String str2, long j10, int[] iArr, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapButtonActionComponent.m369copyNkFJqEg(str, d10, str2, j10, iArr);
    }
    ...
    public static final void write$Self(TapButtonActionComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.A(serialDesc, 1, self.messageFlags);
        output.e(serialDesc, 2, a2.f26940a, self.customId);
        output.C(serialDesc, 3, ApplicationId$$serializer.INSTANCE, ApplicationId.m549boximpl(self.applicationId));
        output.C(serialDesc, 4, kotlinx.serialization.internal.f.f21179c, self.indices);
    }
    ...
    public final long m368component4VavddsQ() {
    ...
    public final TapButtonActionComponent m369copyNkFJqEg(String messageId, double d10, String str, long j10, int[] indices) {
    ...
    public final String m371getMessageId3Eiw7ao() {
        return this.messageId;
    }

    public int hashCode() {
        int i10 = ((MessageId.m593hashCodeimpl(this.messageId) * 31) + Double.doubleToLongBits(this.messageFlags)) * 31;
        String str = this.customId;
        return ((((i10 + (str == null ? 0 : str.hashCode())) * 31) + ApplicationId.m554hashCodeimpl(this.applicationId)) * 31) + Arrays.hashCode(this.indices);
    }

    @Override // com.discord.reactevents.ReactEvent
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(x.a("messageId", MessageId.m594toStringimpl(this.messageId)), x.a("messageFlags", Double.valueOf(this.messageFlags)), x.a("customId", this.customId), x.a("applicationId", ApplicationId.m556toStringimpl(this.applicationId)), x.a("indices", NativeArrayExtensionsKt.toNativeArray(this.indices)));
    }
    ...
    public String toString() {
        ...
        String str3 = ApplicationId.m556toStringimpl(this.applicationId);
