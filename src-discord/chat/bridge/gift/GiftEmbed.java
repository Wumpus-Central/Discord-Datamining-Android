    ...
    public interface Resolved extends GiftEmbed {
        ...
        public static final class Valid implements Resolved {
            ...
            public static final void write$Self(Valid self, CompositeEncoder output, SerialDescriptor serialDesc) {
                ...
                if (z10) {
                    output.u(serialDesc, 4, a2.f32933a, self.getThumbnailUrl());
                }
                ...
                if (z11) {
                    output.u(serialDesc, 5, a2.f32933a, self.getTitleText());
                }
                output.x(serialDesc, 6, self.getTitleColor());
                ...
                if (z12) {
                    output.u(serialDesc, 7, a2.f32933a, self.getSubtitle());
                }
                output.x(serialDesc, 8, self.getSubtitleColor());
                ...
                if (z13) {
                    output.u(serialDesc, 9, a2.f32933a, self.bodyText);
                }
                ...
                if (z14) {
                    output.u(serialDesc, 11, a2.f32933a, self.acceptLabelText);
                }
                ...
                if (z15) {
                    output.u(serialDesc, 14, a2.f32933a, self.splashUrl);
                }
