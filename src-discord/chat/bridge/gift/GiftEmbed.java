    ...
    public interface Resolved extends GiftEmbed {
        ...
        public static final class Valid implements Resolved {
            ...
            public static final void write$Self(Valid self, CompositeEncoder output, SerialDescriptor serialDesc) {
                ...
                if (z10) {
                    output.e(serialDesc, 4, a2.f26972a, self.getThumbnailUrl());
                }
                ...
                if (z11) {
                    output.e(serialDesc, 5, a2.f26972a, self.getTitleText());
                }
                output.r(serialDesc, 6, self.getTitleColor());
                ...
                if (z12) {
                    output.e(serialDesc, 7, a2.f26972a, self.getSubtitle());
                }
                output.r(serialDesc, 8, self.getSubtitleColor());
                ...
                if (z13) {
                    output.e(serialDesc, 9, a2.f26972a, self.bodyText);
                }
                ...
                if (z14) {
                    output.e(serialDesc, 11, a2.f26972a, self.acceptLabelText);
                }
                ...
                if (z15) {
                    output.e(serialDesc, 14, a2.f26972a, self.splashUrl);
                }
