    ...
    public interface Resolved extends GiftEmbed {
        ...
        public static final class Valid implements Resolved {
            ...
            public static final void write$Self(Valid self, CompositeEncoder output, SerialDescriptor serialDesc) {
                ...
                if (z10) {
                    output.p(serialDesc, 4, a2.f5917a, self.getThumbnailUrl());
                }
                ...
                if (z11) {
                    output.p(serialDesc, 5, a2.f5917a, self.getTitleText());
                }
                output.x(serialDesc, 6, self.getTitleColor());
                ...
                if (z12) {
                    output.p(serialDesc, 7, a2.f5917a, self.getSubtitle());
                }
                output.x(serialDesc, 8, self.getSubtitleColor());
                ...
                if (z13) {
                    output.p(serialDesc, 9, a2.f5917a, self.bodyText);
                }
                ...
                if (z14) {
                    output.p(serialDesc, 11, a2.f5917a, self.acceptLabelText);
                }
                ...
                if (z15) {
                    output.p(serialDesc, 14, a2.f5917a, self.splashUrl);
                }
