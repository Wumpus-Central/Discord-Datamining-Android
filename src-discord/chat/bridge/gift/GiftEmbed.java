    ...
    public interface Resolved extends GiftEmbed {
        ...
        public static final class Valid implements Resolved {
            ...
            public static final void write$Self(Valid self, CompositeEncoder output, SerialDescriptor serialDesc) {
                ...
                if (z10) {
                    output.z(serialDesc, 4, a2.f26246a, self.getThumbnailUrl());
                }
                ...
                if (z11) {
                    output.z(serialDesc, 5, a2.f26246a, self.getTitleText());
                }
                output.q(serialDesc, 6, self.getTitleColor());
                ...
                if (z12) {
                    output.z(serialDesc, 7, a2.f26246a, self.getSubtitle());
                }
                output.q(serialDesc, 8, self.getSubtitleColor());
                ...
                if (z13) {
                    output.z(serialDesc, 9, a2.f26246a, self.bodyText);
                }
                ...
                if (z14) {
                    output.z(serialDesc, 11, a2.f26246a, self.acceptLabelText);
                }
                ...
                if (z15) {
                    output.z(serialDesc, 14, a2.f26246a, self.splashUrl);
                }
