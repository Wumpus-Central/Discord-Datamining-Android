    ...
    public interface Resolved extends GiftEmbed {
        ...
        public static final class Valid implements Resolved {
            ...
            public static final void write$Self(Valid self, CompositeEncoder output, SerialDescriptor serialDesc) {
                ...
                if (z10) {
                    output.u(serialDesc, 4, a2.f32931a, self.getThumbnailUrl());
                }
                ...
                if (z11) {
                    output.u(serialDesc, 5, a2.f32931a, self.getTitleText());
                }
                output.x(serialDesc, 6, self.getTitleColor());
                ...
                if (z12) {
                    output.u(serialDesc, 7, a2.f32931a, self.getSubtitle());
                }
                output.x(serialDesc, 8, self.getSubtitleColor());
                ...
                if (z13) {
                    output.u(serialDesc, 9, a2.f32931a, self.bodyText);
                }
                ...
                if (z14) {
                    output.u(serialDesc, 11, a2.f32931a, self.acceptLabelText);
                }
                ...
                if (z15) {
                    output.u(serialDesc, 14, a2.f32931a, self.splashUrl);
                }
            ...
            public /* synthetic */ Valid(String str, int i10, int i11, int i12, String str2, String str3, int i13, String str4, int i14, String str5, int i15, String str6, int i16, int i17, String str7, float f10, boolean z10, String str8, int i18, DefaultConstructorMarker defaultConstructorMarker) {
                this(str, i10, i11, i12, (i18 & 16) != 0 ? null : str2, (i18 & 32) != 0 ? null : str3, i13, (i18 & 128) != 0 ? null : str4, i14, (i18 & 512) != 0 ? null : str5, i15, (i18 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : str6, i16, i17, (i18 & Spliterator.SUBSIZED) != 0 ? null : str7, f10, z10, str8);
            }
        }
