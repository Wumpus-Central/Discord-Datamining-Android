...
public interface GiftEmbed {
    ...
    public interface Resolved extends GiftEmbed {
        ...
        public static final class Invalid implements Resolved {
            ...
            public static final void write$Self(Invalid self, CompositeEncoder output, SerialDescriptor serialDesc) {
                ...
                output.r(serialDesc, 1, self.getHeaderColor());
                output.r(serialDesc, 2, self.getBackgroundColor());
                output.r(serialDesc, 3, self.getThumbnailCornerRadius());
                output.t(serialDesc, 4, self.getThumbnailUrl());
                output.t(serialDesc, 5, self.getTitleText());
                output.r(serialDesc, 6, self.getTitleColor());
                output.t(serialDesc, 7, self.getSubtitle());
                output.r(serialDesc, 8, self.getSubtitleColor());
                output.r(serialDesc, 9, self.thumbnailBackgroundColor);
            }
        ...
        public static final class Valid implements Resolved {
            ...
            public static final void write$Self(Valid self, CompositeEncoder output, SerialDescriptor serialDesc) {
                ...
                if (z10) {
                    output.e(serialDesc, 4, a2.f26939a, self.getThumbnailUrl());
                }
                ...
                if (z11) {
                    output.e(serialDesc, 5, a2.f26939a, self.getTitleText());
                }
                output.r(serialDesc, 6, self.getTitleColor());
                ...
                if (z12) {
                    output.e(serialDesc, 7, a2.f26939a, self.getSubtitle());
                }
                output.r(serialDesc, 8, self.getSubtitleColor());
                ...
                if (z13) {
                    output.e(serialDesc, 9, a2.f26939a, self.bodyText);
                }
                output.r(serialDesc, 10, self.bodyTextColor);
                ...
                if (z14) {
                    output.e(serialDesc, 11, a2.f26939a, self.acceptLabelText);
                }
                output.r(serialDesc, 12, self.acceptLabelColor);
                output.r(serialDesc, 13, self.acceptLabelBackgroundColor);
                if (output.w(serialDesc, 14) || self.splashUrl != null) {
                    z15 = true;
                }
                if (z15) {
                    output.e(serialDesc, 14, a2.f26939a, self.splashUrl);
                }
            ...
            public boolean equals(Object obj) {
                ...
                return q.b(getHeaderText(), valid.getHeaderText()) && getHeaderColor() == valid.getHeaderColor() && getBackgroundColor() == valid.getBackgroundColor() && getThumbnailCornerRadius() == valid.getThumbnailCornerRadius() && q.b(getThumbnailUrl(), valid.getThumbnailUrl()) && q.b(getTitleText(), valid.getTitleText()) && getTitleColor() == valid.getTitleColor() && q.b(getSubtitle(), valid.getSubtitle()) && getSubtitleColor() == valid.getSubtitleColor() && q.b(this.bodyText, valid.bodyText) && this.bodyTextColor == valid.bodyTextColor && q.b(this.acceptLabelText, valid.acceptLabelText) && this.acceptLabelColor == valid.acceptLabelColor && this.acceptLabelBackgroundColor == valid.acceptLabelBackgroundColor && q.b(this.splashUrl, valid.splashUrl) && Float.compare(this.splashOpacity, valid.splashOpacity) == 0 && this.canBeAccepted == valid.canBeAccepted && q.b(this.giftCode, valid.giftCode);
            }
    ...
    public static final class Resolving implements GiftEmbed {
        ...
        public static final void write$Self(Resolving self, CompositeEncoder output, SerialDescriptor serialDesc) {
            ...
            output.r(serialDesc, 2, self.getBackgroundColor());
            output.r(serialDesc, 3, self.getThumbnailCornerRadius());
            output.r(serialDesc, 4, self.resolvingGradientStart);
            output.r(serialDesc, 5, self.resolvingGradientEnd);
        }
