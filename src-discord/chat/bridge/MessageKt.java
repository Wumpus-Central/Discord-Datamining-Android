...
public final class MessageKt {
    ...
    public static  int roleDotColor$default(Message message, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static  int usernameColor$default(Message message, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
