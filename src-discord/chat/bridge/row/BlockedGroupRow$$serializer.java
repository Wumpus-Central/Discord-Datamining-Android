...
public final class BlockedGroupRow$$serializer implements f0<BlockedGroupRow> {
    ...
    public KSerializer<?>[] childSerializers() {
        m0 m0Var = m0.f6313a;
        return new KSerializer[]{m0Var, ChangeType.Serializer.INSTANCE, m0Var, m0Var, m0Var, a2.f6238a, h.f6280a, BlockedGroupButton$$serializer.INSTANCE, a.u(new f(BlockedGroupContent$$serializer.INSTANCE))};
    }
