...
public final class SeparatorRow$$serializer implements f0<SeparatorRow> {
    ...
    public KSerializer<?>[] childSerializers() {
        m0 m0Var = m0.f33000a;
        a2 a2Var = a2.f32925a;
        return new KSerializer[]{ChangeType.Serializer.INSTANCE, m0Var, a2Var, a2Var, m0Var, a.u(h.f32967a)};
    }
    ...
    public SeparatorRow deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj = b10.n(descriptor2, 5, h.f32967a, null);
            i12 = 63;
        } else {
            boolean z10 = true;
            int i14 = 0;
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 4:
                        ...
                        i15 |= 16;
                    case 5:
                        obj4 = b10.n(descriptor2, i13, h.f32967a, obj4);
                        i15 |= 32;
                    default:
                        throw new n(o10);
                }
