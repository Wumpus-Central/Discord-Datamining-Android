...
public final class UploadProgressRow extends Row {
    ...
    public  UploadProgressRow(int i10, int i11, ChangeType changeType, Message message, String str, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (15 != (i10 & 15)) {
    ...
    public static  UploadProgressRow copy$default(UploadProgressRow uploadProgressRow, int i10, ChangeType changeType, Message message, String str, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(UploadProgressRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 2, Message$$serializer.INSTANCE, self.message);
        output.y(serialDesc, 3, self.fileId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getIndex() == uploadProgressRow.getIndex() && getChangeType() == uploadProgressRow.getChangeType() && q.c(this.message, uploadProgressRow.message) && q.c(this.fileId, uploadProgressRow.fileId);
    }
