...
public final class LoadMoreButton {
    ...
    public static final void write$Self(LoadMoreButton self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.q(serialDesc, 0, LoadingAction$$serializer.INSTANCE, self.action);
        ...
        if (z10) {
            output.u(serialDesc, 3, m0.f32999a, self.cornerRadius);
        }
        if (output.A(serialDesc, 4) || self.color != null) {
            z11 = true;
        }
        if (z11) {
            output.u(serialDesc, 4, m0.f32999a, self.color);
        }
    }
