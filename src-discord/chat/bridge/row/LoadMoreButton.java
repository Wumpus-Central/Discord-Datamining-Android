...
public final class LoadMoreButton {
    ...
    public static final void write$Self(LoadMoreButton self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.i(serialDesc, 0, LoadingAction$$serializer.INSTANCE, self.action);
        ...
        if (z10) {
            output.E(serialDesc, 3, m0.f6313a, self.cornerRadius);
        }
        if (output.z(serialDesc, 4) || self.color != null) {
            z11 = true;
        }
        if (z11) {
            output.E(serialDesc, 4, m0.f6313a, self.color);
        }
    }
