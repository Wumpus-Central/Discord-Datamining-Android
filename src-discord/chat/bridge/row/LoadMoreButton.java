...
public final class LoadMoreButton {
    ...
    public static final void write$Self(LoadMoreButton self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.C(serialDesc, 0, LoadingAction$$serializer.INSTANCE, self.action);
        ...
        if (z10) {
            output.e(serialDesc, 3, m0.f27015a, self.cornerRadius);
        }
        if (output.w(serialDesc, 4) || self.color != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 4, m0.f27015a, self.color);
        }
    }
