...
public final class LoadMoreButton {
    ...
    public static final void write$Self(LoadMoreButton self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.z(serialDesc, 0, LoadingAction$$serializer.INSTANCE, self.action);
        output.y(serialDesc, 1, self.text);
        output.w(serialDesc, 2, self.backgroundColor);
        if (!output.A(serialDesc, 3) && self.cornerRadius == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.h(serialDesc, 3, m0.f32388a, self.cornerRadius);
        }
        if (output.A(serialDesc, 4) || self.color != null) {
            z11 = true;
        }
        if (z11) {
            output.h(serialDesc, 4, m0.f32388a, self.color);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.action, loadMoreButton.action) && q.b(this.text, loadMoreButton.text) && this.backgroundColor == loadMoreButton.backgroundColor && q.b(this.cornerRadius, loadMoreButton.cornerRadius) && q.b(this.color, loadMoreButton.color);
    }
