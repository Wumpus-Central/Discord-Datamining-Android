...
public final class LoadingAction {
    ...
    public /* synthetic */ LoadingAction(int i10, LoadingActionType loadingActionType, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static /* synthetic */ LoadingAction copy$default(LoadingAction loadingAction, LoadingActionType loadingActionType, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(LoadingAction self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 0, LoadingActionType.Companion.serializer(), self.type);
    }
