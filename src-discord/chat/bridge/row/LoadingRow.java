...
public final class LoadingRow extends Row {
    ...
    public  LoadingRow(int i10, int i11, ChangeType changeType, LoadMoreButton loadMoreButton, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (15 != (i10 & 15)) {
    ...
    public static  LoadingRow copy$default(LoadingRow loadingRow, int i10, ChangeType changeType, LoadMoreButton loadMoreButton, boolean z10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(LoadingRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 2, LoadMoreButton$$serializer.INSTANCE, self.button);
    ...
    public boolean equals(Object obj) {
        ...
        return getIndex() == loadingRow.getIndex() && getChangeType() == loadingRow.getChangeType() && q.c(this.button, loadingRow.button) && this.isLoading == loadingRow.isLoading;
    }
