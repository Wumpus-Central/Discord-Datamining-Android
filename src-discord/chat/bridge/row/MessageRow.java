...
public final class MessageRow extends Row {
    ...
    public static final void write$Self(MessageRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 1, ChangeType.Serializer.INSTANCE, self.getChangeType());
        ...
        if (z18) {
            output.h(serialDesc, 11, ReactionsTheme$$serializer.INSTANCE, self.reactionsTheme);
        }
        ...
        if (z21) {
            output.h(serialDesc, 14, MessageFrameSerializer.INSTANCE, self.messageFrame);
        }
        ...
        if (z23) {
            output.h(serialDesc, 16, Truncation$$serializer.INSTANCE, self.truncation);
        }
        ...
        if (z24) {
            output.h(serialDesc, 17, BackgroundHighlight$$serializer.INSTANCE, self.backgroundHighlight);
        }
        if (output.A(serialDesc, 18) || self.enableSwipeToReply) {
            z25 = true;
        }
        if (z25) {
            output.x(serialDesc, 18, self.enableSwipeToReply);
        }
    }
