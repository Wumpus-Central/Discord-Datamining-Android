...
public final class MessageRow extends Row {
    ...
    public static final void write$Self(MessageRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.u(serialDesc, 2, h.f32975a, self.jumped);
        }
        ...
        if (z11) {
            output.u(serialDesc, 3, h.f32975a, self.highlightJumpedOnceOnly);
        }
        ...
        if (z12) {
            output.u(serialDesc, 5, h.f32975a, self.scrollTo);
        }
        ...
        if (z13) {
            output.u(serialDesc, 6, h.f32975a, self.animated);
        }
        ...
        if (z14) {
            output.u(serialDesc, 7, h.f32975a, self.canAddNewReactions);
        }
        ...
        if (z15) {
            output.u(serialDesc, 8, a2.f32933a, self.addReactionLabel);
        }
        ...
        if (z16) {
            output.u(serialDesc, 9, a2.f32933a, self.addNewReactionAccessibilityLabel);
        }
        ...
        if (z17) {
            output.u(serialDesc, 10, a2.f32933a, self.addNewBurstReactionAccessibilityLabel);
        }
        ...
        if (z22) {
            output.u(serialDesc, 15, m0.f33008a, self.reactTag);
        }
