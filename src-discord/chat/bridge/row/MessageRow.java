...
public final class MessageRow extends Row {
    ...
    public static final void write$Self(MessageRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.p(serialDesc, 2, h.f5959a, self.jumped);
        }
        ...
        if (z11) {
            output.p(serialDesc, 3, h.f5959a, self.highlightJumpedOnceOnly);
        }
        output.t(serialDesc, 4, MessageSerializer.INSTANCE, self.message);
        ...
        if (z13) {
            output.p(serialDesc, 6, h.f5959a, self.animated);
        }
        ...
        if (z14) {
            output.p(serialDesc, 7, h.f5959a, self.canAddNewReactions);
        }
        ...
        if (z15) {
            output.p(serialDesc, 8, a2.f5917a, self.addReactionLabel);
        }
        ...
        if (z16) {
            output.p(serialDesc, 9, a2.f5917a, self.addNewReactionAccessibilityLabel);
        }
        ...
        if (z17) {
            output.p(serialDesc, 10, a2.f5917a, self.addNewBurstReactionAccessibilityLabel);
        }
        ...
        if (z18) {
            output.p(serialDesc, 11, ReactionsTheme$$serializer.INSTANCE, self.reactionsTheme);
        }
        ...
        if (z21) {
            output.p(serialDesc, 14, MessageFrameSerializer.INSTANCE, self.messageFrame);
        }
        ...
        if (z22) {
            output.p(serialDesc, 15, m0.f5992a, self.reactTag);
        }
        ...
        if (z23) {
            output.p(serialDesc, 16, Truncation$$serializer.INSTANCE, self.truncation);
        }
        ...
        if (z24) {
            output.p(serialDesc, 17, BackgroundHighlight$$serializer.INSTANCE, self.backgroundHighlight);
        }
