...
public final class MessageRow extends Row {
    ...
    public static final void write$Self(MessageRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.z(serialDesc, 2, h.f26275a, self.jumped);
        }
        ...
        if (z11) {
            output.z(serialDesc, 3, h.f26275a, self.highlightJumpedOnceOnly);
        }
        ...
        if (z12) {
            output.z(serialDesc, 5, h.f26275a, self.scrollTo);
        }
        ...
        if (z13) {
            output.z(serialDesc, 6, h.f26275a, self.animated);
        }
        ...
        if (z14) {
            output.z(serialDesc, 7, h.f26275a, self.canAddNewReactions);
        }
        ...
        if (z15) {
            output.z(serialDesc, 8, a2.f26233a, self.addReactionLabel);
        }
        ...
        if (z16) {
            output.z(serialDesc, 9, a2.f26233a, self.addNewReactionAccessibilityLabel);
        }
        ...
        if (z17) {
            output.z(serialDesc, 10, a2.f26233a, self.addNewBurstReactionAccessibilityLabel);
        }
        ...
        if (z22) {
            output.z(serialDesc, 15, m0.f26308a, self.reactTag);
        }
