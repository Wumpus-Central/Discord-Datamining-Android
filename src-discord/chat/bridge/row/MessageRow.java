...
public final class MessageRow extends Row {
    ...
    public static final void write$Self(MessageRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 1, ChangeType.Serializer.INSTANCE, self.getChangeType());
        if (!output.A(serialDesc, 2) && self.jumped == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 2, h.f32966a, self.jumped);
        }
        ...
        if (z11) {
            output.u(serialDesc, 3, h.f32966a, self.highlightJumpedOnceOnly);
        }
        output.q(serialDesc, 4, MessageSerializer.INSTANCE, self.message);
        ...
        if (z12) {
            output.u(serialDesc, 5, h.f32966a, self.scrollTo);
        }
        ...
        if (z13) {
            output.u(serialDesc, 6, h.f32966a, self.animated);
        }
        ...
        if (z14) {
            output.u(serialDesc, 7, h.f32966a, self.canAddNewReactions);
        }
        ...
        if (z15) {
            output.u(serialDesc, 8, a2.f32924a, self.addReactionLabel);
        }
        ...
        if (z16) {
            output.u(serialDesc, 9, a2.f32924a, self.addNewReactionAccessibilityLabel);
        }
        ...
        if (z17) {
            output.u(serialDesc, 10, a2.f32924a, self.addNewBurstReactionAccessibilityLabel);
        }
        ...
        if (z18) {
            output.u(serialDesc, 11, ReactionsTheme$$serializer.INSTANCE, self.reactionsTheme);
        }
        if (!output.A(serialDesc, 12) && !self.isHighlight) {
            z19 = false;
        } else {
            z19 = true;
        }
        if (z19) {
            output.y(serialDesc, 12, self.isHighlight);
        }
        if (!output.A(serialDesc, 13) && !self.renderContentOnly) {
            z20 = false;
        } else {
            z20 = true;
        }
        if (z20) {
            output.y(serialDesc, 13, self.renderContentOnly);
        }
        if (!output.A(serialDesc, 14) && self.messageFrame == null) {
            z21 = false;
        } else {
            z21 = true;
        }
        if (z21) {
            output.u(serialDesc, 14, MessageFrameSerializer.INSTANCE, self.messageFrame);
        }
        if (!output.A(serialDesc, 15) && self.reactTag == null) {
            z22 = false;
        } else {
            z22 = true;
        }
        if (z22) {
            output.u(serialDesc, 15, m0.f32999a, self.reactTag);
        }
        ...
        if (z23) {
            output.u(serialDesc, 16, Truncation$$serializer.INSTANCE, self.truncation);
        }
        if (!output.A(serialDesc, 17) && self.backgroundHighlight == null) {
            z24 = false;
        } else {
            z24 = true;
        }
        if (z24) {
            output.u(serialDesc, 17, BackgroundHighlight$$serializer.INSTANCE, self.backgroundHighlight);
        }
        if (output.A(serialDesc, 18) || self.enableSwipeToReply) {
            z25 = true;
        }
        if (z25) {
            output.y(serialDesc, 18, self.enableSwipeToReply);
        }
    }
    ...
    public /* synthetic */ MessageRow(int i10, ChangeType changeType, Boolean bool, Boolean bool2, MessageBase messageBase, Boolean bool3, Boolean bool4, Boolean bool5, String str, String str2, String str3, ReactionsTheme reactionsTheme, boolean z10, boolean z11, MessageFrame messageFrame, Integer num, Truncation truncation, BackgroundHighlight backgroundHighlight, boolean z12, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, changeType, (i11 & 4) != 0 ? null : bool, (i11 & 8) != 0 ? null : bool2, messageBase, (i11 & 32) != 0 ? null : bool3, (i11 & 64) != 0 ? null : bool4, (i11 & 128) != 0 ? null : bool5, (i11 & Spliterator.NONNULL) != 0 ? null : str, (i11 & 512) != 0 ? null : str2, (i11 & Spliterator.IMMUTABLE) != 0 ? null : str3, (i11 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : reactionsTheme, (i11 & 4096) != 0 ? false : z10, (i11 & 8192) != 0 ? false : z11, (i11 & Spliterator.SUBSIZED) != 0 ? null : messageFrame, (32768 & i11) != 0 ? null : num, (65536 & i11) != 0 ? null : truncation, (131072 & i11) != 0 ? null : backgroundHighlight, (i11 & 262144) != 0 ? false : z12);
    }
