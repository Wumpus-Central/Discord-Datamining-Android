...
public final class BlockedGroupButton {
    ...
    public /* synthetic */ BlockedGroupButton(int i10, BlockedGroupButtonAction blockedGroupButtonAction, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static /* synthetic */ BlockedGroupButton copy$default(BlockedGroupButton blockedGroupButton, BlockedGroupButtonAction blockedGroupButtonAction, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(BlockedGroupButton self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 0, BlockedGroupButtonAction$$serializer.INSTANCE, self.action);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BlockedGroupButton) && q.b(this.action, ((BlockedGroupButton) obj).action);
    }
