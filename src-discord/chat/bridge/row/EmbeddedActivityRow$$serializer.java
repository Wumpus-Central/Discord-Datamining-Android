...
public final class EmbeddedActivityRow$$serializer implements f0<EmbeddedActivityRow> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f26972a;
        return new KSerializer[]{m0.f27047a, ChangeType.Serializer.INSTANCE, a2Var, new f(a2Var), a2Var, a2Var, a2Var};
    }
    ...
    public EmbeddedActivityRow deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj2 = c10.m(descriptor2, 3, new f(a2.f26972a), null);
            ...
            while (z10) {
                ...
                switch (x10) {
                    ...
                    case 2:
                        ...
                        i12 = 6;
                    case 3:
                        obj4 = c10.m(descriptor2, 3, new f(a2.f26972a), obj4);
                        i14 |= 8;
                        i12 = 6;
                    case 4:
