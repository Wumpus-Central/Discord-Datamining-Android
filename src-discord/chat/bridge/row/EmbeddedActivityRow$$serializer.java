...
public final class EmbeddedActivityRow$$serializer implements f0<EmbeddedActivityRow> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f29758a;
        return new KSerializer[]{m0.f29833a, ChangeType.Serializer.INSTANCE, a2Var, new f(a2Var), a2Var, a2Var, a2Var};
    }
    ...
    public EmbeddedActivityRow deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj2 = b10.y(descriptor2, 3, new f(a2.f29758a), null);
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 2:
                        ...
                        i12 = 6;
                    case 3:
                        obj4 = b10.y(descriptor2, 3, new f(a2.f29758a), obj4);
                        i14 |= 8;
                        i12 = 6;
                    case 4:
