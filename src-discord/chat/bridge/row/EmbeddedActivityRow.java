...
public final class EmbeddedActivityRow extends Row {
    ...
    public static final void write$Self(EmbeddedActivityRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 2, self.content);
        output.C(serialDesc, 3, new ti.f(a2.f26972a), self.avatarUrls);
        output.t(serialDesc, 4, self.buttonText);
        output.t(serialDesc, 5, self.embeddedActivityKey);
        output.t(serialDesc, 6, self.dismissButtonAccessibilityLabel);
    }
