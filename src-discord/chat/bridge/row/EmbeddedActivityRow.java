...
public final class EmbeddedActivityRow extends Row {
    ...
    public static final void write$Self(EmbeddedActivityRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 3, new xi.f(a2.f30574a), self.avatarUrls);
    ...
    public boolean equals(Object obj) {
        ...
        return getIndex() == embeddedActivityRow.getIndex() && getChangeType() == embeddedActivityRow.getChangeType() && q.c(this.content, embeddedActivityRow.content) && q.c(this.avatarUrls, embeddedActivityRow.avatarUrls) && q.c(this.buttonText, embeddedActivityRow.buttonText) && q.c(this.embeddedActivityKey, embeddedActivityRow.embeddedActivityKey) && q.c(this.dismissButtonAccessibilityLabel, embeddedActivityRow.dismissButtonAccessibilityLabel);
    }
