...
public final class EmbeddedActivityRow extends Row {
    ...
    public /* synthetic */ EmbeddedActivityRow(int i10, int i11, ChangeType changeType, String str, List list, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (127 != (i10 & 127)) {
    ...
    public static /* synthetic */ EmbeddedActivityRow copy$default(EmbeddedActivityRow embeddedActivityRow, int i10, ChangeType changeType, String str, List list, String str2, String str3, String str4, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(EmbeddedActivityRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 2, self.content);
        output.q(serialDesc, 3, new yj.f(a2.f32931a), self.avatarUrls);
        output.z(serialDesc, 4, self.buttonText);
        output.z(serialDesc, 5, self.embeddedActivityKey);
        output.z(serialDesc, 6, self.dismissButtonAccessibilityLabel);
    }
