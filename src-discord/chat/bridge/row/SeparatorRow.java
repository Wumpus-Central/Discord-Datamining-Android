...
public final class SeparatorRow extends Row {
    ...
    public static final void write$Self(SeparatorRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.z(serialDesc, 0, ChangeType.Serializer.INSTANCE, self.getChangeType());
        output.w(serialDesc, 1, self.getIndex());
        output.y(serialDesc, 2, self.text);
        output.y(serialDesc, 3, self.f7702id);
    ...
    public boolean equals(Object obj) {
        ...
        return getChangeType() == separatorRow.getChangeType() && getIndex() == separatorRow.getIndex() && q.b(this.text, separatorRow.text) && q.b(this.f7702id, separatorRow.f7702id) && this.color == separatorRow.color && q.b(this.scrollTo, separatorRow.scrollTo);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((getChangeType().hashCode() * 31) + getIndex()) * 31) + this.text.hashCode()) * 31) + this.f7702id.hashCode()) * 31) + this.color) * 31;
