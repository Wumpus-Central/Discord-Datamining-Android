...
public final class SeparatorRow extends Row {
    ...
    public static final void write$Self(SeparatorRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.q(serialDesc, 0, ChangeType.Serializer.INSTANCE, self.getChangeType());
        output.x(serialDesc, 1, self.getIndex());
        output.z(serialDesc, 2, self.text);
        output.z(serialDesc, 3, self.f7625id);
        ...
        if (!output.A(serialDesc, 6) && self.isBeforeContent == null) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (z11) {
            output.u(serialDesc, 6, h.f32976a, self.isBeforeContent);
        }
        if (output.A(serialDesc, 7) || self.summary != null) {
            z12 = true;
        }
        if (z12) {
            output.u(serialDesc, 7, Summary$$serializer.INSTANCE, self.summary);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((getChangeType().hashCode() * 31) + getIndex()) * 31) + this.text.hashCode()) * 31) + this.f7625id.hashCode()) * 31) + this.color) * 31;
