...
public final class SeparatorRow extends Row {
    ...
    public boolean equals(Object obj) {
        ...
        return getChangeType() == separatorRow.getChangeType() && getIndex() == separatorRow.getIndex() && q.b(this.text, separatorRow.text) && q.b(this.f7625id, separatorRow.f7625id) && this.color == separatorRow.color && q.b(this.scrollTo, separatorRow.scrollTo);
    }
