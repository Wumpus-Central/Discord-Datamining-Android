...
public final class SeparatorRow extends Row {
    ...
    public static final void write$Self(SeparatorRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.s(serialDesc, 3, self.f7109id);
        ...
        if (z11) {
            output.z(serialDesc, 6, h.f29582a, self.isBeforeContent);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return getChangeType() == separatorRow.getChangeType() && getIndex() == separatorRow.getIndex() && q.c(this.text, separatorRow.text) && q.c(this.f7109id, separatorRow.f7109id) && this.color == separatorRow.color && q.c(this.scrollTo, separatorRow.scrollTo) && q.c(this.isBeforeContent, separatorRow.isBeforeContent) && q.c(this.summary, separatorRow.summary);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((getChangeType().hashCode() * 31) + getIndex()) * 31) + this.text.hashCode()) * 31) + this.f7109id.hashCode()) * 31) + this.color) * 31;
