...
public final class SeparatorRow extends Row {
    ...
    public static final void write$Self(SeparatorRow self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.C(serialDesc, 0, ChangeType.Serializer.INSTANCE, self.getChangeType());
        output.r(serialDesc, 1, self.getIndex());
        output.t(serialDesc, 2, self.text);
        output.t(serialDesc, 3, self.f7295id);
        output.r(serialDesc, 4, self.color);
        ...
        if (z10) {
            output.e(serialDesc, 5, h.f26982a, self.scrollTo);
        }
        ...
        if (z11) {
            output.e(serialDesc, 6, h.f26982a, self.isBeforeContent);
        }
    ...
    public int hashCode() {
        int hashCode = ((((((((getChangeType().hashCode() * 31) + getIndex()) * 31) + this.text.hashCode()) * 31) + this.f7295id.hashCode()) * 31) + this.color) * 31;
