...
public final class LoadingAction$$serializer implements f0<LoadingAction> {
    ...
    public LoadingAction deserialize(Decoder decoder) {
        ...
        int i10 = 1;
        if (c10.y()) {
            obj = c10.m(descriptor2, 0, LoadingActionType.Companion.serializer(), null);
        } else {
            int i11 = 0;
            obj = null;
            while (i10 != 0) {
                ...
                if (x10 == -1) {
                    ...
                    obj = c10.m(descriptor2, 0, LoadingActionType.Companion.serializer(), obj);
                    i11 |= 1;
                } else {
                    throw new n(x10);
                }
    ...
    public void serialize(Encoder encoder, LoadingAction value) {
        ...
        LoadingAction.write$Self(value, c10, descriptor2);
        c10.b(descriptor2);
    }
