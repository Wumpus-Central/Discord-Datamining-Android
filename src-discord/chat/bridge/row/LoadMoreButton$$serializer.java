...
public final class LoadMoreButton$$serializer implements f0<LoadMoreButton> {
    ...
    public KSerializer<?>[] childSerializers() {
        m0 m0Var = m0.f32384a;
        return new KSerializer[]{LoadingAction$$serializer.INSTANCE, a2.f32309a, m0Var, a.u(m0Var), a.u(m0Var)};
    }
        ...
        if (b10.p()) {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj5 = b10.n(descriptor2, 3, m0.f32384a, obj5);
                    i13 |= 8;
                } else if (o10 == 4) {
                    obj6 = b10.n(descriptor2, 4, m0.f32384a, obj6);
                    i13 |= 16;
                } else {
                    throw new n(o10);
                }
