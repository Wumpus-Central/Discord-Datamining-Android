...
public final class BlockedGroupButtonAction {
    ...
    public  BlockedGroupButtonAction(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  BlockedGroupButtonAction copy$default(BlockedGroupButtonAction blockedGroupButtonAction, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(BlockedGroupButtonAction self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 1, self.context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.type, blockedGroupButtonAction.type) && q.c(this.context, blockedGroupButtonAction.context);
    }
