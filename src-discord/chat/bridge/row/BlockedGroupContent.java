...
public final class BlockedGroupContent {
    ...
    public  BlockedGroupContent(int i10, @f(with = MessageSerializer.class) MessageBase messageBase, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  BlockedGroupContent copy$default(BlockedGroupContent blockedGroupContent, MessageBase messageBase, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(BlockedGroupContent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, MessageSerializer.INSTANCE, self.message);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BlockedGroupContent) && q.c(this.message, ((BlockedGroupContent) obj).message);
    }
