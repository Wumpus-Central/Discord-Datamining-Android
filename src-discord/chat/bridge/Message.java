...
public final class Message extends MessageBase {
    ...
    private Message(int i10, int i11, int i12, MessageType messageType, String str, String str2, ChannelId channelId, GuildId guildId, MessageState messageState, UserId userId, long j10, String str3, Float f10, String str4, String str5, Integer num, Integer num2, boolean z10, boolean z11, Integer num3, String str6, String str7, List<Embed> list, List<Attachment> list2, Float f11, StructurableText structurableText, List<UploadProgress> list3, List<MessageReaction> list4, Boolean bool, List<? extends CodedLinkEmbed> list5, List<Sticker> list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z12, Boolean bool2, Boolean bool3, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List<? extends Component> list7, String str8, Boolean bool4, String str9, Boolean bool5, Integer num4, Integer num5, String str10, String str11, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool6, Boolean bool7, Boolean bool8, String str12, String str13, List<String> list8, Boolean bool9, Boolean bool10, Long l10, Sticker sticker, String str14, String str15, Boolean bool11, ActivityInviteEmbed activityInviteEmbed, boolean z13, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List<? extends GiftEmbed> list9, GiftEmbed giftEmbed, Integer num6, String str16, List<PostPreviewEmbed> list10, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.useAttachmentGridLayout = (i11 & 65536) == 0 ? Boolean.FALSE : bool6;
        this.useAttachmentUploadPreview = (i11 & 131072) == 0 ? Boolean.FALSE : bool7;
        this.isCurrentUserMessageAuthor = (i11 & 262144) == 0 ? Boolean.FALSE : bool8;
        if ((524288 & i11) == 0) {
            this.title = null;
        } else {
            this.title = str12;
        ...
        if ((268435456 & i11) == 0) {
            ...
            this.showInviteToSpeakButton = bool11;
        }
        if ((536870912 & i11) == 0) {
    ...
    public static final void write$Self(Message self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 1, messageId$$serializer, MessageId.m590boximpl(self.f7286id));
        if (output.w(serialDesc, 2) || self.nonce != null) {
            String str = self.nonce;
            output.e(serialDesc, 2, messageId$$serializer, str != null ? MessageId.m590boximpl(str) : null);
        }
        output.C(serialDesc, 3, ChannelId$$serializer.INSTANCE, ChannelId.m564boximpl(self.channelId));
        ...
        if (output.w(serialDesc, 8) || self.edited != null) {
            output.e(serialDesc, 8, a2.f26972a, self.edited);
        }
        if (output.w(serialDesc, 9) || self._constrainedWidth != null) {
            output.e(serialDesc, 9, e0.f26997a, self._constrainedWidth);
        }
        if (output.w(serialDesc, 10) || self.timestamp != null) {
            output.e(serialDesc, 10, a2.f26972a, self.timestamp);
        }
        if (output.w(serialDesc, 11) || self.username != null) {
            output.e(serialDesc, 11, a2.f26972a, self.username);
        }
        if (output.w(serialDesc, 12) || self.usernameColor != null) {
            output.e(serialDesc, 12, m0.f27047a, self.usernameColor);
        }
        if (output.w(serialDesc, 13) || self.roleColor != null) {
            output.e(serialDesc, 13, m0.f27047a, self.roleColor);
        }
        ...
        if (output.w(serialDesc, 16) || self.colorString != null) {
            output.e(serialDesc, 16, m0.f27047a, self.colorString);
        }
        if (output.w(serialDesc, 17) || self.avatarURL != null) {
            output.e(serialDesc, 17, a2.f26972a, self.avatarURL);
        }
        if (output.w(serialDesc, 18) || self.avatarDecorationURL != null) {
            output.e(serialDesc, 18, a2.f26972a, self.avatarDecorationURL);
        }
        ...
        if (output.w(serialDesc, 21) || self.attachmentsOpacity != null) {
            output.e(serialDesc, 21, e0.f26997a, self.attachmentsOpacity);
        }
        ...
        if (output.w(serialDesc, 25) || !q.b(self.useAddBurstReaction, Boolean.FALSE)) {
            output.e(serialDesc, 25, h.f27014a, self.useAddBurstReaction);
        }
        if (output.w(serialDesc, 26) || self.codedLinks != null) {
            output.e(serialDesc, 26, new ti.f(a.u(CodedLinkSerializer.INSTANCE)), self.codedLinks);
        }
        if (output.w(serialDesc, 27) || self.stickers != null) {
            output.e(serialDesc, 27, new ti.f(Sticker$$serializer.INSTANCE), self.stickers);
        }
        ...
        output.s(serialDesc, 31, self.mentioned);
        if (output.w(serialDesc, 32) || self.gifAutoPlay != null) {
            output.e(serialDesc, 32, h.f27014a, self.gifAutoPlay);
        }
        if (output.w(serialDesc, 33) || self.animateEmoji != null) {
            output.e(serialDesc, 33, h.f27014a, self.animateEmoji);
        }
        ...
        if (output.w(serialDesc, 36) || self.components != null) {
            output.e(serialDesc, 36, new ti.f(ComponentSerializer.INSTANCE), self.components);
        }
        if (output.w(serialDesc, 37) || self.threadStarterMessageHeader != null) {
            output.e(serialDesc, 37, a2.f26972a, self.threadStarterMessageHeader);
        }
        if (output.w(serialDesc, 38) || self.communicationDisabled != null) {
            output.e(serialDesc, 38, h.f27014a, self.communicationDisabled);
        }
        if (output.w(serialDesc, 39) || self.tagText != null) {
            output.e(serialDesc, 39, a2.f26972a, self.tagText);
        }
        if (output.w(serialDesc, 40) || self.tagVerified != null) {
            output.e(serialDesc, 40, h.f27014a, self.tagVerified);
        }
        if (output.w(serialDesc, 41) || self.tagTextColor != null) {
            output.e(serialDesc, 41, m0.f27047a, self.tagTextColor);
        }
        if (output.w(serialDesc, 42) || self.tagBackgroundColor != null) {
            output.e(serialDesc, 42, m0.f27047a, self.tagBackgroundColor);
        }
        if (output.w(serialDesc, 43) || self.tagType != null) {
            output.e(serialDesc, 43, a2.f26972a, self.tagType);
        }
        if (output.w(serialDesc, 44) || self.opTagText != null) {
            output.e(serialDesc, 44, a2.f26972a, self.opTagText);
        }
        if (output.w(serialDesc, 45) || self.ephemeralIndication != null) {
            output.e(serialDesc, 45, EphemeralIndication$$serializer.INSTANCE, self.ephemeralIndication);
        }
        if (output.w(serialDesc, 46) || self.surveyIndication != null) {
            output.e(serialDesc, 46, SurveyIndication$$serializer.INSTANCE, self.surveyIndication);
        }
        if (output.w(serialDesc, 47) || self.interactionStatus != null) {
            output.e(serialDesc, 47, InteractionStatus$$serializer.INSTANCE, self.interactionStatus);
        }
        if (output.w(serialDesc, 48) || !q.b(self.useAttachmentGridLayout, Boolean.FALSE)) {
            output.e(serialDesc, 48, h.f27014a, self.useAttachmentGridLayout);
        }
        if (output.w(serialDesc, 49) || !q.b(self.useAttachmentUploadPreview, Boolean.FALSE)) {
            output.e(serialDesc, 49, h.f27014a, self.useAttachmentUploadPreview);
        }
        if (output.w(serialDesc, 50) || !q.b(self.isCurrentUserMessageAuthor, Boolean.FALSE)) {
            output.e(serialDesc, 50, h.f27014a, self.isCurrentUserMessageAuthor);
        }
        if (output.w(serialDesc, 51) || self.title != null) {
            output.e(serialDesc, 51, a2.f26972a, self.title);
        }
        if (output.w(serialDesc, 52) || self.description != null) {
            output.e(serialDesc, 52, a2.f26972a, self.description);
        }
        if (output.w(serialDesc, 53) || self.avatarURLs != null) {
            output.e(serialDesc, 53, new ti.f(a2.f26972a), self.avatarURLs);
        }
        if (output.w(serialDesc, 54) || self.isCallActive != null) {
            output.e(serialDesc, 54, h.f27014a, self.isCallActive);
        }
        if (output.w(serialDesc, 55) || self.missed != null) {
            output.e(serialDesc, 55, h.f27014a, self.missed);
        }
        if (output.w(serialDesc, 56) || self.rawMilliseconds != null) {
            output.e(serialDesc, 56, w0.f27088a, self.rawMilliseconds);
        }
        if (output.w(serialDesc, 57) || self.sticker != null) {
            output.e(serialDesc, 57, Sticker$$serializer.INSTANCE, self.sticker);
        }
        if (output.w(serialDesc, 58) || self.stickerLabel != null) {
            output.e(serialDesc, 58, a2.f26972a, self.stickerLabel);
        }
        if (output.w(serialDesc, 59) || self.buttonLabel != null) {
            output.e(serialDesc, 59, a2.f26972a, self.buttonLabel);
        }
        if (output.w(serialDesc, 60) || self.showInviteToSpeakButton != null) {
            output.e(serialDesc, 60, h.f27014a, self.showInviteToSpeakButton);
        }
        if (output.w(serialDesc, 61) || self.activityInviteEmbed != null) {
            output.e(serialDesc, 61, ActivityInviteEmbed$$serializer.INSTANCE, self.activityInviteEmbed);
        }
        if (output.w(serialDesc, 62) || self.isFirstForumPostMessage) {
            output.s(serialDesc, 62, self.isFirstForumPostMessage);
        }
        if (output.w(serialDesc, 63) || self.postActions != null) {
            output.e(serialDesc, 63, ForumPostActions$$serializer.INSTANCE, self.postActions);
        }
        if (output.w(serialDesc, 64) || self.autoModerationContext != null) {
            output.e(serialDesc, 64, AutoModerationContext$$serializer.INSTANCE, self.autoModerationContext);
        }
        if (output.w(serialDesc, 65) || self.giftCodes != null) {
            output.e(serialDesc, 65, new ti.f(GiftEmbedSerializer.INSTANCE), self.giftCodes);
        }
        if (output.w(serialDesc, 66) || self.referralTrialOffer != null) {
            output.e(serialDesc, 66, GiftEmbedSerializer.INSTANCE, self.referralTrialOffer);
        }
        if (output.w(serialDesc, 67) || self.totalMonthsSubscribed != null) {
            output.e(serialDesc, 67, m0.f27047a, self.totalMonthsSubscribed);
        }
        if (output.w(serialDesc, 68) || self.swipeToReplyIconUrl != null) {
            output.e(serialDesc, 68, a2.f26972a, self.swipeToReplyIconUrl);
        }
        if (output.w(serialDesc, 69) || self.postPreviewEmbeds != null) {
            z10 = true;
        }
        if (z10) {
            output.e(serialDesc, 69, new ti.f(PostPreviewEmbed$$serializer.INSTANCE), self.postPreviewEmbeds);
        }
    }
    ...
    */
    ...
    public int hashCode() {
        int hashCode = ((this.type.hashCode() * 31) + MessageId.m595hashCodeimpl(this.f7286id)) * 31;
        String str = this.nonce;
        int i10 = 0;
        int i11 = (((hashCode + (str == null ? 0 : MessageId.m595hashCodeimpl(str))) * 31) + ChannelId.m569hashCodeimpl(this.channelId)) * 31;
        GuildId guildId = this.guildId;
        int i12 = (i11 + (guildId == null ? 0 : GuildId.m582hashCodeimpl(guildId.m586unboximpl()))) * 31;
        ...
        int i13 = (((hashCode2 + (userId == null ? 0 : UserId.m633hashCodeimpl(userId.m637unboximpl()))) * 31) + b.a(this.flags)) * 31;
        ...
        Boolean bool6 = this.useAttachmentGridLayout;
        int hashCode40 = (hashCode39 + (bool6 == null ? 0 : bool6.hashCode())) * 31;
        Boolean bool7 = this.useAttachmentUploadPreview;
        int hashCode41 = (hashCode40 + (bool7 == null ? 0 : bool7.hashCode())) * 31;
        Boolean bool8 = this.isCurrentUserMessageAuthor;
        ...
        Boolean bool9 = this.isCallActive;
        int hashCode46 = (hashCode45 + (bool9 == null ? 0 : bool9.hashCode())) * 31;
        Boolean bool10 = this.missed;
        ...
        Boolean bool11 = this.showInviteToSpeakButton;
    ...
    public String toString() {
        ...
        String str = MessageId.m596toStringimpl(this.f7286id);
        String str2 = this.nonce;
        String str3 = str2 == null ? "null" : MessageId.m596toStringimpl(str2);
        String str4 = ChannelId.m571toStringimpl(this.channelId);
        GuildId guildId = this.guildId;
        MessageState messageState = this.state;
        UserId userId = this.authorId;
        long j10 = this.flags;
        ...
        List<PostPreviewEmbed> list10 = this.postPreviewEmbeds;
        return "Message(type=" + messageType + ", id=" + str + ", nonce=" + str3 + ", channelId=" + str4 + ", guildId=" + guildId + ", state=" + messageState + ", authorId=" + userId + ", flags=" + j10 + ", edited=" + str5 + ", _constrainedWidth=" + f10 + ", timestamp=" + str6 + ", username=" + str7 + ", usernameColor=" + num + ", roleColor=" + num2 + ", shouldShowRoleDot=" + z10 + ", shouldShowRoleOnName=" + z11 + ", colorString=" + num3 + ", avatarURL=" + str8 + ", avatarDecorationURL=" + str9 + ", embeds=" + list + ", attachments=" + list2 + ", attachmentsOpacity=" + f11 + ", content=" + structurableText + ", progress=" + list3 + ", reactions=" + list4 + ", useAddBurstReaction=" + bool + ", codedLinks=" + list5 + ", stickers=" + list6 + ", roleIcon=" + roleIcon + ", connectionsRoleTag=" + connectionsRoleTag + ", threadEmbed=" + threadEmbed + ", mentioned=" + z12 + ", gifAutoPlay=" + bool2 + ", animateEmoji=" + bool3 + ", referencedMessage=" + referencedMessage + ", executedCommand=" + executedCommand + ", components=" + list7 + ", threadStarterMessageHeader=" + str10 + ", communicationDisabled=" + bool4 + ", tagText=" + str11 + ", tagVerified=" + bool5 + ", tagTextColor=" + num4 + ", tagBackgroundColor=" + num5 + ", tagType=" + str12 + ", opTagText=" + str13 + ", ephemeralIndication=" + ephemeralIndication + ", surveyIndication=" + surveyIndication + ", interactionStatus=" + interactionStatus + ", useAttachmentGridLayout=" + bool6 + ", useAttachmentUploadPreview=" + bool7 + ", isCurrentUserMessageAuthor=" + bool8 + ", title=" + str14 + ", description=" + str15 + ", avatarURLs=" + list8 + ", isCallActive=" + bool9 + ", missed=" + bool10 + ", rawMilliseconds=" + l10 + ", sticker=" + sticker + ", stickerLabel=" + str16 + ", buttonLabel=" + str17 + ", showInviteToSpeakButton=" + bool11 + ", activityInviteEmbed=" + activityInviteEmbed + ", isFirstForumPostMessage=" + z13 + ", postActions=" + forumPostActions + ", autoModerationContext=" + autoModerationContext + ", giftCodes=" + list9 + ", referralTrialOffer=" + giftEmbed + ", totalMonthsSubscribed=" + num6 + ", swipeToReplyIconUrl=" + str18 + ", postPreviewEmbeds=" + list10 + ")";
    }

    public /* synthetic */ Message(MessageType messageType, String str, String str2, long j10, GuildId guildId, MessageState messageState, UserId userId, long j11, String str3, Float f10, String str4, String str5, Integer num, Integer num2, boolean z10, boolean z11, Integer num3, String str6, String str7, List list, List list2, Float f11, StructurableText structurableText, List list3, List list4, Boolean bool, List list5, List list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z12, Boolean bool2, Boolean bool3, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List list7, String str8, Boolean bool4, String str9, Boolean bool5, Integer num4, Integer num5, String str10, String str11, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool6, Boolean bool7, Boolean bool8, String str12, String str13, List list8, Boolean bool9, Boolean bool10, Long l10, Sticker sticker, String str14, String str15, Boolean bool11, ActivityInviteEmbed activityInviteEmbed, boolean z13, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List list9, GiftEmbed giftEmbed, Integer num6, String str16, List list10, int i10, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this(messageType, str, (i10 & 4) != 0 ? null : str2, j10, (i10 & 16) != 0 ? null : guildId, (i10 & 32) != 0 ? null : messageState, (i10 & 64) != 0 ? null : userId, (i10 & 128) != 0 ? 0L : j11, (i10 & 256) != 0 ? null : str3, (i10 & 512) != 0 ? null : f10, (i10 & 1024) != 0 ? null : str4, (i10 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : str5, (i10 & RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? null : num, (i10 & 8192) != 0 ? null : num2, (i10 & 16384) != 0 ? false : z10, (i10 & 32768) != 0 ? false : z11, (i10 & 65536) != 0 ? null : num3, (i10 & 131072) != 0 ? null : str6, (i10 & 262144) != 0 ? null : str7, (i10 & 524288) != 0 ? null : list, (i10 & 1048576) != 0 ? null : list2, (i10 & 2097152) != 0 ? null : f11, (i10 & 4194304) != 0 ? null : structurableText, (i10 & 8388608) != 0 ? null : list3, (i10 & 16777216) != 0 ? null : list4, (i10 & 33554432) != 0 ? Boolean.FALSE : bool, (i10 & 67108864) != 0 ? null : list5, (i10 & 134217728) != 0 ? null : list6, (i10 & 268435456) != 0 ? null : roleIcon, (i10 & 536870912) != 0 ? null : connectionsRoleTag, (i10 & 1073741824) != 0 ? null : threadEmbed, z12, (i11 & 1) != 0 ? null : bool2, (i11 & 2) != 0 ? null : bool3, (i11 & 4) != 0 ? null : referencedMessage, (i11 & 8) != 0 ? null : executedCommand, (i11 & 16) != 0 ? null : list7, (i11 & 32) != 0 ? null : str8, (i11 & 64) != 0 ? null : bool4, (i11 & 128) != 0 ? null : str9, (i11 & 256) != 0 ? null : bool5, (i11 & 512) != 0 ? null : num4, (i11 & 1024) != 0 ? null : num5, (i11 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : str10, (i11 & RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? null : str11, (i11 & 8192) != 0 ? null : ephemeralIndication, (i11 & 16384) != 0 ? null : surveyIndication, (32768 & i11) != 0 ? null : interactionStatus, (i11 & 65536) != 0 ? Boolean.FALSE : bool6, (i11 & 131072) != 0 ? Boolean.FALSE : bool7, (i11 & 262144) != 0 ? Boolean.FALSE : bool8, (i11 & 524288) != 0 ? null : str12, (i11 & 1048576) != 0 ? null : str13, (i11 & 2097152) != 0 ? null : list8, (i11 & 4194304) != 0 ? null : bool9, (8388608 & i11) != 0 ? null : bool10, (16777216 & i11) != 0 ? null : l10, (33554432 & i11) != 0 ? null : sticker, (67108864 & i11) != 0 ? null : str14, (134217728 & i11) != 0 ? null : str15, (268435456 & i11) != 0 ? null : bool11, (536870912 & i11) != 0 ? null : activityInviteEmbed, (1073741824 & i11) != 0 ? false : z13, (i11 & Integer.MIN_VALUE) != 0 ? null : forumPostActions, (i12 & 1) != 0 ? null : autoModerationContext, (i12 & 2) != 0 ? null : list9, (i12 & 4) != 0 ? null : giftEmbed, (i12 & 8) != 0 ? null : num6, (i12 & 16) != 0 ? null : str16, (i12 & 32) != 0 ? null : list10, null);
    }
    ...
    private Message(MessageType messageType, String str, String str2, long j10, GuildId guildId, MessageState messageState, UserId userId, long j11, String str3, Float f10, String str4, String str5, Integer num, Integer num2, boolean z10, boolean z11, Integer num3, String str6, String str7, List<Embed> list, List<Attachment> list2, Float f11, StructurableText structurableText, List<UploadProgress> list3, List<MessageReaction> list4, Boolean bool, List<? extends CodedLinkEmbed> list5, List<Sticker> list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z12, Boolean bool2, Boolean bool3, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List<? extends Component> list7, String str8, Boolean bool4, String str9, Boolean bool5, Integer num4, Integer num5, String str10, String str11, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool6, Boolean bool7, Boolean bool8, String str12, String str13, List<String> list8, Boolean bool9, Boolean bool10, Long l10, Sticker sticker, String str14, String str15, Boolean bool11, ActivityInviteEmbed activityInviteEmbed, boolean z13, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List<? extends GiftEmbed> list9, GiftEmbed giftEmbed, Integer num6, String str16, List<PostPreviewEmbed> list10) {
        ...
        this.surveyIndication = surveyIndication;
        this.interactionStatus = interactionStatus;
        this.useAttachmentGridLayout = bool6;
        this.useAttachmentUploadPreview = bool7;
        this.isCurrentUserMessageAuthor = bool8;
        this.title = str12;
        this.description = str13;
        this.avatarURLs = list8;
        this.isCallActive = bool9;
