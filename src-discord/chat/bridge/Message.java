...
public final class Message extends MessageBase {
    ...
    public static final void write$Self(Message self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.n(serialDesc, 1, messageId$$serializer, MessageId.m590boximpl(self.f6878id));
        if (output.w(serialDesc, 2) || self.nonce != null) {
            String str = self.nonce;
            output.z(serialDesc, 2, messageId$$serializer, str != null ? MessageId.m590boximpl(str) : null);
        }
        output.n(serialDesc, 3, ChannelId$$serializer.INSTANCE, ChannelId.m564boximpl(self.channelId));
    ...
    */
    ...
    public int hashCode() {
        int hashCode = ((this.type.hashCode() * 31) + MessageId.m595hashCodeimpl(this.f6878id)) * 31;
    ...
    public String toString() {
        ...
        String str = MessageId.m596toStringimpl(this.f6878id);
