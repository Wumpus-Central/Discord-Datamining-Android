...
public final class Message extends MessageBase {
    ...
    private Message(int i10, int i11, int i12, MessageType messageType, String str, String str2, ChannelId channelId, GuildId guildId, MessageState messageState, UserId userId, long j10, String str3, Float f10, String str4, String str5, Integer num, Integer num2, boolean z10, boolean z11, Integer num3, String str6, String str7, List<Embed> list, List<Attachment> list2, Float f11, StructurableText structurableText, List<UploadProgress> list3, List<MessageReaction> list4, Boolean bool, Boolean bool2, List<? extends CodedLinkEmbed> list5, List<Sticker> list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z12, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List<? extends Component> list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, Integer num5, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List<String> list8, Boolean bool10, Boolean bool11, Long l10, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z13, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List<? extends GiftEmbed> list9, GiftEmbed giftEmbed, Integer num6, String str15, List<PostPreviewEmbed> list10, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.useAttachmentGridLayout = (i11 & 65536) == 0 ? Boolean.FALSE : bool7;
        this.useAttachmentUploadPreview = (i11 & 131072) == 0 ? Boolean.FALSE : bool8;
        this.isCurrentUserMessageAuthor = (i11 & 262144) == 0 ? Boolean.FALSE : bool9;
        if ((524288 & i11) == 0) {
            this.title = null;
        } else {
            this.title = str11;
    ...
    public /* synthetic */ Message(int i10, int i11, int i12, MessageType messageType, String str, String str2, ChannelId channelId, GuildId guildId, MessageState messageState, UserId userId, long j10, String str3, Float f10, String str4, String str5, Integer num, Integer num2, boolean z10, boolean z11, Integer num3, String str6, String str7, List list, List list2, Float f11, StructurableText structurableText, List list3, List list4, Boolean bool, Boolean bool2, List list5, List list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z12, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, Integer num5, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List list8, Boolean bool10, Boolean bool11, Long l10, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z13, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List list9, GiftEmbed giftEmbed, Integer num6, String str15, List list10, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, i11, i12, messageType, str, str2, channelId, guildId, messageState, userId, j10, str3, f10, str4, str5, num, num2, z10, z11, num3, str6, str7, list, list2, f11, structurableText, list3, list4, bool, bool2, list5, list6, roleIcon, connectionsRoleTag, threadEmbed, z12, bool3, bool4, referencedMessage, executedCommand, list7, str8, bool5, str9, bool6, num4, num5, str10, ephemeralIndication, surveyIndication, interactionStatus, bool7, bool8, bool9, str11, str12, list8, bool10, bool11, l10, sticker, str13, str14, bool12, activityInviteEmbed, z13, forumPostActions, autoModerationContext, list9, giftEmbed, num6, str15, list10, serializationConstructorMarker);
    }

    public /* synthetic */ Message(MessageType messageType, String str, String str2, long j10, GuildId guildId, MessageState messageState, UserId userId, long j11, String str3, Float f10, String str4, String str5, Integer num, Integer num2, boolean z10, boolean z11, Integer num3, String str6, String str7, List list, List list2, Float f11, StructurableText structurableText, List list3, List list4, Boolean bool, Boolean bool2, List list5, List list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z12, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List list7, String str8, Boolean bool5, String str9, Boolean bool6, Integer num4, Integer num5, String str10, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str11, String str12, List list8, Boolean bool10, Boolean bool11, Long l10, Sticker sticker, String str13, String str14, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z13, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List list9, GiftEmbed giftEmbed, Integer num6, String str15, List list10, DefaultConstructorMarker defaultConstructorMarker) {
        this(messageType, str, str2, j10, guildId, messageState, userId, j11, str3, f10, str4, str5, num, num2, z10, z11, num3, str6, str7, list, list2, f11, structurableText, list3, list4, bool, bool2, list5, list6, roleIcon, connectionsRoleTag, threadEmbed, z12, bool3, bool4, referencedMessage, executedCommand, list7, str8, bool5, str9, bool6, num4, num5, str10, ephemeralIndication, surveyIndication, interactionStatus, bool7, bool8, bool9, str11, str12, list8, bool10, bool11, l10, sticker, str13, str14, bool12, activityInviteEmbed, z13, forumPostActions, autoModerationContext, list9, giftEmbed, num6, str15, list10);
    }
    ...
    public static final void write$Self(Message self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.q(serialDesc, 0, MessageType.Serializer.INSTANCE, self.type);
        MessageId$$serializer messageId$$serializer = MessageId$$serializer.INSTANCE;
        output.q(serialDesc, 1, messageId$$serializer, MessageId.m572boximpl(self.f7616id));
        if (output.A(serialDesc, 2) || self.nonce != null) {
            String str = self.nonce;
            output.u(serialDesc, 2, messageId$$serializer, str != null ? MessageId.m572boximpl(str) : null);
        }
        ...
        if (output.A(serialDesc, 4) || self.guildId != null) {
            output.u(serialDesc, 4, GuildId$$serializer.INSTANCE, self.guildId);
        }
        if (output.A(serialDesc, 5) || self.state != null) {
            output.u(serialDesc, 5, MessageState.Serializer.INSTANCE, self.state);
        }
        if (output.A(serialDesc, 6) || self.authorId != null) {
            output.u(serialDesc, 6, UserId$$serializer.INSTANCE, self.authorId);
        }
        if (output.A(serialDesc, 7) || self.flags != 0) {
            output.E(serialDesc, 7, self.flags);
        }
        if (output.A(serialDesc, 8) || self.edited != null) {
            output.u(serialDesc, 8, a2.f32924a, self.edited);
        }
        if (output.A(serialDesc, 9) || self._constrainedWidth != null) {
            output.u(serialDesc, 9, e0.f32949a, self._constrainedWidth);
        }
        if (output.A(serialDesc, 10) || self.timestamp != null) {
            output.u(serialDesc, 10, a2.f32924a, self.timestamp);
        }
        if (output.A(serialDesc, 11) || self.username != null) {
            output.u(serialDesc, 11, a2.f32924a, self.username);
        }
        if (output.A(serialDesc, 12) || self.usernameColor != null) {
            output.u(serialDesc, 12, m0.f32999a, self.usernameColor);
        }
        if (output.A(serialDesc, 13) || self.roleColor != null) {
            output.u(serialDesc, 13, m0.f32999a, self.roleColor);
        }
        if (output.A(serialDesc, 14) || self.shouldShowRoleDot) {
            output.y(serialDesc, 14, self.shouldShowRoleDot);
        }
        if (output.A(serialDesc, 15) || self.shouldShowRoleOnName) {
            output.y(serialDesc, 15, self.shouldShowRoleOnName);
        }
        if (output.A(serialDesc, 16) || self.colorString != null) {
            output.u(serialDesc, 16, m0.f32999a, self.colorString);
        }
        if (output.A(serialDesc, 17) || self.avatarURL != null) {
            output.u(serialDesc, 17, a2.f32924a, self.avatarURL);
        }
        if (output.A(serialDesc, 18) || self.avatarDecorationURL != null) {
            output.u(serialDesc, 18, a2.f32924a, self.avatarDecorationURL);
        }
        if (output.A(serialDesc, 19) || self.embeds != null) {
            output.u(serialDesc, 19, new yj.f(Embed$$serializer.INSTANCE), self.embeds);
        }
        if (output.A(serialDesc, 20) || self.attachments != null) {
            output.u(serialDesc, 20, new yj.f(Attachment$$serializer.INSTANCE), self.attachments);
        }
        if (output.A(serialDesc, 21) || self.attachmentsOpacity != null) {
            output.u(serialDesc, 21, e0.f32949a, self.attachmentsOpacity);
        }
        if (output.A(serialDesc, 22) || self.content != null) {
            output.u(serialDesc, 22, StructurableTextSerializer.INSTANCE, self.content);
        }
        if (output.A(serialDesc, 23) || self.progress != null) {
            output.u(serialDesc, 23, new yj.f(UploadProgress$$serializer.INSTANCE), self.progress);
        }
        if (output.A(serialDesc, 24) || self.reactions != null) {
            output.u(serialDesc, 24, new yj.f(MessageReaction$$serializer.INSTANCE), self.reactions);
        }
        if (output.A(serialDesc, 25) || !q.b(self.useSortedReactions, Boolean.TRUE)) {
            output.u(serialDesc, 25, h.f32966a, self.useSortedReactions);
        }
        if (output.A(serialDesc, 26) || !q.b(self.useAddBurstReaction, Boolean.FALSE)) {
            output.u(serialDesc, 26, h.f32966a, self.useAddBurstReaction);
        }
        if (output.A(serialDesc, 27) || self.codedLinks != null) {
            output.u(serialDesc, 27, new yj.f(a.u(CodedLinkSerializer.INSTANCE)), self.codedLinks);
        }
        if (output.A(serialDesc, 28) || self.stickers != null) {
            output.u(serialDesc, 28, new yj.f(Sticker$$serializer.INSTANCE), self.stickers);
        }
        if (output.A(serialDesc, 29) || self.roleIcon != null) {
            output.u(serialDesc, 29, RoleIcon$$serializer.INSTANCE, self.roleIcon);
        }
        if (output.A(serialDesc, 30) || self.connectionsRoleTag != null) {
            output.u(serialDesc, 30, ConnectionsRoleTag$$serializer.INSTANCE, self.connectionsRoleTag);
        }
        if (output.A(serialDesc, 31) || self.threadEmbed != null) {
            output.u(serialDesc, 31, ThreadEmbed$$serializer.INSTANCE, self.threadEmbed);
        }
        output.y(serialDesc, 32, self.mentioned);
        if (output.A(serialDesc, 33) || self.gifAutoPlay != null) {
            output.u(serialDesc, 33, h.f32966a, self.gifAutoPlay);
        }
        if (output.A(serialDesc, 34) || self.animateEmoji != null) {
            output.u(serialDesc, 34, h.f32966a, self.animateEmoji);
        }
        if (output.A(serialDesc, 35) || self.referencedMessage != null) {
            output.u(serialDesc, 35, ReferencedMessageSerializer.INSTANCE, self.referencedMessage);
        }
        if (output.A(serialDesc, 36) || self.executedCommand != null) {
            output.u(serialDesc, 36, ExecutedCommand$$serializer.INSTANCE, self.executedCommand);
        }
        if (output.A(serialDesc, 37) || self.components != null) {
            output.u(serialDesc, 37, new yj.f(ComponentSerializer.INSTANCE), self.components);
        }
        if (output.A(serialDesc, 38) || self.threadStarterMessageHeader != null) {
            output.u(serialDesc, 38, a2.f32924a, self.threadStarterMessageHeader);
        }
        if (output.A(serialDesc, 39) || self.communicationDisabled != null) {
            output.u(serialDesc, 39, h.f32966a, self.communicationDisabled);
        }
        if (output.A(serialDesc, 40) || self.tagText != null) {
            output.u(serialDesc, 40, a2.f32924a, self.tagText);
        }
        if (output.A(serialDesc, 41) || self.tagVerified != null) {
            output.u(serialDesc, 41, h.f32966a, self.tagVerified);
        }
        if (output.A(serialDesc, 42) || self.tagTextColor != null) {
            output.u(serialDesc, 42, m0.f32999a, self.tagTextColor);
        }
        if (output.A(serialDesc, 43) || self.tagBackgroundColor != null) {
            output.u(serialDesc, 43, m0.f32999a, self.tagBackgroundColor);
        }
        if (output.A(serialDesc, 44) || self.opTagText != null) {
            output.u(serialDesc, 44, a2.f32924a, self.opTagText);
        }
        if (output.A(serialDesc, 45) || self.ephemeralIndication != null) {
            output.u(serialDesc, 45, EphemeralIndication$$serializer.INSTANCE, self.ephemeralIndication);
        }
        if (output.A(serialDesc, 46) || self.surveyIndication != null) {
            output.u(serialDesc, 46, SurveyIndication$$serializer.INSTANCE, self.surveyIndication);
        }
        if (output.A(serialDesc, 47) || self.interactionStatus != null) {
            output.u(serialDesc, 47, InteractionStatus$$serializer.INSTANCE, self.interactionStatus);
        }
        if (output.A(serialDesc, 48) || !q.b(self.useAttachmentGridLayout, Boolean.FALSE)) {
            output.u(serialDesc, 48, h.f32966a, self.useAttachmentGridLayout);
        }
        if (output.A(serialDesc, 49) || !q.b(self.useAttachmentUploadPreview, Boolean.FALSE)) {
            output.u(serialDesc, 49, h.f32966a, self.useAttachmentUploadPreview);
        }
        if (output.A(serialDesc, 50) || !q.b(self.isCurrentUserMessageAuthor, Boolean.FALSE)) {
            output.u(serialDesc, 50, h.f32966a, self.isCurrentUserMessageAuthor);
        }
        if (output.A(serialDesc, 51) || self.title != null) {
            output.u(serialDesc, 51, a2.f32924a, self.title);
        }
        if (output.A(serialDesc, 52) || self.description != null) {
            output.u(serialDesc, 52, a2.f32924a, self.description);
        }
        if (output.A(serialDesc, 53) || self.avatarURLs != null) {
            output.u(serialDesc, 53, new yj.f(a2.f32924a), self.avatarURLs);
        }
        if (output.A(serialDesc, 54) || self.isCallActive != null) {
            output.u(serialDesc, 54, h.f32966a, self.isCallActive);
        }
        if (output.A(serialDesc, 55) || self.missed != null) {
            output.u(serialDesc, 55, h.f32966a, self.missed);
        }
        if (output.A(serialDesc, 56) || self.rawMilliseconds != null) {
            output.u(serialDesc, 56, w0.f33040a, self.rawMilliseconds);
        }
        if (output.A(serialDesc, 57) || self.sticker != null) {
            output.u(serialDesc, 57, Sticker$$serializer.INSTANCE, self.sticker);
        }
        if (output.A(serialDesc, 58) || self.stickerLabel != null) {
            output.u(serialDesc, 58, a2.f32924a, self.stickerLabel);
        }
        if (output.A(serialDesc, 59) || self.buttonLabel != null) {
            output.u(serialDesc, 59, a2.f32924a, self.buttonLabel);
        }
        if (output.A(serialDesc, 60) || self.showInviteToSpeakButton != null) {
            output.u(serialDesc, 60, h.f32966a, self.showInviteToSpeakButton);
        }
        if (output.A(serialDesc, 61) || self.activityInviteEmbed != null) {
            output.u(serialDesc, 61, ActivityInviteEmbed$$serializer.INSTANCE, self.activityInviteEmbed);
        }
        if (output.A(serialDesc, 62) || self.isFirstForumPostMessage) {
            output.y(serialDesc, 62, self.isFirstForumPostMessage);
        }
        if (output.A(serialDesc, 63) || self.postActions != null) {
            output.u(serialDesc, 63, ForumPostActions$$serializer.INSTANCE, self.postActions);
        }
        if (output.A(serialDesc, 64) || self.autoModerationContext != null) {
            output.u(serialDesc, 64, AutoModerationContext$$serializer.INSTANCE, self.autoModerationContext);
        }
        if (output.A(serialDesc, 65) || self.giftCodes != null) {
            output.u(serialDesc, 65, new yj.f(GiftEmbedSerializer.INSTANCE), self.giftCodes);
        }
        if (output.A(serialDesc, 66) || self.referralTrialOffer != null) {
            output.u(serialDesc, 66, GiftEmbedSerializer.INSTANCE, self.referralTrialOffer);
        }
        if (output.A(serialDesc, 67) || self.totalMonthsSubscribed != null) {
            output.u(serialDesc, 67, m0.f32999a, self.totalMonthsSubscribed);
        }
        if (output.A(serialDesc, 68) || self.swipeToReplyIconUrl != null) {
            output.u(serialDesc, 68, a2.f32924a, self.swipeToReplyIconUrl);
        }
        if (output.A(serialDesc, 69) || self.postPreviewEmbeds != null) {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 69, new yj.f(PostPreviewEmbed$$serializer.INSTANCE), self.postPreviewEmbeds);
        }
    }
    ...
    public final EphemeralIndication component46() {
        return this.ephemeralIndication;
    }

    public final SurveyIndication component47() {
        return this.surveyIndication;
    }

    public final InteractionStatus component48() {
    ...
    public final Sticker component58() {
        return this.sticker;
    }
    ...
    public final ActivityInviteEmbed component62() {
    ...
    public final ForumPostActions component64() {
        return this.postActions;
    }

    public final AutoModerationContext component65() {
        return this.autoModerationContext;
    }

    public final List<GiftEmbed> component66() {
        return this.giftCodes;
    }

    public final GiftEmbed component67() {
    ...
    public final List<PostPreviewEmbed> component70() {
    ...
    /* renamed from: copy-_QDE604  reason: not valid java name */
    public final Message m13copy_QDE604(MessageType type, String id2, String str, long j10, GuildId guildId, MessageState messageState, UserId userId, long j11, String str2, Float f10, String str3, String str4, Integer num, Integer num2, boolean z10, boolean z11, Integer num3, String str5, String str6, List<Embed> list, List<Attachment> list2, Float f11, StructurableText structurableText, List<UploadProgress> list3, List<MessageReaction> list4, Boolean bool, Boolean bool2, List<? extends CodedLinkEmbed> list5, List<Sticker> list6, RoleIcon roleIcon, ConnectionsRoleTag connectionsRoleTag, ThreadEmbed threadEmbed, boolean z12, Boolean bool3, Boolean bool4, ReferencedMessage referencedMessage, ExecutedCommand executedCommand, List<? extends Component> list7, String str7, Boolean bool5, String str8, Boolean bool6, Integer num4, Integer num5, String str9, EphemeralIndication ephemeralIndication, SurveyIndication surveyIndication, InteractionStatus interactionStatus, Boolean bool7, Boolean bool8, Boolean bool9, String str10, String str11, List<String> list8, Boolean bool10, Boolean bool11, Long l10, Sticker sticker, String str12, String str13, Boolean bool12, ActivityInviteEmbed activityInviteEmbed, boolean z13, ForumPostActions forumPostActions, AutoModerationContext autoModerationContext, List<? extends GiftEmbed> list9, GiftEmbed giftEmbed, Integer num6, String str14, List<PostPreviewEmbed> list10) {
        q.g(type, "type");
        q.g(id2, "id");
        return new Message(type, id2, str, j10, guildId, messageState, userId, j11, str2, f10, str3, str4, num, num2, z10, z11, num3, str5, str6, list, list2, f11, structurableText, list3, list4, bool, bool2, list5, list6, roleIcon, connectionsRoleTag, threadEmbed, z12, bool3, bool4, referencedMessage, executedCommand, list7, str7, bool5, str8, bool6, num4, num5, str9, ephemeralIndication, surveyIndication, interactionStatus, bool7, bool8, bool9, str10, str11, list8, bool10, bool11, l10, sticker, str12, str13, bool12, activityInviteEmbed, z13, forumPostActions, autoModerationContext, list9, giftEmbed, num6, str14, list10, null);
    }
    ...
    */
    ...
    public int hashCode() {
        int hashCode = ((this.type.hashCode() * 31) + MessageId.m577hashCodeimpl(this.f7616id)) * 31;
        ...
        int hashCode37 = (hashCode36 + (ephemeralIndication == null ? 0 : ephemeralIndication.hashCode())) * 31;
        SurveyIndication surveyIndication = this.surveyIndication;
        int hashCode38 = (hashCode37 + (surveyIndication == null ? 0 : surveyIndication.hashCode())) * 31;
        InteractionStatus interactionStatus = this.interactionStatus;
        int hashCode39 = (hashCode38 + (interactionStatus == null ? 0 : interactionStatus.hashCode())) * 31;
        ...
        int hashCode49 = (hashCode48 + (sticker == null ? 0 : sticker.hashCode())) * 31;
        ...
        int hashCode53 = (hashCode52 + (activityInviteEmbed == null ? 0 : activityInviteEmbed.hashCode())) * 31;
        boolean z13 = this.isFirstForumPostMessage;
        if (!z13) {
            i14 = z13 ? 1 : 0;
        }
        int i27 = (hashCode53 + i14) * 31;
        ForumPostActions forumPostActions = this.postActions;
        int hashCode54 = (i27 + (forumPostActions == null ? 0 : forumPostActions.hashCode())) * 31;
        AutoModerationContext autoModerationContext = this.autoModerationContext;
        int hashCode55 = (hashCode54 + (autoModerationContext == null ? 0 : autoModerationContext.hashCode())) * 31;
        ...
        int hashCode57 = (hashCode56 + (giftEmbed == null ? 0 : giftEmbed.hashCode())) * 31;
    ...
    public String toString() {
        ...
        String str = MessageId.m578toStringimpl(this.f7616id);
