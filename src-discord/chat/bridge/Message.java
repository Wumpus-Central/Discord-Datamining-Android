...
public final class Message extends MessageBase {
    ...
    public static final void write$Self(Message self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.A(serialDesc, 42) || self.tagBackgroundColor != null) {
            output.u(serialDesc, 42, m0.f32999a, self.tagBackgroundColor);
        }
        if (output.A(serialDesc, 43) || self.opTagText != null) {
            output.u(serialDesc, 43, a2.f32924a, self.opTagText);
        }
        if (output.A(serialDesc, 44) || self.ephemeralIndication != null) {
            output.u(serialDesc, 44, EphemeralIndication$$serializer.INSTANCE, self.ephemeralIndication);
        }
        if (output.A(serialDesc, 45) || self.surveyIndication != null) {
            output.u(serialDesc, 45, SurveyIndication$$serializer.INSTANCE, self.surveyIndication);
        }
        if (output.A(serialDesc, 46) || self.interactionStatus != null) {
            output.u(serialDesc, 46, InteractionStatus$$serializer.INSTANCE, self.interactionStatus);
        }
        if (output.A(serialDesc, 47) || !q.b(self.useAttachmentGridLayout, Boolean.FALSE)) {
            output.u(serialDesc, 47, h.f32966a, self.useAttachmentGridLayout);
        }
        if (output.A(serialDesc, 48) || !q.b(self.useAttachmentUploadPreview, Boolean.FALSE)) {
            output.u(serialDesc, 48, h.f32966a, self.useAttachmentUploadPreview);
        }
        if (output.A(serialDesc, 49) || !q.b(self.isCurrentUserMessageAuthor, Boolean.FALSE)) {
            output.u(serialDesc, 49, h.f32966a, self.isCurrentUserMessageAuthor);
        }
        if (output.A(serialDesc, 50) || self.title != null) {
            output.u(serialDesc, 50, a2.f32924a, self.title);
        }
        if (output.A(serialDesc, 51) || self.description != null) {
            output.u(serialDesc, 51, a2.f32924a, self.description);
        }
        if (output.A(serialDesc, 52) || self.avatarURLs != null) {
            output.u(serialDesc, 52, new yj.f(a2.f32924a), self.avatarURLs);
        }
        if (output.A(serialDesc, 53) || self.isCallActive != null) {
            output.u(serialDesc, 53, h.f32966a, self.isCallActive);
        }
        if (output.A(serialDesc, 54) || self.missed != null) {
            output.u(serialDesc, 54, h.f32966a, self.missed);
        }
        if (output.A(serialDesc, 55) || self.rawMilliseconds != null) {
            output.u(serialDesc, 55, w0.f33040a, self.rawMilliseconds);
        }
        if (output.A(serialDesc, 56) || self.sticker != null) {
            output.u(serialDesc, 56, Sticker$$serializer.INSTANCE, self.sticker);
        }
        if (output.A(serialDesc, 57) || self.stickerLabel != null) {
            output.u(serialDesc, 57, a2.f32924a, self.stickerLabel);
        }
        if (output.A(serialDesc, 58) || self.buttonLabel != null) {
            output.u(serialDesc, 58, a2.f32924a, self.buttonLabel);
        }
        if (output.A(serialDesc, 59) || self.showInviteToSpeakButton != null) {
            output.u(serialDesc, 59, h.f32966a, self.showInviteToSpeakButton);
        }
        if (output.A(serialDesc, 60) || self.activityInviteEmbed != null) {
            output.u(serialDesc, 60, ActivityInviteEmbed$$serializer.INSTANCE, self.activityInviteEmbed);
        }
        ...
        if (output.A(serialDesc, 62) || self.postActions != null) {
            output.u(serialDesc, 62, ForumPostActions$$serializer.INSTANCE, self.postActions);
        }
        if (output.A(serialDesc, 63) || self.autoModerationContext != null) {
            output.u(serialDesc, 63, AutoModerationContext$$serializer.INSTANCE, self.autoModerationContext);
        }
        if (output.A(serialDesc, 64) || self.giftCodes != null) {
            output.u(serialDesc, 64, new yj.f(GiftEmbedSerializer.INSTANCE), self.giftCodes);
        }
        if (output.A(serialDesc, 65) || self.referralTrialOffer != null) {
            output.u(serialDesc, 65, GiftEmbedSerializer.INSTANCE, self.referralTrialOffer);
        }
        if (output.A(serialDesc, 66) || self.totalMonthsSubscribed != null) {
            output.u(serialDesc, 66, m0.f32999a, self.totalMonthsSubscribed);
        }
        if (output.A(serialDesc, 67) || self.swipeToReplyIconUrl != null) {
            output.u(serialDesc, 67, a2.f32924a, self.swipeToReplyIconUrl);
        }
        if (output.A(serialDesc, 68) || self.postPreviewEmbeds != null) {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 68, new yj.f(PostPreviewEmbed$$serializer.INSTANCE), self.postPreviewEmbeds);
        }
    }
