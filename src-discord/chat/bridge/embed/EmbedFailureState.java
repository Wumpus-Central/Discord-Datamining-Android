...
public enum EmbedFailureState implements IntEnum {
    ...
    private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = n.a(p.PUBLICATION, EmbedFailureState$Companion$$cachedSerializer$delegate$1.INSTANCE);
