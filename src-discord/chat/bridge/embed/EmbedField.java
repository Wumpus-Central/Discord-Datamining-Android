...
public final class EmbedField {
    ...
    public static final void write$Self(EmbedField self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 0, a2.f30576a, self.rawName);
        }
        ...
        if (z11) {
            output.e(serialDesc, 1, a2.f30576a, self.rawValue);
        }
        ...
        if (z12) {
            output.e(serialDesc, 2, StructurableTextSerializer.INSTANCE, self.name);
        }
        if (output.z(serialDesc, 3) || self.value != null) {
            z13 = true;
        }
        if (z13) {
            output.e(serialDesc, 3, StructurableTextSerializer.INSTANCE, self.value);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.rawName, embedField.rawName) && q.c(this.rawValue, embedField.rawValue) && q.c(this.name, embedField.name) && q.c(this.value, embedField.value);
    }
