...
public final class EmbedThumbnail implements EmbedUrlProvider {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.url, embedThumbnail.url) && q.c(this.proxyURL, embedThumbnail.proxyURL) && q.c(this.videoUrl, embedThumbnail.videoUrl) && this.height == embedThumbnail.height && this.width == embedThumbnail.width && q.c(this.gifv, embedThumbnail.gifv) && q.c(this.showPlayButton, embedThumbnail.showPlayButton);
    }
