...
public final class MentionableSelectComponent extends SearchableSelectComponent {
    ...
    public /* synthetic */ MentionableSelectComponent(int i10, List list, int i11, List list2, String str, String str2, String str3, String str4, int i12, int i13, boolean z10, ActionComponentState actionComponentState, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == mentionableSelectComponent.getType() && q.b(getIndices(), mentionableSelectComponent.getIndices()) && q.b(getApplicationId(), mentionableSelectComponent.getApplicationId()) && q.b(getCustomId(), mentionableSelectComponent.getCustomId()) && q.b(getPlaceholder(), mentionableSelectComponent.getPlaceholder()) && q.b(getAccessibilityLabel(), mentionableSelectComponent.getAccessibilityLabel()) && getMinValues() == mentionableSelectComponent.getMinValues() && getMaxValues() == mentionableSelectComponent.getMaxValues() && getDisabled() == mentionableSelectComponent.getDisabled() && getState() == mentionableSelectComponent.getState();
    }
    ...
    public /* synthetic */ MentionableSelectComponent(int i10, List list, String str, String str2, String str3, String str4, int i11, int i12, boolean z10, ActionComponentState actionComponentState, int i13, DefaultConstructorMarker defaultConstructorMarker) {
