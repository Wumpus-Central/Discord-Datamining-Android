...
public final class ActionRowComponent extends Component {
    ...
    public  ActionRowComponent(int i10, int i11, List list, String str, List list2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (11 != (i10 & 11)) {
    ...
    public static  ActionRowComponent copy$default(ActionRowComponent actionRowComponent, int i10, List list, String str, List list2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(ActionRowComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.z(serialDesc, 2) || self.errorText != null) {
            z10 = true;
        }
        if (z10) {
            output.e(serialDesc, 2, a2.f30568a, self.errorText);
        }
        output.h(serialDesc, 3, new xi.f(ComponentSerializer.INSTANCE), self.components);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == actionRowComponent.getType() && q.c(getIndices(), actionRowComponent.getIndices()) && q.c(this.errorText, actionRowComponent.errorText) && q.c(this.components, actionRowComponent.components);
    }
    ...
    public  ActionRowComponent(int i10, List list, String str, List list2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
