...
public final class StringSelectItem extends SelectItem {
    ...
    public static final void write$Self(StringSelectItem self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (!output.A(serialDesc, 3) && self.description == null) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (z11) {
            output.u(serialDesc, 3, a2.f32933a, self.description);
        }
        if (output.A(serialDesc, 4) || !q.b(self.f0default, Boolean.FALSE)) {
            z12 = true;
        }
        if (z12) {
            output.u(serialDesc, 4, h.f32975a, self.f0default);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(getLabel(), stringSelectItem.getLabel()) && q.b(getValue(), stringSelectItem.getValue()) && q.b(getEmoji(), stringSelectItem.getEmoji()) && q.b(this.description, stringSelectItem.description) && q.b(this.f0default, stringSelectItem.f0default);
    }
