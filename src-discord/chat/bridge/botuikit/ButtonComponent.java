...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 1, new cj.f(m0.f6313a), self.getIndices());
        output.i(serialDesc, 2, ApplicationId$$serializer.INSTANCE, ApplicationId.m604boximpl(self.applicationId));
        ...
        if (z10) {
            output.E(serialDesc, 3, a2.f6238a, self.customId);
        }
        ...
        if (z11) {
            output.E(serialDesc, 4, a2.f6238a, self.label);
        }
        output.i(serialDesc, 5, ButtonStyle.Serializer.INSTANCE, self.style);
        ...
        if (z14) {
            output.E(serialDesc, 8, a2.f6238a, self.url);
        }
        output.i(serialDesc, 9, ActionComponentState.Serializer.INSTANCE, self.state);
    }
    ...
    public final long m37component3VavddsQ() {
    ...
    public final ButtonComponent m38copyonMGE3A(int i10, List<Integer> indices, long j10, String str, String str2, ButtonStyle style, boolean z10, ComponentEmoji componentEmoji, String str3, ActionComponentState state) {
        q.h(indices, "indices");
        q.h(style, "style");
        q.h(state, "state");
    ...
    public int hashCode() {
        int type = ((((getType() * 31) + getIndices().hashCode()) * 31) + ApplicationId.m609hashCodeimpl(this.applicationId)) * 31;
    ...
    public String toString() {
        ...
        String str = ApplicationId.m611toStringimpl(this.applicationId);
