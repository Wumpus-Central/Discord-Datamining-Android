...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 1, new xi.f(m0.f30649a), self.getIndices());
        output.h(serialDesc, 2, ApplicationId$$serializer.INSTANCE, ApplicationId.m585boximpl(self.applicationId));
        ...
        if (z10) {
            output.e(serialDesc, 3, a2.f30574a, self.customId);
        }
        ...
        if (z11) {
            output.e(serialDesc, 4, a2.f30574a, self.label);
        }
        ...
        if (z14) {
            output.e(serialDesc, 8, a2.f30574a, self.url);
        }
    ...
    public final long m38component3VavddsQ() {
    ...
    public final ButtonComponent m39copyonMGE3A(int i10, List<Integer> indices, long j10, String str, String str2, ButtonStyle style, boolean z10, ComponentEmoji componentEmoji, String str3, ActionComponentState state) {
        q.h(indices, "indices");
        q.h(style, "style");
        q.h(state, "state");
    ...
    public int hashCode() {
        int type = ((((getType() * 31) + getIndices().hashCode()) * 31) + ApplicationId.m590hashCodeimpl(this.applicationId)) * 31;
    ...
    public String toString() {
        ...
        String str = ApplicationId.m592toStringimpl(this.applicationId);
