...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 1, new yj.f(m0.f33008a), self.getIndices());
        output.q(serialDesc, 2, ApplicationId$$serializer.INSTANCE, ApplicationId.m550boximpl(self.applicationId));
        ...
        if (z10) {
            output.u(serialDesc, 3, a2.f32933a, self.customId);
        }
        ...
        if (z11) {
            output.u(serialDesc, 4, a2.f32933a, self.label);
        }
        ...
        if (z13) {
            output.u(serialDesc, 7, ComponentEmoji$$serializer.INSTANCE, self.emoji);
        }
        if (output.A(serialDesc, 8) || self.url != null) {
            z14 = true;
        }
        if (z14) {
            output.u(serialDesc, 8, a2.f32933a, self.url);
        }
    ...
    public int hashCode() {
        int type = ((((getType() * 31) + getIndices().hashCode()) * 31) + ApplicationId.m555hashCodeimpl(this.applicationId)) * 31;
    ...
    public String toString() {
        ...
        String str = ApplicationId.m557toStringimpl(this.applicationId);
