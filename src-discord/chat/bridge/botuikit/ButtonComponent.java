...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 1, new yj.f(m0.f33009a), self.getIndices());
        ...
        if (z10) {
            output.u(serialDesc, 3, a2.f32934a, self.customId);
        }
        ...
        if (z11) {
            output.u(serialDesc, 4, a2.f32934a, self.label);
        }
        ...
        if (z14) {
            output.u(serialDesc, 8, a2.f32934a, self.url);
        }
