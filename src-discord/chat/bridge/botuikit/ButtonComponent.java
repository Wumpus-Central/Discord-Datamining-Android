...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.p(serialDesc, 3, a2.f5917a, self.customId);
        }
        ...
        if (z11) {
            output.p(serialDesc, 4, a2.f5917a, self.label);
        }
        output.t(serialDesc, 5, ButtonStyle.Serializer.INSTANCE, self.style);
        ...
        if (z12) {
            output.y(serialDesc, 6, self.disabled);
        }
        if (!output.A(serialDesc, 7) && self.emoji == null) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (z13) {
            output.p(serialDesc, 7, ComponentEmoji$$serializer.INSTANCE, self.emoji);
        }
        if (output.A(serialDesc, 8) || self.url != null) {
            z14 = true;
        }
        if (z14) {
            output.p(serialDesc, 8, a2.f5917a, self.url);
        }
        output.t(serialDesc, 9, ActionComponentState.Serializer.INSTANCE, self.state);
    }
    ...
    public /* synthetic */ ButtonComponent(int i10, List list, long j10, String str, String str2, ButtonStyle buttonStyle, boolean z10, ComponentEmoji componentEmoji, String str3, ActionComponentState actionComponentState, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, list, j10, (i11 & 8) != 0 ? null : str, (i11 & 16) != 0 ? null : str2, buttonStyle, (i11 & 64) != 0 ? false : z10, (i11 & 128) != 0 ? null : componentEmoji, (i11 & Spliterator.NONNULL) != 0 ? null : str3, actionComponentState, null);
    }
