...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 1, new xi.f(m0.f30643a), self.getIndices());
        output.h(serialDesc, 2, ApplicationId$$serializer.INSTANCE, ApplicationId.m578boximpl(self.applicationId));
        ...
        if (z10) {
            output.e(serialDesc, 3, a2.f30568a, self.customId);
        }
        ...
        if (z11) {
            output.e(serialDesc, 4, a2.f30568a, self.label);
        }
        ...
        if (z14) {
            output.e(serialDesc, 8, a2.f30568a, self.url);
        }
    ...
    public int hashCode() {
        int type = ((((getType() * 31) + getIndices().hashCode()) * 31) + ApplicationId.m583hashCodeimpl(this.applicationId)) * 31;
    ...
    public String toString() {
        ...
        String str = ApplicationId.m585toStringimpl(this.applicationId);
