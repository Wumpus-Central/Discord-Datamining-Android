...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 1, new ti.f(m0.f27047a), self.getIndices());
        output.C(serialDesc, 2, ApplicationId$$serializer.INSTANCE, ApplicationId.m551boximpl(self.applicationId));
        ...
        if (z10) {
            output.e(serialDesc, 3, a2.f26972a, self.customId);
        }
        ...
        if (z11) {
            output.e(serialDesc, 4, a2.f26972a, self.label);
        }
        ...
        if (z14) {
            output.e(serialDesc, 8, a2.f26972a, self.url);
        }
    ...
    public int hashCode() {
        int type = ((((getType() * 31) + getIndices().hashCode()) * 31) + ApplicationId.m556hashCodeimpl(this.applicationId)) * 31;
    ...
    public String toString() {
        ...
        String str = ApplicationId.m558toStringimpl(this.applicationId);
