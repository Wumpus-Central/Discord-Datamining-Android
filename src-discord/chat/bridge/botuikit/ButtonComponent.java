...
public final class ButtonComponent extends Component {
    ...
    public /* synthetic */ ButtonComponent(int i10, List list, long j10, String str, String str2, ButtonStyle buttonStyle, boolean z10, ComponentEmoji componentEmoji, String str3, ActionComponentState actionComponentState, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 1, new ti.f(m0.f27014a), self.getIndices());
        output.C(serialDesc, 2, ApplicationId$$serializer.INSTANCE, ApplicationId.m549boximpl(self.applicationId));
        ...
        if (z10) {
            output.e(serialDesc, 3, a2.f26939a, self.customId);
        }
        ...
        if (z11) {
            output.e(serialDesc, 4, a2.f26939a, self.label);
        }
        output.C(serialDesc, 5, ButtonStyle.Serializer.INSTANCE, self.style);
        ...
        if (z12) {
            output.s(serialDesc, 6, self.disabled);
        }
        ...
        if (z13) {
            output.e(serialDesc, 7, ComponentEmoji$$serializer.INSTANCE, self.emoji);
        }
        if (output.w(serialDesc, 8) || self.url != null) {
            z14 = true;
        }
        if (z14) {
            output.e(serialDesc, 8, a2.f26939a, self.url);
        }
        output.C(serialDesc, 9, ActionComponentState.Serializer.INSTANCE, self.state);
    }
    ...
    public final long m29component3VavddsQ() {
    ...
    public final ButtonComponent m30copyonMGE3A(int i10, List<Integer> indices, long j10, String str, String str2, ButtonStyle style, boolean z10, ComponentEmoji componentEmoji, String str3, ActionComponentState state) {
        q.g(indices, "indices");
        q.g(style, "style");
        q.g(state, "state");
    ...
    public int hashCode() {
        int type = ((((getType() * 31) + getIndices().hashCode()) * 31) + ApplicationId.m554hashCodeimpl(this.applicationId)) * 31;
    ...
    public String toString() {
        ...
        String str = ApplicationId.m556toStringimpl(this.applicationId);
    ...
    public /* synthetic */ ButtonComponent(int i10, List list, long j10, String str, String str2, ButtonStyle buttonStyle, boolean z10, ComponentEmoji componentEmoji, String str3, ActionComponentState actionComponentState, int i11, DefaultConstructorMarker defaultConstructorMarker) {
