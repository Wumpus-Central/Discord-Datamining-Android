...
public final class ButtonComponent extends Component {
    ...
    public static final void write$Self(ButtonComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.o(serialDesc, 1, new wi.f(m0.f29839a), self.getIndices());
        output.o(serialDesc, 2, ApplicationId$$serializer.INSTANCE, ApplicationId.m578boximpl(self.applicationId));
        ...
        if (z10) {
            output.B(serialDesc, 3, a2.f29764a, self.customId);
        }
        ...
        if (z11) {
            output.B(serialDesc, 4, a2.f29764a, self.label);
        }
        ...
        if (z14) {
            output.B(serialDesc, 8, a2.f29764a, self.url);
        }
