...
public final class SearchableSelectItem$$serializer implements f0<SearchableSelectItem> {
    ...
    public SearchableSelectItem deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj2 = b10.n(descriptor2, 4, a2.f32313a, null);
            obj3 = b10.n(descriptor2, 5, m0.f32388a, null);
            i11 = 63;
        } else {
            boolean z10 = true;
            int i12 = 0;
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        obj5 = b10.n(descriptor2, 4, a2.f32313a, obj5);
                        i13 |= 16;
                        break;
                    case 5:
                        obj6 = b10.n(descriptor2, 5, m0.f32388a, obj6);
                        i13 |= 32;
                        break;
                    default:
                        throw new n(o10);
