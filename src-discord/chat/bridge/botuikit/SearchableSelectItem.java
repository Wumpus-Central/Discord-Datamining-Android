...
public final class SearchableSelectItem extends SelectItem {
    ...
    public static final void write$Self(SearchableSelectItem self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.t(serialDesc, 0, self.getLabel());
        output.t(serialDesc, 1, self.getValue());
        ...
        if (z10) {
            output.e(serialDesc, 2, ComponentEmoji$$serializer.INSTANCE, self.getEmoji());
        }
        output.r(serialDesc, 3, self.type);
        ...
        if (z11) {
            output.e(serialDesc, 4, a2.f26939a, self.iconSrc);
        }
        if (output.w(serialDesc, 5) || self.iconColor != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 5, m0.f27014a, self.iconColor);
        }
    }
