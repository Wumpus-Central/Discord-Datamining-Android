...
public final class SearchableSelectItem extends SelectItem {
    ...
    public /* synthetic */ SearchableSelectItem(int i10, String str, String str2, ComponentEmoji componentEmoji, int i11, String str3, Integer num, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public static /* synthetic */ SearchableSelectItem copy$default(SearchableSelectItem searchableSelectItem, String str, String str2, ComponentEmoji componentEmoji, int i10, String str3, Integer num, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(SearchableSelectItem self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.z(serialDesc, 0, self.getLabel());
        output.z(serialDesc, 1, self.getValue());
        if (!output.A(serialDesc, 2) && self.getEmoji() == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 2, ComponentEmoji$$serializer.INSTANCE, self.getEmoji());
        }
        output.x(serialDesc, 3, self.type);
        if (!output.A(serialDesc, 4) && self.iconSrc == null) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (z11) {
            output.u(serialDesc, 4, a2.f32925a, self.iconSrc);
        }
        if (output.A(serialDesc, 5) || self.iconColor != null) {
            z12 = true;
        }
        if (z12) {
            output.u(serialDesc, 5, m0.f33000a, self.iconColor);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(getLabel(), searchableSelectItem.getLabel()) && q.b(getValue(), searchableSelectItem.getValue()) && q.b(getEmoji(), searchableSelectItem.getEmoji()) && this.type == searchableSelectItem.type && q.b(this.iconSrc, searchableSelectItem.iconSrc) && q.b(this.iconColor, searchableSelectItem.iconColor);
    }
    ...
    public /* synthetic */ SearchableSelectItem(String str, String str2, ComponentEmoji componentEmoji, int i10, String str3, Integer num, int i11, DefaultConstructorMarker defaultConstructorMarker) {
