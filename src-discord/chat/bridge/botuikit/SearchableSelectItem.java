...
public final class SearchableSelectItem extends SelectItem {
    ...
    public static final void write$Self(SearchableSelectItem self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.y(serialDesc, 0, self.getLabel());
        output.y(serialDesc, 1, self.getValue());
        ...
        if (z10) {
            output.h(serialDesc, 2, ComponentEmoji$$serializer.INSTANCE, self.getEmoji());
        }
        output.w(serialDesc, 3, self.type);
