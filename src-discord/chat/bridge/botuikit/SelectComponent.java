...
public abstract class SelectComponent extends Component {
    ...
    private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = n.a(p.PUBLICATION, SelectComponent$Companion$$cachedSerializer$delegate$1.INSTANCE);
