...
public abstract class SelectComponent extends Component {
    ...
    static {
        ...
        a10 = n.a(p.PUBLICATION, SelectComponent$Companion$$cachedSerializer$delegate$1.INSTANCE);
        $cachedSerializer$delegate = a10;
    }

    public  SelectComponent(int i10, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
    }
