...
public final class ComponentEmoji {
    ...
    public static final void write$Self(ComponentEmoji self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        if (!output.A(serialDesc, 0) && self.f7618id == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 0, a2.f32933a, self.f7618id);
        }
        ...
        if (z11) {
            output.u(serialDesc, 2, a2.f32933a, self.src);
        }
        ...
        if (z13) {
            output.u(serialDesc, 4, a2.f32933a, self.surrogates);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7618id, componentEmoji.f7618id) && q.b(this.name, componentEmoji.name) && q.b(this.src, componentEmoji.src) && this.animated == componentEmoji.animated && q.b(this.surrogates, componentEmoji.surrogates);
    }
