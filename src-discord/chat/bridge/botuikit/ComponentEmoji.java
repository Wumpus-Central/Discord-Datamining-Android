...
public final class ComponentEmoji {
    ...
    public static final void write$Self(ComponentEmoji self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        if (!output.A(serialDesc, 0) && self.f7695id == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.h(serialDesc, 0, a2.f32313a, self.f7695id);
        }
        ...
        if (z11) {
            output.h(serialDesc, 2, a2.f32313a, self.src);
        }
        ...
        if (z13) {
            output.h(serialDesc, 4, a2.f32313a, self.surrogates);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7695id, componentEmoji.f7695id) && q.b(this.name, componentEmoji.name) && q.b(this.src, componentEmoji.src) && this.animated == componentEmoji.animated && q.b(this.surrogates, componentEmoji.surrogates);
    }
