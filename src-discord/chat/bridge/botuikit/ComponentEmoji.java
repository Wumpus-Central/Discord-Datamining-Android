...
public final class ComponentEmoji {
    ...
    public static final void write$Self(ComponentEmoji self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        if (!output.z(serialDesc, 0) && self.f7246id == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.B(serialDesc, 0, a2.f29755a, self.f7246id);
        }
        ...
        if (z11) {
            output.B(serialDesc, 2, a2.f29755a, self.src);
        }
        ...
        if (z13) {
            output.B(serialDesc, 4, a2.f29755a, self.surrogates);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7246id, componentEmoji.f7246id) && q.c(this.name, componentEmoji.name) && q.c(this.src, componentEmoji.src) && this.animated == componentEmoji.animated && q.c(this.surrogates, componentEmoji.surrogates);
    }
