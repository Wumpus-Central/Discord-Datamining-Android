...
public final class ComponentEmoji {
    ...
    public static final void write$Self(ComponentEmoji self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        if (!output.w(serialDesc, 0) && self.f7288id == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.e(serialDesc, 0, a2.f26972a, self.f7288id);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, a2.f26972a, self.src);
        }
        ...
        if (z13) {
            output.e(serialDesc, 4, a2.f26972a, self.surrogates);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7288id, componentEmoji.f7288id) && q.b(this.name, componentEmoji.name) && q.b(this.src, componentEmoji.src) && this.animated == componentEmoji.animated && q.b(this.surrogates, componentEmoji.surrogates);
    }
