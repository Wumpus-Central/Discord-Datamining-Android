...
public final class UserSelectComponent extends SearchableSelectComponent {
    ...
    public  UserSelectComponent(int i10, List list, int i11, List list2, String str, String str2, String str3, String str4, int i12, int i13, boolean z10, ActionComponentState actionComponentState, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public static final void write$Self(UserSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 2, new cj.f(m0.f6313a), self.getIndices());
        ...
        if (z10) {
            output.E(serialDesc, 5, a2.f6238a, self.getPlaceholder());
        }
        ...
        if (z11) {
            output.E(serialDesc, 6, a2.f6238a, self.getAccessibilityLabel());
        }
        ...
        output.i(serialDesc, 10, ActionComponentState.Serializer.INSTANCE, self.getState());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == userSelectComponent.getType() && q.c(getIndices(), userSelectComponent.getIndices()) && q.c(getApplicationId(), userSelectComponent.getApplicationId()) && q.c(getCustomId(), userSelectComponent.getCustomId()) && q.c(getPlaceholder(), userSelectComponent.getPlaceholder()) && q.c(getAccessibilityLabel(), userSelectComponent.getAccessibilityLabel()) && getMinValues() == userSelectComponent.getMinValues() && getMaxValues() == userSelectComponent.getMaxValues() && getDisabled() == userSelectComponent.getDisabled() && getState() == userSelectComponent.getState();
    }
    ...
    public  UserSelectComponent(int i10, List list, String str, String str2, String str3, String str4, int i11, int i12, boolean z10, ActionComponentState actionComponentState, int i13, DefaultConstructorMarker defaultConstructorMarker) {
