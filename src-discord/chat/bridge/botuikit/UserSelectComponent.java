...
public final class UserSelectComponent extends SearchableSelectComponent {
    ...
    public static final void write$Self(UserSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 2, new yj.f(m0.f33008a), self.getIndices());
        ...
        if (z10) {
            output.u(serialDesc, 5, a2.f32933a, self.getPlaceholder());
        }
        ...
        if (z11) {
            output.u(serialDesc, 6, a2.f32933a, self.getAccessibilityLabel());
        }
        ...
        if (z12) {
            output.y(serialDesc, 9, self.getDisabled());
        }
        output.q(serialDesc, 10, ActionComponentState.Serializer.INSTANCE, self.getState());
    }
