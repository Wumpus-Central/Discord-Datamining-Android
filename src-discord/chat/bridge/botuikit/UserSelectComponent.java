...
public final class UserSelectComponent extends SearchableSelectComponent {
    ...
    public static final void write$Self(UserSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 2, new bj.f(m0.f5992a), self.getIndices());
        ...
        if (z10) {
            output.p(serialDesc, 5, a2.f5917a, self.getPlaceholder());
        }
        ...
        if (z11) {
            output.p(serialDesc, 6, a2.f5917a, self.getAccessibilityLabel());
        }
        ...
        output.t(serialDesc, 10, ActionComponentState.Serializer.INSTANCE, self.getState());
    }
