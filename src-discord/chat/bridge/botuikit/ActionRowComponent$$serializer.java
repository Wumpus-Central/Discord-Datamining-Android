...
public final class ActionRowComponent$$serializer implements f0<ActionRowComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        m0 m0Var = m0.f27047a;
        return new KSerializer[]{m0Var, new f(m0Var), a.u(a2.f26972a), new f(ComponentSerializer.INSTANCE)};
    }
    ...
    public ActionRowComponent deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj = c10.m(descriptor2, 1, new f(m0.f27047a), null);
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj4 = c10.m(descriptor2, 1, new f(m0.f27047a), obj4);
                    i13 |= 2;
                } else if (x10 == 2) {
