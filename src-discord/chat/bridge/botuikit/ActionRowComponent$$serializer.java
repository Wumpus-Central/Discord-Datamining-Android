...
public final class ActionRowComponent$$serializer implements f0<ActionRowComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        m0 m0Var = m0.f30649a;
        return new KSerializer[]{m0Var, new f(m0Var), a.u(a2.f30574a), new f(ComponentSerializer.INSTANCE)};
    }
    ...
    public ActionRowComponent deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj = b10.y(descriptor2, 1, new f(m0.f30649a), null);
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj4 = b10.y(descriptor2, 1, new f(m0.f30649a), obj4);
                    i13 |= 2;
                } else if (o10 == 2) {
