...
public final class ActionRowComponent$$serializer implements f0<ActionRowComponent> {
    ...
    public KSerializer<?>[] childSerializers() {
        m0 m0Var = m0.f26312a;
        return new KSerializer[]{m0Var, new f(m0Var), a.u(a2.f26237a), new f(ComponentSerializer.INSTANCE)};
    }
    ...
    public ActionRowComponent deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj = c10.m(descriptor2, 1, new f(m0.f26312a), null);
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj4 = c10.m(descriptor2, 1, new f(m0.f26312a), obj4);
                    i13 |= 2;
                } else if (x10 == 2) {
