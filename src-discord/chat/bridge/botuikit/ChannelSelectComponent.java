...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    public /* synthetic */ ChannelSelectComponent(int i10, List list, int i11, List list2, String str, String str2, String str3, String str4, int i12, int i13, boolean z10, ActionComponentState actionComponentState, List list3, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public static final void write$Self(ChannelSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        m0 m0Var = m0.f32999a;
        output.q(serialDesc, 2, new yj.f(m0Var), self.getIndices());
        ...
        if (!output.A(serialDesc, 11) && self.channelTypes == null) {
            z13 = false;
        }
        if (z13) {
            output.u(serialDesc, 11, new yj.f(m0Var), self.channelTypes);
        }
    }
    ...
    public /* synthetic */ ChannelSelectComponent(int i10, List list, String str, String str2, String str3, String str4, int i11, int i12, boolean z10, ActionComponentState actionComponentState, List list2, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, list, str, str2, (i13 & 16) != 0 ? null : str3, (i13 & 32) != 0 ? null : str4, i11, i12, (i13 & Spliterator.NONNULL) != 0 ? false : z10, actionComponentState, (i13 & Spliterator.IMMUTABLE) != 0 ? null : list2);
    }
