...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    public static final void write$Self(ChannelSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        m0 m0Var = m0.f6313a;
        output.i(serialDesc, 2, new cj.f(m0Var), self.getIndices());
        ...
        if (z13) {
            output.E(serialDesc, 11, new cj.f(m0Var), self.channelTypes);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == channelSelectComponent.getType() && q.c(getIndices(), channelSelectComponent.getIndices()) && q.c(getApplicationId(), channelSelectComponent.getApplicationId()) && q.c(getCustomId(), channelSelectComponent.getCustomId()) && q.c(getPlaceholder(), channelSelectComponent.getPlaceholder()) && q.c(getAccessibilityLabel(), channelSelectComponent.getAccessibilityLabel()) && getMinValues() == channelSelectComponent.getMinValues() && getMaxValues() == channelSelectComponent.getMaxValues() && getDisabled() == channelSelectComponent.getDisabled() && getState() == channelSelectComponent.getState() && q.c(this.channelTypes, channelSelectComponent.channelTypes);
    }
