...
public final class RoleSelectComponent extends SearchableSelectComponent {
    ...
    public  RoleSelectComponent(int i10, List list, int i11, List list2, String str, String str2, String str3, String str4, int i12, int i13, boolean z10, ActionComponentState actionComponentState, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == roleSelectComponent.getType() && q.c(getIndices(), roleSelectComponent.getIndices()) && q.c(getApplicationId(), roleSelectComponent.getApplicationId()) && q.c(getCustomId(), roleSelectComponent.getCustomId()) && q.c(getPlaceholder(), roleSelectComponent.getPlaceholder()) && q.c(getAccessibilityLabel(), roleSelectComponent.getAccessibilityLabel()) && getMinValues() == roleSelectComponent.getMinValues() && getMaxValues() == roleSelectComponent.getMaxValues() && getDisabled() == roleSelectComponent.getDisabled() && getState() == roleSelectComponent.getState();
    }
    ...
    public  RoleSelectComponent(int i10, List list, String str, String str2, String str3, String str4, int i11, int i12, boolean z10, ActionComponentState actionComponentState, int i13, DefaultConstructorMarker defaultConstructorMarker) {
