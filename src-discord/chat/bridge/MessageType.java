...
public enum MessageType implements IntEnum {
    ...
    static {
        ...
        MessageType messageType28 = CALL;
        MessageType messageType29 = GUILD_STREAM;
        EnumSet of2 = EnumSet.of(r0, messageType, messageType28, messageType2, messageType3, messageType4, messageType5, messageType6, messageType7, messageType8, messageType9, messageType10, messageType29, messageType11, messageType12, messageType13, messageType14, messageType15, messageType16, messageType17, messageType18, messageType19, messageType20, messageType21, messageType22, messageType23, messageType24, messageType25, messageType26, messageType27);
        q.g(of2, "of(\n            RECIPIEN…_REVIVE_PROMPT,\n        )");
        SystemTypes = of2;
        EnumSet of3 = EnumSet.of(messageType28, messageType29);
        q.g(of3, "of(\n            CALL,\n  …  GUILD_STREAM,\n        )");
        CallTypes = of3;
