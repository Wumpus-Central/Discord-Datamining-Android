...
public final class ExecutedCommand$$serializer implements f0<ExecutedCommand> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{UserId$$serializer.INSTANCE, m0.f26305a, a.u(a2.f26230a), AnnotatedStructurableTextSerializer.INSTANCE};
    }
    ...
    public ExecutedCommand deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj = c10.v(descriptor2, 2, a2.f26230a, null);
