...
public final class ExecutedCommand$$serializer implements f0<ExecutedCommand> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{UserId$$serializer.INSTANCE, m0.f32384a, a.u(a2.f32309a), AnnotatedStructurableTextSerializer.INSTANCE};
    }
    ...
    public ExecutedCommand deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj = b10.n(descriptor2, 2, a2.f32309a, null);
