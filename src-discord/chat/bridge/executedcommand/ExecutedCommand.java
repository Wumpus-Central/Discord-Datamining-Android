...
public final class ExecutedCommand {
    ...
    private ExecutedCommand(int i10, UserId userId, int i11, String str, AnnotatedStructurableText annotatedStructurableText, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.userId = userId.m619unboximpl();
    ...
    public /* synthetic */ ExecutedCommand(int i10, UserId userId, int i11, String str, AnnotatedStructurableText annotatedStructurableText, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, userId, i11, str, annotatedStructurableText, serializationConstructorMarker);
    }

    public /* synthetic */ ExecutedCommand(long j10, int i10, String str, AnnotatedStructurableText annotatedStructurableText, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, i10, str, annotatedStructurableText);
    }

    /* renamed from: copy-ASSxI_0$default  reason: not valid java name */
    public static /* synthetic */ ExecutedCommand m103copyASSxI_0$default(ExecutedCommand executedCommand, long j10, int i10, String str, AnnotatedStructurableText annotatedStructurableText, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(ExecutedCommand self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.q(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m610boximpl(self.userId));
        output.x(serialDesc, 1, self.usernameColor);
        if (output.A(serialDesc, 2) || self.avatarURL != null) {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 2, a2.f32924a, self.avatarURL);
        }
        output.q(serialDesc, 3, AnnotatedStructurableTextSerializer.INSTANCE, self.content);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m614equalsimpl0(this.userId, executedCommand.userId) && this.usernameColor == executedCommand.usernameColor && q.b(this.avatarURL, executedCommand.avatarURL) && q.b(this.content, executedCommand.content);
    }
    ...
    public int hashCode() {
        int i10 = ((UserId.m615hashCodeimpl(this.userId) * 31) + this.usernameColor) * 31;
        String str = this.avatarURL;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.content.hashCode();
    }

    public String toString() {
        String str = UserId.m617toStringimpl(this.userId);
    ...
    public /* synthetic */ ExecutedCommand(long j10, int i10, String str, AnnotatedStructurableText annotatedStructurableText, int i11, DefaultConstructorMarker defaultConstructorMarker) {
