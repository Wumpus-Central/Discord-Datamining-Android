...
public final class ExecutedCommand {
    ...
    public static final void write$Self(ExecutedCommand self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.z(serialDesc, 2, a2.f26237a, self.avatarURL);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m634equalsimpl0(this.userId, executedCommand.userId) && this.usernameColor == executedCommand.usernameColor && q.b(this.avatarURL, executedCommand.avatarURL) && q.b(this.content, executedCommand.content);
    }
    ...
    public int hashCode() {
        int i10 = ((UserId.m635hashCodeimpl(this.userId) * 31) + this.usernameColor) * 31;
