...
public final class ExecutedCommand {
    ...
    private ExecutedCommand(int i10, UserId userId, int i11, String str, AnnotatedStructurableText annotatedStructurableText, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.userId = userId.m610unboximpl();
    ...
    public static /* synthetic */ ExecutedCommand m102copyASSxI_0$default(ExecutedCommand executedCommand, long j10, int i10, String str, AnnotatedStructurableText annotatedStructurableText, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(ExecutedCommand self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.t(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m601boximpl(self.userId));
        output.x(serialDesc, 1, self.usernameColor);
        if (output.A(serialDesc, 2) || self.avatarURL != null) {
            z10 = true;
        }
        if (z10) {
            output.p(serialDesc, 2, a2.f5917a, self.avatarURL);
        }
        output.t(serialDesc, 3, AnnotatedStructurableTextSerializer.INSTANCE, self.content);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m605equalsimpl0(this.userId, executedCommand.userId) && this.usernameColor == executedCommand.usernameColor && q.b(this.avatarURL, executedCommand.avatarURL) && q.b(this.content, executedCommand.content);
    }
    ...
    public int hashCode() {
        int i10 = ((UserId.m606hashCodeimpl(this.userId) * 31) + this.usernameColor) * 31;
        String str = this.avatarURL;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.content.hashCode();
    }

    public String toString() {
        String str = UserId.m608toStringimpl(this.userId);
