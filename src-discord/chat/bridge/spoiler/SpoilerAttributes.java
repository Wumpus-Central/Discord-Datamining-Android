...
public final class SpoilerAttributes {
    ...
    public static final class Companion {
        ...
        private final SpoilerAttributes m132forItemA9xMOlw(SpoilerableData spoilerableData, String str, String str2) {
            String obscureOrNull = spoilerableData.getObscureOrNull();
            if (obscureOrNull != null) {
                String str3 = MessageId.m649toStringimpl(str);
                return new SpoilerAttributes(SpoilerIdentifier.m136constructorimpl("obscure:messageId" + str3 + ":" + str2), obscureOrNull, SpoilerType.OBSCURE, null);
            }
            String spoilerOrNull = spoilerableData.getSpoilerOrNull();
            if (spoilerOrNull == null) {
                return null;
            }
            String str4 = MessageId.m649toStringimpl(str);
            return new SpoilerAttributes(SpoilerIdentifier.m136constructorimpl("spoiler:messageId" + str4 + ":" + str2), spoilerOrNull, SpoilerType.SPOILER, null);
        }
        ...
        public final SpoilerAttributes forAttachment(Attachment attachment, Message message, int i10) {
            ...
            return m132forItemA9xMOlw(attachment, str, indexLabel + i10);
        }
        ...
        public final SpoilerAttributes forEmbed(Embed embed, Message message, int i10) {
            ...
            q.h(message, "message");
            String str = message.m24getId3Eiw7ao();
            return m132forItemA9xMOlw(embed, str, "embedIndex" + i10);
        }
        ...
        public final SpoilerAttributes forMediaPostPreviewEmbed(PostPreviewEmbed embed, Message message, int i10) {
            ...
            q.h(message, "message");
            String str = message.m24getId3Eiw7ao();
            return m132forItemA9xMOlw(embed, str, "mediaPostPreviewEmbed" + i10);
        }
    }
    ...
    public static  SpoilerAttributes m128copyhoKre8U$default(SpoilerAttributes spoilerAttributes, String str, String str2, SpoilerType spoilerType, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return spoilerAttributes.m130copyhoKre8U(str, str2, spoilerType);
    }

    private final boolean hasSpoilerConfig() {
        if (SpoilerManager.INSTANCE.m143isNotRevealedV2PEE7g(this.identifier) || this.type == SpoilerType.OBSCURE) {
            return true;
        }
        return false;
    }
    ...
    public final String m129component1Bq9X6Gg() {
    ...
    public final SpoilerAttributes m130copyhoKre8U(String identifier, String label, SpoilerType type) {
    ...
    public boolean equals(Object obj) {
        ...
        return SpoilerIdentifier.m138equalsimpl0(this.identifier, spoilerAttributes.identifier) && q.c(this.label, spoilerAttributes.label) && this.type == spoilerAttributes.type;
    }

    
    public final String m131getIdentifierBq9X6Gg() {
        return this.identifier;
    }
    ...
    public int hashCode() {
        return (((SpoilerIdentifier.m139hashCodeimpl(this.identifier) * 31) + this.label.hashCode()) * 31) + this.type.hashCode();
    }

    public String toString() {
        String str = SpoilerIdentifier.m140toStringimpl(this.identifier);
