...
public final class SpoilerAttributes {
    ...
    public static final class Companion {
        ...
        private final SpoilerAttributes m120forItemA9xMOlw(SpoilerableData spoilerableData, String str, String str2) {
            ...
            String str3 = MessageId.m597toStringimpl(str);
        ...
        public final SpoilerAttributes forMediaPostPreviewEmbed(PostPreviewEmbed embed, Message message, int i10) {
            ...
            q.g(message, "message");
            String str = message.m16getId3Eiw7ao();
            return m120forItemA9xMOlw(embed, str, "mediaPostPreviewEmbed" + i10);
        }
    }
    ...
    public  SpoilerAttributes(String str, String str2, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2);
    }
    ...
    public static  SpoilerAttributes m116copyBDqOPVI$default(SpoilerAttributes spoilerAttributes, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
