...
final class SpoilerAttributes$configure$3$2 extends s implements Function1<SpoilerIdentifier, Unit> {
    ...
    public   Unit invoke(SpoilerIdentifier spoilerIdentifier) {
        m134invokeV2PEE7g(spoilerIdentifier.m141unboximpl());
        return Unit.f21601a;
    }

    
    public final void m134invokeV2PEE7g(String spoilerId) {
        q.h(spoilerId, "spoilerId");
        SpoilerManager.INSTANCE.m145markHiddenV2PEE7g(spoilerId);
