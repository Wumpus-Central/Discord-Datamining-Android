...
final class SpoilerAttributes$configure$3$1 extends s implements Function1<SpoilerIdentifier, Unit> {
    ...
    public   Unit invoke(SpoilerIdentifier spoilerIdentifier) {
        m133invokeV2PEE7g(spoilerIdentifier.m141unboximpl());
        return Unit.f21601a;
    }

    
    public final void m133invokeV2PEE7g(String spoilerId) {
        q.h(spoilerId, "spoilerId");
        SpoilerManager.INSTANCE.m146markRevealedV2PEE7g(spoilerId);
