...
public final class SpoilerIdentifier {
    ...
    public static final class Companion {
        ...
        public final String m142forNode2sfwrmE(SpoilerContentNode node, String containerId, int i10) {
            q.h(node, "node");
            q.h(containerId, "containerId");
            int hashCode = node.hashCode();
            return SpoilerIdentifier.m136constructorimpl("spoiler:" + hashCode + ":" + containerId + ":" + i10);
        }
    }
    ...
    public static final  SpoilerIdentifier m135boximpl(String str) {
        return new SpoilerIdentifier(str);
    }

    
    public static String m136constructorimpl(String id2) {
        q.h(id2, "id");
        return id2;
    }

    
    public static boolean m137equalsimpl(String str, Object obj) {
        return (obj instanceof SpoilerIdentifier) && q.c(str, ((SpoilerIdentifier) obj).m141unboximpl());
    }

    
    public static final boolean m138equalsimpl0(String str, String str2) {
        return q.c(str, str2);
    }

    
    public static int m139hashCodeimpl(String str) {
        return str.hashCode();
    }

    
    public static String m140toStringimpl(String str) {
        return "SpoilerIdentifier(id=" + str + ")";
    }

    public boolean equals(Object obj) {
        return m137equalsimpl(this.f6933id, obj);
    }
    ...
    public int hashCode() {
        return m139hashCodeimpl(this.f6933id);
    }

    public String toString() {
        return m140toStringimpl(this.f6933id);
    }

    
    public final  String m141unboximpl() {
        return this.f6933id;
    }
}
