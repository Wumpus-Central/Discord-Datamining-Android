...
public final class ParagraphContentNode extends ContentNode {
    ...
    public /* synthetic */ ParagraphContentNode(int i10, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static /* synthetic */ ParagraphContentNode copy$default(ParagraphContentNode paragraphContentNode, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ParagraphContentNode) && q.b(this.content, ((ParagraphContentNode) obj).content);
    }
