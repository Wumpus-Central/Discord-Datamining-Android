...
public final class CodeBlockContentNode extends ContentNode {
    ...
    public  CodeBlockContentNode(int i10, String str, String str2, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (7 != (i10 & 7)) {
    ...
    public static  CodeBlockContentNode copy$default(CodeBlockContentNode codeBlockContentNode, String str, String str2, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(CodeBlockContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.s(serialDesc, 0, self.lang);
        output.s(serialDesc, 1, self.content);
        output.r(serialDesc, 2, self.inQuote);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.lang, codeBlockContentNode.lang) && q.c(this.content, codeBlockContentNode.content) && this.inQuote == codeBlockContentNode.inQuote;
    }
