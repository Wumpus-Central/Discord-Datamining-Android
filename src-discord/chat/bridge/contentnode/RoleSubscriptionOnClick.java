...
public final class RoleSubscriptionOnClick {
    ...
    public  RoleSubscriptionOnClick(int i10, String str, String str2, String str3, String str4, String str5, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i10 & 31)) {
    ...
    public static  RoleSubscriptionOnClick copy$default(RoleSubscriptionOnClick roleSubscriptionOnClick, String str, String str2, String str3, String str4, String str5, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(RoleSubscriptionOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        a2 a2Var = a2.f30568a;
        output.e(serialDesc, 2, a2Var, self.messageId);
        output.e(serialDesc, 3, a2Var, self.channelId);
        output.e(serialDesc, 4, a2Var, self.roleSubscriptionListingId);
    }
