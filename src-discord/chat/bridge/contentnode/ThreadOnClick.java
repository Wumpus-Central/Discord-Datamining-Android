...
public final class ThreadOnClick {
    ...
    public  ThreadOnClick(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  ThreadOnClick copy$default(ThreadOnClick threadOnClick, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(ThreadOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 1, self.threadId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.action, threadOnClick.action) && q.c(this.threadId, threadOnClick.threadId);
    }
