...
public final class CustomEmojiContentNode extends EmojiContentNode {
    ...
    public static /* synthetic */ CustomEmojiContentNode copy$default(CustomEmojiContentNode customEmojiContentNode, long j10, String str, String str2, String str3, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = customEmojiContentNode.f7199id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(CustomEmojiContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.E(serialDesc, 0, self.f7199id);
        ...
        if (z10) {
            output.y(serialDesc, 4, self.getJumboable());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7199id == customEmojiContentNode.f7199id && q.b(this.alt, customEmojiContentNode.alt) && q.b(this.src, customEmojiContentNode.src) && q.b(this.frozenSrc, customEmojiContentNode.frozenSrc) && getJumboable() == customEmojiContentNode.getJumboable();
    }
    ...
    public int hashCode() {
        int a10 = ((((((a.a(this.f7199id) * 31) + this.alt.hashCode()) * 31) + this.src.hashCode()) * 31) + this.frozenSrc.hashCode()) * 31;
