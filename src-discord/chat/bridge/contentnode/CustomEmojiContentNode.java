...
public final class CustomEmojiContentNode extends EmojiContentNode {
    ...
    public static /* synthetic */ CustomEmojiContentNode copy$default(CustomEmojiContentNode customEmojiContentNode, long j10, String str, String str2, String str3, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = customEmojiContentNode.f7290id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(CustomEmojiContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.D(serialDesc, 0, self.f7290id);
        output.t(serialDesc, 1, self.alt);
        output.t(serialDesc, 2, self.src);
        output.t(serialDesc, 3, self.frozenSrc);
        if (output.w(serialDesc, 4) || self.getJumboable()) {
            z10 = true;
        }
        if (z10) {
            output.s(serialDesc, 4, self.getJumboable());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7290id == customEmojiContentNode.f7290id && q.b(this.alt, customEmojiContentNode.alt) && q.b(this.src, customEmojiContentNode.src) && q.b(this.frozenSrc, customEmojiContentNode.frozenSrc) && getJumboable() == customEmojiContentNode.getJumboable();
    }
    ...
    public int hashCode() {
        int a10 = ((((((b.a(this.f7290id) * 31) + this.alt.hashCode()) * 31) + this.src.hashCode()) * 31) + this.frozenSrc.hashCode()) * 31;
