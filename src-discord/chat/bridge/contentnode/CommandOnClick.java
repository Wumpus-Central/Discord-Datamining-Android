...
public final class CommandOnClick {
    ...
    public static /* synthetic */ CommandOnClick m47copyjIMHauk$default(CommandOnClick commandOnClick, String str, UserId userId, String str2, UserId userId2, MessageType messageType, ChannelId channelId, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(CommandOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z15 = false;
        if (!output.A(serialDesc, 0) && self.action == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 0, a2.f32934a, self.action);
        }
        ...
        if (z12) {
            ...
            if (str != null) {
                messageId = MessageId.m589boximpl(str);
            } else {
                messageId = null;
            }
            output.u(serialDesc, 2, messageId$$serializer, messageId);
        }
        if (!output.A(serialDesc, 3) && self.applicationUserId == null) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (z13) {
            output.u(serialDesc, 3, UserId$$serializer.INSTANCE, self.applicationUserId);
        }
        if (!output.A(serialDesc, 4) && self.messageType == null) {
            z14 = false;
        } else {
            z14 = true;
        }
        if (z14) {
            output.u(serialDesc, 4, MessageType.Serializer.INSTANCE, self.messageType);
        }
        if (output.A(serialDesc, 5) || self.messageChannelId != null) {
            z15 = true;
        }
        if (z15) {
            output.u(serialDesc, 5, ChannelId$$serializer.INSTANCE, self.messageChannelId);
        }
    }
    ...
    */
    ...
    public int hashCode() {
        ...
        int i11 = (hashCode + (userId == null ? 0 : UserId.m632hashCodeimpl(userId.m636unboximpl()))) * 31;
        String str2 = this.messageId;
        int i12 = (i11 + (str2 == null ? 0 : MessageId.m594hashCodeimpl(str2))) * 31;
        UserId userId2 = this.applicationUserId;
        int i13 = (i12 + (userId2 == null ? 0 : UserId.m632hashCodeimpl(userId2.m636unboximpl()))) * 31;
        MessageType messageType = this.messageType;
        int hashCode2 = (i13 + (messageType == null ? 0 : messageType.hashCode())) * 31;
        ChannelId channelId = this.messageChannelId;
        if (channelId != null) {
            i10 = ChannelId.m568hashCodeimpl(channelId.m572unboximpl());
        }
