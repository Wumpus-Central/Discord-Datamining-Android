...
public final class CommandOnClick {
    ...
    public static  CommandOnClick m54copyjIMHauk$default(CommandOnClick commandOnClick, String str, UserId userId, String str2, UserId userId2, MessageType messageType, ChannelId channelId, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return commandOnClick.m59copyjIMHauk(str, userId, str2, userId2, messageType, channelId);
    }
    ...
    public static final void write$Self(CommandOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.E(serialDesc, 0, a2.f6238a, self.action);
        }
    ...
    public final UserId m55component2wUX8bhU() {
        return this.userId;
    }

    
    public final String m56component3N_6c4I0() {
        return this.messageId;
    }

    
    public final UserId m57component4wUX8bhU() {
    ...
    public final ChannelId m58component6qMVnFVQ() {
        return this.messageChannelId;
    }

    
    public final CommandOnClick m59copyjIMHauk(String str, UserId userId, String str2, UserId userId2, MessageType messageType, ChannelId channelId) {
    ...
    public final UserId m60getApplicationUserIdwUX8bhU() {
        return this.applicationUserId;
    }

    
    public final ChannelId m61getMessageChannelIdqMVnFVQ() {
        return this.messageChannelId;
    }

    
    public final String m62getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public final UserId m63getUserIdwUX8bhU() {
        return this.userId;
    }
