...
public final class HeadingContentNode extends ContentNode {
    ...
    public  HeadingContentNode(int i10, int i11, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (3 != (i10 & 3)) {
    ...
    public static  HeadingContentNode copy$default(HeadingContentNode headingContentNode, int i10, List list, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(HeadingContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 1, new xi.f(ContentNodeSerializer.INSTANCE), self.content);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.level == headingContentNode.level && q.c(this.content, headingContentNode.content);
    }
