...
public final class ChannelMentionContentNode extends MentionContentNode {
    ...
    public static final void write$Self(ChannelMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 1, a2.f26972a, self.guildId);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, a2.f26972a, self.messageId);
        }
        ...
        if (z12) {
            output.e(serialDesc, 3, a2.f26972a, self.originalLink);
        }
        if (output.w(serialDesc, 4) || self.inContent != null) {
            z13 = true;
        }
        if (z13) {
            output.e(serialDesc, 4, new ti.f(ContentNodeSerializer.INSTANCE), self.inContent);
        }
        output.e(serialDesc, 5, new ti.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
