...
public final class ChannelMentionContentNode extends MentionContentNode {
    ...
    public static final void write$Self(ChannelMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.E(serialDesc, 1, a2.f6238a, self.guildId);
        }
        ...
        if (z13) {
            output.E(serialDesc, 4, new cj.f(ContentNodeSerializer.INSTANCE), self.inContent);
        }
        output.E(serialDesc, 5, new cj.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
