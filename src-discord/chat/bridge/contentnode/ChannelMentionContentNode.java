...
public final class ChannelMentionContentNode extends MentionContentNode {
    ...
    public static final void write$Self(ChannelMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.u(serialDesc, 1, a2.f32924a, self.guildId);
        }
        ...
        if (z11) {
            output.u(serialDesc, 2, a2.f32924a, self.messageId);
        }
        ...
        if (z12) {
            output.u(serialDesc, 3, a2.f32924a, self.originalLink);
        }
        if (output.A(serialDesc, 4) || self.inContent != null) {
            z13 = true;
        }
        if (z13) {
            output.u(serialDesc, 4, new yj.f(ContentNodeSerializer.INSTANCE), self.inContent);
        }
        output.u(serialDesc, 5, new yj.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
