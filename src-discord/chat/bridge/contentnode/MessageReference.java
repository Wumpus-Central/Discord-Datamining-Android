...
public final class MessageReference {
    ...
    public static /* synthetic */ MessageReference m71copy2_zTmBg$default(MessageReference messageReference, long j10, GuildId guildId, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static /* synthetic */ void m72getChannelIdo4g7jtM$annotations() {
    }

    /* renamed from: getGuildId-qOKuAAo$annotations  reason: not valid java name */
    public static /* synthetic */ void m73getGuildIdqOKuAAo$annotations() {
    }
    ...
    public static final void write$Self(MessageReference self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.q(serialDesc, 0, ChannelId$$serializer.INSTANCE, ChannelId.m554boximpl(self.channelId));
    ...
    public boolean equals(Object obj) {
        ...
        return ChannelId.m558equalsimpl0(this.channelId, messageReference.channelId) && q.b(this.guildId, messageReference.guildId);
    }
    ...
    public int hashCode() {
        int i10 = ChannelId.m559hashCodeimpl(this.channelId) * 31;
        GuildId guildId = this.guildId;
        return i10 + (guildId == null ? 0 : GuildId.m572hashCodeimpl(guildId.m576unboximpl()));
    }
