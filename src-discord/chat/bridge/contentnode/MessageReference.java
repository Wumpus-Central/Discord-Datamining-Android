...
public final class MessageReference {
    ...
    public static  MessageReference m78copy2_zTmBg$default(MessageReference messageReference, long j10, GuildId guildId, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return messageReference.m83copy2_zTmBg(j10, guildId);
    }

    
    public static  void m79getChannelIdo4g7jtM$annotations() {
    }

    
    public static  void m80getGuildIdqOKuAAo$annotations() {
    }
    ...
    public final long m81component1o4g7jtM() {
        return this.channelId;
    }

    
    public final GuildId m82component2qOKuAAo() {
        return this.guildId;
    }

    
    public final MessageReference m83copy2_zTmBg(long j10, GuildId guildId) {
    ...
    public boolean equals(Object obj) {
        ...
        return ChannelId.m614equalsimpl0(this.channelId, messageReference.channelId) && q.c(this.guildId, messageReference.guildId);
    }

    
    public final long m84getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public int hashCode() {
        int i10 = ChannelId.m615hashCodeimpl(this.channelId) * 31;
        GuildId guildId = this.guildId;
        return i10 + (guildId == null ? 0 : GuildId.m628hashCodeimpl(guildId.m632unboximpl()));
    }
