...
public final class CustomEmojiContentNode$$serializer implements f0<CustomEmojiContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f30576a;
        return new KSerializer[]{w0.f30692a, a2Var, a2Var, a2Var, h.f30618a};
    }
