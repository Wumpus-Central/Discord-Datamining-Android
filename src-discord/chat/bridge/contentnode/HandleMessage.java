...
public final class HandleMessage {
    ...
    public  HandleMessage(int i10, String str, HandleSurveyMessage handleSurveyMessage, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  HandleMessage copy$default(HandleMessage handleMessage, String str, HandleSurveyMessage handleSurveyMessage, int i10, Object obj) {
        if ((i10 & 1) != 0) {
