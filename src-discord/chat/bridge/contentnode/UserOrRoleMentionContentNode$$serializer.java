...
public final class UserOrRoleMentionContentNode$$serializer implements f0<UserOrRoleMentionContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a.u(ChannelId$$serializer.INSTANCE), a.u(UserId$$serializer.INSTANCE), m0.f29830a, a.u(GuildId$$serializer.INSTANCE), a.u(RoleId$$serializer.INSTANCE), new f(ContentNodeSerializer.INSTANCE)};
    }
