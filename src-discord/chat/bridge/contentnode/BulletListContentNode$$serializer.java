...
public final class BulletListContentNode$$serializer implements f0<BulletListContentNode> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a.u(w0.f30684a), h.f30610a, new f(new f(ContentNodeSerializer.INSTANCE))};
    }
    ...
    public BulletListContentNode deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            obj2 = b10.n(descriptor2, 0, w0.f30684a, null);
            ...
            while (z11) {
                ...
                if (o10 == -1) {
                    ...
                    obj3 = b10.n(descriptor2, 0, w0.f30684a, obj3);
                    i11 |= 1;
                } else if (o10 == 1) {
