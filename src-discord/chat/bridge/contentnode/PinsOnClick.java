...
public final class PinsOnClick {
    ...
    private PinsOnClick(int i10, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.action = str;
        this.messageChannelId = channelId.m600unboximpl();
    }
    ...
    public static final void write$Self(PinsOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m591boximpl(self.messageChannelId));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.action, pinsOnClick.action) && ChannelId.m595equalsimpl0(this.messageChannelId, pinsOnClick.messageChannelId);
    }
    ...
    public int hashCode() {
        return (this.action.hashCode() * 31) + ChannelId.m596hashCodeimpl(this.messageChannelId);
    }

    public String toString() {
        String str = this.action;
        String str2 = ChannelId.m598toStringimpl(this.messageChannelId);
