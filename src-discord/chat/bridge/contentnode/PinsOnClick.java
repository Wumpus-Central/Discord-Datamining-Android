...
public final class PinsOnClick {
    ...
    private PinsOnClick(int i10, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.action = str;
        this.messageChannelId = channelId.m571unboximpl();
    }

    public /* synthetic */ PinsOnClick(int i10, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, str, channelId, serializationConstructorMarker);
    }

    public /* synthetic */ PinsOnClick(String str, long j10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, j10);
    }

    /* renamed from: copy-mJqaSGE$default  reason: not valid java name */
    public static /* synthetic */ PinsOnClick m78copymJqaSGE$default(PinsOnClick pinsOnClick, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return pinsOnClick.m80copymJqaSGE(str, j10);
    }
    ...
    public static final void write$Self(PinsOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m562boximpl(self.messageChannelId));
    }
    ...
    public final long m79component2o4g7jtM() {
        return this.messageChannelId;
    }

    /* renamed from: copy-mJqaSGE  reason: not valid java name */
    public final PinsOnClick m80copymJqaSGE(String action, long j10) {
        q.g(action, "action");
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.action, pinsOnClick.action) && ChannelId.m566equalsimpl0(this.messageChannelId, pinsOnClick.messageChannelId);
    }
    ...
    public final long m81getMessageChannelIdo4g7jtM() {
        return this.messageChannelId;
    }

    public int hashCode() {
        return (this.action.hashCode() * 31) + ChannelId.m567hashCodeimpl(this.messageChannelId);
    }

    public String toString() {
        String str = this.action;
        String str2 = ChannelId.m569toStringimpl(this.messageChannelId);
