...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    public static final void write$Self(CommandMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, ChannelId$$serializer.INSTANCE, ChannelId.m610boximpl(self.channelId));
    ...
    public boolean equals(Object obj) {
        ...
        return ChannelId.m614equalsimpl0(this.channelId, commandMentionContentNode.channelId) && q.c(this.commandId, commandMentionContentNode.commandId) && q.c(this.commandName, commandMentionContentNode.commandName) && q.c(this.commandKey, commandMentionContentNode.commandKey) && q.c(getContent(), commandMentionContentNode.getContent());
    }
    ...
    public int hashCode() {
        return (((((((ChannelId.m615hashCodeimpl(this.channelId) * 31) + this.commandId.hashCode()) * 31) + this.commandName.hashCode()) * 31) + this.commandKey.hashCode()) * 31) + getContent().hashCode();
    }
