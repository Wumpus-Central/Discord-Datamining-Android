...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    public static  CommandMentionContentNode m42copyJrbBJuM$default(CommandMentionContentNode commandMentionContentNode, long j10, String str, String str2, String str3, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(CommandMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.n(serialDesc, 4, new si.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
    ...
    public int hashCode() {
        return (((((((ChannelId.m571hashCodeimpl(this.channelId) * 31) + this.commandId.hashCode()) * 31) + this.commandName.hashCode()) * 31) + this.commandKey.hashCode()) * 31) + getContent().hashCode();
    }
