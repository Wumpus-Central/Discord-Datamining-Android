...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    public static  CommandMentionContentNode m50copyJrbBJuM$default(CommandMentionContentNode commandMentionContentNode, long j10, String str, String str2, String str3, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return commandMentionContentNode.m52copyJrbBJuM(j10, str, str2, str3, list);
    }
    ...
    public static final void write$Self(CommandMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, ChannelId$$serializer.INSTANCE, ChannelId.m617boximpl(self.channelId));
        output.y(serialDesc, 1, self.commandId);
        output.y(serialDesc, 2, self.commandName);
        output.y(serialDesc, 3, self.commandKey);
        output.i(serialDesc, 4, new cj.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }

    
    public final long m51component1o4g7jtM() {
    ...
    public final CommandMentionContentNode m52copyJrbBJuM(long j10, String commandId, String commandName, String commandKey, List<? extends ContentNode> content) {
    ...
    public boolean equals(Object obj) {
        ...
        return ChannelId.m621equalsimpl0(this.channelId, commandMentionContentNode.channelId) && q.c(this.commandId, commandMentionContentNode.commandId) && q.c(this.commandName, commandMentionContentNode.commandName) && q.c(this.commandKey, commandMentionContentNode.commandKey) && q.c(getContent(), commandMentionContentNode.getContent());
    }

    
    public final long m53getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public int hashCode() {
        return (((((((ChannelId.m622hashCodeimpl(this.channelId) * 31) + this.commandId.hashCode()) * 31) + this.commandName.hashCode()) * 31) + this.commandKey.hashCode()) * 31) + getContent().hashCode();
    }
