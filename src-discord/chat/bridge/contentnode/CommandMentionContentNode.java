...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    public static final void write$Self(CommandMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 0, ChannelId$$serializer.INSTANCE, ChannelId.m605boximpl(self.channelId));
    ...
    public int hashCode() {
        return (((((((ChannelId.m610hashCodeimpl(this.channelId) * 31) + this.commandId.hashCode()) * 31) + this.commandName.hashCode()) * 31) + this.commandKey.hashCode()) * 31) + getContent().hashCode();
    }
