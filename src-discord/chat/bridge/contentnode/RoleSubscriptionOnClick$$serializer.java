...
@Metadata(d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, d2 = {"com/discord/chat/bridge/contentnode/RoleSubscriptionOnClick.$serializer", "Lsi/f0;", "Lcom/discord/chat/bridge/contentnode/RoleSubscriptionOnClick;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "chat_release"}, k = 1, mv = {1, 8, 0})
...
public final class RoleSubscriptionOnClick$$serializer implements f0<RoleSubscriptionOnClick> {
        ...
        if (c10.y()) {
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj4 = c10.v(descriptor2, 2, a2.f26246a, obj4);
                    i11 |= 4;
                } else if (x10 == 3) {
                    obj5 = c10.v(descriptor2, 3, a2.f26246a, obj5);
                    i11 |= 8;
                } else if (x10 == 4) {
                    obj6 = c10.v(descriptor2, 4, a2.f26246a, obj6);
                    i11 |= 16;
                } else {
                    throw new n(x10);
                }
    ...
    public void serialize(Encoder encoder, RoleSubscriptionOnClick value) {
        ...
        RoleSubscriptionOnClick.write$Self(value, c10, descriptor2);
        c10.b(descriptor2);
    }
