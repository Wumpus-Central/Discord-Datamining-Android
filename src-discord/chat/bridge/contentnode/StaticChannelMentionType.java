...
public enum StaticChannelMentionType {
    ...
    private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = n.a(p.PUBLICATION, StaticChannelMentionType$Companion$$cachedSerializer$delegate$1.INSTANCE);
    ...
    public static final class Serializer implements KSerializer<StaticChannelMentionType> {
        ...
        public SerialDescriptor getDescriptor() {
            return g.a("StaticChannelMentionType", e.i.f32129a);
        }
