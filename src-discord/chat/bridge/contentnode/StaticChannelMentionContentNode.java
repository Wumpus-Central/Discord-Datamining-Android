...
public final class StaticChannelMentionContentNode extends MentionContentNode {
    ...
    public static  StaticChannelMentionContentNode m83copyCu15v9A$default(StaticChannelMentionContentNode staticChannelMentionContentNode, StaticChannelMentionType staticChannelMentionType, GuildId guildId, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return ((hashCode + (guildId == null ? 0 : GuildId.m585hashCodeimpl(guildId.m589unboximpl()))) * 31) + getContent().hashCode();
    }
