...
public final class StaticChannelMentionContentNode extends MentionContentNode {
    ...
    public static final void write$Self(StaticChannelMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.n(serialDesc, 0, StaticChannelMentionType.Serializer.INSTANCE, self.channelId);
        ...
        output.n(serialDesc, 2, new si.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode + (guildId == null ? 0 : GuildId.m584hashCodeimpl(guildId.m588unboximpl()))) * 31) + getContent().hashCode();
    }
