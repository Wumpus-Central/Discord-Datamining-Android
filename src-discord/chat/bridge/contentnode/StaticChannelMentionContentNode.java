...
public final class StaticChannelMentionContentNode extends MentionContentNode {
    ...
    public static /* synthetic */ StaticChannelMentionContentNode m83copyCu15v9A$default(StaticChannelMentionContentNode staticChannelMentionContentNode, StaticChannelMentionType staticChannelMentionType, GuildId guildId, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return staticChannelMentionContentNode.m85copyCu15v9A(staticChannelMentionType, guildId, list);
    }
    ...
    public static final void write$Self(StaticChannelMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.q(serialDesc, 0, StaticChannelMentionType.Serializer.INSTANCE, self.channelId);
        if (output.A(serialDesc, 1) || self.guildId != null) {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 1, GuildId$$serializer.INSTANCE, self.guildId);
        }
        output.q(serialDesc, 2, new yj.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }
    ...
    public final GuildId m84component2qOKuAAo() {
        return this.guildId;
    }
    ...
    public final StaticChannelMentionContentNode m85copyCu15v9A(StaticChannelMentionType channelId, GuildId guildId, List<? extends ContentNode> content) {
    ...
    public int hashCode() {
        ...
        return ((hashCode + (guildId == null ? 0 : GuildId.m572hashCodeimpl(guildId.m576unboximpl()))) * 31) + getContent().hashCode();
    }
