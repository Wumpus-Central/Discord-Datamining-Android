...
public final class HandleSurveyMessage {
    ...
    public static /* synthetic */ HandleSurveyMessage m64copyEqy5D80$default(HandleSurveyMessage handleSurveyMessage, String str, long j10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = handleSurveyMessage.f7622id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(HandleSurveyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.q(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m589boximpl(self.f7622id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m593equalsimpl0(this.f7622id, handleSurveyMessage.f7622id) && ChannelId.m567equalsimpl0(this.channelId, handleSurveyMessage.channelId) && q.b(this.loggingName, handleSurveyMessage.loggingName);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m594hashCodeimpl(this.f7622id) * 31) + ChannelId.m568hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return i10 + (str == null ? 0 : str.hashCode());
    }

    public String toString() {
        String str = MessageId.m595toStringimpl(this.f7622id);
