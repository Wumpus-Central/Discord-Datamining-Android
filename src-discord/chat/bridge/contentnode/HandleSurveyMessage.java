...
public final class HandleSurveyMessage {
    ...
    public static /* synthetic */ HandleSurveyMessage m64copyEqy5D80$default(HandleSurveyMessage handleSurveyMessage, String str, long j10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = handleSurveyMessage.f7699id;
        }
        if ((i10 & 2) != 0) {
        ...
        return handleSurveyMessage.m68copyEqy5D80(str, j10, str2);
    }

    /* renamed from: getChannelId-o4g7jtM$annotations  reason: not valid java name */
    public static /* synthetic */ void m65getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(HandleSurveyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.z(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m572boximpl(self.f7699id));
    ...
    public final HandleSurveyMessage m68copyEqy5D80(String id2, long j10, String str) {
        q.g(id2, "id");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(this.f7699id, handleSurveyMessage.f7699id) && ChannelId.m550equalsimpl0(this.channelId, handleSurveyMessage.channelId) && q.b(this.loggingName, handleSurveyMessage.loggingName);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m577hashCodeimpl(this.f7699id) * 31) + ChannelId.m551hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return i10 + (str == null ? 0 : str.hashCode());
    }

    public String toString() {
        String str = MessageId.m578toStringimpl(this.f7699id);
