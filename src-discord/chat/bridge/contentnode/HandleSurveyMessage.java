...
public final class HandleSurveyMessage {
    ...
    public static  HandleSurveyMessage m71copyEqy5D80$default(HandleSurveyMessage handleSurveyMessage, String str, long j10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = handleSurveyMessage.f6927id;
        }
        if ((i10 & 2) != 0) {
        ...
        return handleSurveyMessage.m75copyEqy5D80(str, j10, str2);
    }
    ...
    public static final void write$Self(HandleSurveyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.i(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m643boximpl(self.f6927id));
    ...
    public final String m73component13Eiw7ao() {
        return this.f6927id;
    }

    
    public final long m74component2o4g7jtM() {
    ...
    public final HandleSurveyMessage m75copyEqy5D80(String id2, long j10, String str) {
        q.h(id2, "id");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m647equalsimpl0(this.f6927id, handleSurveyMessage.f6927id) && ChannelId.m621equalsimpl0(this.channelId, handleSurveyMessage.channelId) && q.c(this.loggingName, handleSurveyMessage.loggingName);
    }

    
    public final long m76getChannelIdo4g7jtM() {
        return this.channelId;
    }

    
    public final String m77getId3Eiw7ao() {
        return this.f6927id;
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m648hashCodeimpl(this.f6927id) * 31) + ChannelId.m622hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return i10 + (str == null ? 0 : str.hashCode());
    }

    public String toString() {
        String str = MessageId.m649toStringimpl(this.f6927id);
