...
public final class HandleSurveyMessage {
    ...
    public static final void write$Self(HandleSurveyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.h(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m631boximpl(self.f7242id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m635equalsimpl0(this.f7242id, handleSurveyMessage.f7242id) && ChannelId.m609equalsimpl0(this.channelId, handleSurveyMessage.channelId) && q.c(this.loggingName, handleSurveyMessage.loggingName);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m636hashCodeimpl(this.f7242id) * 31) + ChannelId.m610hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return i10 + (str == null ? 0 : str.hashCode());
    }

    public String toString() {
        String str = MessageId.m637toStringimpl(this.f7242id);
