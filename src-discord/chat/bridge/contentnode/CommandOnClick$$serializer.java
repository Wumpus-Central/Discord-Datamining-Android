...
public final class CommandOnClick$$serializer implements f0<CommandOnClick> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{a.u(a2.f29758a), a.u(userId$$serializer), a.u(MessageId$$serializer.INSTANCE), a.u(userId$$serializer), a.u(MessageType.Serializer.INSTANCE), a.u(ChannelId$$serializer.INSTANCE)};
    }
    ...
    public CommandOnClick deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            obj6 = b10.n(descriptor2, 0, a2.f29758a, null);
            UserId$$serializer userId$$serializer = UserId$$serializer.INSTANCE;
            ...
            while (z10) {
                ...
                switch (o10) {
                    case -1:
                        ...
                        break;
                    case 0:
                        obj6 = b10.n(descriptor2, 0, a2.f29758a, obj6);
                        i11 |= 1;
                        break;
                    case 1:
