...
public final class WebhookNameOnClick {
    ...
    public /* synthetic */ WebhookNameOnClick(int i10, String str, MessageReference messageReference, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static /* synthetic */ WebhookNameOnClick copy$default(WebhookNameOnClick webhookNameOnClick, String str, MessageReference messageReference, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(WebhookNameOnClick self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.A(serialDesc, 1) || self.messageReference != null) {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 1, MessageReference$$serializer.INSTANCE, self.messageReference);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.action, webhookNameOnClick.action) && q.b(this.messageReference, webhookNameOnClick.messageReference);
    }
    ...
    public /* synthetic */ WebhookNameOnClick(String str, MessageReference messageReference, int i10, DefaultConstructorMarker defaultConstructorMarker) {
