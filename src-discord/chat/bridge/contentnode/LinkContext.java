...
public final class LinkContext {
    ...
    public static final void write$Self(LinkContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z19 = false;
        if (!output.A(serialDesc, 0) && self.usernameOnClick == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 0, UserNameOnClick$$serializer.INSTANCE, self.usernameOnClick);
        }
        ...
        if (z11) {
            output.u(serialDesc, 1, UserNameOnClick$$serializer.INSTANCE, self.otherUsernameOnClick);
        }
        ...
        if (z12) {
            output.u(serialDesc, 2, CommandOnClick$$serializer.INSTANCE, self.commandNameOnClick);
        }
        ...
        if (z13) {
            output.u(serialDesc, 3, ActorHook$$serializer.INSTANCE, self.actorHook);
        }
        ...
        if (z14) {
            output.u(serialDesc, 4, ThreadOnClick$$serializer.INSTANCE, self.threadOnClick);
        }
        ...
        if (z15) {
            output.u(serialDesc, 5, PinsOnClick$$serializer.INSTANCE, self.pinsOnClick);
        }
        ...
        if (z16) {
            output.u(serialDesc, 6, WebhookNameOnClick$$serializer.INSTANCE, self.webhookNameOnClick);
        }
        ...
        if (z17) {
            output.u(serialDesc, 7, HandleDelete$$serializer.INSTANCE, self.handleDelete);
        }
        ...
        if (z18) {
            output.u(serialDesc, 8, RoleSubscriptionOnClick$$serializer.INSTANCE, self.roleSubscriptionOnClick);
        }
        if (output.A(serialDesc, 9) || self.handleMessage != null) {
            z19 = true;
        }
        if (z19) {
            output.u(serialDesc, 9, HandleMessage$$serializer.INSTANCE, self.handleMessage);
        }
    }
    ...
    public /* synthetic */ LinkContext(UserNameOnClick userNameOnClick, UserNameOnClick userNameOnClick2, CommandOnClick commandOnClick, ActorHook actorHook, ThreadOnClick threadOnClick, PinsOnClick pinsOnClick, WebhookNameOnClick webhookNameOnClick, HandleDelete handleDelete, RoleSubscriptionOnClick roleSubscriptionOnClick, HandleMessage handleMessage, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? null : userNameOnClick, (i10 & 2) != 0 ? null : userNameOnClick2, (i10 & 4) != 0 ? null : commandOnClick, (i10 & 8) != 0 ? null : actorHook, (i10 & 16) != 0 ? null : threadOnClick, (i10 & 32) != 0 ? null : pinsOnClick, (i10 & 64) != 0 ? null : webhookNameOnClick, (i10 & 128) != 0 ? null : handleDelete, (i10 & Spliterator.NONNULL) != 0 ? null : roleSubscriptionOnClick, (i10 & 512) == 0 ? handleMessage : null);
    }
}
