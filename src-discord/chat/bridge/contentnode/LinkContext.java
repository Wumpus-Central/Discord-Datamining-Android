...
public final class LinkContext {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.usernameOnClick, linkContext.usernameOnClick) && q.c(this.otherUsernameOnClick, linkContext.otherUsernameOnClick) && q.c(this.commandNameOnClick, linkContext.commandNameOnClick) && q.c(this.actorHook, linkContext.actorHook) && q.c(this.threadOnClick, linkContext.threadOnClick) && q.c(this.pinsOnClick, linkContext.pinsOnClick) && q.c(this.webhookNameOnClick, linkContext.webhookNameOnClick) && q.c(this.handleDelete, linkContext.handleDelete) && q.c(this.roleSubscriptionOnClick, linkContext.roleSubscriptionOnClick) && q.c(this.handleMessage, linkContext.handleMessage);
    }
