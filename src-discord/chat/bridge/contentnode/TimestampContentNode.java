...
public final class TimestampContentNode extends ContentNode {
    ...
    public static final void write$Self(TimestampContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 1, self.full);
        output.z(serialDesc, 2, self.formatted);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.timestamp == timestampContentNode.timestamp && q.b(this.full, timestampContentNode.full) && q.b(this.formatted, timestampContentNode.formatted);
    }
