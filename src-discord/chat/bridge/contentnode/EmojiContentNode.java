...
public abstract class EmojiContentNode extends ContentNode implements Jumboable {
    ...
    private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = n.a(p.PUBLICATION, EmojiContentNode$Companion$$cachedSerializer$delegate$1.INSTANCE);
