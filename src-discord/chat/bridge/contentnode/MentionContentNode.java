...
public abstract class MentionContentNode extends ContentNode {
    ...
    private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = n.a(p.PUBLICATION, MentionContentNode$Companion$$cachedSerializer$delegate$1.INSTANCE);
