...
public abstract class MentionContentNode extends ContentNode {
    ...
    static {
        ...
        b10 = n.b(p.PUBLICATION, MentionContentNode$Companion$$cachedSerializer$delegate$1.INSTANCE);
        $cachedSerializer$delegate = b10;
    }

    public  MentionContentNode(int i10, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
    }

    public  MentionContentNode(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
