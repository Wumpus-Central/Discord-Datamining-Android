...
public final class HandleMessage$$serializer implements f0<HandleMessage> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a2.f26237a, HandleSurveyMessage$$serializer.INSTANCE};
    }
        ...
        if (c10.y()) {
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj2 = c10.m(descriptor2, 1, HandleSurveyMessage$$serializer.INSTANCE, obj2);
                    i11 |= 2;
                } else {
                    throw new n(x10);
                }
