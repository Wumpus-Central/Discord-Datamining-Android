...
public final class HandleMessage$$serializer implements f0<HandleMessage> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a2.f32309a, HandleSurveyMessage$$serializer.INSTANCE};
    }
