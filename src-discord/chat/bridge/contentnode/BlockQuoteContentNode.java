...
public final class BlockQuoteContentNode extends ContentNode {
    ...
    public  BlockQuoteContentNode(int i10, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static  BlockQuoteContentNode copy$default(BlockQuoteContentNode blockQuoteContentNode, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
