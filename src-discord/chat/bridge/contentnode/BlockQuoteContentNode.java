...
public final class BlockQuoteContentNode extends ContentNode {
    ...
    public /* synthetic */ BlockQuoteContentNode(int i10, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
            n1.b(i10, 1, BlockQuoteContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.content = list;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ BlockQuoteContentNode copy$default(BlockQuoteContentNode blockQuoteContentNode, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BlockQuoteContentNode) && q.b(this.content, ((BlockQuoteContentNode) obj).content);
    }
