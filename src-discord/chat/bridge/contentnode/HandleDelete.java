...
public final class HandleDelete {
    ...
    public  HandleDelete(int i10, String str, HandleDeleteMessage handleDeleteMessage, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  HandleDelete copy$default(HandleDelete handleDelete, String str, HandleDeleteMessage handleDeleteMessage, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(HandleDelete self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 1, HandleDeleteMessage$$serializer.INSTANCE, self.message);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.action, handleDelete.action) && q.c(this.message, handleDelete.message);
    }
