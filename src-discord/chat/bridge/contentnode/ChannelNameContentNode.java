...
public final class ChannelNameContentNode extends ContentNode {
    ...
    public static final void write$Self(ChannelNameContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.h(serialDesc, 0, ChannelType.Serializer.INSTANCE, self.channelType);
        }
        ...
        if (z11) {
            output.h(serialDesc, 2, a2.f32313a, self.icon);
        }
        output.z(serialDesc, 3, new xj.f(ContentNodeSerializer.INSTANCE), self.content);
    }
