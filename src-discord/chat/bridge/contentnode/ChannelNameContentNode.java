...
public final class ChannelNameContentNode extends ContentNode {
    ...
    public  ChannelNameContentNode(int i10, ChannelType channelType, String str, String str2, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (10 != (i10 & 10)) {
    ...
    public static  ChannelNameContentNode copy$default(ChannelNameContentNode channelNameContentNode, ChannelType channelType, String str, String str2, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(ChannelNameContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 0, ChannelType.Serializer.INSTANCE, self.channelType);
        }
        output.y(serialDesc, 1, self.iconType);
        if (output.z(serialDesc, 2) || self.icon != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 2, a2.f30576a, self.icon);
        }
        output.h(serialDesc, 3, new xi.f(ContentNodeSerializer.INSTANCE), self.content);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.channelType == channelNameContentNode.channelType && q.c(this.iconType, channelNameContentNode.iconType) && q.c(this.icon, channelNameContentNode.icon) && q.c(this.content, channelNameContentNode.content);
    }
    ...
    public  ChannelNameContentNode(ChannelType channelType, String str, String str2, List list, int i10, DefaultConstructorMarker defaultConstructorMarker) {
