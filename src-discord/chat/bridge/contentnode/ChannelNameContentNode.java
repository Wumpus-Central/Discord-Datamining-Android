...
public final class ChannelNameContentNode extends ContentNode {
    ...
    public static final void write$Self(ChannelNameContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 1, self.iconType);
        if (output.w(serialDesc, 2) || self.icon != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 2, a2.f26972a, self.icon);
        }
        output.C(serialDesc, 3, new ti.f(ContentNodeSerializer.INSTANCE), self.content);
    }
