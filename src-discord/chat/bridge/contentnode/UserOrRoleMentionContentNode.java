...
public final class UserOrRoleMentionContentNode extends MentionContentNode {
    ...
    public int hashCode() {
        ...
        int i10 = 0;
        int i11 = (channelId == null ? 0 : ChannelId.m596hashCodeimpl(channelId.m600unboximpl())) * 31;
        UserId userId = this.userId;
        int i12 = (((i11 + (userId == null ? 0 : UserId.m660hashCodeimpl(userId.m664unboximpl()))) * 31) + this.roleColor) * 31;
        GuildId guildId = this.guildId;
        int i13 = (i12 + (guildId == null ? 0 : GuildId.m609hashCodeimpl(guildId.m613unboximpl()))) * 31;
        RoleId roleId = this.roleId;
        if (roleId != null) {
            i10 = RoleId.m634hashCodeimpl(roleId.m638unboximpl());
        }
