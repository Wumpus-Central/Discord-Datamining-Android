...
public final class UserOrRoleMentionContentNode extends MentionContentNode {
    ...
    public  UserOrRoleMentionContentNode(int i10, ChannelId channelId, UserId userId, int i11, GuildId guildId, RoleId roleId, List list, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, channelId, userId, i11, guildId, roleId, list, serializationConstructorMarker);
    }

    public  UserOrRoleMentionContentNode(ChannelId channelId, UserId userId, int i10, GuildId guildId, RoleId roleId, List list, DefaultConstructorMarker defaultConstructorMarker) {
        this(channelId, userId, i10, guildId, roleId, list);
    }

    
    
    public static  UserOrRoleMentionContentNode m100copyDZRaReU$default(UserOrRoleMentionContentNode userOrRoleMentionContentNode, ChannelId channelId, UserId userId, int i10, GuildId guildId, RoleId roleId, List list, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return userOrRoleMentionContentNode.m105copyDZRaReU(channelId, userId, i10, guildId, roleId, list);
    }
    ...
    public static final void write$Self(UserOrRoleMentionContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.E(serialDesc, 0, ChannelId$$serializer.INSTANCE, self.channelId);
        }
        ...
        if (z12) {
            output.w(serialDesc, 2, self.roleColor);
        }
        ...
        if (z14) {
            output.E(serialDesc, 4, RoleId$$serializer.INSTANCE, self.roleId);
        }
        output.i(serialDesc, 5, new cj.f(ContentNodeSerializer.INSTANCE), self.getContent());
    }

    
    public final ChannelId m101component1qMVnFVQ() {
        return this.channelId;
    }

    
    public final UserId m102component2wUX8bhU() {
        return this.userId;
    }
    ...
    public final GuildId m103component4qOKuAAo() {
        return this.guildId;
    }

    
    public final RoleId m104component5fYaclRY() {
        return this.roleId;
    }
    ...
    public final UserOrRoleMentionContentNode m105copyDZRaReU(ChannelId channelId, UserId userId, int i10, GuildId guildId, RoleId roleId, List<? extends ContentNode> content) {
        q.h(content, "content");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.channelId, userOrRoleMentionContentNode.channelId) && q.c(this.userId, userOrRoleMentionContentNode.userId) && this.roleColor == userOrRoleMentionContentNode.roleColor && q.c(this.guildId, userOrRoleMentionContentNode.guildId) && q.c(this.roleId, userOrRoleMentionContentNode.roleId) && q.c(getContent(), userOrRoleMentionContentNode.getContent());
    }

    
    public final ChannelId m106getChannelIdqMVnFVQ() {
        return this.channelId;
    }
    ...
    public final GuildId m107getGuildIdqOKuAAo() {
        return this.guildId;
    }
    ...
    public final RoleId m108getRoleIdfYaclRY() {
        return this.roleId;
    }

    
    public final UserId m109getUserIdwUX8bhU() {
        return this.userId;
    }
    ...
    public int hashCode() {
        ...
        int i10 = 0;
        int i11 = (channelId == null ? 0 : ChannelId.m615hashCodeimpl(channelId.m619unboximpl())) * 31;
        UserId userId = this.userId;
        int i12 = (((i11 + (userId == null ? 0 : UserId.m679hashCodeimpl(userId.m683unboximpl()))) * 31) + this.roleColor) * 31;
        GuildId guildId = this.guildId;
        int i13 = (i12 + (guildId == null ? 0 : GuildId.m628hashCodeimpl(guildId.m632unboximpl()))) * 31;
        RoleId roleId = this.roleId;
        if (roleId != null) {
            i10 = RoleId.m653hashCodeimpl(roleId.m657unboximpl());
        }
    ...
    public  UserOrRoleMentionContentNode(ChannelId channelId, UserId userId, int i10, GuildId guildId, RoleId roleId, List list, int i11, DefaultConstructorMarker defaultConstructorMarker) {
