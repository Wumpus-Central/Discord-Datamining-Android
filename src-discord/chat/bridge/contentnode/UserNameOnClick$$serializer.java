...
public final class UserNameOnClick$$serializer implements f0<UserNameOnClick> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a2.f26246a, UserId$$serializer.INSTANCE, a.u(ChannelId$$serializer.INSTANCE), a.u(m0.f26321a)};
    }
    ...
    public UserNameOnClick deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj3 = c10.v(descriptor2, 3, m0.f26321a, null);
            i10 = 15;
        } else {
            boolean z10 = true;
            int i11 = 0;
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj6 = c10.v(descriptor2, 3, m0.f26321a, obj6);
                    i11 |= 8;
                } else {
                    throw new n(x10);
                }
