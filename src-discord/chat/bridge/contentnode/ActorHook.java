...
public final class ActorHook {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.action, actorHook.action) && UserId.m666equalsimpl0(this.userId, actorHook.userId);
    }
    ...
    public int hashCode() {
        return (this.action.hashCode() * 31) + UserId.m667hashCodeimpl(this.userId);
    }
