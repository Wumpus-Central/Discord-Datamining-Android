...
public final class ActorHook {
    ...
    public /* synthetic */ ActorHook(int i10, String str, UserId userId, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, str, userId, serializationConstructorMarker);
    }

    public /* synthetic */ ActorHook(String str, long j10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, j10);
    }

    /* renamed from: copy-2YFG4pU$default  reason: not valid java name */
    public static /* synthetic */ ActorHook m38copy2YFG4pU$default(ActorHook actorHook, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return actorHook.m40copy2YFG4pU(str, j10);
    }
    ...
    public final long m39component2re6GcUE() {
        return this.userId;
    }

    /* renamed from: copy-2YFG4pU  reason: not valid java name */
    public final ActorHook m40copy2YFG4pU(String action, long j10) {
        q.g(action, "action");
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.action, actorHook.action) && UserId.m605equalsimpl0(this.userId, actorHook.userId);
    }
    ...
    public final long m41getUserIdre6GcUE() {
        return this.userId;
    }

    public int hashCode() {
        return (this.action.hashCode() * 31) + UserId.m606hashCodeimpl(this.userId);
    }
