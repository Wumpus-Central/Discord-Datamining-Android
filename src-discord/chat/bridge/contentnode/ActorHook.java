...
public final class ActorHook {
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.action, actorHook.action) && UserId.m622equalsimpl0(this.userId, actorHook.userId);
    }
    ...
    public int hashCode() {
        return (this.action.hashCode() * 31) + UserId.m623hashCodeimpl(this.userId);
    }
