...
public final class ActorHook {
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.action, actorHook.action) && UserId.m630equalsimpl0(this.userId, actorHook.userId);
    }
    ...
    public int hashCode() {
        return (this.action.hashCode() * 31) + UserId.m631hashCodeimpl(this.userId);
    }
