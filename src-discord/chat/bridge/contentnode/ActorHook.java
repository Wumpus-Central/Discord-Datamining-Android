...
public final class ActorHook {
    ...
    public static  ActorHook m46copy2YFG4pU$default(ActorHook actorHook, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return actorHook.m48copy2YFG4pU(str, j10);
    }
    ...
    public final long m47component2re6GcUE() {
        return this.userId;
    }

    
    public final ActorHook m48copy2YFG4pU(String action, long j10) {
        q.h(action, "action");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.action, actorHook.action) && UserId.m685equalsimpl0(this.userId, actorHook.userId);
    }
    ...
    public final long m49getUserIdre6GcUE() {
        return this.userId;
    }

    public int hashCode() {
        return (this.action.hashCode() * 31) + UserId.m686hashCodeimpl(this.userId);
    }
