...
public final class UnicodeEmojiContentNode extends EmojiContentNode {
    ...
    public  UnicodeEmojiContentNode(int i10, String str, String str2, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public static  UnicodeEmojiContentNode copy$default(UnicodeEmojiContentNode unicodeEmojiContentNode, String str, String str2, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(UnicodeEmojiContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 1, self.surrogate);
        if (output.z(serialDesc, 2) || self.getJumboable()) {
            z10 = true;
        }
        if (z10) {
            output.x(serialDesc, 2, self.getJumboable());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.content, unicodeEmojiContentNode.content) && q.c(this.surrogate, unicodeEmojiContentNode.surrogate) && getJumboable() == unicodeEmojiContentNode.getJumboable();
    }
    ...
    public  UnicodeEmojiContentNode(String str, String str2, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
