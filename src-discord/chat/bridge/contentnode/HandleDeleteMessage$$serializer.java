...
public final class HandleDeleteMessage$$serializer implements f0<HandleDeleteMessage> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MessageId$$serializer.INSTANCE, ChannelId$$serializer.INSTANCE, a.u(a2.f32925a), HandleDeleteMessageAuthor$$serializer.INSTANCE};
    }
    ...
    public HandleDeleteMessage deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj2 = b10.n(descriptor2, 2, a2.f32925a, null);
