...
public final class HandleDeleteMessage$$serializer implements f0<HandleDeleteMessage> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MessageId$$serializer.INSTANCE, ChannelId$$serializer.INSTANCE, a.u(a2.f26231a), HandleDeleteMessageAuthor$$serializer.INSTANCE};
    }
        ...
        if (c10.y()) {
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj6 = c10.v(descriptor2, 2, a2.f26231a, obj6);
                    i11 |= 4;
                } else if (x10 == 3) {
