...
public final class SpoilerContentNode extends ContentNode implements SpoilerableData {
    ...
    public /* synthetic */ SpoilerContentNode(int i10, List list, String str, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static final void write$Self(SpoilerContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.A(serialDesc, 1) || !q.b(self.getSpoilerOrNull(), "")) {
            z10 = true;
        }
        if (z10) {
            output.z(serialDesc, 1, self.getSpoilerOrNull());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SpoilerContentNode) && q.b(this.content, ((SpoilerContentNode) obj).content);
    }
