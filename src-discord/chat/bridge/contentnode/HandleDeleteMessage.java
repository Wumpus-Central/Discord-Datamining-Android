...
public final class HandleDeleteMessage {
    ...
    public static /* synthetic */ HandleDeleteMessage m56copy8a0ehIg$default(HandleDeleteMessage handleDeleteMessage, String str, long j10, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = handleDeleteMessage.f6883id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static /* synthetic */ void m57getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(HandleDeleteMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.n(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m590boximpl(self.f6883id));
        ...
        if (z10) {
            output.z(serialDesc, 2, a2.f26230a, self.loggingName);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m594equalsimpl0(this.f6883id, handleDeleteMessage.f6883id) && ChannelId.m568equalsimpl0(this.channelId, handleDeleteMessage.channelId) && q.b(this.loggingName, handleDeleteMessage.loggingName) && q.b(this.author, handleDeleteMessage.author);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m595hashCodeimpl(this.f6883id) * 31) + ChannelId.m569hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
    }

    public String toString() {
        String str = MessageId.m596toStringimpl(this.f6883id);
