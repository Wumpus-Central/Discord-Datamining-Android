...
public final class HandleDeleteMessage {
    ...
    public /* synthetic */ HandleDeleteMessage(int i10, String str, ChannelId channelId, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, str, channelId, str2, handleDeleteMessageAuthor, serializationConstructorMarker);
    }

    public /* synthetic */ HandleDeleteMessage(String str, long j10, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, j10, str2, handleDeleteMessageAuthor);
    }

    /* renamed from: copy-8a0ehIg$default  reason: not valid java name */
    public static /* synthetic */ HandleDeleteMessage m57copy8a0ehIg$default(HandleDeleteMessage handleDeleteMessage, String str, long j10, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = handleDeleteMessage.f7698id;
        }
        if ((i10 & 2) != 0) {
        ...
        return handleDeleteMessage.m61copy8a0ehIg(str, j10, str2, handleDeleteMessageAuthor);
    }

    /* renamed from: getChannelId-o4g7jtM$annotations  reason: not valid java name */
    public static /* synthetic */ void m58getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(HandleDeleteMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.z(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m572boximpl(self.f7698id));
        output.z(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m546boximpl(self.channelId));
        if (output.A(serialDesc, 2) || self.loggingName != null) {
            z10 = true;
        }
        if (z10) {
            output.h(serialDesc, 2, a2.f32313a, self.loggingName);
        }
        output.z(serialDesc, 3, HandleDeleteMessageAuthor$$serializer.INSTANCE, self.author);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m59component13Eiw7ao() {
        return this.f7698id;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m60component2o4g7jtM() {
    ...
    public final HandleDeleteMessage m61copy8a0ehIg(String id2, long j10, String str, HandleDeleteMessageAuthor author) {
        q.g(id2, "id");
        q.g(author, "author");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(this.f7698id, handleDeleteMessage.f7698id) && ChannelId.m550equalsimpl0(this.channelId, handleDeleteMessage.channelId) && q.b(this.loggingName, handleDeleteMessage.loggingName) && q.b(this.author, handleDeleteMessage.author);
    }
    ...
    public final long m62getChannelIdo4g7jtM() {
        return this.channelId;
    }

    /* renamed from: getId-3Eiw7ao  reason: not valid java name */
    public final String m63getId3Eiw7ao() {
        return this.f7698id;
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m577hashCodeimpl(this.f7698id) * 31) + ChannelId.m551hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
    }

    public String toString() {
        String str = MessageId.m578toStringimpl(this.f7698id);
    ...
    public /* synthetic */ HandleDeleteMessage(String str, long j10, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, int i10, DefaultConstructorMarker defaultConstructorMarker) {
