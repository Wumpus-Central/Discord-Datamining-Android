...
public final class HandleDeleteMessage {
    ...
    public static  HandleDeleteMessage m64copy8a0ehIg$default(HandleDeleteMessage handleDeleteMessage, String str, long j10, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = handleDeleteMessage.f6926id;
        }
        if ((i10 & 2) != 0) {
        ...
        return handleDeleteMessage.m68copy8a0ehIg(str, j10, str2, handleDeleteMessageAuthor);
    }

    
    public static  void m65getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(HandleDeleteMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.i(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m643boximpl(self.f6926id));
        ...
        if (z10) {
            output.E(serialDesc, 2, a2.f6238a, self.loggingName);
        }
        output.i(serialDesc, 3, HandleDeleteMessageAuthor$$serializer.INSTANCE, self.author);
    }

    
    public final String m66component13Eiw7ao() {
        return this.f6926id;
    }

    
    public final long m67component2o4g7jtM() {
    ...
    public final HandleDeleteMessage m68copy8a0ehIg(String id2, long j10, String str, HandleDeleteMessageAuthor author) {
        q.h(id2, "id");
        q.h(author, "author");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m647equalsimpl0(this.f6926id, handleDeleteMessage.f6926id) && ChannelId.m621equalsimpl0(this.channelId, handleDeleteMessage.channelId) && q.c(this.loggingName, handleDeleteMessage.loggingName) && q.c(this.author, handleDeleteMessage.author);
    }
    ...
    public final long m69getChannelIdo4g7jtM() {
        return this.channelId;
    }

    
    public final String m70getId3Eiw7ao() {
        return this.f6926id;
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m648hashCodeimpl(this.f6926id) * 31) + ChannelId.m622hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
    }

    public String toString() {
        String str = MessageId.m649toStringimpl(this.f6926id);
