...
public final class HandleDeleteMessage {
    ...
    public static  HandleDeleteMessage m57copy8a0ehIg$default(HandleDeleteMessage handleDeleteMessage, String str, long j10, String str2, HandleDeleteMessageAuthor handleDeleteMessageAuthor, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = handleDeleteMessage.f7249id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(HandleDeleteMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.o(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m607boximpl(self.f7249id));
        ...
        if (z10) {
            output.B(serialDesc, 2, a2.f29755a, self.loggingName);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m611equalsimpl0(this.f7249id, handleDeleteMessage.f7249id) && ChannelId.m585equalsimpl0(this.channelId, handleDeleteMessage.channelId) && q.c(this.loggingName, handleDeleteMessage.loggingName) && q.c(this.author, handleDeleteMessage.author);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m612hashCodeimpl(this.f7249id) * 31) + ChannelId.m586hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
    }

    public String toString() {
        String str = MessageId.m613toStringimpl(this.f7249id);
