...
public final class HandleDeleteMessage {
    ...
    public static final void write$Self(HandleDeleteMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.q(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m572boximpl(self.f7621id));
        ...
        if (z10) {
            output.u(serialDesc, 2, a2.f32925a, self.loggingName);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(this.f7621id, handleDeleteMessage.f7621id) && ChannelId.m550equalsimpl0(this.channelId, handleDeleteMessage.channelId) && q.b(this.loggingName, handleDeleteMessage.loggingName) && q.b(this.author, handleDeleteMessage.author);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m577hashCodeimpl(this.f7621id) * 31) + ChannelId.m551hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
    }

    public String toString() {
        String str = MessageId.m578toStringimpl(this.f7621id);
