...
public final class HandleDeleteMessage {
    ...
    public static final void write$Self(HandleDeleteMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.C(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m588boximpl(self.f7291id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m592equalsimpl0(this.f7291id, handleDeleteMessage.f7291id) && ChannelId.m566equalsimpl0(this.channelId, handleDeleteMessage.channelId) && q.b(this.loggingName, handleDeleteMessage.loggingName) && q.b(this.author, handleDeleteMessage.author);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m593hashCodeimpl(this.f7291id) * 31) + ChannelId.m567hashCodeimpl(this.channelId)) * 31;
        String str = this.loggingName;
        return ((i10 + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
    }

    public String toString() {
        String str = MessageId.m594toStringimpl(this.f7291id);
