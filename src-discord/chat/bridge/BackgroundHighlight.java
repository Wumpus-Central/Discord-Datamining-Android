...
public final class BackgroundHighlight {
    ...
    public  BackgroundHighlight(int i10, Integer num, Integer num2, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i10 & 0) != 0) {
    ...
    public static  BackgroundHighlight copy$default(BackgroundHighlight backgroundHighlight, Integer num, Integer num2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(BackgroundHighlight self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.B(serialDesc, 0, m0.f29833a, self.backgroundColor);
        }
        if (output.z(serialDesc, 1) || self.gutterColor != null) {
            z11 = true;
        }
        if (z11) {
            output.B(serialDesc, 1, m0.f29833a, self.gutterColor);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.backgroundColor, backgroundHighlight.backgroundColor) && q.c(this.gutterColor, backgroundHighlight.gutterColor);
    }
    ...
    public  BackgroundHighlight(Integer num, Integer num2, int i10, DefaultConstructorMarker defaultConstructorMarker) {
