...
public final class UploadProgress {
    ...
    public static final void write$Self(UploadProgress self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.r(serialDesc, 1, self.headerColor);
        output.r(serialDesc, 2, self.backgroundColor);
        output.m(serialDesc, 3, self.progress);
        output.t(serialDesc, 4, self.fileId);
        output.t(serialDesc, 5, self.fileType);
        output.r(serialDesc, 6, self.progressTrackColor);
        output.r(serialDesc, 7, self.progressStartColor);
        output.r(serialDesc, 8, self.progressEndColor);
        output.r(serialDesc, 9, self.iconTintColor);
        output.r(serialDesc, 10, self.closeTintColor);
    }
