...
public final class UploadProgress {
    ...
    public /* synthetic */ UploadProgress(int i10, String str, int i11, int i12, float f10, String str2, String str3, int i13, int i14, int i15, int i16, int i17, SerializationConstructorMarker serializationConstructorMarker) {
        if (2047 != (i10 & 2047)) {
    ...
    public static final void write$Self(UploadProgress self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 1, self.headerColor);
        output.w(serialDesc, 2, self.backgroundColor);
        output.r(serialDesc, 3, self.progress);
        output.y(serialDesc, 4, self.fileId);
        output.y(serialDesc, 5, self.fileType);
        output.w(serialDesc, 6, self.progressTrackColor);
        output.w(serialDesc, 7, self.progressStartColor);
        output.w(serialDesc, 8, self.progressEndColor);
        output.w(serialDesc, 9, self.iconTintColor);
        output.w(serialDesc, 10, self.closeTintColor);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.headerText, uploadProgress.headerText) && this.headerColor == uploadProgress.headerColor && this.backgroundColor == uploadProgress.backgroundColor && Float.compare(this.progress, uploadProgress.progress) == 0 && q.b(this.fileId, uploadProgress.fileId) && q.b(this.fileType, uploadProgress.fileType) && this.progressTrackColor == uploadProgress.progressTrackColor && this.progressStartColor == uploadProgress.progressStartColor && this.progressEndColor == uploadProgress.progressEndColor && this.iconTintColor == uploadProgress.iconTintColor && this.closeTintColor == uploadProgress.closeTintColor;
    }
