...
public final class UploadProgress {
    ...
    public static final void write$Self(UploadProgress self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 0, self.headerText);
        output.x(serialDesc, 1, self.headerColor);
        output.x(serialDesc, 2, self.backgroundColor);
        output.s(serialDesc, 3, self.progress);
        output.z(serialDesc, 4, self.fileId);
        output.z(serialDesc, 5, self.fileType);
        output.x(serialDesc, 6, self.progressTrackColor);
        output.x(serialDesc, 7, self.progressStartColor);
        output.x(serialDesc, 8, self.progressEndColor);
        output.x(serialDesc, 9, self.iconTintColor);
        output.x(serialDesc, 10, self.closeTintColor);
    }
