...
public final class Summary {
    ...
    public static final void write$Self(Summary self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.s(serialDesc, 0, self.f7112id);
        ...
        output.h(serialDesc, 4, messageId$$serializer, MessageId.m593boximpl(self.startId));
        output.h(serialDesc, 5, messageId$$serializer, MessageId.m593boximpl(self.endId));
        output.q(serialDesc, 6, self.count);
        output.h(serialDesc, 7, ChannelId$$serializer.INSTANCE, ChannelId.m567boximpl(self.channelId));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7112id, summary.f7112id) && q.c(this.topic, summary.topic) && q.c(this.summShort, summary.summShort) && q.c(this.people, summary.people) && MessageId.m597equalsimpl0(this.startId, summary.startId) && MessageId.m597equalsimpl0(this.endId, summary.endId) && this.count == summary.count && ChannelId.m571equalsimpl0(this.channelId, summary.channelId);
    }
    ...
    public int hashCode() {
        return (((((((((((((this.f7112id.hashCode() * 31) + this.topic.hashCode()) * 31) + this.summShort.hashCode()) * 31) + this.people.hashCode()) * 31) + MessageId.m598hashCodeimpl(this.startId)) * 31) + MessageId.m598hashCodeimpl(this.endId)) * 31) + this.count) * 31) + ChannelId.m572hashCodeimpl(this.channelId);
    }
    ...
    public String toString() {
        ...
        String str4 = MessageId.m599toStringimpl(this.startId);
        String str5 = MessageId.m599toStringimpl(this.endId);
        int i10 = this.count;
        String str6 = ChannelId.m574toStringimpl(this.channelId);
