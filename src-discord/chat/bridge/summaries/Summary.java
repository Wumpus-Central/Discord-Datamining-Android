...
public final class Summary {
    ...
    public static final void write$Self(Summary self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 0, self.f7298id);
        output.t(serialDesc, 1, self.topic);
        output.t(serialDesc, 2, self.summShort);
        output.C(serialDesc, 3, new ti.f(UserId$$serializer.INSTANCE), self.people);
        MessageId$$serializer messageId$$serializer = MessageId$$serializer.INSTANCE;
        output.C(serialDesc, 4, messageId$$serializer, MessageId.m588boximpl(self.startId));
        output.C(serialDesc, 5, messageId$$serializer, MessageId.m588boximpl(self.endId));
        output.r(serialDesc, 6, self.count);
        output.C(serialDesc, 7, ChannelId$$serializer.INSTANCE, ChannelId.m562boximpl(self.channelId));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7298id, summary.f7298id) && q.b(this.topic, summary.topic) && q.b(this.summShort, summary.summShort) && q.b(this.people, summary.people) && MessageId.m592equalsimpl0(this.startId, summary.startId) && MessageId.m592equalsimpl0(this.endId, summary.endId) && this.count == summary.count && ChannelId.m566equalsimpl0(this.channelId, summary.channelId);
    }
    ...
    public int hashCode() {
        return (((((((((((((this.f7298id.hashCode() * 31) + this.topic.hashCode()) * 31) + this.summShort.hashCode()) * 31) + this.people.hashCode()) * 31) + MessageId.m593hashCodeimpl(this.startId)) * 31) + MessageId.m593hashCodeimpl(this.endId)) * 31) + this.count) * 31) + ChannelId.m567hashCodeimpl(this.channelId);
    }
    ...
    public String toString() {
        ...
        String str4 = MessageId.m594toStringimpl(this.startId);
        String str5 = MessageId.m594toStringimpl(this.endId);
        int i10 = this.count;
        String str6 = ChannelId.m569toStringimpl(this.channelId);
