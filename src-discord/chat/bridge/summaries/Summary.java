...
public final class Summary {
    ...
    public static final void write$Self(Summary self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 4, messageId$$serializer, MessageId.m590boximpl(self.startId));
        output.C(serialDesc, 5, messageId$$serializer, MessageId.m590boximpl(self.endId));
        output.r(serialDesc, 6, self.count);
        output.C(serialDesc, 7, ChannelId$$serializer.INSTANCE, ChannelId.m564boximpl(self.channelId));
    }
    ...
    public int hashCode() {
        return (((((((((((((this.f7298id.hashCode() * 31) + this.topic.hashCode()) * 31) + this.summShort.hashCode()) * 31) + this.people.hashCode()) * 31) + MessageId.m595hashCodeimpl(this.startId)) * 31) + MessageId.m595hashCodeimpl(this.endId)) * 31) + this.count) * 31) + ChannelId.m569hashCodeimpl(this.channelId);
    }
