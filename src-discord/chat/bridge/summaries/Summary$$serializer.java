...
public final class Summary$$serializer implements f0<Summary> {
    ...
    public Summary deserialize(Decoder decoder) {
        ...
        return new Summary(i12, str3, str2, str, (List) obj2, messageId != null ? messageId.m597unboximpl() : null, messageId2 != null ? messageId2.m597unboximpl() : null, i10, (ChannelId) obj4, null, null);
    }
