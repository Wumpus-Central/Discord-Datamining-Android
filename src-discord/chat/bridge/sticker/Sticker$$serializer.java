...
public final class Sticker$$serializer implements f0<Sticker> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f26246a;
        m0 m0Var = m0.f26321a;
        return new KSerializer[]{w0.f26362a, StickerFormatType.StickerFormatTypeSerializer.INSTANCE, a2Var, a2Var, a2Var, a.u(m0Var), a.u(m0Var), m0Var};
    }
            ...
            while (z10) {
                ...
                switch (x10) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        obj = c10.v(descriptor2, 5, m0.f26321a, obj);
                        i15 |= 32;
                        break;
                    case 6:
                        obj2 = c10.v(descriptor2, i13, m0.f26321a, obj2);
                        i15 |= 64;
                        break;
                    case 7:
