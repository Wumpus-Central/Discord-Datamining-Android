...
public final class Sticker {
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.E(serialDesc, 0, self.f7627id);
        output.q(serialDesc, 1, StickerFormatType.StickerFormatTypeSerializer.INSTANCE, self.formatType);
        ...
        if (z10) {
            output.u(serialDesc, 5, m0.f32999a, self.width);
        }
        if (output.A(serialDesc, 6) || self.height != null) {
            z11 = true;
        }
        if (z11) {
            output.u(serialDesc, 6, m0.f32999a, self.height);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7627id == sticker.f7627id && this.formatType == sticker.formatType && q.b(this.name, sticker.name) && q.b(this.asset, sticker.asset) && q.b(this.url, sticker.url) && q.b(this.width, sticker.width) && q.b(this.height, sticker.height) && this.renderMode == sticker.renderMode;
    }
