...
public final class Sticker {
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.E(serialDesc, 0, self.f7704id);
        output.z(serialDesc, 1, StickerFormatType.StickerFormatTypeSerializer.INSTANCE, self.formatType);
        ...
        if (z10) {
            output.h(serialDesc, 5, m0.f32388a, self.width);
        }
        if (output.A(serialDesc, 6) || self.height != null) {
            z11 = true;
        }
        if (z11) {
            output.h(serialDesc, 6, m0.f32388a, self.height);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7704id == sticker.f7704id && this.formatType == sticker.formatType && q.b(this.name, sticker.name) && q.b(this.asset, sticker.asset) && q.b(this.url, sticker.url) && q.b(this.width, sticker.width) && q.b(this.height, sticker.height) && this.renderMode == sticker.renderMode;
    }
    ...
    public int hashCode() {
        int a10 = ((((((((a.a(this.f7704id) * 31) + this.formatType.hashCode()) * 31) + this.name.hashCode()) * 31) + this.asset.hashCode()) * 31) + this.url.hashCode()) * 31;
