...
public enum StickerFormatType {
    ...
    private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = n.a(p.PUBLICATION, StickerFormatType$Companion$$cachedSerializer$delegate$1.INSTANCE);
    ...
    public static final class StickerFormatTypeSerializer implements KSerializer<StickerFormatType> {
        ...
        public SerialDescriptor getDescriptor() {
            return g.a("StickerFormatType", e.f.f32126a);
        }
