...
public final class MessageFrameMediaViewer extends MessageFrame {
    ...
    public  MessageFrameMediaViewer(int i10, MessageFrameType messageFrameType, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static  MessageFrameMediaViewer copy$default(MessageFrameMediaViewer messageFrameMediaViewer, MessageFrameType messageFrameType, int i10, Object obj) {
        if ((i10 & 1) != 0) {
