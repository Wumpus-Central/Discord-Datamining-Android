...
public final class MessageFrameJump extends MessageFrame {
    ...
    public static final void write$Self(MessageFrameJump self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.C(serialDesc, 0, MessageFrameType.Serializer.INSTANCE, self.getType());
        ...
        if (z10) {
            output.e(serialDesc, 1, a2.f26972a, self.guildName);
        }
        if (output.w(serialDesc, 2) || self.channelName != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 2, a2.f26972a, self.channelName);
        }
    }
