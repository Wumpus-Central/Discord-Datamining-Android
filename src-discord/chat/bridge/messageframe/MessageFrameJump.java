...
public final class MessageFrameJump extends MessageFrame {
    ...
    public /* synthetic */ MessageFrameJump(int i10, MessageFrameType messageFrameType, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static /* synthetic */ MessageFrameJump copy$default(MessageFrameJump messageFrameJump, MessageFrameType messageFrameType, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(MessageFrameJump self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.z(serialDesc, 0, MessageFrameType.Serializer.INSTANCE, self.getType());
        if (!output.A(serialDesc, 1) && self.guildName == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.h(serialDesc, 1, a2.f32309a, self.guildName);
        }
        if (output.A(serialDesc, 2) || self.channelName != null) {
            z11 = true;
        }
        if (z11) {
            output.h(serialDesc, 2, a2.f32309a, self.channelName);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getType() == messageFrameJump.getType() && q.b(this.guildName, messageFrameJump.guildName) && q.b(this.channelName, messageFrameJump.channelName);
    }
    ...
    public /* synthetic */ MessageFrameJump(MessageFrameType messageFrameType, String str, String str2, int i10, DefaultConstructorMarker defaultConstructorMarker) {
