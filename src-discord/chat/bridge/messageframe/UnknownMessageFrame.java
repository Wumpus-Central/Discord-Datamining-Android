...
public final class UnknownMessageFrame extends MessageFrame {
    ...
    public  UnknownMessageFrame(int i10, MessageFrameType messageFrameType, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static  UnknownMessageFrame copy$default(UnknownMessageFrame unknownMessageFrame, MessageFrameType messageFrameType, int i10, Object obj) {
        if ((i10 & 1) != 0) {
