...
public final class ThreadEmbed$$serializer implements f0<ThreadEmbed> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f32933a;
        return new KSerializer[]{a2Var, a2Var, a.u(a2Var), a.u(h.f32975a), a.u(a2Var), a.u(ThreadEmbedMessage$$serializer.INSTANCE)};
    }
    ...
    public ThreadEmbed deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj3 = b10.n(descriptor2, 3, h.f32975a, null);
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        obj6 = b10.n(descriptor2, 3, h.f32975a, obj6);
                        i11 |= 8;
                        break;
                    case 4:
                        obj7 = b10.n(descriptor2, 4, a2.f32933a, obj7);
                        i11 |= 16;
                        break;
                    case 5:
