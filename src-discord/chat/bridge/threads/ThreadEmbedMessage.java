...
public final class ThreadEmbedMessage {
    ...
    public  ThreadEmbedMessage(int i10, Message message, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  ThreadEmbedMessage copy$default(ThreadEmbedMessage threadEmbedMessage, Message message, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ThreadEmbedMessage) && q.c(this.message, ((ThreadEmbedMessage) obj).message);
    }
