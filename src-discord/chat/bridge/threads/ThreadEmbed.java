...
public final class ThreadEmbed {
    ...
    public static final void write$Self(ThreadEmbed self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.u(serialDesc, 2, a2.f32933a, self.messagePreviewString);
        }
        ...
        if (z11) {
            output.u(serialDesc, 3, h.f32975a, self.archived);
        }
        ...
        if (z12) {
            output.u(serialDesc, 4, a2.f32933a, self.archivedIconUrl);
        }
