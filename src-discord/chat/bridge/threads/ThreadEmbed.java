...
public final class ThreadEmbed {
    ...
    public static final void write$Self(ThreadEmbed self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.z(serialDesc, 2, a2.f26237a, self.messagePreviewString);
        }
        ...
        if (z11) {
            output.z(serialDesc, 3, h.f26279a, self.archived);
        }
        ...
        if (z12) {
            output.z(serialDesc, 4, a2.f26237a, self.archivedIconUrl);
        }
