...
public final class ThreadEmbed {
    ...
    public static final void write$Self(ThreadEmbed self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.h(serialDesc, 2, a2.f32313a, self.messagePreviewString);
        }
        ...
        if (z11) {
            output.h(serialDesc, 3, h.f32355a, self.archived);
        }
        ...
        if (z12) {
            output.h(serialDesc, 4, a2.f32313a, self.archivedIconUrl);
        }
        if (output.A(serialDesc, 5) || self.referencedMessage != null) {
            z13 = true;
        }
        if (z13) {
            output.h(serialDesc, 5, ThreadEmbedMessage$$serializer.INSTANCE, self.referencedMessage);
        }
    }
