...
public final class ConnectionsRoleTag {
    ...
    public  ConnectionsRoleTag(int i10, String str, String str2, int i11, int i12, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i10 & 15)) {
    ...
    public static  ConnectionsRoleTag copy$default(ConnectionsRoleTag connectionsRoleTag, String str, String str2, int i10, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = connectionsRoleTag.f7239id;
        }
        if ((i12 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7239id, connectionsRoleTag.f7239id) && q.c(this.name, connectionsRoleTag.name) && this.backgroundColor == connectionsRoleTag.backgroundColor && this.iconColor == connectionsRoleTag.iconColor;
    }
    ...
    public int hashCode() {
        return (((((this.f7239id.hashCode() * 31) + this.name.hashCode()) * 31) + this.backgroundColor) * 31) + this.iconColor;
    }

    public String toString() {
        String str = this.f7239id;
