...
public final class ConnectionsRoleTag {
    ...
    public static /* synthetic */ ConnectionsRoleTag copy$default(ConnectionsRoleTag connectionsRoleTag, String str, String str2, int i10, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = connectionsRoleTag.f7198id;
        }
        if ((i12 & 2) != 0) {
    ...
    public static final void write$Self(ConnectionsRoleTag self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 0, self.f7198id);
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7198id, connectionsRoleTag.f7198id) && q.b(this.name, connectionsRoleTag.name) && this.backgroundColor == connectionsRoleTag.backgroundColor && this.iconColor == connectionsRoleTag.iconColor;
    }
    ...
    public int hashCode() {
        return (((((this.f7198id.hashCode() * 31) + this.name.hashCode()) * 31) + this.backgroundColor) * 31) + this.iconColor;
    }

    public String toString() {
        String str = this.f7198id;
