...
public final class ConnectionsRoleTag {
    ...
    public static  ConnectionsRoleTag copy$default(ConnectionsRoleTag connectionsRoleTag, String str, String str2, int i10, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = connectionsRoleTag.f7246id;
        }
        if ((i12 & 2) != 0) {
    ...
    public static final void write$Self(ConnectionsRoleTag self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.x(serialDesc, 0, self.f7246id);
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7246id, connectionsRoleTag.f7246id) && q.c(this.name, connectionsRoleTag.name) && this.backgroundColor == connectionsRoleTag.backgroundColor && this.iconColor == connectionsRoleTag.iconColor;
    }
    ...
    public int hashCode() {
        return (((((this.f7246id.hashCode() * 31) + this.name.hashCode()) * 31) + this.backgroundColor) * 31) + this.iconColor;
    }
