...
public final class ForumPostActions {
    ...
    public static final void write$Self(ForumPostActions self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        output.r(serialDesc, 0, self.numDisplayedReactions);
        output.s(serialDesc, 1, self.isFollowing);
        ...
        if (z10) {
            output.e(serialDesc, 2, a2.f26972a, self.followIcon);
        }
        output.t(serialDesc, 3, self.followLabel);
        ...
        if (z11) {
            output.e(serialDesc, 4, a2.f26972a, self.shareIcon);
        }
        output.t(serialDesc, 5, self.shareLabel);
