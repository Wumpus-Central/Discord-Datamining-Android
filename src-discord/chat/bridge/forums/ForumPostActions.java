...
public final class ForumPostActions {
    ...
    public  ForumPostActions(int i10, int i11, boolean z10, String str, String str2, String str3, String str4, MessageReaction messageReaction, PostSharePrompt postSharePrompt, SerializationConstructorMarker serializationConstructorMarker) {
        if (43 != (i10 & 43)) {
    ...
    public static final void write$Self(ForumPostActions self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        output.w(serialDesc, 0, self.numDisplayedReactions);
        output.x(serialDesc, 1, self.isFollowing);
        ...
        if (z10) {
            output.e(serialDesc, 2, a2.f30574a, self.followIcon);
        }
        output.y(serialDesc, 3, self.followLabel);
        ...
        if (z11) {
            output.e(serialDesc, 4, a2.f30574a, self.shareIcon);
        }
        output.y(serialDesc, 5, self.shareLabel);
        ...
        if (z12) {
            output.e(serialDesc, 6, MessageReaction$$serializer.INSTANCE, self.defaultReaction);
        }
        if (output.z(serialDesc, 7) || self.sharePrompt != null) {
            z13 = true;
        }
        if (z13) {
            output.e(serialDesc, 7, PostSharePrompt$$serializer.INSTANCE, self.sharePrompt);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.numDisplayedReactions == forumPostActions.numDisplayedReactions && this.isFollowing == forumPostActions.isFollowing && q.c(this.followIcon, forumPostActions.followIcon) && q.c(this.followLabel, forumPostActions.followLabel) && q.c(this.shareIcon, forumPostActions.shareIcon) && q.c(this.shareLabel, forumPostActions.shareLabel) && q.c(this.defaultReaction, forumPostActions.defaultReaction) && q.c(this.sharePrompt, forumPostActions.sharePrompt);
    }
    ...
    public  ForumPostActions(int i10, boolean z10, String str, String str2, String str3, String str4, MessageReaction messageReaction, PostSharePrompt postSharePrompt, int i11, DefaultConstructorMarker defaultConstructorMarker) {
