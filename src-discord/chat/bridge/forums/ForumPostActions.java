...
public final class ForumPostActions {
    ...
    public static final void write$Self(ForumPostActions self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.h(serialDesc, 2, a2.f32313a, self.followIcon);
        }
        ...
        if (z11) {
            output.h(serialDesc, 4, a2.f32313a, self.shareIcon);
        }
        ...
        if (z12) {
            output.h(serialDesc, 6, MessageReaction$$serializer.INSTANCE, self.defaultReaction);
        }
        if (output.A(serialDesc, 7) || self.sharePrompt != null) {
            z13 = true;
        }
        if (z13) {
            output.h(serialDesc, 7, PostSharePrompt$$serializer.INSTANCE, self.sharePrompt);
        }
    }
