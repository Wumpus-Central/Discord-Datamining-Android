...
public final class ForumPostActions$$serializer implements f0<ForumPostActions> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f29758a;
        return new KSerializer[]{m0.f29833a, h.f29800a, a.u(a2Var), a2Var, a.u(a2Var), a2Var, a.u(MessageReaction$$serializer.INSTANCE), a.u(PostSharePrompt$$serializer.INSTANCE)};
    }
            ...
            while (z11) {
                ...
                switch (o10) {
                    ...
                    case 3:
                        ...
                        i14 |= 8;
                    case 4:
                        obj7 = b10.n(descriptor2, 4, a2.f29758a, obj7);
                        i14 |= 16;
                    case 5:
                        str = b10.m(descriptor2, 5);
                        i14 |= 32;
