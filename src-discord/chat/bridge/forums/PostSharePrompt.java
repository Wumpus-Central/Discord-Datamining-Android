...
public final class PostSharePrompt {
    ...
    public static final void write$Self(PostSharePrompt self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 1, StructurableTextSerializer.INSTANCE, self.subtitle);
        output.t(serialDesc, 2, self.cta);
        output.t(serialDesc, 3, self.icon);
        output.t(serialDesc, 4, self.closeIcon);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.title, postSharePrompt.title) && q.b(this.subtitle, postSharePrompt.subtitle) && q.b(this.cta, postSharePrompt.cta) && q.b(this.icon, postSharePrompt.icon) && q.b(this.closeIcon, postSharePrompt.closeIcon);
    }
