...
public final class InteractionStatus {
    ...
    public  InteractionStatus(int i10, InteractionStatusViewState interactionStatusViewState, StructurableText structurableText, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  InteractionStatus copy$default(InteractionStatus interactionStatus, InteractionStatusViewState interactionStatusViewState, StructurableText structurableText, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(InteractionStatus self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, InteractionStatusViewState.Serializer.INSTANCE, self.state);
        output.i(serialDesc, 1, StructurableTextSerializer.INSTANCE, self.text);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.state == interactionStatus.state && q.c(this.text, interactionStatus.text);
    }
