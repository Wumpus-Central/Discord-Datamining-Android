...
public final class Truncation {
    ...
    public  Truncation(int i10, int i11, String str, Integer num, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  Truncation copy$default(Truncation truncation, int i10, String str, Integer num, Boolean bool, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(Truncation self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.w(serialDesc, 0, self.numberOfLines);
        output.y(serialDesc, 1, self.seeMoreLabel);
        ...
        if (z10) {
            output.e(serialDesc, 2, m0.f30643a, self.seeMoreLabelColor);
        }
        if (output.z(serialDesc, 3) || self.forceShow != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 3, h.f30610a, self.forceShow);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.numberOfLines == truncation.numberOfLines && q.c(this.seeMoreLabel, truncation.seeMoreLabel) && q.c(this.seeMoreLabelColor, truncation.seeMoreLabelColor) && q.c(this.forceShow, truncation.forceShow);
    }
    ...
    public  Truncation(int i10, String str, Integer num, Boolean bool, int i11, DefaultConstructorMarker defaultConstructorMarker) {
