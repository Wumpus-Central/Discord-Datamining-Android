...
public final class Truncation {
    ...
    public static final void write$Self(Truncation self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z11 = false;
        output.r(serialDesc, 0, self.numberOfLines);
        output.t(serialDesc, 1, self.seeMoreLabel);
        ...
        if (z10) {
            output.e(serialDesc, 2, m0.f27047a, self.seeMoreLabelColor);
        }
        if (output.w(serialDesc, 3) || self.forceShow != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 3, h.f27014a, self.forceShow);
        }
    }
