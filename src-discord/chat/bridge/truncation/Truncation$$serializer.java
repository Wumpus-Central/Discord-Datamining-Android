...
public final class Truncation$$serializer implements f0<Truncation> {
    ...
    public KSerializer<?>[] childSerializers() {
        m0 m0Var = m0.f29837a;
        return new KSerializer[]{m0Var, a2.f29762a, a.u(m0Var), a.u(h.f29804a)};
    }
    ...
    public Truncation deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj = b10.n(descriptor2, 2, m0.f29837a, null);
            obj2 = b10.n(descriptor2, 3, h.f29804a, null);
            i11 = 15;
        } else {
            boolean z10 = true;
            int i12 = 0;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj3 = b10.n(descriptor2, 2, m0.f29837a, obj3);
                    i13 |= 4;
                } else if (o10 == 3) {
