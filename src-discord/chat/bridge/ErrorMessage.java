...
public final class ErrorMessage extends MessageBase {
    ...
    public static final void write$Self(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m572boximpl(self.f7692id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(this.f7692id, errorMessage.f7692id) && q.b(this.stackTrace, errorMessage.stackTrace);
    }
    ...
    public int hashCode() {
        return (MessageId.m577hashCodeimpl(this.f7692id) * 31) + this.stackTrace.hashCode();
    }

    public String toString() {
        String str = MessageId.m578toStringimpl(this.f7692id);
