...
public final class ErrorMessage extends MessageBase {
    ...
    public static final void write$Self(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.o(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m617boximpl(self.f7242id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m621equalsimpl0(this.f7242id, errorMessage.f7242id) && q.c(this.stackTrace, errorMessage.stackTrace);
    }
    ...
    public int hashCode() {
        return (MessageId.m622hashCodeimpl(this.f7242id) * 31) + this.stackTrace.hashCode();
    }
