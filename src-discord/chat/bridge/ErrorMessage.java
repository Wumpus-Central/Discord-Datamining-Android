...
public final class ErrorMessage extends MessageBase {
    ...
    public static final void write$Self(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m588boximpl(self.f7285id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m592equalsimpl0(this.f7285id, errorMessage.f7285id) && q.b(this.stackTrace, errorMessage.stackTrace);
    }
    ...
    public int hashCode() {
        return (MessageId.m593hashCodeimpl(this.f7285id) * 31) + this.stackTrace.hashCode();
    }

    public String toString() {
        String str = MessageId.m594toStringimpl(this.f7285id);
