...
public final class ErrorMessage extends MessageBase {
    ...
    public static final void write$Self(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m589boximpl(self.f7615id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m593equalsimpl0(this.f7615id, errorMessage.f7615id) && q.b(this.stackTrace, errorMessage.stackTrace);
    }
    ...
    public int hashCode() {
        return (MessageId.m594hashCodeimpl(this.f7615id) * 31) + this.stackTrace.hashCode();
    }

    public String toString() {
        String str = MessageId.m595toStringimpl(this.f7615id);
