...
public final class ErrorMessage extends MessageBase {
    ...
    public static /* synthetic */ ErrorMessage m3copyntcYbpo$default(ErrorMessage errorMessage, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = errorMessage.f7615id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m572boximpl(self.f7615id));
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(this.f7615id, errorMessage.f7615id) && q.b(this.stackTrace, errorMessage.stackTrace);
    }
    ...
    public int hashCode() {
        return (MessageId.m577hashCodeimpl(this.f7615id) * 31) + this.stackTrace.hashCode();
    }

    public String toString() {
        String str = MessageId.m578toStringimpl(this.f7615id);
