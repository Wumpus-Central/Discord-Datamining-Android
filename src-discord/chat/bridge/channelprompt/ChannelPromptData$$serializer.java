...
public final class ChannelPromptData$$serializer implements f0<ChannelPromptData> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.discord.chat.bridge.channelprompt.ChannelPromptData", channelPromptData$$serializer, 2);
    ...
    public ChannelPromptData deserialize(Decoder decoder) {
        ...
        b10.c(descriptor2);
        return new ChannelPromptData(i10, (String) obj, (String) obj2, (SerializationConstructorMarker) null);
    }
