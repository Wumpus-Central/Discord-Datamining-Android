...
public final class EphemeralIndication {
    ...
    public  EphemeralIndication(int i10, StructurableText structurableText, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
    ...
    public static  EphemeralIndication copy$default(EphemeralIndication ephemeralIndication, StructurableText structurableText, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(EphemeralIndication self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, StructurableTextSerializer.INSTANCE, self.content);
        output.y(serialDesc, 1, self.helpArticleLink);
        output.y(serialDesc, 2, self.helpButtonAccessibilityLabel);
    }
    ...
    public final EphemeralIndication copy(StructurableText content, String helpArticleLink, String helpButtonAccessibilityLabel) {
        q.h(content, "content");
        q.h(helpArticleLink, "helpArticleLink");
        q.h(helpButtonAccessibilityLabel, "helpButtonAccessibilityLabel");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.content, ephemeralIndication.content) && q.c(this.helpArticleLink, ephemeralIndication.helpArticleLink) && q.c(this.helpButtonAccessibilityLabel, ephemeralIndication.helpButtonAccessibilityLabel);
    }
