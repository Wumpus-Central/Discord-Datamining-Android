...
public final class EphemeralIndication {
    ...
    public static final void write$Self(EphemeralIndication self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 0, StructurableTextSerializer.INSTANCE, self.content);
        output.t(serialDesc, 1, self.helpArticleLink);
        output.t(serialDesc, 2, self.helpButtonAccessibilityLabel);
    }
