...
public final class MessageReaction implements ReactionView.Reaction {
    ...
    public static final void write$Self(MessageReaction self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.x(serialDesc, 1, self.f6930me);
        ...
        if (output.z(serialDesc, 6) || self.isMe() != self.f6930me) {
            z13 = true;
        }
        if (z13) {
    ...
    public boolean equals(Object obj) {
        ...
        return getCount() == messageReaction.getCount() && this.f6930me == messageReaction.f6930me && isMeBurst() == messageReaction.isMeBurst() && q.c(getEmoji(), messageReaction.getEmoji()) && getBurstCount() == messageReaction.getBurstCount() && q.c(getThemedBurstColors(), messageReaction.getThemedBurstColors());
    }
