...
public final class MessageReaction implements ReactionView.Reaction {
    ...
    public static final void write$Self(MessageReaction self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        output.r(serialDesc, 0, self.getCount());
        output.s(serialDesc, 1, self.f7293me);
        ...
        if (z10) {
            output.s(serialDesc, 2, self.isMeBurst());
        }
        output.C(serialDesc, 3, MessageReactionEmoji$$serializer.INSTANCE, self.getEmoji());
        ...
        if (z11) {
            output.r(serialDesc, 4, self.getBurstCount());
        }
        ...
        if (output.w(serialDesc, 6) || self.isMe() != self.f7293me) {
            z13 = true;
        }
        if (z13) {
            output.s(serialDesc, 6, self.isMe());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getCount() == messageReaction.getCount() && this.f7293me == messageReaction.f7293me && isMeBurst() == messageReaction.isMeBurst() && q.b(getEmoji(), messageReaction.getEmoji()) && getBurstCount() == messageReaction.getBurstCount() && q.b(getThemedBurstColors(), messageReaction.getThemedBurstColors());
    }
