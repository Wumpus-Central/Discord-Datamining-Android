...
public final class MessageReaction implements ReactionView.Reaction {
    ...
    public static final void write$Self(MessageReaction self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.x(serialDesc, 1, self.f7700me);
        ...
        output.z(serialDesc, 3, MessageReactionEmoji$$serializer.INSTANCE, self.getEmoji());
        ...
        if (z12) {
            output.h(serialDesc, 5, ThemedBurstReactionColorPalette$$serializer.INSTANCE, self.getThemedBurstColors());
        }
        if (output.A(serialDesc, 6) || self.isMe() != self.f7700me) {
            z13 = true;
        }
        if (z13) {
    ...
    public boolean equals(Object obj) {
        ...
        return getCount() == messageReaction.getCount() && this.f7700me == messageReaction.f7700me && isMeBurst() == messageReaction.isMeBurst() && q.b(getEmoji(), messageReaction.getEmoji()) && getBurstCount() == messageReaction.getBurstCount() && q.b(getThemedBurstColors(), messageReaction.getThemedBurstColors());
    }
