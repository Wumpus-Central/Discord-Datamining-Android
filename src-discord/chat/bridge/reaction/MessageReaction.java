...
public final class MessageReaction implements ReactionView.Reaction {
    ...
    public static final void write$Self(MessageReaction self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.x(serialDesc, 1, self.f7243me);
        ...
        if (output.z(serialDesc, 6) || self.isMe() != self.f7243me) {
            z13 = true;
        }
        if (z13) {
    ...
    public boolean equals(Object obj) {
        ...
        return getCount() == messageReaction.getCount() && this.f7243me == messageReaction.f7243me && isMeBurst() == messageReaction.isMeBurst() && q.c(getEmoji(), messageReaction.getEmoji()) && getBurstCount() == messageReaction.getBurstCount() && q.c(getThemedBurstColors(), messageReaction.getThemedBurstColors());
    }
