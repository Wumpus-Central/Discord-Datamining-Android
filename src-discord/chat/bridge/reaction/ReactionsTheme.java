...
public final class ReactionsTheme implements ReactionView.ReactionsTheme {
    ...
    public  ReactionsTheme(int i10, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i10 & 0) != 0) {
    ...
    public static  ReactionsTheme copy$default(ReactionsTheme reactionsTheme, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(ReactionsTheme self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.B(serialDesc, 0, m0.f29833a, self.getReactionBackgroundColor());
        }
        ...
        if (z11) {
            output.B(serialDesc, 1, m0.f29833a, self.getReactionBorderColor());
        }
        ...
        if (z12) {
            output.B(serialDesc, 2, m0.f29833a, self.getReactionTextColor());
        }
        ...
        if (z13) {
            output.B(serialDesc, 3, m0.f29833a, self.getActiveReactionBackgroundColor());
        }
        ...
        if (z14) {
            output.B(serialDesc, 4, m0.f29833a, self.getActiveReactionBorderColor());
        }
        if (output.z(serialDesc, 5) || self.getActiveReactionTextColor() != null) {
            z15 = true;
        }
        if (z15) {
            output.B(serialDesc, 5, m0.f29833a, self.getActiveReactionTextColor());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(getReactionBackgroundColor(), reactionsTheme.getReactionBackgroundColor()) && q.c(getReactionBorderColor(), reactionsTheme.getReactionBorderColor()) && q.c(getReactionTextColor(), reactionsTheme.getReactionTextColor()) && q.c(getActiveReactionBackgroundColor(), reactionsTheme.getActiveReactionBackgroundColor()) && q.c(getActiveReactionBorderColor(), reactionsTheme.getActiveReactionBorderColor()) && q.c(getActiveReactionTextColor(), reactionsTheme.getActiveReactionTextColor());
    }
    ...
    public  ReactionsTheme(Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, int i10, DefaultConstructorMarker defaultConstructorMarker) {
