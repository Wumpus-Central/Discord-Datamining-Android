...
public final class ReactionsTheme implements ReactionView.ReactionsTheme {
    ...
    public static final void write$Self(ReactionsTheme self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.E(serialDesc, 0, m0.f6313a, self.getReactionBackgroundColor());
        }
        ...
        if (z11) {
            output.E(serialDesc, 1, m0.f6313a, self.getReactionBorderColor());
        }
        ...
        if (z12) {
            output.E(serialDesc, 2, m0.f6313a, self.getReactionTextColor());
        }
        ...
        if (z13) {
            output.E(serialDesc, 3, m0.f6313a, self.getActiveReactionBackgroundColor());
        }
        ...
        if (z14) {
            output.E(serialDesc, 4, m0.f6313a, self.getActiveReactionBorderColor());
        }
        if (output.z(serialDesc, 5) || self.getActiveReactionTextColor() != null) {
            z15 = true;
        }
        if (z15) {
            output.E(serialDesc, 5, m0.f6313a, self.getActiveReactionTextColor());
        }
    }
