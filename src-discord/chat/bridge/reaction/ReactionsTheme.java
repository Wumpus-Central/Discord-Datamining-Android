...
public final class ReactionsTheme implements ReactionView.ReactionsTheme {
    ...
    public static final void write$Self(ReactionsTheme self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.B(serialDesc, 0, m0.f29837a, self.getReactionBackgroundColor());
        }
        ...
        if (z11) {
            output.B(serialDesc, 1, m0.f29837a, self.getReactionBorderColor());
        }
        ...
        if (z12) {
            output.B(serialDesc, 2, m0.f29837a, self.getReactionTextColor());
        }
        ...
        if (z13) {
            output.B(serialDesc, 3, m0.f29837a, self.getActiveReactionBackgroundColor());
        }
        ...
        if (z14) {
            output.B(serialDesc, 4, m0.f29837a, self.getActiveReactionBorderColor());
        }
        if (output.z(serialDesc, 5) || self.getActiveReactionTextColor() != null) {
            z15 = true;
        }
        if (z15) {
            output.B(serialDesc, 5, m0.f29837a, self.getActiveReactionTextColor());
        }
    }
