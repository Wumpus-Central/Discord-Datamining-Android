...
public final class ReactionsTheme implements ReactionView.ReactionsTheme {
    ...
    public static final void write$Self(ReactionsTheme self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.z(serialDesc, 0, m0.f26308a, self.getReactionBackgroundColor());
        }
        ...
        if (z11) {
            output.z(serialDesc, 1, m0.f26308a, self.getReactionBorderColor());
        }
        ...
        if (z12) {
            output.z(serialDesc, 2, m0.f26308a, self.getReactionTextColor());
        }
        ...
        if (z13) {
            output.z(serialDesc, 3, m0.f26308a, self.getActiveReactionBackgroundColor());
        }
        ...
        if (z14) {
            output.z(serialDesc, 4, m0.f26308a, self.getActiveReactionBorderColor());
        }
        if (output.w(serialDesc, 5) || self.getActiveReactionTextColor() != null) {
            z15 = true;
        }
        if (z15) {
            output.z(serialDesc, 5, m0.f26308a, self.getActiveReactionTextColor());
        }
    }
