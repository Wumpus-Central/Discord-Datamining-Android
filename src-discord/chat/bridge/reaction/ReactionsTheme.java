...
public final class ReactionsTheme implements ReactionView.ReactionsTheme {
    ...
    public static final void write$Self(ReactionsTheme self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.p(serialDesc, 0, m0.f5992a, self.getReactionBackgroundColor());
        }
        ...
        if (z11) {
            output.p(serialDesc, 1, m0.f5992a, self.getReactionBorderColor());
        }
        ...
        if (z12) {
            output.p(serialDesc, 2, m0.f5992a, self.getReactionTextColor());
        }
        ...
        if (z13) {
            output.p(serialDesc, 3, m0.f5992a, self.getActiveReactionBackgroundColor());
        }
        ...
        if (z14) {
            output.p(serialDesc, 4, m0.f5992a, self.getActiveReactionBorderColor());
        }
        if (output.A(serialDesc, 5) || self.getActiveReactionTextColor() != null) {
            z15 = true;
        }
        if (z15) {
            output.p(serialDesc, 5, m0.f5992a, self.getActiveReactionTextColor());
        }
    }
