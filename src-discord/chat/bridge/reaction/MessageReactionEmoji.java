...
public final class MessageReactionEmoji implements ReactionView.Emoji {
    ...
    public  MessageReactionEmoji(int i10, String str, String str2, String str3, String str4, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        if (6 != (i10 & 6)) {
    ...
    public static  MessageReactionEmoji copy$default(MessageReactionEmoji messageReactionEmoji, String str, String str2, String str3, String str4, Boolean bool, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(MessageReactionEmoji self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 0, a2.f30574a, self.getName());
        }
        ...
        if (z11) {
            output.e(serialDesc, 3, a2.f30574a, self.getId());
        }
        if (output.z(serialDesc, 4) || self.getAnimated() != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 4, h.f30616a, self.getAnimated());
        }
    }
    ...
    public  MessageReactionEmoji(String str, String str2, String str3, String str4, Boolean bool, int i10, DefaultConstructorMarker defaultConstructorMarker) {
