...
public final class MessageReactionEmoji implements ReactionView.Emoji {
    ...
    public static final void write$Self(MessageReactionEmoji self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 0, a2.f26939a, self.getName());
        }
        output.t(serialDesc, 1, self.getSrc());
        ...
        if (z11) {
            output.e(serialDesc, 3, a2.f26939a, self.getId());
        }
        if (output.w(serialDesc, 4) || self.getAnimated() != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 4, h.f26981a, self.getAnimated());
        }
    }
