...
public final class BurstReactionColorPalette implements BurstReactionView.BurstColorPalette {
    ...
    public static final void write$Self(BurstReactionColorPalette self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        a2 a2Var = a2.f26237a;
        output.z(serialDesc, 0, a2Var, self.getBackgroundColor());
        output.z(serialDesc, 1, a2Var, self.getAccentColor());
        output.z(serialDesc, 2, a2Var, self.getHighlightColor());
        output.l(serialDesc, 3, self.getOpacity());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(getBackgroundColor(), burstReactionColorPalette.getBackgroundColor()) && q.b(getAccentColor(), burstReactionColorPalette.getAccentColor()) && q.b(getHighlightColor(), burstReactionColorPalette.getHighlightColor()) && Float.compare(getOpacity(), burstReactionColorPalette.getOpacity()) == 0;
    }
