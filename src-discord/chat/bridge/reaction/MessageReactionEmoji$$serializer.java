...
public final class MessageReactionEmoji$$serializer implements f0<MessageReactionEmoji> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f32925a;
        return new KSerializer[]{a.u(a2Var), a2Var, a2Var, a.u(a2Var), a.u(h.f32967a)};
    }
    ...
    public MessageReactionEmoji deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj2 = b10.n(descriptor2, 4, h.f32967a, null);
            i10 = 31;
        } else {
            boolean z10 = true;
            int i11 = 0;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj5 = b10.n(descriptor2, 3, a2.f32925a, obj5);
                    i11 |= 8;
                } else if (o10 == 4) {
                    obj6 = b10.n(descriptor2, 4, h.f32967a, obj6);
                    i11 |= 16;
                } else {
                    throw new n(o10);
                }
