...
public final class EmbeddedActivityInviteEmbedImpl extends CodedLinkEmbed implements EmbeddedActivityInviteEmbed {
    ...
    public  EmbeddedActivityInviteEmbedImpl(int i10, int i11, int i12, int i13, int i14, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, Integer num4, Boolean bool, Boolean bool2, Integer num5, Integer num6, Boolean bool3, Integer num7, String str4, String str5, String str6, Integer num8, Integer num9, Integer num10, String str7, String str8, Integer num11, String str9, List list, CodedLinkExtendedType codedLinkExtendedType, AnnotatedStructurableText annotatedStructurableText, String str10, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.extendedType = (268435456 & i10) == 0 ? CodedLinkExtendedType.ACTIVITY_BOOKMARK : codedLinkExtendedType;
        if ((i10 & 536870912) == 0) {
    ...
    public static final void write$Self(EmbeddedActivityInviteEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 2, self.getHeaderColor());
        a2 a2Var = a2.f29550a;
        output.z(serialDesc, 3, a2Var, self.getHeaderText());
        if (output.w(serialDesc, 4) || self.getType() != null) {
            output.z(serialDesc, 4, InviteType.Serializer.INSTANCE, self.getType());
        }
        if (output.w(serialDesc, 5) || self.getAcceptLabelBackgroundColor() != null) {
            output.z(serialDesc, 5, m0.f29625a, self.getAcceptLabelBackgroundColor());
        }
        if (output.w(serialDesc, 6) || self.getAcceptLabelBorderColor() != null) {
            output.z(serialDesc, 6, m0.f29625a, self.getAcceptLabelBorderColor());
        }
        if (output.w(serialDesc, 7) || self.getAcceptLabelColor() != null) {
            output.z(serialDesc, 7, m0.f29625a, self.getAcceptLabelColor());
        }
        if (output.w(serialDesc, 8) || self.getAcceptLabelText() != null) {
            output.z(serialDesc, 8, a2Var, self.getAcceptLabelText());
        }
        if (output.w(serialDesc, 9) || self.getBodyText() != null) {
            output.z(serialDesc, 9, a2Var, self.getBodyText());
        }
        if (output.w(serialDesc, 10) || self.getBodyTextColor() != null) {
            output.z(serialDesc, 10, m0.f29625a, self.getBodyTextColor());
        }
        if (output.w(serialDesc, 11) || self.getCanBeAccepted() != null) {
            output.z(serialDesc, 11, h.f29592a, self.getCanBeAccepted());
        }
        if (output.w(serialDesc, 12) || self.getEmbedCanBeTapped() != null) {
            output.z(serialDesc, 12, h.f29592a, self.getEmbedCanBeTapped());
        }
        if (output.w(serialDesc, 13) || self.getResolvingGradientEnd() != null) {
            output.z(serialDesc, 13, m0.f29625a, self.getResolvingGradientEnd());
        }
        if (output.w(serialDesc, 14) || self.getResolvingGradientStart() != null) {
            output.z(serialDesc, 14, m0.f29625a, self.getResolvingGradientStart());
        }
        if (output.w(serialDesc, 15) || self.getSplashHasRadialGradient() != null) {
            output.z(serialDesc, 15, h.f29592a, self.getSplashHasRadialGradient());
        }
        if (output.w(serialDesc, 16) || self.getSplashOpacity() != null) {
            output.z(serialDesc, 16, m0.f29625a, self.getSplashOpacity());
        }
        if (output.w(serialDesc, 17) || self.getSplashUrl() != null) {
            output.z(serialDesc, 17, a2Var, self.getSplashUrl());
        }
        if (output.w(serialDesc, 18) || self.getInviteSplash() != null) {
            output.z(serialDesc, 18, a2Var, self.getInviteSplash());
        }
        if (output.w(serialDesc, 19) || self.getSubtitle() != null) {
            output.z(serialDesc, 19, a2Var, self.getSubtitle());
        }
        if (output.w(serialDesc, 20) || self.getSubtitleColor() != null) {
            output.z(serialDesc, 20, m0.f29625a, self.getSubtitleColor());
        }
        if (output.w(serialDesc, 21) || self.getThumbnailBackgroundColor() != null) {
            output.z(serialDesc, 21, m0.f29625a, self.getThumbnailBackgroundColor());
        }
        if (output.w(serialDesc, 22) || self.getThumbnailCornerRadius() != null) {
            output.z(serialDesc, 22, m0.f29625a, self.getThumbnailCornerRadius());
        }
        if (output.w(serialDesc, 23) || self.getThumbnailText() != null) {
            output.z(serialDesc, 23, a2Var, self.getThumbnailText());
        }
        if (output.w(serialDesc, 24) || self.getThumbnailUrl() != null) {
            output.z(serialDesc, 24, a2Var, self.getThumbnailUrl());
        }
        if (output.w(serialDesc, 25) || self.getTitleColor() != null) {
            output.z(serialDesc, 25, m0.f29625a, self.getTitleColor());
        }
        if (output.w(serialDesc, 26) || self.getTitleText() != null) {
            output.z(serialDesc, 26, a2Var, self.getTitleText());
        }
        output.h(serialDesc, 27, new wi.f(a2Var), self.getParticipantAvatarUris());
        if (output.w(serialDesc, 28) || self.getExtendedType() != CodedLinkExtendedType.ACTIVITY_BOOKMARK) {
            output.h(serialDesc, 28, CodedLinkExtendedType.Serializer.INSTANCE, self.getExtendedType());
        }
        if (output.w(serialDesc, 29) || self.getStructurableSubtitleText() != null) {
            z10 = true;
        }
        if (z10) {
            output.z(serialDesc, 29, AnnotatedStructurableTextSerializer.INSTANCE, self.getStructurableSubtitleText());
        }
        output.s(serialDesc, 30, self.getNoParticipantsText());
        output.r(serialDesc, 31, self.getCtaEnabled());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getBackgroundColor() == embeddedActivityInviteEmbedImpl.getBackgroundColor() && getBorderColor() == embeddedActivityInviteEmbedImpl.getBorderColor() && getHeaderColor() == embeddedActivityInviteEmbedImpl.getHeaderColor() && q.c(getHeaderText(), embeddedActivityInviteEmbedImpl.getHeaderText()) && getType() == embeddedActivityInviteEmbedImpl.getType() && q.c(getAcceptLabelBackgroundColor(), embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor()) && q.c(getAcceptLabelBorderColor(), embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor()) && q.c(getAcceptLabelColor(), embeddedActivityInviteEmbedImpl.getAcceptLabelColor()) && q.c(getAcceptLabelText(), embeddedActivityInviteEmbedImpl.getAcceptLabelText()) && q.c(getBodyText(), embeddedActivityInviteEmbedImpl.getBodyText()) && q.c(getBodyTextColor(), embeddedActivityInviteEmbedImpl.getBodyTextColor()) && q.c(getCanBeAccepted(), embeddedActivityInviteEmbedImpl.getCanBeAccepted()) && q.c(getEmbedCanBeTapped(), embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped()) && q.c(getResolvingGradientEnd(), embeddedActivityInviteEmbedImpl.getResolvingGradientEnd()) && q.c(getResolvingGradientStart(), embeddedActivityInviteEmbedImpl.getResolvingGradientStart()) && q.c(getSplashHasRadialGradient(), embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient()) && q.c(getSplashOpacity(), embeddedActivityInviteEmbedImpl.getSplashOpacity()) && q.c(getSplashUrl(), embeddedActivityInviteEmbedImpl.getSplashUrl()) && q.c(getInviteSplash(), embeddedActivityInviteEmbedImpl.getInviteSplash()) && q.c(getSubtitle(), embeddedActivityInviteEmbedImpl.getSubtitle()) && q.c(getSubtitleColor(), embeddedActivityInviteEmbedImpl.getSubtitleColor()) && q.c(getThumbnailBackgroundColor(), embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor()) && q.c(getThumbnailCornerRadius(), embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius()) && q.c(getThumbnailText(), embeddedActivityInviteEmbedImpl.getThumbnailText()) && q.c(getThumbnailUrl(), embeddedActivityInviteEmbedImpl.getThumbnailUrl()) && q.c(getTitleColor(), embeddedActivityInviteEmbedImpl.getTitleColor()) && q.c(getTitleText(), embeddedActivityInviteEmbedImpl.getTitleText()) && q.c(getParticipantAvatarUris(), embeddedActivityInviteEmbedImpl.getParticipantAvatarUris()) && getExtendedType() == embeddedActivityInviteEmbedImpl.getExtendedType() && q.c(getStructurableSubtitleText(), embeddedActivityInviteEmbedImpl.getStructurableSubtitleText()) && q.c(getNoParticipantsText(), embeddedActivityInviteEmbedImpl.getNoParticipantsText()) && getCtaEnabled() == embeddedActivityInviteEmbedImpl.getCtaEnabled();
    }
