...
public final class EmbeddedActivityInviteEmbedImpl extends CodedLinkEmbed implements EmbeddedActivityInviteEmbed {
    ...
    public static final void write$Self(EmbeddedActivityInviteEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.z(serialDesc, 12) || self.getEmbedCanBeTapped() != null) {
            output.E(serialDesc, 12, h.f6280a, self.getEmbedCanBeTapped());
        }
        if (output.z(serialDesc, 13) || self.getResolvingGradientEnd() != null) {
            output.E(serialDesc, 13, m0.f6313a, self.getResolvingGradientEnd());
        }
        if (output.z(serialDesc, 14) || self.getResolvingGradientStart() != null) {
            output.E(serialDesc, 14, m0.f6313a, self.getResolvingGradientStart());
        }
        if (output.z(serialDesc, 15) || self.getSplashHasRadialGradient() != null) {
            output.E(serialDesc, 15, h.f6280a, self.getSplashHasRadialGradient());
        }
        if (output.z(serialDesc, 16) || self.getSplashOpacity() != null) {
            output.E(serialDesc, 16, m0.f6313a, self.getSplashOpacity());
        }
        ...
        if (output.z(serialDesc, 20) || self.getSubtitleColor() != null) {
            output.E(serialDesc, 20, m0.f6313a, self.getSubtitleColor());
        }
        if (output.z(serialDesc, 21) || self.getThumbnailBackgroundColor() != null) {
            output.E(serialDesc, 21, m0.f6313a, self.getThumbnailBackgroundColor());
        }
        if (output.z(serialDesc, 22) || self.getThumbnailCornerRadius() != null) {
            output.E(serialDesc, 22, m0.f6313a, self.getThumbnailCornerRadius());
        }
        ...
        if (output.z(serialDesc, 25) || self.getTitleColor() != null) {
            output.E(serialDesc, 25, m0.f6313a, self.getTitleColor());
        }
        if (output.z(serialDesc, 26) || self.getTitleText() != null) {
            output.E(serialDesc, 26, a2Var, self.getTitleText());
        }
        output.i(serialDesc, 27, new cj.f(a2Var), self.getParticipantAvatarUris());
        if (output.z(serialDesc, 28) || self.getExtendedType() != CodedLinkExtendedType.ACTIVITY_BOOKMARK) {
            output.i(serialDesc, 28, CodedLinkExtendedType.Serializer.INSTANCE, self.getExtendedType());
        }
