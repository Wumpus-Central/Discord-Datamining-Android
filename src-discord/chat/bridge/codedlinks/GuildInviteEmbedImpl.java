...
public final class GuildInviteEmbedImpl extends CodedLinkEmbed implements GuildInviteEmbed {
    ...
    public static final void write$Self(GuildInviteEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 4, InviteType.Serializer.INSTANCE, self.getType());
        ...
        if (output.w(serialDesc, 14) || self.getEmbedCanBeTapped() != null) {
            output.e(serialDesc, 14, h.f27014a, self.getEmbedCanBeTapped());
        }
        ...
        if (output.w(serialDesc, 17) || self.getResolvingGradientEnd() != null) {
            output.e(serialDesc, 17, m0.f27047a, self.getResolvingGradientEnd());
        }
        if (output.w(serialDesc, 18) || self.getResolvingGradientStart() != null) {
            output.e(serialDesc, 18, m0.f27047a, self.getResolvingGradientStart());
        }
        if (output.w(serialDesc, 19) || self.getSplashHasRadialGradient() != null) {
            output.e(serialDesc, 19, h.f27014a, self.getSplashHasRadialGradient());
        }
        if (output.w(serialDesc, 20) || self.getSplashOpacity() != null) {
            output.e(serialDesc, 20, m0.f27047a, self.getSplashOpacity());
        }
        ...
        if (output.w(serialDesc, 24) || self.getSubtitleColor() != null) {
            output.e(serialDesc, 24, m0.f27047a, self.getSubtitleColor());
        }
        if (output.w(serialDesc, 25) || self.getThumbnailBackgroundColor() != null) {
            output.e(serialDesc, 25, m0.f27047a, self.getThumbnailBackgroundColor());
        }
        if (output.w(serialDesc, 26) || self.getThumbnailCornerRadius() != null) {
            output.e(serialDesc, 26, m0.f27047a, self.getThumbnailCornerRadius());
        }
        ...
        if (output.w(serialDesc, 29) || self.getTitleColor() != null) {
            output.e(serialDesc, 29, m0.f27047a, self.getTitleColor());
        }
