...
public final class GuildEventInviteEmbedImpl extends CodedLinkEmbed implements GuildEventInviteEmbed, GuildInviteExtendedEmbed {
    ...
    public static final void write$Self(GuildEventInviteEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.A(serialDesc, 2) || self.getExtendedType() != CodedLinkExtendedType.GUILD_SCHEDULED_EVENT) {
            output.z(serialDesc, 2, CodedLinkExtendedType.Serializer.INSTANCE, self.getExtendedType());
        }
        output.w(serialDesc, 3, self.getHeaderColor());
        output.y(serialDesc, 4, self.getHeaderText());
        output.z(serialDesc, 5, InviteType.Serializer.INSTANCE, self.getType());
        if (output.A(serialDesc, 6) || self.getAcceptLabelBackgroundColor() != null) {
            output.h(serialDesc, 6, m0.f32388a, self.getAcceptLabelBackgroundColor());
        }
        if (output.A(serialDesc, 7) || self.getAcceptLabelBorderColor() != null) {
            output.h(serialDesc, 7, m0.f32388a, self.getAcceptLabelBorderColor());
        }
        if (output.A(serialDesc, 8) || self.getAcceptLabelColor() != null) {
            output.h(serialDesc, 8, m0.f32388a, self.getAcceptLabelColor());
        }
        if (output.A(serialDesc, 9) || self.getAcceptLabelIcon() != null) {
            output.h(serialDesc, 9, a2.f32313a, self.getAcceptLabelIcon());
        }
        if (output.A(serialDesc, 10) || self.getAcceptLabelText() != null) {
            output.h(serialDesc, 10, a2.f32313a, self.getAcceptLabelText());
        }
        if (output.A(serialDesc, 11) || self.getBadgeCount() != null) {
            output.h(serialDesc, 11, a2.f32313a, self.getBadgeCount());
        }
        if (output.A(serialDesc, 12) || self.getBadgeIcon() != null) {
            output.h(serialDesc, 12, a2.f32313a, self.getBadgeIcon());
        }
        if (output.A(serialDesc, 13) || self.getBodyText() != null) {
            output.h(serialDesc, 13, a2.f32313a, self.getBodyText());
        }
        if (output.A(serialDesc, 14) || self.getBodyTextColor() != null) {
            output.h(serialDesc, 14, m0.f32388a, self.getBodyTextColor());
        }
        if (output.A(serialDesc, 15) || self.getCanBeAccepted() != null) {
            output.h(serialDesc, 15, h.f32355a, self.getCanBeAccepted());
        }
        if (output.A(serialDesc, 16) || self.getChannelIcon() != null) {
            output.h(serialDesc, 16, a2.f32313a, self.getChannelIcon());
        }
        if (output.A(serialDesc, 17) || self.getChannelName() != null) {
            output.h(serialDesc, 17, a2.f32313a, self.getChannelName());
        }
        if (output.A(serialDesc, 18) || self.getContent() != null) {
            output.h(serialDesc, 18, StructurableTextSerializer.INSTANCE, self.getContent());
        }
        if (output.A(serialDesc, 19) || self.getCreatorAvatar() != null) {
            output.h(serialDesc, 19, a2.f32313a, self.getCreatorAvatar());
        }
        if (output.A(serialDesc, 20) || self.getEmbedCanBeTapped() != null) {
            output.h(serialDesc, 20, h.f32355a, self.getEmbedCanBeTapped());
        }
        if (output.A(serialDesc, 21) || self.getGuildIcon() != null) {
            output.h(serialDesc, 21, a2.f32313a, self.getGuildIcon());
        }
        if (output.A(serialDesc, 22) || self.getGuildName() != null) {
            output.h(serialDesc, 22, a2.f32313a, self.getGuildName());
        }
        if (output.A(serialDesc, 23) || self.getHeaderIcon() != null) {
            output.h(serialDesc, 23, a2.f32313a, self.getHeaderIcon());
        }
        if (output.A(serialDesc, 24) || self.getHeaderTextColor() != null) {
            output.h(serialDesc, 24, m0.f32388a, self.getHeaderTextColor());
        }
        if (output.A(serialDesc, 25) || self.isRsvped() != null) {
            output.h(serialDesc, 25, h.f32355a, self.isRsvped());
        }
        if (output.A(serialDesc, 26) || self.getMemberText() != null) {
            output.h(serialDesc, 26, a2.f32313a, self.getMemberText());
        }
        if (output.A(serialDesc, 27) || self.getOnlineText() != null) {
            output.h(serialDesc, 27, a2.f32313a, self.getOnlineText());
        }
        if (output.A(serialDesc, 28) || self.getResolvingGradientEnd() != null) {
            output.h(serialDesc, 28, m0.f32388a, self.getResolvingGradientEnd());
        }
        if (output.A(serialDesc, 29) || self.getResolvingGradientStart() != null) {
            output.h(serialDesc, 29, m0.f32388a, self.getResolvingGradientStart());
        }
        if (output.A(serialDesc, 30) || self.getSecondaryActionIcon() != null) {
            output.h(serialDesc, 30, a2.f32313a, self.getSecondaryActionIcon());
        }
        if (output.A(serialDesc, 31) || self.getSplashHasRadialGradient() != null) {
            output.h(serialDesc, 31, h.f32355a, self.getSplashHasRadialGradient());
        }
        if (output.A(serialDesc, 32) || self.getSplashOpacity() != null) {
            output.h(serialDesc, 32, m0.f32388a, self.getSplashOpacity());
        }
        if (output.A(serialDesc, 33) || self.getSplashUrl() != null) {
            output.h(serialDesc, 33, a2.f32313a, self.getSplashUrl());
        }
        if (output.A(serialDesc, 34) || self.getInviteSplash() != null) {
            output.h(serialDesc, 34, a2.f32313a, self.getInviteSplash());
        }
        if (output.A(serialDesc, 35) || self.getSubtitle() != null) {
            output.h(serialDesc, 35, a2.f32313a, self.getSubtitle());
        }
        if (output.A(serialDesc, 36) || self.getSubtitleColor() != null) {
            output.h(serialDesc, 36, m0.f32388a, self.getSubtitleColor());
        }
        if (output.A(serialDesc, 37) || self.getThumbnailBackgroundColor() != null) {
            output.h(serialDesc, 37, m0.f32388a, self.getThumbnailBackgroundColor());
        }
        if (output.A(serialDesc, 38) || self.getThumbnailCornerRadius() != null) {
            output.h(serialDesc, 38, m0.f32388a, self.getThumbnailCornerRadius());
        }
        if (output.A(serialDesc, 39) || self.getThumbnailText() != null) {
            output.h(serialDesc, 39, a2.f32313a, self.getThumbnailText());
        }
        if (output.A(serialDesc, 40) || self.getThumbnailUrl() != null) {
            output.h(serialDesc, 40, a2.f32313a, self.getThumbnailUrl());
        }
        if (output.A(serialDesc, 41) || self.getTitleColor() != null) {
            output.h(serialDesc, 41, m0.f32388a, self.getTitleColor());
        }
        if (output.A(serialDesc, 42) || self.getTitleText() != null) {
            z10 = true;
        }
        if (z10) {
            output.h(serialDesc, 42, a2.f32313a, self.getTitleText());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getBackgroundColor() == guildEventInviteEmbedImpl.getBackgroundColor() && getBorderColor() == guildEventInviteEmbedImpl.getBorderColor() && getExtendedType() == guildEventInviteEmbedImpl.getExtendedType() && getHeaderColor() == guildEventInviteEmbedImpl.getHeaderColor() && q.b(getHeaderText(), guildEventInviteEmbedImpl.getHeaderText()) && getType() == guildEventInviteEmbedImpl.getType() && q.b(getAcceptLabelBackgroundColor(), guildEventInviteEmbedImpl.getAcceptLabelBackgroundColor()) && q.b(getAcceptLabelBorderColor(), guildEventInviteEmbedImpl.getAcceptLabelBorderColor()) && q.b(getAcceptLabelColor(), guildEventInviteEmbedImpl.getAcceptLabelColor()) && q.b(getAcceptLabelIcon(), guildEventInviteEmbedImpl.getAcceptLabelIcon()) && q.b(getAcceptLabelText(), guildEventInviteEmbedImpl.getAcceptLabelText()) && q.b(getBadgeCount(), guildEventInviteEmbedImpl.getBadgeCount()) && q.b(getBadgeIcon(), guildEventInviteEmbedImpl.getBadgeIcon()) && q.b(getBodyText(), guildEventInviteEmbedImpl.getBodyText()) && q.b(getBodyTextColor(), guildEventInviteEmbedImpl.getBodyTextColor()) && q.b(getCanBeAccepted(), guildEventInviteEmbedImpl.getCanBeAccepted()) && q.b(getChannelIcon(), guildEventInviteEmbedImpl.getChannelIcon()) && q.b(getChannelName(), guildEventInviteEmbedImpl.getChannelName()) && q.b(getContent(), guildEventInviteEmbedImpl.getContent()) && q.b(getCreatorAvatar(), guildEventInviteEmbedImpl.getCreatorAvatar()) && q.b(getEmbedCanBeTapped(), guildEventInviteEmbedImpl.getEmbedCanBeTapped()) && q.b(getGuildIcon(), guildEventInviteEmbedImpl.getGuildIcon()) && q.b(getGuildName(), guildEventInviteEmbedImpl.getGuildName()) && q.b(getHeaderIcon(), guildEventInviteEmbedImpl.getHeaderIcon()) && q.b(getHeaderTextColor(), guildEventInviteEmbedImpl.getHeaderTextColor()) && q.b(isRsvped(), guildEventInviteEmbedImpl.isRsvped()) && q.b(getMemberText(), guildEventInviteEmbedImpl.getMemberText()) && q.b(getOnlineText(), guildEventInviteEmbedImpl.getOnlineText()) && q.b(getResolvingGradientEnd(), guildEventInviteEmbedImpl.getResolvingGradientEnd()) && q.b(getResolvingGradientStart(), guildEventInviteEmbedImpl.getResolvingGradientStart()) && q.b(getSecondaryActionIcon(), guildEventInviteEmbedImpl.getSecondaryActionIcon()) && q.b(getSplashHasRadialGradient(), guildEventInviteEmbedImpl.getSplashHasRadialGradient()) && q.b(getSplashOpacity(), guildEventInviteEmbedImpl.getSplashOpacity()) && q.b(getSplashUrl(), guildEventInviteEmbedImpl.getSplashUrl()) && q.b(getInviteSplash(), guildEventInviteEmbedImpl.getInviteSplash()) && q.b(getSubtitle(), guildEventInviteEmbedImpl.getSubtitle()) && q.b(getSubtitleColor(), guildEventInviteEmbedImpl.getSubtitleColor()) && q.b(getThumbnailBackgroundColor(), guildEventInviteEmbedImpl.getThumbnailBackgroundColor()) && q.b(getThumbnailCornerRadius(), guildEventInviteEmbedImpl.getThumbnailCornerRadius()) && q.b(getThumbnailText(), guildEventInviteEmbedImpl.getThumbnailText()) && q.b(getThumbnailUrl(), guildEventInviteEmbedImpl.getThumbnailUrl()) && q.b(getTitleColor(), guildEventInviteEmbedImpl.getTitleColor()) && q.b(getTitleText(), guildEventInviteEmbedImpl.getTitleText());
    }
    ...
    public /* synthetic */ GuildEventInviteEmbedImpl(int i10, int i11, CodedLinkExtendedType codedLinkExtendedType, int i12, String str, InviteType inviteType, Integer num, Integer num2, Integer num3, String str2, String str3, String str4, String str5, String str6, Integer num4, Boolean bool, String str7, String str8, StructurableText structurableText, String str9, Boolean bool2, String str10, String str11, String str12, Integer num5, Boolean bool3, String str13, String str14, Integer num6, Integer num7, String str15, Boolean bool4, Integer num8, String str16, String str17, String str18, Integer num9, Integer num10, Integer num11, String str19, String str20, Integer num12, String str21, int i13, int i14, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, i11, (i13 & 4) != 0 ? CodedLinkExtendedType.GUILD_SCHEDULED_EVENT : codedLinkExtendedType, i12, str, inviteType, (i13 & 64) != 0 ? null : num, (i13 & 128) != 0 ? null : num2, (i13 & Spliterator.NONNULL) != 0 ? null : num3, (i13 & 512) != 0 ? null : str2, (i13 & Spliterator.IMMUTABLE) != 0 ? null : str3, (i13 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : str4, (i13 & 4096) != 0 ? null : str5, (i13 & 8192) != 0 ? null : str6, (i13 & Spliterator.SUBSIZED) != 0 ? null : num4, (32768 & i13) != 0 ? null : bool, (65536 & i13) != 0 ? null : str7, (131072 & i13) != 0 ? null : str8, (262144 & i13) != 0 ? null : structurableText, (524288 & i13) != 0 ? null : str9, (1048576 & i13) != 0 ? null : bool2, (2097152 & i13) != 0 ? null : str10, (4194304 & i13) != 0 ? null : str11, (8388608 & i13) != 0 ? null : str12, (16777216 & i13) != 0 ? null : num5, (33554432 & i13) != 0 ? null : bool3, (67108864 & i13) != 0 ? null : str13, (134217728 & i13) != 0 ? null : str14, (268435456 & i13) != 0 ? null : num6, (536870912 & i13) != 0 ? null : num7, (1073741824 & i13) != 0 ? null : str15, (i13 & Integer.MIN_VALUE) != 0 ? null : bool4, (i14 & 1) != 0 ? null : num8, (i14 & 2) != 0 ? null : str16, (i14 & 4) != 0 ? null : str17, (i14 & 8) != 0 ? null : str18, (i14 & 16) != 0 ? null : num9, (i14 & 32) != 0 ? null : num10, (i14 & 64) != 0 ? null : num11, (i14 & 128) != 0 ? null : str19, (i14 & Spliterator.NONNULL) != 0 ? null : str20, (i14 & 512) != 0 ? null : num12, (i14 & Spliterator.IMMUTABLE) != 0 ? null : str21);
    }
