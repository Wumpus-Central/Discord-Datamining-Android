...
public final class GuildInviteDisabledEmbedImpl extends CodedLinkEmbed implements GuildDisabledInviteEmbed, GuildInviteExtendedEmbed {
    ...
    public static final void write$Self(GuildInviteDisabledEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.w(serialDesc, 9) || self.getAcceptLabelBackgroundColor() != null) {
            output.z(serialDesc, 9, m0.f26306a, self.getAcceptLabelBackgroundColor());
        }
        if (output.w(serialDesc, 10) || self.getAcceptLabelBorderColor() != null) {
            output.z(serialDesc, 10, m0.f26306a, self.getAcceptLabelBorderColor());
        }
        if (output.w(serialDesc, 11) || self.getAcceptLabelColor() != null) {
            output.z(serialDesc, 11, m0.f26306a, self.getAcceptLabelColor());
        }
        if (output.w(serialDesc, 12) || self.getAcceptLabelText() != null) {
            output.z(serialDesc, 12, a2.f26231a, self.getAcceptLabelText());
        }
        ...
        if (output.w(serialDesc, 18) || self.getEmbedCanBeTapped() != null) {
            output.z(serialDesc, 18, h.f26273a, self.getEmbedCanBeTapped());
        }
        if (output.w(serialDesc, 19) || self.getMemberText() != null) {
            output.z(serialDesc, 19, a2.f26231a, self.getMemberText());
        }
        if (output.w(serialDesc, 20) || self.getOnlineText() != null) {
            output.z(serialDesc, 20, a2.f26231a, self.getOnlineText());
        }
        if (output.w(serialDesc, 21) || self.getResolvingGradientEnd() != null) {
            output.z(serialDesc, 21, m0.f26306a, self.getResolvingGradientEnd());
        }
        if (output.w(serialDesc, 22) || self.getResolvingGradientStart() != null) {
            output.z(serialDesc, 22, m0.f26306a, self.getResolvingGradientStart());
        }
        if (output.w(serialDesc, 23) || self.getSplashHasRadialGradient() != null) {
            output.z(serialDesc, 23, h.f26273a, self.getSplashHasRadialGradient());
        }
        if (output.w(serialDesc, 24) || self.getSplashOpacity() != null) {
            output.z(serialDesc, 24, m0.f26306a, self.getSplashOpacity());
        }
        if (output.w(serialDesc, 25) || self.getSplashUrl() != null) {
            output.z(serialDesc, 25, a2.f26231a, self.getSplashUrl());
        }
        if (output.w(serialDesc, 26) || self.getInviteSplash() != null) {
            output.z(serialDesc, 26, a2.f26231a, self.getInviteSplash());
        }
        if (output.w(serialDesc, 27) || self.getSubtitleColor() != null) {
            output.z(serialDesc, 27, m0.f26306a, self.getSubtitleColor());
        }
        if (output.w(serialDesc, 28) || self.getThumbnailBackgroundColor() != null) {
            output.z(serialDesc, 28, m0.f26306a, self.getThumbnailBackgroundColor());
        }
        if (output.w(serialDesc, 29) || self.getThumbnailCornerRadius() != null) {
            output.z(serialDesc, 29, m0.f26306a, self.getThumbnailCornerRadius());
        }
        if (output.w(serialDesc, 30) || self.getThumbnailText() != null) {
            output.z(serialDesc, 30, a2.f26231a, self.getThumbnailText());
        }
        if (output.w(serialDesc, 31) || self.getThumbnailUrl() != null) {
            output.z(serialDesc, 31, a2.f26231a, self.getThumbnailUrl());
        }
        if (output.w(serialDesc, 32) || self.getTitleColor() != null) {
            output.z(serialDesc, 32, m0.f26306a, self.getTitleColor());
        }
        ...
        if (output.w(serialDesc, 35) || self.getGuildIcon() != null) {
            output.z(serialDesc, 35, a2.f26231a, self.getGuildIcon());
        }
        if (output.w(serialDesc, 36) || self.getHeaderIcon() != null) {
            z10 = true;
        }
        if (z10) {
            output.z(serialDesc, 36, a2.f26231a, self.getHeaderIcon());
        }
    }
