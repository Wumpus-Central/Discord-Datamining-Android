...
public final class ActivityBookmarkEmbedImpl extends CodedLinkEmbed implements ActivityBookmarkEmbed {
    ...
    public static final void write$Self(ActivityBookmarkEmbedImpl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 27, ApplicationId$$serializer.INSTANCE, ApplicationId.m578boximpl(self.mo41getApplicationIdVavddsQ()));
        output.h(serialDesc, 28, ChannelId$$serializer.INSTANCE, ChannelId.m591boximpl(self.mo42getChannelIdo4g7jtM()));
    ...
    public String toString() {
        ...
        String str = ApplicationId.m585toStringimpl(mo41getApplicationIdVavddsQ());
        String str2 = ChannelId.m598toStringimpl(mo42getChannelIdo4g7jtM());
