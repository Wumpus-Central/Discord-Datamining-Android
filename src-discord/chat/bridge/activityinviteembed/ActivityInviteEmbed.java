...
public final class ActivityInviteEmbed {
    ...
    public static final void write$Self(ActivityInviteEmbed self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.E(serialDesc, 0, a2.f6238a, self.coverImage);
        }
        ...
        if (z11) {
            output.E(serialDesc, 4, new cj.f(a.u(a2.f6238a)), self.avatarsToRender);
        }
        ...
        if (z12) {
            output.E(serialDesc, 6, a2.f6238a, self.name);
        }
        if (output.z(serialDesc, 7) || self.subtext != null) {
            z13 = true;
        }
        if (z13) {
            output.E(serialDesc, 7, a2.f6238a, self.subtext);
        }
