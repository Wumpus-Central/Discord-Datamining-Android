...
public final class ActivityInviteEmbed {
    ...
    public static final void write$Self(ActivityInviteEmbed self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.u(serialDesc, 0, a2.f32925a, self.coverImage);
        }
        ...
        if (z11) {
            output.u(serialDesc, 4, new yj.f(a.u(a2.f32925a)), self.avatarsToRender);
        }
        ...
        if (z12) {
            output.u(serialDesc, 6, a2.f32925a, self.name);
        }
        if (output.A(serialDesc, 7) || self.subtext != null) {
            z13 = true;
        }
        if (z13) {
            output.u(serialDesc, 7, a2.f32925a, self.subtext);
        }
