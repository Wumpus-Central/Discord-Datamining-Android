...
public final class SurveyIndication {
    ...
    public  SurveyIndication(int i10, StructurableText structurableText, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  SurveyIndication copy$default(SurveyIndication surveyIndication, StructurableText structurableText, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public final SurveyIndication copy(StructurableText content, String feedbackIconUrl) {
        q.h(content, "content");
        q.h(feedbackIconUrl, "feedbackIconUrl");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.content, surveyIndication.content) && q.c(this.feedbackIconUrl, surveyIndication.feedbackIconUrl);
    }
