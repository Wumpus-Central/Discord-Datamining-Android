...
public final class RoleIcon {
    ...
    public /* synthetic */ RoleIcon(int i10, String str, String str2, String str3, int i11, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (28 != (i10 & 28)) {
    ...
    public static /* synthetic */ RoleIcon copy$default(RoleIcon roleIcon, String str, String str2, String str3, int i10, String str4, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = roleIcon.source;
        }
        if ((i11 & 2) != 0) {
    ...
    public static final void write$Self(RoleIcon self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.p(serialDesc, 0, a2.f5917a, self.source);
        }
        if (output.A(serialDesc, 1) || self.unicodeEmoji != null) {
            z11 = true;
        }
        if (z11) {
            output.p(serialDesc, 1, a2.f5917a, self.unicodeEmoji);
        }
        output.z(serialDesc, 2, self.name);
        output.x(serialDesc, 3, self.size);
        output.z(serialDesc, 4, self.alt);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.source, roleIcon.source) && q.b(this.unicodeEmoji, roleIcon.unicodeEmoji) && q.b(this.name, roleIcon.name) && this.size == roleIcon.size && q.b(this.alt, roleIcon.alt);
    }
    ...
    public /* synthetic */ RoleIcon(String str, String str2, String str3, int i10, String str4, int i11, DefaultConstructorMarker defaultConstructorMarker) {
