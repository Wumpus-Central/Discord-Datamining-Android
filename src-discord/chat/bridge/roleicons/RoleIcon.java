...
public final class RoleIcon {
    ...
    public static final void write$Self(RoleIcon self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 0, a2.f26972a, self.source);
        }
        if (output.w(serialDesc, 1) || self.unicodeEmoji != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 1, a2.f26972a, self.unicodeEmoji);
        }
        output.t(serialDesc, 2, self.name);
        output.r(serialDesc, 3, self.size);
        output.t(serialDesc, 4, self.alt);
    }
