...
public final class LoadedReferencedMessage extends ReferencedMessage {
    ...
    public  LoadedReferencedMessage(int i10, Message message, String str, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static  LoadedReferencedMessage copy$default(LoadedReferencedMessage loadedReferencedMessage, Message message, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(LoadedReferencedMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z10 = false;
        output.i(serialDesc, 0, Message$$serializer.INSTANCE, self.message);
        if (output.z(serialDesc, 1) || self.systemContent != null) {
            z10 = true;
        }
        if (z10) {
            output.E(serialDesc, 1, a2.f6238a, self.systemContent);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.message, loadedReferencedMessage.message) && q.c(this.systemContent, loadedReferencedMessage.systemContent);
    }
    ...
    public  LoadedReferencedMessage(Message message, String str, int i10, DefaultConstructorMarker defaultConstructorMarker) {
