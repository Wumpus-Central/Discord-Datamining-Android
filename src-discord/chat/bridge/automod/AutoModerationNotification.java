...
public final class AutoModerationNotification {
    ...
    public /* synthetic */ AutoModerationNotification(int i10, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static /* synthetic */ AutoModerationNotification copy$default(AutoModerationNotification autoModerationNotification, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(AutoModerationNotification self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.z(serialDesc, 0, self.header);
        if (!output.A(serialDesc, 1) && self.severity == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 1, a2.f32934a, self.severity);
        }
        if (!output.A(serialDesc, 2) && self.startTime == null) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (z11) {
            output.u(serialDesc, 2, a2.f32934a, self.startTime);
        }
        if (output.A(serialDesc, 3) || self.body != null) {
            z12 = true;
        }
        if (z12) {
            output.u(serialDesc, 3, a2.f32934a, self.body);
        }
    }
    ...
    public /* synthetic */ AutoModerationNotification(String str, String str2, String str3, String str4, int i10, DefaultConstructorMarker defaultConstructorMarker) {
