...
public final class AutoModerationNotification {
    ...
    public static final void write$Self(AutoModerationNotification self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.t(serialDesc, 0, self.header);
        ...
        if (z10) {
            output.e(serialDesc, 1, a2.f26939a, self.severity);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, a2.f26939a, self.startTime);
        }
        if (output.w(serialDesc, 3) || self.body != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 3, a2.f26939a, self.body);
        }
    }
