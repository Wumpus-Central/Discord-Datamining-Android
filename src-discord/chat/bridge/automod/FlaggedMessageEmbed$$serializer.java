...
public final class FlaggedMessageEmbed$$serializer implements f0<FlaggedMessageEmbed> {
    ...
    public FlaggedMessageEmbed deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj9 = b10.n(descriptor2, 8, m0.f33000a, null);
            z10 = b10.C(descriptor2, 9);
            obj8 = b10.n(descriptor2, 10, a2Var, null);
            obj4 = b10.n(descriptor2, 11, h.f32967a, null);
            i11 = 4095;
        } else {
            int i16 = 11;
            boolean z11 = true;
            ...
            while (z11) {
                ...
                switch (o10) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        obj14 = b10.n(descriptor2, 5, a2.f32925a, obj14);
                        i17 |= 32;
                        i16 = 11;
                        continue;
                    case 6:
                        obj15 = b10.n(descriptor2, i15, a2.f32925a, obj15);
                        i17 |= 64;
                        break;
                    case 7:
                        ...
                        break;
                    case 8:
                        obj11 = b10.n(descriptor2, 8, m0.f33000a, obj11);
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        obj13 = b10.n(descriptor2, i16, h.f32967a, obj13);
