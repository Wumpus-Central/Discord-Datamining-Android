...
public final class FlaggedMessageEmbed$$serializer implements f0<FlaggedMessageEmbed> {
    ...
    public FlaggedMessageEmbed deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj9 = b10.n(descriptor2, 8, m0.f33009a, null);
            z10 = b10.C(descriptor2, 9);
            obj8 = b10.n(descriptor2, 10, a2Var, null);
            obj4 = b10.n(descriptor2, 11, h.f32976a, null);
            i11 = 4095;
        } else {
            int i16 = 11;
            boolean z11 = true;
            ...
            while (z11) {
                ...
                switch (o10) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        obj14 = b10.n(descriptor2, 5, a2.f32934a, obj14);
                        i17 |= 32;
                        i16 = 11;
                        continue;
                    case 6:
                        obj15 = b10.n(descriptor2, i15, a2.f32934a, obj15);
                        i17 |= 64;
                        break;
                    case 7:
                        ...
                        break;
                    case 8:
                        obj11 = b10.n(descriptor2, 8, m0.f33009a, obj11);
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        obj16 = b10.n(descriptor2, i12, a2.f32934a, obj16);
                        i17 |= Spliterator.IMMUTABLE;
                        break;
                    case 11:
                        obj13 = b10.n(descriptor2, i16, h.f32976a, obj13);
        ...
        return new FlaggedMessageEmbed(i11, messageId != null ? messageId.m597unboximpl() : null, (ChannelId) obj, (GuildId) obj2, (UserId) obj5, (StructurableText) obj3, (String) obj6, (String) obj7, i10, (Integer) obj9, z10, (String) obj8, (Boolean) obj4, null, null);
    }
