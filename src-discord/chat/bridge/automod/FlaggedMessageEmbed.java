...
public final class FlaggedMessageEmbed {
    ...
    public static final void write$Self(FlaggedMessageEmbed self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z17 = false;
        output.i(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m643boximpl(self.f6922id));
        ...
        if (z13) {
            output.E(serialDesc, 5, a2.f6238a, self.channelName);
        }
        ...
        if (z14) {
            output.E(serialDesc, 6, a2.f6238a, self.username);
        }
        output.w(serialDesc, 7, self.usernameColor);
        ...
        if (z15) {
            output.E(serialDesc, 8, m0.f6313a, self.roleColor);
        }
        output.x(serialDesc, 9, self.shouldShowRoleDot);
        ...
        if (z16) {
            output.E(serialDesc, 10, a2.f6238a, self.avatarURL);
        }
        if (output.z(serialDesc, 11) || !q.c(self.communicationDisabled, Boolean.FALSE)) {
            z17 = true;
        }
        if (z17) {
            output.E(serialDesc, 11, h.f6280a, self.communicationDisabled);
        }
    }

    
    public final String m27component13Eiw7ao() {
        return this.f6922id;
    }
    ...
    public final long m28component2o4g7jtM() {
        return this.channelId;
    }

    
    public final GuildId m29component3qOKuAAo() {
        return this.guildId;
    }

    
    public final UserId m30component4wUX8bhU() {
        return this.userId;
    }
    ...
    public final FlaggedMessageEmbed m31copyYvvreA(String id2, long j10, GuildId guildId, UserId userId, StructurableText structurableText, String str, String str2, int i10, Integer num, boolean z10, String str3, Boolean bool) {
        q.h(id2, "id");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m647equalsimpl0(this.f6922id, flaggedMessageEmbed.f6922id) && ChannelId.m621equalsimpl0(this.channelId, flaggedMessageEmbed.channelId) && q.c(this.guildId, flaggedMessageEmbed.guildId) && q.c(this.userId, flaggedMessageEmbed.userId) && q.c(this.content, flaggedMessageEmbed.content) && q.c(this.channelName, flaggedMessageEmbed.channelName) && q.c(this.username, flaggedMessageEmbed.username) && this.usernameColor == flaggedMessageEmbed.usernameColor && q.c(this.roleColor, flaggedMessageEmbed.roleColor) && this.shouldShowRoleDot == flaggedMessageEmbed.shouldShowRoleDot && q.c(this.avatarURL, flaggedMessageEmbed.avatarURL) && q.c(this.communicationDisabled, flaggedMessageEmbed.communicationDisabled);
    }
    ...
    public final long m32getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final GuildId m33getGuildIdqOKuAAo() {
        return this.guildId;
    }

    
    public final String m34getId3Eiw7ao() {
        return this.f6922id;
    }
    ...
    public final UserId m35getUserIdwUX8bhU() {
        return this.userId;
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m648hashCodeimpl(this.f6922id) * 31) + ChannelId.m622hashCodeimpl(this.channelId)) * 31;
        GuildId guildId = this.guildId;
        int i11 = 0;
        int i12 = (i10 + (guildId == null ? 0 : GuildId.m635hashCodeimpl(guildId.m639unboximpl()))) * 31;
        UserId userId = this.userId;
        int i13 = (i12 + (userId == null ? 0 : UserId.m686hashCodeimpl(userId.m690unboximpl()))) * 31;
    ...
    public String toString() {
        String str = MessageId.m649toStringimpl(this.f6922id);
