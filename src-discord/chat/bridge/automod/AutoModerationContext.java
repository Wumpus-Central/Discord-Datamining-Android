...
public final class AutoModerationContext {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.p(serialDesc, 2, a2.f5917a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.p(serialDesc, 3, a2.f5917a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.p(serialDesc, 4, a2.f5917a, self.actionsIconURL);
        }
        output.z(serialDesc, 5, self.actionsText);
        output.z(serialDesc, 6, self.feedbackText);
        output.t(serialDesc, 7, FlaggedMessageEmbed$$serializer.INSTANCE, self.message);
        if (output.A(serialDesc, 8) || self.notification != null) {
            z13 = true;
        }
        if (z13) {
            output.p(serialDesc, 8, AutoModerationNotification$$serializer.INSTANCE, self.notification);
        }
    }
