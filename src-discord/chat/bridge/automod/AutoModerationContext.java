...
public final class AutoModerationContext {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.z(serialDesc, 2, a2.f26230a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.z(serialDesc, 3, a2.f26230a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.z(serialDesc, 4, a2.f26230a, self.actionsIconURL);
        }
        output.s(serialDesc, 5, self.actionsText);
        output.s(serialDesc, 6, self.feedbackText);
        output.n(serialDesc, 7, FlaggedMessageEmbed$$serializer.INSTANCE, self.message);
