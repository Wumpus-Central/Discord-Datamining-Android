...
public final class AutoModerationContext {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 1, self.headerBadgeText);
        if (!output.A(serialDesc, 2) && self.ruleDisplayText == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 2, a2.f32931a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.u(serialDesc, 3, a2.f32931a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.u(serialDesc, 4, a2.f32931a, self.actionsIconURL);
        }
        output.z(serialDesc, 5, self.actionsText);
        output.z(serialDesc, 6, self.feedbackText);
        output.q(serialDesc, 7, FlaggedMessageEmbed$$serializer.INSTANCE, self.message);
        if (output.A(serialDesc, 8) || self.notification != null) {
            z13 = true;
        }
        if (z13) {
            output.u(serialDesc, 8, AutoModerationNotification$$serializer.INSTANCE, self.notification);
        }
    }
    ...
    public /* synthetic */ AutoModerationContext(String str, String str2, String str3, String str4, String str5, String str6, String str7, FlaggedMessageEmbed flaggedMessageEmbed, AutoModerationNotification autoModerationNotification, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, (i10 & 4) != 0 ? null : str3, (i10 & 8) != 0 ? null : str4, (i10 & 16) != 0 ? null : str5, str6, str7, flaggedMessageEmbed, (i10 & Spliterator.NONNULL) != 0 ? null : autoModerationNotification);
    }
}
