...
public final class AutoModerationContext {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.B(serialDesc, 2, a2.f29764a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.B(serialDesc, 3, a2.f29764a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.B(serialDesc, 4, a2.f29764a, self.actionsIconURL);
        }
