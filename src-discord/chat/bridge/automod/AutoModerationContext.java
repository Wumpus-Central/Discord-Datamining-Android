...
public final class AutoModerationContext {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.u(serialDesc, 2, a2.f32933a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.u(serialDesc, 3, a2.f32933a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.u(serialDesc, 4, a2.f32933a, self.actionsIconURL);
        }
