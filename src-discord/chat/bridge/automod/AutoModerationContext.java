...
public final class AutoModerationContext {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.z(serialDesc, 2, a2.f29540a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.z(serialDesc, 3, a2.f29540a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.z(serialDesc, 4, a2.f29540a, self.actionsIconURL);
        }
