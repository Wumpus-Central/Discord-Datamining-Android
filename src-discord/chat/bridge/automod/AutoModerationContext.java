...
public final class AutoModerationContext {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 2, a2.f26940a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.e(serialDesc, 3, a2.f26940a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.e(serialDesc, 4, a2.f26940a, self.actionsIconURL);
        }
