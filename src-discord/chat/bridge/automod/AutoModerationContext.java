...
public final class AutoModerationContext {
    ...
    public  AutoModerationContext(int i10, String str, String str2, String str3, String str4, String str5, String str6, String str7, FlaggedMessageEmbed flaggedMessageEmbed, AutoModerationNotification autoModerationNotification, SerializationConstructorMarker serializationConstructorMarker) {
        if (227 != (i10 & 227)) {
    ...
    public static final void write$Self(AutoModerationContext self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z13 = false;
        output.y(serialDesc, 0, self.headerText);
        output.y(serialDesc, 1, self.headerBadgeText);
        ...
        if (z10) {
            output.E(serialDesc, 2, a2.f6238a, self.ruleDisplayText);
        }
        ...
        if (z11) {
            output.E(serialDesc, 3, a2.f6238a, self.keywordDisplayText);
        }
        ...
        if (z12) {
            output.E(serialDesc, 4, a2.f6238a, self.actionsIconURL);
        }
        output.y(serialDesc, 5, self.actionsText);
        output.y(serialDesc, 6, self.feedbackText);
        output.i(serialDesc, 7, FlaggedMessageEmbed$$serializer.INSTANCE, self.message);
    ...
    public final AutoModerationContext copy(String headerText, String headerBadgeText, String str, String str2, String str3, String actionsText, String feedbackText, FlaggedMessageEmbed message, AutoModerationNotification autoModerationNotification) {
        ...
        q.h(headerBadgeText, "headerBadgeText");
        q.h(actionsText, "actionsText");
        q.h(feedbackText, "feedbackText");
        q.h(message, "message");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.headerText, autoModerationContext.headerText) && q.c(this.headerBadgeText, autoModerationContext.headerBadgeText) && q.c(this.ruleDisplayText, autoModerationContext.ruleDisplayText) && q.c(this.keywordDisplayText, autoModerationContext.keywordDisplayText) && q.c(this.actionsIconURL, autoModerationContext.actionsIconURL) && q.c(this.actionsText, autoModerationContext.actionsText) && q.c(this.feedbackText, autoModerationContext.feedbackText) && q.c(this.message, autoModerationContext.message) && q.c(this.notification, autoModerationContext.notification);
    }
    ...
    public  AutoModerationContext(String str, String str2, String str3, String str4, String str5, String str6, String str7, FlaggedMessageEmbed flaggedMessageEmbed, AutoModerationNotification autoModerationNotification, int i10, DefaultConstructorMarker defaultConstructorMarker) {
