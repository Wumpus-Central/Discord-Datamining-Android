...
public abstract class ChatListAction {
    ...
    public static final class ScrollTo extends ChatListAction {
        ...
        public  ScrollTo(int i10, boolean z10, boolean z11, boolean z12, int i11, DefaultConstructorMarker defaultConstructorMarker) {
            this(i10, (i11 & 2) != 0 ? false : z10, (i11 & 4) != 0 ? false : z11, (i11 & 8) != 0 ? false : z12);
        }

        public static  ScrollTo copy$default(ScrollTo scrollTo, int i10, boolean z10, boolean z11, boolean z12, int i11, Object obj) {
            if ((i11 & 1) != 0) {
    ...
    public  ChatListAction(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
}
