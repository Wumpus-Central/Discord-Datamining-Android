...
public final class ChatInputRootView extends RelativeLayout implements KeyboardEvent {
    ...
    static final class AnonymousClass2 extends s implements Function2<Integer, Integer, Unit> {
        AnonymousClass2() {
            super(2);
        }
    ...
    public static final class CurrentTextAndSelection {
        ...
        public static  CurrentTextAndSelection copy$default(CurrentTextAndSelection currentTextAndSelection, int i10, int i11, String str, String str2, int i12, Object obj) {
            if ((i12 & 1) != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return this.selectionStart == currentTextAndSelection.selectionStart && this.selectionEnd == currentTextAndSelection.selectionEnd && q.c(this.text, currentTextAndSelection.text) && q.c(this.editId, currentTextAndSelection.editId);
        }
    ...
    public  ChatInputRootView(Context context, AttributeSet attributeSet, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final ContentInfoCompat _init_$lambda$3(ChatInputRootView this$0, final Context context, View view, ContentInfoCompat payload) {
        ...
        if (contentInfoCompat != null) {
            ...
            while (it.hasNext()) {
                ...
                q.g(uri, "clip.getItemAt(itemIndex).uri");
    ...
    public static  void setSelection$default(ChatInputRootView chatInputRootView, int i10, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = i10;
        }
    ...
    private final void updateChatNodes(List<ChatInputNode> list, int i10) {
        ...
        if (!(!z10)) {
            ...
            q.g(editableText3, "editText.editableText");
        ...
        q.g(editableText4, "editText.editableText");
        Object[] spans2 = editableText4.getSpans(0, editableText4.length(), SelectionGuardSpanWatcher.class);
        q.g(spans2, "getSpans(0, length, T::class.java)");
        if (spans2.length == 0) {
            z11 = true;
        }
        if (!(!z11)) {
            Editable editableText5 = this.editText.getEditableText();
            q.g(editableText5, "editText.editableText");
            SpannableExtensionsKt.coverWithSpan(editableText5, new SelectionGuardSpanWatcher());
        }
    }

    static  void updateChatNodes$default(ChatInputRootView chatInputRootView, List list, int i10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            i10 = 0;
        }
    ...
    public final void clearAndApplyChatNodes(String str, List<ChatInputNode> chatInputNodes) {
        q.h(chatInputNodes, "chatInputNodes");
        if (q.c(this.lastEditId, str) || str == null) {
            Editable editableText = this.editText.getEditableText();
            ...
            if (dCDInputSpanArr != null) {
                q.g(dCDInputSpanArr, "getSpans(0, length, DCDInputSpan::class.java)");
    ...
    public final void replaceRange(int i10, int i11, String text, List<ChatInputNode> styleBlocks, boolean z10, String str) {
        ...
        if (q.c(str, this.lastEditId) || str == null) {
    ...
    public ChatInputRootView(final Context context, AttributeSet attributeSet, int i10) {
        ...
        q.g(dCDChatInput, "binding.chatInputEditText");
        ...
        dCDChatInput.setOnFocusChangeListener(new View.OnFocusChangeListener() { 
            @Override 
            public final void onFocusChange(View view, boolean z10) {
                ChatInputRootView._init_$lambda$0(ChatInputRootView.this, view, z10);
            }
        });
        w0.E0(dCDChatInput, new String[]{"image/*"}, new s0() { 
            @Override 
        ...
        dCDChatInput.addTextChangedListener(new TextWatcher() { 
            @Override 
