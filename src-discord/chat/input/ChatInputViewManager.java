...
public final class ChatInputViewManager extends ViewGroupManager<ChatInputRootView> implements DCDChatInputManagerInterface<ChatInputRootView> {
    ...
    public ChatInputRootView createViewInstance(final ThemedReactContext reactContext) {
        ...
        ref$ObjectRef.f20697k = UIManagerHelper.getEventDispatcherForReactTag(reactContext, chatInputRootView.getId());
        chatInputRootView.setListener(new ChatInputRootView.ChatInputListener() { 
            @Override 
            public void onContentSizeChange(int i10, int i11) {
                ChatInputViewManager.this.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20697k, reactContext, chatInputRootView, new OnContentSizeChangeEvent(i10, i11));
            }

            @Override 
            public void onEndBlur(String text) {
                q.g(text, "text");
                ChatInputViewManager.this.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20697k, reactContext, chatInputRootView, new OnEndBlurEvent(text));
            }

            @Override 
            public void onFocus(int i10, int i11) {
                ChatInputViewManager.this.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20697k, reactContext, chatInputRootView, new OnFocusEvent(i10, i11, 0, 4, (DefaultConstructorMarker) null));
            }
            ...
            public void onImageInserted(Uri uri) {
                ...
                ChatInputViewManager.this.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20697k, themedReactContext, chatInputRootView2, new OnPasteImageEvent(uri2, reactContext.getContentResolver().getType(uri)));
            }

            @Override 
            public void onRequestSend() {
                ChatInputViewManager.this.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20697k, reactContext, chatInputRootView, new OnRequestSendEvent());
            }
            ...
            public void onTextOrSelectionChanged(int i10, int i11, String text, String editId) {
                q.g(text, "text");
                q.g(editId, "editId");
                ChatInputViewManager.this.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20697k, reactContext, chatInputRootView, new OnSelectionOrTextChangeEvent(i10, i11, text, editId));
            }
        });
