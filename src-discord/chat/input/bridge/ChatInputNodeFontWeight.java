...
public enum ChatInputNodeFontWeight {
    ...
    private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = n.a(p.PUBLICATION, ChatInputNodeFontWeight$Companion$$cachedSerializer$delegate$1.INSTANCE);
