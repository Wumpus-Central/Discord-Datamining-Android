...
public final class TapAction {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Lcom/discord/chat/input/bridge/TapAction$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/input/bridge/TapAction;", "chat_input_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public  TapAction(int i10, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
            n1.b(i10, 7, TapAction$$serializer.INSTANCE.getDescriptor());
        }
        this.action = str;
        this.channelId = str2;
    ...
    public static  TapAction copy$default(TapAction tapAction, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(TapAction self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 2, self.optionName);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.action, tapAction.action) && q.c(this.channelId, tapAction.channelId) && q.c(this.optionName, tapAction.optionName);
    }
