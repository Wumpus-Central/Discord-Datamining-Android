...
public final class ChatInputNode {
    ...
    public  ChatInputNode(int i10, int i11, int i12, int i13, ChatInputNodeStyle chatInputNodeStyle, boolean z10, TapAction tapAction, boolean z11, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
    ...
    public static  ChatInputNode copy$default(ChatInputNode chatInputNode, int i10, int i11, int i12, ChatInputNodeStyle chatInputNodeStyle, boolean z10, TapAction tapAction, boolean z11, int i13, Object obj) {
        if ((i13 & 1) != 0) {
    ...
    public static final void write$Self(ChatInputNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 1, self.location);
        output.w(serialDesc, 2, self.length);
        ...
        if (z10) {
            output.e(serialDesc, 3, ChatInputNodeStyle$$serializer.INSTANCE, self.style);
        }
        ...
        if (z11) {
            output.x(serialDesc, 4, self.deleteNodeOnBackspace);
        }
        ...
        if (z12) {
            output.e(serialDesc, 5, TapAction$$serializer.INSTANCE, self.tapAction);
        }
        if (output.z(serialDesc, 6) || self.editDisabled) {
            z13 = true;
        }
        if (z13) {
            output.x(serialDesc, 6, self.editDisabled);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.type == chatInputNode.type && this.location == chatInputNode.location && this.length == chatInputNode.length && q.c(this.style, chatInputNode.style) && this.deleteNodeOnBackspace == chatInputNode.deleteNodeOnBackspace && q.c(this.tapAction, chatInputNode.tapAction) && this.editDisabled == chatInputNode.editDisabled;
    }
    ...
    public  ChatInputNode(int i10, int i11, int i12, ChatInputNodeStyle chatInputNodeStyle, boolean z10, TapAction tapAction, boolean z11, int i13, DefaultConstructorMarker defaultConstructorMarker) {
