...
public final class ChatInputNodeStyle {
    ...
    public  ChatInputNodeStyle(int i10, Integer num, int i11, BackgroundStyle backgroundStyle, ChatInputNodeFontWeight chatInputNodeFontWeight, SerializationConstructorMarker serializationConstructorMarker) {
        if (6 != (i10 & 6)) {
    ...
    public static  ChatInputNodeStyle copy$default(ChatInputNodeStyle chatInputNodeStyle, Integer num, int i10, BackgroundStyle backgroundStyle, ChatInputNodeFontWeight chatInputNodeFontWeight, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(ChatInputNodeStyle self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.e(serialDesc, 0, m0.f30651a, self.fontSize);
        }
        output.w(serialDesc, 1, self.color);
        output.e(serialDesc, 2, BackgroundStyle$$serializer.INSTANCE, self.backgroundStyle);
        if (output.z(serialDesc, 3) || self.fontWeight != null) {
            z11 = true;
        }
        if (z11) {
            output.e(serialDesc, 3, ChatInputNodeFontWeight.Companion.serializer(), self.fontWeight);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.fontSize, chatInputNodeStyle.fontSize) && this.color == chatInputNodeStyle.color && q.c(this.backgroundStyle, chatInputNodeStyle.backgroundStyle) && this.fontWeight == chatInputNodeStyle.fontWeight;
    }
    ...
    public  ChatInputNodeStyle(Integer num, int i10, BackgroundStyle backgroundStyle, ChatInputNodeFontWeight chatInputNodeFontWeight, int i11, DefaultConstructorMarker defaultConstructorMarker) {
