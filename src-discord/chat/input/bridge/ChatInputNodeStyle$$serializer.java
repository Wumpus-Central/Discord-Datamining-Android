...
@Metadata(d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, d2 = {"com/discord/chat/input/bridge/ChatInputNodeStyle.$serializer", "Lxi/f0;", "Lcom/discord/chat/input/bridge/ChatInputNodeStyle;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "chat_input_release"}, k = 1, mv = {1, 8, 0})
...
public final class ChatInputNodeStyle$$serializer implements f0<ChatInputNodeStyle> {
    ...
    public ChatInputNodeStyle deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            obj3 = b10.n(descriptor2, 0, m0.f30651a, null);
            i10 = b10.i(descriptor2, 1);
            obj = b10.n(descriptor2, 2, BackgroundStyle$$serializer.INSTANCE, null);
            obj2 = b10.n(descriptor2, 3, ChatInputNodeFontWeight.Companion.serializer(), null);
            i11 = 15;
        } else {
            boolean z10 = true;
            int i12 = 0;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj4 = b10.n(descriptor2, 0, m0.f30651a, obj4);
                    i13 |= 1;
                } else if (o10 == 1) {
                    i12 = b10.i(descriptor2, 1);
                    i13 |= 2;
                } else if (o10 == 2) {
                    obj5 = b10.n(descriptor2, 2, BackgroundStyle$$serializer.INSTANCE, obj5);
                    i13 |= 4;
                } else if (o10 == 3) {
                    obj6 = b10.n(descriptor2, 3, ChatInputNodeFontWeight.Companion.serializer(), obj6);
                    i13 |= 8;
                } else {
                    throw new n(o10);
                }
    ...
    public void serialize(Encoder encoder, ChatInputNodeStyle value) {
        ...
        ChatInputNodeStyle.write$Self(value, b10, descriptor2);
        b10.c(descriptor2);
    }
