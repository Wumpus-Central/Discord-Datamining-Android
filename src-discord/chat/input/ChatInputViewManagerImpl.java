...
public final class ChatInputViewManagerImpl {
    ...
    public final ChatInputRootView createViewInstance(final ThemedReactContext reactContext) {
        ...
        ref$ObjectRef.f20712k = UIManagerHelper.getEventDispatcherForReactTag(reactContext, chatInputRootView.getId());
        chatInputRootView.setListener(new ChatInputRootView.ChatInputListener() { // from class: com.discord.chat.input.ChatInputViewManagerImpl$createViewInstance$1$1
            ...
            public void onContentSizeChange(int i10, int i11) {
                ChatInputViewManagerImpl.INSTANCE.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20712k, reactContext, chatInputRootView, new OnContentSizeChangeEvent(i10, i11));
            }

            @Override // com.discord.chat.input.views.ChatInputRootView.ChatInputListener
            public void onEndBlur(String text) {
                q.g(text, "text");
                ChatInputViewManagerImpl.INSTANCE.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20712k, reactContext, chatInputRootView, new OnEndBlurEvent(text));
            }

            @Override // com.discord.chat.input.views.ChatInputRootView.ChatInputListener
            public void onFocus(int i10, int i11) {
                ChatInputViewManagerImpl.INSTANCE.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20712k, reactContext, chatInputRootView, new OnFocusEvent(i10, i11, 0, 4, (DefaultConstructorMarker) null));
            }
            ...
            public void onImageInserted(Uri uri) {
                ...
                ChatInputViewManagerImpl.INSTANCE.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20712k, themedReactContext, chatInputRootView2, new OnPasteImageEvent(uri2, reactContext.getContentResolver().getType(uri)));
            }

            @Override // com.discord.chat.input.views.ChatInputRootView.ChatInputListener
            public void onRequestSend() {
                ChatInputViewManagerImpl.INSTANCE.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20712k, reactContext, chatInputRootView, new OnRequestSendEvent());
            }
            ...
            public void onTextOrSelectionChanged(int i10, int i11, String text, String editId) {
                q.g(text, "text");
                q.g(editId, "editId");
                ChatInputViewManagerImpl.INSTANCE.getReactEvents$chat_input_release().emitEvent(ref$ObjectRef.f20712k, reactContext, chatInputRootView, new OnSelectionOrTextChangeEvent(i10, i11, text, editId));
            }
        });
