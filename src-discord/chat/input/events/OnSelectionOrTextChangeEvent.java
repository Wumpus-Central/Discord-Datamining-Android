...
public final class OnSelectionOrTextChangeEvent implements ReactEvent {
    ...
    public  OnSelectionOrTextChangeEvent(int i10, int i11, int i12, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i10 & 15)) {
    ...
    public static  OnSelectionOrTextChangeEvent copy$default(OnSelectionOrTextChangeEvent onSelectionOrTextChangeEvent, int i10, int i11, String str, String str2, int i12, Object obj) {
        if ((i12 & 1) != 0) {
    ...
    public static final void write$Self(OnSelectionOrTextChangeEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 3, self.editId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.start == onSelectionOrTextChangeEvent.start && this.end == onSelectionOrTextChangeEvent.end && q.c(this.text, onSelectionOrTextChangeEvent.text) && q.c(this.editId, onSelectionOrTextChangeEvent.editId);
    }
