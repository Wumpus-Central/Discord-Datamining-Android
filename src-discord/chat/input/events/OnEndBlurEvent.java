...
public final class OnEndBlurEvent implements ReactEvent {
    ...
    public  OnEndBlurEvent(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  OnEndBlurEvent copy$default(OnEndBlurEvent onEndBlurEvent, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnEndBlurEvent) && q.c(this.text, ((OnEndBlurEvent) obj).text);
    }
