...
public final class OnPasteImageEvent implements ReactEvent {
    ...
    public  OnPasteImageEvent(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  OnPasteImageEvent copy$default(OnPasteImageEvent onPasteImageEvent, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(OnPasteImageEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.e(serialDesc, 1, a2.f30574a, self.type);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.url, onPasteImageEvent.url) && q.c(this.type, onPasteImageEvent.type);
    }
