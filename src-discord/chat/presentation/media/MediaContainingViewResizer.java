...
public final class MediaContainingViewResizer {
    ...
    public static  void resizeLayoutParams$default(MediaContainingViewResizer mediaContainingViewResizer, View view, int i10, int i11, int i12, int i13, ResizeMode resizeMode, int i14, Object obj) {
        if ((i14 & 16) != 0) {
