...
final class MessageBundleAdapter$onTruncateMessage$1 extends s implements Function1<MessageId, Unit> {
    ...
    public   Unit invoke(MessageId messageId) {
        m202invoke1xi1bu0(messageId.m623unboximpl());
        return Unit.f21213a;
    }

    
    public final void m202invoke1xi1bu0(String it) {
        q.h(it, "it");
    }
}
