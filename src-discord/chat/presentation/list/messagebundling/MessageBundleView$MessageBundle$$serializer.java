...
public final class MessageBundleView$MessageBundle$$serializer implements f0<MessageBundleView.MessageBundle> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{a.u(MessageFrameFeedHeaderView$MessageBundleHeader$$serializer.INSTANCE), new f(messageRow$$serializer), a.u(e0.f29783a), new f(messageRow$$serializer), a.u(a2.f29758a)};
    }
    ...
    public MessageBundleView.MessageBundle deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj2 = b10.n(descriptor2, 2, e0.f29783a, null);
            obj4 = b10.y(descriptor2, 3, new f(messageRow$$serializer), null);
            obj3 = b10.n(descriptor2, 4, a2.f29758a, null);
            i10 = 31;
        } else {
            boolean z10 = true;
            int i11 = 0;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj8 = b10.n(descriptor2, 2, e0.f29783a, obj8);
                    i11 |= 4;
                } else if (o10 == 3) {
                    obj9 = b10.y(descriptor2, 3, new f(MessageRow$$serializer.INSTANCE), obj9);
                    i11 |= 8;
                } else if (o10 == 4) {
                    obj10 = b10.n(descriptor2, 4, a2.f29758a, obj10);
                    i11 |= 16;
                } else {
                    throw new n(o10);
                }
