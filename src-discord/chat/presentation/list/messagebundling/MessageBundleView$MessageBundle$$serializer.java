...
public final class MessageBundleView$MessageBundle$$serializer implements f0<MessageBundleView.MessageBundle> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{a.u(MessageFrameFeedHeaderView$MessageBundleHeader$$serializer.INSTANCE), new f(messageRow$$serializer), a.u(e0.f26997a), new f(messageRow$$serializer), a.u(a2.f26972a)};
    }
    ...
    public MessageBundleView.MessageBundle deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj2 = c10.v(descriptor2, 2, e0.f26997a, null);
            obj4 = c10.m(descriptor2, 3, new f(messageRow$$serializer), null);
            obj3 = c10.v(descriptor2, 4, a2.f26972a, null);
            i10 = 31;
        } else {
            boolean z10 = true;
            int i11 = 0;
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj8 = c10.v(descriptor2, 2, e0.f26997a, obj8);
                    i11 |= 4;
                } else if (x10 == 3) {
                    obj9 = c10.m(descriptor2, 3, new f(MessageRow$$serializer.INSTANCE), obj9);
                    i11 |= 8;
                } else if (x10 == 4) {
                    obj10 = c10.v(descriptor2, 4, a2.f26972a, obj10);
                    i11 |= 16;
                } else {
                    throw new n(x10);
                }
