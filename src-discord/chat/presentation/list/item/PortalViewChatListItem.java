...
public final class PortalViewChatListItem extends ChatListItem {
    ...
    public  PortalViewChatListItem(String str, View view, Pair pair, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, view, (i10 & 4) != 0 ? null : pair);
    }

    
    public static  PortalViewChatListItem copy$default(PortalViewChatListItem portalViewChatListItem, String str, View view, Pair pair, int i10, Object obj) {
        if ((i10 & 1) != 0) {
