...
public final class AutomodSystemMessageItem extends ChatListItem {
    ...
    public  AutomodSystemMessageItem(Message message, MessageContext messageContext, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        Message message2;
        boolean z11;
    ...
    public AutomodSystemMessageItem(Message message, MessageContext messageContext, boolean z10) {
        super(MessageId.m630toStringimpl(message.m25getId3Eiw7ao()), null);
        q.h(message, "message");
        q.h(messageContext, "messageContext");
