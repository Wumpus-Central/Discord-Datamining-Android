...
public final class MessageBundleMessageItem extends MessageBundleItem {
    ...
    public MessageBundleMessageItem(MessageItem messageItem) {
        super(MessageId.m595toStringimpl(messageItem.getMessage().m17getId3Eiw7ao()), null);
        q.g(messageItem, "messageItem");
        this.messageItem = messageItem;
    }

    public static /* synthetic */ MessageBundleMessageItem copy$default(MessageBundleMessageItem messageBundleMessageItem, MessageItem messageItem, int i10, Object obj) {
        if ((i10 & 1) != 0) {
