...
public final class MessageBundleConversationItem extends MessageBundleItem {
    ...
    public MessageBundleConversationItem(MessageItem messageItem) {
        super(MessageId.m611toStringimpl(messageItem.getMessage().m17getId3Eiw7ao()), null);
        q.h(messageItem, "messageItem");
        this.messageItem = messageItem;
    }

    public static  MessageBundleConversationItem copy$default(MessageBundleConversationItem messageBundleConversationItem, MessageItem messageItem, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof MessageBundleConversationItem) && q.c(this.messageItem, ((MessageBundleConversationItem) obj).messageItem);
    }
