    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(b.f24757f);
                this.mMaxSwipeVelocity = resources.getDimension(b.f24756e);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder != this.mSelected || i10 != this.mActionState) {
            ...
            if (viewHolder2 != null) {
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    float f12 = fArr[0];
                    float f13 = fArr[1];
                    RecoverAnimation recoverAnimation = new RecoverAnimation(viewHolder2, i13, i11, f12, f13, f11, f10) { 
                        @Override 
                        public void onAnimationEnd(Animator animator) {
