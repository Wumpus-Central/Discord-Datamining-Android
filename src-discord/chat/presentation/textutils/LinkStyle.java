...
public final class LinkStyle {
    ...
    public static  LinkStyle copy$default(LinkStyle linkStyle, DiscordFont discordFont, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public  LinkStyle(DiscordFont discordFont, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
