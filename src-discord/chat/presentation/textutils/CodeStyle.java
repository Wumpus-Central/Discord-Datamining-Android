...
public final class CodeStyle {
    ...
    private static final CodeStyleProviders<RenderContext> staticCodeStyles = new CodeStyleProviders<>(null, null, new StyleNode.SpanProvider() { 
        @Override 
    ...
    private final List<Node<RenderContext>> generateAst(CodeBlockContentNode codeBlockContentNode) {
        ...
        try {
            s.a aVar = s.f21220k;
            list = s.b(Parser.parse$default(getParser(), str, Unit.f21442a, null, 4, null));
        } catch (Throwable th2) {
            s.a aVar2 = s.f21220k;
            list = s.b(t.a(th2));
        }
    ...
    private final Parser<RenderContext, Node<RenderContext>, Object> getParser() {
        ...
        q.g(simpleName, "Theme::class.java.simpleName");
        Parser<RenderContext, Node<RenderContext>, Object> parser = map.get(simpleName);
        if (parser == null) {
            copy = r3.copy((r18 & 1) != 0 ? r3.defaultStyleProvider : new StyleNode.SpanProvider() { 
                @Override 
                public final Iterable get(Object obj) {
            ...
            }, (r18 & 2) != 0 ? r3.commentStyleProvider : new StyleNode.SpanProvider() { 
                @Override 
                public final Iterable get(Object obj) {
