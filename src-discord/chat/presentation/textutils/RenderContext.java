...
public final class RenderContext {
    ...
    public final RenderContext copy(Context context, String containerId, Function1<? super LinkContentNode, Unit> onTapLink, Function1<? super LinkContentNode, Unit> onLongTapLink, Function1<? super LinkContentNode, LinkStyle> linkStyle, Function3<? super String, ? super String, ? super String, Unit> onTapChannel, Function4<? super String, ? super String, ? super String, ? super String, Unit> onLongPressChannel, Function2<? super String, ? super String, Unit> onTapMention, Function1<? super CommandMentionContentNode, Unit> onTapCommand, Function1<? super CommandMentionContentNode, Unit> onLongPressCommand, Function0<Unit> onTapSpoiler, Function1<? super String, Unit> onTapTimestamp, Function1<? super EmojiContentNode, Unit> onTapEmoji, boolean z10, boolean z11, boolean z12, boolean z13, Paint paint, SpoilerState spoilerState, int i10, Long l10, Long l11, Insets insets, DiscordTheme theme, float f10, Integer num) {
        ...
        q.h(insets, "insets");
        q.h(theme, "theme");
        return new RenderContext(context, containerId, onTapLink, onLongTapLink, linkStyle, onTapChannel, onLongPressChannel, onTapMention, onTapCommand, onLongPressCommand, onTapSpoiler, onTapTimestamp, onTapEmoji, z10, z11, z12, z13, paint, spoilerState, i10, l10, l11, insets, theme, f10, num);
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((i22 + i10) * 31) + this.paint.hashCode()) * 31) + this.spoilerState.hashCode()) * 31) + this.listNestedLevel) * 31;
    ...
    public String toString() {
        ...
        Integer num = this.emojiSizeOverride;
        return "RenderContext(context=" + context + ", containerId=" + str + ", onTapLink=" + function1 + ", onLongTapLink=" + function12 + ", linkStyle=" + function13 + ", onTapChannel=" + function3 + ", onLongPressChannel=" + function4 + ", onTapMention=" + function2 + ", onTapCommand=" + function14 + ", onLongPressCommand=" + function15 + ", onTapSpoiler=" + function0 + ", onTapTimestamp=" + function16 + ", onTapEmoji=" + function17 + ", animateEmoji=" + z10 + ", shouldShowRoleDot=" + z11 + ", shouldShowRoleOnName=" + z12 + ", singleLine=" + z13 + ", paint=" + paint + ", spoilerState=" + spoilerState + ", listNestedLevel=" + i10 + ", listOrderedIndex=" + l10 + ", listLargestOrderedIndex=" + l11 + ", insets=" + insets + ", theme=" + discordTheme + ", baselineHeight=" + f10 + ", emojiSizeOverride=" + num + ")";
    }
    ...
    public  RenderContext(Context context, String str, Function1 function1, Function1 function12, Function1 function13, Function3 function3, Function4 function4, Function2 function2, Function1 function14, Function1 function15, Function0 function0, Function1 function16, Function1 function17, boolean z10, boolean z11, boolean z12, boolean z13, Paint paint, SpoilerState spoilerState, int i10, Long l10, Long l11, Insets insets, DiscordTheme discordTheme, float f10, Integer num, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, function1, function12, function13, function3, function4, function2, function14, function15, function0, function16, function17, z10, z11, z12, z13, paint, (i11 & 262144) != 0 ? SpoilerState.None : spoilerState, (i11 & 524288) != 0 ? 0 : i10, (i11 & 1048576) != 0 ? null : l10, (i11 & 2097152) != 0 ? null : l11, (i11 & 4194304) != 0 ? new Insets(0, 0, 0, 0, 15, null) : insets, discordTheme, (i11 & 16777216) != 0 ? -1.0f : f10, (i11 & 33554432) != 0 ? null : num);
    }
}
