...
public final class MessageComponentsViewHolder extends MessagePartViewHolder implements ComponentActionListener {
    ...
    private String messageId = MessageId.m590constructorimpl("0");
    ...
    public void mo318onTapButtonActionComponenty43Yjpg(String str, long j10, List<Integer> indices) {
        int[] C0;
        q.g(indices, "indices");
        ...
        C0 = r.C0(indices);
        chatEventHandler.mo160onTapButtonActionComponentNkFJqEg(str2, j11, str, j10, C0);
    }

    @Override // com.discord.chat.presentation.message.view.botuikit.ComponentActionListener
    public void onTapSelectActionComponent(SelectComponent selectComponent) {
        q.g(selectComponent, "selectComponent");
        this.eventHandler.mo173onTapSelectActionComponentu7_MRrM(this.messageId, this.messageFlags, selectComponent);
    }
    ...
    public final void m337setMessageId1xi1bu0(String str) {
        q.g(str, "<set-?>");
        this.messageId = str;
    }
}
