...
public  class EmbedViewHolder$bind$1 extends n implements Function3<MessageId, String, String, Unit> {
    ...
    public   Unit invoke(MessageId messageId, String str, String str2) {
        m353invokeu7_MRrM(messageId.m639unboximpl(), str, str2);
        return Unit.f21444a;
    }

    
    public final void m353invokeu7_MRrM(String p02, String p12, String str) {
        q.h(p02, "p0");
        q.h(p12, "p1");
        ((ChatEventHandler) this.receiver).mo161onLinkClickedu7_MRrM(p02, p12, str);
    }
}
