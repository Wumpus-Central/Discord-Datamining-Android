...
public final class EmbeddedActivityInviteViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$1$lambda$0(EmbeddedActivityInviteViewHolder this$0, EmbeddedActivityInviteMessageAccessory embeddedActivityInviteAccessory, View view) {
        ...
        this$0.eventHandler.mo157onTapInviteEmbedAFFcxXc(embeddedActivityInviteAccessory.mo206getMessageId3Eiw7ao(), embeddedActivityInviteAccessory.getCodedLinkIndex(), null, null);
    }
    ...
    public final void bind(final EmbeddedActivityInviteMessageAccessory embeddedActivityInviteAccessory) {
        ...
        embeddedActivityInviteView.m296setSubtitleTextSAQFhFE(embeddedActivityInviteEmbed.getStructurableSubtitleText(), embeddedActivityInviteAccessory.mo206getMessageId3Eiw7ao(), new EmbeddedActivityInviteViewHolder$bind$1$1(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$2(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$3(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$4(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$5(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$6(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$7(this.eventHandler), EmbeddedActivityInviteViewHolder$bind$1$11.INSTANCE, new EmbeddedActivityInviteViewHolder$bind$1$8(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$9(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$10(this.eventHandler));
        ...
        embeddedActivityInviteView.setOnLaunchButtonClickListener(new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.e
