...
public final class PostPreviewEmbedViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$0(Function4 onTapPostPreviewEmbed, PostPreviewEmbed postPreviewEmbed, View view) {
        ...
        onTapPostPreviewEmbed.invoke(GuildId.m578boximpl(postPreviewEmbed.m112getGuildIdfYKD8eg()), ChannelId.m565boximpl(postPreviewEmbed.m114getParentChannelIdo4g7jtM()), ChannelId.m565boximpl(postPreviewEmbed.m115getThreadIdo4g7jtM()), MessageId.m591boximpl(postPreviewEmbed.m113getMessageId3Eiw7ao()));
    }
    ...
    public final void bind(final PostPreviewEmbed postPreviewEmbed, final Function4<? super GuildId, ? super ChannelId, ? super ChannelId, ? super MessageId, Unit> onTapPostPreviewEmbed, SpoilerConfig spoilerConfig) {
        ...
        postPreviewEmbedView.m318setPostPreviewEmbedOGpb6Gk(title, subtitle, ctaText, ctaButtonColor, postPreviewEmbed.getFooter(), postPreviewEmbed.m113getMessageId3Eiw7ao(), coverImage, blurredCoverImage, postPreviewEmbed.getCoverImageOverlayText(), postPreviewEmbed.getBackgroundImage(), new View.OnClickListener() { 
            @Override 
