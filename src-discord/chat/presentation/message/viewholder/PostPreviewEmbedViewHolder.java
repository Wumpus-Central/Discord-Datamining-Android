...
public final class PostPreviewEmbedViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$0(Function4 onTapPostPreviewEmbed, PostPreviewEmbed postPreviewEmbed, View view) {
        ...
        onTapPostPreviewEmbed.invoke(GuildId.m594boximpl(postPreviewEmbed.m113getGuildIdfYKD8eg()), ChannelId.m581boximpl(postPreviewEmbed.m115getParentChannelIdo4g7jtM()), ChannelId.m581boximpl(postPreviewEmbed.m116getThreadIdo4g7jtM()), MessageId.m607boximpl(postPreviewEmbed.m114getMessageId3Eiw7ao()));
    }
    ...
    public final void bind(final PostPreviewEmbed postPreviewEmbed, final Function4<? super GuildId, ? super ChannelId, ? super ChannelId, ? super MessageId, Unit> onTapPostPreviewEmbed, SpoilerConfig spoilerConfig) {
        ...
        postPreviewEmbedView.m327setPostPreviewEmbedOGpb6Gk(title, subtitle, ctaText, ctaButtonColor, postPreviewEmbed.getFooter(), postPreviewEmbed.m114getMessageId3Eiw7ao(), coverImage, blurredCoverImage, postPreviewEmbed.getCoverImageOverlayText(), postPreviewEmbed.getBackgroundImage(), new View.OnClickListener() { 
            @Override 
