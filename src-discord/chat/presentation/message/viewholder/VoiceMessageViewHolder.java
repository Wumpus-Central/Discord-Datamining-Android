...
public final class VoiceMessageViewHolder extends MessagePartViewHolder {
    ...
    public final void bind(final AudioAttachmentMessageAccessory accessory, final ChatEventHandler eventHandler, Float f10) {
        ...
        if (waveformByteArray != null && (durationSecs = attachment.getDurationSecs()) != null) {
            ...
            audioPlayerView.m334setSourceUrlntcYbpo(accessory.mo222getMessageId3Eiw7ao(), accessory.getAttachment().getUrl());
            ...
            audioPlayerView.setListener(new AudioPlayerView.Listener() { 
                ...
                public void voiceMessagePlaybackEnded(float f11, float f12) {
                    ...
                    String str = accessory.mo222getMessageId3Eiw7ao();
                    float f13 = floatValue;
                    UserId userId = accessory.m230getAuthorIdwUX8bhU();
                    if (userId != null) {
                        chatEventHandler.mo183voiceMessagePlaybackEndedHuwN0RY(str, f13, f11, userId.m654unboximpl(), f12);
                    }
                }

                @Override 
                public void voiceMessagePlaybackFailed(String str) {
                    ChatEventHandler.this.mo184voiceMessagePlaybackFailedntcYbpo(accessory.mo222getMessageId3Eiw7ao(), str);
                }
                ...
                public void voiceMessagePlaybackStarted(float f11) {
                    ...
                    UserId userId = accessory.m230getAuthorIdwUX8bhU();
                    if (userId != null) {
                        chatEventHandler.mo185voiceMessagePlaybackStartedOuNwOLg(str, f12, f11, userId.m654unboximpl());
                    }
                }
            });
        }
