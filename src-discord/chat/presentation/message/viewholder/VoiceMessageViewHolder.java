...
public final class VoiceMessageViewHolder extends MessagePartViewHolder {
    ...
    public final void bind(final AudioAttachmentMessageAccessory accessory, final ChatEventHandler eventHandler, Float f10) {
        ...
        if (waveformByteArray != null && (durationSecs = attachment.getDurationSecs()) != null) {
            ...
            audioPlayerView.m360setSourceUrlntcYbpo(accessory.mo240getMessageId3Eiw7ao(), accessory.getAttachment().getUrl());
            ...
            audioPlayerView.setListener(new AudioPlayerView.Listener() { 
                ...
                public void voiceMessagePlaybackEnded(float f11, float f12) {
                    ...
                    String str = accessory.mo240getMessageId3Eiw7ao();
                    float f13 = floatValue;
                    UserId userId = accessory.m248getAuthorIdwUX8bhU();
                    if (userId != null) {
                        chatEventHandler.mo200voiceMessagePlaybackEndedHuwN0RY(str, f13, f11, userId.m690unboximpl(), f12);
                    }
                }

                @Override 
                public void voiceMessagePlaybackFailed(String str) {
                    ChatEventHandler.this.mo201voiceMessagePlaybackFailedntcYbpo(accessory.mo240getMessageId3Eiw7ao(), str);
                }
                ...
                public void voiceMessagePlaybackStarted(float f11) {
                    ...
                    UserId userId = accessory.m248getAuthorIdwUX8bhU();
                    if (userId != null) {
                        chatEventHandler.mo202voiceMessagePlaybackStartedOuNwOLg(str, f12, f11, userId.m690unboximpl());
                    }
                }
            });
        }
