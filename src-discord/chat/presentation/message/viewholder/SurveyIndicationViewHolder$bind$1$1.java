...
public /* synthetic */ class SurveyIndicationViewHolder$bind$1$1 extends n implements Function2<MessageId, LinkContentNode, Unit> {
    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId, LinkContentNode linkContentNode) {
        m341invokentcYbpo(messageId.m598unboximpl(), linkContentNode);
        return Unit.f20717a;
    }

    /* renamed from: invoke-ntcYbpo  reason: not valid java name */
    public final void m341invokentcYbpo(String p02, LinkContentNode p12) {
        q.g(p02, "p0");
        q.g(p12, "p1");
