...
public final class EmbedViewHolder extends MessagePartViewHolder {
    ...
    public final void bind(EmbedMessageAccessory accessory, int i10, int i11, Function0<Unit> onTapSpoiler, SpoilerConfig spoilerConfig, Function2<? super Double, ? super Integer, Unit> onMediaClicked, View.OnLongClickListener onLongClickListener, double d10) {
        ...
        this.embedView.m305setEmbedlKx2FiY(accessory.getEmbed(), accessory.mo216getMessageId3Eiw7ao(), accessory.getConstrainedWidth(), i10, i11, accessory.getShouldAutoPlayGifs(), accessory.getShouldAnimateEmoji(), accessory.getShouldShowRoleDot(), accessory.getShouldShowRoleOnName(), new EmbedViewHolder$bind$1(this.eventHandler), new EmbedViewHolder$bind$2(this.eventHandler), onMediaClicked, onLongClickListener, new EmbedViewHolder$bind$3(this.eventHandler), new EmbedViewHolder$bind$4(this.eventHandler), new EmbedViewHolder$bind$5(this.eventHandler), onTapSpoiler, new EmbedViewHolder$bind$6(this.eventHandler), new EmbedViewHolder$bind$7(this.eventHandler), new EmbedViewHolder$bind$8(this.eventHandler), new EmbedViewHolder$bind$9(this.eventHandler), spoilerConfig, d10);
    }
}
