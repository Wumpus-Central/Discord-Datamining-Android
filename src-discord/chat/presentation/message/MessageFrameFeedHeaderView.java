...
public final class MessageFrameFeedHeaderView extends ConstraintLayout {
    ...
    public static final class MessageBundleHeader {
        ...
        public  MessageBundleHeader(int i10, String str, String str2, ArrayList arrayList, String str3, SerializationConstructorMarker serializationConstructorMarker) {
            if ((i10 & 0) != 0) {
        ...
        public static  MessageBundleHeader copy$default(MessageBundleHeader messageBundleHeader, String str, String str2, ArrayList arrayList, String str3, int i10, Object obj) {
            if ((i10 & 1) != 0) {
        ...
        public static final void write$Self(MessageBundleHeader self, CompositeEncoder output, SerialDescriptor serialDesc) {
            ...
            if (z10) {
                output.B(serialDesc, 0, a2.f29764a, self.channelIconURL);
            }
            ...
            if (z11) {
                output.B(serialDesc, 1, a2.f29764a, self.chatIconURL);
            }
            ...
            if (z12) {
                output.B(serialDesc, 2, new wi.f(a2.f29764a), self.avatarURLs);
            }
            if (output.z(serialDesc, 3) || self.channelName != null) {
                z13 = true;
            }
            if (z13) {
                output.B(serialDesc, 3, a2.f29764a, self.channelName);
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            return q.c(this.channelIconURL, messageBundleHeader.channelIconURL) && q.c(this.chatIconURL, messageBundleHeader.chatIconURL) && q.c(this.avatarURLs, messageBundleHeader.avatarURLs) && q.c(this.channelName, messageBundleHeader.channelName);
        }
        ...
        public  MessageBundleHeader(String str, String str2, ArrayList arrayList, String str3, int i10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public  MessageFrameFeedHeaderView(Context context, AttributeSet attributeSet, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public MessageFrameFeedHeaderView(Context context, AttributeSet attributeSet, int i10) {
        ...
        q.g(simpleDraweeView, "binding.feedChannelIcon");
        ...
        q.g(simpleDraweeView2, "binding.feedReplyIcon");
