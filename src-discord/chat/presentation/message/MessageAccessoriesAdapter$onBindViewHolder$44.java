...
public  class MessageAccessoriesAdapter$onBindViewHolder$44 extends n implements Function2<MessageId, ChannelId, Unit> {
    ...
    public   Unit invoke(MessageId messageId, ChannelId channelId) {
        m225invokepfaIj0E(messageId.m651unboximpl(), channelId.m626unboximpl());
        return Unit.f21601a;
    }

    
    public final void m225invokepfaIj0E(String p02, long j10) {
        q.h(p02, "p0");
        ((ChatEventHandler) this.receiver).mo171onTapAutoModerationActionspfaIj0E(p02, j10);
    }
}
