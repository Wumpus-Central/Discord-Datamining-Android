...
public final class MessageAccessoriesAdapter$onBindViewHolder$28 extends s implements Function1<ReactionView.Reaction, Unit> {
    final  MessageAccessoriesAdapter this$0;

    
    
    public MessageAccessoriesAdapter$onBindViewHolder$28(MessageAccessoriesAdapter messageAccessoriesAdapter) {
        super(1);
    ...
    public final void invoke2(ReactionView.Reaction reaction) {
        ...
        q.e(channelId);
        chatEventHandler.mo166onLongPressReactionEqy5D80(str, channelId.m626unboximpl(), reaction);
    }
}
