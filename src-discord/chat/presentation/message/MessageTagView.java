...
public final class MessageTagView extends FrameLayout {
    ...
    public static final void configureTagView_e_CJZyo$lambda$0(ChatEventHandler eventHandler, String messageId, long j10, String str, View view) {
        ...
        eventHandler.mo175onTapTagEqy5D80(messageId, j10, str);
    }
    ...
    public final void m209configureTagVieweCJZyo(String str, Boolean bool, Integer num, Integer num2, String str2, final ChatEventHandler eventHandler, final String messageId, final long j10, final String str3) {
        int i10;
        q.g(eventHandler, "eventHandler");
        q.g(messageId, "messageId");
        int i11 = 0;
        if (str != null) {
            ...
            NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(constraintLayout4, false, new View.OnClickListener() { // from class: com.discord.chat.presentation.message.k
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
