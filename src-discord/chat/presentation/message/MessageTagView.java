...
public final class MessageTagView extends FrameLayout {
    ...
    public static final void configureTagView_e_CJZyo$lambda$0(ChatEventHandler eventHandler, String messageId, long j10, String str, View view) {
        ...
        eventHandler.mo191onTapTagEqy5D80(messageId, j10, str);
    }
    ...
    public final void m231configureTagVieweCJZyo(String str, Boolean bool, Integer num, Integer num2, String str2, final ChatEventHandler eventHandler, final String messageId, final long j10, final String str3) {
        int i10;
        q.h(eventHandler, "eventHandler");
        q.h(messageId, "messageId");
        int i11 = 0;
