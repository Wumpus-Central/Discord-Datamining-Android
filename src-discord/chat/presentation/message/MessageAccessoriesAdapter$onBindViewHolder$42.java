...
public  class MessageAccessoriesAdapter$onBindViewHolder$42 extends n implements Function2<MessageId, ChannelId, Unit> {
    ...
    public   Unit invoke(MessageId messageId, ChannelId channelId) {
        m219invokepfaIj0E(messageId.m644unboximpl(), channelId.m619unboximpl());
        return Unit.f21600a;
    }

    
    public final void m219invokepfaIj0E(String p02, long j10) {
        q.h(p02, "p0");
        ((ChatEventHandler) this.receiver).mo167onTapAutoModerationActionspfaIj0E(p02, j10);
    }
}
