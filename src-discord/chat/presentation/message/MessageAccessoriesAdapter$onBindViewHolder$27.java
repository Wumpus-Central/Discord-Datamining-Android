...
public final class MessageAccessoriesAdapter$onBindViewHolder$27 extends s implements Function1<ReactionView.Reaction, Unit> {
    ...
    public final void invoke2(ReactionView.Reaction reaction) {
        ...
        q.e(str);
        ChatEventHandler.DefaultImpls.m205onTapReactionu7_MRrM$default(chatEventHandler, str, reaction, null, 4, null);
    }
}
