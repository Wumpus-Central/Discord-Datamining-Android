...
public final class CallSystemMessageView$setMessage$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                t.b(obj);
                a.C0287a aVar = a.f20587l;
                final Flow<Unit> flow = IntervalFlowKt.m468intervalFlowQTBD994(c.s(1, ki.d.SECONDS), a.f20587l.b());
                ...
                FlowCollector flowCollector = new FlowCollector() { 
                    ...
                    public   Object emit(Object obj2, Continuation continuation) {
                        return m304emitVtjQ1oo(((a) obj2).K(), continuation);
                    }

                    
                    public final Object m304emitVtjQ1oo(long j11, Continuation<? super Unit> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CallSystemMessageView$setMessage$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f20670a);
    }
