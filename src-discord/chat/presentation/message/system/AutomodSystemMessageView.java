...
public final class AutomodSystemMessageView extends ConstraintLayout implements VerticalSpacingItemDecoration.SpacingProviderView, SpineParentMessage {
    ...
    private final void configureAuthor(Message message, final AutoModerationContext autoModerationContext, final ChatEventHandler chatEventHandler) {
        ...
        this.binding.messageTagView.m228configureTagVieweCJZyo(autoModerationContext.getHeaderBadgeText(), Boolean.FALSE, null, null, null, chatEventHandler, message.m25getId3Eiw7ao(), message.m23getChannelIdo4g7jtM(), message.getTagType());
        ...
        NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(configureAuthor$lambda$8, false, new View.OnClickListener() { 
            @Override 
    ...
    public static final void configureAuthor$lambda$8$lambda$7(ChatEventHandler eventHandler, AutoModerationContext automodContext, View view) {
        ...
        String str2 = ChannelId.m605toStringimpl(automodContext.getMessage().m33getChannelIdo4g7jtM());
        GuildId guildId = automodContext.getMessage().m34getGuildIdqOKuAAo();
        if (guildId != null) {
            str = GuildId.m618toStringimpl(guildId.m620unboximpl());
        } else {
            str = null;
        }
    ...
    private final List<MessageAccessory> generateMessageAccessories(Message message, MessageContext messageContext) {
        ...
        String str = message2.m35getId3Eiw7ao();
        long j10 = message2.m33getChannelIdo4g7jtM();
        GuildId guildId = message2.m34getGuildIdqOKuAAo();
        UserId userId = message2.m36getUserIdwUX8bhU();
        ...
        Message message3 = new Message(messageType, str, (String) null, j10, guildId, (MessageState) null, userId, 0L, (String) null, (Float) null, (String) null, username, Integer.valueOf(usernameColor), roleColor, shouldShowRoleDot, false, (Integer) null, avatarURL, (String) null, (List) null, (List) null, (Float) null, content, (List) null, (List) null, (Boolean) null, (List) null, (List) null, message.getRoleIcon(), (ConnectionsRoleTag) null, (ThreadEmbed) null, false, (Boolean) null, (Boolean) null, (ReferencedMessage) null, (ExecutedCommand) null, (List) null, (String) null, Boolean.valueOf(z10), (String) null, (Boolean) null, (Integer) null, (Integer) null, (String) null, (String) null, (Boolean) null, (Integer) null, (Integer) null, (EphemeralIndication) null, (SurveyIndication) null, (InteractionStatus) null, (Boolean) null, (Boolean) null, (Boolean) null, (String) null, (String) null, (List) null, (Boolean) null, (Boolean) null, (Long) null, (Sticker) null, (String) null, (String) null, (Boolean) null, (ActivityInviteEmbed) null, false, (ForumPostActions) null, autoModerationContext, (List) null, (GiftEmbed) null, (Integer) null, (List) null, (ChannelPromptData) null, 1874692004, -65, 503, (DefaultConstructorMarker) null);
        if (autoModerationContext.getNotification() != null) {
            this.accessories.add(new AutoModerationNotificationEmbedAccessory(message3.m25getId3Eiw7ao(), message, autoModerationContext, null));
        } else {
            this.accessories.add(new FlaggedMessageEmbedAccessory(message3.m25getId3Eiw7ao(), message3, messageContext, null));
            this.accessories.add(new FlaggedMessageActionBarAccessory(message3.m25getId3Eiw7ao(), message, autoModerationContext, null));
        }
    ...
    public static  void setMessage$default(AutomodSystemMessageView automodSystemMessageView, Message message, MessageContext messageContext, ChatEventHandler chatEventHandler, ComponentProvider componentProvider, boolean z10, int i10, Object obj) {
        if ((i10 & 4) != 0) {
    ...
    public final void setMessage(Message message, MessageContext messageContext, ChatEventHandler eventHandler, ComponentProvider componentProvider, boolean z10) {
        ...
        if (autoModerationContext != null) {
            ...
            this.binding.accessoriesView.m226setAccessoriesRC8ZMxU(message.m25getId3Eiw7ao(), message.m23getChannelIdo4g7jtM(), message.m24getGuildIdqOKuAAo(), generateMessageAccessories(message, messageContext), eventHandler, componentProvider);
        }
    }
