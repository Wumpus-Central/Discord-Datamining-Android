...
public /* synthetic */ class MessageAccessoriesAdapter$onBindViewHolder$29 extends n implements Function1<MessageId, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId) {
        m190invoke1xi1bu0(messageId.m588unboximpl());
        return Unit.f22111a;
    }

    /* renamed from: invoke-1xi1bu0  reason: not valid java name */
    public final void m190invoke1xi1bu0(String p02) {
        q.g(p02, "p0");
        ((ChatEventHandler) this.receiver).mo168onTapThreadEmbed1xi1bu0(p02);
    }
}
