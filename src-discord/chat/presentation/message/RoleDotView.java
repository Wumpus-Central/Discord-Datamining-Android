...
public final class RoleDotView extends FrameLayout {
    ...
    public static  void configure$default(RoleDotView roleDotView, int i10, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = 20;
        }
    ...
    public  RoleDotView(Context context, AttributeSet attributeSet, int i10, DefaultConstructorMarker defaultConstructorMarker) {
