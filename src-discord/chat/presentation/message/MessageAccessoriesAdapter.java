...
public final class MessageAccessoriesAdapter extends RecyclerView.Adapter<MessagePartViewHolder> {
    ...
    public static final void onBindViewHolder$lambda$0(MessageAccessory part, MessageAccessoriesAdapter this$0, MessagePartViewHolder holder, View view) {
        ...
        q.g(this$0, "this$0");
        q.g(holder, "$holder");
        this$0.m187onMediaClickedl3ndGo(holder, part.mo206getMessageId3Eiw7ao(), ((ImageAttachmentMessageAccessory) part).getAttachmentIndex(), "attachment", null, null, ViewResizeMode.Fill);
    }
    ...
    public static final void onBindViewHolder$lambda$1(MessageAccessoriesAdapter this$0, View view) {
        ...
        q.d(str);
        ChatEventHandler.DefaultImpls.m177onTapReactionu7_MRrM$default(chatEventHandler, str, null, null, 4, null);
    }
    ...
    public static final void onBindViewHolder$lambda$3(MessageAccessoriesAdapter this$0, View view) {
        ...
        q.d(channelId);
        chatEventHandler.mo155onTapFollowForumPostpfaIj0E(str, channelId.m563unboximpl());
    }
    ...
    public static final void onBindViewHolder$lambda$4(MessageAccessoriesAdapter this$0, View view) {
        ...
        q.d(guildId);
        chatEventHandler.mo166onTapShareForumPostmgk6anA(j10, guildId.m576unboximpl());
    }
    ...
    public static final void onBindViewHolder$lambda$6(MessageAccessoriesAdapter this$0, View view) {
        ...
        ChannelId channelId = this$0.channelId;
        q.d(channelId);
        chatEventHandler.mo163onTapReactionOverflowpfaIj0E(str, channelId.m563unboximpl());
    }
    ...
    public final void m187onMediaClickedl3ndGo(MessagePartViewHolder messagePartViewHolder, String str, int i10, String str2, Double d10, Integer num, ViewResizeMode viewResizeMode) {
    ...
    public final void m188setItemsbo5iIEc(String messageId, long j10, GuildId guildId, List<? extends MessageAccessory> items) {
        q.g(messageId, "messageId");
        q.g(items, "items");
        this.messageId = messageId;
        this.channelId = ChannelId.m554boximpl(j10);
    ...
    public void onBindViewHolder(final MessagePartViewHolder holder, int i10) {
        ...
        if (messageAccessory instanceof EmbedMessageAccessory) {
            ...
            String str = messageAccessory.mo206getMessageId3Eiw7ao();
            ReactionsMessageAccessory reactionsMessageAccessory = (ReactionsMessageAccessory) messageAccessory;
            ((ReactionsViewHolder) holder).m330bindoSm889w(str, reactionsMessageAccessory.getReactions(), reactionsMessageAccessory.getCanAddNewReactions(), reactionsMessageAccessory.getCanAddNewBurstReactions(), reactionsMessageAccessory.getAddReactionLabel(), reactionsMessageAccessory.getAddNewReactionAccessibilityLabel(), reactionsMessageAccessory.getAddNewBurstReactionAccessibilityLabel(), reactionsMessageAccessory.getReactionsTheme(), new View.OnClickListener() { // from class: com.discord.chat.presentation.message.c
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        ForceExhaustiveKt.forceExhaustive(Unit.f22111a);
    }
