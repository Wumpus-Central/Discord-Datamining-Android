...
public /* synthetic */ class MessageAccessoriesAdapter$onBindViewHolder$37 extends n implements Function2<MessageId, LinkContentNode, Unit> {
    /* JADX INFO: Access modifiers changed from: package-private */
    public MessageAccessoriesAdapter$onBindViewHolder$37(Object obj) {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(MessageId messageId, LinkContentNode linkContentNode) {
        m199invokentcYbpo(messageId.m598unboximpl(), linkContentNode);
        return Unit.f20663a;
    }

    /* renamed from: invoke-ntcYbpo  reason: not valid java name */
    public final void m199invokentcYbpo(String p02, LinkContentNode p12) {
        q.g(p02, "p0");
        q.g(p12, "p1");
