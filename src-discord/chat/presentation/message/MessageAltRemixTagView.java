...
public final class MessageAltRemixTagView extends FrameLayout {
    ...
    public final void m224configureTagViewe2j04IU(String str, Integer num, Integer num2, final ChatEventHandler eventHandler, final String messageId, final long j10, final String str2) {
        int i10;
        int i11;
        q.h(eventHandler, "eventHandler");
        q.h(messageId, "messageId");
