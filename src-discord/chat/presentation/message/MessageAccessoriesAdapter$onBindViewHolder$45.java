...
public  class MessageAccessoriesAdapter$onBindViewHolder$45 extends n implements Function1<MessageId, Unit> {
    ...
    public   Unit invoke(MessageId messageId) {
        m218invoke1xi1bu0(messageId.m623unboximpl());
        return Unit.f21213a;
    }

    
    public final void m218invoke1xi1bu0(String p02) {
        q.h(p02, "p0");
        ((ChatEventHandler) this.receiver).mo175onTapJoinActivity1xi1bu0(p02);
    }
}
