...
public final class MessageAccessoriesAdapter$onBindViewHolder$40 extends s implements Function2<String, String, Unit> {
    ...
    public final void invoke2(String url, String filename) {
        ...
        q.e(str);
        chatEventHandler.mo160onLinkClickedu7_MRrM(str, url, filename);
    }
}
