...
public final class MessageAccessoriesAdapter$onBindViewHolder$20 extends s implements Function1<Double, Unit> {
    ...
    public final void invoke2(Double d10) {
        this.this$0.m198onMediaClickedl3ndGo(this.$holder, this.$part.mo220getMessageId3Eiw7ao(), ((VideoAttachmentMessageAccessory) this.$part).getIndex(), "attachment", d10, null, ViewResizeMode.Fill);
    }
}
