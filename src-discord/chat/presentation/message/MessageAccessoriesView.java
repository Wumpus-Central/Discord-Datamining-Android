...
public final class MessageAccessoriesView extends RecyclerView {
    ...
    public final void m215setAccessoriesRC8ZMxU(String messageId, long j10, GuildId guildId, List<? extends MessageAccessory> items, ChatEventHandler eventHandler, ComponentProvider componentProvider) {
        ...
        this.accessoriesAdapter.m201setItemsbo5iIEc(messageId, j10, guildId, items);
    }
