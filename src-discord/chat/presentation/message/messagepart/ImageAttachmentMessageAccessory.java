...
public final class ImageAttachmentMessageAccessory extends MessageAccessory {
    ...
    public final ImageAttachmentMessageAccessory m261copyIwdeaXA(String messageId, int i10, Attachment attachment, int i11, int i12, SpoilerAttributes spoilerAttributes, View.OnLongClickListener onLongClickListener, boolean z10, Float f10) {
    ...
    public int hashCode() {
        int i10 = ((((((((MessageId.m593hashCodeimpl(mo214getMessageId3Eiw7ao()) * 31) + this.attachmentIndex) * 31) + this.attachment.hashCode()) * 31) + this.constrainedWidth) * 31) + this.radiusPx) * 31;
