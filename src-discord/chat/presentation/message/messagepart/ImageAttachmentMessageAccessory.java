...
public final class ImageAttachmentMessageAccessory extends MessageAccessory {
    ...
    public final ImageAttachmentMessageAccessory m269copyJJXpD5M(String messageId, int i10, Attachment attachment, int i11, int i12, SpoilerAttributes spoilerAttributes, View.OnLongClickListener onLongClickListener, boolean z10, Float f10, boolean z11, boolean z12, Integer num, Integer num2) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m611equalsimpl0(mo222getMessageId3Eiw7ao(), imageAttachmentMessageAccessory.mo222getMessageId3Eiw7ao()) && this.attachmentIndex == imageAttachmentMessageAccessory.attachmentIndex && q.c(this.attachment, imageAttachmentMessageAccessory.attachment) && this.constrainedWidth == imageAttachmentMessageAccessory.constrainedWidth && this.radiusPx == imageAttachmentMessageAccessory.radiusPx && q.c(this.spoilerAttributes, imageAttachmentMessageAccessory.spoilerAttributes) && q.c(this.onLongClick, imageAttachmentMessageAccessory.onLongClick) && this.useNewAltTextButton == imageAttachmentMessageAccessory.useNewAltTextButton && q.c(this.attachmentsOpacity, imageAttachmentMessageAccessory.attachmentsOpacity) && this.showRemixButton == imageAttachmentMessageAccessory.showRemixButton && this.isPartOfMosaic == imageAttachmentMessageAccessory.isPartOfMosaic && q.c(this.remixButtonIconColor, imageAttachmentMessageAccessory.remixButtonIconColor) && q.c(this.remixButtonBackgroundColor, imageAttachmentMessageAccessory.remixButtonBackgroundColor);
    }
    ...
    public int hashCode() {
        int i10 = ((((((((MessageId.m612hashCodeimpl(mo222getMessageId3Eiw7ao()) * 31) + this.attachmentIndex) * 31) + this.attachment.hashCode()) * 31) + this.constrainedWidth) * 31) + this.radiusPx) * 31;
