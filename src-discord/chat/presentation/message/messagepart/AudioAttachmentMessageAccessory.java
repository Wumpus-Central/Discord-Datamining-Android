...
public final class AudioAttachmentMessageAccessory extends MessageAccessory {
    ...
    public static  AudioAttachmentMessageAccessory m234copyD2GGZos$default(AudioAttachmentMessageAccessory audioAttachmentMessageAccessory, String str, UserId userId, int i10, Attachment attachment, Float f10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = audioAttachmentMessageAccessory.mo230getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return audioAttachmentMessageAccessory.m237copyD2GGZos(str, userId, i10, attachment, f10);
    }
    ...
    public final UserId m236component2wUX8bhU() {
    ...
    public final AudioAttachmentMessageAccessory m237copyD2GGZos(String messageId, UserId userId, int i10, Attachment attachment, Float f10) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m619equalsimpl0(mo230getMessageId3Eiw7ao(), audioAttachmentMessageAccessory.mo230getMessageId3Eiw7ao()) && q.c(this.authorId, audioAttachmentMessageAccessory.authorId) && this.index == audioAttachmentMessageAccessory.index && q.c(this.attachment, audioAttachmentMessageAccessory.attachment) && q.c(this.attachmentsOpacity, audioAttachmentMessageAccessory.attachmentsOpacity);
    }
    ...
    public final UserId m238getAuthorIdwUX8bhU() {
        return this.authorId;
    }
    ...
    public int hashCode() {
        ...
        int i11 = 0;
        int i12 = (((((i10 + (userId == null ? 0 : UserId.m658hashCodeimpl(userId.m662unboximpl()))) * 31) + this.index) * 31) + this.attachment.hashCode()) * 31;
