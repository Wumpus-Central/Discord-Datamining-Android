...
public final class AudioAttachmentMessageAccessory extends MessageAccessory {
    ...
    public static  AudioAttachmentMessageAccessory m219copyD2GGZos$default(AudioAttachmentMessageAccessory audioAttachmentMessageAccessory, String str, UserId userId, int i10, Attachment attachment, Float f10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        int i11 = 0;
        int i12 = (((((i10 + (userId == null ? 0 : UserId.m633hashCodeimpl(userId.m637unboximpl()))) * 31) + this.index) * 31) + this.attachment.hashCode()) * 31;
