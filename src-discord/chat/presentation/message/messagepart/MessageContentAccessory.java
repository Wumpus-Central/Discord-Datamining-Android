...
public final class MessageContentAccessory extends MessageAccessory {
    ...
    public  MessageContentAccessory(String str, StructurableText structurableText, boolean z10, boolean z11, boolean z12, int i10, int i11, int i12, DiscordFont discordFont, int i13, boolean z13, int i14, String str2, Truncation truncation, DiscordTheme discordTheme, int i15, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, structurableText, z10, z11, z12, i10, i11, i12, discordFont, i13, z13, i14, str2, (i15 & 8192) != 0 ? null : truncation, (i15 & 16384) != 0 ? ThemeManagerKt.getTheme() : discordTheme, null);
    }

    public  MessageContentAccessory(String str, StructurableText structurableText, boolean z10, boolean z11, boolean z12, int i10, int i11, int i12, DiscordFont discordFont, int i13, boolean z13, int i14, String str2, Truncation truncation, DiscordTheme discordTheme, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final MessageContentAccessory m295copyUwkiYZs(String messageId, StructurableText messageContent, boolean z10, boolean z11, boolean z12, int i10, int i11, int i12, DiscordFont messageFont, int i13, boolean z13, int i14, String str, Truncation truncation, DiscordTheme theme) {
    ...
    public int hashCode() {
        int i10 = ((MessageId.m636hashCodeimpl(mo236getMessageId3Eiw7ao()) * 31) + this.messageContent.hashCode()) * 31;
