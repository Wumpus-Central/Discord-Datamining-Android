...
public final class EphemeralIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ EphemeralIndicationMessageAccessory m232copyntcYbpo$default(EphemeralIndicationMessageAccessory ephemeralIndicationMessageAccessory, String str, EphemeralIndication ephemeralIndication, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = ephemeralIndicationMessageAccessory.mo214getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            ephemeralIndication = ephemeralIndicationMessageAccessory.ephemeralIndication;
        }
        return ephemeralIndicationMessageAccessory.m234copyntcYbpo(str, ephemeralIndication);
    }
    ...
    public final EphemeralIndicationMessageAccessory m234copyntcYbpo(String messageId, EphemeralIndication ephemeralIndication) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m592equalsimpl0(mo214getMessageId3Eiw7ao(), ephemeralIndicationMessageAccessory.mo214getMessageId3Eiw7ao()) && q.b(this.ephemeralIndication, ephemeralIndicationMessageAccessory.ephemeralIndication);
    }
    ...
    public int hashCode() {
        return (MessageId.m593hashCodeimpl(mo214getMessageId3Eiw7ao()) * 31) + this.ephemeralIndication.hashCode();
    }
