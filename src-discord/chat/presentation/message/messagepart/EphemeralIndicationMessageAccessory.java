...
public final class EphemeralIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ EphemeralIndicationMessageAccessory m222copyntcYbpo$default(EphemeralIndicationMessageAccessory ephemeralIndicationMessageAccessory, String str, EphemeralIndication ephemeralIndication, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = ephemeralIndicationMessageAccessory.mo204getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            ephemeralIndication = ephemeralIndicationMessageAccessory.ephemeralIndication;
        }
        return ephemeralIndicationMessageAccessory.m224copyntcYbpo(str, ephemeralIndication);
    }
    ...
    public final EphemeralIndicationMessageAccessory m224copyntcYbpo(String messageId, EphemeralIndication ephemeralIndication) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(mo204getMessageId3Eiw7ao(), ephemeralIndicationMessageAccessory.mo204getMessageId3Eiw7ao()) && q.b(this.ephemeralIndication, ephemeralIndicationMessageAccessory.ephemeralIndication);
    }
    ...
    public int hashCode() {
        return (MessageId.m577hashCodeimpl(mo204getMessageId3Eiw7ao()) * 31) + this.ephemeralIndication.hashCode();
    }
