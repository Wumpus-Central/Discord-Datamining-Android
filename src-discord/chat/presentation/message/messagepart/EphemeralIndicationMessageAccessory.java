...
public final class EphemeralIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ EphemeralIndicationMessageAccessory m224copyntcYbpo$default(EphemeralIndicationMessageAccessory ephemeralIndicationMessageAccessory, String str, EphemeralIndication ephemeralIndication, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = ephemeralIndicationMessageAccessory.mo206getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            ephemeralIndication = ephemeralIndicationMessageAccessory.ephemeralIndication;
        }
        return ephemeralIndicationMessageAccessory.m226copyntcYbpo(str, ephemeralIndication);
    }
    ...
    public final EphemeralIndicationMessageAccessory m226copyntcYbpo(String messageId, EphemeralIndication ephemeralIndication) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m584equalsimpl0(mo206getMessageId3Eiw7ao(), ephemeralIndicationMessageAccessory.mo206getMessageId3Eiw7ao()) && q.b(this.ephemeralIndication, ephemeralIndicationMessageAccessory.ephemeralIndication);
    }
    ...
    public int hashCode() {
        return (MessageId.m585hashCodeimpl(mo206getMessageId3Eiw7ao()) * 31) + this.ephemeralIndication.hashCode();
    }
