...
public final class EmbeddedActivityInviteMessageAccessory extends MessageAccessory {
    ...
    public /* synthetic */ EmbeddedActivityInviteMessageAccessory(String str, int i10, EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbedImpl, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i10, embeddedActivityInviteEmbedImpl, i11);
    }

    /* renamed from: copy-AFFcxXc$default  reason: not valid java name */
    public static /* synthetic */ EmbeddedActivityInviteMessageAccessory m221copyAFFcxXc$default(EmbeddedActivityInviteMessageAccessory embeddedActivityInviteMessageAccessory, String str, int i10, EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbedImpl, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = embeddedActivityInviteMessageAccessory.mo206getMessageId3Eiw7ao();
        }
        if ((i12 & 2) != 0) {
        ...
        return embeddedActivityInviteMessageAccessory.m223copyAFFcxXc(str, i10, embeddedActivityInviteEmbedImpl, i11);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m222component13Eiw7ao() {
    ...
    public final EmbeddedActivityInviteMessageAccessory m223copyAFFcxXc(String messageId, int i10, EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbed, int i11) {
    ...
    public int hashCode() {
        return (((((MessageId.m585hashCodeimpl(mo206getMessageId3Eiw7ao()) * 31) + this.codedLinkIndex) * 31) + this.embeddedActivityInviteEmbed.hashCode()) * 31) + this.constrainedWidth;
    }
