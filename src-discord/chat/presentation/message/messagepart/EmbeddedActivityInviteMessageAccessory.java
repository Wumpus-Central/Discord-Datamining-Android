...
public final class EmbeddedActivityInviteMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ EmbeddedActivityInviteMessageAccessory m217copyAFFcxXc$default(EmbeddedActivityInviteMessageAccessory embeddedActivityInviteMessageAccessory, String str, int i10, EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbedImpl, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = embeddedActivityInviteMessageAccessory.mo202getMessageId3Eiw7ao();
        }
        if ((i12 & 2) != 0) {
        ...
        return embeddedActivityInviteMessageAccessory.m219copyAFFcxXc(str, i10, embeddedActivityInviteEmbedImpl, i11);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m218component13Eiw7ao() {
    ...
    public final EmbeddedActivityInviteMessageAccessory m219copyAFFcxXc(String messageId, int i10, EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbed, int i11) {
    ...
    public int hashCode() {
        return (((((MessageId.m563hashCodeimpl(mo202getMessageId3Eiw7ao()) * 31) + this.codedLinkIndex) * 31) + this.embeddedActivityInviteEmbed.hashCode()) * 31) + this.constrainedWidth;
    }
