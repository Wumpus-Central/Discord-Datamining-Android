...
public final class ActivityLauncherMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ ActivityLauncherMessageAccessory m203copyAFFcxXc$default(ActivityLauncherMessageAccessory activityLauncherMessageAccessory, String str, int i10, ActivityLauncherEmbedImpl activityLauncherEmbedImpl, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = activityLauncherMessageAccessory.mo202getMessageId3Eiw7ao();
        }
        if ((i12 & 2) != 0) {
        ...
        return activityLauncherMessageAccessory.m205copyAFFcxXc(str, i10, activityLauncherEmbedImpl, i11);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m204component13Eiw7ao() {
    ...
    public final ActivityLauncherMessageAccessory m205copyAFFcxXc(String messageId, int i10, ActivityLauncherEmbedImpl activityLauncherEmbed, int i11) {
    ...
    public int hashCode() {
        return (((((MessageId.m563hashCodeimpl(mo202getMessageId3Eiw7ao()) * 31) + this.codedLinkIndex) * 31) + this.activityLauncherEmbed.hashCode()) * 31) + this.constrainedWidth;
    }
