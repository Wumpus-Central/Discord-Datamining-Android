...
public final class PostPreviewEmbedMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ PostPreviewEmbedMessageAccessory m262copyu7_MRrM$default(PostPreviewEmbedMessageAccessory postPreviewEmbedMessageAccessory, String str, PostPreviewEmbed postPreviewEmbed, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = postPreviewEmbedMessageAccessory.mo202getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return postPreviewEmbedMessageAccessory.m264copyu7_MRrM(str, postPreviewEmbed, i10);
    }
    ...
    public final PostPreviewEmbedMessageAccessory m264copyu7_MRrM(String messageId, PostPreviewEmbed postPreviewEmbed, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m562equalsimpl0(mo202getMessageId3Eiw7ao(), postPreviewEmbedMessageAccessory.mo202getMessageId3Eiw7ao()) && q.b(this.postPreviewEmbed, postPreviewEmbedMessageAccessory.postPreviewEmbed) && this.index == postPreviewEmbedMessageAccessory.index;
    }
    ...
    public int hashCode() {
        return (((MessageId.m563hashCodeimpl(mo202getMessageId3Eiw7ao()) * 31) + this.postPreviewEmbed.hashCode()) * 31) + this.index;
    }
