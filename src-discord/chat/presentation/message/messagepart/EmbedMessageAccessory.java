...
public final class EmbedMessageAccessory extends MessageAccessory implements PortalUiModel {
    ...
    public final EmbedMessageAccessory m244copy5odn8qk(String messageId, int i10, int i11, int i12, Embed embed, boolean z10, boolean z11, boolean z12, boolean z13, SpoilerAttributes spoilerAttributes, View.OnLongClickListener onLongClickListener) {
    ...
    public int hashCode() {
        int i10 = ((((((((MessageId.m620hashCodeimpl(mo230getMessageId3Eiw7ao()) * 31) + getIndex()) * 31) + this.constrainedWidth) * 31) + this.radiusPx) * 31) + this.embed.hashCode()) * 31;
