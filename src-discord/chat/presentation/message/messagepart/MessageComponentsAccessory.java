...
public final class MessageComponentsAccessory extends MessageAccessory {
    ...
    public static  MessageComponentsAccessory m269copyu7_MRrM$default(MessageComponentsAccessory messageComponentsAccessory, String str, long j10, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = messageComponentsAccessory.mo215getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return messageComponentsAccessory.m271copyu7_MRrM(str, j10, list);
    }
    ...
    public final MessageComponentsAccessory m271copyu7_MRrM(String messageId, long j10, List<? extends Component> messageComponents) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m594equalsimpl0(mo215getMessageId3Eiw7ao(), messageComponentsAccessory.mo215getMessageId3Eiw7ao()) && this.messageFlags == messageComponentsAccessory.messageFlags && q.b(this.messageComponents, messageComponentsAccessory.messageComponents);
    }
    ...
    public int hashCode() {
        return (((MessageId.m595hashCodeimpl(mo215getMessageId3Eiw7ao()) * 31) + b.a(this.messageFlags)) * 31) + this.messageComponents.hashCode();
    }
