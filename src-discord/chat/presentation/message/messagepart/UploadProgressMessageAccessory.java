...
public final class UploadProgressMessageAccessory extends MessageAccessory {
    ...
    public static  UploadProgressMessageAccessory m317copyu7_MRrM$default(UploadProgressMessageAccessory uploadProgressMessageAccessory, String str, int i10, UploadProgress uploadProgress, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return uploadProgressMessageAccessory.m319copyu7_MRrM(str, i10, uploadProgress);
    }
    ...
    public final UploadProgressMessageAccessory m319copyu7_MRrM(String messageId, int i10, UploadProgress uploadProgress) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m635equalsimpl0(mo236getMessageId3Eiw7ao(), uploadProgressMessageAccessory.mo236getMessageId3Eiw7ao()) && this.index == uploadProgressMessageAccessory.index && q.c(this.uploadProgress, uploadProgressMessageAccessory.uploadProgress);
    }
    ...
    public int hashCode() {
        return (((MessageId.m636hashCodeimpl(mo236getMessageId3Eiw7ao()) * 31) + this.index) * 31) + this.uploadProgress.hashCode();
    }
