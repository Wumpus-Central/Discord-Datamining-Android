...
public final class UploadProgressMessageAccessory extends MessageAccessory {
    ...
    public static  UploadProgressMessageAccessory m314copyu7_MRrM$default(UploadProgressMessageAccessory uploadProgressMessageAccessory, String str, int i10, UploadProgress uploadProgress, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = uploadProgressMessageAccessory.mo233getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return uploadProgressMessageAccessory.m316copyu7_MRrM(str, i10, uploadProgress);
    }
    ...
    public final UploadProgressMessageAccessory m316copyu7_MRrM(String messageId, int i10, UploadProgress uploadProgress) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m628equalsimpl0(mo233getMessageId3Eiw7ao(), uploadProgressMessageAccessory.mo233getMessageId3Eiw7ao()) && this.index == uploadProgressMessageAccessory.index && q.c(this.uploadProgress, uploadProgressMessageAccessory.uploadProgress);
    }
    ...
    public int hashCode() {
        return (((MessageId.m629hashCodeimpl(mo233getMessageId3Eiw7ao()) * 31) + this.index) * 31) + this.uploadProgress.hashCode();
    }
