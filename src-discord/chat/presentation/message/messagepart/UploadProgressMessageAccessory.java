...
public final class UploadProgressMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ UploadProgressMessageAccessory m295copyu7_MRrM$default(UploadProgressMessageAccessory uploadProgressMessageAccessory, String str, int i10, UploadProgress uploadProgress, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = uploadProgressMessageAccessory.mo214getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return uploadProgressMessageAccessory.m297copyu7_MRrM(str, i10, uploadProgress);
    }
    ...
    public final UploadProgressMessageAccessory m297copyu7_MRrM(String messageId, int i10, UploadProgress uploadProgress) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m592equalsimpl0(mo214getMessageId3Eiw7ao(), uploadProgressMessageAccessory.mo214getMessageId3Eiw7ao()) && this.index == uploadProgressMessageAccessory.index && q.b(this.uploadProgress, uploadProgressMessageAccessory.uploadProgress);
    }
    ...
    public int hashCode() {
        return (((MessageId.m593hashCodeimpl(mo214getMessageId3Eiw7ao()) * 31) + this.index) * 31) + this.uploadProgress.hashCode();
    }
