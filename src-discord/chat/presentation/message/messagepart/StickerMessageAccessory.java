...
public final class StickerMessageAccessory extends MessageAccessory {
    ...
    public static  StickerMessageAccessory m302copyntcYbpo$default(StickerMessageAccessory stickerMessageAccessory, String str, Sticker sticker, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = stickerMessageAccessory.mo233getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            sticker = stickerMessageAccessory.sticker;
        }
        return stickerMessageAccessory.m304copyntcYbpo(str, sticker);
    }
    ...
    public final StickerMessageAccessory m304copyntcYbpo(String messageId, Sticker sticker) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m628equalsimpl0(mo233getMessageId3Eiw7ao(), stickerMessageAccessory.mo233getMessageId3Eiw7ao()) && q.c(this.sticker, stickerMessageAccessory.sticker);
    }
    ...
    public int hashCode() {
        return (MessageId.m629hashCodeimpl(mo233getMessageId3Eiw7ao()) * 31) + this.sticker.hashCode();
    }
