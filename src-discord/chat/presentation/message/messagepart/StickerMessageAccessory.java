...
public final class StickerMessageAccessory extends MessageAccessory {
    ...
    */
    ...
    public static /* synthetic */ StickerMessageAccessory m283copyntcYbpo$default(StickerMessageAccessory stickerMessageAccessory, String str, Sticker sticker, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = stickerMessageAccessory.mo214getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            sticker = stickerMessageAccessory.sticker;
        }
        return stickerMessageAccessory.m285copyntcYbpo(str, sticker);
    }
    ...
    public final StickerMessageAccessory m285copyntcYbpo(String messageId, Sticker sticker) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m592equalsimpl0(mo214getMessageId3Eiw7ao(), stickerMessageAccessory.mo214getMessageId3Eiw7ao()) && q.b(this.sticker, stickerMessageAccessory.sticker);
    }
    ...
    public int hashCode() {
        return (MessageId.m593hashCodeimpl(mo214getMessageId3Eiw7ao()) * 31) + this.sticker.hashCode();
    }
