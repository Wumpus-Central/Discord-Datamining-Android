...
public final class StickerMessageAccessory extends MessageAccessory {
    ...
    */
    ...
    public static /* synthetic */ StickerMessageAccessory m284copyntcYbpo$default(StickerMessageAccessory stickerMessageAccessory, String str, Sticker sticker, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = stickerMessageAccessory.mo215getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            sticker = stickerMessageAccessory.sticker;
        }
        return stickerMessageAccessory.m286copyntcYbpo(str, sticker);
    }
    ...
    public final StickerMessageAccessory m286copyntcYbpo(String messageId, Sticker sticker) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m593equalsimpl0(mo215getMessageId3Eiw7ao(), stickerMessageAccessory.mo215getMessageId3Eiw7ao()) && q.b(this.sticker, stickerMessageAccessory.sticker);
    }
    ...
    public int hashCode() {
        return (MessageId.m594hashCodeimpl(mo215getMessageId3Eiw7ao()) * 31) + this.sticker.hashCode();
    }
