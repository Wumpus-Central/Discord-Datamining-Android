...
public final class TimestampMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ TimestampMessageAccessory m281copyAFFcxXc$default(TimestampMessageAccessory timestampMessageAccessory, String str, String str2, int i10, DiscordFont discordFont, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = timestampMessageAccessory.mo203getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return timestampMessageAccessory.m283copyAFFcxXc(str, str2, i10, discordFont);
    }
    ...
    public final TimestampMessageAccessory m283copyAFFcxXc(String messageId, String timestamp, int i10, DiscordFont discordFont) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m567equalsimpl0(mo203getMessageId3Eiw7ao(), timestampMessageAccessory.mo203getMessageId3Eiw7ao()) && q.b(this.timestamp, timestampMessageAccessory.timestamp) && this.textColor == timestampMessageAccessory.textColor && this.discordFont == timestampMessageAccessory.discordFont;
    }
    ...
    public int hashCode() {
        return (((((MessageId.m568hashCodeimpl(mo203getMessageId3Eiw7ao()) * 31) + this.timestamp.hashCode()) * 31) + this.textColor) * 31) + this.discordFont.hashCode();
    }
