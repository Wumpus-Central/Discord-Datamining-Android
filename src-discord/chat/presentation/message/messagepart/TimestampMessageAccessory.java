...
public final class TimestampMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ TimestampMessageAccessory m292copyAFFcxXc$default(TimestampMessageAccessory timestampMessageAccessory, String str, String str2, int i10, DiscordFont discordFont, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = timestampMessageAccessory.mo214getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return timestampMessageAccessory.m294copyAFFcxXc(str, str2, i10, discordFont);
    }
    ...
    public final TimestampMessageAccessory m294copyAFFcxXc(String messageId, String timestamp, int i10, DiscordFont discordFont) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m592equalsimpl0(mo214getMessageId3Eiw7ao(), timestampMessageAccessory.mo214getMessageId3Eiw7ao()) && q.b(this.timestamp, timestampMessageAccessory.timestamp) && this.textColor == timestampMessageAccessory.textColor && this.discordFont == timestampMessageAccessory.discordFont;
    }
    ...
    public int hashCode() {
        return (((((MessageId.m593hashCodeimpl(mo214getMessageId3Eiw7ao()) * 31) + this.timestamp.hashCode()) * 31) + this.textColor) * 31) + this.discordFont.hashCode();
    }
