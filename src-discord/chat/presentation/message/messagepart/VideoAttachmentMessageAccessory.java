...
public final class VideoAttachmentMessageAccessory extends MessageAccessory implements PortalUiModel {
    ...
    public final VideoAttachmentMessageAccessory m292copya6FnOk(String messageId, int i10, Attachment attachment, int i11, int i12, SpoilerAttributes spoilerAttributes, View.OnLongClickListener onLongClickListener, boolean z10, boolean z11, Float f10) {
    ...
    public int hashCode() {
        int i10 = ((((((((MessageId.m585hashCodeimpl(mo206getMessageId3Eiw7ao()) * 31) + getIndex()) * 31) + this.attachment.hashCode()) * 31) + this.constrainedWidth) * 31) + this.radiusPx) * 31;
