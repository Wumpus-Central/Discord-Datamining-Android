...
public final class InviteToSpeakAccessory extends MessageAccessory {
    ...
    public InviteToSpeakAccessory(Message message) {
        super(message.m24getId3Eiw7ao(), "invite to speak", null);
        q.h(message, "message");
        this.message = message;
    }

    public static  InviteToSpeakAccessory copy$default(InviteToSpeakAccessory inviteToSpeakAccessory, Message message, int i10, Object obj) {
        if ((i10 & 1) != 0) {
