...
public final class AutoModerationNotificationEmbedAccessory extends MessageAccessory {
    ...
    public static  AutoModerationNotificationEmbedAccessory m226copyu7_MRrM$default(AutoModerationNotificationEmbedAccessory autoModerationNotificationEmbedAccessory, String str, Message message, AutoModerationContext autoModerationContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = autoModerationNotificationEmbedAccessory.mo217getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return autoModerationNotificationEmbedAccessory.m228copyu7_MRrM(str, message, autoModerationContext);
    }
    ...
    public final AutoModerationNotificationEmbedAccessory m228copyu7_MRrM(String messageId, Message message, AutoModerationContext moderationContext) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m596equalsimpl0(mo217getMessageId3Eiw7ao(), autoModerationNotificationEmbedAccessory.mo217getMessageId3Eiw7ao()) && q.b(this.message, autoModerationNotificationEmbedAccessory.message) && q.b(this.moderationContext, autoModerationNotificationEmbedAccessory.moderationContext);
    }
    ...
    public int hashCode() {
        return (((MessageId.m597hashCodeimpl(mo217getMessageId3Eiw7ao()) * 31) + this.message.hashCode()) * 31) + this.moderationContext.hashCode();
    }
