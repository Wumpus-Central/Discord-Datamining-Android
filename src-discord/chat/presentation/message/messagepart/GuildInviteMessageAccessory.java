...
public final class GuildInviteMessageAccessory extends MessageAccessory {
    ...
    public /* synthetic */ GuildInviteMessageAccessory(String str, int i10, GuildInviteEmbedImpl guildInviteEmbedImpl, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i10, guildInviteEmbedImpl);
    }

    /* renamed from: copy-u7_MRrM$default  reason: not valid java name */
    public static /* synthetic */ GuildInviteMessageAccessory m246copyu7_MRrM$default(GuildInviteMessageAccessory guildInviteMessageAccessory, String str, int i10, GuildInviteEmbedImpl guildInviteEmbedImpl, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = guildInviteMessageAccessory.mo204getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return guildInviteMessageAccessory.m248copyu7_MRrM(str, i10, guildInviteEmbedImpl);
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m247component13Eiw7ao() {
    ...
    public final GuildInviteMessageAccessory m248copyu7_MRrM(String messageId, int i10, GuildInviteEmbedImpl invite) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(mo204getMessageId3Eiw7ao(), guildInviteMessageAccessory.mo204getMessageId3Eiw7ao()) && this.codedLinkIndex == guildInviteMessageAccessory.codedLinkIndex && q.b(this.invite, guildInviteMessageAccessory.invite);
    }
