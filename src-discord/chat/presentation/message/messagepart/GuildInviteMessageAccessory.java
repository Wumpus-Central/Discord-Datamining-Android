...
public final class GuildInviteMessageAccessory extends MessageAccessory {
    ...
    public static  GuildInviteMessageAccessory m264copyu7_MRrM$default(GuildInviteMessageAccessory guildInviteMessageAccessory, String str, int i10, GuildInviteEmbedImpl guildInviteEmbedImpl, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = guildInviteMessageAccessory.mo222getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return guildInviteMessageAccessory.m266copyu7_MRrM(str, i10, guildInviteEmbedImpl);
    }
    ...
    public final GuildInviteMessageAccessory m266copyu7_MRrM(String messageId, int i10, GuildInviteEmbedImpl invite) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m611equalsimpl0(mo222getMessageId3Eiw7ao(), guildInviteMessageAccessory.mo222getMessageId3Eiw7ao()) && this.codedLinkIndex == guildInviteMessageAccessory.codedLinkIndex && q.c(this.invite, guildInviteMessageAccessory.invite);
    }
