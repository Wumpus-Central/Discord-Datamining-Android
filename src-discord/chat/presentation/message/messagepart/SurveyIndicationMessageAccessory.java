...
public final class SurveyIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ SurveyIndicationMessageAccessory m275copyntcYbpo$default(SurveyIndicationMessageAccessory surveyIndicationMessageAccessory, String str, SurveyIndication surveyIndication, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = surveyIndicationMessageAccessory.mo203getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            surveyIndication = surveyIndicationMessageAccessory.surveyIndication;
        }
        return surveyIndicationMessageAccessory.m277copyntcYbpo(str, surveyIndication);
    }
    ...
    public final SurveyIndicationMessageAccessory m277copyntcYbpo(String messageId, SurveyIndication surveyIndication) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m567equalsimpl0(mo203getMessageId3Eiw7ao(), surveyIndicationMessageAccessory.mo203getMessageId3Eiw7ao()) && q.b(this.surveyIndication, surveyIndicationMessageAccessory.surveyIndication);
    }
    ...
    public int hashCode() {
        return (MessageId.m568hashCodeimpl(mo203getMessageId3Eiw7ao()) * 31) + this.surveyIndication.hashCode();
    }
