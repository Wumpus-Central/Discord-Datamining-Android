...
public final class SurveyIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ SurveyIndicationMessageAccessory m276copyntcYbpo$default(SurveyIndicationMessageAccessory surveyIndicationMessageAccessory, String str, SurveyIndication surveyIndication, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = surveyIndicationMessageAccessory.mo204getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
            surveyIndication = surveyIndicationMessageAccessory.surveyIndication;
        }
        return surveyIndicationMessageAccessory.m278copyntcYbpo(str, surveyIndication);
    }
    ...
    public final SurveyIndicationMessageAccessory m278copyntcYbpo(String messageId, SurveyIndication surveyIndication) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(mo204getMessageId3Eiw7ao(), surveyIndicationMessageAccessory.mo204getMessageId3Eiw7ao()) && q.b(this.surveyIndication, surveyIndicationMessageAccessory.surveyIndication);
    }
    ...
    public int hashCode() {
        return (MessageId.m577hashCodeimpl(mo204getMessageId3Eiw7ao()) * 31) + this.surveyIndication.hashCode();
    }
