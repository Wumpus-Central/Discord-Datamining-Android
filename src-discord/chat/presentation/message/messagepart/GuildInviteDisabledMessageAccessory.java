...
public final class GuildInviteDisabledMessageAccessory extends MessageAccessory {
    ...
    public /* synthetic */ GuildInviteDisabledMessageAccessory(String str, int i10, GuildInviteDisabledEmbedImpl guildInviteDisabledEmbedImpl, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i10, guildInviteDisabledEmbedImpl);
    }

    /* renamed from: copy-u7_MRrM$default  reason: not valid java name */
    public static /* synthetic */ GuildInviteDisabledMessageAccessory m243copyu7_MRrM$default(GuildInviteDisabledMessageAccessory guildInviteDisabledMessageAccessory, String str, int i10, GuildInviteDisabledEmbedImpl guildInviteDisabledEmbedImpl, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = guildInviteDisabledMessageAccessory.mo204getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return guildInviteDisabledMessageAccessory.m245copyu7_MRrM(str, i10, guildInviteDisabledEmbedImpl);
    }
    ...
    public final GuildInviteDisabledMessageAccessory m245copyu7_MRrM(String messageId, int i10, GuildInviteDisabledEmbedImpl invite) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(mo204getMessageId3Eiw7ao(), guildInviteDisabledMessageAccessory.mo204getMessageId3Eiw7ao()) && this.codedLinkIndex == guildInviteDisabledMessageAccessory.codedLinkIndex && q.b(this.invite, guildInviteDisabledMessageAccessory.invite);
    }
    ...
    public int hashCode() {
        return (((MessageId.m577hashCodeimpl(mo204getMessageId3Eiw7ao()) * 31) + this.codedLinkIndex) * 31) + this.invite.hashCode();
    }
