...
public final class GuildInviteDisabledMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ GuildInviteDisabledMessageAccessory m242copyu7_MRrM$default(GuildInviteDisabledMessageAccessory guildInviteDisabledMessageAccessory, String str, int i10, GuildInviteDisabledEmbedImpl guildInviteDisabledEmbedImpl, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = guildInviteDisabledMessageAccessory.mo203getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return guildInviteDisabledMessageAccessory.m244copyu7_MRrM(str, i10, guildInviteDisabledEmbedImpl);
    }
    ...
    public final GuildInviteDisabledMessageAccessory m244copyu7_MRrM(String messageId, int i10, GuildInviteDisabledEmbedImpl invite) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m567equalsimpl0(mo203getMessageId3Eiw7ao(), guildInviteDisabledMessageAccessory.mo203getMessageId3Eiw7ao()) && this.codedLinkIndex == guildInviteDisabledMessageAccessory.codedLinkIndex && q.b(this.invite, guildInviteDisabledMessageAccessory.invite);
    }
    ...
    public int hashCode() {
        return (((MessageId.m568hashCodeimpl(mo203getMessageId3Eiw7ao()) * 31) + this.codedLinkIndex) * 31) + this.invite.hashCode();
    }
