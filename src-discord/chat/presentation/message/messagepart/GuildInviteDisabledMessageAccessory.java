...
public final class GuildInviteDisabledMessageAccessory extends MessageAccessory {
    ...
    public static  GuildInviteDisabledMessageAccessory m271copyu7_MRrM$default(GuildInviteDisabledMessageAccessory guildInviteDisabledMessageAccessory, String str, int i10, GuildInviteDisabledEmbedImpl guildInviteDisabledEmbedImpl, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = guildInviteDisabledMessageAccessory.mo232getMessageId3Eiw7ao();
        }
        if ((i11 & 2) != 0) {
        ...
        return guildInviteDisabledMessageAccessory.m273copyu7_MRrM(str, i10, guildInviteDisabledEmbedImpl);
    }
    ...
    public final GuildInviteDisabledMessageAccessory m273copyu7_MRrM(String messageId, int i10, GuildInviteDisabledEmbedImpl invite) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m621equalsimpl0(mo232getMessageId3Eiw7ao(), guildInviteDisabledMessageAccessory.mo232getMessageId3Eiw7ao()) && this.codedLinkIndex == guildInviteDisabledMessageAccessory.codedLinkIndex && q.c(this.invite, guildInviteDisabledMessageAccessory.invite);
    }
    ...
    public int hashCode() {
        return (((MessageId.m622hashCodeimpl(mo232getMessageId3Eiw7ao()) * 31) + this.codedLinkIndex) * 31) + this.invite.hashCode();
    }
