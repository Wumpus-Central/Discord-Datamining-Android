...
public final class ReactionsMessageAccessory extends MessageAccessory {
    ...
    public int hashCode() {
        int i10 = ((MessageId.m585hashCodeimpl(mo206getMessageId3Eiw7ao()) * 31) + this.reactions.hashCode()) * 31;
