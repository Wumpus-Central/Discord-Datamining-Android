...
public final class GuildEventInviteMessageAccessory extends MessageAccessory {
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m594hashCodeimpl(mo215getMessageId3Eiw7ao()) * 31) + this.codedLinkIndex) * 31) + this.invite.hashCode()) * 31;
