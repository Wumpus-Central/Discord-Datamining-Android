...
public final class ForumPostActionBar extends MessageAccessory {
    ...
    public static  ForumPostActionBar m270copyLdU2QRA$default(ForumPostActionBar forumPostActionBar, String str, ForumPostActions forumPostActions, List list, boolean z10, String str2, ReactionsTheme reactionsTheme, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = forumPostActionBar.mo240getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return forumPostActionBar.m272copyLdU2QRA(str, forumPostActions, list, z10, str2, reactionsTheme);
    }
    ...
    public final ForumPostActionBar m272copyLdU2QRA(String messageId, ForumPostActions postActions, List<MessageReaction> list, boolean z10, String addNewReactionAccessibilityLabel, ReactionsTheme reactionsTheme) {
    ...
    public int hashCode() {
        int i10 = ((MessageId.m648hashCodeimpl(mo240getMessageId3Eiw7ao()) * 31) + this.postActions.hashCode()) * 31;
