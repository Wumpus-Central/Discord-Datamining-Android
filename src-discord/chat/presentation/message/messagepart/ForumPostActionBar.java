...
public final class ForumPostActionBar extends MessageAccessory {
    ...
    public static /* synthetic */ ForumPostActionBar m232copydB0bEw$default(ForumPostActionBar forumPostActionBar, String str, ForumPostActions forumPostActions, List list, boolean z10, String str2, ReactionsTheme reactionsTheme, boolean z11, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = forumPostActionBar.mo202getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return forumPostActionBar.m234copydB0bEw(str, forumPostActions, list, z10, str2, reactionsTheme, z11);
    }
    ...
    public final ForumPostActionBar m234copydB0bEw(String messageId, ForumPostActions postActions, List<MessageReaction> list, boolean z10, String addNewReactionAccessibilityLabel, ReactionsTheme reactionsTheme, boolean z11) {
    ...
    public int hashCode() {
        int i10 = ((MessageId.m563hashCodeimpl(mo202getMessageId3Eiw7ao()) * 31) + this.postActions.hashCode()) * 31;
