...
public final class ForumPostActionBar extends MessageAccessory {
    ...
    public static  ForumPostActionBar m248copyLdU2QRA$default(ForumPostActionBar forumPostActionBar, String str, ForumPostActions forumPostActions, List list, boolean z10, String str2, ReactionsTheme reactionsTheme, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = forumPostActionBar.mo218getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return forumPostActionBar.m250copyLdU2QRA(str, forumPostActions, list, z10, str2, reactionsTheme);
    }
    ...
    public final ForumPostActionBar m250copyLdU2QRA(String messageId, ForumPostActions postActions, List<MessageReaction> list, boolean z10, String addNewReactionAccessibilityLabel, ReactionsTheme reactionsTheme) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m597equalsimpl0(mo218getMessageId3Eiw7ao(), forumPostActionBar.mo218getMessageId3Eiw7ao()) && q.c(this.postActions, forumPostActionBar.postActions) && q.c(this.reactions, forumPostActionBar.reactions) && this.canAddNewReactions == forumPostActionBar.canAddNewReactions && q.c(this.addNewReactionAccessibilityLabel, forumPostActionBar.addNewReactionAccessibilityLabel) && q.c(this.reactionsTheme, forumPostActionBar.reactionsTheme);
    }
    ...
    public int hashCode() {
        int i10 = ((MessageId.m598hashCodeimpl(mo218getMessageId3Eiw7ao()) * 31) + this.postActions.hashCode()) * 31;
