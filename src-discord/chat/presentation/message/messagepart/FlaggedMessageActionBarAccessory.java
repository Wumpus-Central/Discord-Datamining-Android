...
public final class FlaggedMessageActionBarAccessory extends MessageAccessory {
    ...
    public static  FlaggedMessageActionBarAccessory m257copyu7_MRrM$default(FlaggedMessageActionBarAccessory flaggedMessageActionBarAccessory, String str, Message message, AutoModerationContext autoModerationContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = flaggedMessageActionBarAccessory.mo233getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return flaggedMessageActionBarAccessory.m259copyu7_MRrM(str, message, autoModerationContext);
    }
    ...
    public final FlaggedMessageActionBarAccessory m259copyu7_MRrM(String messageId, Message message, AutoModerationContext autoModerationContext) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m628equalsimpl0(mo233getMessageId3Eiw7ao(), flaggedMessageActionBarAccessory.mo233getMessageId3Eiw7ao()) && q.c(this.message, flaggedMessageActionBarAccessory.message) && q.c(this.autoModerationContext, flaggedMessageActionBarAccessory.autoModerationContext);
    }
    ...
    public int hashCode() {
        return (((MessageId.m629hashCodeimpl(mo233getMessageId3Eiw7ao()) * 31) + this.message.hashCode()) * 31) + this.autoModerationContext.hashCode();
    }
