...
public final class FlaggedMessageActionBarAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ FlaggedMessageActionBarAccessory m230copyu7_MRrM$default(FlaggedMessageActionBarAccessory flaggedMessageActionBarAccessory, String str, Message message, AutoModerationContext autoModerationContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = flaggedMessageActionBarAccessory.mo206getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return flaggedMessageActionBarAccessory.m232copyu7_MRrM(str, message, autoModerationContext);
    }
    ...
    public final FlaggedMessageActionBarAccessory m232copyu7_MRrM(String messageId, Message message, AutoModerationContext autoModerationContext) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m584equalsimpl0(mo206getMessageId3Eiw7ao(), flaggedMessageActionBarAccessory.mo206getMessageId3Eiw7ao()) && q.b(this.message, flaggedMessageActionBarAccessory.message) && q.b(this.autoModerationContext, flaggedMessageActionBarAccessory.autoModerationContext);
    }
    ...
    public int hashCode() {
        return (((MessageId.m585hashCodeimpl(mo206getMessageId3Eiw7ao()) * 31) + this.message.hashCode()) * 31) + this.autoModerationContext.hashCode();
    }
