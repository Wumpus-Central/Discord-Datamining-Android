...
public final class FlaggedMessageEmbedAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ FlaggedMessageEmbedAccessory m231copyu7_MRrM$default(FlaggedMessageEmbedAccessory flaggedMessageEmbedAccessory, String str, Message message, MessageContext messageContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = flaggedMessageEmbedAccessory.mo204getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return flaggedMessageEmbedAccessory.m233copyu7_MRrM(str, message, messageContext);
    }
    ...
    public final FlaggedMessageEmbedAccessory m233copyu7_MRrM(String messageId, Message message, MessageContext messageContext) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m576equalsimpl0(mo204getMessageId3Eiw7ao(), flaggedMessageEmbedAccessory.mo204getMessageId3Eiw7ao()) && q.b(this.message, flaggedMessageEmbedAccessory.message) && q.b(this.messageContext, flaggedMessageEmbedAccessory.messageContext);
    }
    ...
    public int hashCode() {
        return (((MessageId.m577hashCodeimpl(mo204getMessageId3Eiw7ao()) * 31) + this.message.hashCode()) * 31) + this.messageContext.hashCode();
    }
