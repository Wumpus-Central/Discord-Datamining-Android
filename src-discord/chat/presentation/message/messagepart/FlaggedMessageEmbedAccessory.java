...
public final class FlaggedMessageEmbedAccessory extends MessageAccessory {
    ...
    public static  FlaggedMessageEmbedAccessory m257copyu7_MRrM$default(FlaggedMessageEmbedAccessory flaggedMessageEmbedAccessory, String str, Message message, MessageContext messageContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = flaggedMessageEmbedAccessory.mo230getMessageId3Eiw7ao();
        }
        if ((i10 & 2) != 0) {
        ...
        return flaggedMessageEmbedAccessory.m259copyu7_MRrM(str, message, messageContext);
    }
    ...
    public final FlaggedMessageEmbedAccessory m259copyu7_MRrM(String messageId, Message message, MessageContext messageContext) {
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m619equalsimpl0(mo230getMessageId3Eiw7ao(), flaggedMessageEmbedAccessory.mo230getMessageId3Eiw7ao()) && q.c(this.message, flaggedMessageEmbedAccessory.message) && q.c(this.messageContext, flaggedMessageEmbedAccessory.messageContext);
    }
    ...
    public int hashCode() {
        return (((MessageId.m620hashCodeimpl(mo230getMessageId3Eiw7ao()) * 31) + this.message.hashCode()) * 31) + this.messageContext.hashCode();
    }
