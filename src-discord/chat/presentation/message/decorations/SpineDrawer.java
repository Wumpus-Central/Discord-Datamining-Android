...
public final class SpineDrawer extends RecyclerView.ItemDecoration {
    ...
    public static  void drawSpinePiece$default(SpineDrawer spineDrawer, Canvas canvas, RecyclerView recyclerView, View view, int i10, int i11, int i12, Object obj) {
        if ((i12 & 16) != 0) {
            i11 = 0;
        }
