...
public final class MessageAccessoriesAdapter$onBindViewHolder$19 extends s implements Function1<Double, Unit> {
    ...
    public final void invoke2(Double d10) {
        this.this$0.m197onMediaClickedl3ndGo(this.$holder, this.$part.mo218getMessageId3Eiw7ao(), ((VideoAttachmentMessageAccessory) this.$part).getIndex(), "attachment", d10, null, ViewResizeMode.Fill);
    }
}
