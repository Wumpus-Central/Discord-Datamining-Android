...
public final class PostPreviewEmbedView extends ConstraintLayout {
    ...
    private final void m352setFooterAyv7vGE(StructurableText structurableText, String str) {
    ...
    public final void m353setPostPreviewEmbedOGpb6Gk(String title, String str, String ctaCopy, int i10, StructurableText footer, String messageId, String str2, String str3, String str4, String str5, View.OnClickListener onButtonClickListener, boolean z10, SpoilerConfig spoilerConfig) {
        q.h(title, "title");
        q.h(ctaCopy, "ctaCopy");
        q.h(footer, "footer");
        ...
        setTitle(title);
        setSubtitle(str);
        m352setFooterAyv7vGE(footer, messageId);
