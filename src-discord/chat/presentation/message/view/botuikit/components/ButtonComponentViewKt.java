...
public final class ButtonComponentViewKt {
    public static final  boolean access$hasEmoji(ButtonComponent buttonComponent) {
        return hasEmoji(buttonComponent);
    }

    public static final  boolean access$hasIcon(ButtonComponent buttonComponent) {
        return hasIcon(buttonComponent);
    }

    public static final  void access$setBrandColor(Button button) {
        setBrandColor(button);
    }

    public static final  void access$setDangerColor(Button button) {
        setDangerColor(button);
    }

    public static final  void access$setSecondaryColor(Button button) {
        setSecondaryColor(button);
    }

    public static final  void access$setSuccessColor(Button button) {
