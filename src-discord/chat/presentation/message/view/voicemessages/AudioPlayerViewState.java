...
public final class AudioPlayerViewState {
    ...
    public  AudioPlayerViewState(String str, String str2, boolean z10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, z10);
    }

    
    public static  AudioPlayerViewState m327copyP6IPuNM$default(AudioPlayerViewState audioPlayerViewState, String str, String str2, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return audioPlayerViewState.m329copyP6IPuNM(str, str2, z10);
    }

    
    public final String m328component1N_6c4I0() {
    ...
    public final AudioPlayerViewState m329copyP6IPuNM(String str, String str2, boolean z10) {
    ...
    public final String m330getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public  AudioPlayerViewState(String str, String str2, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
