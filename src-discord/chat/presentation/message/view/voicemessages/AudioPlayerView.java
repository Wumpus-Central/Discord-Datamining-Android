...
public final class AudioPlayerView extends FrameLayout {
    ...
    public interface Listener {
        ...
        public static final class Companion {
            ...
            public final float secondsSinceStart(long j10) {
                ...
                e10 = j.e(Duration.e(a.t(System.currentTimeMillis() - j10, c.MILLISECONDS)), Duration.e(Duration.f21310k.b()));
                return (float) Duration.G(((Duration) e10).L(), c.SECONDS);
            }
        }
    ...
    public final void maybeLogPlaybackEnded() {
        ...
        if (currentPosition != null) {
            ...
            if (l10 != null) {
                ...
                if (listener != null) {
                    Duration.a aVar = Duration.f21310k;
                    listener.voiceMessagePlaybackEnded((float) Duration.G(a.t(longValue, c.MILLISECONDS), c.SECONDS), secondsSinceStart);
                }
            }
        }
    }
    ...
    public final void maybeLogPlaybackStarted() {
        ...
        if (currentPosition != null) {
            ...
            if (listener != null) {
                Duration.a aVar = Duration.f21310k;
                listener.voiceMessagePlaybackStarted((float) Duration.G(a.t(longValue, c.MILLISECONDS), c.SECONDS));
            }
        }
    }
    ...
    private final int toSeconds(long j10) {
        Duration.a aVar = Duration.f21310k;
        return (int) Math.ceil(Duration.G(a.t(j10, c.MILLISECONDS), c.SECONDS));
    }
    ...
    public final void m344setSourceUrlntcYbpo(String messageId, String str) {
