...
public final class AudioPlayerManager {
    ...
    public static final class AudioSource {
        ...
        public static  AudioSource m340copyntcYbpo$default(AudioSource audioSource, String str, String str2, int i10, Object obj) {
            if ((i10 & 1) != 0) {
            ...
            return audioSource.m342copyntcYbpo(str, str2);
        }
        ...
        public final AudioSource m342copyntcYbpo(String messageId, String url) {
        ...
        public boolean equals(Object obj) {
            ...
            return MessageId.m621equalsimpl0(this.messageId, audioSource.messageId) && q.c(this.url, audioSource.url);
        }
        ...
        public int hashCode() {
            return (MessageId.m622hashCodeimpl(this.messageId) * 31) + this.url.hashCode();
        }
    ...
    public final boolean hasCurrentPlayer(AudioSource audioSource) {
        return audioSource != null && q.c(getCurrentPlayerSource(), audioSource);
    }
    ...
    public final void init(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            q.g(build, "Builder(AudioManager.AUD…\n                .build()");
            focusRequest = build;
        }
    }
    ...
    public final void setupPlayer(Context context, AudioSource source, long j10, Function1<? super MediaPlayer.Event, Unit> onStateChanged) {
        ...
        q.h(context, "context");
        q.h(source, "source");
        q.h(onStateChanged, "onStateChanged");
        if (mediaPlayer == null) {
            mediaPlayer = MediaPlayer.Factory.INSTANCE.create(context);
        }
        if (!q.c(source, getCurrentPlayerSource())) {
            storeDuration(getCurrentPlayerSource());
            mediaPlayerState = null;
