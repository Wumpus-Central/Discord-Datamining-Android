...
final class ForumPostActionBarView$setSharePrompt$3$1 extends s implements Function1<LinkContentNode, Unit> {
    ...
    public ForumPostActionBarView$setSharePrompt$3$1(Function2<? super MessageId, ? super LinkContentNode, Unit> function2, String str) {
        super(1);
