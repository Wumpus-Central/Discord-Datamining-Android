...
public final class FileAttachmentView$setContent$2$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FileAttachmentView$setContent$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f21600a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            FlowCollector<? super DownloadState> flowCollector = new FlowCollector() { 
                ...
                public static final class C01041 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    final  DownloadState $downloadState;
                    int label;
                    final  FileAttachmentView this$0;

                    
                    C01041(DownloadState downloadState, FileAttachmentView fileAttachmentView, Continuation<? super C01041> continuation) {
                        super(2, continuation);
                    ...
                    @Override 
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C01041(this.$downloadState, this.this$0, continuation);
                    }

                    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                        return ((C01041) create(coroutineScope, continuation)).invokeSuspend(Unit.f21600a);
                    }
                ...
                public final Object emit(DownloadState downloadState, Continuation<? super Unit> continuation) {
                    Object d11;
                    Object g10 = j.g(b1.c(), new C01041(downloadState, FileAttachmentView.this, null), continuation);
                    d11 = d.d();
                    return g10 == d11 ? g10 : Unit.f21600a;
                }
            };
            this.label = 1;
