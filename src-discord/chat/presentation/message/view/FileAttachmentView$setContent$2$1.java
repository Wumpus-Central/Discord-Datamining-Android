...
public final class FileAttachmentView$setContent$2$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FileAttachmentView$setContent$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f22036a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            FlowCollector<? super DownloadState> flowCollector = new FlowCollector() { // from class: com.discord.chat.presentation.message.view.FileAttachmentView$setContent$2$1.1
                ...
                /* loaded from: classes4.dex */
                public static final class C01051 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                        return ((C01051) create(coroutineScope, continuation)).invokeSuspend(Unit.f22036a);
                    }
                ...
                public final Object emit(DownloadState downloadState, Continuation<? super Unit> continuation) {
                    Object d11;
                    Object g10 = j.g(y0.c(), new C01051(downloadState, FileAttachmentView.this, null), continuation);
                    d11 = d.d();
                    return g10 == d11 ? g10 : Unit.f22036a;
                }
            };
            this.label = 1;
