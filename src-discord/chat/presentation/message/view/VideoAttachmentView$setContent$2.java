...
public final class VideoAttachmentView$setContent$2 extends s implements Function0<Unit> {
    ...
    public VideoAttachmentView$setContent$2(boolean z10, VideoAttachmentView videoAttachmentView) {
        super(0);
        this.$isObscure = z10;
    ...
    public final void invoke2() {
        ...
        if (this.$isObscure) {
            ...
            videoAttachmentViewBinding.spoiler.makeObscureHideButtonHidden();
        }
    }
}
