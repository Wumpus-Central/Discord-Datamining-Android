        ...
        if (c10.y()) {
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj5 = c10.v(descriptor2, 0, a2.f26237a, obj5);
                    i11 |= 1;
                } else if (x10 == 1) {
                    obj6 = c10.v(descriptor2, 1, a2.f26237a, obj6);
                    i11 |= 2;
                } else if (x10 == 2) {
                    obj = c10.v(descriptor2, 2, new f(a2.f26237a), obj);
                    i11 |= 4;
                } else if (x10 == 3) {
                    obj7 = c10.v(descriptor2, 3, a2.f26237a, obj7);
                    i11 |= 8;
                } else {
                    throw new n(x10);
                }
