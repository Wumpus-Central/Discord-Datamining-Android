        ...
        if (b10.p()) {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj5 = b10.n(descriptor2, 0, a2.f29762a, obj5);
                    i11 |= 1;
                } else if (o10 == 1) {
                    obj6 = b10.n(descriptor2, 1, a2.f29762a, obj6);
                    i11 |= 2;
                } else if (o10 == 2) {
                    obj = b10.n(descriptor2, 2, new f(a2.f29762a), obj);
                    i11 |= 4;
                } else if (o10 == 3) {
                    obj7 = b10.n(descriptor2, 3, a2.f29762a, obj7);
                    i11 |= 8;
                } else {
                    throw new n(o10);
                }
