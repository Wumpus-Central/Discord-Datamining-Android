...
public interface ChatEventHandler {
    ...
    public static final class DefaultImpls {
        ...
        public static  void m185onLinkClickedu7_MRrM$default(ChatEventHandler chatEventHandler, String str, String str2, String str3, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    str3 = null;
                }
        ...
        public static  void m186onTapButtonActionComponentNkFJqEg$default(ChatEventHandler chatEventHandler, String str, long j10, String str2, long j11, int[] iArr, int i10, Object obj) {
            if (obj == null) {
        ...
        public static  void m187onTapReactionu7_MRrM$default(ChatEventHandler chatEventHandler, String str, ReactionView.Reaction reaction, Boolean bool, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    bool = Boolean.FALSE;
                }
        ...
        public static  void m188onTapSelectActionComponentu7_MRrM$default(ChatEventHandler chatEventHandler, String str, long j10, SelectComponent selectComponent, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 2) != 0) {
                    j10 = 0;
                }
                chatEventHandler.mo173onTapSelectActionComponentu7_MRrM(str, j10, selectComponent);
                return;
            }
    ...
    void mo172onTapSeeMore1xi1bu0(String str);

    
    void mo173onTapSelectActionComponentu7_MRrM(String str, long j10, SelectComponent selectComponent);

    
    void mo174onTapShareForumPostmgk6anA(long j10, long j11);

    void onTapShowAltText(String str);

    
    void mo175onTapSummarysekaTiM(long j10, String str, String str2);

    
    void mo176onTapSummaryJumpsekaTiM(long j10, String str, String str2);

    void onTapSuppressNotificationsIcon();

    
    void mo177onTapTagEqy5D80(String str, long j10, String str2);

    
    void mo178onTapThreadEmbed1xi1bu0(String str);

    void onTapTimestamp(String str);

    
    void mo179onTapToggleBlockedMessages1xi1bu0(String str);

    void onTapUploadProgressClose(String str);

    
    void mo180onTapUsernamex5gers8(String str, long j10);

    
    void mo181onWelcomeReplyClickedAyv7vGE(Sticker sticker, String str);

    
    void mo182voiceMessagePlaybackEndedHuwN0RY(String str, float f10, float f11, long j10, float f12);

    
    void mo183voiceMessagePlaybackFailedntcYbpo(String str, String str2);

    
    void mo184voiceMessagePlaybackStartedOuNwOLg(String str, float f10, float f11, long j10);
}
