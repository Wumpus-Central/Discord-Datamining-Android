...
public interface ChatEventHandler {
    ...
    public static final class DefaultImpls {
        ...
        public static  void m184onLinkClickedu7_MRrM$default(ChatEventHandler chatEventHandler, String str, String str2, String str3, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    str3 = null;
                }
        ...
        public static  void m185onTapButtonActionComponentNkFJqEg$default(ChatEventHandler chatEventHandler, String str, long j10, String str2, long j11, int[] iArr, int i10, Object obj) {
            if (obj == null) {
        ...
        public static  void m186onTapReactionu7_MRrM$default(ChatEventHandler chatEventHandler, String str, ReactionView.Reaction reaction, Boolean bool, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    bool = Boolean.FALSE;
                }
        ...
        public static  void m187onTapSelectActionComponentu7_MRrM$default(ChatEventHandler chatEventHandler, String str, long j10, SelectComponent selectComponent, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 2) != 0) {
                    j10 = 0;
                }
    ...
    void mo175onTapSummaryJumpsekaTiM(long j10, String str, String str2);

    void onTapSuppressNotificationsIcon();

    
    void mo176onTapTagEqy5D80(String str, long j10, String str2);

    
    void mo177onTapThreadEmbed1xi1bu0(String str);

    void onTapTimestamp(String str);

    
    void mo178onTapToggleBlockedMessages1xi1bu0(String str);

    void onTapUploadProgressClose(String str);

    
    void mo179onTapUsernamex5gers8(String str, long j10);

    
    void mo180onWelcomeReplyClickedAyv7vGE(Sticker sticker, String str);

    
    void mo181voiceMessagePlaybackEndedHuwN0RY(String str, float f10, float f11, long j10, float f12);

    
    void mo182voiceMessagePlaybackFailedntcYbpo(String str, String str2);

    
    void mo183voiceMessagePlaybackStartedOuNwOLg(String str, float f10, float f11, long j10);
}
