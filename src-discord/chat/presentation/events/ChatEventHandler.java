...
public interface ChatEventHandler {
    ...
    public static final class DefaultImpls {
        ...
        public static  void m199onLinkClickedu7_MRrM$default(ChatEventHandler chatEventHandler, String str, String str2, String str3, int i10, Object obj) {
            if (obj == null) {
                ...
                chatEventHandler.mo160onLinkClickedu7_MRrM(str, str2, str3);
                return;
            }
        ...
        public static  void m200onTapButtonActionComponentNkFJqEg$default(ChatEventHandler chatEventHandler, String str, long j10, String str2, long j11, int[] iArr, int i10, Object obj) {
            if (obj == null) {
                chatEventHandler.mo170onTapButtonActionComponentNkFJqEg(str, (i10 & 2) != 0 ? 0L : j10, str2, j11, iArr);
                return;
            }
    ...
    void mo157onInitiateEditpfaIj0E(String str, long j10);

    
    void mo158onInitiateReplypfaIj0E(String str, long j10);

    
    void mo159onLinkClickedntcYbpo(String str, LinkContentNode linkContentNode);

    
    void mo160onLinkClickedu7_MRrM(String str, String str2, String str3);

    void onLinkLongClicked(LinkContentNode linkContentNode);

    
    void mo161onLongPressAvatarx5gers8(String str, long j10);
    ...
    void mo162onLongPressReactionEqy5D80(String str, long j10, ReactionView.Reaction reaction);

    
    void mo163onLongPressUsernamex5gers8(String str, long j10);

    void onScrollStateChanged(ScrollState scrollState);

    
    void mo164onStickerClickedAyv7vGE(Sticker sticker, String str);

    
    void mo165onStickerLongClickedAyv7vGE(Sticker sticker, String str);

    
    void mo166onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11);

    
    void mo167onTapAutoModerationActionspfaIj0E(String str, long j10);

    
    void mo168onTapAutoModerationFeedbackpfaIj0E(String str, long j10);

    
    void mo169onTapAvatarx5gers8(String str, long j10);

    
    void mo170onTapButtonActionComponentNkFJqEg(String str, long j10, String str2, long j11, int[] iArr);

    
    void mo171onTapCallpfaIj0E(String str, long j10);
    ...
    void mo172onTapChannelPromptButtonEqy5D80(String str, long j10, String str2);
    ...
    void mo173onTapDismissMediaPostSharePrompt1xi1bu0(String str);

    void onTapEmoji(EmojiContentNode emojiContentNode);

    
    void mo174onTapFollowForumPostpfaIj0E(String str, long j10);

    
    void mo175onTapGiftCodeAcceptNU4t8f8(String str, String str2);

    void onTapGiftCodeEmbed(String str);

    
    void mo176onTapImagea6FnOk(String str, int i10, String str2, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num);

    
    void mo177onTapInviteEmbedAFFcxXc(String str, int i10, Boolean bool, Boolean bool2);

    
    void mo178onTapInviteToSpeak1xi1bu0(String str);

    
    void mo179onTapJoinActivity1xi1bu0(String str);
    ...
    void mo180onTapMessageReply0eiqbug(long j10, String str);

    
    void mo181onTapObscuredMediaLearnMore8a0ehIg(String str, long j10, String str2, String str3);
