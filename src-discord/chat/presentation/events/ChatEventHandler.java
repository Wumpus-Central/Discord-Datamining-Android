...
public interface ChatEventHandler {
    ...
    public static final class DefaultImpls {
        ...
        public static  void m199onLinkClickedu7_MRrM$default(ChatEventHandler chatEventHandler, String str, String str2, String str3, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    str3 = null;
                }
                chatEventHandler.mo161onLinkClickedu7_MRrM(str, str2, str3);
                return;
            }
        ...
        public static  void m200onTapButtonActionComponentNkFJqEg$default(ChatEventHandler chatEventHandler, String str, long j10, String str2, long j11, int[] iArr, int i10, Object obj) {
            if (obj == null) {
                chatEventHandler.mo171onTapButtonActionComponentNkFJqEg(str, (i10 & 2) != 0 ? 0L : j10, str2, j11, iArr);
                return;
            }
        ...
        public static  void m201onTapReactionu7_MRrM$default(ChatEventHandler chatEventHandler, String str, ReactionView.Reaction reaction, Boolean bool, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 4) != 0) {
                    bool = Boolean.FALSE;
                }
                chatEventHandler.mo183onTapReactionu7_MRrM(str, reaction, bool);
                return;
            }
        ...
        public static  void m202onTapSelectActionComponentu7_MRrM$default(ChatEventHandler chatEventHandler, String str, long j10, SelectComponent selectComponent, int i10, Object obj) {
            if (obj == null) {
                if ((i10 & 2) != 0) {
                    j10 = 0;
                }
                chatEventHandler.mo187onTapSelectActionComponentu7_MRrM(str, j10, selectComponent);
                return;
            }
    ...
    public static final class Empty implements ChatEventHandler {
        ...
        public void mo158onInitiateEditpfaIj0E(String messageId, long j10) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo159onInitiateReplypfaIj0E(String messageId, long j10) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo160onLinkClickedntcYbpo(String messageId, LinkContentNode node) {
            q.h(messageId, "messageId");
            q.h(node, "node");
        }
        ...
        public void mo161onLinkClickedu7_MRrM(String messageId, String url, String str) {
            q.h(messageId, "messageId");
            q.h(url, "url");
        }
        ...
        public void mo162onLongPressAvatarx5gers8(String messageId, long j10) {
            q.h(messageId, "messageId");
        }
        ...
        public void mo163onLongPressReactionEqy5D80(String messageId, long j10, ReactionView.Reaction reaction) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo164onLongPressUsernamex5gers8(String messageId, long j10) {
            q.h(messageId, "messageId");
        }
        ...
        public void mo165onStickerClickedAyv7vGE(Sticker sticker, String messageId) {
            q.h(sticker, "sticker");
            q.h(messageId, "messageId");
        }
        ...
        public void mo166onStickerLongClickedAyv7vGE(Sticker sticker, String messageId) {
            q.h(sticker, "sticker");
            q.h(messageId, "messageId");
        }
        ...
        public void mo167onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11) {
        }

        @Override 
        
        public void mo168onTapAutoModerationActionspfaIj0E(String messageId, long j10) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo169onTapAutoModerationFeedbackpfaIj0E(String messageId, long j10) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo170onTapAvatarx5gers8(String messageId, long j10) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo171onTapButtonActionComponentNkFJqEg(String messageId, long j10, String str, long j11, int[] indices) {
            q.h(messageId, "messageId");
            q.h(indices, "indices");
        }
        ...
        public void mo172onTapCallpfaIj0E(String messageId, long j10) {
            q.h(messageId, "messageId");
        }
        ...
        public void mo173onTapChannelPromptButtonEqy5D80(String messageId, long j10, String buttonType) {
            q.h(messageId, "messageId");
        ...
        public void mo174onTapDismissMediaPostSharePrompt1xi1bu0(String messageId) {
            q.h(messageId, "messageId");
        }
        ...
        public void mo175onTapFollowForumPostpfaIj0E(String messageId, long j10) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo176onTapGiftCodeAcceptNU4t8f8(String giftCode, String str) {
        ...
        public void mo177onTapImagea6FnOk(String messageId, int i10, String type, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num) {
            q.h(messageId, "messageId");
            q.h(type, "type");
        ...
        public void mo178onTapInviteEmbedAFFcxXc(String messageId, int i10, Boolean bool, Boolean bool2) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo179onTapInviteToSpeak1xi1bu0(String messageId) {
            q.h(messageId, "messageId");
        }

        @Override 
        
        public void mo180onTapJoinActivity1xi1bu0(String messageId) {
            q.h(messageId, "messageId");
        }
        ...
        public void mo181onTapMessageReply0eiqbug(long j10, String originId) {
    ...
    void mo158onInitiateEditpfaIj0E(String str, long j10);

    
    void mo159onInitiateReplypfaIj0E(String str, long j10);

    
    void mo160onLinkClickedntcYbpo(String str, LinkContentNode linkContentNode);

    
    void mo161onLinkClickedu7_MRrM(String str, String str2, String str3);

    void onLinkLongClicked(LinkContentNode linkContentNode);

    
    void mo162onLongPressAvatarx5gers8(String str, long j10);
    ...
    void mo163onLongPressReactionEqy5D80(String str, long j10, ReactionView.Reaction reaction);

    
    void mo164onLongPressUsernamex5gers8(String str, long j10);

    void onScrollStateChanged(ScrollState scrollState);

    
    void mo165onStickerClickedAyv7vGE(Sticker sticker, String str);

    
    void mo166onStickerLongClickedAyv7vGE(Sticker sticker, String str);

    
    void mo167onTapActivityBookmarkEmbeduU1mFKc(long j10, long j11);

    
    void mo168onTapAutoModerationActionspfaIj0E(String str, long j10);

    
    void mo169onTapAutoModerationFeedbackpfaIj0E(String str, long j10);

    
    void mo170onTapAvatarx5gers8(String str, long j10);

    
    void mo171onTapButtonActionComponentNkFJqEg(String str, long j10, String str2, long j11, int[] iArr);

    
    void mo172onTapCallpfaIj0E(String str, long j10);
    ...
    void mo173onTapChannelPromptButtonEqy5D80(String str, long j10, String str2);
    ...
    void mo174onTapDismissMediaPostSharePrompt1xi1bu0(String str);

    void onTapEmoji(EmojiContentNode emojiContentNode);

    
    void mo175onTapFollowForumPostpfaIj0E(String str, long j10);

    
    void mo176onTapGiftCodeAcceptNU4t8f8(String str, String str2);

    void onTapGiftCodeEmbed(String str);

    
    void mo177onTapImagea6FnOk(String str, int i10, String str2, int i11, int i12, int i13, int i14, ViewResizeMode viewResizeMode, Double d10, Integer num);

    
    void mo178onTapInviteEmbedAFFcxXc(String str, int i10, Boolean bool, Boolean bool2);

    
    void mo179onTapInviteToSpeak1xi1bu0(String str);

    
    void mo180onTapJoinActivity1xi1bu0(String str);
    ...
    void mo181onTapMessageReply0eiqbug(long j10, String str);

    void onTapOpTag();

    
    void mo182onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, String str);

    
    void mo183onTapReactionu7_MRrM(String str, ReactionView.Reaction reaction, Boolean bool);

    
    void mo184onTapReactionOverflowpfaIj0E(String str, long j10);

    
    void mo185onTapRemix1xi1bu0(String str);

    void onTapRoleIcon(String str, String str2);

    
    void mo186onTapSeeMore1xi1bu0(String str);

    
    void mo187onTapSelectActionComponentu7_MRrM(String str, long j10, SelectComponent selectComponent);

    
    void mo188onTapShareForumPostmgk6anA(long j10, long j11);

    void onTapShowAltText(String str);

    
    void mo189onTapSummarysekaTiM(long j10, String str, String str2);

    
    void mo190onTapSummaryJumpsekaTiM(long j10, String str, String str2);

    void onTapSuppressNotificationsIcon();

    
    void mo191onTapTagEqy5D80(String str, long j10, String str2);

    
    void mo192onTapThreadEmbed1xi1bu0(String str);

    void onTapTimestamp(String str);

    
    void mo193onTapToggleBlockedMessages1xi1bu0(String str);

    void onTapUploadProgressClose(String str);

    
    void mo194onTapUsernamex5gers8(String str, long j10);

    
    void mo195onWelcomeReplyClickedAyv7vGE(Sticker sticker, String str);

    
    void mo196voiceMessagePlaybackEndedHuwN0RY(String str, float f10, float f11, long j10, float f12);

    
    void mo197voiceMessagePlaybackFailedntcYbpo(String str, String str2);

    
    void mo198voiceMessagePlaybackStartedOuNwOLg(String str, float f10, float f11, long j10);
}
