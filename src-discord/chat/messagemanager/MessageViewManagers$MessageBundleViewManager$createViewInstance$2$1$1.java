...
public final class MessageViewManagers$MessageBundleViewManager$createViewInstance$2$1$1 extends s implements Function1<MessageId, Unit> {
    ...
    public MessageViewManagers$MessageBundleViewManager$createViewInstance$2$1$1(MessageViewManagers.MessageBundleViewManager messageBundleViewManager, ViewMeasuringWrapper<MessageBundleView> viewMeasuringWrapper) {
        super(1);
    ...
    public   Unit invoke(MessageId messageId) {
        m159invoke1xi1bu0(messageId.m651unboximpl());
        return Unit.f21601a;
    }

    
    public final void m159invoke1xi1bu0(String messageId) {
        q.h(messageId, "messageId");
        this.this$0.m158emitOnTruncateMessageAyv7vGE(this.$wrapper, messageId);
    }
}
