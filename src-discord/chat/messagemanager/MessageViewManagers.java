...
public final class MessageViewManagers {
    ...
    public static final class MessageBundleViewManager extends ViewGroupManager<ViewMeasuringWrapper<MessageBundleView>> {
        ...
        public final void m135emitOnTapReplyAyv7vGE(View view, String str) {
        ...
        public final void m136emitOnTruncateMessageJPrav84(Context context, int i10, String str) {
        ...
        public final void data(final ViewMeasuringWrapper<MessageBundleView> wrappedView, String data) {
            ...
            json.a();
            wrappedView.getView().setBundle((MessageBundleView.MessageBundle) json.b(MessageBundleView.MessageBundle.Companion.serializer(), data), new View.OnClickListener() { // from class: com.discord.chat.messagemanager.b
