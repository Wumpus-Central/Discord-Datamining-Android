...
public final class SeparatorSummaryViewBinding {
    ...
    private SeparatorSummaryViewBinding(View view, Guideline guideline, SimpleDraweeView simpleDraweeView, SimpleDraweeView simpleDraweeView2, Barrier barrier, SimpleDraweeView simpleDraweeView3, SimpleDraweeView simpleDraweeView4, TextView textView, SimpleDraweeView simpleDraweeView5, View view2, Guideline guideline2) {
        this.rootView = view;
                            ...
                            if (simpleDraweeView4 != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (!(simpleDraweeView5 == null || (a10 = a.a(view, (i10 = R.id.right_bar))) == null)) {
                                        ...
                                        if (guideline2 != null) {
                                            return new SeparatorSummaryViewBinding(view, guideline, simpleDraweeView, simpleDraweeView2, barrier, simpleDraweeView3, simpleDraweeView4, textView, simpleDraweeView5, a10, guideline2);
                                        }
                                    }
                                }
                            }
