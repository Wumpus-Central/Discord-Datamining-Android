...
public final class SegmentedControlView extends FrameLayout {
    ...
    static  void updateView$default(SegmentedControlView segmentedControlView, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            z10 = false;
        }
    ...
    private final <T> ReadWriteProperty<Object, T> updateViewOnChange(final T t10, final boolean z10) {
        kotlin.properties.a aVar = kotlin.properties.a.f21266a;
        return new c<T>(t10) { 
            @Override 
    ...
    static  ReadWriteProperty updateViewOnChange$default(SegmentedControlView segmentedControlView, Object obj, boolean z10, int i10, Object obj2) {
        if ((i10 & 2) != 0) {
            z10 = false;
        }
