...
public final class ValueChangeEvent implements ReactEvent {
    ...
    public  ValueChangeEvent(int i10, String str, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  ValueChangeEvent copy$default(ValueChangeEvent valueChangeEvent, String str, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(ValueChangeEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 1, self.selectedSegmentIndex);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.value, valueChangeEvent.value) && this.selectedSegmentIndex == valueChangeEvent.selectedSegmentIndex;
    }
