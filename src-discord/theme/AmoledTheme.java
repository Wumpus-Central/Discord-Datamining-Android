...
public final class AmoledTheme extends DiscordTheme {
    ...
    public AmoledTheme(Context context) {
        ...
        int i11 = R.color.dontuse_24;
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, R.color.android_navigation_scrim_background_amoled);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, R.color.android_ripple_amoled);
        int i12 = R.color.dontuse_17;
        this.backgroundAccent = ColorUtilsKt.getColorCompat(context, i12);
        int i13 = R.color.dontuse_23;
        this.backgroundFloating = ColorUtilsKt.getColorCompat(context, i13);
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, R.color.background_mentioned_amoled);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, R.color.background_mentioned_hover_amoled);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, R.color.background_message_automod_amoled);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, R.color.background_message_automod_hover_amoled);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, R.color.background_message_highlight_amoled);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, R.color.background_message_highlight_hover_amoled);
        int i14 = R.color.dontuse_21;
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, i14);
        int i15 = R.color.black_500;
        this.backgroundMobilePrimary = ColorUtilsKt.getColorCompat(context, i15);
        this.backgroundMobileSecondary = ColorUtilsKt.getColorCompat(context, R.color.dontuse_26);
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_accent_amoled);
        this.backgroundModifierAccent2 = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_accent_2_amoled);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_active_amoled);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_hover_amoled);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_selected_amoled);
        this.backgroundNestedFloating = ColorUtilsKt.getColorCompat(context, i15);
        this.backgroundPrimary = ColorUtilsKt.getColorCompat(context, i15);
        this.backgroundSecondary = ColorUtilsKt.getColorCompat(context, i13);
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i12);
        int i16 = R.color.dontuse_19;
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i16);
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, R.color.bg_backdrop_amoled);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i15);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i15);
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i15);
        this.bgModFaint = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_faint_amoled);
        this.bgModStrong = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_strong_amoled);
        this.bgModSubtle = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_subtle_amoled);
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i16);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i13);
        int i17 = R.color.dontuse_22;
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i17);
        this.black = ColorUtilsKt.getColorCompat(context, i15);
        this.blurFallback = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_amoled);
        this.blurFallbackPressed = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_pressed_amoled);
        this.borderFaint = ColorUtilsKt.getColorCompat(context, R.color.border_faint_amoled);
        this.borderStrong = ColorUtilsKt.getColorCompat(context, R.color.border_strong_amoled);
        this.borderSubtle = ColorUtilsKt.getColorCompat(context, R.color.border_subtle_amoled);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, R.color.bug_reporter_modal_submitting_background_amoled);
        int i18 = R.color.teal_430;
        this.buttonCreatorRevenueBackground = ColorUtilsKt.getColorCompat(context, i18);
        int i19 = R.color.red_430;
        this.buttonDangerBackground = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, R.color.red_530);
        this.buttonDangerBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, R.color.red_500);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_brand_background_amoled);
        int i20 = R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i20);
        int i21 = R.color.brand_500;
        this.buttonOutlineBrandBackgroundHover = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlineBrandBorder = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlineBrandBorderActive = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonOutlineBrandBorderHover = ColorUtilsKt.getColorCompat(context, i21);
        int i22 = R.color.white_500;
        this.buttonOutlineBrandText = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineBrandTextActive = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineBrandTextHover = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_danger_background_amoled);
        int i23 = R.color.red_460;
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i19);
        int i24 = R.color.red_400;
        this.buttonOutlineDangerBorder = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlineDangerBorderActive = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlineDangerBorderHover = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlineDangerText = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineDangerTextActive = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineDangerTextHover = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_positive_background_amoled);
        int i25 = R.color.green_530;
        this.buttonOutlinePositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i25);
        int i26 = R.color.green_430;
        this.buttonOutlinePositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i26);
        int i27 = R.color.green_360;
        this.buttonOutlinePositiveBorder = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonOutlinePositiveBorderActive = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonOutlinePositiveBorderHover = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonOutlinePositiveText = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlinePositiveTextActive = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlinePositiveTextHover = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_primary_background_amoled);
        int i28 = R.color.dontuse_11;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i28);
        int i29 = R.color.dontuse_13;
        this.buttonOutlinePrimaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i29);
        this.buttonOutlinePrimaryBorder = ColorUtilsKt.getColorCompat(context, R.color.primary_500);
        this.buttonOutlinePrimaryBorderActive = ColorUtilsKt.getColorCompat(context, i28);
        this.buttonOutlinePrimaryBorderHover = ColorUtilsKt.getColorCompat(context, i29);
        this.buttonOutlinePrimaryText = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlinePrimaryTextActive = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlinePrimaryTextHover = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonPositiveBackground = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonPositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonPositiveBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i29);
        int i30 = R.color.dontuse_10;
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i30);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i29);
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i28);
        this.cardGradientBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_bg_amoled);
        this.cardGradientPressedBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_pressed_bg_amoled);
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i17);
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, i11);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i13);
        int i31 = R.color.dontuse_25;
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, i31);
        ...
        int i32 = R.color.dontuse_9;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i32);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, i13);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i15);
        int i33 = R.color.dontuse_20;
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i33);
        int i34 = R.color.dontuse_16;
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i34);
        this.chatSwipeToReplyBackground = ColorUtilsKt.getColorCompat(context, i17);
        ...
        this.creatorRevenueIconGradientEnd = ColorUtilsKt.getColorCompat(context, i18);
        this.creatorRevenueIconGradientStart = ColorUtilsKt.getColorCompat(context, R.color.teal_360);
        this.creatorRevenueInfoBoxBackground = ColorUtilsKt.getColorCompat(context, R.color.creator_revenue_info_box_background_amoled);
        ...
        this.deprecatedCardBg = ColorUtilsKt.getColorCompat(context, R.color.deprecated_card_bg_amoled);
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, R.color.deprecated_card_editable_bg_amoled);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_400);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, R.color.deprecated_quickswitcher_input_placeholder_amoled);
        ...
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, R.color.deprecated_text_input_border_amoled);
        ...
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, R.color.display_banner_overflow_background_amoled);
        this.dividerStrong = ColorUtilsKt.getColorCompat(context, R.color.divider_strong_amoled);
        this.dividerSubtle = ColorUtilsKt.getColorCompat(context, R.color.divider_subtle_amoled);
        int i37 = R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i37);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, R.color.forum_post_extra_media_count_container_background_amoled);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, R.color.forum_post_tag_background_amoled);
        this.guildNotificationsBottomSheetPillBackground = ColorUtilsKt.getColorCompat(context, i10);
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i30);
        int i38 = R.color.dontuse_2;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i38);
        int i39 = R.color.dontuse_8;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i39);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_760);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, R.color.home_card_resting_border_amoled);
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i29);
        int i40 = R.color.dontuse_5;
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i40);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i32);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, R.color.info_box_background_amoled);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, R.color.info_danger_background_amoled);
        this.infoDangerForeground = ColorUtilsKt.getColorCompat(context, i24);
        this.infoDangerText = ColorUtilsKt.getColorCompat(context, i22);
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, R.color.info_help_background_amoled);
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i37);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i22);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, R.color.info_positive_background_amoled);
        this.infoPositiveForeground = ColorUtilsKt.getColorCompat(context, i27);
        this.infoPositiveText = ColorUtilsKt.getColorCompat(context, i22);
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, R.color.info_warning_background_amoled);
        int i41 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i41);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i22);
        this.inputBackground = ColorUtilsKt.getColorCompat(context, i17);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i32);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, R.color.dontuse_3);
        int i42 = R.color.dontuse_4;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i42);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i29);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i40);
        this.legacyAndroidBlurOverlayDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_default_amoled);
        this.legacyAndroidBlurOverlayUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_ultra_thin_amoled);
        this.legacyBlurFallbackDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_default_amoled);
        this.legacyBlurFallbackUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_ultra_thin_amoled);
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, R.color.live_stage_tile_border_amoled);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i22);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, R.color.mention_background_amoled);
        ...
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i12);
        this.profileGradientCardBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_card_background_amoled);
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_message_input_border_amoled);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_note_background_amoled);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_overlay_amoled);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_overlay_synced_with_user_theme_amoled);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_profile_body_background_hover_amoled);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_role_pill_background_amoled);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_role_pill_border_amoled);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_section_box_amoled);
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, i33);
        ...
        this.redesignActivityCardBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_activity_card_border_amoled);
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_630);
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i19);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonDangerText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonOverlayAlphaBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_overlay_alpha_background_amoled);
        this.redesignButtonOverlayAlphaPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_overlay_alpha_pressed_background_amoled);
        this.redesignButtonOverlayAlphaText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonOverlayBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i42);
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, i31);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i26);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, R.color.green_460);
        this.redesignButtonPositiveText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPrimaryAltBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_background_amoled);
        int i43 = R.color.brand_430;
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i43);
        this.redesignButtonPrimaryAltOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_on_blurple_background_amoled);
        this.redesignButtonPrimaryAltOnBlurpleBorder = ColorUtilsKt.getColorCompat(context, i22);
        int i44 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i44);
        this.redesignButtonPrimaryAltOnBlurplePressedBorder = ColorUtilsKt.getColorCompat(context, i35);
        this.redesignButtonPrimaryAltOnBlurpleText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPrimaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_pressed_background_amoled);
        this.redesignButtonPrimaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_pressed_border_amoled);
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i35);
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i43);
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignButtonPrimaryOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPrimaryOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, R.color.brand_200);
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i44);
        this.redesignButtonPrimaryOnBlurpleText = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignButtonPrimaryPressedBackground = ColorUtilsKt.getColorCompat(context, i20);
        this.redesignButtonPrimaryText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonSecondaryAltBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_alt_background_amoled);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_alt_pressed_background_amoled);
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i39);
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i42);
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_15);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_border_amoled);
        int i45 = R.color.dontuse_12;
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i45);
        this.redesignButtonSecondaryPressedBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_pressed_border_amoled);
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i42);
        this.redesignChannelCategoryNameText = ColorUtilsKt.getColorCompat(context, i39);
        this.redesignChannelMessagePreviewText = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignChannelNameMutedText = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i38);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, i17);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i12);
        this.redesignInputControlSelected = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignOnlyBackgroundActive = ColorUtilsKt.getColorCompat(context, i12);
        this.redesignOnlyBackgroundDefault = ColorUtilsKt.getColorCompat(context, i15);
        ...
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i33);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i12);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i34);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i31);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i33);
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, R.color.scrollbar_thin_track_amoled);
        this.spoilerHiddenBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_14);
        this.spoilerRevealedBackground = ColorUtilsKt.getColorCompat(context, R.color.spoiler_revealed_background_amoled);
        this.statusDanger = ColorUtilsKt.getColorCompat(context, i24);
        this.statusDangerBackground = ColorUtilsKt.getColorCompat(context, i24);
        this.statusDangerText = ColorUtilsKt.getColorCompat(context, i22);
        this.statusDnd = ColorUtilsKt.getColorCompat(context, i24);
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i41);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i32);
        this.statusOnline = ColorUtilsKt.getColorCompat(context, i27);
        this.statusPositive = ColorUtilsKt.getColorCompat(context, i27);
        this.statusPositiveBackground = ColorUtilsKt.getColorCompat(context, i26);
        this.statusPositiveText = ColorUtilsKt.getColorCompat(context, i22);
        this.statusSpeaking = ColorUtilsKt.getColorCompat(context, i27);
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i41);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i41);
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i15);
        this.textBrand = ColorUtilsKt.getColorCompat(context, i43);
        ...
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i45);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i32);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i30);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i28);
        ...
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i39);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i41);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i32);
        this.themeLockedBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.theme_locked_blur_fallback_amoled);
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, R.color.user_profile_header_overflow_background_amoled);
        this.voiceVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_tile_blur_fallback_amoled);
        this.voiceVideoVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_video_tile_blur_fallback_amoled);
        this.white = ColorUtilsKt.getColorCompat(context, i22);
    }
