...
public final class AmoledTheme extends DiscordTheme {
    ...
    public AmoledTheme(Context context) {
        ...
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, R.color.plum_21);
        ...
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, R.color.plum_3);
        int i42 = R.color.plum_4;
        ...
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, R.color.plum_15);
