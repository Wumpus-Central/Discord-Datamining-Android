...
public final class AmoledTheme extends DiscordTheme {
    ...
    public AmoledTheme(Context context) {
        ...
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i12);
        ...
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, R.color.dontuse_24);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i12);
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, R.color.dontuse_25);
        ...
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_800);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i14);
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i10);
        int i31 = R.color.primary_600;
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.deprecatedStoreBg = ColorUtilsKt.getColorCompat(context, i31);
        ...
        int i35 = R.color.dontuse_10;
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i35);
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, R.color.dontuse_2);
        int i36 = R.color.dontuse_8;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i36);
        ...
        int i37 = R.color.dontuse_13;
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i37);
        int i38 = R.color.dontuse_5;
        ...
        this.inputBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i39);
        int i41 = R.color.dontuse_20;
        this.inputPressedBackground = ColorUtilsKt.getColorCompat(context, i41);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, R.color.dontuse_3);
        int i42 = R.color.primary_230;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i42);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i31);
        int i43 = R.color.primary_630;
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i43);
        ...
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, i41);
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i13);
        int i44 = R.color.dontuse_11;
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i44);
        ...
        int i45 = R.color.primary_860;
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, i45);
        ...
        int i46 = R.color.brand_430;
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i46);
        ...
        int i47 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i47);
        ...
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i46);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i47);
        ...
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i36);
        int i48 = R.color.dontuse_4;
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i48);
        ...
        int i49 = R.color.dontuse_12;
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i49);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i48);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i11);
        ...
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i15);
        ...
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i10);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i43);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i31);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i45);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i10);
        ...
        this.textBrand = ColorUtilsKt.getColorCompat(context, i46);
        ...
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i49);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i39);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i35);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i44);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i48);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i48);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i36);
