...
public final class AmoledTheme extends DiscordTheme {
    ...
    public AmoledTheme(Context context) {
        ...
        int i41 = R.color.primary_230;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i41);
        ...
        int i42 = R.color.primary_630;
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i42);
        ...
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_20);
        ...
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i42);
        ...
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i41);
        int i43 = R.color.primary_860;
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, i43);
        ...
        int i46 = R.color.dontuse_4;
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i46);
        ...
        int i47 = R.color.dontuse_12;
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i47);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i46);
        ...
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i42);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i31);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i43);
        ...
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i47);
        ...
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, R.color.dontuse_11);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i46);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i46);
