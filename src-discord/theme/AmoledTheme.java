...
public final class AmoledTheme extends DiscordTheme {
    ...
    public AmoledTheme(Context context) {
        ...
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i14);
        ...
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i15);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i13);
        int i16 = R.color.dontuse_22;
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i16);
        this.black = ColorUtilsKt.getColorCompat(context, i14);
        ...
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i28);
        int i29 = R.color.dontuse_10;
        ...
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i16);
        ...
        int i30 = R.color.dontuse_25;
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, i30);
        ...
        int i31 = R.color.dontuse_9;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i31);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, i13);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i14);
        int i32 = R.color.dontuse_20;
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i32);
        int i33 = R.color.dontuse_16;
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i33);
        this.chatSwipeToReplyBackground = ColorUtilsKt.getColorCompat(context, i16);
        ...
        this.homeBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_18);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, R.color.home_card_resting_border_amoled);
        int i40 = R.color.dontuse_12;
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i40);
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, R.color.dontuse_5);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.inputBackground = ColorUtilsKt.getColorCompat(context, R.color.input_background_amoled);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i33);
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i12);
        this.navigatorHeaderTint = ColorUtilsKt.getColorCompat(context, i21);
        ...
        int i43 = R.color.primary_630;
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i43);
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i27);
        this.redesignActivityCardBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_activity_card_border_amoled);
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i43);
        ...
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, i30);
        ...
        int i44 = R.color.brand_430;
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i44);
        ...
        int i45 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i45);
        ...
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i44);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i45);
        ...
        this.redesignChannelMessagePreviewText = ColorUtilsKt.getColorCompat(context, i29);
        this.redesignChannelNameMutedText = ColorUtilsKt.getColorCompat(context, i29);
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i38);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_chat_input_background_amoled);
        ...
        this.redesignOnlyBackgroundRaised = ColorUtilsKt.getColorCompat(context, i43);
        this.redesignOnlyBackgroundSunken = ColorUtilsKt.getColorCompat(context, R.color.primary_660);
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i32);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i12);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i33);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i30);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i32);
        ...
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.statusSpeaking = ColorUtilsKt.getColorCompat(context, i26);
        ...
        this.textBrand = ColorUtilsKt.getColorCompat(context, i44);
        ...
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i40);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i31);
