...
public final class DarkerTheme extends DiscordTheme {
    ...
    public DarkerTheme(Context context) {
        ...
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, R.color.dontuse_21);
        ...
        int i16 = R.color.dontuse_20;
        this.backgroundPrimary = ColorUtilsKt.getColorCompat(context, i16);
        ...
        int i17 = R.color.dontuse_16;
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i17);
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, R.color.bg_backdrop_darker);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i16);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i16);
        ...
        int i18 = R.color.dontuse_17;
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i18);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i18);
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i12);
        int i19 = R.color.black_500;
        this.black = ColorUtilsKt.getColorCompat(context, i19);
        ...
        int i20 = R.color.teal_430;
        this.buttonCreatorRevenueBackground = ColorUtilsKt.getColorCompat(context, i20);
        int i21 = R.color.red_430;
        this.buttonDangerBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, R.color.red_530);
        this.buttonDangerBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i21);
        ...
        int i22 = R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i22);
        int i23 = R.color.brand_500;
        this.buttonOutlineBrandBackgroundHover = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineBrandBorder = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineBrandBorderActive = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineBrandBorderHover = ColorUtilsKt.getColorCompat(context, i23);
        int i24 = R.color.white_500;
        this.buttonOutlineBrandText = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlineBrandTextActive = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlineBrandTextHover = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_danger_background_darker);
        int i25 = R.color.red_460;
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonOutlineDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i21);
        int i26 = R.color.red_400;
        this.buttonOutlineDangerBorder = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonOutlineDangerBorderActive = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlineDangerBorderHover = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlineDangerText = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlineDangerTextActive = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlineDangerTextHover = ColorUtilsKt.getColorCompat(context, i24);
        ...
        int i27 = R.color.green_530;
        this.buttonOutlinePositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i27);
        int i28 = R.color.green_430;
        this.buttonOutlinePositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i28);
        int i29 = R.color.green_360;
        this.buttonOutlinePositiveBorder = ColorUtilsKt.getColorCompat(context, i29);
        this.buttonOutlinePositiveBorderActive = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonOutlinePositiveBorderHover = ColorUtilsKt.getColorCompat(context, i28);
        this.buttonOutlinePositiveText = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlinePositiveTextActive = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlinePositiveTextHover = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_primary_background_darker);
        int i30 = R.color.primary_430;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i30);
        int i31 = R.color.primary_500;
        this.buttonOutlinePrimaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i31);
        this.buttonOutlinePrimaryBorder = ColorUtilsKt.getColorCompat(context, i31);
        this.buttonOutlinePrimaryBorderActive = ColorUtilsKt.getColorCompat(context, i30);
        this.buttonOutlinePrimaryBorderHover = ColorUtilsKt.getColorCompat(context, i31);
        this.buttonOutlinePrimaryText = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlinePrimaryTextActive = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlinePrimaryTextHover = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonPositiveBackground = ColorUtilsKt.getColorCompat(context, i28);
        this.buttonPositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonPositiveBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i28);
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, R.color.green_500);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i31);
        int i32 = R.color.primary_400;
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i32);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i31);
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i30);
        this.channelIcon = ColorUtilsKt.getColorCompat(context, i32);
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, i30);
        ...
        this.creatorRevenueIconGradientEnd = ColorUtilsKt.getColorCompat(context, i20);
        ...
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, i32);
        ...
        int i37 = R.color.dontuse_10;
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i37);
        int i38 = R.color.dontuse_1;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i38);
        int i39 = R.color.dontuse_9;
        ...
        int i40 = R.color.dontuse_13;
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i40);
        int i41 = R.color.dontuse_3;
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i41);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i39);
        ...
        this.infoDangerForeground = ColorUtilsKt.getColorCompat(context, i26);
        this.infoDangerText = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i24);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, R.color.info_positive_background_darker);
        this.infoPositiveForeground = ColorUtilsKt.getColorCompat(context, i29);
        this.infoPositiveText = ColorUtilsKt.getColorCompat(context, i24);
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, R.color.info_warning_background_darker);
        int i42 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i42);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i24);
        this.inputBackground = ColorUtilsKt.getColorCompat(context, R.color.input_background_darker);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i39);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i38);
        int i43 = R.color.primary_230;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i43);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i40);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i41);
        ...
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_19);
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i32);
        this.redesignActivityCardBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_activity_card_border_darker);
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i25);
        this.redesignButtonDangerText = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignButtonOverlayAlphaText = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignButtonOverlayBackground = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i43);
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, R.color.primary_860);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i28);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, R.color.green_460);
        this.redesignButtonPositiveText = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignButtonPrimaryAltOnBlurpleBorder = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignButtonPrimaryAltOnBlurpleText = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonPrimaryOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignButtonPrimaryOnBlurpleText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonPrimaryPressedBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPrimaryText = ColorUtilsKt.getColorCompat(context, i24);
        ...
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i41);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i41);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_chat_input_background_darker);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i17);
        this.redesignInputControlSelected = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignOnlyBackgroundActive = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignOnlyBackgroundDefault = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i17);
        ...
        int i45 = R.color.primary_730;
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i45);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i45);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i45);
        ...
        this.statusDanger = ColorUtilsKt.getColorCompat(context, i26);
        this.statusDangerBackground = ColorUtilsKt.getColorCompat(context, i26);
        this.statusDangerText = ColorUtilsKt.getColorCompat(context, i24);
        this.statusDnd = ColorUtilsKt.getColorCompat(context, i26);
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i42);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i33);
        this.statusOnline = ColorUtilsKt.getColorCompat(context, i29);
        this.statusPositive = ColorUtilsKt.getColorCompat(context, i29);
        this.statusPositiveBackground = ColorUtilsKt.getColorCompat(context, i28);
        this.statusPositiveText = ColorUtilsKt.getColorCompat(context, i24);
        this.statusSpeaking = ColorUtilsKt.getColorCompat(context, i29);
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i42);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i42);
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i19);
        ...
        int i46 = R.color.dontuse_11;
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i46);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i46);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i37);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i46);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i41);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i41);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i39);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i42);
        ...
        this.white = ColorUtilsKt.getColorCompat(context, i24);
    }
