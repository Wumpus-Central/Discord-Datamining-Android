...
public final class DarkerTheme extends DiscordTheme {
    ...
    private final int inputPressedBackground;
    ...
    public DarkerTheme(Context context) {
        ...
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_830);
        ...
        int i33 = R.color.primary_360;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i33);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_560);
        int i34 = R.color.primary_600;
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i34);
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i10);
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i34);
        int i35 = R.color.brand_360;
        this.controlBrandForeground = ColorUtilsKt.getColorCompat(context, i35);
        this.controlBrandForegroundNew = ColorUtilsKt.getColorCompat(context, i35);
        ...
        int i36 = R.color.teal_400;
        this.creatorRevenueInfoBoxBorder = ColorUtilsKt.getColorCompat(context, i36);
        this.creatorRevenueLockedChannelIcon = ColorUtilsKt.getColorCompat(context, R.color.teal_345);
        this.creatorRevenueProgressBar = ColorUtilsKt.getColorCompat(context, i36);
        ...
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.deprecatedStoreBg = ColorUtilsKt.getColorCompat(context, i34);
        ...
        int i38 = R.color.dontuse_10;
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i38);
        int i39 = R.color.dontuse_1;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i39);
        int i40 = R.color.dontuse_9;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i40);
        ...
        int i41 = R.color.dontuse_13;
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i41);
        int i42 = R.color.dontuse_3;
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i42);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i40);
        ...
        int i43 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i43);
        ...
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i40);
        this.inputPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.input_pressed_background_darker);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i39);
        int i44 = R.color.primary_230;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i44);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i41);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i42);
        ...
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i34);
        int i45 = R.color.primary_630;
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i45);
        ...
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, i32);
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i38);
        ...
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i44);
        ...
        int i46 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i46);
        this.redesignButtonPrimaryAltOnBlurplePressedBorder = ColorUtilsKt.getColorCompat(context, i35);
        ...
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i35);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i46);
        ...
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i40);
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i42);
        ...
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_12);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i42);
        ...
        this.redesignOnlyBackgroundDefault = ColorUtilsKt.getColorCompat(context, i14);
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignOnlyBackgroundRaised = ColorUtilsKt.getColorCompat(context, i12);
        this.redesignOnlyBackgroundSunken = ColorUtilsKt.getColorCompat(context, i15);
        int i47 = R.color.primary_730;
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i47);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i45);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i47);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i45);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i47);
        ...
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i43);
        ...
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i43);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i43);
        ...
        int i48 = R.color.dontuse_11;
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i48);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i48);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i38);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i48);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i42);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i42);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i40);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i43);
    ...
    @Override 
    public int getInputPressedBackground() {
        return this.inputPressedBackground;
    }
