...
public final class DarkerTheme extends DiscordTheme {
    ...
    public DarkerTheme(Context context) {
        ...
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, R.color.plum_24);
        ...
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, R.color.plum_6);
        ...
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, R.color.plum_25);
        ...
        this.spoilerHiddenBackground = ColorUtilsKt.getColorCompat(context, R.color.plum_14);
