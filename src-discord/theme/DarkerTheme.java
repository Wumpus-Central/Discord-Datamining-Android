...
public final class DarkerTheme extends DiscordTheme {
    ...
    public DarkerTheme(Context context) {
        ...
        this.deprecatedStoreBg = ColorUtilsKt.getColorCompat(context, R.color.primary_600);
        ...
        int i36 = R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i36);
        ...
        int i37 = R.color.dontuse_1;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i30);
        int i38 = R.color.dontuse_3;
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i38);
        ...
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i36);
        ...
        int i39 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i39);
        ...
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i37);
        int i40 = R.color.dontuse_4;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i40);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i30);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i38);
        ...
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i40);
        ...
        int i41 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i41);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i41);
        ...
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i39);
        ...
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i39);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i39);
        ...
        this.textLink = ColorUtilsKt.getColorCompat(context, i36);
        ...
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i29);
        ...
        this.textWarning = ColorUtilsKt.getColorCompat(context, i39);
