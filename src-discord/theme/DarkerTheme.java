...
public final class DarkerTheme extends DiscordTheme {
    ...
    public DarkerTheme(Context context) {
        super(null);
        q.h(context, "context");
        int i10 = R.color.primary_700;
        this.activityCardBackground = ColorUtilsKt.getColorCompat(context, i10);
        this.androidNavigationBarBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_24);
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, R.color.android_navigation_scrim_background_darker);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, R.color.android_ripple_darker);
        int i11 = R.color.dontuse_15;
        this.backgroundAccent = ColorUtilsKt.getColorCompat(context, i11);
        int i12 = R.color.dontuse_18;
        this.backgroundFloating = ColorUtilsKt.getColorCompat(context, i12);
        this.backgroundMentioned = ColorUtilsKt.getColorCompat(context, R.color.background_mentioned_darker);
        this.backgroundMentionedHover = ColorUtilsKt.getColorCompat(context, R.color.background_mentioned_hover_darker);
        this.backgroundMessageAutomod = ColorUtilsKt.getColorCompat(context, R.color.background_message_automod_darker);
        this.backgroundMessageAutomodHover = ColorUtilsKt.getColorCompat(context, R.color.background_message_automod_hover_darker);
        this.backgroundMessageHighlight = ColorUtilsKt.getColorCompat(context, R.color.background_message_highlight_darker);
        this.backgroundMessageHighlightHover = ColorUtilsKt.getColorCompat(context, R.color.background_message_highlight_hover_darker);
        int i13 = R.color.dontuse_21;
        this.backgroundMessageHover = ColorUtilsKt.getColorCompat(context, i13);
        int i14 = R.color.dontuse_20;
        this.backgroundMobilePrimary = ColorUtilsKt.getColorCompat(context, i14);
        this.backgroundMobileSecondary = ColorUtilsKt.getColorCompat(context, i14);
        this.backgroundModifierAccent = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_accent_darker);
        this.backgroundModifierAccent2 = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_accent_2_darker);
        this.backgroundModifierActive = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_active_darker);
        this.backgroundModifierHover = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_hover_darker);
        this.backgroundModifierSelected = ColorUtilsKt.getColorCompat(context, R.color.background_modifier_selected_darker);
        int i15 = R.color.dontuse_22;
        this.backgroundNestedFloating = ColorUtilsKt.getColorCompat(context, i15);
        this.backgroundPrimary = ColorUtilsKt.getColorCompat(context, i14);
        this.backgroundSecondary = ColorUtilsKt.getColorCompat(context, i12);
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i11);
        int i16 = R.color.dontuse_16;
        this.backgroundTertiary = ColorUtilsKt.getColorCompat(context, i16);
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, R.color.bg_backdrop_darker);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i14);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i14);
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i15);
        this.bgModFaint = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_faint_darker);
        this.bgModStrong = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_strong_darker);
        this.bgModSubtle = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_subtle_darker);
        int i17 = R.color.dontuse_17;
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i17);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i17);
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i12);
        int i18 = R.color.black_500;
        this.black = ColorUtilsKt.getColorCompat(context, i18);
        this.blurFallback = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_darker);
        this.blurFallbackPressed = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_pressed_darker);
        this.borderFaint = ColorUtilsKt.getColorCompat(context, R.color.border_faint_darker);
        this.borderStrong = ColorUtilsKt.getColorCompat(context, R.color.border_strong_darker);
        this.borderSubtle = ColorUtilsKt.getColorCompat(context, R.color.border_subtle_darker);
        this.bugReporterModalSubmittingBackground = ColorUtilsKt.getColorCompat(context, R.color.bug_reporter_modal_submitting_background_darker);
        int i19 = R.color.teal_430;
        this.buttonCreatorRevenueBackground = ColorUtilsKt.getColorCompat(context, i19);
        int i20 = R.color.red_430;
        this.buttonDangerBackground = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, R.color.red_530);
        this.buttonDangerBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, R.color.red_500);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_brand_background_darker);
        int i21 = R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i21);
        int i22 = R.color.brand_500;
        this.buttonOutlineBrandBackgroundHover = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineBrandBorder = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlineBrandBorderActive = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlineBrandBorderHover = ColorUtilsKt.getColorCompat(context, i22);
        int i23 = R.color.white_500;
        this.buttonOutlineBrandText = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineBrandTextActive = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineBrandTextHover = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_danger_background_darker);
        int i24 = R.color.red_460;
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlineDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i20);
        int i25 = R.color.red_400;
        this.buttonOutlineDangerBorder = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonOutlineDangerBorderActive = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonOutlineDangerBorderHover = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonOutlineDangerText = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineDangerTextActive = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlineDangerTextHover = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_positive_background_darker);
        int i26 = R.color.green_530;
        this.buttonOutlinePositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i26);
        int i27 = R.color.green_430;
        this.buttonOutlinePositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i27);
        int i28 = R.color.green_360;
        this.buttonOutlinePositiveBorder = ColorUtilsKt.getColorCompat(context, i28);
        this.buttonOutlinePositiveBorderActive = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonOutlinePositiveBorderHover = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonOutlinePositiveText = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlinePositiveTextActive = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlinePositiveTextHover = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_primary_background_darker);
        int i29 = R.color.dontuse_11;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i29);
        int i30 = R.color.dontuse_13;
        this.buttonOutlinePrimaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i30);
        this.buttonOutlinePrimaryBorder = ColorUtilsKt.getColorCompat(context, R.color.primary_500);
        this.buttonOutlinePrimaryBorderActive = ColorUtilsKt.getColorCompat(context, i29);
        this.buttonOutlinePrimaryBorderHover = ColorUtilsKt.getColorCompat(context, i30);
        this.buttonOutlinePrimaryText = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlinePrimaryTextActive = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlinePrimaryTextHover = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonPositiveBackground = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonPositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonPositiveBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, R.color.green_500);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i30);
        int i31 = R.color.dontuse_10;
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i31);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i30);
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i29);
        this.cardGradientBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_bg_darker);
        this.cardGradientPressedBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_pressed_bg_darker);
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i12);
        int i32 = R.color.dontuse_19;
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, i32);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i32);
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, i13);
        this.channelIcon = ColorUtilsKt.getColorCompat(context, i31);
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, i29);
        int i33 = R.color.dontuse_9;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i33);
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i14);
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.chatSwipeToReplyBackground = ColorUtilsKt.getColorCompat(context, i15);
        int i34 = R.color.brand_360;
        this.controlBrandForeground = ColorUtilsKt.getColorCompat(context, i34);
        this.controlBrandForegroundNew = ColorUtilsKt.getColorCompat(context, i34);
        this.creatorRevenueIconGradientEnd = ColorUtilsKt.getColorCompat(context, i19);
        this.creatorRevenueIconGradientStart = ColorUtilsKt.getColorCompat(context, R.color.teal_360);
        this.creatorRevenueInfoBoxBackground = ColorUtilsKt.getColorCompat(context, R.color.creator_revenue_info_box_background_darker);
        int i35 = R.color.teal_400;
        this.creatorRevenueInfoBoxBorder = ColorUtilsKt.getColorCompat(context, i35);
        this.creatorRevenueLockedChannelIcon = ColorUtilsKt.getColorCompat(context, R.color.teal_345);
        this.creatorRevenueProgressBar = ColorUtilsKt.getColorCompat(context, i35);
        this.deprecatedCardBg = ColorUtilsKt.getColorCompat(context, R.color.deprecated_card_bg_darker);
        this.deprecatedCardEditableBg = ColorUtilsKt.getColorCompat(context, R.color.deprecated_card_editable_bg_darker);
        this.deprecatedQuickswitcherInputBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_400);
        this.deprecatedQuickswitcherInputPlaceholder = ColorUtilsKt.getColorCompat(context, R.color.deprecated_quickswitcher_input_placeholder_darker);
        int i36 = R.color.primary_600;
        this.deprecatedStoreBg = ColorUtilsKt.getColorCompat(context, i36);
        this.deprecatedTextInputBg = ColorUtilsKt.getColorCompat(context, i10);
        this.deprecatedTextInputBorder = ColorUtilsKt.getColorCompat(context, R.color.deprecated_text_input_border_darker);
        this.deprecatedTextInputBorderDisabled = ColorUtilsKt.getColorCompat(context, i10);
        this.deprecatedTextInputBorderHover = ColorUtilsKt.getColorCompat(context, R.color.primary_900);
        this.deprecatedTextInputPrefix = ColorUtilsKt.getColorCompat(context, R.color.primary_200);
        this.displayBannerOverflowBackground = ColorUtilsKt.getColorCompat(context, R.color.display_banner_overflow_background_darker);
        this.dividerStrong = ColorUtilsKt.getColorCompat(context, R.color.divider_strong_darker);
        this.dividerSubtle = ColorUtilsKt.getColorCompat(context, R.color.divider_subtle_darker);
        int i37 = R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i37);
        this.forumPostExtraMediaCountContainerBackground = ColorUtilsKt.getColorCompat(context, R.color.forum_post_extra_media_count_container_background_darker);
        this.forumPostTagBackground = ColorUtilsKt.getColorCompat(context, R.color.forum_post_tag_background_darker);
        this.guildNotificationsBottomSheetPillBackground = ColorUtilsKt.getColorCompat(context, i10);
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i31);
        int i38 = R.color.dontuse_1;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i38);
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i33);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, i12);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, R.color.home_card_resting_border_darker);
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i29);
        int i39 = R.color.dontuse_4;
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i39);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i33);
        this.infoBoxBackground = ColorUtilsKt.getColorCompat(context, R.color.info_box_background_darker);
        this.infoDangerBackground = ColorUtilsKt.getColorCompat(context, R.color.info_danger_background_darker);
        this.infoDangerForeground = ColorUtilsKt.getColorCompat(context, i25);
        this.infoDangerText = ColorUtilsKt.getColorCompat(context, i23);
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, R.color.info_help_background_darker);
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i37);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i23);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, R.color.info_positive_background_darker);
        this.infoPositiveForeground = ColorUtilsKt.getColorCompat(context, i28);
        this.infoPositiveText = ColorUtilsKt.getColorCompat(context, i23);
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, R.color.info_warning_background_darker);
        int i40 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i40);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i23);
        this.inputBackground = ColorUtilsKt.getColorCompat(context, R.color.input_background_darker);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i33);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i38);
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i39);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i30);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, R.color.dontuse_6);
        this.legacyAndroidBlurOverlayDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_default_darker);
        this.legacyAndroidBlurOverlayUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_ultra_thin_darker);
        this.legacyBlurFallbackDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_default_darker);
        this.legacyBlurFallbackUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_ultra_thin_darker);
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, R.color.live_stage_tile_border_darker);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i23);
        this.mentionBackground = ColorUtilsKt.getColorCompat(context, R.color.mention_background_darker);
        this.mentionForeground = ColorUtilsKt.getColorCompat(context, R.color.brand_230);
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.modalFooterBackground = ColorUtilsKt.getColorCompat(context, i17);
        this.navigatorHeaderTint = ColorUtilsKt.getColorCompat(context, i23);
        this.profileGradientCardBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_card_background_darker);
        this.profileGradientMessageInputBorder = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_message_input_border_darker);
        this.profileGradientNoteBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_note_background_darker);
        this.profileGradientOverlay = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_overlay_darker);
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_overlay_synced_with_user_theme_darker);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_profile_body_background_hover_darker);
        this.profileGradientRolePillBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_role_pill_background_darker);
        this.profileGradientRolePillBorder = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_role_pill_border_darker);
        this.profileGradientSectionBox = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_section_box_darker);
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_560);
        int i41 = R.color.primary_630;
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i41);
        this.redesignActivityCardBadgeIcon = ColorUtilsKt.getColorCompat(context, i31);
        this.redesignActivityCardBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_activity_card_border_darker);
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i17);
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i20);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i24);
        this.redesignButtonDangerText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonOverlayAlphaBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_overlay_alpha_background_darker);
        this.redesignButtonOverlayAlphaPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_overlay_alpha_pressed_background_darker);
        this.redesignButtonOverlayAlphaText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonOverlayBackground = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i39);
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, R.color.dontuse_25);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i27);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, R.color.green_460);
        this.redesignButtonPositiveText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonPrimaryAltBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_background_darker);
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i34);
        this.redesignButtonPrimaryAltOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_on_blurple_background_darker);
        this.redesignButtonPrimaryAltOnBlurpleBorder = ColorUtilsKt.getColorCompat(context, i23);
        int i42 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i42);
        this.redesignButtonPrimaryAltOnBlurplePressedBorder = ColorUtilsKt.getColorCompat(context, i34);
        this.redesignButtonPrimaryAltOnBlurpleText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonPrimaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_pressed_background_darker);
        this.redesignButtonPrimaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_primary_alt_pressed_border_darker);
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i34);
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i34);
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPrimaryOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonPrimaryOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, R.color.brand_200);
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i42);
        this.redesignButtonPrimaryOnBlurpleText = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPrimaryPressedBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.redesignButtonPrimaryText = ColorUtilsKt.getColorCompat(context, i23);
        this.redesignButtonSecondaryAltBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_alt_background_darker);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_alt_pressed_background_darker);
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i33);
        int i43 = R.color.dontuse_3;
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i43);
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_border_darker);
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonSecondaryPressedBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_pressed_border_darker);
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i43);
        this.redesignChannelCategoryNameText = ColorUtilsKt.getColorCompat(context, i33);
        this.redesignChannelMessagePreviewText = ColorUtilsKt.getColorCompat(context, i31);
        this.redesignChannelNameMutedText = ColorUtilsKt.getColorCompat(context, i31);
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i38);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_chat_input_background_darker);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignInputControlSelected = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignOnlyBackgroundActive = ColorUtilsKt.getColorCompat(context, R.color.primary_530);
        this.redesignOnlyBackgroundDefault = ColorUtilsKt.getColorCompat(context, i36);
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, R.color.primary_645);
        this.redesignOnlyBackgroundRaised = ColorUtilsKt.getColorCompat(context, i41);
        this.redesignOnlyBackgroundSunken = ColorUtilsKt.getColorCompat(context, R.color.primary_660);
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i13);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i17);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i13);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i17);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i13);
        this.scrollbarThinTrack = ColorUtilsKt.getColorCompat(context, R.color.scrollbar_thin_track_darker);
        this.spoilerHiddenBackground = ColorUtilsKt.getColorCompat(context, R.color.dontuse_14);
        this.spoilerRevealedBackground = ColorUtilsKt.getColorCompat(context, R.color.spoiler_revealed_background_darker);
        this.statusDanger = ColorUtilsKt.getColorCompat(context, i25);
        this.statusDangerBackground = ColorUtilsKt.getColorCompat(context, i25);
        this.statusDangerText = ColorUtilsKt.getColorCompat(context, i23);
        this.statusDnd = ColorUtilsKt.getColorCompat(context, i25);
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i40);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i33);
        this.statusOnline = ColorUtilsKt.getColorCompat(context, i28);
        this.statusPositive = ColorUtilsKt.getColorCompat(context, i28);
        this.statusPositiveBackground = ColorUtilsKt.getColorCompat(context, i27);
        this.statusPositiveText = ColorUtilsKt.getColorCompat(context, i23);
        this.statusSpeaking = ColorUtilsKt.getColorCompat(context, i28);
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i40);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i40);
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i18);
        this.textBrand = ColorUtilsKt.getColorCompat(context, i34);
        this.textDanger = ColorUtilsKt.getColorCompat(context, R.color.red_345);
        this.textLink = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.textMuted = ColorUtilsKt.getColorCompat(context, i31);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, R.color.primary_330);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i43);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i43);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i33);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i40);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i33);
        this.themeLockedBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.theme_locked_blur_fallback_darker);
        this.userProfileHeaderOverflowBackground = ColorUtilsKt.getColorCompat(context, R.color.user_profile_header_overflow_background_darker);
        this.voiceVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_tile_blur_fallback_darker);
        this.voiceVideoVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_video_tile_blur_fallback_darker);
        this.white = ColorUtilsKt.getColorCompat(context, i23);
    }
