...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        int i37 = R.color.primary_460;
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i37);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, i37);
        ...
        int i38 = R.color.primary_730;
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i38);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i38);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i38);
