...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        int i17 = R.color.red_500;
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i17);
        ...
        int i27 = R.color.green_500;
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i27);
        ...
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, i11);
        ...
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i17);
        this.redesignButtonFloatingBackground = ColorUtilsKt.getColorCompat(context, i20);
        ...
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, i27);
