...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, R.color.bg_backdrop_dark);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i13);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i14);
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i15);
        this.bgModFaint = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_faint_dark);
        this.bgModStrong = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_strong_dark);
        this.bgModSubtle = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_subtle_dark);
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i12);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i12);
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i13);
        int i16 = R.color.black_500;
        this.black = ColorUtilsKt.getColorCompat(context, i16);
        this.blurFallback = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_dark);
        this.blurFallbackPressed = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_pressed_dark);
        this.borderFaint = ColorUtilsKt.getColorCompat(context, R.color.border_faint_dark);
        ...
        this.cardGradientBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_bg_dark);
        this.cardGradientPressedBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_pressed_bg_dark);
        int i30 = R.color.primary_560;
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i30);
        int i31 = R.color.primary_645;
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, i31);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i30);
        ...
        int i33 = R.color.brand_360;
        this.controlBrandForeground = ColorUtilsKt.getColorCompat(context, i33);
        this.controlBrandForegroundNew = ColorUtilsKt.getColorCompat(context, i33);
        ...
        int i34 = R.color.teal_400;
        this.creatorRevenueInfoBoxBorder = ColorUtilsKt.getColorCompat(context, i34);
        this.creatorRevenueLockedChannelIcon = ColorUtilsKt.getColorCompat(context, R.color.teal_345);
        this.creatorRevenueProgressBar = ColorUtilsKt.getColorCompat(context, i34);
        ...
        int i35 = R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i35);
        ...
        this.headerMuted = ColorUtilsKt.getColorCompat(context, i32);
        int i36 = R.color.primary_130;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i36);
        int i37 = R.color.primary_330;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i37);
        this.homeBackground = ColorUtilsKt.getColorCompat(context, i31);
        this.homeCardRestingBorder = ColorUtilsKt.getColorCompat(context, R.color.home_card_resting_border_dark);
        this.iconMuted = ColorUtilsKt.getColorCompat(context, i28);
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i36);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i35);
        ...
        int i38 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i38);
        ...
        this.inputPressedBackground = ColorUtilsKt.getColorCompat(context, i15);
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i21);
        int i39 = R.color.primary_230;
        ...
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i37);
        this.legacyAndroidBlurOverlayDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_default_dark);
        this.legacyAndroidBlurOverlayUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_ultra_thin_dark);
        this.legacyBlurFallbackDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_default_dark);
        this.legacyBlurFallbackUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_ultra_thin_dark);
        ...
        this.profileGradientCardBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_card_background_dark);
        ...
        this.redesignActivityCardOverflowBackground = ColorUtilsKt.getColorCompat(context, i14);
        ...
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i33);
        ...
        int i40 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i40);
        this.redesignButtonPrimaryAltOnBlurplePressedBorder = ColorUtilsKt.getColorCompat(context, i33);
        ...
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i33);
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i33);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i40);
        ...
        this.redesignButtonSecondaryAltBackground = ColorUtilsKt.getColorCompat(context, i15);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonSecondaryAltPressedText = ColorUtilsKt.getColorCompat(context, i37);
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i39);
        ...
        this.redesignButtonSecondaryPressedBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_pressed_border_dark);
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i39);
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, i10);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.redesignOnlyBackgroundDefault = ColorUtilsKt.getColorCompat(context, i13);
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i31);
        ...
        int i41 = R.color.primary_730;
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i41);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i41);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i41);
        ...
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i38);
        ...
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i38);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i38);
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i16);
        this.textBrand = ColorUtilsKt.getColorCompat(context, i33);
        this.textDanger = ColorUtilsKt.getColorCompat(context, R.color.red_345);
        this.textLink = ColorUtilsKt.getColorCompat(context, i35);
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, R.color.blue_330);
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i32);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i32);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i32);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i37);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i39);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textPrimary = ColorUtilsKt.getColorCompat(context, i39);
        this.textSecondary = ColorUtilsKt.getColorCompat(context, i37);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i38);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i32);
        this.themeLockedBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.theme_locked_blur_fallback_dark);
        ...
        this.voiceVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_tile_blur_fallback_dark);
        this.voiceVideoVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_video_tile_blur_fallback_dark);
