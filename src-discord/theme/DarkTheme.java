...
public final class DarkTheme extends DiscordTheme {
    ...
    private final int redesignButtonSecondaryAltBorder;
    private final int redesignButtonSecondaryAltPressedBackground;
    private final int redesignButtonSecondaryAltPressedBorder;
    ...
    public DarkTheme(Context context) {
        ...
        int i16 = R.color.red_430;
        this.buttonDangerBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.buttonDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, R.color.red_530);
        this.buttonDangerBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i16);
        ...
        int i20 = R.color.red_460;
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonOutlineDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i16);
        int i21 = R.color.red_400;
        this.buttonOutlineDangerBorder = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlineDangerBorderActive = ColorUtilsKt.getColorCompat(context, i16);
        this.buttonOutlineDangerBorderHover = ColorUtilsKt.getColorCompat(context, i16);
        ...
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i26);
        int i27 = R.color.primary_400;
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i25);
        this.channelIcon = ColorUtilsKt.getColorCompat(context, i27);
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, i25);
        ...
        this.infoDangerForeground = ColorUtilsKt.getColorCompat(context, i21);
        ...
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i26);
        ...
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i20);
        this.redesignButtonDangerText = ColorUtilsKt.getColorCompat(context, i19);
        ...
        this.redesignButtonPositiveText = ColorUtilsKt.getColorCompat(context, i19);
        ...
        this.redesignButtonPrimaryAltBorder = ColorUtilsKt.getColorCompat(context, i30);
        ...
        this.redesignButtonPrimaryAltOnBlurpleBorder = ColorUtilsKt.getColorCompat(context, i19);
        int i36 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i36);
        this.redesignButtonPrimaryAltOnBlurplePressedBorder = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonPrimaryAltOnBlurpleText = ColorUtilsKt.getColorCompat(context, i19);
        ...
        int i37 = R.color.brand_330;
        this.redesignButtonPrimaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, i37);
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i37);
        this.redesignButtonPrimaryAltText = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.redesignButtonPrimaryOnBlurpleBackground = ColorUtilsKt.getColorCompat(context, i19);
        ...
        this.redesignButtonPrimaryOnBlurpleText = ColorUtilsKt.getColorCompat(context, i18);
        this.redesignButtonPrimaryPressedBackground = ColorUtilsKt.getColorCompat(context, i17);
        this.redesignButtonPrimaryText = ColorUtilsKt.getColorCompat(context, i19);
        this.redesignButtonSecondaryAltBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonSecondaryAltBorder = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, i29);
        this.redesignButtonSecondaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, i29);
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i26);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, i26);
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i19);
        ...
        this.statusDanger = ColorUtilsKt.getColorCompat(context, i21);
        this.statusDangerBackground = ColorUtilsKt.getColorCompat(context, i21);
        this.statusDangerText = ColorUtilsKt.getColorCompat(context, i19);
        this.statusDnd = ColorUtilsKt.getColorCompat(context, i21);
    ...
    @Override // com.discord.theme.DiscordTheme
    public int getRedesignButtonSecondaryAltBorder() {
        return this.redesignButtonSecondaryAltBorder;
    }
    ...
    @Override // com.discord.theme.DiscordTheme
    public int getRedesignButtonSecondaryAltPressedBorder() {
        return this.redesignButtonSecondaryAltPressedBorder;
    }
