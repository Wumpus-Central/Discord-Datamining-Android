...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        int i29 = R.color.brand_360;
        this.controlBrandForeground = ColorUtilsKt.getColorCompat(context, i29);
        this.controlBrandForegroundNew = ColorUtilsKt.getColorCompat(context, i29);
        ...
        int i30 = R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i30);
        ...
        int i31 = R.color.primary_330;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i30);
        ...
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i31);
        ...
        int i34 = R.color.primary_730;
        this.redesignButtonFloatingPressedBackground = ColorUtilsKt.getColorCompat(context, i34);
        ...
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i34);
        ...
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i34);
        ...
        this.textBrand = ColorUtilsKt.getColorCompat(context, i29);
        this.textDanger = ColorUtilsKt.getColorCompat(context, R.color.red_345);
        this.textLink = ColorUtilsKt.getColorCompat(context, i30);
