...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        int i35 = R.color.primary_130;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i35);
        int i36 = R.color.primary_330;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i36);
        int i37 = R.color.primary_645;
        this.homeBackground = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.iconPrimary = ColorUtilsKt.getColorCompat(context, i35);
        this.iconSecondary = ColorUtilsKt.getColorCompat(context, i36);
        ...
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i36);
        ...
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.textLowContrast = ColorUtilsKt.getColorCompat(context, i30);
        this.textMessagePreviewLowSat = ColorUtilsKt.getColorCompat(context, i30);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i30);
        this.textMutedOnDefault = ColorUtilsKt.getColorCompat(context, i36);
