...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        this.androidNavigationScrimBackground = ColorUtilsKt.getColorCompat(context, R.color.android_navigation_scrim_background_dark);
        this.androidRipple = ColorUtilsKt.getColorCompat(context, R.color.android_ripple_dark);
        this.backgroundAccent = ColorUtilsKt.getColorCompat(context, R.color.primary_530);
        ...
        int i11 = R.color.primary_600;
        this.backgroundMobilePrimary = ColorUtilsKt.getColorCompat(context, i11);
        int i12 = R.color.primary_630;
        this.backgroundMobileSecondary = ColorUtilsKt.getColorCompat(context, i12);
        ...
        this.backgroundNestedFloating = ColorUtilsKt.getColorCompat(context, i12);
        this.backgroundPrimary = ColorUtilsKt.getColorCompat(context, i11);
        this.backgroundSecondary = ColorUtilsKt.getColorCompat(context, i12);
        int i13 = R.color.primary_660;
        this.backgroundSecondaryAlt = ColorUtilsKt.getColorCompat(context, i13);
        ...
        int i15 = R.color.red_430;
        this.buttonDangerBackground = ColorUtilsKt.getColorCompat(context, i15);
        this.buttonDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, R.color.red_530);
        this.buttonDangerBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i15);
        int i16 = R.color.red_500;
        this.buttonDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i16);
        this.buttonOutlineBrandBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_brand_background_dark);
        int i17 = R.color.brand_560;
        this.buttonOutlineBrandBackgroundActive = ColorUtilsKt.getColorCompat(context, i17);
        int i18 = R.color.brand_500;
        this.buttonOutlineBrandBackgroundHover = ColorUtilsKt.getColorCompat(context, i18);
        this.buttonOutlineBrandBorder = ColorUtilsKt.getColorCompat(context, i18);
        this.buttonOutlineBrandBorderActive = ColorUtilsKt.getColorCompat(context, i17);
        this.buttonOutlineBrandBorderHover = ColorUtilsKt.getColorCompat(context, i18);
        int i19 = R.color.white_500;
        this.buttonOutlineBrandText = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlineBrandTextActive = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlineBrandTextHover = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlineDangerBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_danger_background_dark);
        this.buttonOutlineDangerBackgroundActive = ColorUtilsKt.getColorCompat(context, R.color.red_460);
        this.buttonOutlineDangerBackgroundHover = ColorUtilsKt.getColorCompat(context, i15);
        int i20 = R.color.red_400;
        this.buttonOutlineDangerBorder = ColorUtilsKt.getColorCompat(context, i20);
        this.buttonOutlineDangerBorderActive = ColorUtilsKt.getColorCompat(context, i15);
        this.buttonOutlineDangerBorderHover = ColorUtilsKt.getColorCompat(context, i15);
        this.buttonOutlineDangerText = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlineDangerTextActive = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlineDangerTextHover = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePositiveBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_positive_background_dark);
        int i21 = R.color.green_530;
        this.buttonOutlinePositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i21);
        int i22 = R.color.green_430;
        this.buttonOutlinePositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i22);
        int i23 = R.color.green_360;
        this.buttonOutlinePositiveBorder = ColorUtilsKt.getColorCompat(context, i23);
        this.buttonOutlinePositiveBorderActive = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonOutlinePositiveBorderHover = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonOutlinePositiveText = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePositiveTextActive = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePositiveTextHover = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePrimaryBackground = ColorUtilsKt.getColorCompat(context, R.color.button_outline_primary_background_dark);
        int i24 = R.color.primary_430;
        this.buttonOutlinePrimaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i24);
        int i25 = R.color.primary_500;
        this.buttonOutlinePrimaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonOutlinePrimaryBorder = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonOutlinePrimaryBorderActive = ColorUtilsKt.getColorCompat(context, i24);
        this.buttonOutlinePrimaryBorderHover = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonOutlinePrimaryText = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePrimaryTextActive = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonOutlinePrimaryTextHover = ColorUtilsKt.getColorCompat(context, i19);
        this.buttonPositiveBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.buttonPositiveBackgroundActive = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonPositiveBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i22);
        int i26 = R.color.green_500;
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i26);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i25);
        int i27 = R.color.primary_400;
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i27);
        this.buttonSecondaryBackgroundDisabled = ColorUtilsKt.getColorCompat(context, i25);
        this.buttonSecondaryBackgroundHover = ColorUtilsKt.getColorCompat(context, i24);
        this.channelIcon = ColorUtilsKt.getColorCompat(context, i27);
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, i24);
        int i28 = R.color.primary_360;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i28);
        int i29 = R.color.primary_560;
        this.channeltextareaBackground = ColorUtilsKt.getColorCompat(context, i29);
        this.chatBackground = ColorUtilsKt.getColorCompat(context, i11);
        this.chatBorder = ColorUtilsKt.getColorCompat(context, i10);
        this.chatInputContainerBackground = ColorUtilsKt.getColorCompat(context, i11);
        int i30 = R.color.brand_360;
        this.controlBrandForeground = ColorUtilsKt.getColorCompat(context, i30);
        this.controlBrandForegroundNew = ColorUtilsKt.getColorCompat(context, i30);
        ...
        int i31 = R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i31);
        ...
        int i32 = R.color.primary_330;
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i32);
        ...
        this.infoDangerForeground = ColorUtilsKt.getColorCompat(context, i20);
        this.infoDangerText = ColorUtilsKt.getColorCompat(context, i19);
        this.infoHelpBackground = ColorUtilsKt.getColorCompat(context, R.color.info_help_background_dark);
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i31);
        this.infoHelpText = ColorUtilsKt.getColorCompat(context, i19);
        this.infoPositiveBackground = ColorUtilsKt.getColorCompat(context, R.color.info_positive_background_dark);
        this.infoPositiveForeground = ColorUtilsKt.getColorCompat(context, i23);
        this.infoPositiveText = ColorUtilsKt.getColorCompat(context, i19);
        this.infoWarningBackground = ColorUtilsKt.getColorCompat(context, R.color.info_warning_background_dark);
        int i33 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i33);
        this.infoWarningText = ColorUtilsKt.getColorCompat(context, i19);
        ...
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i19);
        int i34 = R.color.primary_230;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i34);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i25);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i32);
        this.liveStageTileBorder = ColorUtilsKt.getColorCompat(context, R.color.live_stage_tile_border_dark);
        this.logoPrimary = ColorUtilsKt.getColorCompat(context, i19);
        ...
        this.modalBackground = ColorUtilsKt.getColorCompat(context, i11);
        ...
        this.profileGradientOverlaySyncedWithUserTheme = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_overlay_synced_with_user_theme_dark);
        this.profileGradientProfileBodyBackgroundHover = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_profile_body_background_hover_dark);
        ...
        this.redesignActivityCardBackground = ColorUtilsKt.getColorCompat(context, i29);
        this.redesignActivityCardBackgroundPressed = ColorUtilsKt.getColorCompat(context, i12);
        this.redesignButtonDangerBackground = ColorUtilsKt.getColorCompat(context, i15);
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i16);
        this.redesignButtonFloatingBackground = ColorUtilsKt.getColorCompat(context, i19);
        int i35 = R.color.primary_730;
        this.redesignButtonFloatingPressedBackground = ColorUtilsKt.getColorCompat(context, i35);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, i26);
        this.redesignButtonPrimaryBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.redesignButtonPrimaryPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.brand_600);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_border_dark);
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i10);
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i35);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i12);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i35);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i12);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i35);
        ...
        this.spoilerRevealedBackground = ColorUtilsKt.getColorCompat(context, i13);
        this.statusDanger = ColorUtilsKt.getColorCompat(context, i20);
        this.statusDangerBackground = ColorUtilsKt.getColorCompat(context, i20);
        this.statusDangerText = ColorUtilsKt.getColorCompat(context, i19);
        this.statusDnd = ColorUtilsKt.getColorCompat(context, i20);
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i33);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i28);
        this.statusOnline = ColorUtilsKt.getColorCompat(context, i23);
        this.statusPositive = ColorUtilsKt.getColorCompat(context, i23);
        this.statusPositiveBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.statusPositiveText = ColorUtilsKt.getColorCompat(context, i19);
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i33);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i33);
        this.statusWarningText = ColorUtilsKt.getColorCompat(context, i14);
        this.textBrand = ColorUtilsKt.getColorCompat(context, i30);
        this.textDanger = ColorUtilsKt.getColorCompat(context, R.color.red_345);
        this.textLink = ColorUtilsKt.getColorCompat(context, i31);
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, R.color.blue_330);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i28);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i34);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i33);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i28);
        ...
        this.white = ColorUtilsKt.getColorCompat(context, i19);
    }
