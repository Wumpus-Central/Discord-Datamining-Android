...
public final class DarkTheme extends DiscordTheme {
    ...
    private final int redesignButtonOverlayAlphaBorder;
    ...
    public DarkTheme(Context context) {
        ...
        int i32 = R.color.blue_345;
        this.focusPrimary = ColorUtilsKt.getColorCompat(context, i32);
        ...
        this.infoHelpForeground = ColorUtilsKt.getColorCompat(context, i32);
        ...
        int i34 = R.color.yellow_300;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i34);
        ...
        int i35 = R.color.primary_230;
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i35);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i27);
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i33);
        ...
        this.redesignButtonOverlayAlphaBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_overlay_alpha_border_dark);
        ...
        this.redesignButtonOverlayPressedBackground = ColorUtilsKt.getColorCompat(context, i35);
        ...
        this.redesignButtonSecondaryAltBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_alt_border_dark);
        this.redesignButtonSecondaryAltPressedBackground = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i20);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i20);
        ...
        int i37 = R.color.primary_730;
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, i37);
        this.scrollbarAutoScrollbarColorTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i37);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i34);
        ...
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i34);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i34);
        ...
        this.textLink = ColorUtilsKt.getColorCompat(context, i32);
        ...
        this.textNormal = ColorUtilsKt.getColorCompat(context, i35);
        this.textPositive = ColorUtilsKt.getColorCompat(context, R.color.green_330);
        this.textWarning = ColorUtilsKt.getColorCompat(context, i34);
    ...
    @Override // com.discord.theme.DiscordTheme
    public int getRedesignButtonOverlayAlphaBorder() {
        return this.redesignButtonOverlayAlphaBorder;
    }
