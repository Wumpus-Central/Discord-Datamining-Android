...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        int i36 = R.color.primary_730;
        this.redesignButtonFloatingPressedBackground = ColorUtilsKt.getColorCompat(context, i36);
        ...
        int i38 = R.color.brand_330;
        this.redesignButtonPrimaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, i38);
        this.redesignButtonPrimaryAltPressedText = ColorUtilsKt.getColorCompat(context, i38);
        ...
        this.redesignButtonSecondaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, i30);
        this.redesignButtonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i27);
        this.redesignButtonSecondaryBorder = ColorUtilsKt.getColorCompat(context, i27);
        ...
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i36);
        this.scrollbarAutoTrack = ColorUtilsKt.getColorCompat(context, i14);
        this.scrollbarThinThumb = ColorUtilsKt.getColorCompat(context, i36);
