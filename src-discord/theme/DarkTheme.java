...
public final class DarkTheme extends DiscordTheme {
    ...
    public DarkTheme(Context context) {
        ...
        this.redesignChannelCategoryNameText = ColorUtilsKt.getColorCompat(context, i37);
        this.redesignChannelMessagePreviewText = ColorUtilsKt.getColorCompat(context, i32);
        this.redesignChannelNameMutedText = ColorUtilsKt.getColorCompat(context, i32);
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i36);
