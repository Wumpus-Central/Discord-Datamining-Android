...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        int i29 = R.color.primary_300;
        this.deprecatedTextInputBorderHover = ColorUtilsKt.getColorCompat(context, i29);
        this.deprecatedTextInputPrefix = ColorUtilsKt.getColorCompat(context, i29);
        ...
        int i30 = R.color.primary_860;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i30);
        ...
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i30);
        ...
        this.redesignButtonOverlayAlphaBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_overlay_alpha_border_light);
        ...
        int i34 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i34);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i34);
        ...
        this.redesignButtonSecondaryAltBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_alt_border_light);
        ...
        int i35 = R.color.primary_700;
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i35);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i35);
        ...
        this.redesignOnlyBackgroundOverlay = ColorUtilsKt.getColorCompat(context, i10);
        this.redesignOnlyBackgroundRaised = ColorUtilsKt.getColorCompat(context, i13);
        this.redesignOnlyBackgroundSunken = ColorUtilsKt.getColorCompat(context, i10);
        ...
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i29);
        ...
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, i31);
