...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        this.bgBackdrop = ColorUtilsKt.getColorCompat(context, R.color.bg_backdrop_light);
        this.bgBasePrimary = ColorUtilsKt.getColorCompat(context, i10);
        this.bgBaseSecondary = ColorUtilsKt.getColorCompat(context, i13);
        this.bgBaseTertiary = ColorUtilsKt.getColorCompat(context, i14);
        this.bgModFaint = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_faint_light);
        this.bgModStrong = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_strong_light);
        this.bgModSubtle = ColorUtilsKt.getColorCompat(context, R.color.bg_mod_subtle_light);
        this.bgSurfaceOverlay = ColorUtilsKt.getColorCompat(context, i10);
        this.bgSurfaceOverlayTmp = ColorUtilsKt.getColorCompat(context, i13);
        this.bgSurfaceRaised = ColorUtilsKt.getColorCompat(context, i10);
        int i16 = R.color.black_500;
        this.black = ColorUtilsKt.getColorCompat(context, i16);
        this.blurFallback = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_light);
        this.blurFallbackPressed = ColorUtilsKt.getColorCompat(context, R.color.blur_fallback_pressed_light);
        this.borderFaint = ColorUtilsKt.getColorCompat(context, R.color.border_faint_light);
        ...
        this.cardGradientBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_bg_light);
        this.cardGradientPressedBg = ColorUtilsKt.getColorCompat(context, R.color.card_gradient_pressed_bg_light);
        this.cardPrimaryBg = ColorUtilsKt.getColorCompat(context, i10);
        this.cardPrimaryPressedBg = ColorUtilsKt.getColorCompat(context, i14);
        this.cardSecondaryBg = ColorUtilsKt.getColorCompat(context, i10);
        this.cardSecondaryPressedBg = ColorUtilsKt.getColorCompat(context, i14);
        ...
        this.inputBackground = ColorUtilsKt.getColorCompat(context, R.color.input_background_light);
        this.inputPlaceholderText = ColorUtilsKt.getColorCompat(context, i27);
        this.inputPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.input_pressed_background_light);
        ...
        this.legacyAndroidBlurOverlayDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_default_light);
        this.legacyAndroidBlurOverlayUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_android_blur_overlay_ultra_thin_light);
        this.legacyBlurFallbackDefault = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_default_light);
        this.legacyBlurFallbackUltraThin = ColorUtilsKt.getColorCompat(context, R.color.legacy_blur_fallback_ultra_thin_light);
        ...
        this.profileGradientCardBackground = ColorUtilsKt.getColorCompat(context, R.color.profile_gradient_card_background_light);
        ...
        this.redesignChatInputBackground = ColorUtilsKt.getColorCompat(context, R.color.redesign_chat_input_background_light);
        this.redesignInputControlActiveBg = ColorUtilsKt.getColorCompat(context, i10);
        ...
        this.statusSpeaking = ColorUtilsKt.getColorCompat(context, R.color.green_360);
        ...
        this.themeLockedBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.theme_locked_blur_fallback_light);
        ...
        this.voiceVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_tile_blur_fallback_light);
        this.voiceVideoVideoTileBlurFallback = ColorUtilsKt.getColorCompat(context, R.color.voice_video_video_tile_blur_fallback_light);
