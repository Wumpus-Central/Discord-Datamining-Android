...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        int i33 = R.color.brand_530;
        this.redesignButtonPrimaryAltOnBlurplePressedBackground = ColorUtilsKt.getColorCompat(context, i33);
        ...
        this.redesignButtonPrimaryOnBlurplePressedText = ColorUtilsKt.getColorCompat(context, i33);
        ...
        this.redesignButtonSecondaryAltPressedBorder = ColorUtilsKt.getColorCompat(context, R.color.redesign_button_secondary_alt_pressed_border_light);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, R.color.primary_700);
        ...
        this.scrollbarAutoScrollbarColorThumb = ColorUtilsKt.getColorCompat(context, R.color.primary_230);
