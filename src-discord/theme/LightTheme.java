...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        this.chatSwipeToReplyBackground = ColorUtilsKt.getColorCompat(context, i14);
        ...
        this.redesignChannelCategoryNameText = ColorUtilsKt.getColorCompat(context, i27);
        ...
        this.redesignChannelNameText = ColorUtilsKt.getColorCompat(context, i33);
