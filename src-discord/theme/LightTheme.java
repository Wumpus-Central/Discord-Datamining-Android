...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        int i29 = R.color.teal_400;
        this.creatorRevenueIconGradientEnd = ColorUtilsKt.getColorCompat(context, i29);
        int i30 = R.color.teal_345;
        this.creatorRevenueIconGradientStart = ColorUtilsKt.getColorCompat(context, i30);
        ...
        this.creatorRevenueInfoBoxBorder = ColorUtilsKt.getColorCompat(context, i29);
        this.creatorRevenueLockedChannelIcon = ColorUtilsKt.getColorCompat(context, i29);
        this.creatorRevenueProgressBar = ColorUtilsKt.getColorCompat(context, i30);
        ...
        int i31 = R.color.primary_300;
        this.deprecatedTextInputBorderHover = ColorUtilsKt.getColorCompat(context, i31);
        this.deprecatedTextInputPrefix = ColorUtilsKt.getColorCompat(context, i31);
        ...
        int i32 = R.color.primary_860;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i32);
        ...
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i32);
        this.interactiveHover = ColorUtilsKt.getColorCompat(context, i25);
        this.interactiveMuted = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.redesignButtonOverlayText = ColorUtilsKt.getColorCompat(context, i32);
        ...
        int i37 = R.color.primary_700;
        this.redesignButtonSecondaryAltText = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.redesignButtonSecondaryText = ColorUtilsKt.getColorCompat(context, i37);
        ...
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, i33);
