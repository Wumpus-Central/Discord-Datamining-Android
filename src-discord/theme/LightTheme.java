...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        this.buttonPositiveBackgroundHover = ColorUtilsKt.getColorCompat(context, i21);
        this.buttonSecondaryBackground = ColorUtilsKt.getColorCompat(context, i12);
        this.buttonSecondaryBackgroundActive = ColorUtilsKt.getColorCompat(context, i25);
        ...
        this.channelTextAreaPlaceholder = ColorUtilsKt.getColorCompat(context, R.color.primary_400);
        int i27 = R.color.primary_460;
        this.channelsDefault = ColorUtilsKt.getColorCompat(context, i27);
        ...
        int i28 = R.color.primary_300;
        this.deprecatedTextInputBorderHover = ColorUtilsKt.getColorCompat(context, i28);
        this.deprecatedTextInputPrefix = ColorUtilsKt.getColorCompat(context, i28);
        ...
        int i29 = R.color.primary_860;
        this.headerPrimary = ColorUtilsKt.getColorCompat(context, i29);
        this.headerSecondary = ColorUtilsKt.getColorCompat(context, i26);
        ...
        int i31 = R.color.yellow_400;
        this.infoWarningForeground = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.interactiveActive = ColorUtilsKt.getColorCompat(context, i29);
        ...
        this.interactiveNormal = ColorUtilsKt.getColorCompat(context, i26);
        ...
        this.redesignButtonDangerPressedBackground = ColorUtilsKt.getColorCompat(context, i18);
        this.redesignButtonFloatingBackground = ColorUtilsKt.getColorCompat(context, i10);
        this.redesignButtonFloatingPressedBackground = ColorUtilsKt.getColorCompat(context, R.color.primary_730);
        this.redesignButtonPositiveBackground = ColorUtilsKt.getColorCompat(context, i22);
        this.redesignButtonPositivePressedBackground = ColorUtilsKt.getColorCompat(context, R.color.green_500);
        ...
        int i32 = R.color.primary_230;
        this.redesignButtonSecondaryPressedBackground = ColorUtilsKt.getColorCompat(context, i32);
        ...
        this.scrollbarAutoThumb = ColorUtilsKt.getColorCompat(context, i28);
        ...
        this.statusIdle = ColorUtilsKt.getColorCompat(context, i31);
        this.statusOffline = ColorUtilsKt.getColorCompat(context, i27);
        ...
        this.statusWarning = ColorUtilsKt.getColorCompat(context, i31);
        this.statusWarningBackground = ColorUtilsKt.getColorCompat(context, i31);
        ...
        this.textLinkLowSaturation = ColorUtilsKt.getColorCompat(context, i30);
        this.textMuted = ColorUtilsKt.getColorCompat(context, i27);
        this.textNormal = ColorUtilsKt.getColorCompat(context, i24);
        this.textPositive = ColorUtilsKt.getColorCompat(context, i22);
        this.textWarning = ColorUtilsKt.getColorCompat(context, R.color.yellow_430);
        this.textboxMarkdownSyntax = ColorUtilsKt.getColorCompat(context, i25);
