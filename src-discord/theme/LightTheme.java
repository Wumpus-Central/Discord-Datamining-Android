...
public final class LightTheme extends DiscordTheme {
    ...
    public LightTheme(Context context) {
        ...
        this.navigatorHeaderTint = ColorUtilsKt.getColorCompat(context, i27);
