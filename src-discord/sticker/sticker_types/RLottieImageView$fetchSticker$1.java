...
public final class RLottieImageView$fetchSticker$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((RLottieImageView$fetchSticker$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f21444a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        FlowCollector flowCollector = new FlowCollector() { 
            ...
            public static final class C01142 extends k implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
                ...
                public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
                    return ((C01142) create(coroutineScope, continuation)).invokeSuspend(Unit.f21444a);
                }
            ...
            public final Object emit(DownloadState downloadState, Continuation<? super Unit> continuation) {
                ...
                if (downloadState instanceof DownloadState.Completed) {
                    ...
                    d12 = d.d();
                    return g10 == d12 ? g10 : Unit.f21444a;
                    ...
                    d11 = d.d();
                    return g11 == d11 ? g11 : Unit.f21444a;
                }
            }
        };
        this.label = 2;
