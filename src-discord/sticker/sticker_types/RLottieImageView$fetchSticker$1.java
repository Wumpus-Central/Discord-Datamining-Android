...
public final class RLottieImageView$fetchSticker$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((RLottieImageView$fetchSticker$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f21436a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        FlowCollector flowCollector = new FlowCollector() { 
            ...
            public static final class C01142 extends k implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
                int label;
                final  RLottieImageView this$0;

                
                C01142(RLottieImageView rLottieImageView, Continuation<? super C01142> continuation) {
                    super(2, continuation);
                    this.this$0 = rLottieImageView;
                }
                ...
                @Override 
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C01142(this.this$0, continuation);
                }

                public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
                    return ((C01142) create(coroutineScope, continuation)).invokeSuspend(Unit.f21436a);
                }
            ...
            public final Object emit(DownloadState downloadState, Continuation<? super Unit> continuation) {
                ...
                if (downloadState instanceof DownloadState.Completed) {
                    Object g10 = j.g(a1.c(), new AnonymousClass1(RLottieImageView.this, downloadState, config, null), continuation);
                    d12 = d.d();
                    return g10 == d12 ? g10 : Unit.f21436a;
                } else if (!(downloadState instanceof DownloadState.Failure)) {
                    return Unit.f21436a;
                } else {
                    Object g11 = j.g(a1.c(), new C01142(RLottieImageView.this, null), continuation);
                    d11 = d.d();
                    return g11 == d11 ? g11 : Unit.f21436a;
                }
            }
        };
        this.label = 2;
