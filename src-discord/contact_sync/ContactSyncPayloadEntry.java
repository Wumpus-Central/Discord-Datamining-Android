...
public final class ContactSyncPayloadEntry {
    ...
    public  ContactSyncPayloadEntry(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  ContactSyncPayloadEntry copy$default(ContactSyncPayloadEntry contactSyncPayloadEntry, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static  void getFriendId$annotations() {
    }
    ...
    public static final void write$Self(ContactSyncPayloadEntry self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.friendId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ContactSyncPayloadEntry) && q.c(this.friendId, ((ContactSyncPayloadEntry) obj).friendId);
    }
