...
public final class ContactSyncBlobEntry {
    ...
    public  ContactSyncBlobEntry(int i10, String str, String str2, boolean z10, String str3, String str4, String str5, SerializationConstructorMarker serializationConstructorMarker) {
        if (63 != (i10 & 63)) {
    ...
    public static  ContactSyncBlobEntry copy$default(ContactSyncBlobEntry contactSyncBlobEntry, String str, String str2, boolean z10, String str3, String str4, String str5, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static  void getDeviceContactId$annotations() {
    }
    ...
    public static  void getHasImageData$annotations() {
    }

    public static  void getUnencryptedName$annotations() {
    }
    ...
    public static final void write$Self(ContactSyncBlobEntry self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.phone);
        output.y(serialDesc, 1, self.unencryptedName);
        output.x(serialDesc, 2, self.hasImageData);
        output.y(serialDesc, 3, self.deviceContactId);
        output.y(serialDesc, 4, self.givenName);
        output.y(serialDesc, 5, self.familyName);
    }
    ...
    public final ContactSyncBlobEntry copy(String phone, String unencryptedName, boolean z10, String deviceContactId, String givenName, String familyName) {
        q.h(phone, "phone");
        q.h(unencryptedName, "unencryptedName");
        q.h(deviceContactId, "deviceContactId");
        q.h(givenName, "givenName");
        q.h(familyName, "familyName");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.phone, contactSyncBlobEntry.phone) && q.c(this.unencryptedName, contactSyncBlobEntry.unencryptedName) && this.hasImageData == contactSyncBlobEntry.hasImageData && q.c(this.deviceContactId, contactSyncBlobEntry.deviceContactId) && q.c(this.givenName, contactSyncBlobEntry.givenName) && q.c(this.familyName, contactSyncBlobEntry.familyName);
    }
