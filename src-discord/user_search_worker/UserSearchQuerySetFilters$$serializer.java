...
public final class UserSearchQuerySetFilters$$serializer implements f0<UserSearchQuerySetFilters> {
    ...
    public KSerializer<?>[] childSerializers() {
        h hVar = h.f32976a;
        return new KSerializer[]{a.u(a2.f32934a), a.u(hVar), a.u(hVar)};
    }
    ...
    public UserSearchQuerySetFilters deserialize(Decoder decoder) {
        ...
        Object obj4 = null;
        if (b10.p()) {
            obj3 = b10.n(descriptor2, 0, a2.f32934a, null);
            h hVar = h.f32976a;
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj5 = b10.n(descriptor2, 1, h.f32976a, obj5);
                    i11 |= 2;
                } else if (o10 == 2) {
                    obj6 = b10.n(descriptor2, 2, h.f32976a, obj6);
                    i11 |= 4;
                } else {
                    throw new n(o10);
                }
