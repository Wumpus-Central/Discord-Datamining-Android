...
public final class UserSearchQueryClearData extends UserSearchData {
    ...
    public  UserSearchQueryClearData(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
    ...
    public static  UserSearchQueryClearData copy$default(UserSearchQueryClearData userSearchQueryClearData, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UserSearchQueryClearData) && q.c(this.uuid, ((UserSearchQueryClearData) obj).uuid);
    }
