    ...
    */
    private final void mergeUsers(com.discord.user_search_worker.UserSearchUpdateUsersData r14) {
        ...
        L_0x005b:
            ...
            java.util.Map r12 = hf.s.o(r5, r12)
            r5 = r4
    ...
    private final void searchUsers(String str, UserSearchQuerySetPayload userSearchQuerySetPayload) {
        ...
        Comparator b10;
        List u02;
        List<UserSearchWorkerResult> v02;
        List list;
        List<String> P;
        double d10;
        Regex regex;
        ...
        String c12 = Regex.f20787l.c(query);
        ...
        for (Map.Entry<String, UserSearchTransformedUser> entry : this.users.entrySet()) {
            ...
            if (isValid(key, value, userSearchQuerySetPayload)) {
                if (z10 == c11) {
                    ...
                    list = kotlin.collections.j.k(strArr);
                } else if (!z10) {
                    String[] strArr2 = new String[3];
                    strArr2[c10] = value.getUsername();
                    strArr2[c11] = value.getGlobalName();
                    strArr2[2] = value.getFriendNickname();
                    k10 = kotlin.collections.j.k(strArr2);
                    list = r.m0(k10, value.getNicknames().values());
                } else {
                    throw new gf.q();
                }
                P = r.P(list);
        ...
        u02 = r.u0(arrayList, b10);
        v02 = r.v0(u02, userSearchQuerySetPayload.getLimit());
        this.onResults.invoke(v02, query, str);
    }
