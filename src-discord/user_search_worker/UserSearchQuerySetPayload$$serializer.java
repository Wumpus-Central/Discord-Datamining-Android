...
public final class UserSearchQuerySetPayload$$serializer implements f0<UserSearchQuerySetPayload> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f5917a;
        return new KSerializer[]{a2Var, a.u(UserSearchQuerySetFilters$$serializer.INSTANCE), a.u(new f(a2Var)), a.u(new f(a2Var)), new r0(a2Var, x.f6038a), m0.f5992a};
    }
    ...
    public UserSearchQuerySetPayload deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj3 = b10.y(descriptor2, 4, new r0(a2Var, x.f6038a), null);
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 1:
                        ...
                        i12 = 5;
                    case 2:
                        obj6 = b10.n(descriptor2, 2, new f(a2.f5917a), obj6);
                        i14 |= 4;
                        i12 = 5;
                    case 3:
                        obj7 = b10.n(descriptor2, 3, new f(a2.f5917a), obj7);
                        i14 |= 8;
                        i12 = 5;
                    case 4:
                        obj8 = b10.y(descriptor2, 4, new r0(a2.f5917a, x.f6038a), obj8);
                        i14 |= 16;
                        i12 = 5;
                    case 5:
