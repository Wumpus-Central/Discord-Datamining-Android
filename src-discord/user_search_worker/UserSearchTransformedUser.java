    ...
    public static final class Serializer implements KSerializer<UserSearchTransformedUser> {
        ...
        public UserSearchTransformedUser deserialize(Decoder decoder) {
            ...
            while (true) {
                ...
                if (kotlinx.serialization.json.f.m(jsonElement).b()) {
                    str = kotlinx.serialization.json.f.m(jsonElement).a();
                }
            ...
            Boolean valueOf = (jsonElement2 == null || (m13 = kotlinx.serialization.json.f.m(jsonElement2)) == null) ? null : Boolean.valueOf(kotlinx.serialization.json.f.e(m13));
            JsonElement jsonElement3 = (JsonElement) jsonObject.get("isFriend");
            Boolean valueOf2 = (jsonElement3 == null || (m12 = kotlinx.serialization.json.f.m(jsonElement3)) == null) ? null : Boolean.valueOf(kotlinx.serialization.json.f.e(m12));
            JsonElement jsonElement4 = (JsonElement) jsonObject.get("friendNickname");
            if (jsonElement4 == null || (m11 = kotlinx.serialization.json.f.m(jsonElement4)) == null) {
                str2 = null;
            } else {
                str2 = m11.b() ? m11.a() : null;
            }
            JsonElement jsonElement5 = (JsonElement) jsonObject.get("globalName");
            if (!(jsonElement5 == null || (m10 = kotlinx.serialization.json.f.m(jsonElement5)) == null || !m10.b())) {
                str = m10.a();
            }
