...
public final class UserSearchWorkerResult {
    ...
    public static /* synthetic */ UserSearchWorkerResult copy$default(UserSearchWorkerResult userSearchWorkerResult, String str, String str2, String str3, double d10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = userSearchWorkerResult.f7637id;
        }
        if ((i10 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.f7637id, userSearchWorkerResult.f7637id) && q.b(this.username, userSearchWorkerResult.username) && q.b(this.comparator, userSearchWorkerResult.comparator) && Double.compare(this.score, userSearchWorkerResult.score) == 0;
    }
    ...
    public int hashCode() {
        return (((((this.f7637id.hashCode() * 31) + this.username.hashCode()) * 31) + this.comparator.hashCode()) * 31) + Double.doubleToLongBits(this.score);
    }
