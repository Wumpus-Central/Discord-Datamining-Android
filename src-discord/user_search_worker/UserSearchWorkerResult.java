...
public final class UserSearchWorkerResult {
    ...
    public static  UserSearchWorkerResult copy$default(UserSearchWorkerResult userSearchWorkerResult, String str, String str2, String str3, double d10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = userSearchWorkerResult.f7464id;
        }
        if ((i10 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.f7464id, userSearchWorkerResult.f7464id) && q.c(this.username, userSearchWorkerResult.username) && q.c(this.comparator, userSearchWorkerResult.comparator) && Double.compare(this.score, userSearchWorkerResult.score) == 0;
    }
    ...
    public int hashCode() {
        return (((((this.f7464id.hashCode() * 31) + this.username.hashCode()) * 31) + this.comparator.hashCode()) * 31) + Double.doubleToLongBits(this.score);
    }

    public String toString() {
        String str = this.f7464id;
