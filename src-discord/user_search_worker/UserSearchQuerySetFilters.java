...
public final class UserSearchQuerySetFilters {
    ...
    public static final void write$Self(UserSearchQuerySetFilters self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        if (!output.A(serialDesc, 0) && self.guild == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.u(serialDesc, 0, a2.f32925a, self.guild);
        }
        ...
        if (z11) {
            output.u(serialDesc, 1, h.f32967a, self.friends);
        }
        if (output.A(serialDesc, 2) || self.strict != null) {
            z12 = true;
        }
        if (z12) {
            output.u(serialDesc, 2, h.f32967a, self.strict);
        }
    }
