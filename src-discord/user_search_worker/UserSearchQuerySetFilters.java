...
public final class UserSearchQuerySetFilters {
    ...
    public static final void write$Self(UserSearchQuerySetFilters self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.B(serialDesc, 0, a2.f29762a, self.guild);
        }
        ...
        if (z11) {
            output.B(serialDesc, 1, h.f29804a, self.friends);
        }
        if (output.z(serialDesc, 2) || self.strict != null) {
            z12 = true;
        }
        if (z12) {
            output.B(serialDesc, 2, h.f29804a, self.strict);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.guild, userSearchQuerySetFilters.guild) && q.c(this.friends, userSearchQuerySetFilters.friends) && q.c(this.strict, userSearchQuerySetFilters.strict);
    }
