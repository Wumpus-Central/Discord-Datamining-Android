...
public final class UserSearchUpdateUsersData extends UserSearchData {
    ...
    public static final void write$Self(UserSearchUpdateUsersData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, new cj.f(UserSearchTransformedUser.Serializer.INSTANCE), self.payload);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UserSearchUpdateUsersData) && q.c(this.payload, ((UserSearchUpdateUsersData) obj).payload);
    }
