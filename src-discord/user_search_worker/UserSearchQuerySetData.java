...
public final class UserSearchQuerySetData extends UserSearchData {
    ...
    public  UserSearchQuerySetData(int i10, String str, UserSearchQuerySetPayload userSearchQuerySetPayload, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (3 != (i10 & 3)) {
    ...
    public static  UserSearchQuerySetData copy$default(UserSearchQuerySetData userSearchQuerySetData, String str, UserSearchQuerySetPayload userSearchQuerySetPayload, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(UserSearchQuerySetData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 1, UserSearchQuerySetPayload$$serializer.INSTANCE, self.payload);
    }
