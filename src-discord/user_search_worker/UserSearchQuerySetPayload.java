...
public final class UserSearchQuerySetPayload {
    ...
    public  UserSearchQuerySetPayload(int i10, String str, UserSearchQuerySetFilters userSearchQuerySetFilters, List list, List list2, Map map, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (49 != (i10 & 49)) {
    ...
    public static  UserSearchQuerySetPayload copy$default(UserSearchQuerySetPayload userSearchQuerySetPayload, String str, UserSearchQuerySetFilters userSearchQuerySetFilters, List list, List list2, Map map, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(UserSearchQuerySetPayload self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.y(serialDesc, 0, self.query);
        ...
        if (z10) {
            output.e(serialDesc, 1, UserSearchQuerySetFilters$$serializer.INSTANCE, self.filters);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, new xi.f(a2.f30576a), self.blacklist);
        }
        if (output.z(serialDesc, 3) || self.whitelist != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 3, new xi.f(a2.f30576a), self.whitelist);
        }
        output.h(serialDesc, 4, new r0(a2.f30576a, x.f30697a), self.boosters);
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.query, userSearchQuerySetPayload.query) && q.c(this.filters, userSearchQuerySetPayload.filters) && q.c(this.blacklist, userSearchQuerySetPayload.blacklist) && q.c(this.whitelist, userSearchQuerySetPayload.whitelist) && q.c(this.boosters, userSearchQuerySetPayload.boosters) && this.limit == userSearchQuerySetPayload.limit;
    }
    ...
    public  UserSearchQuerySetPayload(String str, UserSearchQuerySetFilters userSearchQuerySetFilters, List list, List list2, Map map, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
