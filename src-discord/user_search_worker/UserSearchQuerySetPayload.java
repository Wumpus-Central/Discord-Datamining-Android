...
public final class UserSearchQuerySetPayload {
    ...
    public static final void write$Self(UserSearchQuerySetPayload self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.h(serialDesc, 1, UserSearchQuerySetFilters$$serializer.INSTANCE, self.filters);
        }
        ...
        if (z11) {
            output.h(serialDesc, 2, new xj.f(a2.f32313a), self.blacklist);
        }
        if (output.A(serialDesc, 3) || self.whitelist != null) {
            z12 = true;
        }
        if (z12) {
            output.h(serialDesc, 3, new xj.f(a2.f32313a), self.whitelist);
        }
        output.z(serialDesc, 4, new r0(a2.f32313a, x.f32434a), self.boosters);
