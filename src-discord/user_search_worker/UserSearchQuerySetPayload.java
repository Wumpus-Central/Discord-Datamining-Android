...
public final class UserSearchQuerySetPayload {
    ...
    public static final void write$Self(UserSearchQuerySetPayload self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (z10) {
            output.p(serialDesc, 1, UserSearchQuerySetFilters$$serializer.INSTANCE, self.filters);
        }
        ...
        if (z11) {
            output.p(serialDesc, 2, new bj.f(a2.f5917a), self.blacklist);
        }
        if (output.A(serialDesc, 3) || self.whitelist != null) {
            z12 = true;
        }
        if (z12) {
            output.p(serialDesc, 3, new bj.f(a2.f5917a), self.whitelist);
        }
        output.t(serialDesc, 4, new r0(a2.f5917a, x.f6038a), self.boosters);
