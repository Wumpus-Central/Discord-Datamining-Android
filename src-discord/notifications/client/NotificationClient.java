...
public final class NotificationClient {
    ...
    private final void showNotification(Context context, NotificationData notificationData, Map<String, String> map, boolean z10) {
        ...
        pairArr[1] = x.a("channelId", String.valueOf(notificationData.m556getChannelIdqMVnFVQ()));
        String str3 = notificationData.m558getMessageIdN_6c4I0();
        if (str3 == null) {
            str = "null";
        } else {
        ...
        k10 = v.k(pairArr);
        CrashReporting.addBreadcrumb$default(crashReporting, "Kotlin NotificationClient received Notification.", k10, null, 4, null);
        if (this.cache.isAuthed(context)) {
            ...
            if (q.c(notificationData.getType(), NotificationData.TYPE_CHANNEL_ACK)) {
                ...
                try {
                    ...
                    if (q.c(notificationData.getType(), NotificationData.TYPE_MESSAGE_CREATE)) {
                        ...
                        if (kvMessage != null) {
                            String str4 = notificationData.m558getMessageIdN_6c4I0();
                            ...
                            if (!(str4 == null || channelId == null)) {
                                ...
                                if (guildId != null) {
                                    str2 = GuildId.m609toStringimpl(guildId.m611unboximpl());
                                } else {
                                    str2 = null;
                                }
                                String str7 = ChannelId.m596toStringimpl(channelId.m598unboximpl());
                                String str8 = MessageId.m621toStringimpl(str4);
    ...
    public final void handleIntent(Context context, Intent intent) {
        ...
        if (IntentUtilsKt.hasExtra(intent, f0.b(ContentAction.class))) {
            notificationAction = (NotificationAction) ((Parcelable) e.b(intent, "action_intent_arg_key", ContentAction.class));
        } else {
    ...
    public final void onDirectReplySuccess(Context context, String data) {
        ...
        Pair[] pairArr = new Pair[3];
        pairArr[0] = x.a("type", notificationData.getType());
        pairArr[1] = x.a("channel_id", String.valueOf(notificationData.m556getChannelIdqMVnFVQ()));
    ...
    public final void onNotificationReceived(Context context, Map<String, String> data) {
        q.h(context, "context");
        q.h(data, "data");
        showNotification(context, (NotificationData) a.f31570b.d(NotificationData.Companion.serializer(), data), data, true);
    }
    ...
    public final void setTokenListener(Function1<? super String, Unit> tokenListener) {
        q.h(tokenListener, "tokenListener");
