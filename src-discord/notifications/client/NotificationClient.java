...
public final class NotificationClient {
        ...
        if (this.cache.isAuthed(context)) {
            if (q.b(notificationData.getType(), NotificationData.TYPE_CHANNEL_ACK)) {
                ...
                try {
                    ...
                    if (q.b(notificationData.getType(), NotificationData.TYPE_MESSAGE_CREATE) && updateAndComputeIfShouldRunBackgroundSync(context)) {
    ...
    public final void onNotificationReceived(Context context, Map<String, String> data) {
        q.g(context, "context");
        q.g(data, "data");
        showNotification(context, (NotificationData) a.f15090b.d(NotificationData.Companion.serializer(), data), data, true);
    }
