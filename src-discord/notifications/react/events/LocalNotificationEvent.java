...
public final class LocalNotificationEvent implements ReactEvent {
    ...
    public  LocalNotificationEvent(int i10, Map map, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  LocalNotificationEvent copy$default(LocalNotificationEvent localNotificationEvent, Map map, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(LocalNotificationEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        a2 a2Var = a2.f30568a;
        output.h(serialDesc, 0, new r0(a2Var, a.u(a2Var)), self.locationNotification);
    }
    ...
    public final LocalNotificationEvent copy(Map<String, String> locationNotification) {
        q.h(locationNotification, "locationNotification");
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof LocalNotificationEvent) && q.c(this.locationNotification, ((LocalNotificationEvent) obj).locationNotification);
    }
