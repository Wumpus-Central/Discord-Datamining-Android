...
public final class KvMessageEntry {
    ...
    public static final void write$Self(KvMessageEntry self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 3, MessageId$$serializer.INSTANCE, MessageId.m590boximpl(self.f7594id));
        output.C(serialDesc, 4, ChannelId$$serializer.INSTANCE, ChannelId.m564boximpl(self.channelId));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.b(this.members, kvMessageEntry.members) && q.b(this.users, kvMessageEntry.users) && q.b(this.message, kvMessageEntry.message) && MessageId.m594equalsimpl0(this.f7594id, kvMessageEntry.f7594id) && ChannelId.m568equalsimpl0(this.channelId, kvMessageEntry.channelId);
    }
    ...
    public int hashCode() {
        return (((((((this.members.hashCode() * 31) + this.users.hashCode()) * 31) + this.message.hashCode()) * 31) + MessageId.m595hashCodeimpl(this.f7594id)) * 31) + ChannelId.m569hashCodeimpl(this.channelId);
    }
    ...
    public String toString() {
        ...
        String str = MessageId.m596toStringimpl(this.f7594id);
