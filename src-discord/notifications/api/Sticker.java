...
public final class Sticker implements Parcelable {
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z17 = false;
        if (!output.A(serialDesc, 0) && StickerId.m601equalsimpl0(self.f7995id, StickerId.m598constructorimpl(0L))) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.z(serialDesc, 0, StickerId$$serializer.INSTANCE, StickerId.m597boximpl(self.f7995id));
        }
        ...
        if (z12) {
            output.h(serialDesc, 3, GuildId$$serializer.INSTANCE, self.guildId);
        }
        ...
        if (z14) {
            output.z(serialDesc, 5, StickerFormatType.Serializer.INSTANCE, self.formatType);
        }
        ...
        if (z16) {
            output.z(serialDesc, 7, StickerType.Serializer.INSTANCE, self.type);
        }
    ...
    public int hashCode() {
        int i10 = ((StickerId.m602hashCodeimpl(this.f7995id) * 31) + this.name.hashCode()) * 31;
    ...
    public String toString() {
        String str = StickerId.m604toStringimpl(this.f7995id);
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        out.writeParcelable(StickerId.m597boximpl(this.f7995id), i10);
