...
public final class Sticker implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<Sticker> {
        ...
        public final Sticker createFromParcel(Parcel parcel) {
            Boolean bool;
            q.h(parcel, "parcel");
            long j10 = ((StickerId) parcel.readParcelable(Sticker.class.getClassLoader())).m658unboximpl();
    ...
    private Sticker(int i10, StickerId stickerId, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if ((i10 & 1) == 0) {
            j10 = StickerId.m650constructorimpl(0L);
        } else {
            j10 = stickerId.m658unboximpl();
        }
        this.f7564id = j10;
        this.name = str;
        if ((i10 & 4) == 0) {
    ...
    public  Sticker(int i10, StickerId stickerId, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, stickerId, str, l10, guildId, str2, stickerFormatType, str3, stickerType, bool, serializationConstructorMarker);
    }

    public  Sticker(long j10, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, str, l10, guildId, str2, stickerFormatType, str3, stickerType, bool);
    }

    public static  void getAvailable$annotations() {
    }

    public static  void getDescription$annotations() {
    }

    public static  void getFormatType$annotations() {
    }

    
    public static  void m571getGuildIdqOKuAAo$annotations() {
    }

    
    public static  void m572getIde_wqtJY$annotations() {
    }

    public static  void getName$annotations() {
    }

    public static  void getPackId$annotations() {
    }
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z17 = false;
        if (!output.z(serialDesc, 0) && StickerId.m653equalsimpl0(self.f7564id, StickerId.m650constructorimpl(0L))) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.h(serialDesc, 0, StickerId$$serializer.INSTANCE, StickerId.m649boximpl(self.f7564id));
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, w0.f30690a, self.packId);
        }
        ...
        if (!output.z(serialDesc, 4) && q.c(self.description, "")) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (z13) {
            output.y(serialDesc, 4, self.description);
        }
        if (!output.z(serialDesc, 5) && self.formatType == StickerFormatType.Companion.fromInt(0)) {
            z14 = false;
        } else {
            z14 = true;
        }
        if (z14) {
            output.h(serialDesc, 5, StickerFormatType.Serializer.INSTANCE, self.formatType);
        }
        if (!output.z(serialDesc, 6) && q.c(self.tags, "")) {
            z15 = false;
        } else {
            z15 = true;
        }
        if (z15) {
            output.y(serialDesc, 6, self.tags);
        }
        if (!output.z(serialDesc, 7) && self.type == StickerType.Companion.fromInt(0)) {
            z16 = false;
        } else {
            z16 = true;
        }
        if (z16) {
            output.h(serialDesc, 7, StickerType.Serializer.INSTANCE, self.type);
        }
        if (output.z(serialDesc, 8) || self.available != null) {
            z17 = true;
        }
        if (z17) {
            output.e(serialDesc, 8, h.f30616a, self.available);
        }
    }

    
    public final long m573component1e_wqtJY() {
        return this.f7564id;
    }
    ...
    public final GuildId m574component4qOKuAAo() {
        return this.guildId;
    }
    ...
    public final Sticker m575copyfJhvhH4(long j10, String name, Long l10, GuildId guildId, String description, StickerFormatType formatType, String tags, StickerType type, Boolean bool) {
        q.h(name, "name");
    ...
    public final GuildId m576getGuildIdqOKuAAo() {
        return this.guildId;
    }

    
    public final long m577getIde_wqtJY() {
        return this.f7564id;
    }
    ...
    public int hashCode() {
        int i10 = ((StickerId.m654hashCodeimpl(this.f7564id) * 31) + this.name.hashCode()) * 31;
        Long l10 = this.packId;
        int i11 = 0;
        int hashCode = (i10 + (l10 == null ? 0 : l10.hashCode())) * 31;
        GuildId guildId = this.guildId;
        int i12 = (((((((((hashCode + (guildId == null ? 0 : GuildId.m616hashCodeimpl(guildId.m620unboximpl()))) * 31) + this.description.hashCode()) * 31) + this.formatType.hashCode()) * 31) + this.tags.hashCode()) * 31) + this.type.hashCode()) * 31;
    ...
    public String toString() {
        String str = StickerId.m656toStringimpl(this.f7564id);
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.h(out, "out");
        out.writeParcelable(StickerId.m649boximpl(this.f7564id), i10);
    ...
    public  Sticker(long j10, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? StickerId.m650constructorimpl(0L) : j10, str, (i10 & 4) != 0 ? null : l10, (i10 & 8) != 0 ? null : guildId, (i10 & 16) != 0 ? "" : str2, (i10 & 32) != 0 ? StickerFormatType.Companion.fromInt(0) : stickerFormatType, (i10 & 64) != 0 ? "" : str3, (i10 & 128) != 0 ? StickerType.Companion.fromInt(0) : stickerType, (i10 & 256) != 0 ? null : bool, null);
    }
}
