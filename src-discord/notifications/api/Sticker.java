...
public final class Sticker implements Parcelable {
    ...
    public static  void m537getGuildIdqOKuAAo$annotations() {
    }

    
    public static  void m538getIde_wqtJY$annotations() {
    }
    ...
    public static final void write$Self(Sticker self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z17 = false;
        if (!output.w(serialDesc, 0) && StickerId.m619equalsimpl0(self.f7187id, StickerId.m616constructorimpl(0L))) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.n(serialDesc, 0, StickerId$$serializer.INSTANCE, StickerId.m615boximpl(self.f7187id));
        }
        ...
        if (z11) {
            output.z(serialDesc, 2, w0.f26346a, self.packId);
        }
        ...
        if (z17) {
            output.z(serialDesc, 8, h.f26272a, self.available);
        }
    }
    ...
    public int hashCode() {
        int i10 = ((StickerId.m620hashCodeimpl(this.f7187id) * 31) + this.name.hashCode()) * 31;
    ...
    public String toString() {
        String str = StickerId.m622toStringimpl(this.f7187id);
    ...
    public void writeToParcel(Parcel out, int i10) {
        q.g(out, "out");
        out.writeParcelable(StickerId.m615boximpl(this.f7187id), i10);
