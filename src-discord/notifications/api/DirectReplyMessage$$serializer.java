...
@Metadata(d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, d2 = {"com/discord/notifications/api/DirectReplyMessage.$serializer", "Lwi/f0;", "Lcom/discord/notifications/api/DirectReplyMessage;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "notification_api_release"}, k = 1, mv = {1, 8, 0})
...
public final class DirectReplyMessage$$serializer implements f0<DirectReplyMessage> {
    ...
    public DirectReplyMessage deserialize(Decoder decoder) {
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 2:
                        ...
                        continue;
                    case 3:
                        obj14 = b10.n(descriptor2, 3, a2.f29764a, obj14);
                        i13 |= 8;
                        break;
                    case 4:
                        obj9 = b10.n(descriptor2, 4, m0.f29839a, obj9);
                        i13 |= 16;
                        break;
                    case 5:
                        obj13 = b10.n(descriptor2, 5, m0.f29839a, obj13);
                        i13 |= 32;
                        break;
                    case 6:
                        obj12 = b10.n(descriptor2, i12, a2.f29764a, obj12);
                        i13 |= 64;
                        break;
                    case 7:
                        obj11 = b10.n(descriptor2, i11, a2.f29764a, obj11);
                        i13 |= 128;
                        break;
                    default:
                        throw new n(o10);
        ...
        return new DirectReplyMessage(i10, messageId != null ? messageId.m625unboximpl() : null, (ChannelId) obj, (DirectReplyUser) obj2, (String) obj4, (Integer) obj3, (Integer) obj5, (String) obj6, (String) obj7, null, null);
    }
