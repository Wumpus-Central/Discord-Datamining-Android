...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7559id = userId.m654unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.o(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m645boximpl(self.f7559id));
        ...
        if (z10) {
            output.B(serialDesc, 1, a2.f29755a, self.username);
        }
        ...
        if (z11) {
            output.B(serialDesc, 2, a2.f29755a, self.discriminator);
        }
        if (output.z(serialDesc, 3) || self.avatar != null) {
            z12 = true;
        }
        if (z12) {
            output.B(serialDesc, 3, a2.f29755a, self.avatar);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m649equalsimpl0(this.f7559id, directReplyUser.f7559id) && q.c(this.username, directReplyUser.username) && q.c(this.discriminator, directReplyUser.discriminator) && q.c(this.avatar, directReplyUser.avatar);
    }
    ...
    public int hashCode() {
        int i10 = UserId.m650hashCodeimpl(this.f7559id) * 31;
    ...
    public String toString() {
        String str = UserId.m652toStringimpl(this.f7559id);
