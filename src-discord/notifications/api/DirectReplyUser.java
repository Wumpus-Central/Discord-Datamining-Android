...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7556id = userId.m664unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.h(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m655boximpl(self.f7556id));
        ...
        if (z10) {
            output.e(serialDesc, 1, a2.f30568a, self.username);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, a2.f30568a, self.discriminator);
        }
        if (output.z(serialDesc, 3) || self.avatar != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 3, a2.f30568a, self.avatar);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m659equalsimpl0(this.f7556id, directReplyUser.f7556id) && q.c(this.username, directReplyUser.username) && q.c(this.discriminator, directReplyUser.discriminator) && q.c(this.avatar, directReplyUser.avatar);
    }
    ...
    public int hashCode() {
        int i10 = UserId.m660hashCodeimpl(this.f7556id) * 31;
    ...
    public String toString() {
        String str = UserId.m662toStringimpl(this.f7556id);
