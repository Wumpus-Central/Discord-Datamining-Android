...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7593id = userId.m637unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static /* synthetic */ DirectReplyUser m504copyASSxI_0$default(DirectReplyUser directReplyUser, long j10, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = directReplyUser.f7593id;
        }
        if ((i10 & 2) != 0) {
        ...
        return directReplyUser.m506copyASSxI_0(j10, str, str2, str3);
    }
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.C(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m628boximpl(self.f7593id));
        if (!output.w(serialDesc, 1) && self.username == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            output.e(serialDesc, 1, a2.f26972a, self.username);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, a2.f26972a, self.discriminator);
        }
        if (output.w(serialDesc, 3) || self.avatar != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 3, a2.f26972a, self.avatar);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m505component1re6GcUE() {
        return this.f7593id;
    }
    ...
    public final DirectReplyUser m506copyASSxI_0(long j10, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m632equalsimpl0(this.f7593id, directReplyUser.f7593id) && q.b(this.username, directReplyUser.username) && q.b(this.discriminator, directReplyUser.discriminator) && q.b(this.avatar, directReplyUser.avatar);
    }
    ...
    public final long m507getIdre6GcUE() {
        return this.f7593id;
    }
    ...
    public int hashCode() {
        int i10 = UserId.m633hashCodeimpl(this.f7593id) * 31;
    ...
    public String toString() {
        String str = UserId.m635toStringimpl(this.f7593id);
