...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7917id = userId.m619unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.q(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m610boximpl(self.f7917id));
        ...
        if (z10) {
            output.u(serialDesc, 1, a2.f32925a, self.username);
        }
        ...
        if (z11) {
            output.u(serialDesc, 2, a2.f32925a, self.discriminator);
        }
        if (output.A(serialDesc, 3) || self.avatar != null) {
            z12 = true;
        }
        if (z12) {
            output.u(serialDesc, 3, a2.f32925a, self.avatar);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m614equalsimpl0(this.f7917id, directReplyUser.f7917id) && q.b(this.username, directReplyUser.username) && q.b(this.discriminator, directReplyUser.discriminator) && q.b(this.avatar, directReplyUser.avatar);
    }
    ...
    public int hashCode() {
        int i10 = UserId.m615hashCodeimpl(this.f7917id) * 31;
    ...
    public String toString() {
        String str = UserId.m617toStringimpl(this.f7917id);
