...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7495id = userId.m610unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static /* synthetic */ DirectReplyUser m485copyASSxI_0$default(DirectReplyUser directReplyUser, long j10, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = directReplyUser.f7495id;
        }
        if ((i10 & 2) != 0) {
        ...
        return directReplyUser.m487copyASSxI_0(j10, str, str2, str3);
    }
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.t(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m601boximpl(self.f7495id));
        ...
        if (z10) {
            output.p(serialDesc, 1, a2.f5917a, self.username);
        }
        ...
        if (z11) {
            output.p(serialDesc, 2, a2.f5917a, self.discriminator);
        }
        if (output.A(serialDesc, 3) || self.avatar != null) {
            z12 = true;
        }
        if (z12) {
            output.p(serialDesc, 3, a2.f5917a, self.avatar);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m486component1re6GcUE() {
        return this.f7495id;
    }
    ...
    public final DirectReplyUser m487copyASSxI_0(long j10, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m605equalsimpl0(this.f7495id, directReplyUser.f7495id) && q.b(this.username, directReplyUser.username) && q.b(this.discriminator, directReplyUser.discriminator) && q.b(this.avatar, directReplyUser.avatar);
    }
    ...
    public final long m488getIdre6GcUE() {
        return this.f7495id;
    }
    ...
    public int hashCode() {
        int i10 = UserId.m606hashCodeimpl(this.f7495id) * 31;
    ...
    public String toString() {
        String str = UserId.m608toStringimpl(this.f7495id);
