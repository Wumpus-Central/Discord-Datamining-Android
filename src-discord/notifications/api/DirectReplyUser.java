...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7592id = userId.m635unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static /* synthetic */ DirectReplyUser m502copyASSxI_0$default(DirectReplyUser directReplyUser, long j10, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = directReplyUser.f7592id;
        }
        if ((i10 & 2) != 0) {
        ...
        return directReplyUser.m504copyASSxI_0(j10, str, str2, str3);
    }
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.C(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m626boximpl(self.f7592id));
        ...
        if (z10) {
            output.e(serialDesc, 1, a2.f26939a, self.username);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, a2.f26939a, self.discriminator);
        }
        if (output.w(serialDesc, 3) || self.avatar != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 3, a2.f26939a, self.avatar);
        }
    }
    ...
    public final DirectReplyUser m504copyASSxI_0(long j10, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m630equalsimpl0(this.f7592id, directReplyUser.f7592id) && q.b(this.username, directReplyUser.username) && q.b(this.discriminator, directReplyUser.discriminator) && q.b(this.avatar, directReplyUser.avatar);
    }
    ...
    public final long m505getIdre6GcUE() {
        return this.f7592id;
    }
    ...
    public int hashCode() {
        int i10 = UserId.m631hashCodeimpl(this.f7592id) * 31;
    ...
    public String toString() {
        String str = UserId.m633toStringimpl(this.f7592id);
