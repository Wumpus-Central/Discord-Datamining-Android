...
public final class DirectReplyUser {
    ...
    private DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f7593id = userId.m635unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
    ...
    public static final void write$Self(DirectReplyUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z12 = false;
        output.C(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m626boximpl(self.f7593id));
        ...
        if (z10) {
            output.e(serialDesc, 1, a2.f26940a, self.username);
        }
        ...
        if (z11) {
            output.e(serialDesc, 2, a2.f26940a, self.discriminator);
        }
        if (output.w(serialDesc, 3) || self.avatar != null) {
            z12 = true;
        }
        if (z12) {
            output.e(serialDesc, 3, a2.f26940a, self.avatar);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m630equalsimpl0(this.f7593id, directReplyUser.f7593id) && q.b(this.username, directReplyUser.username) && q.b(this.discriminator, directReplyUser.discriminator) && q.b(this.avatar, directReplyUser.avatar);
    }
    ...
    public int hashCode() {
        int i10 = UserId.m631hashCodeimpl(this.f7593id) * 31;
    ...
    public String toString() {
        String str = UserId.m633toStringimpl(this.f7593id);
