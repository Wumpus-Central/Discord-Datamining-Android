...
public final class KvMessageEntry$$serializer implements f0<KvMessageEntry> {
    ...
    public KvMessageEntry deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            while (z10) {
                ...
                if (x10 == -1) {
                    ...
                    obj5 = c10.m(descriptor2, 0, new f(t.f21225a), obj5);
                    i11 |= 1;
                } else if (x10 == 1) {
                    obj9 = c10.m(descriptor2, 1, new f(t.f21225a), obj9);
                    i11 |= 2;
                } else if (x10 == 2) {
                    obj8 = c10.m(descriptor2, 2, t.f21225a, obj8);
                    i11 |= 4;
                } else if (x10 == 3) {
        ...
        return new KvMessageEntry(i10, (List) obj5, (List) obj, (JsonObject) obj2, messageId != null ? messageId.m599unboximpl() : null, (ChannelId) obj3, null, null);
    }
