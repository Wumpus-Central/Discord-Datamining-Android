...
public final class KvMessageEntry$$serializer implements f0<KvMessageEntry> {
    ...
    public KvMessageEntry deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    obj5 = b10.y(descriptor2, 0, new f(t.f22029a), obj5);
                    i11 |= 1;
                } else if (o10 == 1) {
                    obj9 = b10.y(descriptor2, 1, new f(t.f22029a), obj9);
                    i11 |= 2;
                } else if (o10 == 2) {
                    obj8 = b10.y(descriptor2, 2, t.f22029a, obj8);
                    i11 |= 4;
                } else if (o10 == 3) {
        ...
        return new KvMessageEntry(i10, (List) obj5, (List) obj, (JsonObject) obj2, messageId != null ? messageId.m639unboximpl() : null, (ChannelId) obj3, null, null);
    }
