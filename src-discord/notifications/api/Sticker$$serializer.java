...
public final class Sticker$$serializer implements f0<Sticker> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f26939a;
        return new KSerializer[]{StickerId$$serializer.INSTANCE, a2Var, a.u(w0.f27055a), a.u(GuildId$$serializer.INSTANCE), a2Var, StickerFormatType.Serializer.INSTANCE, a2Var, StickerType.Serializer.INSTANCE, a.u(h.f26981a)};
    }
    ...
    public Sticker deserialize(Decoder decoder) {
        ...
        if (c10.y()) {
            ...
            obj = c10.v(descriptor2, 2, w0.f27055a, null);
            ...
            obj3 = c10.v(descriptor2, 8, h.f26981a, null);
            i10 = 511;
        } else {
            boolean z10 = true;
            int i13 = 0;
            ...
            while (z10) {
                ...
                switch (x10) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        obj = c10.v(descriptor2, 2, w0.f27055a, obj);
                        i13 |= 4;
                        i11 = 7;
                        break;
                    case 3:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        obj3 = c10.v(descriptor2, 8, h.f26981a, obj3);
                        i13 |= 256;
                        break;
                    default:
                        throw new n(x10);
