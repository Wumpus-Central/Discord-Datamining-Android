...
public final class Sticker$$serializer implements f0<Sticker> {
    ...
    public KSerializer<?>[] childSerializers() {
        a2 a2Var = a2.f32934a;
        return new KSerializer[]{StickerId$$serializer.INSTANCE, a2Var, a.u(w0.f33050a), a.u(GuildId$$serializer.INSTANCE), a2Var, StickerFormatType.Serializer.INSTANCE, a2Var, StickerType.Serializer.INSTANCE, a.u(h.f32976a)};
    }
    ...
    public Sticker deserialize(Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            obj = b10.n(descriptor2, 2, w0.f33050a, null);
            ...
            obj3 = b10.n(descriptor2, 8, h.f32976a, null);
            i10 = 511;
        } else {
            boolean z10 = true;
            int i13 = 0;
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        obj = b10.n(descriptor2, 2, w0.f33050a, obj);
                        i13 |= 4;
                        i11 = 7;
                        break;
                    case 3:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        obj3 = b10.n(descriptor2, 8, h.f32976a, obj3);
