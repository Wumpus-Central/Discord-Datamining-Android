...
public final class DirectReplyMessage {
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z14 = false;
        output.t(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m563boximpl(self.f7494id));
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m568hashCodeimpl(this.f7494id) * 31) + ChannelId.m542hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m569toStringimpl(this.f7494id);
