...
public final class DirectReplyMessage {
    ...
    public static final class Companion {
        ...
        public final NotificationData toNotificationData(String data) {
            ...
            String str = directReplyMessage.m485getId3Eiw7ao();
            Integer type = directReplyMessage.getType();
            String content = directReplyMessage.getContent();
            long j10 = directReplyMessage.m484getChannelIdo4g7jtM();
            Integer channelType = directReplyMessage.getChannelType();
            i10 = j.i();
            long j11 = directReplyMessage.getAuthor().m489getIdre6GcUE();
    ...
    public static /* synthetic */ void m480getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z14 = false;
        output.z(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m572boximpl(self.f7992id));
        output.z(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m546boximpl(self.channelId));
        output.z(serialDesc, 2, DirectReplyUser$$serializer.INSTANCE, self.author);
        ...
        if (z10) {
            output.h(serialDesc, 3, a2.f32309a, self.content);
        }
        ...
        if (z11) {
            output.h(serialDesc, 4, m0.f32384a, self.type);
        }
        ...
        if (z12) {
            output.h(serialDesc, 5, m0.f32384a, self.channelType);
        }
        ...
        if (z13) {
            output.h(serialDesc, 6, a2.f32309a, self.channelName);
        }
        if (output.A(serialDesc, 7) || self.guildName != null) {
            z14 = true;
        }
        if (z14) {
            output.h(serialDesc, 7, a2.f32309a, self.guildName);
        }
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m481component13Eiw7ao() {
        return this.f7992id;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m482component2o4g7jtM() {
    ...
    public final DirectReplyMessage m483copy_6Dih7Q(String id2, long j10, DirectReplyUser author, String str, Integer num, Integer num2, String str2, String str3) {
        q.g(id2, "id");
        q.g(author, "author");
    ...
    public final long m484getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m485getId3Eiw7ao() {
        return this.f7992id;
    }
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m577hashCodeimpl(this.f7992id) * 31) + ChannelId.m551hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m578toStringimpl(this.f7992id);
