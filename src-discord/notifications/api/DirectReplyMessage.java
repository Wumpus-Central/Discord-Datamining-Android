...
public final class DirectReplyMessage {
    ...
    public static final class Companion {
        ...
        public final NotificationData toNotificationData(String data) {
            ...
            String str = directReplyMessage.m530getId3Eiw7ao();
            Integer type = directReplyMessage.getType();
            String content = directReplyMessage.getContent();
            long j10 = directReplyMessage.m529getChannelIdo4g7jtM();
            Integer channelType = directReplyMessage.getChannelType();
            h10 = j.h();
            long j11 = directReplyMessage.getAuthor().m534getIdre6GcUE();
    ...
    public  DirectReplyMessage(int i10, String str, ChannelId channelId, DirectReplyUser directReplyUser, String str2, Integer num, Integer num2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, str, channelId, directReplyUser, str2, num, num2, str3, str4, serializationConstructorMarker);
    }

    public  DirectReplyMessage(String str, long j10, DirectReplyUser directReplyUser, String str2, Integer num, Integer num2, String str3, String str4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, j10, directReplyUser, str2, num, num2, str3, str4);
    }

    
    public static  void m525getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z14 = false;
        output.h(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m617boximpl(self.f7555id));
        output.h(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m591boximpl(self.channelId));
        ...
        if (z10) {
            output.e(serialDesc, 3, a2.f30568a, self.content);
        }
        ...
        if (z11) {
            output.e(serialDesc, 4, m0.f30643a, self.type);
        }
        ...
        if (z12) {
            output.e(serialDesc, 5, m0.f30643a, self.channelType);
        }
        ...
        if (z13) {
            output.e(serialDesc, 6, a2.f30568a, self.channelName);
        }
        if (output.z(serialDesc, 7) || self.guildName != null) {
            z14 = true;
        }
        if (z14) {
            output.e(serialDesc, 7, a2.f30568a, self.guildName);
        }
    }

    
    public final String m526component13Eiw7ao() {
        return this.f7555id;
    }

    
    public final long m527component2o4g7jtM() {
    ...
    public final DirectReplyMessage m528copy_6Dih7Q(String id2, long j10, DirectReplyUser author, String str, Integer num, Integer num2, String str2, String str3) {
        q.h(id2, "id");
        q.h(author, "author");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m621equalsimpl0(this.f7555id, directReplyMessage.f7555id) && ChannelId.m595equalsimpl0(this.channelId, directReplyMessage.channelId) && q.c(this.author, directReplyMessage.author) && q.c(this.content, directReplyMessage.content) && q.c(this.type, directReplyMessage.type) && q.c(this.channelType, directReplyMessage.channelType) && q.c(this.channelName, directReplyMessage.channelName) && q.c(this.guildName, directReplyMessage.guildName);
    }
    ...
    public final long m529getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m530getId3Eiw7ao() {
        return this.f7555id;
    }
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m622hashCodeimpl(this.f7555id) * 31) + ChannelId.m596hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m623toStringimpl(this.f7555id);
    ...
    public  DirectReplyMessage(String str, long j10, DirectReplyUser directReplyUser, String str2, Integer num, Integer num2, String str3, String str4, int i10, DefaultConstructorMarker defaultConstructorMarker) {
