...
public final class DirectReplyMessage {
    ...
    public static final class Companion {
        ...
        public final NotificationData toNotificationData(String data) {
            ...
            String str = directReplyMessage.m502getId3Eiw7ao();
            Integer type = directReplyMessage.getType();
            String content = directReplyMessage.getContent();
            long j10 = directReplyMessage.m501getChannelIdo4g7jtM();
            Integer channelType = directReplyMessage.getChannelType();
            i10 = j.i();
            long j11 = directReplyMessage.getAuthor().m506getIdre6GcUE();
    ...
    public static /* synthetic */ void m497getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z14 = false;
        output.q(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m589boximpl(self.f7921id));
        output.q(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m563boximpl(self.channelId));
        output.q(serialDesc, 2, DirectReplyUser$$serializer.INSTANCE, self.author);
        ...
        if (z10) {
            output.u(serialDesc, 3, a2.f32933a, self.content);
        }
        ...
        if (z11) {
            output.u(serialDesc, 4, m0.f33008a, self.type);
        }
        ...
        if (z12) {
            output.u(serialDesc, 5, m0.f33008a, self.channelType);
        }
        ...
        if (z13) {
            output.u(serialDesc, 6, a2.f32933a, self.channelName);
        }
        if (output.A(serialDesc, 7) || self.guildName != null) {
            z14 = true;
        }
        if (z14) {
            output.u(serialDesc, 7, a2.f32933a, self.guildName);
        }
    }

    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m498component13Eiw7ao() {
        return this.f7921id;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m499component2o4g7jtM() {
    ...
    public final DirectReplyMessage m500copy_6Dih7Q(String id2, long j10, DirectReplyUser author, String str, Integer num, Integer num2, String str2, String str3) {
        q.g(id2, "id");
        q.g(author, "author");
    ...
    public final long m501getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m502getId3Eiw7ao() {
        return this.f7921id;
    }
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m594hashCodeimpl(this.f7921id) * 31) + ChannelId.m568hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m595toStringimpl(this.f7921id);
