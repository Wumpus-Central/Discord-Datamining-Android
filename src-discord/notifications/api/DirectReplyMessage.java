...
public final class DirectReplyMessage {
    ...
    public static final class Companion {
        ...
        public final NotificationData toNotificationData(String data) {
            ...
            String str = directReplyMessage.m503getId3Eiw7ao();
            Integer type = directReplyMessage.getType();
            String content = directReplyMessage.getContent();
            long j10 = directReplyMessage.m502getChannelIdo4g7jtM();
            Integer channelType = directReplyMessage.getChannelType();
            h10 = j.h();
            long j11 = directReplyMessage.getAuthor().m507getIdre6GcUE();
    ...
    public static  void m498getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z14 = false;
        output.n(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m590boximpl(self.f7184id));
        output.n(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m564boximpl(self.channelId));
    ...
    public final String m499component13Eiw7ao() {
        return this.f7184id;
    }

    
    public final long m500component2o4g7jtM() {
    ...
    public final DirectReplyMessage m501copy_6Dih7Q(String id2, long j10, DirectReplyUser author, String str, Integer num, Integer num2, String str2, String str3) {
        q.g(id2, "id");
        q.g(author, "author");
    ...
    public final long m502getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m503getId3Eiw7ao() {
        return this.f7184id;
    }
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m595hashCodeimpl(this.f7184id) * 31) + ChannelId.m569hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m596toStringimpl(this.f7184id);
