...
public final class DirectReplyMessage {
    ...
    public static final class Companion {
        ...
        public final NotificationData toNotificationData(String data) {
            ...
            String str = directReplyMessage.m518getId3Eiw7ao();
            Integer type = directReplyMessage.getType();
            String content = directReplyMessage.getContent();
            long j10 = directReplyMessage.m517getChannelIdo4g7jtM();
            Integer channelType = directReplyMessage.getChannelType();
            h10 = j.h();
            long j11 = directReplyMessage.getAuthor().m522getIdre6GcUE();
    ...
    public static  void m513getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z14 = false;
        output.h(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m605boximpl(self.f7416id));
        ...
        if (z10) {
            output.z(serialDesc, 3, a2.f29550a, self.content);
        }
        ...
        if (z11) {
            output.z(serialDesc, 4, m0.f29625a, self.type);
        }
        ...
        if (z12) {
            output.z(serialDesc, 5, m0.f29625a, self.channelType);
        }
        ...
        if (z13) {
            output.z(serialDesc, 6, a2.f29550a, self.channelName);
        }
        if (output.w(serialDesc, 7) || self.guildName != null) {
            z14 = true;
        }
        if (z14) {
            output.z(serialDesc, 7, a2.f29550a, self.guildName);
        }
    }

    
    public final String m514component13Eiw7ao() {
        return this.f7416id;
    }

    
    public final long m515component2o4g7jtM() {
    ...
    public final DirectReplyMessage m516copy_6Dih7Q(String id2, long j10, DirectReplyUser author, String str, Integer num, Integer num2, String str2, String str3) {
        q.h(id2, "id");
        q.h(author, "author");
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m609equalsimpl0(this.f7416id, directReplyMessage.f7416id) && ChannelId.m583equalsimpl0(this.channelId, directReplyMessage.channelId) && q.c(this.author, directReplyMessage.author) && q.c(this.content, directReplyMessage.content) && q.c(this.type, directReplyMessage.type) && q.c(this.channelType, directReplyMessage.channelType) && q.c(this.channelName, directReplyMessage.channelName) && q.c(this.guildName, directReplyMessage.guildName);
    }
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m610hashCodeimpl(this.f7416id) * 31) + ChannelId.m584hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m611toStringimpl(this.f7416id);
