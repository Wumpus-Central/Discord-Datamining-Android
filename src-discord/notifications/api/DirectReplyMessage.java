...
public final class DirectReplyMessage {
    ...
    public static final void write$Self(DirectReplyMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z14 = false;
        output.o(serialDesc, 0, MessageId$$serializer.INSTANCE, MessageId.m617boximpl(self.f7561id));
        ...
        if (z10) {
            output.B(serialDesc, 3, a2.f29764a, self.content);
        }
        ...
        if (z11) {
            output.B(serialDesc, 4, m0.f29839a, self.type);
        }
        ...
        if (z12) {
            output.B(serialDesc, 5, m0.f29839a, self.channelType);
        }
        ...
        if (z13) {
            output.B(serialDesc, 6, a2.f29764a, self.channelName);
        }
        if (output.z(serialDesc, 7) || self.guildName != null) {
            z14 = true;
        }
        if (z14) {
            output.B(serialDesc, 7, a2.f29764a, self.guildName);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return MessageId.m621equalsimpl0(this.f7561id, directReplyMessage.f7561id) && ChannelId.m595equalsimpl0(this.channelId, directReplyMessage.channelId) && q.c(this.author, directReplyMessage.author) && q.c(this.content, directReplyMessage.content) && q.c(this.type, directReplyMessage.type) && q.c(this.channelType, directReplyMessage.channelType) && q.c(this.channelName, directReplyMessage.channelName) && q.c(this.guildName, directReplyMessage.guildName);
    }
    ...
    public int hashCode() {
        int i10 = ((((MessageId.m622hashCodeimpl(this.f7561id) * 31) + ChannelId.m596hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String str = MessageId.m623toStringimpl(this.f7561id);
