...
public final class Surrogates {
    ...
    public static final /* synthetic */ Surrogates m427boximpl(String str) {
        return new Surrogates(str);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static String m428constructorimpl(String value) {
        q.g(value, "value");
        return value;
    }
    ...
    public static boolean m429equalsimpl(String str, Object obj) {
        return (obj instanceof Surrogates) && q.b(str, ((Surrogates) obj).m436unboximpl());
    }
    ...
    public static final String m432toAssetUrlimpl(String str) {
        String str2 = m433toCodePointsimpl(str);
        return "asset:///emoji-" + str2 + ".png";
    }

    /* renamed from: toCodePoints-impl  reason: not valid java name */
    private static final String m433toCodePointsimpl(String str) {
        boolean z10;
    ...
    public static String m434toStringimpl(String str) {
        return "Surrogates(value=" + str + ")";
    }

    /* renamed from: withoutDiversity-impl  reason: not valid java name */
    public static final String m435withoutDiversityimpl(String str) {
        String a02;
    ...
    public final /* synthetic */ String m436unboximpl() {
        return this.value;
    }
}
