...
public final class RenderableEmojiKt {
    ...
    public static  DraweeSpanStringBuilder renderEmoji$default(RenderableEmoji renderableEmoji, Context context, int i10, boolean z10, int i11, Function1 function1, int i12, Object obj) {
        if ((i12 & 16) != 0) {
            i11 = 2;
        }
        if ((i12 & 32) != 0) {
    ...
    public static  void renderEmojiInto$default(DraweeSpanStringBuilder draweeSpanStringBuilder, RenderableEmoji renderableEmoji, Context context, int i10, boolean z10, int i11, Function1 function1, int i12, Object obj) {
        if ((i12 & 32) != 0) {
            i11 = 2;
        }
        if ((i12 & 64) != 0) {
    ...
    public static final void renderEmojiInto(DraweeSpanStringBuilder draweeSpanStringBuilder, String str, String str2, Context context, int i10, boolean z10, int i11, Function1<? super GenericDraweeHierarchyBuilder, Unit> function1) {
        ...
        GenericDraweeHierarchyBuilder w10 = GenericDraweeHierarchyBuilder.u(context.getResources()).w(ScalingUtils.ScaleType.f7394e);
