...
public final class ScreenshotContentObserver extends ContentObserver {
    ...
    public static final class Companion {
        ...
        public final boolean isScreenshotPath(String str) {
            ...
            M = p.M(lowerCase, "screenshots/", false, 2, null);
            return M;
        }
    }
    ...
    public static final class ScreenshotData {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f7224id == screenshotData.f7224id && q.c(this.fileName, screenshotData.fileName) && q.c(this.relativePath, screenshotData.relativePath) && q.c(this.uri, screenshotData.uri) && this.dateAdded == screenshotData.dateAdded;
        }
        ...
        public int hashCode() {
            return (((((((b.a(this.f7224id) * 31) + this.fileName.hashCode()) * 31) + this.relativePath.hashCode()) * 31) + this.uri.hashCode()) * 31) + b.a(this.dateAdded);
        }

        public String toString() {
            long j10 = this.f7224id;
            ...
            try {
                ...
                if (cursor != null) {
                    ...
                    if (i10 >= 29) {
                        ...
                        relativePath = p.T0(string, '/', th, 2, th);
                    }
    ...
    private final void process(Uri uri) {
        ...
        if (screenshotData != null) {
            ...
            if (str != null) {
                u10 = o.u(str, screenshotData.getPath(), false, 2, null);
                if (u10) {
                    return;
                }
            }
