...
public final class MediaPlayerPause implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7908id, mediaPlayerPause.f7908id) == 0 && this.paused == mediaPlayerPause.paused;
    }
    ...
    public int hashCode() {
        int doubleToLongBits = Double.doubleToLongBits(this.f7908id) * 31;
