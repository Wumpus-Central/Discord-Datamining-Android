...
public final class MediaPlayerPause implements ReactEvent {
    ...
    public static final void write$Self(MediaPlayerPause self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 1, self.paused);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7902id, mediaPlayerPause.f7902id) == 0 && this.paused == mediaPlayerPause.paused;
    }
    ...
    public int hashCode() {
        int doubleToLongBits = Double.doubleToLongBits(this.f7902id) * 31;
