...
public final class MediaPlayerPause implements ReactEvent {
    ...
    public static final void write$Self(MediaPlayerPause self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.D(serialDesc, 0, self.f7905id);
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7905id, mediaPlayerPause.f7905id) == 0 && this.paused == mediaPlayerPause.paused;
    }
    ...
    public int hashCode() {
        int doubleToLongBits = Double.doubleToLongBits(this.f7905id) * 31;
