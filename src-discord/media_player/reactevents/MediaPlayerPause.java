...
public final class MediaPlayerPause implements ReactEvent {
    ...
    public static final void write$Self(MediaPlayerPause self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 0, self.f7241id);
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7241id, mediaPlayerPause.f7241id) == 0 && this.paused == mediaPlayerPause.paused;
    }
    ...
    public int hashCode() {
        int doubleToLongBits = Double.doubleToLongBits(this.f7241id) * 31;
