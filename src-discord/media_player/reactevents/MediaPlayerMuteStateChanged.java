...
public final class MediaPlayerMuteStateChanged implements ReactEvent {
    ...
    public static /* synthetic */ MediaPlayerMuteStateChanged copy$default(MediaPlayerMuteStateChanged mediaPlayerMuteStateChanged, double d10, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            d10 = mediaPlayerMuteStateChanged.f7906id;
        }
        if ((i10 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7906id, mediaPlayerMuteStateChanged.f7906id) == 0 && this.isMuted == mediaPlayerMuteStateChanged.isMuted;
    }
    ...
    public int hashCode() {
        int doubleToLongBits = Double.doubleToLongBits(this.f7906id) * 31;
