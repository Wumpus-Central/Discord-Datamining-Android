...
public final class MediaPlayerMuteStateChanged implements ReactEvent {
    ...
    public static  MediaPlayerMuteStateChanged copy$default(MediaPlayerMuteStateChanged mediaPlayerMuteStateChanged, double d10, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            d10 = mediaPlayerMuteStateChanged.f7175id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(MediaPlayerMuteStateChanged self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.B(serialDesc, 0, self.f7175id);
        output.r(serialDesc, 1, self.isMuted);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7175id, mediaPlayerMuteStateChanged.f7175id) == 0 && this.isMuted == mediaPlayerMuteStateChanged.isMuted;
    }
    ...
    public int hashCode() {
        int doubleToLongBits = Double.doubleToLongBits(this.f7175id) * 31;
    ...
    public String toString() {
        double d10 = this.f7175id;
        boolean z10 = this.isMuted;
        return "MediaPlayerMuteStateChanged(id=" + d10 + ", isMuted=" + z10 + ")";
    }

    public  MediaPlayerMuteStateChanged(int i10, double d10, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
