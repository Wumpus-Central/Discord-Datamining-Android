...
public final class MediaPlayerProgress implements ReactEvent {
    ...
    public static  MediaPlayerProgress copy$default(MediaPlayerProgress mediaPlayerProgress, double d10, long j10, long j11, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            d10 = mediaPlayerProgress.f7542id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(MediaPlayerProgress self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 0, self.f7542id);
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7542id, mediaPlayerProgress.f7542id) == 0 && this.time == mediaPlayerProgress.time && this.duration == mediaPlayerProgress.duration;
    }
    ...
    public int hashCode() {
        return (((Double.doubleToLongBits(this.f7542id) * 31) + b.a(this.time)) * 31) + b.a(this.duration);
    }
