...
public final class MediaPlayerProgress implements ReactEvent {
    ...
    public static /* synthetic */ MediaPlayerProgress copy$default(MediaPlayerProgress mediaPlayerProgress, double d10, long j10, long j11, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            d10 = mediaPlayerProgress.f7171id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(MediaPlayerProgress self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.B(serialDesc, 0, self.f7171id);
        output.D(serialDesc, 1, self.time);
        output.D(serialDesc, 2, self.duration);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.f7171id, mediaPlayerProgress.f7171id) == 0 && this.time == mediaPlayerProgress.time && this.duration == mediaPlayerProgress.duration;
    }
    ...
    public int hashCode() {
        return (((Double.doubleToLongBits(this.f7171id) * 31) + b.a(this.time)) * 31) + b.a(this.duration);
    }
    ...
    public String toString() {
        double d10 = this.f7171id;
        long j10 = this.time;
        long j11 = this.duration;
        return "MediaPlayerProgress(id=" + d10 + ", time=" + j10 + ", duration=" + j11 + ")";
    }

    public /* synthetic */ MediaPlayerProgress(int i10, double d10, long j10, long j11, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
