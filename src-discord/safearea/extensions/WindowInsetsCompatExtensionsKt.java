...
public final class WindowInsetsCompatExtensionsKt {
    ...
    public static  Insets getDisplayCutoutInsets$default(WindowInsetsCompat windowInsetsCompat, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            z10 = false;
        }
    ...
    public static  Insets getImeInsets$default(WindowInsetsCompat windowInsetsCompat, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            z10 = false;
        }
    ...
    static  Insets getInsets$default(WindowInsetsCompat windowInsetsCompat, int i10, boolean z10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            z10 = false;
        }
    ...
    public static  Insets getSystemBarInsets$default(WindowInsetsCompat windowInsetsCompat, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            z10 = false;
        }
