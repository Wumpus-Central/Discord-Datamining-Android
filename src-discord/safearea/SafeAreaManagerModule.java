...
public final class SafeAreaManagerModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        DCDSafeAreaUtils.SafeAreaEdgeInsets b10 = DCDSafeAreaUtils.f13427a.b(rootView);
        if (b10 == null) {
            return new LinkedHashMap();
        }
        l10 = v.l(x.a(ViewProps.TOP, Float.valueOf(b10.d())), x.a(ViewProps.BOTTOM, Float.valueOf(b10.a())), x.a(ViewProps.LEFT, Float.valueOf(b10.b())), x.a(ViewProps.RIGHT, Float.valueOf(b10.c())));
        return l10;
    }
    ...
    public final void getStableSafeAreaInsets(Promise promise) {
        ...
        if (currentActivity == null || (rootView = ActivityExtensionsKt.getRootView(currentActivity)) == null) {
            ...
            safeAreaEdgeInsets = DCDSafeAreaUtils.f13427a.c(rootView);
        }
