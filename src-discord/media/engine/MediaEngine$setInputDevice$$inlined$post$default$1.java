...
public final class MediaEngine$setInputDevice$$inlined$post$default$1 extends s implements Function0<Unit> {
    final /* synthetic */ int $deviceIndex$inlined;
    final /* synthetic */ MediaEngine this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MediaEngine$setInputDevice$$inlined$post$default$1(MediaEngine mediaEngine, int i10) {
        super(0);
