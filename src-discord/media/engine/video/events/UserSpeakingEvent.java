...
public final class UserSpeakingEvent implements ReactEvent {
    ...
    public /* synthetic */ UserSpeakingEvent(int i10, int i11, String str, int i12, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
    ...
    public static /* synthetic */ UserSpeakingEvent copy$default(UserSpeakingEvent userSpeakingEvent, int i10, String str, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
    ...
    public static final void write$Self(UserSpeakingEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.r(serialDesc, 2, self.isSpeaking);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == userSpeakingEvent.connectionId && q.b(this.userId, userSpeakingEvent.userId) && this.isSpeaking == userSpeakingEvent.isSpeaking;
    }
