...
public final class OnVideoCallbackEvent implements ReactEvent {
    ...
    public  OnVideoCallbackEvent(int i10, int i11, String str, long j10, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i10 & 31)) {
    ...
    public static  OnVideoCallbackEvent copy$default(OnVideoCallbackEvent onVideoCallbackEvent, int i10, String str, long j10, String str2, String str3, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(OnVideoCallbackEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 3, self.streamId);
        output.y(serialDesc, 4, self.videoStreamParametersJSON);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == onVideoCallbackEvent.connectionId && q.c(this.userId, onVideoCallbackEvent.userId) && this.ssrc == onVideoCallbackEvent.ssrc && q.c(this.streamId, onVideoCallbackEvent.streamId) && q.c(this.videoStreamParametersJSON, onVideoCallbackEvent.videoStreamParametersJSON);
    }
