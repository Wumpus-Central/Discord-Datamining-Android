...
public final class OnReadyEvent$$serializer implements f0<OnReadyEvent> {
    ...
    public void serialize(Encoder encoder, OnReadyEvent value) {
        ...
        OnReadyEvent.write$Self(value, c10, descriptor2);
        c10.b(descriptor2);
    }
