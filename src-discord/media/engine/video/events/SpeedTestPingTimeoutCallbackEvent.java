...
public final class SpeedTestPingTimeoutCallbackEvent implements ReactEvent {
    ...
    public  SpeedTestPingTimeoutCallbackEvent(int i10, int i11, String str, int i12, int i13, int i14, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i10 & 31)) {
    ...
    public static  SpeedTestPingTimeoutCallbackEvent copy$default(SpeedTestPingTimeoutCallbackEvent speedTestPingTimeoutCallbackEvent, int i10, String str, int i11, int i12, int i13, int i14, Object obj) {
        if ((i14 & 1) != 0) {
    ...
    public static final void write$Self(SpeedTestPingTimeoutCallbackEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 1, self.server);
        output.w(serialDesc, 2, self.port);
        output.w(serialDesc, 3, self.seq);
        output.w(serialDesc, 4, self.timeout);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == speedTestPingTimeoutCallbackEvent.connectionId && q.c(this.server, speedTestPingTimeoutCallbackEvent.server) && this.port == speedTestPingTimeoutCallbackEvent.port && this.seq == speedTestPingTimeoutCallbackEvent.seq && this.timeout == speedTestPingTimeoutCallbackEvent.timeout;
    }
