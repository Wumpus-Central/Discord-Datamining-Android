...
public final class OnVoiceEvent implements ReactEvent {
    ...
    public static  OnVoiceEvent copy$default(OnVoiceEvent onVoiceEvent, float f10, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(OnVoiceEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 1, self.speaking);
    }
    ...
    public  OnVoiceEvent(int i10, float f10, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
