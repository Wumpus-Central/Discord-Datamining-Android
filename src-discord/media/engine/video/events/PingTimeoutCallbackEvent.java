...
public final class PingTimeoutCallbackEvent implements ReactEvent {
    ...
    public  PingTimeoutCallbackEvent(int i10, int i11, String str, int i12, int i13, int i14, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i10 & 31)) {
    ...
    public static  PingTimeoutCallbackEvent copy$default(PingTimeoutCallbackEvent pingTimeoutCallbackEvent, int i10, String str, int i11, int i12, int i13, int i14, Object obj) {
        if ((i14 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == pingTimeoutCallbackEvent.connectionId && q.c(this.server, pingTimeoutCallbackEvent.server) && this.port == pingTimeoutCallbackEvent.port && this.seq == pingTimeoutCallbackEvent.seq && this.timeout == pingTimeoutCallbackEvent.timeout;
    }
