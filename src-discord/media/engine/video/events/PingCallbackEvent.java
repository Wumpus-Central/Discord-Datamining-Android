...
public final class PingCallbackEvent implements ReactEvent {
    ...
    public  PingCallbackEvent(int i10, int i11, int i12, String str, int i13, int i14, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i10 & 31)) {
    ...
    public static  PingCallbackEvent copy$default(PingCallbackEvent pingCallbackEvent, int i10, int i11, String str, int i12, int i13, int i14, Object obj) {
        if ((i14 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == pingCallbackEvent.connectionId && this.ping == pingCallbackEvent.ping && q.c(this.server, pingCallbackEvent.server) && this.port == pingCallbackEvent.port && this.seq == pingCallbackEvent.seq;
    }
