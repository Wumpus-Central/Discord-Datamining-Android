...
public final class ActiveSinksChangeEvent implements ReactEvent {
    ...
    public  ActiveSinksChangeEvent(int i10, String str, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  ActiveSinksChangeEvent copy$default(ActiveSinksChangeEvent activeSinksChangeEvent, String str, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.streamId, activeSinksChangeEvent.streamId) && this.active == activeSinksChangeEvent.active;
    }
