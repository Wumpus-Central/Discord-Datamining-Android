...
public final class FirstFrameCallbackEvent implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return this.connectionId == firstFrameCallbackEvent.connectionId && q.c(this.userId, firstFrameCallbackEvent.userId) && this.ssrc == firstFrameCallbackEvent.ssrc && q.c(this.streamId, firstFrameCallbackEvent.streamId);
    }
