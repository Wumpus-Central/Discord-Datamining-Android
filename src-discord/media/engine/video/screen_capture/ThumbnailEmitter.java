...
public final class ThumbnailEmitter {
    ...
    private final Bitmap createThumbnail(VideoFrame videoFrame) {
        ...
        if (rotatedWidth / rotatedHeight < i10 / i11) {
            ...
            a12 = c.a((i10 - f10) / 2.0f);
            a13 = c.a(f10);
            videoFrameDrawer.drawFrame(videoFrame, glRectDrawer, matrix, a12, 0, a13, this.height);
        } else {
            ...
            a10 = c.a((i11 - f11) / 2.0f);
            int i12 = this.width;
            a11 = c.a(f11);
            videoFrameDrawer2.drawFrame(videoFrame, glRectDrawer2, matrix2, 0, a10, i12, a11);
        }
