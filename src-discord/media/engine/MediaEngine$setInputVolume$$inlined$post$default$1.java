...
public final class MediaEngine$setInputVolume$$inlined$post$default$1 extends s implements Function0<Unit> {
    final /* synthetic */ float $volume$inlined;
    final /* synthetic */ MediaEngine this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MediaEngine$setInputVolume$$inlined$post$default$1(MediaEngine mediaEngine, float f10) {
        super(0);
