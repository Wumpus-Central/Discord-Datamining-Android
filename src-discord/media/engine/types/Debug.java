...
public final class Debug {
    ...
    public static  void log$default(Debug debug, String tag, String method, Function0 lazyMsg, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            method = "";
        }
        q.g(tag, "tag");
    ...
    public static  void log$default(Debug debug, String tag, String method, long j10, Function0 lazyMsg, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            method = "";
        }
        q.g(tag, "tag");
