...
public final class CompressionProgressEvent implements ReactEvent {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Lcom/discord/media/react/events/CompressionProgressEvent$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/media/react/events/CompressionProgressEvent;", "media_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public  CompressionProgressEvent(int i10, String str, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  CompressionProgressEvent copy$default(CompressionProgressEvent compressionProgressEvent, String str, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(CompressionProgressEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 1, self.progress);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.uri, compressionProgressEvent.uri) && this.progress == compressionProgressEvent.progress;
    }
