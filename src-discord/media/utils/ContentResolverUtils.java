...
public final class ContentResolverUtils {
    ...
    public static  File createTempFile$default(ContentResolverUtils contentResolverUtils, ContentResolver contentResolver, Uri uri, String str, String str2, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            str = "temp_";
        }
        if ((i10 & 4) != 0) {
    ...
    public final File createTempFile(ContentResolver contentResolver, Uri uri, String prefix, String str) {
        ...
        q.g(createTempFile, "createTempFile(prefix, \"….deleteOnExit()\n        }");
    ...
    public final boolean isHeif(ContentResolver contentResolver, Uri uri) {
        q.h(contentResolver, "<this>");
        q.h(uri, "uri");
        if (q.c(contentResolver.getType(uri), "image/heif") || q.c(contentResolver.getType(uri), "image/heic")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isJpeg(ContentResolver contentResolver, Uri uri) {
        q.h(contentResolver, "<this>");
        q.h(uri, "uri");
        if (q.c(contentResolver.getType(uri), "image/jpeg") || q.c(contentResolver.getType(uri), "image/jpg")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isPng(ContentResolver contentResolver, Uri uri) {
        q.h(contentResolver, "<this>");
        q.h(uri, "uri");
        return q.c(contentResolver.getType(uri), "image/png");
    }
    ...
    public final Cursor queryCompat(ContentResolver contentResolver, Uri queryUri, String[] queryProjection, int i10, String querySort, String str, Integer num) {
        ...
        q.h(queryProjection, "queryProjection");
        q.h(querySort, "querySort");
