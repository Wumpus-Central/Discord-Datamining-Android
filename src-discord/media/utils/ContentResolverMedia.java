...
public final class ContentResolverMedia {
    ...
    public enum QueryType {
        ...
        public static final class Companion {
            ...
            public final String getUnsupportedImageMimeTypes() {
                String d02;
                d02 = r.d0(QueryType.UNSUPPORTED_IMAGE_MIME_TYPES, ",", null, null, 0, null, ContentResolverMedia$QueryType$Companion$getUnsupportedImageMimeTypes$1.INSTANCE, 30, null);
                return d02;
            }
        }
        ...
        public final String getSelection() {
            ...
            d02 = r.d0(n10, " OR ", null, null, 0, null, null, 62, null);
            return d02;
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7237id == contentResolverMedia.f7237id && q.c(this.uri, contentResolverMedia.uri) && this.mediaType == contentResolverMedia.mediaType && q.c(this.mimeType, contentResolverMedia.mimeType) && q.c(this.name, contentResolverMedia.name) && this.duration == contentResolverMedia.duration && this.dateAdded == contentResolverMedia.dateAdded && this.width == contentResolverMedia.width && this.height == contentResolverMedia.height;
    }
    ...
    public int hashCode() {
        int a10 = ((((b.a(this.f7237id) * 31) + this.uri.hashCode()) * 31) + this.mediaType.hashCode()) * 31;
    ...
    public static final class QueryColumns {
        ...
        public  QueryColumns(Column column, Column column2, Column column3, Column column4, Column column5, Column column6, Column column7, Column column8, int i10, DefaultConstructorMarker defaultConstructorMarker) {
