...
public final class ContentResolverMedia {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7537id == contentResolverMedia.f7537id && q.c(this.uri, contentResolverMedia.uri) && this.mediaType == contentResolverMedia.mediaType && q.c(this.mimeType, contentResolverMedia.mimeType) && q.c(this.name, contentResolverMedia.name) && this.duration == contentResolverMedia.duration && this.dateAdded == contentResolverMedia.dateAdded && this.width == contentResolverMedia.width && this.height == contentResolverMedia.height;
    }
    ...
    public int hashCode() {
        int a10 = ((((b.a(this.f7537id) * 31) + this.uri.hashCode()) * 31) + this.mediaType.hashCode()) * 31;
