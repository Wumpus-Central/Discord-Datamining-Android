...
public final class ContentResolverMedia {
    ...
    public int hashCode() {
        int a10 = ((((b.a(this.f7172id) * 31) + this.uri.hashCode()) * 31) + this.mediaType.hashCode()) * 31;
