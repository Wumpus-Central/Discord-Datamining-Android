...
public final class MediaManagerModule extends ReactContextBaseJavaModule {
    ...
    private final CoroutineScope scope = m0.b();
    ...
    public final void downloadMediaAsset(String uri, int i10, Promise promise) {
        q.h(uri, "uri");
        q.h(promise, "promise");
        l.d(this.scope, b1.b(), null, new MediaManagerModule$downloadMediaAsset$1(this, uri, promise, null), 2, null);
    }
    ...
    public Map<String, List<String>> getConstants() {
        ...
        l10 = j.l("mp4", "mov", "png", "jpg", "jpeg", "gif", "webp");
        e10 = u.e(x.a("supportedExtensions", l10));
        return e10;
    }
    ...
    public void invalidate() {
        super.invalidate();
        m0.d(this.scope, new CancellationException("Module destroyed"));
    }
