...
public final class MediaManagerModule extends ReactContextBaseJavaModule {
    ...
    public final void downloadMediaAsset(String uri, int i10, Promise promise) {
        q.h(uri, "uri");
        q.h(promise, "promise");
        l.d(this.scope, a1.b(), null, new MediaManagerModule$downloadMediaAsset$1(this, uri, promise, null), 2, null);
    }
    ...
    public void invalidate() {
        super.invalidate();
        m0.c(this.scope, new CancellationException("Module destroyed"));
    }
