...
public final class OnPipModeChangedEvent implements ReactEvent {
    ...
    public  OnPipModeChangedEvent(int i10, boolean z10, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  OnPipModeChangedEvent copy$default(OnPipModeChangedEvent onPipModeChangedEvent, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
