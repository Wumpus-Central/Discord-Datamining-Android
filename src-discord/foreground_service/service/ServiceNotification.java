...
public final class ServiceNotification {
    ...
    public final void startForegroundCompat(Service service, Context context, List<ServiceNotificationConfiguration> serviceNotificationConfigurations) {
        ...
        u02 = r.u0(serviceNotificationConfigurations, new Comparator() { // from class: com.discord.foreground_service.service.ServiceNotification$startForegroundCompat$$inlined$sortedBy$1
        ...
        S = r.S(u02);
        M = r.M(u02, 1);
        ForegroundServiceUtilsKt.startForegroundCompat(service, FOREGROUND_NOTIFICATION_ID, buildNotification(context, (ServiceNotificationConfiguration) S));
        Iterator<Integer> it = new IntRange(0, 5).iterator();
        while (it.hasNext()) {
            int nextInt = ((p) it).nextInt();
            V = r.V(M, nextInt);
            ServiceNotificationConfiguration serviceNotificationConfiguration = (ServiceNotificationConfiguration) V;
