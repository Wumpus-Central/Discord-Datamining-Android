...
public final class ServiceNotification {
    ...
    public final void startForegroundCompat(Service service, Context context, List<ServiceNotificationConfiguration> serviceNotificationConfigurations) {
        ...
        v02 = r.v0(serviceNotificationConfigurations, new Comparator() { 
            @Override 
        ...
        T = r.T(v02);
        N = r.N(v02, 1);
        ForegroundServiceUtilsKt.startForegroundCompat(service, FOREGROUND_NOTIFICATION_ID, buildNotification(context, (ServiceNotificationConfiguration) T));
        Iterator<Integer> it = new IntRange(0, 5).iterator();
        while (it.hasNext()) {
            int nextInt = ((p) it).nextInt();
            W = r.W(N, nextInt);
            ServiceNotificationConfiguration serviceNotificationConfiguration = (ServiceNotificationConfiguration) W;
