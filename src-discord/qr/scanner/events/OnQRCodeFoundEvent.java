...
public final class OnQRCodeFoundEvent implements ReactEvent {
    ...
    public  OnQRCodeFoundEvent(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  OnQRCodeFoundEvent copy$default(OnQRCodeFoundEvent onQRCodeFoundEvent, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(OnQRCodeFoundEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.z(serialDesc, 1) || self.result != null) {
            z10 = true;
        }
        if (z10) {
            output.B(serialDesc, 1, a2.f29762a, self.result);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.status, onQRCodeFoundEvent.status) && q.c(this.result, onQRCodeFoundEvent.result);
    }
    ...
    public  OnQRCodeFoundEvent(String str, String str2, int i10, DefaultConstructorMarker defaultConstructorMarker) {
