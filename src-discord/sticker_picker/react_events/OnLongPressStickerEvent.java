...
public final class OnLongPressStickerEvent implements ReactEvent {
    ...
    public /* synthetic */ OnLongPressStickerEvent(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
            n1.b(i10, 1, OnLongPressStickerEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.stickerId = str;
    }

    public static /* synthetic */ OnLongPressStickerEvent copy$default(OnLongPressStickerEvent onLongPressStickerEvent, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnLongPressStickerEvent) && q.b(this.stickerId, ((OnLongPressStickerEvent) obj).stickerId);
    }
