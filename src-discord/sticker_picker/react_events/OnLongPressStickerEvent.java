...
public final class OnLongPressStickerEvent implements ReactEvent {
    ...
    public  OnLongPressStickerEvent(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  OnLongPressStickerEvent copy$default(OnLongPressStickerEvent onLongPressStickerEvent, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnLongPressStickerEvent) && q.c(this.stickerId, ((OnLongPressStickerEvent) obj).stickerId);
    }
