...
public final class StickerPickerRow {
    ...
    public static final class Sticker {
        ...
        public boolean equals(Object obj) {
            ...
            return q.b(this.f7227id, sticker.f7227id) && q.b(this.name, sticker.name) && this.type == sticker.type && this.animated == sticker.animated && q.b(this.url, sticker.url) && this.disabled == sticker.disabled && this.opaque == sticker.opaque;
        }
        ...
        public int hashCode() {
            int hashCode = ((((this.f7227id.hashCode() * 31) + this.name.hashCode()) * 31) + this.type.hashCode()) * 31;
