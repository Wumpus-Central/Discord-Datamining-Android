...
public final class StickerPickerRow {
    ...
    public static final class Sticker {
        ...
        public boolean equals(Object obj) {
            ...
            return q.b(this.f7221id, sticker.f7221id) && q.b(this.name, sticker.name) && this.type == sticker.type && this.animated == sticker.animated && q.b(this.url, sticker.url) && this.disabled == sticker.disabled && this.opaque == sticker.opaque;
        }
        ...
        public int hashCode() {
            int hashCode = ((((this.f7221id.hashCode() * 31) + this.name.hashCode()) * 31) + this.type.hashCode()) * 31;
    ...
    public static  StickerPickerRow copy$default(StickerPickerRow stickerPickerRow, int i10, int i11, int i12, List list, int i13, Object obj) {
        if ((i13 & 1) != 0) {
