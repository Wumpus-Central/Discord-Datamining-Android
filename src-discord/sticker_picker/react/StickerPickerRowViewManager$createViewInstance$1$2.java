...
public final class StickerPickerRowViewManager$createViewInstance$1$2 extends s implements Function1<String, Unit> {
    ...
    public StickerPickerRowViewManager$createViewInstance$1$2(StickerPickerRowViewManager stickerPickerRowViewManager, ThemedReactContext themedReactContext, StickerPickerRowView stickerPickerRowView) {
        super(1);
