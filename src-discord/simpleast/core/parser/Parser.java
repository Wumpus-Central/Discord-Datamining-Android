...
public class Parser<R, T extends Node<R>, S> {
    ...
    public static final class ParseException extends RuntimeException {
        public  ParseException(String str, CharSequence charSequence, Throwable th2, int i10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static  List parse$default(Parser parser, CharSequence charSequence, Object obj, List list, int i10, Object obj2) {
        if (obj2 == null) {
            if ((i10 & 4) != 0) {
                list = parser.rules;
            }
    ...
    public  Parser(boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
