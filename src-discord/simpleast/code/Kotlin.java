...
public final class Kotlin {
    ...
    public static final class FieldNode<RC> extends Node.Parent<RC> {
        ...
        public static final class Companion {
            ...
            public final <RC, S> Rule<RC, Node<RC>, S> createFieldRule(final CodeStyleProviders<RC> codeStyleProviders) {
                ...
                q.g(PATTERN_KOTLIN_FIELD, "PATTERN_KOTLIN_FIELD");
                return new Rule<RC, Node<RC>, S>(PATTERN_KOTLIN_FIELD) { 
                    @Override 
    ...
    public final <RC, S> List<Rule<RC, Node<RC>, S>> createKotlinCodeRules$simpleast_core_release(CodeStyleProviders<RC> codeStyleProviders) {
        ...
        q.g(PATTERN_KOTLIN_COMMENTS2, "PATTERN_KOTLIN_COMMENTS");
        ...
        l10 = j.l(CodeRules.toMatchGroupRule$default(codeRules, PATTERN_KOTLIN_COMMENTS2, 0, codeStyleProviders.getCommentStyleProvider(), 1, null), CodeRules.toMatchGroupRule$default(codeRules, PATTERN_KOTLIN_STRINGS2, 0, codeStyleProviders.getLiteralStyleProvider(), 1, null), CodeRules.toMatchGroupRule$default(codeRules, PATTERN_KOTLIN_ANNOTATION2, 0, codeStyleProviders.getGenericsStyleProvider(), 1, null), FieldNode.Companion.createFieldRule(codeStyleProviders), FunctionNode.Companion.createFunctionRule(codeStyleProviders));
        return l10;
    }
