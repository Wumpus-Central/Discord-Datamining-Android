...
final  class MarkdownRules$createHeaderRules$2 extends n implements Function1<Integer, CharacterStyle> {
    final  MarkdownRules$createHeaderRules$1 $spanProvider$1;
    ...
    @Override 
    public   CharacterStyle invoke(Integer num) {
