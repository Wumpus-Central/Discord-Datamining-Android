...
public final class MobileVoiceOverlayDataUser {
    ...
    public static  MobileVoiceOverlayDataUser m477copyASSxI_0$default(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, long j10, String str, boolean z10, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return mobileVoiceOverlayDataUser.m479copyASSxI_0(j10, str, z10, i10);
    }
    ...
    public static final void write$Self(MobileVoiceOverlayDataUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.n(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m630boximpl(self.userId));
        output.z(serialDesc, 1, a2.f26246a, self.avatar);
        output.r(serialDesc, 2, self.speaking);
        output.q(serialDesc, 3, self.discriminator);
    }

    
    public final long m478component1re6GcUE() {
        return this.userId;
    }
    ...
    public final MobileVoiceOverlayDataUser m479copyASSxI_0(long j10, String str, boolean z10, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m634equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && q.b(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
    }
    ...
    public final long m480getUserIdre6GcUE() {
        return this.userId;
    }

    public int hashCode() {
        int i10 = UserId.m635hashCodeimpl(this.userId) * 31;
    ...
    public String toString() {
        String str = UserId.m637toStringimpl(this.userId);
