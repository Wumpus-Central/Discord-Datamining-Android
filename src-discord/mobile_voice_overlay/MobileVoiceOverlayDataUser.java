...
public final class MobileVoiceOverlayDataUser {
    ...
    public static /* synthetic */ MobileVoiceOverlayDataUser m457copyASSxI_0$default(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, long j10, String str, boolean z10, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return mobileVoiceOverlayDataUser.m459copyASSxI_0(j10, str, z10, i10);
    }
    ...
    public static final void write$Self(MobileVoiceOverlayDataUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 1, a2.f32309a, self.avatar);
    ...
    public final long m458component1re6GcUE() {
        return this.userId;
    }
    ...
    public final MobileVoiceOverlayDataUser m459copyASSxI_0(long j10, String str, boolean z10, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m614equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && q.b(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
    }
    ...
    public final long m460getUserIdre6GcUE() {
        return this.userId;
    }

    public int hashCode() {
        int i10 = UserId.m615hashCodeimpl(this.userId) * 31;
