...
public final class MobileVoiceOverlayDataUser {
    ...
    private MobileVoiceOverlayDataUser(int i10, UserId userId, String str, boolean z10, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.userId = userId.m690unboximpl();
        this.avatar = str;
        this.speaking = z10;
    ...
    public static  MobileVoiceOverlayDataUser m528copyASSxI_0$default(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, long j10, String str, boolean z10, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return mobileVoiceOverlayDataUser.m530copyASSxI_0(j10, str, z10, i10);
    }
    ...
    public static final void write$Self(MobileVoiceOverlayDataUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m681boximpl(self.userId));
    ...
    public final long m529component1re6GcUE() {
        return this.userId;
    }
    ...
    public final MobileVoiceOverlayDataUser m530copyASSxI_0(long j10, String str, boolean z10, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m685equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && q.c(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
    }
    ...
    public final long m531getUserIdre6GcUE() {
        return this.userId;
    }

    public int hashCode() {
        int i10 = UserId.m686hashCodeimpl(this.userId) * 31;
    ...
    public String toString() {
        String str = UserId.m688toStringimpl(this.userId);
