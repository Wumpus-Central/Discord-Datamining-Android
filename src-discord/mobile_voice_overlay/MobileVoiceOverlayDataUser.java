...
public final class MobileVoiceOverlayDataUser {
    ...
    public static /* synthetic */ MobileVoiceOverlayDataUser m473copyASSxI_0$default(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, long j10, String str, boolean z10, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return mobileVoiceOverlayDataUser.m475copyASSxI_0(j10, str, z10, i10);
    }
    ...
    public static final void write$Self(MobileVoiceOverlayDataUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.e(serialDesc, 1, a2.f26940a, self.avatar);
        output.s(serialDesc, 2, self.speaking);
        output.r(serialDesc, 3, self.discriminator);
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m474component1re6GcUE() {
        return this.userId;
    }
    ...
    public final MobileVoiceOverlayDataUser m475copyASSxI_0(long j10, String str, boolean z10, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m630equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && q.b(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
    }
    ...
    public final long m476getUserIdre6GcUE() {
        return this.userId;
    }

    public int hashCode() {
        int i10 = UserId.m631hashCodeimpl(this.userId) * 31;
