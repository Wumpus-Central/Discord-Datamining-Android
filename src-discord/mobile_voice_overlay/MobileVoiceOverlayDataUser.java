...
public final class MobileVoiceOverlayDataUser {
    ...
    private MobileVoiceOverlayDataUser(int i10, UserId userId, String str, boolean z10, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.userId = userId.m683unboximpl();
        this.avatar = str;
        this.speaking = z10;
    ...
    public static  MobileVoiceOverlayDataUser m521copyASSxI_0$default(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, long j10, String str, boolean z10, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return mobileVoiceOverlayDataUser.m523copyASSxI_0(j10, str, z10, i10);
    }
    ...
    public static final void write$Self(MobileVoiceOverlayDataUser self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.i(serialDesc, 0, UserId$$serializer.INSTANCE, UserId.m674boximpl(self.userId));
        output.E(serialDesc, 1, a2.f6238a, self.avatar);
        output.x(serialDesc, 2, self.speaking);
        output.w(serialDesc, 3, self.discriminator);
    }

    
    public final long m522component1re6GcUE() {
        return this.userId;
    }
    ...
    public final MobileVoiceOverlayDataUser m523copyASSxI_0(long j10, String str, boolean z10, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        return UserId.m678equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && q.c(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
    }
    ...
    public final long m524getUserIdre6GcUE() {
        return this.userId;
    }

    public int hashCode() {
        int i10 = UserId.m679hashCodeimpl(this.userId) * 31;
    ...
    public String toString() {
        String str = UserId.m681toStringimpl(this.userId);
