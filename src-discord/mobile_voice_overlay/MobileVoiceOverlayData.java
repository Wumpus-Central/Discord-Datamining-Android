...
public final class MobileVoiceOverlayData {
    ...
    public static final void write$Self(MobileVoiceOverlayData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 0, new ti.f(MobileVoiceOverlayDataUser$$serializer.INSTANCE), self.users);
        output.r(serialDesc, 1, self.extraUsers);
        ...
        output.t(serialDesc, 4, self.channelName);
        output.t(serialDesc, 5, self.guildName);
        output.s(serialDesc, 6, self.deafened);
        output.s(serialDesc, 7, self.muted);
        output.C(serialDesc, 8, ConnectionQuality.Companion.serializer(), self.connectionQuality);
        output.s(serialDesc, 9, self.canGenerateInvite);
        output.C(serialDesc, 10, new ti.f(MobileVoiceOverlaySelectorResult$$serializer.INSTANCE), self.channelSelectorResults);
    }
