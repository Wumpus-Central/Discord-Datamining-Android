...
public final class MobileVoiceOverlayData {
    ...
    public final GuildId m470component3qOKuAAo() {
        return this.guildId;
    }

    
    public final long m471component4o4g7jtM() {
    ...
    public final MobileVoiceOverlayData m472copyHeAh3Ug(List<MobileVoiceOverlayDataUser> users, int i10, GuildId guildId, long j10, String channelName, String guildName, boolean z10, boolean z11, ConnectionQuality connectionQuality, boolean z12, List<MobileVoiceOverlaySelectorResult> channelSelectorResults) {
        q.g(users, "users");
    ...
    public final GuildId m474getGuildIdqOKuAAo() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        ...
        int i10 = (((((((hashCode + (guildId == null ? 0 : GuildId.m582hashCodeimpl(guildId.m586unboximpl()))) * 31) + ChannelId.m569hashCodeimpl(this.channelId)) * 31) + this.channelName.hashCode()) * 31) + this.guildName.hashCode()) * 31;
