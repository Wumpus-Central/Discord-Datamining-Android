...
public final class MobileVoiceOverlayData {
    ...
    public final GuildId m497component3qOKuAAo() {
        return this.guildId;
    }

    
    public final long m498component4o4g7jtM() {
    ...
    public final MobileVoiceOverlayData m499copyHeAh3Ug(List<MobileVoiceOverlayDataUser> users, int i10, GuildId guildId, long j10, String channelName, String guildName, boolean z10, boolean z11, ConnectionQuality connectionQuality, boolean z12, List<MobileVoiceOverlaySelectorResult> channelSelectorResults) {
        q.h(users, "users");
    ...
    public final GuildId m501getGuildIdqOKuAAo() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        ...
        int i10 = (((((((hashCode + (guildId == null ? 0 : GuildId.m609hashCodeimpl(guildId.m613unboximpl()))) * 31) + ChannelId.m596hashCodeimpl(this.channelId)) * 31) + this.channelName.hashCode()) * 31) + this.guildName.hashCode()) * 31;
