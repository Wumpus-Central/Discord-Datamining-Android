...
public final class MobileVoiceOverlayData {
    ...
    public static final void write$Self(MobileVoiceOverlayData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.o(serialDesc, 0, new wi.f(MobileVoiceOverlayDataUser$$serializer.INSTANCE), self.users);
        output.v(serialDesc, 1, self.extraUsers);
        ...
        output.x(serialDesc, 4, self.channelName);
        output.x(serialDesc, 5, self.guildName);
        output.w(serialDesc, 6, self.deafened);
        output.w(serialDesc, 7, self.muted);
        output.o(serialDesc, 8, ConnectionQuality.Companion.serializer(), self.connectionQuality);
        output.w(serialDesc, 9, self.canGenerateInvite);
        output.o(serialDesc, 10, new wi.f(MobileVoiceOverlaySelectorResult$$serializer.INSTANCE), self.channelSelectorResults);
    }
    ...
    public final GuildId m495component3qOKuAAo() {
        return this.guildId;
    }

    
    public final long m496component4o4g7jtM() {
    ...
    public final MobileVoiceOverlayData m497copyHeAh3Ug(List<MobileVoiceOverlayDataUser> users, int i10, GuildId guildId, long j10, String channelName, String guildName, boolean z10, boolean z11, ConnectionQuality connectionQuality, boolean z12, List<MobileVoiceOverlaySelectorResult> channelSelectorResults) {
        q.h(users, "users");
        q.h(channelName, "channelName");
        q.h(guildName, "guildName");
        q.h(connectionQuality, "connectionQuality");
        q.h(channelSelectorResults, "channelSelectorResults");
    ...
    public final long m498getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final GuildId m499getGuildIdqOKuAAo() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        ...
        int i10 = (((((((hashCode + (guildId == null ? 0 : GuildId.m607hashCodeimpl(guildId.m611unboximpl()))) * 31) + ChannelId.m594hashCodeimpl(this.channelId)) * 31) + this.channelName.hashCode()) * 31) + this.guildName.hashCode()) * 31;
