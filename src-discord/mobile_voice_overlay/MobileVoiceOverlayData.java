...
public final class MobileVoiceOverlayData {
    ...
    public static final void write$Self(MobileVoiceOverlayData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.z(serialDesc, 0, new xj.f(MobileVoiceOverlayDataUser$$serializer.INSTANCE), self.users);
        ...
        output.z(serialDesc, 8, ConnectionQuality.Companion.serializer(), self.connectionQuality);
        output.x(serialDesc, 9, self.canGenerateInvite);
        output.z(serialDesc, 10, new xj.f(MobileVoiceOverlaySelectorResult$$serializer.INSTANCE), self.channelSelectorResults);
    }
