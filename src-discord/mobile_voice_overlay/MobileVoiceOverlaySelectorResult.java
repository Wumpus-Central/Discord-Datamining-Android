...
public final class MobileVoiceOverlaySelectorResult {
    ...
    public static final void write$Self(MobileVoiceOverlaySelectorResult self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.C(serialDesc, 0, GuildId$$serializer.INSTANCE, GuildId.m577boximpl(self.guildId));
        output.C(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m564boximpl(self.channelId));
        output.t(serialDesc, 2, self.channelName);
        output.t(serialDesc, 3, self.guildName);
        output.t(serialDesc, 4, self.categoryName);
    }
