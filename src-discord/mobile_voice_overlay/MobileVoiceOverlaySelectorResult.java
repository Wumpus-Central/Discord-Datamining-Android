...
public final class MobileVoiceOverlaySelectorResult {
    ...
    private MobileVoiceOverlaySelectorResult(int i10, GuildId guildId, ChannelId channelId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.guildId = guildId.m603unboximpl();
    ...
    public static final void write$Self(MobileVoiceOverlaySelectorResult self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.o(serialDesc, 0, GuildId$$serializer.INSTANCE, GuildId.m594boximpl(self.guildId));
    ...
    public final long m497component1fYKD8eg() {
        return this.guildId;
    }
    ...
    public final MobileVoiceOverlaySelectorResult m499copyc25twaQ(long j10, long j11, String channelName, String guildName, String categoryName) {
    ...
    public boolean equals(Object obj) {
        ...
        return GuildId.m598equalsimpl0(this.guildId, mobileVoiceOverlaySelectorResult.guildId) && ChannelId.m585equalsimpl0(this.channelId, mobileVoiceOverlaySelectorResult.channelId) && q.c(this.channelName, mobileVoiceOverlaySelectorResult.channelName) && q.c(this.guildName, mobileVoiceOverlaySelectorResult.guildName) && q.c(this.categoryName, mobileVoiceOverlaySelectorResult.categoryName);
    }
    ...
    public final long m501getGuildIdfYKD8eg() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        return (((((((GuildId.m599hashCodeimpl(this.guildId) * 31) + ChannelId.m586hashCodeimpl(this.channelId)) * 31) + this.channelName.hashCode()) * 31) + this.guildName.hashCode()) * 31) + this.categoryName.hashCode();
    }

    public String toString() {
        String str = GuildId.m601toStringimpl(this.guildId);
