...
public final class MobileVoiceOverlaySelectorResult {
    ...
    private MobileVoiceOverlaySelectorResult(int i10, GuildId guildId, ChannelId channelId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.guildId = guildId.m613unboximpl();
    ...
    public  MobileVoiceOverlaySelectorResult(int i10, GuildId guildId, ChannelId channelId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, guildId, channelId, str, str2, str3, serializationConstructorMarker);
    }

    public  MobileVoiceOverlaySelectorResult(long j10, long j11, String str, String str2, String str3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final void write$Self(MobileVoiceOverlaySelectorResult self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.h(serialDesc, 0, GuildId$$serializer.INSTANCE, GuildId.m604boximpl(self.guildId));
        output.h(serialDesc, 1, ChannelId$$serializer.INSTANCE, ChannelId.m591boximpl(self.channelId));
        output.y(serialDesc, 2, self.channelName);
        output.y(serialDesc, 3, self.guildName);
        output.y(serialDesc, 4, self.categoryName);
    }

    
    public final long m507component1fYKD8eg() {
        return this.guildId;
    }

    
    public final long m508component2o4g7jtM() {
    ...
    public final MobileVoiceOverlaySelectorResult m509copyc25twaQ(long j10, long j11, String channelName, String guildName, String categoryName) {
    ...
    public boolean equals(Object obj) {
        ...
        return GuildId.m608equalsimpl0(this.guildId, mobileVoiceOverlaySelectorResult.guildId) && ChannelId.m595equalsimpl0(this.channelId, mobileVoiceOverlaySelectorResult.channelId) && q.c(this.channelName, mobileVoiceOverlaySelectorResult.channelName) && q.c(this.guildName, mobileVoiceOverlaySelectorResult.guildName) && q.c(this.categoryName, mobileVoiceOverlaySelectorResult.categoryName);
    }
    ...
    public final long m510getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final long m511getGuildIdfYKD8eg() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        return (((((((GuildId.m609hashCodeimpl(this.guildId) * 31) + ChannelId.m596hashCodeimpl(this.channelId)) * 31) + this.channelName.hashCode()) * 31) + this.guildName.hashCode()) * 31) + this.categoryName.hashCode();
    }

    public String toString() {
        String str = GuildId.m611toStringimpl(this.guildId);
