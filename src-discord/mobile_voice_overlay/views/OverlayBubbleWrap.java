...
public abstract class OverlayBubbleWrap extends OverlayView {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {f0.e(new w(OverlayBubbleWrap.class, "isMoving", "isMoving()Z", 0))};
    ...
    public OverlayBubbleWrap(Context context) {
        ...
        this.isMoving$delegate = new c<Boolean>(bool) { // from class: com.discord.mobile_voice_overlay.views.OverlayBubbleWrap$special$$inlined$observable$1
            ...
            protected void afterChange(KProperty<?> property, Boolean bool2, Boolean bool3) {
                ...
                if (bool2.booleanValue() != booleanValue) {
                    ...
                    if (booleanValue) {
                        ...
                        this.getSpringAnimationX().c();
                        this.getSpringAnimationY().c();
                    }
        ...
        SpringAnimation springAnimation = new SpringAnimation(this, DynamicAnimation.f3724u, 0.0f);
        springAnimation.k(50.0f);
        springAnimation.q().f(200.0f);
        springAnimation.q().d(0.75f);
        this.springAnimationX = springAnimation;
        SpringAnimation springAnimation2 = new SpringAnimation(this, DynamicAnimation.f3725v, 0.0f);
    ...
    private final void animateTo(SpringAnimation springAnimation, float f10, float f11) {
        springAnimation.c();
        springAnimation.j(f10);
        springAnimation.o(f11);
    }
    ...
    public OverlayBubbleWrap(Context context, AttributeSet attributeSet) {
        ...
        a aVar = a.f22161a;
        final Boolean bool = Boolean.FALSE;
        this.isMoving$delegate = new c<Boolean>(bool) { // from class: com.discord.mobile_voice_overlay.views.OverlayBubbleWrap$special$$inlined$observable$2
            @Override // kotlin.properties.c
            protected void afterChange(KProperty<?> property, Boolean bool2, Boolean bool3) {
                q.g(property, "property");
                boolean booleanValue = bool3.booleanValue();
    ...
    public OverlayBubbleWrap(Context context, AttributeSet attributeSet, int i10) {
        ...
        a aVar = a.f22161a;
        final Boolean bool = Boolean.FALSE;
        this.isMoving$delegate = new c<Boolean>(bool) { // from class: com.discord.mobile_voice_overlay.views.OverlayBubbleWrap$special$$inlined$observable$3
            @Override // kotlin.properties.c
            protected void afterChange(KProperty<?> property, Boolean bool2, Boolean bool3) {
                q.g(property, "property");
                boolean booleanValue = bool3.booleanValue();
