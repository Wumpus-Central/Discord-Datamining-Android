...
public final class MobileVoiceOverlayAssets {
    ...
    public  MobileVoiceOverlayAssets(int i10, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, SerializationConstructorMarker serializationConstructorMarker) {
        if (2047 != (i10 & 2047)) {
    ...
    public static final void write$Self(MobileVoiceOverlayAssets self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.useSpeaker);
        output.y(serialDesc, 1, self.mute);
        output.y(serialDesc, 2, self.disconnectFromVoice);
        output.y(serialDesc, 3, self.getInvite);
        output.y(serialDesc, 4, self.switchChannels);
        output.y(serialDesc, 5, self.openDiscord);
        output.y(serialDesc, 6, self.inviteLinkCopied);
        output.y(serialDesc, 7, self.channelSelect);
        output.y(serialDesc, 8, self.closeWindow);
        output.y(serialDesc, 9, self.searchChannels);
        output.y(serialDesc, 10, self.noResults);
    }
    ...
    public final MobileVoiceOverlayAssets copy(String useSpeaker, String mute, String disconnectFromVoice, String getInvite, String switchChannels, String openDiscord, String inviteLinkCopied, String channelSelect, String closeWindow, String searchChannels, String noResults) {
        q.h(useSpeaker, "useSpeaker");
        q.h(mute, "mute");
        q.h(disconnectFromVoice, "disconnectFromVoice");
        q.h(getInvite, "getInvite");
        q.h(switchChannels, "switchChannels");
        q.h(openDiscord, "openDiscord");
        q.h(inviteLinkCopied, "inviteLinkCopied");
        q.h(channelSelect, "channelSelect");
        q.h(closeWindow, "closeWindow");
        q.h(searchChannels, "searchChannels");
        q.h(noResults, "noResults");
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.useSpeaker, mobileVoiceOverlayAssets.useSpeaker) && q.c(this.mute, mobileVoiceOverlayAssets.mute) && q.c(this.disconnectFromVoice, mobileVoiceOverlayAssets.disconnectFromVoice) && q.c(this.getInvite, mobileVoiceOverlayAssets.getInvite) && q.c(this.switchChannels, mobileVoiceOverlayAssets.switchChannels) && q.c(this.openDiscord, mobileVoiceOverlayAssets.openDiscord) && q.c(this.inviteLinkCopied, mobileVoiceOverlayAssets.inviteLinkCopied) && q.c(this.channelSelect, mobileVoiceOverlayAssets.channelSelect) && q.c(this.closeWindow, mobileVoiceOverlayAssets.closeWindow) && q.c(this.searchChannels, mobileVoiceOverlayAssets.searchChannels) && q.c(this.noResults, mobileVoiceOverlayAssets.noResults);
    }
