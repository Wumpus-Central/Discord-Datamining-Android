...
public final class CrashReportEvent implements ReactEvent {
    ...
    public WritableMap serialize() {
        ...
        if (tombstone != null) {
            ...
            m10 = j.m(new IntRange(0, RNCWebViewManager.COMMAND_CLEAR_FORM_DATA), c.f6576k);
            if (m10 == 0) {
        ...
        return NativeMapExtensionsKt.nativeMapOf(nf.x.a("reports", NativeArrayExtensionsKt.nativeArrayOf(writableNativeMap)));
    }
