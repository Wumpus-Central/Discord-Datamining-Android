...
public final class CrashReportEvent implements ReactEvent {
    ...
    public static  CrashReportEvent copy$default(CrashReportEvent crashReportEvent, Boolean bool, HistoricalProcessExitReason.Reason reason, SystemLogUtils.Tombstone tombstone, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.crashedLastRun, crashReportEvent.crashedLastRun) && q.c(this.reason, crashReportEvent.reason) && q.c(this.tombstone, crashReportEvent.tombstone);
    }
    ...
    public WritableMap serialize() {
        ...
        if (tombstone != null) {
            ...
            m10 = j.m(new IntRange(0, RNCWebViewManager.COMMAND_CLEAR_FORM_DATA), c.f14517j);
            if (m10 == 0) {
                w10 = o.w(tombstone.getText());
                if (!w10) {
                    a12 = r.a1(tombstone.getText(), 6291456);
                    writableNativeMap.putString("tombstone", a12);
                }
            }
        }
        return NativeMapExtensionsKt.nativeMapOf(x.a("reports", NativeArrayExtensionsKt.nativeArrayOf(writableNativeMap)));
    }
