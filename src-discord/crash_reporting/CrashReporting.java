...
public final class CrashReporting {
    ...
    public static final void init$lambda$3(Context context, SentryAndroidOptions options) {
        ...
        options.setRelease("discord_android@179.14.0-2+179214");
        ...
        options.setProguardUuid("341373c4-d6a7-42fa-b78b-eebf9c26de08");
    ...
    */
    public static final io.sentry.SentryEvent init$lambda$3$lambda$2(io.sentry.SentryEvent r6, io.sentry.Hint r7) {
        ...
        L_0x001f:
            ...
            r5 = 2
            boolean r2 = ri.l.M(r2, r4, r1, r5, r0)
    ...
    public final double getTracingSampleRate() {
        boolean M;
        M = ri.v.M(ClientInfo.INSTANCE.getReleaseChannel(), BuildConfig.FLAVOR, false, 2, null);
        return M ? 0.05d : 0.0d;
    }
    ...
    public final void init(final Context context) {
        ...
        if (!z10) {
            if (isProductionChannel()) {
                ...
                q.f(DEVICE, "DEVICE");
                M = ri.v.M(DEVICE, "vivo", false, 2, null);
                if (M) {
                    return;
                }
            }
    ...
    public final boolean isProductionChannel() {
        ...
        boolean M2;
        ClientInfo clientInfo = ClientInfo.INSTANCE;
        M = ri.v.M(clientInfo.getReleaseChannel(), "beta", false, 2, null);
        if (M) {
            return false;
        }
        M2 = ri.v.M(clientInfo.getReleaseChannel(), BuildConfig.FLAVOR, false, 2, null);
        return !M2;
    }
