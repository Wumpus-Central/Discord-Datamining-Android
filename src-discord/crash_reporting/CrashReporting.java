...
public final class CrashReporting {
    ...
    public static final void init$lambda$0(Context context, SentryAndroidOptions options) {
        ...
        options.setRelease("discord_android@185.10.0-2+185210");
        ...
        options.setProguardUuid("6ffcf625-6b51-4060-be77-68eb1c51008c");
    ...
    public final double getTracingSampleRate() {
        boolean M;
        M = ki.v.M(ClientInfo.INSTANCE.getReleaseChannel(), BuildConfig.FLAVOR, false, 2, null);
        return M ? 0.05d : 0.0d;
    }
    ...
    public final boolean isProductionChannel() {
        ...
        M2 = ki.v.M(clientInfo.getReleaseChannel(), BuildConfig.FLAVOR, false, 2, null);
        return !M2;
    }
