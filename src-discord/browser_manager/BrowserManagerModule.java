    ...
    */
    public java.util.Map<java.lang.String, java.lang.Object> getConstants() {
        /*
            ...
            java.lang.Integer r0 = nj.l.m(r0)
            if (r0 == 0) goto L_0x0018
            int r0 = r0.intValue()
            goto L_0x0019
        L_0x0018:
        ...
        L_0x0019:
            ...
            kotlin.Pair r0 = jg.x.a(r3, r0)
            r3 = 0
            r2[r3] = r0
            java.lang.String r0 = "isChromeInstalled"
            java.lang.Boolean r3 = java.lang.Boolean.TRUE
            kotlin.Pair r0 = jg.x.a(r0, r3)
            r2[r1] = r0
            java.util.Map r0 = kg.s.l(r2)
            return r0
        */
    ...
    @ReactMethod
    public final void selectBrowser(int i10) {
        if (i10 == 0) {
            getCacheModule().setItem(BROWSER_CACHE_KEY, NearbyManager.PERMISSION_DENIED);
        } else if (i10 == 1 || i10 == 2) {
            getCacheModule().setItem(BROWSER_CACHE_KEY, String.valueOf(i10));
        } else {
            throw new IllegalArgumentException("Unknown browser id provided: " + i10);
        }
    }
}
