...
public final class CustomLineHeightSpanOverride {
    ...
    public static final void override$lambda$0(Object[] objArr) {
        ...
        q.e(obj, "null cannot be cast to non-null type android.graphics.Paint.FontMetricsInt");
    ...
    private final void overrideLineHeight(Paint.FontMetricsInt fontMetricsInt, int i10) {
        ...
        if (i14 > 0) {
            a10 = c.a(i13 * ((i10 * 0.75f) / i14));
            fontMetricsInt.descent = a10;
            fontMetricsInt.ascent = a10 - i10;
        }
    }

    public final void override() {
        CustomLineHeightSpan.chooseHeightOverride = new Callback() { // from class: o3.a
