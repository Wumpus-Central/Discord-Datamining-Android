...
public final class ReplayProviderActivity extends Activity {
    ...
    public static final class Companion {
        ...
        public final void requestUriPermission(Activity activity, String replayFilename, int i10) {
            q.g(activity, "activity");
            q.g(replayFilename, "replayFilename");
            Intent intent = new Intent();
    ...
    private final List<Replay> getReplaysList() {
        ...
        q.f(logsFolderPath, "logsFolderPath");
    ...
    private final Uri grantAccessToFile(String str, File file) {
        ...
        q.f(fileContentUri, "fileContentUri");
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (q.b(getIntent().getAction(), "com.discord.GET_REPLAY_LIST")) {
            ...
            setResult(-1, intent);
            finish();
        } else if (q.b(getIntent().getAction(), "com.discord.REQUEST_REPLAY_ACCESS")) {
