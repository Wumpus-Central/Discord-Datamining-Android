...
public final class DebugRowLogger implements RowLogger {
    ...
    private final void appendLine(String str) {
        ...
        w10 = u.w(str);
        if (!w10) {
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(DebugRowLoggerKt.outputStream(this.replayFile, true), d.f20667b);
            try {
    ...
    private final void writeJson() {
        ...
        Charset charset = d.f20667b;
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(fileOutputStream, charset);
        try {
            outputStreamWriter.write("[\n");
            qf.q.c(new InputStreamReader(new FileInputStream(this.replayFile), charset), new DebugRowLogger$writeJson$1$1(ref$BooleanRef, outputStreamWriter));
            outputStreamWriter.write("\n]");
            outputStreamWriter.flush();
            Unit unit = Unit.f20717a;
            th = null;
