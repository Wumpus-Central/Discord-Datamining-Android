...
public final class Replay {
    ...
    public  Replay(int i10, String str, long j10, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
    ...
    public static  Replay copy$default(Replay replay, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = replay.filename;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void write$Self(Replay self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.s(serialDesc, 0, self.filename);
        output.D(serialDesc, 1, self.lastModified);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return q.c(this.filename, replay.filename) && this.lastModified == replay.lastModified;
    }
