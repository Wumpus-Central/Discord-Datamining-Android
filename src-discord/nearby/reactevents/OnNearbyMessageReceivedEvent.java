...
public final class OnNearbyMessageReceivedEvent implements ReactEvent {
    ...
    public  OnNearbyMessageReceivedEvent(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static  OnNearbyMessageReceivedEvent copy$default(OnNearbyMessageReceivedEvent onNearbyMessageReceivedEvent, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof OnNearbyMessageReceivedEvent) && q.c(this.body, ((OnNearbyMessageReceivedEvent) obj).body);
    }
