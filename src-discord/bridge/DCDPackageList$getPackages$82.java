...
final class DCDPackageList$getPackages$82 extends s implements Function1<ReactApplicationContext, NativeModule> {
    public static final DCDPackageList$getPackages$82 INSTANCE = new DCDPackageList$getPackages$82();

    DCDPackageList$getPackages$82() {
        super(1);
    }
