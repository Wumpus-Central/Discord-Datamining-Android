...
public final class DCDPackageList extends PackageList {
    ...
    public ArrayList<ReactPackage> getPackages() {
        ...
        packages.add(dCDModuleProvider.getLegacyPackageForModuleWithViewManager(DCDPackageList$getPackages$55.INSTANCE, DCDPackageList$getPackages$56.INSTANCE));
        ...
        packages.add(dCDModuleProvider.getLegacyPackageForModuleWithViewManager(null, DCDPackageList$getPackages$59.INSTANCE));
        packages.add(dCDModuleProvider.getLegacyPackageForModuleWithViewManager(DCDPackageList$getPackages$60.INSTANCE, DCDPackageList$getPackages$61.INSTANCE));
        ...
        packages.add(dCDModuleProvider.getLegacyPackageForModuleWithViewManager(null, DCDPackageList$getPackages$64.INSTANCE));
        ...
        packages.add(dCDModuleProvider.getTurboPackageForModule(AudioRouteEmitterModule.NAME, DCDPackageList$getPackages$69.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(DeviceManagerModule.NAME, DCDPackageList$getPackages$70.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(DeviceLocaleManagerModule.NAME, DCDPackageList$getPackages$71.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(FileManagerModule.NAME, DCDPackageList$getPackages$72.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(ClientInfoManagerModule.NAME, DCDPackageList$getPackages$73.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(KeyboardManagerModule.NAME, DCDPackageList$getPackages$74.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(HeartbeatKeyProviderModule.NAME, DCDPackageList$getPackages$75.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(ThemeModule.NAME, DCDPackageList$getPackages$76.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(MobileVoiceOverlayManagerModule.NAME, DCDPackageList$getPackages$77.INSTANCE));
