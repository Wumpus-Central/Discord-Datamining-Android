...
public final class DCDPackageList extends PackageList {
    ...
    public ArrayList<ReactPackage> getPackages() {
        ...
        packages.add(dCDModuleProvider.getLegacyPackageForModuleWithViewManager(DCDPackageList$getPackages$54.INSTANCE, DCDPackageList$getPackages$55.INSTANCE));
        ...
        packages.add(dCDModuleProvider.getLegacyPackageForModuleWithViewManager(null, DCDPackageList$getPackages$58.INSTANCE));
        ...
        packages.add(dCDModuleProvider.getLegacyPackageForModuleWithViewManager(null, DCDPackageList$getPackages$63.INSTANCE));
        ...
        packages.add(dCDModuleProvider.getTurboPackageForModule(AudioRouteEmitterModule.NAME, DCDPackageList$getPackages$68.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(DeviceManagerModule.NAME, DCDPackageList$getPackages$69.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(DeviceLocaleManagerModule.NAME, DCDPackageList$getPackages$70.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(FileManagerModule.NAME, DCDPackageList$getPackages$71.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(ClientInfoManagerModule.NAME, DCDPackageList$getPackages$72.INSTANCE));
        packages.add(dCDModuleProvider.getTurboPackageForModule(KeyboardManagerModule.NAME, DCDPackageList$getPackages$73.INSTANCE));
