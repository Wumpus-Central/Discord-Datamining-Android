...
public final class DiscordAudioManager {
    ...
    public static final class AudioDevice {
        ...
        public boolean equals(Object obj) {
            ...
            return this.type == audioDevice.type && this.isAvailable == audioDevice.isAvailable && q.c(this.f7196id, audioDevice.f7196id) && q.c(this.name, audioDevice.name);
        }
