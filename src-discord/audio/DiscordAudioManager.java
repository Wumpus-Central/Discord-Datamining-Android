    ...
    */
    ...
    public static final class AudioDevice {
        ...
        public boolean equals(Object obj) {
            ...
            return this.type == audioDevice.type && this.isAvailable == audioDevice.isAvailable && q.b(this.f7240id, audioDevice.f7240id) && q.b(this.name, audioDevice.name);
        }
