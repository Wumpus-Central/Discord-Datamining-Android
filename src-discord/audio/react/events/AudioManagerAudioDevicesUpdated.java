...
public final class AudioManagerAudioDevicesUpdated implements ReactEvent {
    ...
    public static  AudioManagerAudioDevicesUpdated copy$default(AudioManagerAudioDevicesUpdated audioManagerAudioDevicesUpdated, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
