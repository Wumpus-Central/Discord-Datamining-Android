...
public final class AudioManagerMediaVolumeChanged implements ReactEvent {
    ...
    public static /* synthetic */ AudioManagerMediaVolumeChanged copy$default(AudioManagerMediaVolumeChanged audioManagerMediaVolumeChanged, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(AudioManagerMediaVolumeChanged self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.x(serialDesc, 0, self.volume);
    }
    ...
    public /* synthetic */ AudioManagerMediaVolumeChanged(int i10, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
