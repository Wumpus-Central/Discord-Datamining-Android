...
public final class AudioManagerAudioDeviceChanged implements ReactEvent {
    ...
    public /* synthetic */ AudioManagerAudioDeviceChanged(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
    ...
    public static /* synthetic */ AudioManagerAudioDeviceChanged copy$default(AudioManagerAudioDeviceChanged audioManagerAudioDeviceChanged, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static final void write$Self(AudioManagerAudioDeviceChanged self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.t(serialDesc, 0, self.device);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof AudioManagerAudioDeviceChanged) && q.b(this.device, ((AudioManagerAudioDeviceChanged) obj).device);
    }
