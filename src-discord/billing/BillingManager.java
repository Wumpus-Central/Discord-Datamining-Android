...
public final class BillingManager {
    ...
    private final ExponentialBackoff backoff = new ExponentialBackoff(p1.f21800j, 1000, 300000, 10);
    ...
    public static final ProductDetailsResponseListener getProductsWithRetry$createProductDetailsResponseListener(final Function2<? super BillingResult, ? super List<ProductDetails>, Unit> function2) {
        return new ProductDetailsResponseListener() { 
            ...
            public final void a(BillingResult billingResult, List list) {
                BillingManager.getProductsWithRetry$createProductDetailsResponseListener$lambda$2(Function2.this, billingResult, list);
            }
        };
    }

    
    public static final void getProductsWithRetry$createProductDetailsResponseListener$lambda$2(Function2 listener, BillingResult billingResult, List productDetails) {
    ...
    public static final void purchaseWithProductDetails$lambda$6(BillingManager this$0, Function1 onError, String productId, String str, String str2, String userId, String str3, Activity activity, Function0 onSuccess, Ref$BooleanRef completed, BillingResult billingResult, List productDetails) {
        ...
        q.h(productDetails, "productDetails");
        synchronized (this$0) {
            if (!completed.f21467j) {
                completed.f21467j = true;
