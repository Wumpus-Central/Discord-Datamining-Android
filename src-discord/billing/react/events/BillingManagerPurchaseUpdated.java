...
public final class BillingManagerPurchaseUpdated implements ReactEvent {
    ...
    public  BillingManagerPurchaseUpdated(int i10, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i10 & 7)) {
    ...
    public static final void write$Self(BillingManagerPurchaseUpdated self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.y(serialDesc, 0, self.purchaseToken);
        output.y(serialDesc, 1, self.packageName);
        output.y(serialDesc, 2, self.sku);
    }
