...
public final class BillingManagerDowngradeCommand implements ReactEvent {
    ...
    public static /* synthetic */ BillingManagerDowngradeCommand copy$default(BillingManagerDowngradeCommand billingManagerDowngradeCommand, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(BillingManagerDowngradeCommand self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.r(serialDesc, 0, self.downgradeCommand);
    }
    ...
    public /* synthetic */ BillingManagerDowngradeCommand(int i10, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
