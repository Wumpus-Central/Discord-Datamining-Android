...
public final class BillingManagerConnectionStateUpdated implements ReactEvent {
    ...
    public static  BillingManagerConnectionStateUpdated copy$default(BillingManagerConnectionStateUpdated billingManagerConnectionStateUpdated, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final void write$Self(BillingManagerConnectionStateUpdated self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.w(serialDesc, 0, self.connectionState);
    }
    ...
    public  BillingManagerConnectionStateUpdated(int i10, int i11, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
