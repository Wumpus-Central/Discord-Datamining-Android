...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lco/discord/media_engine/Transport;Lco/discord/media_engine/OutboundRtpAudio;Lco/discord/media_engine/OutboundRtpVideo;Ljava/util/HashMap;Ljava/util/HashMap;)V",
        "getInboundRtpAudio",
        "()Ljava/util/HashMap;",
        "getInboundRtpVideo",
        "getOutboundRtpAudio",
...
# instance fields
.field private final inboundRtpAudio:Ljava/util/HashMap;
...
.field private final inboundRtpVideo:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
# direct methods
.method public constructor <init>(Lco/discord/media_engine/Transport;Lco/discord/media_engine/OutboundRtpAudio;Lco/discord/media_engine/OutboundRtpVideo;Ljava/util/HashMap;Ljava/util/HashMap;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 19
    .line 20
    iput-object p4, p0, Lco/discord/media_engine/Stats;->inboundRtpAudio:Ljava/util/HashMap;

    .line 21
    .line 22
    iput-object p5, p0, Lco/discord/media_engine/Stats;->inboundRtpVideo:Ljava/util/HashMap;
...
.method public static synthetic copy$default(Lco/discord/media_engine/Stats;Lco/discord/media_engine/Transport;Lco/discord/media_engine/OutboundRtpAudio;Lco/discord/media_engine/OutboundRtpVideo;Ljava/util/HashMap;Ljava/util/HashMap;ILjava/lang/Object;)Lco/discord/media_engine/Stats;
    .locals 3
    ...
    iget-object p4, p0, Lco/discord/media_engine/Stats;->inboundRtpAudio:Ljava/util/HashMap;
    ...
    iget-object p5, p0, Lco/discord/media_engine/Stats;->inboundRtpVideo:Ljava/util/HashMap;
    ...
    invoke-virtual/range {p2 .. p7}, Lco/discord/media_engine/Stats;->copy(Lco/discord/media_engine/Transport;Lco/discord/media_engine/OutboundRtpAudio;Lco/discord/media_engine/OutboundRtpVideo;Ljava/util/HashMap;Ljava/util/HashMap;)Lco/discord/media_engine/Stats;
...
.method public final component4()Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lco/discord/media_engine/Stats;->inboundRtpAudio:Ljava/util/HashMap;
...
.method public final component5()Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lco/discord/media_engine/Stats;->inboundRtpVideo:Ljava/util/HashMap;

    return-object v0
.end method

.method public final copy(Lco/discord/media_engine/Transport;Lco/discord/media_engine/OutboundRtpAudio;Lco/discord/media_engine/OutboundRtpVideo;Ljava/util/HashMap;Ljava/util/HashMap;)Lco/discord/media_engine/Stats;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v6}, Lco/discord/media_engine/Stats;-><init>(Lco/discord/media_engine/Transport;Lco/discord/media_engine/OutboundRtpAudio;Lco/discord/media_engine/OutboundRtpVideo;Ljava/util/HashMap;Ljava/util/HashMap;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lco/discord/media_engine/Stats;
    ...
    iget-object v3, p1, Lco/discord/media_engine/Stats;->transport:Lco/discord/media_engine/Transport;
    ...
    iget-object v3, p1, Lco/discord/media_engine/Stats;->outboundRtpAudio:Lco/discord/media_engine/OutboundRtpAudio;
    ...
    iget-object v3, p1, Lco/discord/media_engine/Stats;->outboundRtpVideo:Lco/discord/media_engine/OutboundRtpVideo;
    ...
    :cond_4
    iget-object v1, p0, Lco/discord/media_engine/Stats;->inboundRtpAudio:Ljava/util/HashMap;

    iget-object v3, p1, Lco/discord/media_engine/Stats;->inboundRtpAudio:Ljava/util/HashMap;
    ...
    :cond_5
    iget-object v1, p0, Lco/discord/media_engine/Stats;->inboundRtpVideo:Ljava/util/HashMap;

    iget-object p1, p1, Lco/discord/media_engine/Stats;->inboundRtpVideo:Ljava/util/HashMap;
...
.method public final getInboundRtpAudio()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final getInboundRtpVideo()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
