...
.method constructor <init>(Lj$/util/stream/B;IJJ)V
    ...
    iput-wide p3, p0, Lj$/util/stream/m2;->s:J

    iput-wide p5, p0, Lj$/util/stream/m2;->t:J

    invoke-direct {p0, p1, p2}, Lj$/util/stream/z;-><init>(Lj$/util/stream/B;I)V

    return-void
.end method

.method static h1(Lj$/util/y;JJJ)Lj$/util/y;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lj$/util/stream/r3;-><init>(Lj$/util/y;JJ)V
...
.method final U0(Lj$/util/Spliterator;Lj$/util/function/IntFunction;Lj$/util/stream/c;)Lj$/util/stream/C0;
    ...
    iget-wide v4, v9, Lj$/util/stream/m2;->s:J

    iget-wide v7, v9, Lj$/util/stream/m2;->t:J
    ...
    invoke-static {v6, v0, v10}, Lj$/util/stream/t0;->n0(Lj$/util/stream/t0;Lj$/util/Spliterator;Z)Lj$/util/stream/y0;
    ...
    iget-wide v1, v9, Lj$/util/stream/m2;->s:J

    iget-wide v3, v9, Lj$/util/stream/m2;->t:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/m2;->h1(Lj$/util/y;JJJ)Lj$/util/y;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/t0;->n0(Lj$/util/stream/t0;Lj$/util/Spliterator;Z)Lj$/util/stream/y0;
    ...
    iget-wide v7, v9, Lj$/util/stream/m2;->s:J

    iget-wide v11, v9, Lj$/util/stream/m2;->t:J
...
.method final V0(Lj$/util/stream/c;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v9, p0, Lj$/util/stream/m2;->s:J

    iget-wide p1, p0, Lj$/util/stream/m2;->t:J
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/j3;-><init>(Lj$/util/y;JJ)V
    ...
    iget-wide v1, p0, Lj$/util/stream/m2;->s:J

    iget-wide v3, p0, Lj$/util/stream/m2;->t:J
    ...
    iget-wide v5, p0, Lj$/util/stream/m2;->s:J

    iget-wide v7, p0, Lj$/util/stream/m2;->t:J
...
.method final X0(ILj$/util/stream/e2;)Lj$/util/stream/e2;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/l2;-><init>(Lj$/util/stream/m2;Lj$/util/stream/e2;)V
